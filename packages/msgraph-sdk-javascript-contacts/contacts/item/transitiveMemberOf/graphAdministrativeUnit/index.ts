...
import { createAdministrativeUnitCollectionResponseFromDiscriminatorValue, type AdministrativeUnitCollectionResponse } from 'contacts/models/';
 ...
 */
export const GraphAdministrativeUnitRequestBuilderUriTemplate = "{+baseurl}/contacts/{orgContact%2Did}/transitiveMemberOf/graph.administrativeUnit{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
