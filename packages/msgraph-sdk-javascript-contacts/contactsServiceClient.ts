 ...
 */
export function newContactsServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContactsServiceClient>(requestAdapter, pathParameters, ContactsServiceClientUriTemplate, ContactsServiceClientNavigationMetadata, undefined);
}
/**
