...
import { createPermissionGrantConditionSetFromDiscriminatorValue, serializePermissionGrantConditionSet, type PermissionGrantConditionSet } from 'policies/models/';
 ...
 */
export const PermissionGrantConditionSetItemRequestBuilderUriTemplate = "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/excludes/{permissionGrantConditionSet%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
