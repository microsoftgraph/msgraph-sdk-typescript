 ...
 */
export const AuthenticationMethodConfigurationItemRequestBuilderUriTemplate = "{+baseurl}/authenticationMethodConfigurations/{authenticationMethodConfiguration%2Did}";
/**
...
export const AuthenticationMethodConfigurationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/authenticationMethodConfigurations/{authenticationMethodConfiguration%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
