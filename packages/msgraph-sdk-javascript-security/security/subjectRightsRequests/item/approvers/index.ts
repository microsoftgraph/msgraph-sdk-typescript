...
import { createUserCollectionResponseFromDiscriminatorValue, type UserCollectionResponse } from 'security/models/';
 ...
 */
export const ApproversRequestBuilderUriTemplate = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/approvers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
