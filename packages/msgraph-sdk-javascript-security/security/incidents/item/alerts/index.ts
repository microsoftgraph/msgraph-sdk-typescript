...
import { createAlertCollectionResponseFromDiscriminatorValue, type AlertCollectionResponse } from 'security/models/security/';
 ...
 */
export const AlertsRequestBuilderUriTemplate = "{+baseurl}/security/incidents/{incident%2Did}/alerts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
