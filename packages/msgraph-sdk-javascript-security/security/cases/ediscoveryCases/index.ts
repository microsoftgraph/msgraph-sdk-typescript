...
import { createEdiscoveryCaseCollectionResponseFromDiscriminatorValue, createEdiscoveryCaseFromDiscriminatorValue, serializeEdiscoveryCase, type EdiscoveryCase, type EdiscoveryCaseCollectionResponse } from 'security/models/security/';
 ...
 */
export const EdiscoveryCasesRequestBuilderUriTemplate = "{+baseurl}/security/cases/ediscoveryCases{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
