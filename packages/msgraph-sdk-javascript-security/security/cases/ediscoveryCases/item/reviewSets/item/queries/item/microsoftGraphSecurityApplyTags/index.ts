...
import { createEdiscoveryReviewTagFromDiscriminatorValue, serializeEdiscoveryReviewTag, type EdiscoveryReviewTag } from '@microsoft/msgraph-sdk-javascript/models/security/';
