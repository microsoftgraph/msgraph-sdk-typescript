...
import { createHostTrackerCollectionResponseFromDiscriminatorValue, type HostTrackerCollectionResponse } from 'security/models/security/';
import { CountRequestBuilderRequestsMetadata, CountRequestBuilderUriTemplate, type CountRequestBuilder } from './count/';
import { HostTrackerItemRequestBuilderRequestsMetadata, HostTrackerItemRequestBuilderUriTemplate, type HostTrackerItemRequestBuilder } from './item/';
 ...
 */
export const TrackersRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/trackers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
