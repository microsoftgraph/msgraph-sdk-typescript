...
import { createArticleCollectionResponseFromDiscriminatorValue, createArticleFromDiscriminatorValue, serializeArticle, type Article, type ArticleCollectionResponse } from '@microsoft/msgraph-sdk-javascript/models/security/';
