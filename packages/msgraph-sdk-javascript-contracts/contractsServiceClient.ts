...
export function newContractsServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ContractsServiceClient>(requestAdapter, pathParameters, ContractsServiceClientUriTemplate, ContractsServiceClientNavigationMetadata, undefined);
}
/**
