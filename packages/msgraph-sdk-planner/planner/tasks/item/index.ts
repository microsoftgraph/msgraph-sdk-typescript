 ...
 */
export const PlannerTaskItemRequestBuilderUriTemplate = "{+baseurl}/planner/tasks/{plannerTask%2Did}";
/**
...
export const PlannerTaskItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/planner/tasks/{plannerTask%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
