 ...
 */
export const DetailsRequestBuilderUriTemplate = "{+baseurl}/planner/plans/{plannerPlan%2Did}/details";
/**
...
export const DetailsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/planner/plans/{plannerPlan%2Did}/details{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
