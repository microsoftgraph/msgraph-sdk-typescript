...
// @ts-ignore
import { createPlannerTaskDetailsFromDiscriminatorValue, serializePlannerTaskDetails, type PlannerTaskDetails } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DetailsRequestBuilderUriTemplate = "{+baseurl}/planner/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/details";
/**
...
export const DetailsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/planner/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/details{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
