 ...
 */
export const TimeOffReasonItemRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons/{timeOffReason%2Did}";
/**
...
export const TimeOffReasonItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons/{timeOffReason%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
