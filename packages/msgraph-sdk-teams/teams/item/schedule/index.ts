...
export interface ScheduleRequestBuilder extends BaseRequestBuilder<ScheduleRequestBuilder> {
     ...
     * @returns {Promise<Schedule>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/team-put-schedule?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const ScheduleRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/schedule";
/**
...
export const ScheduleRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/teams/{team%2Did}/schedule{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
