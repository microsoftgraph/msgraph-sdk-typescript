 ...
 */
export const OpenShiftItemRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/schedule/openShifts/{openShift%2Did}";
/**
...
export const OpenShiftItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/teams/{team%2Did}/schedule/openShifts/{openShift%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
