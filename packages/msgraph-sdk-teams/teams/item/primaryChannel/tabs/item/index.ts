 ...
 */
export const TeamsTabItemRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/primaryChannel/tabs/{teamsTab%2Did}";
/**
...
export const TeamsTabItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/teams/{team%2Did}/primaryChannel/tabs/{teamsTab%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
