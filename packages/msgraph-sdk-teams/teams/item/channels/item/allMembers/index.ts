...
export interface AllMembersRequestBuilder extends BaseRequestBuilder<AllMembersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/channel-list-allmembers?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const AllMembersRequestBuilderUriTemplate = "";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const AllMembersRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "count": "%24count",
    "expand": "%24expand",
    "filter": "%24filter",
    "orderby": "%24orderby",
 ...
 */
export const AllMembersRequestBuilderNavigationMetadata: Record<Exclude<keyof AllMembersRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
 ...
 */
export const AllMembersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/allMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/allMembers",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
