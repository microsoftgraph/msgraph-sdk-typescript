...
export function createGroupSettingsServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<GroupSettingsServiceClient>(requestAdapter, pathParameters, GroupSettingsServiceClientUriTemplate, GroupSettingsServiceClientNavigationMetadata, undefined);
}
/**
