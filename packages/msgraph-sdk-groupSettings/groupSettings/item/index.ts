...
// @ts-ignore
import { createGroupSettingFromDiscriminatorValue, serializeGroupSetting, type GroupSetting } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const GroupSettingItemRequestBuilderUriTemplate = "{+baseurl}/groupSettings/{groupSetting%2Did}";
/**
...
export const GroupSettingItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groupSettings/{groupSetting%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
