 ...
 * @param StDevAPostRequestBody The instance to deserialize into.
...
export function deserializeIntoStDevAPostRequestBody(stDevAPostRequestBody: Partial<StDevAPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "values": n => { stDevAPostRequestBody.values = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param StDevAPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeStDevAPostRequestBody(writer: SerializationWriter, stDevAPostRequestBody: Partial<StDevAPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!stDevAPostRequestBody || isSerializingDerivedType) { return; }
