 ...
 * @param T_InvPostRequestBody The instance to deserialize into.
...
export function deserializeIntoT_InvPostRequestBody(t_InvPostRequestBody: Partial<T_InvPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "degFreedom": n => { t_InvPostRequestBody.degFreedom = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "probability": n => { t_InvPostRequestBody.probability = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param T_InvPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeT_InvPostRequestBody(writer: SerializationWriter, t_InvPostRequestBody: Partial<T_InvPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!t_InvPostRequestBody || isSerializingDerivedType) { return; }
