 ...
 * @param CoupDaysPostRequestBody The instance to deserialize into.
 ...
 * @param CoupDaysPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeCoupDaysPostRequestBody(writer: SerializationWriter, coupDaysPostRequestBody: Partial<CoupDaysPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!coupDaysPostRequestBody || isSerializingDerivedType) { return; }
