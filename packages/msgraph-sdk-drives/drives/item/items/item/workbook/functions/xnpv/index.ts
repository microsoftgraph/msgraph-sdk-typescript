 ...
 * @param XnpvPostRequestBody The instance to deserialize into.
...
export function deserializeIntoXnpvPostRequestBody(xnpvPostRequestBody: Partial<XnpvPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "dates": n => { xnpvPostRequestBody.dates = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "rate": n => { xnpvPostRequestBody.rate = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "values": n => { xnpvPostRequestBody.values = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
 ...
 * @param XnpvPostRequestBody The instance to serialize from.
 */
// @ts-ignore
export function serializeXnpvPostRequestBody(writer: SerializationWriter, xnpvPostRequestBody: Partial<XnpvPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!xnpvPostRequestBody || isSerializingDerivedType) { return; }
