 ...
 * @param DbcsPostRequestBody The instance to deserialize into.
 ...
 * @param DbcsPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeDbcsPostRequestBody(writer: SerializationWriter, dbcsPostRequestBody: Partial<DbcsPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!dbcsPostRequestBody || isSerializingDerivedType) { return; }
