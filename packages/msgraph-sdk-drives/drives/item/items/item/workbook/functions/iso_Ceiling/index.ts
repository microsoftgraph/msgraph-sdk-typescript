...
export function deserializeIntoIso_CeilingPostRequestBody(iso_CeilingPostRequestBody: Partial<Iso_CeilingPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "number": n => { iso_CeilingPostRequestBody.number = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "significance": n => { iso_CeilingPostRequestBody.significance = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
