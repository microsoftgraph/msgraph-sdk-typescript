...
export function deserializeIntoDcountAPostRequestBody(dcountAPostRequestBody: Partial<DcountAPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "criteria": n => { dcountAPostRequestBody.criteria = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "database": n => { dcountAPostRequestBody.database = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "field": n => { dcountAPostRequestBody.field = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
