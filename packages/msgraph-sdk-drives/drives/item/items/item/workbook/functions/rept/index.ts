 ...
 * @param ReptPostRequestBody The instance to deserialize into.
 ...
 * @param ReptPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeReptPostRequestBody(writer: SerializationWriter, reptPostRequestBody: Partial<ReptPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!reptPostRequestBody || isSerializingDerivedType) { return; }
