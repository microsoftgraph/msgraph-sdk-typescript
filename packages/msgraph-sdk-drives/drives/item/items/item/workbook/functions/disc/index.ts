...
export function deserializeIntoDiscPostRequestBody(discPostRequestBody: Partial<DiscPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "basis": n => { discPostRequestBody.basis = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "maturity": n => { discPostRequestBody.maturity = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "pr": n => { discPostRequestBody.pr = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "redemption": n => { discPostRequestBody.redemption = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "settlement": n => { discPostRequestBody.settlement = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
