...
export function deserializeIntoGammaLnPostRequestBody(gammaLnPostRequestBody: Partial<GammaLnPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "x": n => { gammaLnPostRequestBody.x = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
export interface GammaLnPostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
    /**
