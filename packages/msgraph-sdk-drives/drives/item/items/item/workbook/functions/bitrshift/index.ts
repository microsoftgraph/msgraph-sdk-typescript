 ...
 */
// @ts-ignore
export function serializeBitrshiftPostRequestBody(writer: SerializationWriter, bitrshiftPostRequestBody: Partial<BitrshiftPostRequestBody> | undefined | null = {}) : void {
    if (bitrshiftPostRequestBody) {
