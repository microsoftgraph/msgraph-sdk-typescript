...
export function deserializeIntoOct2BinPostRequestBody(oct2BinPostRequestBody: Partial<Oct2BinPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "number": n => { oct2BinPostRequestBody.number = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "places": n => { oct2BinPostRequestBody.places = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
