 ...
 * @param SlnPostRequestBody The instance to deserialize into.
 ...
 * @param SlnPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeSlnPostRequestBody(writer: SerializationWriter, slnPostRequestBody: Partial<SlnPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!slnPostRequestBody || isSerializingDerivedType) { return; }
