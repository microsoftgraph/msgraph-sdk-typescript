...
export function deserializeIntoDollarPostRequestBody(dollarPostRequestBody: Partial<DollarPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "decimals": n => { dollarPostRequestBody.decimals = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "number": n => { dollarPostRequestBody.number = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
