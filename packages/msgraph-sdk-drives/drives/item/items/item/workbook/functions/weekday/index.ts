 ...
 * @param WeekdayPostRequestBody The instance to deserialize into.
 ...
 * @param WeekdayPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeWeekdayPostRequestBody(writer: SerializationWriter, weekdayPostRequestBody: Partial<WeekdayPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!weekdayPostRequestBody || isSerializingDerivedType) { return; }
