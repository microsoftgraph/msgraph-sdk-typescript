...
export function deserializeIntoLogNorm_InvPostRequestBody(logNorm_InvPostRequestBody: Partial<LogNorm_InvPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "mean": n => { logNorm_InvPostRequestBody.mean = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "probability": n => { logNorm_InvPostRequestBody.probability = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "standardDev": n => { logNorm_InvPostRequestBody.standardDev = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
