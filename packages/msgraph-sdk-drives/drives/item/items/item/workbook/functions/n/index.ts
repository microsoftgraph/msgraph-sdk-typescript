 ...
 * @param NPostRequestBody The instance to deserialize into.
 ...
 * @param NPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeNPostRequestBody(writer: SerializationWriter, nPostRequestBody: Partial<NPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!nPostRequestBody || isSerializingDerivedType) { return; }
