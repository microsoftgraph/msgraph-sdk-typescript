...
export function deserializeIntoModPostRequestBody(modPostRequestBody: Partial<ModPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "divisor": n => { modPostRequestBody.divisor = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "number": n => { modPostRequestBody.number = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
