 ...
 * @param ApplyValuesFilterPostRequestBody The instance to deserialize into.
 ...
 * @param ApplyValuesFilterPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeApplyValuesFilterPostRequestBody(writer: SerializationWriter, applyValuesFilterPostRequestBody: Partial<ApplyValuesFilterPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!applyValuesFilterPostRequestBody || isSerializingDerivedType) { return; }
