 ...
 */
export const HeaderRowRangeRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/headerRowRange()";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const HeaderRowRangeRequestBuilderNavigationMetadata: Record<Exclude<keyof HeaderRowRangeRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
