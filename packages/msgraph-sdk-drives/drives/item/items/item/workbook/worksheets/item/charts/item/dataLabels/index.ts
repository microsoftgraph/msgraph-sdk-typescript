...
// @ts-ignore
import { createWorkbookChartDataLabelsFromDiscriminatorValue, serializeWorkbookChartDataLabels, type WorkbookChartDataLabels } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const DataLabelsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/dataLabels{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
