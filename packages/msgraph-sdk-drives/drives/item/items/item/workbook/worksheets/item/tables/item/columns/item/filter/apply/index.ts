...
// @ts-ignore
import { createWorkbookFilterCriteriaFromDiscriminatorValue, serializeWorkbookFilterCriteria, type WorkbookFilterCriteria } from '@microsoft/msgraph-sdk/models/';
// @ts-ignore
