...
// @ts-ignore
import { createWorkbookTableColumnFromDiscriminatorValue, serializeWorkbookTableColumn, type WorkbookTableColumn } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
