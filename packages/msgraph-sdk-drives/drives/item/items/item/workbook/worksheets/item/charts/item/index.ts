...
// @ts-ignore
import { AxesRequestBuilderNavigationMetadata, AxesRequestBuilderRequestsMetadata, type AxesRequestBuilder } from './axes/index.js';
// @ts-ignore
import { DataLabelsRequestBuilderNavigationMetadata, DataLabelsRequestBuilderRequestsMetadata, type DataLabelsRequestBuilder } from './dataLabels/index.js';
// @ts-ignore
...
// @ts-ignore
import { LegendRequestBuilderNavigationMetadata, LegendRequestBuilderRequestsMetadata, type LegendRequestBuilder } from './legend/index.js';
// @ts-ignore
...
export const WorkbookChartItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
