...
// @ts-ignore
import { createWorkbookChartAxesFromDiscriminatorValue, serializeWorkbookChartAxes, type WorkbookChartAxes } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CategoryAxisRequestBuilderNavigationMetadata, CategoryAxisRequestBuilderRequestsMetadata, type CategoryAxisRequestBuilder } from './categoryAxis/index.js';
// @ts-ignore
import { SeriesAxisRequestBuilderNavigationMetadata, SeriesAxisRequestBuilderRequestsMetadata, type SeriesAxisRequestBuilder } from './seriesAxis/index.js';
// @ts-ignore
import { type ValueAxisRequestBuilder, ValueAxisRequestBuilderNavigationMetadata, ValueAxisRequestBuilderRequestsMetadata } from './valueAxis/index.js';
// @ts-ignore
 ...
 */
export const AxesRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes";
/**
...
export const AxesRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
