...
// @ts-ignore
import { createWorkbookWorksheetFromDiscriminatorValue, type WorkbookWorksheet } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const WorksheetRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/totalRowRange()/worksheet{?%24expand,%24select}";
/**
