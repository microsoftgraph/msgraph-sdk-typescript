...
// @ts-ignore
import { createWorkbookFromDiscriminatorValue, serializeWorkbook, type Workbook } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { CloseSessionRequestBuilderRequestsMetadata, type CloseSessionRequestBuilder } from './closeSession/index.js';
// @ts-ignore
...
// @ts-ignore
import { CreateSessionRequestBuilderRequestsMetadata, type CreateSessionRequestBuilder } from './createSession/index.js';
// @ts-ignore
...
// @ts-ignore
import { RefreshSessionRequestBuilderRequestsMetadata, type RefreshSessionRequestBuilder } from './refreshSession/index.js';
// @ts-ignore
import { SessionInfoResourceWithKeyRequestBuilderRequestsMetadata, type SessionInfoResourceWithKeyRequestBuilder } from './sessionInfoResourceWithKey/index.js';
// @ts-ignore
import { TableRowOperationResultWithKeyRequestBuilderRequestsMetadata, type TableRowOperationResultWithKeyRequestBuilder } from './tableRowOperationResultWithKey/index.js';
// @ts-ignore
...
// @ts-ignore
import { type WorksheetsRequestBuilder, WorksheetsRequestBuilderNavigationMetadata, WorksheetsRequestBuilderRequestsMetadata } from './worksheets/index.js';
// @ts-ignore
 ...
 */
export const WorkbookRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook";
/**
...
export const WorkbookRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
