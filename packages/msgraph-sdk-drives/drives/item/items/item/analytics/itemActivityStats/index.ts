...
// @ts-ignore
import { createItemActivityStatCollectionResponseFromDiscriminatorValue, createItemActivityStatFromDiscriminatorValue, serializeItemActivityStat, type ItemActivityStat, type ItemActivityStatCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ItemActivityStatItemRequestBuilderNavigationMetadata, ItemActivityStatItemRequestBuilderRequestsMetadata, type ItemActivityStatItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const ItemActivityStatsRequestBuilderUriTemplate = "";
/**
...
export const ItemActivityStatsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/itemActivityStats{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/itemActivityStats",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
