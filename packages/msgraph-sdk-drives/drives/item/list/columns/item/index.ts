 ...
 */
export const ColumnDefinitionItemRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/columns/{columnDefinition%2Did}";
/**
...
export const ColumnDefinitionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/list/columns/{columnDefinition%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
