 ...
 */
export const SubscriptionItemRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}";
/**
...
export const SubscriptionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
