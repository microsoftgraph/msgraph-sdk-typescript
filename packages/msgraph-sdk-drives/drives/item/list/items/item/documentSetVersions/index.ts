...
// @ts-ignore
import { createDocumentSetVersionCollectionResponseFromDiscriminatorValue, createDocumentSetVersionFromDiscriminatorValue, serializeDocumentSetVersion, type DocumentSetVersion, type DocumentSetVersionCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { DocumentSetVersionItemRequestBuilderNavigationMetadata, DocumentSetVersionItemRequestBuilderRequestsMetadata, type DocumentSetVersionItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const DocumentSetVersionsRequestBuilderUriTemplate = "";
/**
...
export const DocumentSetVersionsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
