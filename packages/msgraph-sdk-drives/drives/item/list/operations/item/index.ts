 ...
 */
export const RichLongRunningOperationItemRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/operations/{richLongRunningOperation%2Did}";
/**
...
export const RichLongRunningOperationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/drives/{drive%2Did}/list/operations/{richLongRunningOperation%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
