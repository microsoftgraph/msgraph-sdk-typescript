 ...
 */
export function newAgreementsServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AgreementsServiceClient>(requestAdapter, pathParameters, AgreementsServiceClientUriTemplate, AgreementsServiceClientNavigationMetadata, undefined);
}
/**
