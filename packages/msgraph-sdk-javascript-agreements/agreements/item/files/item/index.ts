 ...
 */
export const AgreementFileLocalizationItemRequestBuilderUriTemplate = "{+baseurl}/agreements/{agreement%2Did}/files/{agreementFileLocalization%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
