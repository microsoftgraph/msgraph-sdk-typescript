...
// @ts-ignore
import { createTeamworkBotFromDiscriminatorValue, serializeTeamworkBot, type TeamworkBot } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const BotRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/appCatalogs/teamsApps/{teamsApp%2Did}/appDefinitions/{teamsAppDefinition%2Did}/bot{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
