...
// @ts-ignore
import { createProvisioningObjectSummaryCollectionResponseFromDiscriminatorValue, createProvisioningObjectSummaryFromDiscriminatorValue, serializeProvisioningObjectSummary, type ProvisioningObjectSummary, type ProvisioningObjectSummaryCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ProvisioningRequestBuilderUriTemplate = "";
/**
...
export const ProvisioningRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/auditLogs/provisioning{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/auditLogs/provisioning",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
