...
// @ts-ignore
import { createProvisioningObjectSummaryFromDiscriminatorValue, serializeProvisioningObjectSummary, type ProvisioningObjectSummary } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ProvisioningObjectSummaryItemRequestBuilderUriTemplate = "{+baseurl}/auditLogs/provisioning/{provisioningObjectSummary%2Did}";
/**
...
export const ProvisioningObjectSummaryItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/auditLogs/provisioning/{provisioningObjectSummary%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
