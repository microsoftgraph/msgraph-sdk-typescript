...
// @ts-ignore
import { createDirectoryAuditCollectionResponseFromDiscriminatorValue, createDirectoryAuditFromDiscriminatorValue, serializeDirectoryAudit, type DirectoryAudit, type DirectoryAuditCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { DirectoryAuditItemRequestBuilderRequestsMetadata, type DirectoryAuditItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const DirectoryAuditsRequestBuilderUriTemplate = "";
/**
...
export const DirectoryAuditsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/auditLogs/directoryAudits{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/auditLogs/directoryAudits",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
