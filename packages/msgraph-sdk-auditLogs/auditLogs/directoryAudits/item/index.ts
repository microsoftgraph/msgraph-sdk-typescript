...
// @ts-ignore
import { createDirectoryAuditFromDiscriminatorValue, serializeDirectoryAudit, type DirectoryAudit } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DirectoryAuditItemRequestBuilderUriTemplate = "{+baseurl}/auditLogs/directoryAudits/{directoryAudit%2Did}";
/**
...
export const DirectoryAuditItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/auditLogs/directoryAudits/{directoryAudit%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
