...
// @ts-ignore
import { createIdentityUserFlowAttributeFromDiscriminatorValue, serializeIdentityUserFlowAttribute, type IdentityUserFlowAttribute } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const IdentityUserFlowAttributeItemRequestBuilderUriTemplate = "{+baseurl}/identity/userFlowAttributes/{identityUserFlowAttribute%2Did}";
/**
...
export const IdentityUserFlowAttributeItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identity/userFlowAttributes/{identityUserFlowAttribute%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
