...
// @ts-ignore
import { createIdentityProviderBaseCollectionResponseFromDiscriminatorValue, createIdentityProviderBaseFromDiscriminatorValue, serializeIdentityProviderBase, type IdentityProviderBase, type IdentityProviderBaseCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { AvailableProviderTypesRequestBuilderRequestsMetadata, type AvailableProviderTypesRequestBuilder } from './availableProviderTypes/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { IdentityProviderBaseItemRequestBuilderRequestsMetadata, type IdentityProviderBaseItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const IdentityProvidersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/identity/identityProviders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/identity/identityProviders",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
