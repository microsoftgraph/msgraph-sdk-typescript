 ...
 */
export const NamedLocationItemRequestBuilderUriTemplate = "{+baseurl}/identity/conditionalAccess/namedLocations/{namedLocation%2Did}";
/**
...
export const NamedLocationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identity/conditionalAccess/namedLocations/{namedLocation%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
