...
// @ts-ignore
import { createOnAuthenticationMethodLoadStartHandlerFromDiscriminatorValue, type OnAuthenticationMethodLoadStartHandler } from '@microsoft/msgraph-sdk/models/';
// @ts-ignore
