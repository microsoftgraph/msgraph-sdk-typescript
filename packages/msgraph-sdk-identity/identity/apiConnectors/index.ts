...
// @ts-ignore
import { createIdentityApiConnectorCollectionResponseFromDiscriminatorValue, createIdentityApiConnectorFromDiscriminatorValue, serializeIdentityApiConnector, type IdentityApiConnector, type IdentityApiConnectorCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { IdentityApiConnectorItemRequestBuilderNavigationMetadata, IdentityApiConnectorItemRequestBuilderRequestsMetadata, type IdentityApiConnectorItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const ApiConnectorsRequestBuilderUriTemplate = "";
/**
...
export const ApiConnectorsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/identity/apiConnectors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/identity/apiConnectors",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
