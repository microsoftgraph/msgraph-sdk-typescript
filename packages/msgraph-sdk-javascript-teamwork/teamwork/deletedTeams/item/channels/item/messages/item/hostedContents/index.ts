...
import { createChatMessageHostedContentCollectionResponseFromDiscriminatorValue, createChatMessageHostedContentFromDiscriminatorValue, serializeChatMessageHostedContent, type ChatMessageHostedContent, type ChatMessageHostedContentCollectionResponse } from 'teamwork/models/';
 ...
 */
export const HostedContentsRequestBuilderUriTemplate = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
