 ...
 */
export const EducationRubricItemRequestBuilderUriTemplate = "{+baseurl}/education/users/{educationUser%2Did}/rubrics/{educationRubric%2Did}";
/**
...
export const EducationRubricItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/education/users/{educationUser%2Did}/rubrics/{educationRubric%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
