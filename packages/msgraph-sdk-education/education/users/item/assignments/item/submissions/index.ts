...
// @ts-ignore
import { createEducationSubmissionCollectionResponseFromDiscriminatorValue, createEducationSubmissionFromDiscriminatorValue, serializeEducationSubmission, type EducationSubmission, type EducationSubmissionCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { EducationSubmissionItemRequestBuilderNavigationMetadata, EducationSubmissionItemRequestBuilderRequestsMetadata, type EducationSubmissionItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const SubmissionsRequestBuilderUriTemplate = "";
/**
...
export const SubmissionsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
