...
// @ts-ignore
import { createEducationUserFromDiscriminatorValue, serializeEducationUser, type EducationUser } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const EducationUserItemRequestBuilderUriTemplate = "{+baseurl}/education/users/{educationUser%2Did}";
/**
...
export const EducationUserItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/education/users/{educationUser%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
