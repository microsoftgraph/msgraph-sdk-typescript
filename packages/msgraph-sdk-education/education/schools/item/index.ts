...
// @ts-ignore
import { createEducationSchoolFromDiscriminatorValue, serializeEducationSchool, type EducationSchool } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const EducationSchoolItemRequestBuilderUriTemplate = "{+baseurl}/education/schools/{educationSchool%2Did}";
/**
...
export const EducationSchoolItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/education/schools/{educationSchool%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
