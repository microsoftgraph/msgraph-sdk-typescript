 ...
 */
export const SpeakerAssignmentSubmissionItemRequestBuilderUriTemplate = "{+baseurl}/education/reports/speakerAssignmentSubmissions/{speakerAssignmentSubmission%2Did}";
/**
...
export const SpeakerAssignmentSubmissionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/education/reports/speakerAssignmentSubmissions/{speakerAssignmentSubmission%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
