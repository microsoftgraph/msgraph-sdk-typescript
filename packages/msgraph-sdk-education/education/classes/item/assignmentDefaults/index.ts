...
// @ts-ignore
import { createEducationAssignmentDefaultsFromDiscriminatorValue, serializeEducationAssignmentDefaults, type EducationAssignmentDefaults } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const AssignmentDefaultsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/education/classes/{educationClass%2Did}/assignmentDefaults{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
