...
// @ts-ignore
import { createEducationAssignmentCollectionResponseFromDiscriminatorValue, createEducationAssignmentFromDiscriminatorValue, serializeEducationAssignment, type EducationAssignment, type EducationAssignmentCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { EducationAssignmentItemRequestBuilderNavigationMetadata, EducationAssignmentItemRequestBuilderRequestsMetadata, type EducationAssignmentItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const AssignmentsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/education/classes/{educationClass%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/education/classes/{educationClass%2Did}/assignments",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
