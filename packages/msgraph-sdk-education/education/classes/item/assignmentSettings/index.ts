...
import { createEducationAssignmentSettingsFromDiscriminatorValue, serializeEducationAssignmentSettings, type EducationAssignmentSettings } from '@microsoft/msgraph-sdk/models/';
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/';
import { GradingCategoriesRequestBuilderNavigationMetadata, GradingCategoriesRequestBuilderRequestsMetadata, type GradingCategoriesRequestBuilder } from './gradingCategories/';
...
export const GetSelectQueryParameterTypeObject = {
    Id: "id",
    SubmissionAnimationDisabled: "submissionAnimationDisabled",
    GradingCategories: "gradingCategories",
} as const;
/* tslint:enable */
/* eslint-enable */
