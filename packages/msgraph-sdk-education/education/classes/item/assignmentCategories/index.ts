...
// @ts-ignore
import { createEducationCategoryCollectionResponseFromDiscriminatorValue, createEducationCategoryFromDiscriminatorValue, serializeEducationCategory, type EducationCategory, type EducationCategoryCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { EducationCategoryItemRequestBuilderRequestsMetadata, type EducationCategoryItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const AssignmentCategoriesRequestBuilderUriTemplate = "";
/**
...
export const AssignmentCategoriesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/education/classes/{educationClass%2Did}/assignmentCategories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/education/classes/{educationClass%2Did}/assignmentCategories",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
