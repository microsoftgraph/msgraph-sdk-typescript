...
// @ts-ignore
import { createEducationCategoryFromDiscriminatorValue, serializeEducationCategory, type EducationCategory } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const EducationCategoryItemRequestBuilderUriTemplate = "{+baseurl}/education/classes/{educationClass%2Did}/assignmentCategories/{educationCategory%2Did}";
/**
...
export const EducationCategoryItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/education/classes/{educationClass%2Did}/assignmentCategories/{educationCategory%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
