...
// @ts-ignore
import { createEducationClassFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeEducationClass, type BaseDeltaFunctionResponse, type EducationClass } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/education/classes/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
