...
// @ts-ignore
import { createInternalDomainFederationCollectionResponseFromDiscriminatorValue, createInternalDomainFederationFromDiscriminatorValue, serializeInternalDomainFederation, type InternalDomainFederation, type InternalDomainFederationCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { InternalDomainFederationItemRequestBuilderRequestsMetadata, type InternalDomainFederationItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const FederationConfigurationRequestBuilderUriTemplate = "";
/**
...
export const FederationConfigurationRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/domains/{domain%2Did}/federationConfiguration{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/domains/{domain%2Did}/federationConfiguration",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
