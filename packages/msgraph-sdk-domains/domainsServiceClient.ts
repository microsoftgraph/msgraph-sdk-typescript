...
export function createDomainsServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DomainsServiceClient>(requestAdapter, pathParameters, DomainsServiceClientUriTemplate, DomainsServiceClientNavigationMetadata, undefined);
}
/**
