...
// @ts-ignore
import { createMultiTenantOrganizationIdentitySyncPolicyTemplateFromDiscriminatorValue, serializeMultiTenantOrganizationIdentitySyncPolicyTemplate, type MultiTenantOrganizationIdentitySyncPolicyTemplate } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const MultiTenantOrganizationIdentitySynchronizationRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/crossTenantAccessPolicy/templates/multiTenantOrganizationIdentitySynchronization{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
