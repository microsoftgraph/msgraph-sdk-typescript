...
// @ts-ignore
import { createCrossTenantAccessPolicyConfigurationDefaultFromDiscriminatorValue, serializeCrossTenantAccessPolicyConfigurationDefault, type CrossTenantAccessPolicyConfigurationDefault } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const DefaultRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/crossTenantAccessPolicy/default{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
