...
// @ts-ignore
import { createCrossTenantAccessPolicyFromDiscriminatorValue, serializeCrossTenantAccessPolicy, type CrossTenantAccessPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const CrossTenantAccessPolicyRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/crossTenantAccessPolicy{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
