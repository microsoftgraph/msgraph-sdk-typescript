...
// @ts-ignore
import { createClaimsMappingPolicyFromDiscriminatorValue, serializeClaimsMappingPolicy, type ClaimsMappingPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const ClaimsMappingPolicyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/claimsMappingPolicies/{claimsMappingPolicy%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
