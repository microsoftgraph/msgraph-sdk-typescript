 ...
 */
export const DirectoryObjectItemRequestBuilderUriTemplate = "{+baseurl}/policies/claimsMappingPolicies/{claimsMappingPolicy%2Did}/appliesTo/{directoryObject%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
