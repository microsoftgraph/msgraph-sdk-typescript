...
// @ts-ignore
import { createPermissionGrantPolicyCollectionResponseFromDiscriminatorValue, createPermissionGrantPolicyFromDiscriminatorValue, serializePermissionGrantPolicy, type PermissionGrantPolicy, type PermissionGrantPolicyCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
