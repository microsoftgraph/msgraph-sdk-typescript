 ...
 */
export const ConditionalAccessPolicyItemRequestBuilderUriTemplate = "{+baseurl}/policies/conditionalAccessPolicies/{conditionalAccessPolicy%2Did}";
/**
...
export const ConditionalAccessPolicyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/conditionalAccessPolicies/{conditionalAccessPolicy%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
