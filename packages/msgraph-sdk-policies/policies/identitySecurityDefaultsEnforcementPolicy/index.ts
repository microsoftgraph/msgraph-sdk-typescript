...
// @ts-ignore
import { createIdentitySecurityDefaultsEnforcementPolicyFromDiscriminatorValue, serializeIdentitySecurityDefaultsEnforcementPolicy, type IdentitySecurityDefaultsEnforcementPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const IdentitySecurityDefaultsEnforcementPolicyRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/identitySecurityDefaultsEnforcementPolicy{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
