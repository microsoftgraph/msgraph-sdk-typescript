...
// @ts-ignore
import { createAuthenticationFlowsPolicyFromDiscriminatorValue, serializeAuthenticationFlowsPolicy, type AuthenticationFlowsPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AuthenticationFlowsPolicyRequestBuilderUriTemplate = "{+baseurl}/policies/authenticationFlowsPolicy";
/**
...
export const AuthenticationFlowsPolicyRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/authenticationFlowsPolicy{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
