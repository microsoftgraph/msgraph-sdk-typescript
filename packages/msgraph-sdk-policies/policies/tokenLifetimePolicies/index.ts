...
// @ts-ignore
import { createTokenLifetimePolicyCollectionResponseFromDiscriminatorValue, createTokenLifetimePolicyFromDiscriminatorValue, serializeTokenLifetimePolicy, type TokenLifetimePolicy, type TokenLifetimePolicyCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { TokenLifetimePolicyItemRequestBuilderNavigationMetadata, TokenLifetimePolicyItemRequestBuilderRequestsMetadata, type TokenLifetimePolicyItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const TokenLifetimePoliciesRequestBuilderUriTemplate = "";
/**
...
export const TokenLifetimePoliciesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/policies/tokenLifetimePolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/policies/tokenLifetimePolicies",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
