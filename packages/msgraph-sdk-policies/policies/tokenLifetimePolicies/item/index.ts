...
// @ts-ignore
import { createTokenLifetimePolicyFromDiscriminatorValue, serializeTokenLifetimePolicy, type TokenLifetimePolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TokenLifetimePolicyItemRequestBuilderUriTemplate = "{+baseurl}/policies/tokenLifetimePolicies/{tokenLifetimePolicy%2Did}";
/**
...
export const TokenLifetimePolicyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/tokenLifetimePolicies/{tokenLifetimePolicy%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
