...
// @ts-ignore
import { createAdminConsentRequestPolicyFromDiscriminatorValue, serializeAdminConsentRequestPolicy, type AdminConsentRequestPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AdminConsentRequestPolicyRequestBuilderUriTemplate = "{+baseurl}/policies/adminConsentRequestPolicy";
/**
...
export const AdminConsentRequestPolicyRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/adminConsentRequestPolicy{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
