...
// @ts-ignore
import { createHomeRealmDiscoveryPolicyFromDiscriminatorValue, serializeHomeRealmDiscoveryPolicy, type HomeRealmDiscoveryPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const HomeRealmDiscoveryPolicyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicy%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
