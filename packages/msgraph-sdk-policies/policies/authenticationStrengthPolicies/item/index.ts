...
// @ts-ignore
import { createAuthenticationStrengthPolicyFromDiscriminatorValue, serializeAuthenticationStrengthPolicy, type AuthenticationStrengthPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CombinationConfigurationsRequestBuilderNavigationMetadata, CombinationConfigurationsRequestBuilderRequestsMetadata, type CombinationConfigurationsRequestBuilder } from './combinationConfigurations/index.js';
// @ts-ignore
import { type UpdateAllowedCombinationsRequestBuilder, UpdateAllowedCombinationsRequestBuilderRequestsMetadata } from './updateAllowedCombinations/index.js';
// @ts-ignore
 ...
 */
export const AuthenticationStrengthPolicyItemRequestBuilderUriTemplate = "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}";
/**
...
export const AuthenticationStrengthPolicyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
