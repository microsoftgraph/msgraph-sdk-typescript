...
// @ts-ignore
import { createFeatureRolloutPolicyFromDiscriminatorValue, serializeFeatureRolloutPolicy, type FeatureRolloutPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const FeatureRolloutPolicyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/policies/featureRolloutPolicies/{featureRolloutPolicy%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
