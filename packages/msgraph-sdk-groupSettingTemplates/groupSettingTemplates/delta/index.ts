...
// @ts-ignore
import { createDirectoryObjectFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeDirectoryObject, type BaseDeltaFunctionResponse, type DirectoryObject } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/groupSettingTemplates/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
