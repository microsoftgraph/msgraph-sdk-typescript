...
export function newDirectoryRolesServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DirectoryRolesServiceClient>(requestAdapter, pathParameters, DirectoryRolesServiceClientUriTemplate, DirectoryRolesServiceClientNavigationMetadata, undefined);
}
/**
