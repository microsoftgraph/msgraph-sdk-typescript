...
// @ts-ignore
import { createContentTypeFromDiscriminatorValue, type ContentType } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ContentTypeItemRequestBuilderUriTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/baseTypes/{contentType%2Did1}{?%24expand,%24select}";
/**
