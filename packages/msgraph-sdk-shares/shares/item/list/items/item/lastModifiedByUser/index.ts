 ...
 */
export const LastModifiedByUserRequestBuilderUriTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/lastModifiedByUser{?%24expand,%24select}";
/**
