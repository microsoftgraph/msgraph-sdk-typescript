 ...
 */
export function newDevicesServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DevicesServiceClient>(requestAdapter, pathParameters, DevicesServiceClientUriTemplate, DevicesServiceClientNavigationMetadata, undefined);
}
/**
