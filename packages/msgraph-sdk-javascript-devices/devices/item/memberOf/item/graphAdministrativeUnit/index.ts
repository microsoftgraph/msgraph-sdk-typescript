 ...
 */
export const GraphAdministrativeUnitRequestBuilderUriTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/graph.administrativeUnit{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
