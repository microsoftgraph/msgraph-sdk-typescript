 ...
 */
export const GraphAppRoleAssignmentRequestBuilderUriTemplate = "{+baseurl}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.appRoleAssignment{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
