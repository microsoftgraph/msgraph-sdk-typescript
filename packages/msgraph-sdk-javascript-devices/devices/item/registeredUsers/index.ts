 ...
 */
const RegisteredUsersRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "count": "%24count",
    "expand": "%24expand",
    "filter": "%24filter",
    "orderby": "%24orderby",
 ...
 */
export const RegisteredUsersRequestBuilderNavigationMetadata: Record<Exclude<keyof RegisteredUsersRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byDirectoryObjectId: {
 ...
 */
export const RegisteredUsersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        queryParametersMapper: RegisteredUsersRequestBuilderGetQueryParametersMapper,
    },
};
/**
 * Uri template for the request builder.
 */
export const RegisteredUsersRequestBuilderUriTemplate = "{+baseurl}/devices/{device%2Did}/registeredUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
