 ...
 */
export const GraphAdministrativeUnitRequestBuilderUriTemplate = "{+baseurl}/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}/graph.administrativeUnit{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
