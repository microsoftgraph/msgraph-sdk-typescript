...
// @ts-ignore
import { createSynchronizationFromDiscriminatorValue, serializeSynchronization, type Synchronization } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const SynchronizationRequestBuilderUriTemplate = "{+baseurl}/applications/{application%2Did}/synchronization";
/**
...
export const SynchronizationRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}/synchronization{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
