...
// @ts-ignore
import { createDirectoryDefinitionCollectionResponseFromDiscriminatorValue, createDirectoryDefinitionFromDiscriminatorValue, serializeDirectoryDefinition, type DirectoryDefinition, type DirectoryDefinitionCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { DirectoryDefinitionItemRequestBuilderNavigationMetadata, DirectoryDefinitionItemRequestBuilderRequestsMetadata, type DirectoryDefinitionItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const DirectoriesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
