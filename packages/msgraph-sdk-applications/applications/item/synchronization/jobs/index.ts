...
// @ts-ignore
import { createSynchronizationJobCollectionResponseFromDiscriminatorValue, createSynchronizationJobFromDiscriminatorValue, serializeSynchronizationJob, type SynchronizationJob, type SynchronizationJobCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const JobsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}/synchronization/jobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}/synchronization/jobs",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
