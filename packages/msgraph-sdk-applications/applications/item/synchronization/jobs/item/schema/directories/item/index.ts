...
// @ts-ignore
import { createDirectoryDefinitionFromDiscriminatorValue, serializeDirectoryDefinition, type DirectoryDefinition } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DirectoryDefinitionItemRequestBuilderUriTemplate = "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories/{directoryDefinition%2Did}";
/**
...
export const DirectoryDefinitionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories/{directoryDefinition%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
