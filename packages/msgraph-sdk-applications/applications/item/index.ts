...
// @ts-ignore
import { createApplicationFromDiscriminatorValue, serializeApplication, type Application } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { ExtensionPropertiesRequestBuilderNavigationMetadata, ExtensionPropertiesRequestBuilderRequestsMetadata, type ExtensionPropertiesRequestBuilder } from './extensionProperties/index.js';
// @ts-ignore
...
// @ts-ignore
import { SetVerifiedPublisherRequestBuilderRequestsMetadata, type SetVerifiedPublisherRequestBuilder } from './setVerifiedPublisher/index.js';
// @ts-ignore
...
// @ts-ignore
import { type UnsetVerifiedPublisherRequestBuilder, UnsetVerifiedPublisherRequestBuilderRequestsMetadata } from './unsetVerifiedPublisher/index.js';
// @ts-ignore
...
export const ApplicationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
