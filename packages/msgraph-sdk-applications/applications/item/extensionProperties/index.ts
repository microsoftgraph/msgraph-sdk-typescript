...
// @ts-ignore
import { createExtensionPropertyCollectionResponseFromDiscriminatorValue, createExtensionPropertyFromDiscriminatorValue, serializeExtensionProperty, type ExtensionProperty, type ExtensionPropertyCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ExtensionPropertyItemRequestBuilderRequestsMetadata, type ExtensionPropertyItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const ExtensionPropertiesRequestBuilderUriTemplate = "";
/**
...
export const ExtensionPropertiesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}/extensionProperties{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}/extensionProperties",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
