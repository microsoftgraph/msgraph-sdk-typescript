...
// @ts-ignore
import { createExtensionPropertyFromDiscriminatorValue, serializeExtensionProperty, type ExtensionProperty } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ExtensionPropertyItemRequestBuilderUriTemplate = "{+baseurl}/applications/{application%2Did}/extensionProperties/{extensionProperty%2Did}";
/**
...
export const ExtensionPropertyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/applications/{application%2Did}/extensionProperties/{extensionProperty%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
