...
// @ts-ignore
import { StoreItemRequestBuilderNavigationMetadata, StoreItemRequestBuilderRequestsMetadata, type StoreItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const TermStoresRequestBuilderUriTemplate = "";
/**
...
export const TermStoresRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/sites/{site%2Did}/termStores{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/sites/{site%2Did}/termStores",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
