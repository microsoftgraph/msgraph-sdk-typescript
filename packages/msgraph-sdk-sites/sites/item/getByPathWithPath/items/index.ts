 ...
 */
export const ItemsRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/items{?%24count,%24expand,%24filter,%24search,%24select,%24skip,%24top}";
/**
