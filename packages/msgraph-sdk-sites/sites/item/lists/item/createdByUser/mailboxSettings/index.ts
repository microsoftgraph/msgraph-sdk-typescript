...
export const MailboxSettingsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/createdByUser/mailboxSettings{?%24expand,%24select}",
    ...
    patch: {
        uriTemplate: "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/createdByUser/mailboxSettings",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
