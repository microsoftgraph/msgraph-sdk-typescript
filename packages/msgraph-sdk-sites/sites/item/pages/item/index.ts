...
// @ts-ignore
import { createBaseSitePageFromDiscriminatorValue, serializeBaseSitePage, type BaseSitePage } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const BaseSitePageItemRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}";
/**
...
export const BaseSitePageItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
