...
// @ts-ignore
import { createSubjectRightsRequestCollectionResponseFromDiscriminatorValue, createSubjectRightsRequestFromDiscriminatorValue, serializeSubjectRightsRequest, type SubjectRightsRequest, type SubjectRightsRequestCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { SubjectRightsRequestItemRequestBuilderNavigationMetadata, SubjectRightsRequestItemRequestBuilderRequestsMetadata, type SubjectRightsRequestItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const SubjectRightsRequestsRequestBuilderUriTemplate = "";
/**
...
export const SubjectRightsRequestsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/privacy/subjectRightsRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/privacy/subjectRightsRequests",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
