...
export function createPermissionGrantsServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<PermissionGrantsServiceClient>(requestAdapter, pathParameters, PermissionGrantsServiceClientUriTemplate, PermissionGrantsServiceClientNavigationMetadata, undefined);
}
/**
