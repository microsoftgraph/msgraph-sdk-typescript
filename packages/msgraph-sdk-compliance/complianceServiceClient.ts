...
export function createComplianceServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ComplianceServiceClient>(requestAdapter, pathParameters, ComplianceServiceClientUriTemplate, ComplianceServiceClientNavigationMetadata, undefined);
}
/**
