...
import { createManagedIOSLobAppFromDiscriminatorValue, type ManagedIOSLobApp } from 'deviceAppManagement/models/';
...
export interface GraphManagedIOSLobAppRequestBuilder extends BaseRequestBuilder<GraphManagedIOSLobAppRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<GraphManagedIOSLobAppRequestBuilderGetQueryParameters> | undefined) : Promise<ManagedIOSLobApp | undefined>;
    /**
     * Get the item of type microsoft.graph.mobileApp as microsoft.graph.managedIOSLobApp
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const GraphManagedIOSLobAppRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedIOSLobApp{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
