...
import { createMobileAppContentCollectionResponseFromDiscriminatorValue, createMobileAppContentFromDiscriminatorValue, serializeMobileAppContent, type MobileAppContent, type MobileAppContentCollectionResponse } from 'deviceAppManagement/models/';
 ...
 */
export const ContentVersionsRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsUniversalAppX/contentVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
