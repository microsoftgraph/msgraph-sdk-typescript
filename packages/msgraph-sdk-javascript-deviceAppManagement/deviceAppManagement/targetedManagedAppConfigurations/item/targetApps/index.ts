...
import { createManagedMobileAppFromDiscriminatorValue, serializeManagedMobileApp, TargetedManagedAppGroupType, TargetedManagedAppGroupTypeObject, type ManagedMobileApp } from 'deviceAppManagement/models/';
...
export function deserializeIntoTargetAppsPostRequestBody(targetAppsPostRequestBody: TargetAppsPostRequestBody | undefined = {} as TargetAppsPostRequestBody) : Record<string, (node: ParseNode) => void> {
    return {
        "appGroupType": n => { targetAppsPostRequestBody.appGroupType = n.getEnumValue<TargetedManagedAppGroupType>(TargetedManagedAppGroupTypeObject); },
...
export interface TargetAppsRequestBuilder extends BaseRequestBuilder<TargetAppsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/intune-mam-targetedmanagedappconfiguration-targetapps?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const TargetAppsRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}/targetApps";
/* tslint:enable */
/* eslint-enable */
