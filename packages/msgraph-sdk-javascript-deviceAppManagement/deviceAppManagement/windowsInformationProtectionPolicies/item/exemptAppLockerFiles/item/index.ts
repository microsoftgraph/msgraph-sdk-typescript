...
import { createWindowsInformationProtectionAppLockerFileFromDiscriminatorValue, serializeWindowsInformationProtectionAppLockerFile, type WindowsInformationProtectionAppLockerFile } from 'deviceAppManagement/models/';
 ...
 */
export const WindowsInformationProtectionAppLockerFileItemRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy%2Did}/exemptAppLockerFiles/{windowsInformationProtectionAppLockerFile%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
