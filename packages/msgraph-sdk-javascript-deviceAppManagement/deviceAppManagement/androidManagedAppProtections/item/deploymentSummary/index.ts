 ...
 */
export const DeploymentSummaryRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection%2Did}/deploymentSummary{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
