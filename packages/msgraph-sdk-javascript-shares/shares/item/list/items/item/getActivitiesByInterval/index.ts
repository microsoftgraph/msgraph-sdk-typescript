...
import { createItemActivityStatFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeItemActivityStat, type BaseCollectionPaginationCountResponse, type ItemActivityStat } from 'shares/models/';
 ...
 */
export const GetActivitiesByIntervalRequestBuilderUriTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/getActivitiesByInterval(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
