...
import { createSubscriptionCollectionResponseFromDiscriminatorValue, createSubscriptionFromDiscriminatorValue, serializeSubscription, type Subscription, type SubscriptionCollectionResponse } from 'shares/models/';
 ...
 */
export const SubscriptionsRequestBuilderUriTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
