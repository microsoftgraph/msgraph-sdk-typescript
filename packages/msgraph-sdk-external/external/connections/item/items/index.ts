...
// @ts-ignore
import { createExternalItemCollectionResponseFromDiscriminatorValue, createExternalItemFromDiscriminatorValue, serializeExternalItem, type ExternalItem, type ExternalItemCollectionResponse } from '@microsoft/msgraph-sdk/models/externalConnectors/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ExternalItemItemRequestBuilderNavigationMetadata, ExternalItemItemRequestBuilderRequestsMetadata, type ExternalItemItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const ItemsRequestBuilderUriTemplate = "";
/**
...
export const ItemsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/external/connections/{externalConnection%2Did}/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/external/connections/{externalConnection%2Did}/items",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
