...
// @ts-ignore
import { createExternalGroupCollectionResponseFromDiscriminatorValue, createExternalGroupFromDiscriminatorValue, serializeExternalGroup, type ExternalGroup, type ExternalGroupCollectionResponse } from '@microsoft/msgraph-sdk/models/externalConnectors/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ExternalGroupItemRequestBuilderNavigationMetadata, ExternalGroupItemRequestBuilderRequestsMetadata, type ExternalGroupItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const GroupsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/external/connections/{externalConnection%2Did}/groups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/external/connections/{externalConnection%2Did}/groups",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
