 ...
 */
export const ExternalItemItemRequestBuilderUriTemplate = "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}";
/**
...
export const ExternalItemItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
