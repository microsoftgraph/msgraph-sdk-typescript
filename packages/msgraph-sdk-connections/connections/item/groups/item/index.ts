 ...
 */
export const ExternalGroupItemRequestBuilderUriTemplate = "{+baseurl}/connections/{externalConnection%2Did}/groups/{externalGroup%2Did}";
/**
...
export const ExternalGroupItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/connections/{externalConnection%2Did}/groups/{externalGroup%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
