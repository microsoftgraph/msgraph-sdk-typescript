...
// @ts-ignore
import { createIdentityCollectionResponseFromDiscriminatorValue, createIdentityFromDiscriminatorValue, serializeIdentity, type Identity, type IdentityCollectionResponse } from '@microsoft/msgraph-sdk/models/externalConnectors/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { IdentityItemRequestBuilderRequestsMetadata, type IdentityItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const MembersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/connections/{externalConnection%2Did}/groups/{externalGroup%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/connections/{externalConnection%2Did}/groups/{externalGroup%2Did}/members",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
