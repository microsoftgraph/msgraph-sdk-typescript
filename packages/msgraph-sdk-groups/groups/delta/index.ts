...
// @ts-ignore
import { createGroupFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeGroup, type BaseDeltaFunctionResponse, type Group } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-delta?view=graph-rest-1.0|Find more info here}
     */
