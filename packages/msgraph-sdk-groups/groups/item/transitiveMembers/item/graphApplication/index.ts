 ...
 */
export const GraphApplicationRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/graph.application{?%24expand,%24select}";
/**
