 ...
 */
// @ts-ignore
export function serializeValidatePropertiesPostRequestBody(writer: SerializationWriter, validatePropertiesPostRequestBody: Partial<ValidatePropertiesPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!validatePropertiesPostRequestBody || isSerializingDerivedType) { return; }
...
export interface ValidatePropertiesRequestBuilder extends BaseRequestBuilder<ValidatePropertiesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-validateproperties?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const ValidatePropertiesRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/validateProperties";
/**
