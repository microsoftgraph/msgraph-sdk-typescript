 ...
 */
export const CreateUploadSessionRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/attachments/createUploadSession";
/**
