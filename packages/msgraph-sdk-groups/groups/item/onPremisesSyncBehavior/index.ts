 ...
 */
export const OnPremisesSyncBehaviorRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/onPremisesSyncBehavior";
/**
...
export const OnPremisesSyncBehaviorRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/onPremisesSyncBehavior{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
