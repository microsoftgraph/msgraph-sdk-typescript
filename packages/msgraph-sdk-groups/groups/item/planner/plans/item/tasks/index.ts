...
// @ts-ignore
import { createPlannerTaskCollectionResponseFromDiscriminatorValue, createPlannerTaskFromDiscriminatorValue, serializePlannerTask, type PlannerTask, type PlannerTaskCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PlannerTaskItemRequestBuilderNavigationMetadata, PlannerTaskItemRequestBuilderRequestsMetadata, type PlannerTaskItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const TasksRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
