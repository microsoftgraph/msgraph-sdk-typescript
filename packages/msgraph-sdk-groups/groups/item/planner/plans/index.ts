...
// @ts-ignore
import { createPlannerPlanCollectionResponseFromDiscriminatorValue, createPlannerPlanFromDiscriminatorValue, serializePlannerPlan, type PlannerPlan, type PlannerPlanCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PlannerPlanItemRequestBuilderNavigationMetadata, PlannerPlanItemRequestBuilderRequestsMetadata, type PlannerPlanItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const PlansRequestBuilderUriTemplate = "";
/**
...
export const PlansRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/planner/plans{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/planner/plans",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
