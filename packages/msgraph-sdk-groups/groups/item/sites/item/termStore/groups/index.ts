...
import { createGroupCollectionResponseFromDiscriminatorValue, createGroupFromDiscriminatorValue, serializeGroup, type Group, type GroupCollectionResponse } from '@microsoft/msgraph-sdk/models/termStore/';
...
export const GroupsRequestBuilderNavigationMetadata: Record<Exclude<keyof GroupsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byGroupId1: {
        ...
        pathParametersMappings: ["group%2Did1"],
    },
    count: {
 ...
 */
export const GroupsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/* tslint:enable */
/* eslint-enable */
