...
// @ts-ignore
import { GraphSitePageRequestBuilderNavigationMetadata, GraphSitePageRequestBuilderRequestsMetadata, type GraphSitePageRequestBuilder } from './graphSitePage/index.js';
// @ts-ignore
import { BaseSitePageItemRequestBuilderNavigationMetadata, BaseSitePageItemRequestBuilderRequestsMetadata, type BaseSitePageItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const PagesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
