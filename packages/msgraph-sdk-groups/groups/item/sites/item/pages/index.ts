...
// @ts-ignore
import { createBaseSitePageCollectionResponseFromDiscriminatorValue, createBaseSitePageFromDiscriminatorValue, serializeBaseSitePage, type BaseSitePage, type BaseSitePageCollectionResponse } from '@microsoft/msgraph-sdk/models/';
// @ts-ignore
...
// @ts-ignore
import { BaseSitePageItemRequestBuilderNavigationMetadata, BaseSitePageItemRequestBuilderRequestsMetadata, type BaseSitePageItemRequestBuilder } from './item/';
// @ts-ignore
 ...
 */
export const PagesRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
...
export const PagesRequestBuilderNavigationMetadata: Record<Exclude<keyof PagesRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byBaseSitePageId: {
        requestsMetadata: BaseSitePageItemRequestBuilderRequestsMetadata,
        navigationMetadata: BaseSitePageItemRequestBuilderNavigationMetadata,
        pathParametersMappings: ["baseSitePage%2Did"],
    },
    count: {
