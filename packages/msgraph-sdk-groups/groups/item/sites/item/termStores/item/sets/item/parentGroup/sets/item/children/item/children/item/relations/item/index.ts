...
// @ts-ignore
import { createRelationFromDiscriminatorValue, serializeRelation, type Relation } from '@microsoft/msgraph-sdk/models/termStore/index.js';
// @ts-ignore
import { FromTermRequestBuilderRequestsMetadata, type FromTermRequestBuilder } from './fromTerm/index.js';
// @ts-ignore
import { SetRequestBuilderRequestsMetadata, type SetRequestBuilder } from './set/index.js';
// @ts-ignore
import { ToTermRequestBuilderRequestsMetadata, type ToTermRequestBuilder } from './toTerm/index.js';
// @ts-ignore
 ...
 */
export const RelationItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}";
/**
...
export const RelationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
