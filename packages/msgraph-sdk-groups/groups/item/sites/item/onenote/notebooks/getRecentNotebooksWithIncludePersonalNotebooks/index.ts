...
import { createRecentNotebookFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeRecentNotebook, type BaseCollectionPaginationCountResponse, type RecentNotebook } from '@microsoft/msgraph-sdk/models/';
 ...
 */
export const GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/getRecentNotebooks(includePersonalNotebooks={includePersonalNotebooks}){?%24top,%24skip,%24search,%24filter,%24count}";
/* tslint:enable */
/* eslint-enable */
