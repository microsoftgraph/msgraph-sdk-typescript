...
export const MailboxSettingsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/createdByUser/mailboxSettings{?%24expand,%24select}",
    ...
    patch: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/createdByUser/mailboxSettings",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
