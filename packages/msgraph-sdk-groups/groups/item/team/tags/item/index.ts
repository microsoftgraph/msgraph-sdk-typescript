 ...
 */
export const TeamworkTagItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/team/tags/{teamworkTag%2Did}";
/**
...
export const TeamworkTagItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/tags/{teamworkTag%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
