...
// @ts-ignore
import { createTeamworkTagMemberCollectionResponseFromDiscriminatorValue, createTeamworkTagMemberFromDiscriminatorValue, serializeTeamworkTagMember, type TeamworkTagMember, type TeamworkTagMemberCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { TeamworkTagMemberItemRequestBuilderRequestsMetadata, type TeamworkTagMemberItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const MembersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/tags/{teamworkTag%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/tags/{teamworkTag%2Did}/members",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
