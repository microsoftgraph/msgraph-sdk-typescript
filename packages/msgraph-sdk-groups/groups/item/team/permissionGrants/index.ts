...
// @ts-ignore
import { ResourceSpecificPermissionGrantItemRequestBuilderRequestsMetadata, type ResourceSpecificPermissionGrantItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const PermissionGrantsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/permissionGrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/permissionGrants",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
