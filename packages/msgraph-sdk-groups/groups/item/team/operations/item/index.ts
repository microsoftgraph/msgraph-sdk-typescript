 ...
 */
export const TeamsAsyncOperationItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/team/operations/{teamsAsyncOperation%2Did}";
/**
...
export const TeamsAsyncOperationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/operations/{teamsAsyncOperation%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
