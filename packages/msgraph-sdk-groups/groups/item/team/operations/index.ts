...
import { createTeamsAsyncOperationCollectionResponseFromDiscriminatorValue, createTeamsAsyncOperationFromDiscriminatorValue, serializeTeamsAsyncOperation, type TeamsAsyncOperation, type TeamsAsyncOperationCollectionResponse } from '@microsoft/msgraph-sdk/models/';
 ...
 */
export const OperationsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/team/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
