 ...
 */
export const ConversationMemberItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/members/{conversationMember%2Did}";
/**
...
export const ConversationMemberItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/primaryChannel/members/{conversationMember%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
