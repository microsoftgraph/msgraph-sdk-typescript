 ...
 */
export const ShiftItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/team/schedule/shifts/{shift%2Did}";
/**
...
export const ShiftItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/schedule/shifts/{shift%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
