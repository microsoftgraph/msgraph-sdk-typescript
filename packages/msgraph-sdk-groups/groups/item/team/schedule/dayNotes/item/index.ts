 ...
 */
export const DayNoteItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/team/schedule/dayNotes/{dayNote%2Did}";
/**
...
export const DayNoteItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/schedule/dayNotes/{dayNote%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
