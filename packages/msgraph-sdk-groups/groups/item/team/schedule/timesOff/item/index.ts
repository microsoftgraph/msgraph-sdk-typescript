 ...
 */
export const TimeOffItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/team/schedule/timesOff/{timeOff%2Did}";
/**
...
export const TimeOffItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/team/schedule/timesOff/{timeOff%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
