 ...
 */
export const CalendarPermissionItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/calendar/calendarPermissions/{calendarPermission%2Did}";
/**
...
export const CalendarPermissionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/calendar/calendarPermissions/{calendarPermission%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
