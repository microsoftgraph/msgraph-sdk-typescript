 ...
 * @param SnoozeReminderPostRequestBody The instance to deserialize into.
 ...
 * @param SnoozeReminderPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeSnoozeReminderPostRequestBody(writer: SerializationWriter, snoozeReminderPostRequestBody: Partial<SnoozeReminderPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!snoozeReminderPostRequestBody || isSerializingDerivedType) { return; }
