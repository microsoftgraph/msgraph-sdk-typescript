 ...
 */
export const CreateUploadSessionRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments/createUploadSession";
/**
