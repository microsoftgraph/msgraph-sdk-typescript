...
export const AttachmentItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/attachments/{attachment%2Did}",
    ...
    get: {
        uriTemplate: "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/attachments/{attachment%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
