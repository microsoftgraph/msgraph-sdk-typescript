 ...
 */
export const AcronymItemRequestBuilderUriTemplate = "{+baseurl}/search/acronyms/{acronym%2Did}";
/**
...
export const AcronymItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/search/acronyms/{acronym%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
