...
// @ts-ignore
import { createQnaFromDiscriminatorValue, serializeQna, type Qna } from '@microsoft/msgraph-sdk/models/search/index.js';
// @ts-ignore
 ...
 */
export const QnaItemRequestBuilderUriTemplate = "{+baseurl}/search/qnas/{qna%2Did}";
/**
...
export const QnaItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/search/qnas/{qna%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
