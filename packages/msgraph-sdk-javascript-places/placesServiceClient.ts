 ...
 */
export function newPlacesServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<PlacesServiceClient>(requestAdapter, pathParameters, PlacesServiceClientUriTemplate, PlacesServiceClientNavigationMetadata, undefined);
}
/**
