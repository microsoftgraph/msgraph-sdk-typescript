...
import { createRoomCollectionResponseFromDiscriminatorValue, createRoomFromDiscriminatorValue, serializeRoom, type Room, type RoomCollectionResponse } from '@microsoft/msgraph-sdk-javascript/models/';
 ...
 */
export const RoomsRequestBuilderUriTemplate = "{+baseurl}/places/{place%2Did}/graph.roomList/rooms{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
