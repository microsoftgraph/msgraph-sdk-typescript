...
import { createChatMessageFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeChatMessage, type BaseCollectionPaginationCountResponse, type ChatMessage } from 'chats/models/';
 ...
 */
export const GetAllMessagesRequestBuilderUriTemplate = "{+baseurl}/chats/getAllMessages(){?model*,%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
