...
// @ts-ignore
import { createAgreementFileLocalizationFromDiscriminatorValue, serializeAgreementFileLocalization, type AgreementFileLocalization } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AgreementFileLocalizationItemRequestBuilderUriTemplate = "{+baseurl}/agreements/{agreement%2Did}/file/localizations/{agreementFileLocalization%2Did}";
/**
...
export const AgreementFileLocalizationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/agreements/{agreement%2Did}/file/localizations/{agreementFileLocalization%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
