...
import { createAttendanceRecordCollectionResponseFromDiscriminatorValue, createAttendanceRecordFromDiscriminatorValue, serializeAttendanceRecord, type AttendanceRecord, type AttendanceRecordCollectionResponse } from 'solutions/models/';
 ...
 */
export const AttendanceRecordsRequestBuilderUriTemplate = "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/attendanceReports/{meetingAttendanceReport%2Did}/attendanceRecords{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
