...
import { createIdentityFromDiscriminatorValue, type Identity } from 'external/models/externalConnectors/';
 ...
 */
export const PerformedByRequestBuilderUriTemplate = "{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities/{externalActivity%2Did}/performedBy{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
