...
import { deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, type BaseCollectionPaginationCountResponse } from 'external/models/';
import { createExternalActivityFromDiscriminatorValue, createExternalActivityResultFromDiscriminatorValue, serializeExternalActivity, serializeExternalActivityResult, type ExternalActivity, type ExternalActivityResult } from 'external/models/externalConnectors/';
 ...
 */
export const MicrosoftGraphExternalConnectorsAddActivitiesRequestBuilderUriTemplate = "{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}/microsoft.graph.externalConnectors.addActivities";
/* tslint:enable */
/* eslint-enable */
