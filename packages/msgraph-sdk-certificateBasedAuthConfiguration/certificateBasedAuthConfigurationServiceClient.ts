...
export function createCertificateBasedAuthConfigurationServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CertificateBasedAuthConfigurationServiceClient>(requestAdapter, pathParameters, CertificateBasedAuthConfigurationServiceClientUriTemplate, CertificateBasedAuthConfigurationServiceClientNavigationMetadata, undefined);
}
/**
