 ...
 */
export const RoleDefinitionRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/roleEligibilitySchedules/{unifiedRoleEligibilitySchedule%2Did}/roleDefinition{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
