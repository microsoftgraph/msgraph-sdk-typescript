 ...
 */
export const AppScopeRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/roleEligibilitySchedules/{unifiedRoleEligibilitySchedule%2Did}/appScope{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
