...
// @ts-ignore
import { createSynchronizationTemplateCollectionResponseFromDiscriminatorValue, createSynchronizationTemplateFromDiscriminatorValue, serializeSynchronizationTemplate, type SynchronizationTemplate, type SynchronizationTemplateCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TemplatesRequestBuilderUriTemplate = "";
/**
...
export const TemplatesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
