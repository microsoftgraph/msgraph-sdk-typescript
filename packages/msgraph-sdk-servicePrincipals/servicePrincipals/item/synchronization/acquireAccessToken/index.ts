 ...
 * @param AcquireAccessTokenPostRequestBody The instance to deserialize into.
 ...
 * @param AcquireAccessTokenPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeAcquireAccessTokenPostRequestBody(writer: SerializationWriter, acquireAccessTokenPostRequestBody: Partial<AcquireAccessTokenPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!acquireAccessTokenPostRequestBody || isSerializingDerivedType) { return; }
