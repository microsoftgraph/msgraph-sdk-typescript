...
// @ts-ignore
import { createApplicationFromDiscriminatorValue, type Application } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const GraphApplicationRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/{directoryObject%2Did}/graph.application{?%24expand,%24select}";
/**
