 ...
 */
export const GraphEndpointRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/{directoryObject%2Did}/graph.endpoint{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
