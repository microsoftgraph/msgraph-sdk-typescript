...
// @ts-ignore
import { createTargetDeviceGroupFromDiscriminatorValue, serializeTargetDeviceGroup, type TargetDeviceGroup } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const TargetDeviceGroupItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/remoteDesktopSecurityConfiguration/targetDeviceGroups/{targetDeviceGroup%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
