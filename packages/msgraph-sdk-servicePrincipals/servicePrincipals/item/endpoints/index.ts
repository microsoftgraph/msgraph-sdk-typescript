...
// @ts-ignore
import { createEndpointCollectionResponseFromDiscriminatorValue, createEndpointFromDiscriminatorValue, serializeEndpoint, type Endpoint, type EndpointCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
