...
// @ts-ignore
import { createDelegatedPermissionClassificationFromDiscriminatorValue, serializeDelegatedPermissionClassification, type DelegatedPermissionClassification } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const DelegatedPermissionClassificationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/delegatedPermissionClassifications/{delegatedPermissionClassification%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
