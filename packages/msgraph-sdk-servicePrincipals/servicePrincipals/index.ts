...
// @ts-ignore
import { createServicePrincipalCollectionResponseFromDiscriminatorValue, createServicePrincipalFromDiscriminatorValue, serializeServicePrincipal, type ServicePrincipal, type ServicePrincipalCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ServicePrincipalsRequestBuilderUriTemplate = "";
/**
...
export const ServicePrincipalsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/servicePrincipals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/servicePrincipals",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
