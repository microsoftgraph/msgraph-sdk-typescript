...
// @ts-ignore
import { createServicePrincipalFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeServicePrincipal, type BaseDeltaFunctionResponse, type ServicePrincipal } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
