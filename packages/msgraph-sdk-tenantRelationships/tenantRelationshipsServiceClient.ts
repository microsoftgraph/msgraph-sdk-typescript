...
export function createTenantRelationshipsServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<TenantRelationshipsServiceClient>(requestAdapter, pathParameters, TenantRelationshipsServiceClientUriTemplate, TenantRelationshipsServiceClientNavigationMetadata, undefined);
}
/**
