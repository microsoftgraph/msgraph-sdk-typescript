 ...
 */
export const RiskyServicePrincipalItemRequestBuilderUriTemplate = "{+baseurl}/identityProtection/riskyServicePrincipals/{riskyServicePrincipal%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
