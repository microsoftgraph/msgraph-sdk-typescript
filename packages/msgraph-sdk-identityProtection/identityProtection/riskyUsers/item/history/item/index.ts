...
// @ts-ignore
import { createRiskyUserHistoryItemFromDiscriminatorValue, serializeRiskyUserHistoryItem, type RiskyUserHistoryItem } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const RiskyUserHistoryItemItemRequestBuilderUriTemplate = "{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}/history/{riskyUserHistoryItem%2Did}";
/**
...
export const RiskyUserHistoryItemItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}/history/{riskyUserHistoryItem%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
