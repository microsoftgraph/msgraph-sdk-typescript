...
// @ts-ignore
import { createRiskyUserCollectionResponseFromDiscriminatorValue, createRiskyUserFromDiscriminatorValue, serializeRiskyUser, type RiskyUser, type RiskyUserCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { RiskyUserItemRequestBuilderNavigationMetadata, RiskyUserItemRequestBuilderRequestsMetadata, type RiskyUserItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const RiskyUsersRequestBuilderUriTemplate = "";
/**
...
export const RiskyUsersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/identityProtection/riskyUsers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/identityProtection/riskyUsers",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
