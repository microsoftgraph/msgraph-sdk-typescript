...
// @ts-ignore
import { createServicePrincipalRiskDetectionFromDiscriminatorValue, serializeServicePrincipalRiskDetection, type ServicePrincipalRiskDetection } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ServicePrincipalRiskDetectionItemRequestBuilderUriTemplate = "{+baseurl}/identityProtection/servicePrincipalRiskDetections/{servicePrincipalRiskDetection%2Did}";
/**
...
export const ServicePrincipalRiskDetectionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityProtection/servicePrincipalRiskDetections/{servicePrincipalRiskDetection%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
