...
// @ts-ignore
import { createServicePrincipalRiskDetectionCollectionResponseFromDiscriminatorValue, createServicePrincipalRiskDetectionFromDiscriminatorValue, serializeServicePrincipalRiskDetection, type ServicePrincipalRiskDetection, type ServicePrincipalRiskDetectionCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ServicePrincipalRiskDetectionsRequestBuilderUriTemplate = "";
/**
...
export const ServicePrincipalRiskDetectionsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/identityProtection/servicePrincipalRiskDetections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/identityProtection/servicePrincipalRiskDetections",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
