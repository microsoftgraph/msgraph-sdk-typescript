...
// @ts-ignore
import { createRiskDetectionFromDiscriminatorValue, serializeRiskDetection, type RiskDetection } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const RiskDetectionItemRequestBuilderUriTemplate = "{+baseurl}/identityProtection/riskDetections/{riskDetection%2Did}";
/**
...
export const RiskDetectionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityProtection/riskDetections/{riskDetection%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
