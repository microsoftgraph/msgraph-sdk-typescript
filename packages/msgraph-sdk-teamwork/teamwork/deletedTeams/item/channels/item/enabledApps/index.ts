...
// @ts-ignore
import { createTeamsAppCollectionResponseFromDiscriminatorValue, type TeamsAppCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { TeamsAppItemRequestBuilderRequestsMetadata, type TeamsAppItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const EnabledAppsRequestBuilderUriTemplate = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/enabledApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const EnabledAppsRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "count": "%24count",
    "expand": "%24expand",
    "filter": "%24filter",
    "orderby": "%24orderby",
 ...
 */
export const EnabledAppsRequestBuilderNavigationMetadata: Record<Exclude<keyof EnabledAppsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byTeamsAppId: {
 ...
 */
export const EnabledAppsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
