...
// @ts-ignore
import { createChannelCollectionResponseFromDiscriminatorValue, createChannelFromDiscriminatorValue, serializeChannel, type Channel, type ChannelCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { ChannelItemRequestBuilderNavigationMetadata, ChannelItemRequestBuilderRequestsMetadata, type ChannelItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const ChannelsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
