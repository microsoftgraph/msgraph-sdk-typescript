 ...
 */
export const WorkforceIntegrationItemRequestBuilderUriTemplate = "{+baseurl}/teamwork/workforceIntegrations/{workforceIntegration%2Did}";
/**
...
export const WorkforceIntegrationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/teamwork/workforceIntegrations/{workforceIntegration%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
