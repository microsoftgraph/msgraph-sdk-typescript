...
// @ts-ignore
import { createWorkforceIntegrationCollectionResponseFromDiscriminatorValue, createWorkforceIntegrationFromDiscriminatorValue, serializeWorkforceIntegration, type WorkforceIntegration, type WorkforceIntegrationCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const WorkforceIntegrationsRequestBuilderUriTemplate = "";
/**
...
export const WorkforceIntegrationsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/teamwork/workforceIntegrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/teamwork/workforceIntegrations",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
