 ...
 */
export const GraphAppRoleAssignmentRequestBuilderUriTemplate = "{+baseurl}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/graph.appRoleAssignment{?%24expand,%24select}";
/**
