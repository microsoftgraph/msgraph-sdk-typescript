 ...
 */
export const GraphEndpointRequestBuilderUriTemplate = "{+baseurl}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.endpoint{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
