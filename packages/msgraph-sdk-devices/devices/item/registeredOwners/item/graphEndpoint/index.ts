 ...
 */
export const GraphEndpointRequestBuilderUriTemplate = "{+baseurl}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.endpoint{?%24expand,%24select}";
/**
