...
export function createApplicationTemplatesServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ApplicationTemplatesServiceClient>(requestAdapter, pathParameters, ApplicationTemplatesServiceClientUriTemplate, ApplicationTemplatesServiceClientNavigationMetadata, undefined);
}
/**
