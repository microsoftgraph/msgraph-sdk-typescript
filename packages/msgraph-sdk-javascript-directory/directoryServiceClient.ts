...
export function newDirectoryServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DirectoryServiceClient>(requestAdapter, pathParameters, DirectoryServiceClientUriTemplate, DirectoryServiceClientNavigationMetadata, undefined);
}
/**
