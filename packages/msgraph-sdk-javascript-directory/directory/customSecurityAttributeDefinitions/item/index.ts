...
import { createCustomSecurityAttributeDefinitionFromDiscriminatorValue, serializeCustomSecurityAttributeDefinition, type CustomSecurityAttributeDefinition } from 'directory/models/';
import { createODataErrorFromDiscriminatorValue, type ODataError } from 'directory/models/oDataErrors/';
import { AllowedValuesRequestBuilderNavigationMetadata, AllowedValuesRequestBuilderRequestsMetadata, AllowedValuesRequestBuilderUriTemplate, type AllowedValuesRequestBuilder } from './allowedValues/';
 ...
 */
export const CustomSecurityAttributeDefinitionItemRequestBuilderUriTemplate = "{+baseurl}/directory/customSecurityAttributeDefinitions/{customSecurityAttributeDefinition%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
