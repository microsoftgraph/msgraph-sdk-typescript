...
import { createAdministrativeUnitFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeAdministrativeUnit, serializeBaseDeltaFunctionResponse, type AdministrativeUnit, type BaseDeltaFunctionResponse } from 'directory/models/';
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/directory/administrativeUnits/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
