...
import { createApplicationCollectionResponseFromDiscriminatorValue, type ApplicationCollectionResponse } from 'directory/models/';
 ...
 */
export const GraphApplicationRequestBuilderUriTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
