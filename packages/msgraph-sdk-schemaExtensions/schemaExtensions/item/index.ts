...
// @ts-ignore
import { createSchemaExtensionFromDiscriminatorValue, serializeSchemaExtension, type SchemaExtension } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const SchemaExtensionItemRequestBuilderUriTemplate = "{+baseurl}/schemaExtensions/{schemaExtension%2Did}";
/**
...
export const SchemaExtensionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/schemaExtensions/{schemaExtension%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
