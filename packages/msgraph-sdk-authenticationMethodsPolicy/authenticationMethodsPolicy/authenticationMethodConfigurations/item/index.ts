...
// @ts-ignore
import { createAuthenticationMethodConfigurationFromDiscriminatorValue, serializeAuthenticationMethodConfiguration, type AuthenticationMethodConfiguration } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AuthenticationMethodConfigurationItemRequestBuilderUriTemplate = "{+baseurl}/authenticationMethodsPolicy/authenticationMethodConfigurations/{authenticationMethodConfiguration%2Did}";
/**
...
export const AuthenticationMethodConfigurationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/authenticationMethodsPolicy/authenticationMethodConfigurations/{authenticationMethodConfiguration%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
