...
import { createComplianceFromDiscriminatorValue, serializeCompliance, type Compliance } from 'compliance/models/';
import { createODataErrorFromDiscriminatorValue, type ODataError } from 'compliance/models/oDataErrors/';
