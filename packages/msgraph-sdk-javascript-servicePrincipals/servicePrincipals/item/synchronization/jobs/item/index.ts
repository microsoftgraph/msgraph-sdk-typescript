...
import { createSynchronizationJobFromDiscriminatorValue, serializeSynchronizationJob, type SynchronizationJob } from '@microsoft/msgraph-sdk-javascript/models/';
