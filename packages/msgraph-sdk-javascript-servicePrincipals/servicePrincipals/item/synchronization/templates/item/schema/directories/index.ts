...
import { createDirectoryDefinitionCollectionResponseFromDiscriminatorValue, createDirectoryDefinitionFromDiscriminatorValue, serializeDirectoryDefinition, type DirectoryDefinition, type DirectoryDefinitionCollectionResponse } from 'servicePrincipals/models/';
 ...
 */
export const DirectoriesRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
