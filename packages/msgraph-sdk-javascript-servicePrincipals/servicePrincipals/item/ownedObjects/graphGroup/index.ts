...
import { createGroupCollectionResponseFromDiscriminatorValue, type GroupCollectionResponse } from '@microsoft/msgraph-sdk-javascript/models/';
 ...
 */
export const GraphGroupRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
