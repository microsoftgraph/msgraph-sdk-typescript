 ...
 */
export const DirectoryObjectItemRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/createdObjects/{directoryObject%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
