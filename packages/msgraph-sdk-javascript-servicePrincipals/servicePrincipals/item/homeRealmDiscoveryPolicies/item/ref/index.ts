...
export interface RefRequestBuilder extends BaseRequestBuilder<RefRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/serviceprincipal-delete-homerealmdiscoverypolicies?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const RefRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicy%2Did}/$ref{?%40id*}";
/* tslint:enable */
/* eslint-enable */
