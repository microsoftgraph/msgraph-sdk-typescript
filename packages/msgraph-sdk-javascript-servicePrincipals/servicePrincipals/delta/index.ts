...
import { createServicePrincipalFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeServicePrincipal, type BaseDeltaFunctionResponse, type ServicePrincipal } from 'servicePrincipals/models/';
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
