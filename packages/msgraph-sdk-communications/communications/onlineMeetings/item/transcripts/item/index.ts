...
// @ts-ignore
import { createCallTranscriptFromDiscriminatorValue, serializeCallTranscript, type CallTranscript } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CallTranscriptItemRequestBuilderUriTemplate = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}";
/**
...
export const CallTranscriptItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
