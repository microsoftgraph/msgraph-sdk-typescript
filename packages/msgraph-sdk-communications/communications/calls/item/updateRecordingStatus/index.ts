 ...
 */
// @ts-ignore
export function serializeUpdateRecordingStatusPostRequestBody(writer: SerializationWriter, updateRecordingStatusPostRequestBody: Partial<UpdateRecordingStatusPostRequestBody> | undefined | null = {}) : void {
    if (updateRecordingStatusPostRequestBody) {
