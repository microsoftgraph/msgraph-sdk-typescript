...
// @ts-ignore
import { createCallFromDiscriminatorValue, serializeCall, type Call } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { AddLargeGalleryViewRequestBuilderRequestsMetadata, type AddLargeGalleryViewRequestBuilder } from './addLargeGalleryView/index.js';
// @ts-ignore
import { AnswerRequestBuilderRequestsMetadata, type AnswerRequestBuilder } from './answer/index.js';
// @ts-ignore
import { AudioRoutingGroupsRequestBuilderNavigationMetadata, AudioRoutingGroupsRequestBuilderRequestsMetadata, type AudioRoutingGroupsRequestBuilder } from './audioRoutingGroups/index.js';
// @ts-ignore
import { CancelMediaProcessingRequestBuilderRequestsMetadata, type CancelMediaProcessingRequestBuilder } from './cancelMediaProcessing/index.js';
// @ts-ignore
import { ChangeScreenSharingRoleRequestBuilderRequestsMetadata, type ChangeScreenSharingRoleRequestBuilder } from './changeScreenSharingRole/index.js';
// @ts-ignore
import { ContentSharingSessionsRequestBuilderNavigationMetadata, ContentSharingSessionsRequestBuilderRequestsMetadata, type ContentSharingSessionsRequestBuilder } from './contentSharingSessions/index.js';
// @ts-ignore
import { KeepAliveRequestBuilderRequestsMetadata, type KeepAliveRequestBuilder } from './keepAlive/index.js';
// @ts-ignore
...
// @ts-ignore
import { PlayPromptRequestBuilderRequestsMetadata, type PlayPromptRequestBuilder } from './playPrompt/index.js';
// @ts-ignore
import { RecordResponseRequestBuilderRequestsMetadata, type RecordResponseRequestBuilder } from './recordResponse/index.js';
// @ts-ignore
import { RedirectRequestBuilderRequestsMetadata, type RedirectRequestBuilder } from './redirect/index.js';
// @ts-ignore
import { RejectRequestBuilderRequestsMetadata, type RejectRequestBuilder } from './reject/index.js';
// @ts-ignore
...
// @ts-ignore
import { type UnmuteRequestBuilder, UnmuteRequestBuilderRequestsMetadata } from './unmute/index.js';
// @ts-ignore
import { type UpdateRecordingStatusRequestBuilder, UpdateRecordingStatusRequestBuilderRequestsMetadata } from './updateRecordingStatus/index.js';
// @ts-ignore
