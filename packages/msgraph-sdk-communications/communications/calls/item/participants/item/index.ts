...
// @ts-ignore
import { createParticipantFromDiscriminatorValue, serializeParticipant, type Participant } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const ParticipantItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/communications/calls/{call%2Did}/participants/{participant%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
