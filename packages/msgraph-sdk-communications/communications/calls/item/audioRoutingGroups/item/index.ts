...
// @ts-ignore
import { createAudioRoutingGroupFromDiscriminatorValue, serializeAudioRoutingGroup, type AudioRoutingGroup } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const AudioRoutingGroupItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/communications/calls/{call%2Did}/audioRoutingGroups/{audioRoutingGroup%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
