...
// @ts-ignore
import { createAudioRoutingGroupCollectionResponseFromDiscriminatorValue, createAudioRoutingGroupFromDiscriminatorValue, serializeAudioRoutingGroup, type AudioRoutingGroup, type AudioRoutingGroupCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AudioRoutingGroupsRequestBuilderUriTemplate = "";
/**
...
export const AudioRoutingGroupsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/communications/calls/{call%2Did}/audioRoutingGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/communications/calls/{call%2Did}/audioRoutingGroups",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
