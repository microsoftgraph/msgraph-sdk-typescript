...
// @ts-ignore
import { createIncomingCallOptionsFromDiscriminatorValue, createMediaConfigFromDiscriminatorValue, serializeIncomingCallOptions, serializeMediaConfig, type IncomingCallOptions, type MediaConfig } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export interface AnswerPostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    acceptedModalities?: string[] | null;
    /**
...
export function deserializeIntoAnswerPostRequestBody(answerPostRequestBody: Partial<AnswerPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "acceptedModalities": n => { answerPostRequestBody.acceptedModalities = n.getCollectionOfPrimitiveValues<string>(); },
...
export function serializeAnswerPostRequestBody(writer: SerializationWriter, answerPostRequestBody: Partial<AnswerPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfPrimitiveValues<string>("acceptedModalities", answerPostRequestBody.acceptedModalities);
