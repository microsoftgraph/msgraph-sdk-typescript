 ...
 */
// @ts-ignore
export function serializeRedirectPostRequestBody(writer: SerializationWriter, redirectPostRequestBody: Partial<RedirectPostRequestBody> | undefined | null = {}) : void {
    if (redirectPostRequestBody) {
