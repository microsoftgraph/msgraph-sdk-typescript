...
// @ts-ignore
import { createTeleconferenceDeviceQualityFromDiscriminatorValue, serializeTeleconferenceDeviceQuality, type TeleconferenceDeviceQuality } from '@microsoft/msgraph-sdk/models/';
// @ts-ignore
