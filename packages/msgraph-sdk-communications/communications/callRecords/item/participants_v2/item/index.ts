...
// @ts-ignore
import { createParticipantFromDiscriminatorValue, serializeParticipant, type Participant } from '@microsoft/msgraph-sdk/models/callRecords/index.js';
// @ts-ignore
 ...
 */
export const ParticipantItemRequestBuilderUriTemplate = "{+baseurl}/communications/callRecords/{callRecord%2Did}/participants_v2/{participant%2Did}";
/**
...
export const ParticipantItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/communications/callRecords/{callRecord%2Did}/participants_v2/{participant%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
