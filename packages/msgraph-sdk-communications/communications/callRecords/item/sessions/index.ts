...
// @ts-ignore
import { createSessionCollectionResponseFromDiscriminatorValue, createSessionFromDiscriminatorValue, serializeSession, type Session, type SessionCollectionResponse } from '@microsoft/msgraph-sdk/models/callRecords/index.js';
// @ts-ignore
...
export const SessionsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/communications/callRecords/{callRecord%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/communications/callRecords/{callRecord%2Did}/sessions",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
