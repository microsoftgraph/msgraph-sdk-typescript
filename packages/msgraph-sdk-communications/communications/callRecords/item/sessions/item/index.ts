...
// @ts-ignore
import { createSessionFromDiscriminatorValue, serializeSession, type Session } from '@microsoft/msgraph-sdk/models/callRecords/index.js';
// @ts-ignore
...
export const SessionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/communications/callRecords/{callRecord%2Did}/sessions/{session%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
