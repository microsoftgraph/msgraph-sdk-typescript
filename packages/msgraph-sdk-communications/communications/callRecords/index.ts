...
// @ts-ignore
import { createCallRecordCollectionResponseFromDiscriminatorValue, createCallRecordFromDiscriminatorValue, serializeCallRecord, type CallRecord, type CallRecordCollectionResponse } from '@microsoft/msgraph-sdk/models/callRecords/index.js';
// @ts-ignore
...
export const CallRecordsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/communications/callRecords{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/communications/callRecords",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
