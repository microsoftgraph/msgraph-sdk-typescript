...
// @ts-ignore
import { createCallRecordingCollectionResponseFromDiscriminatorValue, createCallRecordingFromDiscriminatorValue, serializeCallRecording, type CallRecording, type CallRecordingCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const RecordingsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/recordings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/recordings",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
