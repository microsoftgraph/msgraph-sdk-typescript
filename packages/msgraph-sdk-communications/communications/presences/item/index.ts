...
// @ts-ignore
import { createPresenceFromDiscriminatorValue, serializePresence, type Presence } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const PresenceItemRequestBuilderUriTemplate = "{+baseurl}/communications/presences/{presence%2Did}";
/**
...
export const PresenceItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/communications/presences/{presence%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
