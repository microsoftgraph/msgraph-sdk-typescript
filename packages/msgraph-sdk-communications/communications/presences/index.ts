...
// @ts-ignore
import { createPresenceCollectionResponseFromDiscriminatorValue, createPresenceFromDiscriminatorValue, serializePresence, type Presence, type PresenceCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PresenceItemRequestBuilderNavigationMetadata, PresenceItemRequestBuilderRequestsMetadata, type PresenceItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const PresencesRequestBuilderUriTemplate = "";
/**
...
export const PresencesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/communications/presences{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/communications/presences",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
