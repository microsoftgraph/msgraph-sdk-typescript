 ...
 */
export const ParseExpressionRequestBuilderUriTemplate = "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/parseExpression";
/* tslint:enable */
/* eslint-enable */
