...
import { createChatMessageFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeChatMessage, type BaseCollectionPaginationCountResponse, type ChatMessage } from 'teams/models/';
 ...
 */
export const GetAllMessagesRequestBuilderUriTemplate = "{+baseurl}/teams/getAllMessages(){?model*,%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
