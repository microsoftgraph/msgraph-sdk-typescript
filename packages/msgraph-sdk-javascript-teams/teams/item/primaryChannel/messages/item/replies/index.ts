...
import { createChatMessageCollectionResponseFromDiscriminatorValue, createChatMessageFromDiscriminatorValue, serializeChatMessage, type ChatMessage, type ChatMessageCollectionResponse } from 'teams/models/';
 ...
 */
export const RepliesRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
