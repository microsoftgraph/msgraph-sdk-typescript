...
import { createSchedulingGroupCollectionResponseFromDiscriminatorValue, createSchedulingGroupFromDiscriminatorValue, serializeSchedulingGroup, type SchedulingGroup, type SchedulingGroupCollectionResponse } from 'users/models/';
 ...
 */
export const SchedulingGroupsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/schedulingGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
/* tslint:enable */
/* eslint-enable */
