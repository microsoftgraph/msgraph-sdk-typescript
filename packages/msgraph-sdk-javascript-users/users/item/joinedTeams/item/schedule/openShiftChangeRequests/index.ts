...
import { createOpenShiftChangeRequestCollectionResponseFromDiscriminatorValue, createOpenShiftChangeRequestFromDiscriminatorValue, serializeOpenShiftChangeRequest, type OpenShiftChangeRequest, type OpenShiftChangeRequestCollectionResponse } from 'users/models/';
 ...
 */
export const OpenShiftChangeRequestsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/openShiftChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
