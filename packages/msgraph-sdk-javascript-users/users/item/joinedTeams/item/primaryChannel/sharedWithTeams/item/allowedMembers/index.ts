...
import { createConversationMemberCollectionResponseFromDiscriminatorValue, type ConversationMemberCollectionResponse } from 'users/models/';
 ...
 */
export const AllowedMembersRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
