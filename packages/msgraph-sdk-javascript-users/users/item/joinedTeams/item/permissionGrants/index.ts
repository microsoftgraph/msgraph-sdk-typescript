...
import { createResourceSpecificPermissionGrantCollectionResponseFromDiscriminatorValue, createResourceSpecificPermissionGrantFromDiscriminatorValue, serializeResourceSpecificPermissionGrant, type ResourceSpecificPermissionGrant, type ResourceSpecificPermissionGrantCollectionResponse } from 'users/models/';
 ...
 */
export const PermissionGrantsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
