...
import { createCalendarPermissionCollectionResponseFromDiscriminatorValue, createCalendarPermissionFromDiscriminatorValue, serializeCalendarPermission, type CalendarPermission, type CalendarPermissionCollectionResponse } from 'users/models/';
 ...
 */
export const CalendarPermissionsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarPermissions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
/* tslint:enable */
/* eslint-enable */
