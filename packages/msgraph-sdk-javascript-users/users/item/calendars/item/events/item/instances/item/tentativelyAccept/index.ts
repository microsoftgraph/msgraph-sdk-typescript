 ...
 */
export const TentativelyAcceptRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/tentativelyAccept";
/* tslint:enable */
/* eslint-enable */
