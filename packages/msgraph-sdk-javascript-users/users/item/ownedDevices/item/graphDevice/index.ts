...
import { createDeviceFromDiscriminatorValue, type Device } from 'users/models/';
 ...
 */
export const GraphDeviceRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/ownedDevices/{directoryObject%2Did}/graph.device{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
