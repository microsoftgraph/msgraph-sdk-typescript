...
import { createChatCollectionResponseFromDiscriminatorValue, createChatFromDiscriminatorValue, serializeChat, type Chat, type ChatCollectionResponse } from 'users/models/';
 ...
 */
export const ChatsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/chats{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
