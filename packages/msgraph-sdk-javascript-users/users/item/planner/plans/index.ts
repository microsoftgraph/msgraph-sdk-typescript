...
import { createPlannerPlanCollectionResponseFromDiscriminatorValue, createPlannerPlanFromDiscriminatorValue, serializePlannerPlan, type PlannerPlan, type PlannerPlanCollectionResponse } from 'users/models/';
 ...
 */
export const PlansRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/planner/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
