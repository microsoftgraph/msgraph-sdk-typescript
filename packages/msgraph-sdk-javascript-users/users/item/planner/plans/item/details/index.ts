...
import { createPlannerPlanDetailsFromDiscriminatorValue, serializePlannerPlanDetails, type PlannerPlanDetails } from 'users/models/';
 ...
 */
export const DetailsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/details{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
