...
import { createPlannerBucketCollectionResponseFromDiscriminatorValue, createPlannerBucketFromDiscriminatorValue, serializePlannerBucket, type PlannerBucket, type PlannerBucketCollectionResponse } from '@microsoft/msgraph-sdk-javascript/models/';
