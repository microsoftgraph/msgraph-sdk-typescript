...
import { createPlannerBucketCollectionResponseFromDiscriminatorValue, createPlannerBucketFromDiscriminatorValue, serializePlannerBucket, type PlannerBucket, type PlannerBucketCollectionResponse } from 'users/models/';
 ...
 */
export const BucketsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
