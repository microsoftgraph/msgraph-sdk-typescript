...
import { createPlannerTaskCollectionResponseFromDiscriminatorValue, createPlannerTaskFromDiscriminatorValue, serializePlannerTask, type PlannerTask, type PlannerTaskCollectionResponse } from 'users/models/';
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/planner/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
