 ...
 */
export const DefinitionRequestBuilderUriTemplate = "{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}/tasks/{printTask%2Did}/definition{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
