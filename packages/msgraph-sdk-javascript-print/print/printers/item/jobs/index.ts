...
import { createPrintJobCollectionResponseFromDiscriminatorValue, createPrintJobFromDiscriminatorValue, serializePrintJob, type PrintJob, type PrintJobCollectionResponse } from '@microsoft/msgraph-sdk-javascript/models/';
