...
import { createPrintJobCollectionResponseFromDiscriminatorValue, createPrintJobFromDiscriminatorValue, serializePrintJob, type PrintJob, type PrintJobCollectionResponse } from 'print/models/';
 ...
 */
export const JobsRequestBuilderUriTemplate = "{+baseurl}/print/printers/{printer%2Did}/jobs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
