...
import { createPrintTaskFromDiscriminatorValue, serializePrintTask, type PrintTask } from '@microsoft/msgraph-sdk-javascript/models/';
 ...
 */
export const PrintTaskItemRequestBuilderUriTemplate = "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
