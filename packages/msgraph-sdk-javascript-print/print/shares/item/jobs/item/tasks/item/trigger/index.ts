...
import { createPrintTaskTriggerFromDiscriminatorValue, type PrintTaskTrigger } from 'print/models/';
 ...
 */
export const TriggerRequestBuilderUriTemplate = "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}/trigger{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
