...
// @ts-ignore
import { createTeamworkTagFromDiscriminatorValue, serializeTeamworkTag, type TeamworkTag } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TeamworkTagItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/tags/{teamworkTag%2Did}";
/**
...
export const TeamworkTagItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/tags/{teamworkTag%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
