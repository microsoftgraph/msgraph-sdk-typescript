...
// @ts-ignore
import { createOpenShiftFromDiscriminatorValue, serializeOpenShift, type OpenShift } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const OpenShiftItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/openShifts/{openShift%2Did}";
/**
...
export const OpenShiftItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/openShifts/{openShift%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
