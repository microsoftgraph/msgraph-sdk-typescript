...
// @ts-ignore
import { createOpenShiftChangeRequestFromDiscriminatorValue, serializeOpenShiftChangeRequest, type OpenShiftChangeRequest } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const OpenShiftChangeRequestItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/openShiftChangeRequests/{openShiftChangeRequest%2Did}";
/**
...
export const OpenShiftChangeRequestItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/openShiftChangeRequests/{openShiftChangeRequest%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
