...
// @ts-ignore
import { createTimeOffRequestFromDiscriminatorValue, serializeTimeOffRequest, type TimeOffRequest } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TimeOffRequestItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timeOffRequests/{timeOffRequest%2Did}";
/**
...
export const TimeOffRequestItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timeOffRequests/{timeOffRequest%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
