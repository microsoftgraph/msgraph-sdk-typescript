...
// @ts-ignore
import { createTimeOffReasonFromDiscriminatorValue, serializeTimeOffReason, type TimeOffReason } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TimeOffReasonItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timeOffReasons/{timeOffReason%2Did}";
/**
...
export const TimeOffReasonItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timeOffReasons/{timeOffReason%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
