...
// @ts-ignore
import { createTimeOffFromDiscriminatorValue, serializeTimeOff, type TimeOff } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TimeOffItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timesOff/{timeOff%2Did}";
/**
...
export const TimeOffItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timesOff/{timeOff%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
