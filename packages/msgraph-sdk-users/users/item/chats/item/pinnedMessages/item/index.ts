...
// @ts-ignore
import { createPinnedChatMessageInfoFromDiscriminatorValue, serializePinnedChatMessageInfo, type PinnedChatMessageInfo } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const PinnedChatMessageInfoItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}";
/**
...
export const PinnedChatMessageInfoItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
