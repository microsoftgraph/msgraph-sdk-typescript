...
// @ts-ignore
import { createPinnedChatMessageInfoCollectionResponseFromDiscriminatorValue, createPinnedChatMessageInfoFromDiscriminatorValue, serializePinnedChatMessageInfo, type PinnedChatMessageInfo, type PinnedChatMessageInfoCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PinnedChatMessageInfoItemRequestBuilderNavigationMetadata, PinnedChatMessageInfoItemRequestBuilderRequestsMetadata, type PinnedChatMessageInfoItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const PinnedMessagesRequestBuilderUriTemplate = "";
/**
...
export const PinnedMessagesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
