 ...
 */
export const ContentRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}/hostedContents/{chatMessageHostedContent%2Did}/$value";
/**
