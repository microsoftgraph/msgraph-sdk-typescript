 ...
 * @param UnhideForUserPostRequestBody The instance to deserialize into.
 ...
 * @param UnhideForUserPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeUnhideForUserPostRequestBody(writer: SerializationWriter, unhideForUserPostRequestBody: Partial<UnhideForUserPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!unhideForUserPostRequestBody || isSerializingDerivedType) { return; }
