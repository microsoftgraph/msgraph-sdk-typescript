 ...
 */
// @ts-ignore
export function serializeUnhideForUserPostRequestBody(writer: SerializationWriter, unhideForUserPostRequestBody: Partial<UnhideForUserPostRequestBody> | undefined | null = {}) : void {
    if (unhideForUserPostRequestBody) {
