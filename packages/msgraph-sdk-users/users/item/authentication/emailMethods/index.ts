...
// @ts-ignore
import { createEmailAuthenticationMethodCollectionResponseFromDiscriminatorValue, createEmailAuthenticationMethodFromDiscriminatorValue, serializeEmailAuthenticationMethod, type EmailAuthenticationMethod, type EmailAuthenticationMethodCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const EmailMethodsRequestBuilderUriTemplate = "";
/**
...
export const EmailMethodsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/authentication/emailMethods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/authentication/emailMethods",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
