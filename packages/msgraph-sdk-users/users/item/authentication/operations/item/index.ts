...
// @ts-ignore
import { createLongRunningOperationFromDiscriminatorValue, serializeLongRunningOperation, type LongRunningOperation } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const LongRunningOperationItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/authentication/operations/{longRunningOperation%2Did}";
/**
...
export const LongRunningOperationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/authentication/operations/{longRunningOperation%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
