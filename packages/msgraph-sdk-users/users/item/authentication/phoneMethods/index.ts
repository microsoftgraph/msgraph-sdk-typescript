...
// @ts-ignore
import { createPhoneAuthenticationMethodCollectionResponseFromDiscriminatorValue, createPhoneAuthenticationMethodFromDiscriminatorValue, serializePhoneAuthenticationMethod, type PhoneAuthenticationMethod, type PhoneAuthenticationMethodCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PhoneAuthenticationMethodItemRequestBuilderNavigationMetadata, PhoneAuthenticationMethodItemRequestBuilderRequestsMetadata, type PhoneAuthenticationMethodItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const PhoneMethodsRequestBuilderUriTemplate = "";
/**
...
export const PhoneMethodsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/authentication/phoneMethods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/authentication/phoneMethods",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
