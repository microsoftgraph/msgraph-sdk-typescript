...
// @ts-ignore
import { createAuthenticationMethodCollectionResponseFromDiscriminatorValue, createAuthenticationMethodFromDiscriminatorValue, serializeAuthenticationMethod, type AuthenticationMethod, type AuthenticationMethodCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { AuthenticationMethodItemRequestBuilderNavigationMetadata, AuthenticationMethodItemRequestBuilderRequestsMetadata, type AuthenticationMethodItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const MethodsRequestBuilderUriTemplate = "";
/**
...
export const MethodsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/authentication/methods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/authentication/methods",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
