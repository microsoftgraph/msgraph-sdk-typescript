...
// @ts-ignore
import { createPasswordResetResponseFromDiscriminatorValue, serializePasswordResetResponse, type PasswordResetResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 * @param ResetPasswordPostRequestBody The instance to deserialize into.
 ...
 * @param ResetPasswordPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeResetPasswordPostRequestBody(writer: SerializationWriter, resetPasswordPostRequestBody: Partial<ResetPasswordPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!resetPasswordPostRequestBody || isSerializingDerivedType) { return; }
