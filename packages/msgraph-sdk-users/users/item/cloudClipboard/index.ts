...
// @ts-ignore
import { createCloudClipboardRootFromDiscriminatorValue, serializeCloudClipboardRoot, type CloudClipboardRoot } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const CloudClipboardRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/cloudClipboard{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
