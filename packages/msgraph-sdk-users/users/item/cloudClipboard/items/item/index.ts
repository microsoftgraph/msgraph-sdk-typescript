 ...
 */
export const CloudClipboardItemItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/cloudClipboard/items/{cloudClipboardItem%2Did}";
/**
...
export const CloudClipboardItemItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/cloudClipboard/items/{cloudClipboardItem%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
