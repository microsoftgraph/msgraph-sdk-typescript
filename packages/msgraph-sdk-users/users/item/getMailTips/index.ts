...
// @ts-ignore
import { createMailTipsFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, MailTipsType, MailTipsTypeObject, serializeBaseCollectionPaginationCountResponse, serializeMailTips, type BaseCollectionPaginationCountResponse, type MailTips } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
