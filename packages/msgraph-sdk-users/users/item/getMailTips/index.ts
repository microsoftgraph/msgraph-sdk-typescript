...
// @ts-ignore
import { createMailTipsFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, MailTipsTypeObject, serializeBaseCollectionPaginationCountResponse, serializeMailTips, type BaseCollectionPaginationCountResponse, type MailTips, type MailTipsType } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
