...
// @ts-ignore
import { createDirectoryRoleCollectionResponseFromDiscriminatorValue, type DirectoryRoleCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const GraphDirectoryRoleRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/graph.directoryRole{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
