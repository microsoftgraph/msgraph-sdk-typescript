 ...
 */
export const GraphAdministrativeUnitRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}/graph.administrativeUnit{?%24expand,%24select}";
/**
