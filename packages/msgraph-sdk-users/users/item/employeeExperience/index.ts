...
// @ts-ignore
import { createEmployeeExperienceUserFromDiscriminatorValue, serializeEmployeeExperienceUser, type EmployeeExperienceUser } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const EmployeeExperienceRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/employeeExperience";
/**
...
export const EmployeeExperienceRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/employeeExperience{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
