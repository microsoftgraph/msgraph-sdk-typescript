...
// @ts-ignore
import { createDeviceCollectionResponseFromDiscriminatorValue, type DeviceCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const GraphDeviceRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/registeredDevices/graph.device{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
