...
// @ts-ignore
import { createTrendingFromDiscriminatorValue, serializeTrending, type Trending } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TrendingItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/insights/trending/{trending%2Did}";
/**
...
export const TrendingItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/insights/trending/{trending%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
