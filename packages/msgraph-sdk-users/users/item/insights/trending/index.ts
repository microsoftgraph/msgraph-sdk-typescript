...
// @ts-ignore
import { createTrendingCollectionResponseFromDiscriminatorValue, createTrendingFromDiscriminatorValue, serializeTrending, type Trending, type TrendingCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { TrendingItemRequestBuilderNavigationMetadata, TrendingItemRequestBuilderRequestsMetadata, type TrendingItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const TrendingRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/insights/trending{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/insights/trending",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
