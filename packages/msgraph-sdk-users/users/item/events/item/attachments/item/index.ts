...
export const AttachmentItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/events/{event%2Did}/attachments/{attachment%2Did}",
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/events/{event%2Did}/attachments/{attachment%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
