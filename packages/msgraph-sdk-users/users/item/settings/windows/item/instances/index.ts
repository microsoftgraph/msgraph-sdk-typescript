...
// @ts-ignore
import { createWindowsSettingInstanceCollectionResponseFromDiscriminatorValue, createWindowsSettingInstanceFromDiscriminatorValue, serializeWindowsSettingInstance, type WindowsSettingInstance, type WindowsSettingInstanceCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { type WindowsSettingInstanceItemRequestBuilder, WindowsSettingInstanceItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export const InstancesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/settings/windows/{windowsSetting%2Did}/instances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/settings/windows/{windowsSetting%2Did}/instances",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
