 ...
 */
export const BucketTaskBoardFormatRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/planner/tasks/{plannerTask%2Did}/bucketTaskBoardFormat";
/**
...
export const BucketTaskBoardFormatRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/planner/tasks/{plannerTask%2Did}/bucketTaskBoardFormat{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
