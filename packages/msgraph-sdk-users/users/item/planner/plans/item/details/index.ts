...
// @ts-ignore
import { createPlannerPlanDetailsFromDiscriminatorValue, serializePlannerPlanDetails, type PlannerPlanDetails } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DetailsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/details";
/**
...
export const DetailsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/details{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
