...
// @ts-ignore
import { createPlannerBucketTaskBoardTaskFormatFromDiscriminatorValue, serializePlannerBucketTaskBoardTaskFormat, type PlannerBucketTaskBoardTaskFormat } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const BucketTaskBoardFormatRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/bucketTaskBoardFormat";
/**
...
export const BucketTaskBoardFormatRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/bucketTaskBoardFormat{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
