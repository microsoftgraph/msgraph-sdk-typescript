...
// @ts-ignore
import { createPlannerBucketCollectionResponseFromDiscriminatorValue, createPlannerBucketFromDiscriminatorValue, serializePlannerBucket, type PlannerBucket, type PlannerBucketCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PlannerBucketItemRequestBuilderNavigationMetadata, PlannerBucketItemRequestBuilderRequestsMetadata, type PlannerBucketItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const BucketsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
