...
// @ts-ignore
import { createLicenseDetailsFromDiscriminatorValue, serializeLicenseDetails, type LicenseDetails } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const LicenseDetailsItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/licenseDetails/{licenseDetails%2Did}";
/**
...
export const LicenseDetailsItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/licenseDetails/{licenseDetails%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
