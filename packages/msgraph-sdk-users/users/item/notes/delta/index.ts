...
// @ts-ignore
import { createNoteFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeNote, type BaseDeltaFunctionResponse, type Note } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/note-delta?view=graph-rest-1.0|Find more info here}
     */
...
export function deserializeIntoDeltaGetResponse(deltaGetResponse: Partial<DeltaGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { deltaGetResponse.value = n.getCollectionOfObjectValues<Note>(createNoteFromDiscriminatorValue); },
    }
}
/**
...
export function serializeDeltaGetResponse(writer: SerializationWriter, deltaGetResponse: Partial<DeltaGetResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfObjectValues<Note>("value", deltaGetResponse.value, serializeNote);
}
/**
 * Uri template for the request builder.
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/notes/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
