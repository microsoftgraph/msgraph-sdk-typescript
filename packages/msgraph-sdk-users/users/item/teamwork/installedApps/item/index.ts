...
// @ts-ignore
import { createUserScopeTeamsAppInstallationFromDiscriminatorValue, serializeUserScopeTeamsAppInstallation, type UserScopeTeamsAppInstallation } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const UserScopeTeamsAppInstallationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/teamwork/installedApps/{userScopeTeamsAppInstallation%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
