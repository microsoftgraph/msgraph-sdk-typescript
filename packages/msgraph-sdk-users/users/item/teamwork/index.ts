...
// @ts-ignore
import { createUserTeamworkFromDiscriminatorValue, serializeUserTeamwork, type UserTeamwork } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TeamworkRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/teamwork";
/**
...
export const TeamworkRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/teamwork{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
