...
// @ts-ignore
import { createTodoTaskFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeTodoTask, type BaseDeltaFunctionResponse, type TodoTask } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/todotask-delta?view=graph-rest-1.0|Find more info here}
     */
