...
// @ts-ignore
import { createTodoTaskCollectionResponseFromDiscriminatorValue, createTodoTaskFromDiscriminatorValue, serializeTodoTask, type TodoTask, type TodoTaskCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { TodoTaskItemRequestBuilderNavigationMetadata, TodoTaskItemRequestBuilderRequestsMetadata, type TodoTaskItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const TasksRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
