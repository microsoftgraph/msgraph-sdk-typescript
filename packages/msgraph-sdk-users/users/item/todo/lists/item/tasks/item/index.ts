...
// @ts-ignore
import { createTodoTaskFromDiscriminatorValue, serializeTodoTask, type TodoTask } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const TodoTaskItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
