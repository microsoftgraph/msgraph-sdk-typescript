...
// @ts-ignore
import { createMessageFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeMessage, type BaseDeltaFunctionResponse, type Message } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/messages/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,changeType*}";
/**
