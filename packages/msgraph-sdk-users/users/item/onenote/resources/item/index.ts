 ...
 */
export const OnenoteResourceItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/onenote/resources/{onenoteResource%2Did}";
/**
...
export const OnenoteResourceItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/onenote/resources/{onenoteResource%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
