 ...
 */
export const OnenotePageItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/onenote/pages/{onenotePage%2Did}";
/**
...
export const OnenotePageItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/onenote/pages/{onenotePage%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
