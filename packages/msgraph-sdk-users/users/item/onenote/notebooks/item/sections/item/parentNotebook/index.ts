 ...
 */
export const ParentNotebookRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/parentNotebook{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
