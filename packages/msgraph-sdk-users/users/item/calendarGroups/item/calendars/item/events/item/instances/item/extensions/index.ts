...
// @ts-ignore
import { createExtensionCollectionResponseFromDiscriminatorValue, createExtensionFromDiscriminatorValue, serializeExtension, type Extension, type ExtensionCollectionResponse } from '@microsoft/msgraph-sdk/models/';
// @ts-ignore
