...
// @ts-ignore
import { createAttachmentItemFromDiscriminatorValue, createUploadSessionFromDiscriminatorValue, serializeAttachmentItem, serializeUploadSession, type AttachmentItem, type UploadSession } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CreateUploadSessionRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/attachments/createUploadSession";
/**
