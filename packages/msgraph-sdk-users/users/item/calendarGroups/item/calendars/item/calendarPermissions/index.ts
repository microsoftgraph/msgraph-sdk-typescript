...
// @ts-ignore
import { createCalendarPermissionCollectionResponseFromDiscriminatorValue, createCalendarPermissionFromDiscriminatorValue, serializeCalendarPermission, type CalendarPermission, type CalendarPermissionCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { CalendarPermissionItemRequestBuilderRequestsMetadata, type CalendarPermissionItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const CalendarPermissionsRequestBuilderUriTemplate = "";
/**
...
export const CalendarPermissionsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarPermissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarPermissions",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
