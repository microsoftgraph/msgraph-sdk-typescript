...
// @ts-ignore
import { createCalendarFromDiscriminatorValue, serializeCalendar, type Calendar } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const CalendarItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
