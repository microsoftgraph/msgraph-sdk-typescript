...
// @ts-ignore
import { createAttendeeNotificationInfoFromDiscriminatorValue, RemindBeforeTimeInMinutesTypeObject, serializeAttendeeNotificationInfo, type AttendeeNotificationInfo, type RemindBeforeTimeInMinutesType } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 * @param SendVirtualAppointmentReminderSmsPostRequestBody The instance to deserialize into.
 ...
 * @param SendVirtualAppointmentReminderSmsPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeSendVirtualAppointmentReminderSmsPostRequestBody(writer: SerializationWriter, sendVirtualAppointmentReminderSmsPostRequestBody: Partial<SendVirtualAppointmentReminderSmsPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!sendVirtualAppointmentReminderSmsPostRequestBody || isSerializingDerivedType) { return; }
