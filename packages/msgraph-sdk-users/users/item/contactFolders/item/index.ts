...
// @ts-ignore
import { createContactFolderFromDiscriminatorValue, serializeContactFolder, type ContactFolder } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ContactFolderItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}";
/**
...
export const ContactFolderItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
