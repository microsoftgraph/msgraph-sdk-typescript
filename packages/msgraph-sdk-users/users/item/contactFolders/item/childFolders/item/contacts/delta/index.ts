...
// @ts-ignore
import { createContactFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeContact, type BaseDeltaFunctionResponse, type Contact } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
