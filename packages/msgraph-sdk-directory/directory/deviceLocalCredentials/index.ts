...
// @ts-ignore
import { createDeviceLocalCredentialInfoCollectionResponseFromDiscriminatorValue, createDeviceLocalCredentialInfoFromDiscriminatorValue, serializeDeviceLocalCredentialInfo, type DeviceLocalCredentialInfo, type DeviceLocalCredentialInfoCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DeviceLocalCredentialsRequestBuilderUriTemplate = "";
/**
...
export const DeviceLocalCredentialsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/directory/deviceLocalCredentials{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/directory/deviceLocalCredentials",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
