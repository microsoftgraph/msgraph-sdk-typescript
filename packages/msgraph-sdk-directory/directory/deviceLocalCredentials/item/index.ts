...
// @ts-ignore
import { createDeviceLocalCredentialInfoFromDiscriminatorValue, serializeDeviceLocalCredentialInfo, type DeviceLocalCredentialInfo } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DeviceLocalCredentialInfoItemRequestBuilderUriTemplate = "{+baseurl}/directory/deviceLocalCredentials/{deviceLocalCredentialInfo%2Did}";
/**
...
export const DeviceLocalCredentialInfoItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/directory/deviceLocalCredentials/{deviceLocalCredentialInfo%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
