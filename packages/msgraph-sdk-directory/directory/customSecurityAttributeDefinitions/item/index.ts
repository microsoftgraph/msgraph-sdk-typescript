...
// @ts-ignore
import { createCustomSecurityAttributeDefinitionFromDiscriminatorValue, serializeCustomSecurityAttributeDefinition, type CustomSecurityAttributeDefinition } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const CustomSecurityAttributeDefinitionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/directory/customSecurityAttributeDefinitions/{customSecurityAttributeDefinition%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
