...
// @ts-ignore
import { createScopedRoleMembershipCollectionResponseFromDiscriminatorValue, createScopedRoleMembershipFromDiscriminatorValue, serializeScopedRoleMembership, type ScopedRoleMembership, type ScopedRoleMembershipCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ScopedRoleMembershipItemRequestBuilderRequestsMetadata, type ScopedRoleMembershipItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const ScopedRoleMembersRequestBuilderUriTemplate = "";
/**
...
export const ScopedRoleMembersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/scopedRoleMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/scopedRoleMembers",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
