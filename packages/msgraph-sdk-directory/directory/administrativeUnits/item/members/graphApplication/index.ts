...
// @ts-ignore
import { createApplicationCollectionResponseFromDiscriminatorValue, type ApplicationCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const GraphApplicationRequestBuilderUriTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/graph.application{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
