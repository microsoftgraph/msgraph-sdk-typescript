...
// @ts-ignore
import { createDirectoryFromDiscriminatorValue, serializeDirectory, type Directory } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const DirectoryRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/directory{?%24expand,%24select}",
