...
import { createPrintJobConfigurationFromDiscriminatorValue, createPrintJobFromDiscriminatorValue, serializePrintJob, serializePrintJobConfiguration, type PrintJob, type PrintJobConfiguration } from '@microsoft/msgraph-sdk/models/';
