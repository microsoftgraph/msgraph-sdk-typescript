...
// @ts-ignore
import { createPrintTaskCollectionResponseFromDiscriminatorValue, createPrintTaskFromDiscriminatorValue, serializePrintTask, type PrintTask, type PrintTaskCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PrintTaskItemRequestBuilderNavigationMetadata, PrintTaskItemRequestBuilderRequestsMetadata, type PrintTaskItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const TasksRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
