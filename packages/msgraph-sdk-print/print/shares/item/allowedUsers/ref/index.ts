...
export const RefRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        uriTemplate: "{+baseurl}/print/shares/{printerShare%2Did}/allowedUsers/$ref?@id={%40id}",
    ...
    get: {
        uriTemplate: "{+baseurl}/print/shares/{printerShare%2Did}/allowedUsers/$ref{?%24count,%24filter,%24orderby,%24search,%24skip,%24top}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
    ...
    post: {
        uriTemplate: "{+baseurl}/print/shares/{printerShare%2Did}/allowedUsers/$ref",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
