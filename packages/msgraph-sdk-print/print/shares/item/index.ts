...
// @ts-ignore
import { createPrinterShareFromDiscriminatorValue, serializePrinterShare, type PrinterShare } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const PrinterShareItemRequestBuilderUriTemplate = "{+baseurl}/print/shares/{printerShare%2Did}";
/**
...
export const PrinterShareItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/print/shares/{printerShare%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
