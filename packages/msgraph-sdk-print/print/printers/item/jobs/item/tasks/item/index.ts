...
// @ts-ignore
import { createPrintTaskFromDiscriminatorValue, serializePrintTask, type PrintTask } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const PrintTaskItemRequestBuilderUriTemplate = "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}";
/**
...
export const PrintTaskItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
