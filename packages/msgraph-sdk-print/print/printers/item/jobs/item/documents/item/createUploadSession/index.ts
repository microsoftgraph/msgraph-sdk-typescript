...
// @ts-ignore
import { createPrintDocumentUploadPropertiesFromDiscriminatorValue, createUploadSessionFromDiscriminatorValue, serializePrintDocumentUploadProperties, serializeUploadSession, type PrintDocumentUploadProperties, type UploadSession } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export interface CreateUploadSessionPostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    properties?: PrintDocumentUploadProperties | null;
}
/**
