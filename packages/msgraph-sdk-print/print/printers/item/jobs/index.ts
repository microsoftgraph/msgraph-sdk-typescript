...
// @ts-ignore
import { createPrintJobCollectionResponseFromDiscriminatorValue, createPrintJobFromDiscriminatorValue, serializePrintJob, type PrintJob, type PrintJobCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PrintJobItemRequestBuilderNavigationMetadata, PrintJobItemRequestBuilderRequestsMetadata, type PrintJobItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface JobsRequestBuilder extends BaseRequestBuilder<JobsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printer-list-jobs?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printer-post-jobs?view=graph-rest-1.0|Find more info here}
     */
...
export const JobsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/print/printers/{printer%2Did}/jobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/print/printers/{printer%2Did}/jobs",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
