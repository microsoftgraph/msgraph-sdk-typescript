...
// @ts-ignore
import { createPrintServiceEndpointCollectionResponseFromDiscriminatorValue, createPrintServiceEndpointFromDiscriminatorValue, serializePrintServiceEndpoint, type PrintServiceEndpoint, type PrintServiceEndpointCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const EndpointsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/print/services/{printService%2Did}/endpoints{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/print/services/{printService%2Did}/endpoints",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
