...
// @ts-ignore
import { createPrintConnectorFromDiscriminatorValue, serializePrintConnector, type PrintConnector } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const PrintConnectorItemRequestBuilderUriTemplate = "{+baseurl}/print/connectors/{printConnector%2Did}";
/**
...
export const PrintConnectorItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/print/connectors/{printConnector%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
