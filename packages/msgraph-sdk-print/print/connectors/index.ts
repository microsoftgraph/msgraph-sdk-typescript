...
// @ts-ignore
import { createPrintConnectorCollectionResponseFromDiscriminatorValue, createPrintConnectorFromDiscriminatorValue, serializePrintConnector, type PrintConnector, type PrintConnectorCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ConnectorsRequestBuilderUriTemplate = "";
/**
...
export const ConnectorsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/print/connectors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/print/connectors",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
