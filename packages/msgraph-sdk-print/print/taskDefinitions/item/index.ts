...
// @ts-ignore
import { createPrintTaskDefinitionFromDiscriminatorValue, serializePrintTaskDefinition, type PrintTaskDefinition } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const PrintTaskDefinitionItemRequestBuilderUriTemplate = "{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}";
/**
...
export const PrintTaskDefinitionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
