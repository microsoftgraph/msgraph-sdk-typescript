...
export function createPrintServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<PrintServiceClient>(requestAdapter, pathParameters, PrintServiceClientUriTemplate, PrintServiceClientNavigationMetadata, undefined);
}
/**
