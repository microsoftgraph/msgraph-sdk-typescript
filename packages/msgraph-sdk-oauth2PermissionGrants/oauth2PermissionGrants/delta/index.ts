...
// @ts-ignore
import { createOAuth2PermissionGrantFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeOAuth2PermissionGrant, type BaseDeltaFunctionResponse, type OAuth2PermissionGrant } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/oauth2permissiongrant-delta?view=graph-rest-1.0|Find more info here}
     */
