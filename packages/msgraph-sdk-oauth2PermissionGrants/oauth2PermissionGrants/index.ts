...
// @ts-ignore
import { createOAuth2PermissionGrantCollectionResponseFromDiscriminatorValue, createOAuth2PermissionGrantFromDiscriminatorValue, serializeOAuth2PermissionGrant, type OAuth2PermissionGrant, type OAuth2PermissionGrantCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const Oauth2PermissionGrantsRequestBuilderUriTemplate = "";
/**
...
export const Oauth2PermissionGrantsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/oauth2PermissionGrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/oauth2PermissionGrants",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
