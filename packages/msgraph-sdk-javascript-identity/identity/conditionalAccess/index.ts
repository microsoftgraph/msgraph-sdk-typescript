...
import { createConditionalAccessRootFromDiscriminatorValue, serializeConditionalAccessRoot, type ConditionalAccessRoot } from '@microsoft/msgraph-sdk-javascript/models/';
