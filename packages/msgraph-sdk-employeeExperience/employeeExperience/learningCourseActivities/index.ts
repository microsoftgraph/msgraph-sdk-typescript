...
// @ts-ignore
import { createLearningCourseActivityCollectionResponseFromDiscriminatorValue, createLearningCourseActivityFromDiscriminatorValue, serializeLearningCourseActivity, type LearningCourseActivity, type LearningCourseActivityCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const LearningCourseActivitiesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/employeeExperience/learningCourseActivities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/employeeExperience/learningCourseActivities",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
