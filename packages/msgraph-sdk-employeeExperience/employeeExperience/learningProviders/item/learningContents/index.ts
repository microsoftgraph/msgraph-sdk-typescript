...
// @ts-ignore
import { createLearningContentCollectionResponseFromDiscriminatorValue, createLearningContentFromDiscriminatorValue, serializeLearningContent, type LearningContent, type LearningContentCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { LearningContentItemRequestBuilderRequestsMetadata, type LearningContentItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const LearningContentsRequestBuilderUriTemplate = "";
/**
...
export const LearningContentsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
