...
export interface MembersRequestBuilder extends BaseRequestBuilder<MembersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/engagementrole-list-members?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/engagementrole-post-members?view=graph-rest-1.0|Find more info here}
     */
...
export const MembersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/employeeExperience/roles/{engagementRole%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/employeeExperience/roles/{engagementRole%2Did}/members",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
