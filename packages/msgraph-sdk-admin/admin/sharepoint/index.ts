...
// @ts-ignore
import { createSharepointFromDiscriminatorValue, serializeSharepoint, type Sharepoint } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const SharepointRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/admin/sharepoint{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
