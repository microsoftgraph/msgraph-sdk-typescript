...
// @ts-ignore
import { createServiceUpdateMessageFromDiscriminatorValue, serializeServiceUpdateMessage, type ServiceUpdateMessage } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { AttachmentsArchiveRequestBuilderRequestsMetadata, type AttachmentsArchiveRequestBuilder } from './attachmentsArchive/index.js';
// @ts-ignore
...
export const ServiceUpdateMessageItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
