 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/admin/teams/userConfigurations/{teamsUserConfiguration%2Did}/user/mailboxSettings{?%24expand,%24select}";
/**
