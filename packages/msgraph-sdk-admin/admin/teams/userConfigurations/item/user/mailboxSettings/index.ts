...
export const MailboxSettingsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/admin/teams/userConfigurations/{teamsUserConfiguration%2Did}/user/mailboxSettings{?%24expand,%24select}",
    ...
    patch: {
        uriTemplate: "{+baseurl}/admin/teams/userConfigurations/{teamsUserConfiguration%2Did}/user/mailboxSettings",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
