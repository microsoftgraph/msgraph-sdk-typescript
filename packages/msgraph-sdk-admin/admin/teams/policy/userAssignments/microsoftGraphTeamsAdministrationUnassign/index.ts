 ...
 */
// @ts-ignore
export function createUnassignPostRequestBodyFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function deserializeIntoUnassignPostRequestBody(unassignPostRequestBody: Partial<UnassignPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "backingStoreEnabled": n => { unassignPostRequestBody.backingStoreEnabled = true; },
        "value": n => { unassignPostRequestBody.value = n.getCollectionOfObjectValues<TeamsPolicyUserAssignment>(createTeamsPolicyUserAssignmentFromDiscriminatorValue); },
    }
}
/**
 ...
 */
// @ts-ignore
export function serializeUnassignPostRequestBody(writer: SerializationWriter, unassignPostRequestBody: Partial<UnassignPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!unassignPostRequestBody || isSerializingDerivedType) { return; }
    writer.writeCollectionOfObjectValues<TeamsPolicyUserAssignment>("value", unassignPostRequestBody.value, serializeTeamsPolicyUserAssignment);
 ...
 */
export const MicrosoftGraphTeamsAdministrationUnassignRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
