...
// @ts-ignore
import { createMailboxCollectionResponseFromDiscriminatorValue, createMailboxFromDiscriminatorValue, serializeMailbox, type Mailbox, type MailboxCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const MailboxesRequestBuilderUriTemplate = "";
/**
...
export const MailboxesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/admin/exchange/mailboxes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/admin/exchange/mailboxes",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
