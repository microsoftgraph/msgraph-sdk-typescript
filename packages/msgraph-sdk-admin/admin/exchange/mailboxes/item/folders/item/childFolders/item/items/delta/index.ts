...
// @ts-ignore
import { createMailboxItemFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeMailboxItem, type BaseDeltaFunctionResponse, type MailboxItem } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoDeltaGetResponse(deltaGetResponse: Partial<DeltaGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { deltaGetResponse.value = n.getCollectionOfObjectValues<MailboxItem>(createMailboxItemFromDiscriminatorValue); },
    }
}
/**
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/childFolders/{mailboxFolder%2Did1}/items/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
