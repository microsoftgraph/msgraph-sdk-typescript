...
// @ts-ignore
import { createMailboxFolderFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeMailboxFolder, type BaseDeltaFunctionResponse, type MailboxFolder } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoDeltaGetResponse(deltaGetResponse: Partial<DeltaGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { deltaGetResponse.value = n.getCollectionOfObjectValues<MailboxFolder>(createMailboxFolderFromDiscriminatorValue); },
    }
}
/**
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
