...
// @ts-ignore
import { createProfileCardPropertyFromDiscriminatorValue, serializeProfileCardProperty, type ProfileCardProperty } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const ProfileCardPropertyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/admin/people/profileCardProperties/{profileCardProperty%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
