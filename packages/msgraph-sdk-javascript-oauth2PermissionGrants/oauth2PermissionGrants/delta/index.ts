...
import { createOAuth2PermissionGrantFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeOAuth2PermissionGrant, type BaseDeltaFunctionResponse, type OAuth2PermissionGrant } from 'oauth2PermissionGrants/models/';
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/oauth2PermissionGrants/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
