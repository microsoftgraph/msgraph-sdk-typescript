...
// @ts-ignore
import { createPrintUsageByUserFromDiscriminatorValue, serializePrintUsageByUser, type PrintUsageByUser } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const PrintUsageByUserItemRequestBuilderUriTemplate = "{+baseurl}/reports/monthlyPrintUsageByUser/{printUsageByUser%2Did}";
/**
...
export const PrintUsageByUserItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/reports/monthlyPrintUsageByUser/{printUsageByUser%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
