...
// @ts-ignore
import { createManifestFromDiscriminatorValue, serializeManifest, type Manifest } from '@microsoft/msgraph-sdk/models/partners/billing/index.js';
// @ts-ignore
 ...
 */
export const ManifestItemRequestBuilderUriTemplate = "{+baseurl}/reports/partners/billing/manifests/{manifest%2Did}";
/**
...
export const ManifestItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/reports/partners/billing/manifests/{manifest%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
