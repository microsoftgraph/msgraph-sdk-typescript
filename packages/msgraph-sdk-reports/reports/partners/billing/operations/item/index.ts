...
// @ts-ignore
import { createOperationFromDiscriminatorValue, serializeOperation, type Operation } from '@microsoft/msgraph-sdk/models/partners/billing/index.js';
// @ts-ignore
...
export const OperationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/reports/partners/billing/operations/{operation%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
