...
// @ts-ignore
import { createAzureUsageFromDiscriminatorValue, serializeAzureUsage, type AzureUsage } from '@microsoft/msgraph-sdk/models/partners/billing/index.js';
// @ts-ignore
 ...
 */
export const UsageRequestBuilderUriTemplate = "{+baseurl}/reports/partners/billing/usage";
/**
...
export const UsageRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/reports/partners/billing/usage{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
