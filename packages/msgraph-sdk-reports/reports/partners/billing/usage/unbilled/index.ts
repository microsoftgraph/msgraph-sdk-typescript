...
// @ts-ignore
import { createUnbilledUsageFromDiscriminatorValue, serializeUnbilledUsage, type UnbilledUsage } from '@microsoft/msgraph-sdk/models/partners/billing/index.js';
// @ts-ignore
 ...
 */
export const UnbilledRequestBuilderUriTemplate = "{+baseurl}/reports/partners/billing/usage/unbilled";
/**
...
export const UnbilledRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/reports/partners/billing/usage/unbilled{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
