...
// @ts-ignore
import { AttributeSetObject, BillingPeriodObject, createOperationFromDiscriminatorValue, serializeOperation, type AttributeSet, type BillingPeriod, type Operation } from '@microsoft/msgraph-sdk/models/partners/billing/index.js';
// @ts-ignore
...
export interface MicrosoftGraphPartnersBillingExportRequestBuilder extends BaseRequestBuilder<MicrosoftGraphPartnersBillingExportRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/partners-billing-unbilledreconciliation-export?view=graph-rest-1.0|Find more info here}
     */
