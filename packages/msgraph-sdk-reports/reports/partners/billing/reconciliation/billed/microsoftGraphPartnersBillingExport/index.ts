...
// @ts-ignore
import { AttributeSetObject, createOperationFromDiscriminatorValue, serializeOperation, type AttributeSet, type Operation } from '@microsoft/msgraph-sdk/models/partners/billing/index.js';
// @ts-ignore
...
export interface MicrosoftGraphPartnersBillingExportRequestBuilder extends BaseRequestBuilder<MicrosoftGraphPartnersBillingExportRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/partners-billing-billedreconciliation-export?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const MicrosoftGraphPartnersBillingExportRequestBuilderUriTemplate = "{+baseurl}/reports/partners/billing/reconciliation/billed/microsoft.graph.partners.billing.export";
/**
