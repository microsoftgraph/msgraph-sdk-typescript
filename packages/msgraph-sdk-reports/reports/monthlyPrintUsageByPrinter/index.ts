 ...
 */
export const MonthlyPrintUsageByPrinterRequestBuilderUriTemplate = "";
/**
...
export const MonthlyPrintUsageByPrinterRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/reports/monthlyPrintUsageByPrinter{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/reports/monthlyPrintUsageByPrinter",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
