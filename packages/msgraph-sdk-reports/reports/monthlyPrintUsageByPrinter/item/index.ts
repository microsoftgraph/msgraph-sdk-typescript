 ...
 */
export const PrintUsageByPrinterItemRequestBuilderUriTemplate = "{+baseurl}/reports/monthlyPrintUsageByPrinter/{printUsageByPrinter%2Did}";
/**
...
export const PrintUsageByPrinterItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/reports/monthlyPrintUsageByPrinter/{printUsageByPrinter%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
