...
// @ts-ignore
import { createAuthenticationMethodsRootFromDiscriminatorValue, serializeAuthenticationMethodsRoot, type AuthenticationMethodsRoot } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AuthenticationMethodsRequestBuilderUriTemplate = "{+baseurl}/reports/authenticationMethods";
/**
...
export const AuthenticationMethodsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/reports/authenticationMethods{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
