...
// @ts-ignore
import { createUserRegistrationDetailsCollectionResponseFromDiscriminatorValue, createUserRegistrationDetailsFromDiscriminatorValue, serializeUserRegistrationDetails, type UserRegistrationDetails, type UserRegistrationDetailsCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const UserRegistrationDetailsRequestBuilderUriTemplate = "";
/**
...
export const UserRegistrationDetailsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/reports/authenticationMethods/userRegistrationDetails{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/reports/authenticationMethods/userRegistrationDetails",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
