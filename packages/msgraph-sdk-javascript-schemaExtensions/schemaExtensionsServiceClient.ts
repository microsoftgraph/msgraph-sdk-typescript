...
export function newSchemaExtensionsServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<SchemaExtensionsServiceClient>(requestAdapter, pathParameters, SchemaExtensionsServiceClientUriTemplate, SchemaExtensionsServiceClientNavigationMetadata, undefined);
}
/**
