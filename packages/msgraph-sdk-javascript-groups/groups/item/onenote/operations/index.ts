...
import { createOnenoteOperationCollectionResponseFromDiscriminatorValue, createOnenoteOperationFromDiscriminatorValue, serializeOnenoteOperation, type OnenoteOperation, type OnenoteOperationCollectionResponse } from 'groups/models/';
 ...
 */
export const OperationsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/onenote/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
