 ...
 */
export const OnenotePatchContentRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/onenotePatchContent";
/* tslint:enable */
/* eslint-enable */
