 ...
 */
export const CreateUploadSessionRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/attachments/createUploadSession";
/* tslint:enable */
/* eslint-enable */
