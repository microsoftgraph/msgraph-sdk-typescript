...
import { createCalendarFromDiscriminatorValue, type Calendar } from 'groups/models/';
 ...
 */
export const CalendarRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/calendar{?%24select}";
/* tslint:enable */
/* eslint-enable */
