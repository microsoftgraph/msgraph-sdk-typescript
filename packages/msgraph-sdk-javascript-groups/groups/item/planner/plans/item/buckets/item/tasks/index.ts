...
import { createPlannerTaskCollectionResponseFromDiscriminatorValue, createPlannerTaskFromDiscriminatorValue, serializePlannerTask, type PlannerTask, type PlannerTaskCollectionResponse } from 'groups/models/';
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
