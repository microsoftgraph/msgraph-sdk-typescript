...
import { createConversationThreadCollectionResponseFromDiscriminatorValue, createConversationThreadFromDiscriminatorValue, serializeConversationThread, type ConversationThread, type ConversationThreadCollectionResponse } from 'groups/models/';
 ...
 */
export const ThreadsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
