...
import { createChatMessageCollectionResponseFromDiscriminatorValue, createChatMessageFromDiscriminatorValue, serializeChatMessage, type ChatMessage, type ChatMessageCollectionResponse } from 'groups/models/';
 ...
 */
export const RepliesRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
