...
import { createChatMessageFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeChatMessage, type BaseCollectionPaginationCountResponse, type ChatMessage } from 'groups/models/';
 ...
 */
export const GetAllMessagesRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/team/channels/getAllMessages(){?model*,%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
