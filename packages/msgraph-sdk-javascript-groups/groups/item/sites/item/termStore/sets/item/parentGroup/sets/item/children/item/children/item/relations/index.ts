...
import { createRelationCollectionResponseFromDiscriminatorValue, createRelationFromDiscriminatorValue, serializeRelation, type Relation, type RelationCollectionResponse } from 'groups/models/termStore/';
 ...
 */
export const RelationsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
