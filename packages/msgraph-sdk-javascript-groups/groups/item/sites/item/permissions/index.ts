...
import { createPermissionCollectionResponseFromDiscriminatorValue, createPermissionFromDiscriminatorValue, serializePermission, type Permission, type PermissionCollectionResponse } from 'groups/models/';
 ...
 */
export const PermissionsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/permissions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
