...
import { createDriveCollectionResponseFromDiscriminatorValue, type DriveCollectionResponse } from '@microsoft/msgraph-sdk-javascript/models/';
 ...
 */
export const DrivesRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/drives{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
