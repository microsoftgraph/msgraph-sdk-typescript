...
import { createOnenoteSectionCollectionResponseFromDiscriminatorValue, createOnenoteSectionFromDiscriminatorValue, serializeOnenoteSection, type OnenoteSection, type OnenoteSectionCollectionResponse } from 'groups/models/';
 ...
 */
export const SectionsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
