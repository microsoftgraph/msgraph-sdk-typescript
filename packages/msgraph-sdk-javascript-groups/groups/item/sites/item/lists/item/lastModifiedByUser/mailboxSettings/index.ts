...
import { createMailboxSettingsFromDiscriminatorValue, serializeMailboxSettings, type MailboxSettings } from 'groups/models/';
 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/lastModifiedByUser/mailboxSettings{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
