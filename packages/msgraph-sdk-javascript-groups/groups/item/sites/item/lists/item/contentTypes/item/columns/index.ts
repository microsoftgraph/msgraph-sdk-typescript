...
import { createColumnDefinitionCollectionResponseFromDiscriminatorValue, createColumnDefinitionFromDiscriminatorValue, serializeColumnDefinition, type ColumnDefinition, type ColumnDefinitionCollectionResponse } from 'groups/models/';
 ...
 */
export const ColumnsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
