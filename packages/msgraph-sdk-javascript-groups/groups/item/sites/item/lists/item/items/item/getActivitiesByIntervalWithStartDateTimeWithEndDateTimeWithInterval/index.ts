...
import { createItemActivityStatFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeItemActivityStat, type BaseCollectionPaginationCountResponse, type ItemActivityStat } from 'groups/models/';
 ...
 */
export const GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/getActivitiesByInterval(startDateTime='{startDateTime}',endDateTime='{endDateTime}',interval='{interval}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
