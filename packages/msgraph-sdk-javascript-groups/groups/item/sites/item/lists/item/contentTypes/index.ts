...
import { createContentTypeCollectionResponseFromDiscriminatorValue, createContentTypeFromDiscriminatorValue, serializeContentType, type ContentType, type ContentTypeCollectionResponse } from '@microsoft/msgraph-sdk-javascript/models/';
 ...
 */
export const ContentTypesRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
