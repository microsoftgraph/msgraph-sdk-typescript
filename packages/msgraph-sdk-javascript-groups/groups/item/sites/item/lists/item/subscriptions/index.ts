...
import { createSubscriptionCollectionResponseFromDiscriminatorValue, createSubscriptionFromDiscriminatorValue, serializeSubscription, type Subscription, type SubscriptionCollectionResponse } from 'groups/models/';
 ...
 */
export const SubscriptionsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
