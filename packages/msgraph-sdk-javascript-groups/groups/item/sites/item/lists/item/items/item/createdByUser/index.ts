 ...
 */
export const CreatedByUserRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/createdByUser{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
