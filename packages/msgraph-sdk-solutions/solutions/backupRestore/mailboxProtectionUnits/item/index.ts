 ...
 */
export const MailboxProtectionUnitItemRequestBuilderUriTemplate = "{+baseurl}/solutions/backupRestore/mailboxProtectionUnits/{mailboxProtectionUnit%2Did}";
/**
...
export const MailboxProtectionUnitItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/solutions/backupRestore/mailboxProtectionUnits/{mailboxProtectionUnit%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
