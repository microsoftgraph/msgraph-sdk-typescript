 ...
 */
export const GraphDriveProtectionUnitRequestBuilderNavigationMetadata: Record<Exclude<keyof GraphDriveProtectionUnitRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    count: {
