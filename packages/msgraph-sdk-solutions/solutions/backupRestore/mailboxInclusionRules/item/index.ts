...
// @ts-ignore
import { createMailboxProtectionRuleFromDiscriminatorValue, serializeMailboxProtectionRule, type MailboxProtectionRule } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const MailboxProtectionRuleItemRequestBuilderUriTemplate = "{+baseurl}/solutions/backupRestore/mailboxInclusionRules/{mailboxProtectionRule%2Did}";
/**
...
export const MailboxProtectionRuleItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/solutions/backupRestore/mailboxInclusionRules/{mailboxProtectionRule%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
