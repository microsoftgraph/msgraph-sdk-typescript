...
// @ts-ignore
import { createDriveProtectionRuleCollectionResponseFromDiscriminatorValue, createDriveProtectionRuleFromDiscriminatorValue, serializeDriveProtectionRule, type DriveProtectionRule, type DriveProtectionRuleCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export interface DriveInclusionRulesRequestBuilder extends BaseRequestBuilder<DriveInclusionRulesRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     */
     post(body: DriveProtectionRule, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DriveProtectionRule | undefined>;
    /**
     * The list of drive inclusion rules applied to the tenant.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     * @returns {RequestInformation}
     */
     toPostRequestInformation(body: DriveProtectionRule, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * The list of drive inclusion rules applied to the tenant.
 */
 ...
 */
export const DriveInclusionRulesRequestBuilderUriTemplate = "";
/**
...
export const DriveInclusionRulesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/solutions/backupRestore/driveInclusionRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/solutions/backupRestore/driveInclusionRules",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
        ...
        requestBodySerializer: serializeDriveProtectionRule,
