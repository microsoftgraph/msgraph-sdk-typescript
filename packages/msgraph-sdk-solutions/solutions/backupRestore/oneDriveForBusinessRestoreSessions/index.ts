 ...
 */
export const OneDriveForBusinessRestoreSessionsRequestBuilderUriTemplate = "";
/**
...
export const OneDriveForBusinessRestoreSessionsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/solutions/backupRestore/oneDriveForBusinessRestoreSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/solutions/backupRestore/oneDriveForBusinessRestoreSessions",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
