...
// @ts-ignore
import { createRestorePointFromDiscriminatorValue, serializeRestorePoint, type RestorePoint } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const RestorePointItemRequestBuilderUriTemplate = "{+baseurl}/solutions/backupRestore/restorePoints/{restorePoint%2Did}";
/**
...
export const RestorePointItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/solutions/backupRestore/restorePoints/{restorePoint%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
