...
// @ts-ignore
import { createBookingStaffMemberBaseFromDiscriminatorValue, serializeBookingStaffMemberBase, type BookingStaffMemberBase } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const BookingStaffMemberBaseItemRequestBuilderUriTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/staffMembers/{bookingStaffMemberBase%2Did}";
/**
...
export const BookingStaffMemberBaseItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/staffMembers/{bookingStaffMemberBase%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
