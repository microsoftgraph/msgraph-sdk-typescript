...
// @ts-ignore
import { createVirtualEventWebinarCollectionResponseFromDiscriminatorValue, createVirtualEventWebinarFromDiscriminatorValue, serializeVirtualEventWebinar, type VirtualEventWebinar, type VirtualEventWebinarCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { type VirtualEventWebinarItemRequestBuilder, VirtualEventWebinarItemRequestBuilderNavigationMetadata, VirtualEventWebinarItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export const WebinarsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/solutions/virtualEvents/webinars{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/solutions/virtualEvents/webinars",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
