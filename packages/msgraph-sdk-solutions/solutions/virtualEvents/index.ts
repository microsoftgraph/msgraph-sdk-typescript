...
// @ts-ignore
import { createVirtualEventsRootFromDiscriminatorValue, serializeVirtualEventsRoot, type VirtualEventsRoot } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const VirtualEventsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/solutions/virtualEvents{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
