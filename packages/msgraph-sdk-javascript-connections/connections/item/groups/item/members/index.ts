...
import { createIdentityCollectionResponseFromDiscriminatorValue, createIdentityFromDiscriminatorValue, serializeIdentity, type Identity, type IdentityCollectionResponse } from '@microsoft/msgraph-sdk-javascript/models/externalConnectors/';
