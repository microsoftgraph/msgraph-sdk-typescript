...
// @ts-ignore
import { createSubcategoryTemplateCollectionResponseFromDiscriminatorValue, createSubcategoryTemplateFromDiscriminatorValue, serializeSubcategoryTemplate, type SubcategoryTemplate, type SubcategoryTemplateCollectionResponse } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { SubcategoryTemplateItemRequestBuilderRequestsMetadata, type SubcategoryTemplateItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const SubcategoriesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}/subcategories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}/subcategories",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
