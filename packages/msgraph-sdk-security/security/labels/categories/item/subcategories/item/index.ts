...
// @ts-ignore
import { createSubcategoryTemplateFromDiscriminatorValue, serializeSubcategoryTemplate, type SubcategoryTemplate } from '@microsoft/msgraph-sdk/models/security/';
// @ts-ignore
