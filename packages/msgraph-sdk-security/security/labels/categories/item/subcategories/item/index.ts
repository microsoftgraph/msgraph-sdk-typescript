...
// @ts-ignore
import { createSubcategoryTemplateFromDiscriminatorValue, serializeSubcategoryTemplate, type SubcategoryTemplate } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const SubcategoryTemplateItemRequestBuilderUriTemplate = "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}/subcategories/{subcategoryTemplate%2Did}";
/**
...
export const SubcategoryTemplateItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}/subcategories/{subcategoryTemplate%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
