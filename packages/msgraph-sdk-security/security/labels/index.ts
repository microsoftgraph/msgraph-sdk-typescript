...
// @ts-ignore
import { createLabelsRootFromDiscriminatorValue, serializeLabelsRoot, type LabelsRoot } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
import { AuthoritiesRequestBuilderNavigationMetadata, AuthoritiesRequestBuilderRequestsMetadata, type AuthoritiesRequestBuilder } from './authorities/index.js';
// @ts-ignore
...
// @ts-ignore
import { CitationsRequestBuilderNavigationMetadata, CitationsRequestBuilderRequestsMetadata, type CitationsRequestBuilder } from './citations/index.js';
// @ts-ignore
...
// @ts-ignore
import { FilePlanReferencesRequestBuilderNavigationMetadata, FilePlanReferencesRequestBuilderRequestsMetadata, type FilePlanReferencesRequestBuilder } from './filePlanReferences/index.js';
// @ts-ignore
import { RetentionLabelsRequestBuilderNavigationMetadata, RetentionLabelsRequestBuilderRequestsMetadata, type RetentionLabelsRequestBuilder } from './retentionLabels/index.js';
// @ts-ignore
...
export const LabelsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/labels{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
