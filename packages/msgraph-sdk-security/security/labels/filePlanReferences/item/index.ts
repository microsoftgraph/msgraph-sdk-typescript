...
// @ts-ignore
import { createFilePlanReferenceTemplateFromDiscriminatorValue, serializeFilePlanReferenceTemplate, type FilePlanReferenceTemplate } from '@microsoft/msgraph-sdk/models/security/';
// @ts-ignore
