...
// @ts-ignore
import { createArtifactFromDiscriminatorValue, type Artifact } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const ArtifactRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord%2Did}/artifact{?%24expand,%24select}";
/**
