...
// @ts-ignore
import { createHostComponentFromDiscriminatorValue, serializeHostComponent, type HostComponent } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const HostComponentItemRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/hostComponents/{hostComponent%2Did}";
/**
...
export const HostComponentItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/hostComponents/{hostComponent%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
