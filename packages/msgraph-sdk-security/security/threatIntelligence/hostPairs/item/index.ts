...
// @ts-ignore
import { createHostPairFromDiscriminatorValue, serializeHostPair, type HostPair } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
import { ChildHostRequestBuilderRequestsMetadata, type ChildHostRequestBuilder } from './childHost/index.js';
// @ts-ignore
...
export const HostPairItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/hostPairs/{hostPair%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
