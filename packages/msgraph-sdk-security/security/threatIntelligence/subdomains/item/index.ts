 ...
 */
export const SubdomainItemRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/subdomains/{subdomain%2Did}";
/**
...
export const SubdomainItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/subdomains/{subdomain%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
