...
// @ts-ignore
import { createWhoisRecordFromDiscriminatorValue, serializeWhoisRecord, type WhoisRecord } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
...
export const WhoisRecordItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/whoisRecords/{whoisRecord%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
