...
// @ts-ignore
import { createArticleIndicatorFromDiscriminatorValue, serializeArticleIndicator, type ArticleIndicator } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
...
export const ArticleIndicatorItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/articleIndicators/{articleIndicator%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
