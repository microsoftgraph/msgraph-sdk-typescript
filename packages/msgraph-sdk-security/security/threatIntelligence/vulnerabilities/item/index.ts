...
// @ts-ignore
import { createVulnerabilityFromDiscriminatorValue, serializeVulnerability, type Vulnerability } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const VulnerabilityItemRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/vulnerabilities/{vulnerability%2Did}";
/**
...
export const VulnerabilityItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/vulnerabilities/{vulnerability%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
