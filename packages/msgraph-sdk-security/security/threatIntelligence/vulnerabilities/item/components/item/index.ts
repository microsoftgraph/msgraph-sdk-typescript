...
// @ts-ignore
import { createVulnerabilityComponentFromDiscriminatorValue, serializeVulnerabilityComponent, type VulnerabilityComponent } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
