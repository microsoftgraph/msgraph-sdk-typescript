...
// @ts-ignore
import { createHostPairCollectionResponseFromDiscriminatorValue, type HostPairCollectionResponse } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { HostPairItemRequestBuilderRequestsMetadata, type HostPairItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const HostPairsRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/hostPairs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
