...
// @ts-ignore
import { createIntelligenceProfileIndicatorFromDiscriminatorValue, serializeIntelligenceProfileIndicator, type IntelligenceProfileIndicator } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const IntelligenceProfileIndicatorItemRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/intelligenceProfileIndicators/{intelligenceProfileIndicator%2Did}";
/**
...
export const IntelligenceProfileIndicatorItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/intelligenceProfileIndicators/{intelligenceProfileIndicator%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
