 ...
 */
export const ArticleItemRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/articles/{article%2Did}";
/**
...
export const ArticleItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/articles/{article%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
