...
// @ts-ignore
import { createArticleCollectionResponseFromDiscriminatorValue, createArticleFromDiscriminatorValue, serializeArticle, type Article, type ArticleCollectionResponse } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ArticleItemRequestBuilderNavigationMetadata, ArticleItemRequestBuilderRequestsMetadata, type ArticleItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const ArticlesRequestBuilderUriTemplate = "";
/**
...
export const ArticlesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/articles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/security/threatIntelligence/articles",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
