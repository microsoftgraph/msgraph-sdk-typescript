...
// @ts-ignore
import { createRetentionEventTypeFromDiscriminatorValue, serializeRetentionEventType, type RetentionEventType } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const RetentionEventTypeItemRequestBuilderUriTemplate = "{+baseurl}/security/triggerTypes/retentionEventTypes/{retentionEventType%2Did}";
/**
...
export const RetentionEventTypeItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/triggerTypes/retentionEventTypes/{retentionEventType%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
