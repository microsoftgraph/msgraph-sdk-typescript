...
// @ts-ignore
import { createTriggerTypesRootFromDiscriminatorValue, serializeTriggerTypesRoot, type TriggerTypesRoot } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
...
export const TriggerTypesRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/triggerTypes{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
