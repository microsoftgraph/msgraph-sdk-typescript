 ...
 */
export const SensorItemRequestBuilderUriTemplate = "{+baseurl}/security/identities/sensors/{sensor%2Did}";
/**
...
export const SensorItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/identities/sensors/{sensor%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
