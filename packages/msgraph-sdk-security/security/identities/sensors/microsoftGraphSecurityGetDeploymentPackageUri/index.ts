...
// @ts-ignore
import { createSensorDeploymentPackageFromDiscriminatorValue, type SensorDeploymentPackage } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
...
export interface MicrosoftGraphSecurityGetDeploymentPackageUriRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityGetDeploymentPackageUriRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-sensor-getdeploymentpackageuri?view=graph-rest-1.0|Find more info here}
     */
