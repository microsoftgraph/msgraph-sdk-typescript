...
// @ts-ignore
import { createEdiscoveryCaseCollectionResponseFromDiscriminatorValue, createEdiscoveryCaseFromDiscriminatorValue, serializeEdiscoveryCase, type EdiscoveryCase, type EdiscoveryCaseCollectionResponse } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { EdiscoveryCaseItemRequestBuilderNavigationMetadata, EdiscoveryCaseItemRequestBuilderRequestsMetadata, type EdiscoveryCaseItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const EdiscoveryCasesRequestBuilderUriTemplate = "";
/**
...
export const EdiscoveryCasesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/security/cases/ediscoveryCases{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/security/cases/ediscoveryCases",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
