...
// @ts-ignore
import { createCaseOperationCollectionResponseFromDiscriminatorValue, createCaseOperationFromDiscriminatorValue, serializeCaseOperation, type CaseOperation, type CaseOperationCollectionResponse } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
...
export const OperationsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/operations",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
