...
// @ts-ignore
import { AdditionalDataOptions, AdditionalDataOptionsObject, createEdiscoverySearchFromDiscriminatorValue, serializeEdiscoverySearch, type EdiscoverySearch } from '@microsoft/msgraph-sdk/models/security/';
// @ts-ignore
