...
// @ts-ignore
import { createUserSourceFromDiscriminatorValue, serializeUserSource, type UserSource } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
...
export interface UserSourceItemRequestBuilder extends BaseRequestBuilder<UserSourceItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycustodian-delete-usersources?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const UserSourceItemRequestBuilderUriTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/userSources/{userSource%2Did}";
/**
...
export const UserSourceItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/userSources/{userSource%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
