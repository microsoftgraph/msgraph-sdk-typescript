 ...
 */
export const LandingPageItemRequestBuilderUriTemplate = "{+baseurl}/security/attackSimulation/landingPages/{landingPage%2Did}";
/**
...
export const LandingPageItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/attackSimulation/landingPages/{landingPage%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
