...
// @ts-ignore
import { createCollaborationRootFromDiscriminatorValue, serializeCollaborationRoot, type CollaborationRoot } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
import { AnalyzedEmailsRequestBuilderNavigationMetadata, AnalyzedEmailsRequestBuilderRequestsMetadata, type AnalyzedEmailsRequestBuilder } from './analyzedEmails/index.js';
// @ts-ignore
...
export interface CollaborationRequestBuilder extends BaseRequestBuilder<CollaborationRequestBuilder> {
     ...
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<CollaborationRoot>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     */
