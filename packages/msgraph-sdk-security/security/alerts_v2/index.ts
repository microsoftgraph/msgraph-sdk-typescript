...
// @ts-ignore
import { createAlertCollectionResponseFromDiscriminatorValue, createAlertFromDiscriminatorValue, serializeAlert, type Alert, type AlertCollectionResponse } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
...
export const Alerts_v2RequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/security/alerts_v2{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/security/alerts_v2",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
