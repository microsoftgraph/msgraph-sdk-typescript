...
// @ts-ignore
import { createAlertFromDiscriminatorValue, serializeAlert, type Alert } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const AlertItemRequestBuilderUriTemplate = "{+baseurl}/security/alerts_v2/{alert%2Did}";
/**
...
export const AlertItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/alerts_v2/{alert%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
