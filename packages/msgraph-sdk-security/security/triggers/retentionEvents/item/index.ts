...
// @ts-ignore
import { createRetentionEventFromDiscriminatorValue, serializeRetentionEvent, type RetentionEvent } from '@microsoft/msgraph-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const RetentionEventItemRequestBuilderUriTemplate = "{+baseurl}/security/triggers/retentionEvents/{retentionEvent%2Did}";
/**
...
export const RetentionEventItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/security/triggers/retentionEvents/{retentionEvent%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
