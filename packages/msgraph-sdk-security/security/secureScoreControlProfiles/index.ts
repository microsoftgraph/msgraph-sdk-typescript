...
// @ts-ignore
import { createSecureScoreControlProfileCollectionResponseFromDiscriminatorValue, createSecureScoreControlProfileFromDiscriminatorValue, serializeSecureScoreControlProfile, type SecureScoreControlProfile, type SecureScoreControlProfileCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { SecureScoreControlProfileItemRequestBuilderRequestsMetadata, type SecureScoreControlProfileItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const SecureScoreControlProfilesRequestBuilderUriTemplate = "";
/**
...
export const SecureScoreControlProfilesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/security/secureScoreControlProfiles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/security/secureScoreControlProfiles",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
