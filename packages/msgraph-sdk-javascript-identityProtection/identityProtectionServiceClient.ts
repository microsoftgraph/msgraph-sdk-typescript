...
export function newIdentityProtectionServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<IdentityProtectionServiceClient>(requestAdapter, pathParameters, IdentityProtectionServiceClientUriTemplate, IdentityProtectionServiceClientNavigationMetadata, undefined);
}
/**
