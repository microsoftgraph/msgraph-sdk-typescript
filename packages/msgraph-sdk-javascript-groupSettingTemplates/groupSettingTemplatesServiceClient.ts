...
export function newGroupSettingTemplatesServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<GroupSettingTemplatesServiceClient>(requestAdapter, pathParameters, GroupSettingTemplatesServiceClientUriTemplate, GroupSettingTemplatesServiceClientNavigationMetadata, undefined);
}
/**
