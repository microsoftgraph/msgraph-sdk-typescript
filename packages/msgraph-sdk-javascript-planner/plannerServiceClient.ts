...
export function createPlannerServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<PlannerServiceClient>(requestAdapter, pathParameters, PlannerServiceClientUriTemplate, PlannerServiceClientNavigationMetadata, undefined);
}
/**
