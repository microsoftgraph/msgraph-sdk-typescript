...
import { createPlannerTaskDetailsFromDiscriminatorValue, serializePlannerTaskDetails, type PlannerTaskDetails } from 'planner/models/';
 ...
 */
export const DetailsRequestBuilderUriTemplate = "{+baseurl}/planner/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/details{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
