...
import { createPlannerBucketCollectionResponseFromDiscriminatorValue, createPlannerBucketFromDiscriminatorValue, serializePlannerBucket, type PlannerBucket, type PlannerBucketCollectionResponse } from 'planner/models/';
 ...
 */
export const BucketsRequestBuilderUriTemplate = "{+baseurl}/planner/plans/{plannerPlan%2Did}/buckets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
