...
import { createPlannerTaskCollectionResponseFromDiscriminatorValue, createPlannerTaskFromDiscriminatorValue, serializePlannerTask, type PlannerTask, type PlannerTaskCollectionResponse } from 'planner/models/';
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
