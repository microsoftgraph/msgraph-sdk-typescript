...
import { createPlannerTaskFromDiscriminatorValue, serializePlannerTask, type PlannerTask } from 'planner/models/';
import { createODataErrorFromDiscriminatorValue, type ODataError } from 'planner/models/oDataErrors/';
 ...
 */
export const PlannerTaskItemRequestBuilderUriTemplate = "{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
