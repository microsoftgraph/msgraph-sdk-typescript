...
import { createSetCollectionResponseFromDiscriminatorValue, createSetFromDiscriminatorValue, serializeSet, type Set, type SetCollectionResponse } from 'sites/models/termStore/';
 ...
 */
export const SetsRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did}/sets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
