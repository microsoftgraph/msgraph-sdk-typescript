 ...
 */
export const ToTermRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
