...
import { createRelationCollectionResponseFromDiscriminatorValue, createRelationFromDiscriminatorValue, serializeRelation, type Relation, type RelationCollectionResponse } from 'sites/models/termStore/';
 ...
 */
export const RelationsRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}/children/{term%2Did1}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
