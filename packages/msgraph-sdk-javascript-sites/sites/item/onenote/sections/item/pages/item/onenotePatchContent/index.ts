 ...
 */
export const OnenotePatchContentRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/onenotePatchContent";
/* tslint:enable */
/* eslint-enable */
