...
import { createMailboxSettingsFromDiscriminatorValue, serializeMailboxSettings, type MailboxSettings } from 'sites/models/';
 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/createdByUser/mailboxSettings{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
