 ...
 */
export const ChatMessageItemRequestBuilderUriTemplate = "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}";
/**
...
export const ChatMessageItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
