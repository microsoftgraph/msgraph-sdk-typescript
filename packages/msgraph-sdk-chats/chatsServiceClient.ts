...
export function createChatsServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ChatsServiceClient>(requestAdapter, pathParameters, ChatsServiceClientUriTemplate, ChatsServiceClientNavigationMetadata, undefined);
}
/**
