 ...
 */
export const DirectoryScopeRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}/directoryScope{?%24expand,%24select}";
/**
