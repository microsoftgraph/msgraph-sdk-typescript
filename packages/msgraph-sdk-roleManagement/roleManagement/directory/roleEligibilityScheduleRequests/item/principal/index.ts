 ...
 */
export const PrincipalRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/principal{?%24expand,%24select}";
/* tslint:enable */
/* eslint-enable */
