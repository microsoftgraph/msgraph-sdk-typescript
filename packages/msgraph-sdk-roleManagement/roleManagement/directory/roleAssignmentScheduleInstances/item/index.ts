...
// @ts-ignore
import { createUnifiedRoleAssignmentScheduleInstanceFromDiscriminatorValue, serializeUnifiedRoleAssignmentScheduleInstance, type UnifiedRoleAssignmentScheduleInstance } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance%2Did}";
/**
...
export const UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/roleManagement/directory/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
