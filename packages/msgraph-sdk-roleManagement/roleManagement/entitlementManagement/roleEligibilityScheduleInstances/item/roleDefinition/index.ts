...
// @ts-ignore
import { createUnifiedRoleDefinitionFromDiscriminatorValue, type UnifiedRoleDefinition } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const RoleDefinitionRequestBuilderUriTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance%2Did}/roleDefinition{?%24expand,%24select}";
/**
