...
// @ts-ignore
import { createAppScopeFromDiscriminatorValue, type AppScope } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AppScopeRequestBuilderUriTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance%2Did}/appScope{?%24expand,%24select}";
/**
