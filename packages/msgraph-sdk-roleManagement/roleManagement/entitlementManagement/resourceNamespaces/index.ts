 ...
 */
export const ResourceNamespacesRequestBuilderUriTemplate = "";
/**
...
export const ResourceNamespacesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
