 ...
 */
export const DirectoryScopeRequestBuilderUriTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleAssignments/{unifiedRoleAssignment%2Did}/directoryScope{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
