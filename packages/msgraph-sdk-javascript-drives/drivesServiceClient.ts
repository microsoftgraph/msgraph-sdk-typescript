...
export function newDrivesServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DrivesServiceClient>(requestAdapter, pathParameters, DrivesServiceClientUriTemplate, DrivesServiceClientNavigationMetadata, undefined);
}
/**
