...
import { createFieldValueSetFromDiscriminatorValue, serializeFieldValueSet, type FieldValueSet } from 'drives/models/';
 ...
 */
export const FieldsRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}/fields{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
