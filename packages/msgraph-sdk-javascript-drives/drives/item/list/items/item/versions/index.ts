...
import { createListItemVersionCollectionResponseFromDiscriminatorValue, createListItemVersionFromDiscriminatorValue, serializeListItemVersion, type ListItemVersion, type ListItemVersionCollectionResponse } from 'drives/models/';
 ...
 */
export const VersionsRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
