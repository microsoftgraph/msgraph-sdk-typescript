...
import { createMailboxSettingsFromDiscriminatorValue, serializeMailboxSettings, type MailboxSettings } from 'drives/models/';
 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/lastModifiedByUser/mailboxSettings{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
