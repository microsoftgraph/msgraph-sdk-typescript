...
import { createRichLongRunningOperationCollectionResponseFromDiscriminatorValue, createRichLongRunningOperationFromDiscriminatorValue, serializeRichLongRunningOperation, type RichLongRunningOperation, type RichLongRunningOperationCollectionResponse } from 'drives/models/';
 ...
 */
export const OperationsRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
