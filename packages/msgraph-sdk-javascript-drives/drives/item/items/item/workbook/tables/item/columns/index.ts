...
import { createWorkbookTableColumnCollectionResponseFromDiscriminatorValue, createWorkbookTableColumnFromDiscriminatorValue, serializeWorkbookTableColumn, type WorkbookTableColumn, type WorkbookTableColumnCollectionResponse } from '@microsoft/msgraph-sdk-javascript/models/';
 ...
 */
export const ColumnsRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
