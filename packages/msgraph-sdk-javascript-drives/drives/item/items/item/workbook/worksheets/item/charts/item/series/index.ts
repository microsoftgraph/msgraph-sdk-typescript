...
import { createWorkbookChartSeriesCollectionResponseFromDiscriminatorValue, createWorkbookChartSeriesFromDiscriminatorValue, serializeWorkbookChartSeries, type WorkbookChartSeries, type WorkbookChartSeriesCollectionResponse } from 'drives/models/';
 ...
 */
export const SeriesRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/series{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
