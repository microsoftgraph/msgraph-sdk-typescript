 ...
 */
export const ScopedRoleMembershipItemRequestBuilderUriTemplate = "{+baseurl}/scopedRoleMemberships/{scopedRoleMembership%2Did}";
/**
...
export const ScopedRoleMembershipItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/scopedRoleMemberships/{scopedRoleMembership%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
