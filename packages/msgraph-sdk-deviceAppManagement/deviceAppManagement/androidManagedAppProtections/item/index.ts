...
// @ts-ignore
import { createAndroidManagedAppProtectionFromDiscriminatorValue, serializeAndroidManagedAppProtection, type AndroidManagedAppProtection } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const AndroidManagedAppProtectionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
