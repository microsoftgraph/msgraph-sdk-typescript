...
// @ts-ignore
import { createIosManagedAppProtectionCollectionResponseFromDiscriminatorValue, createIosManagedAppProtectionFromDiscriminatorValue, serializeIosManagedAppProtection, type IosManagedAppProtection, type IosManagedAppProtectionCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { IosManagedAppProtectionItemRequestBuilderNavigationMetadata, IosManagedAppProtectionItemRequestBuilderRequestsMetadata, type IosManagedAppProtectionItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const IosManagedAppProtectionsRequestBuilderUriTemplate = "";
/**
...
export const IosManagedAppProtectionsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceAppManagement/iosManagedAppProtections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceAppManagement/iosManagedAppProtections",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
