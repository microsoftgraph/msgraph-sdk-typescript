...
// @ts-ignore
import { createWindowsInformationProtectionPolicyFromDiscriminatorValue, serializeWindowsInformationProtectionPolicy, type WindowsInformationProtectionPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { ExemptAppLockerFilesRequestBuilderNavigationMetadata, ExemptAppLockerFilesRequestBuilderRequestsMetadata, type ExemptAppLockerFilesRequestBuilder } from './exemptAppLockerFiles/index.js';
// @ts-ignore
import { ProtectedAppLockerFilesRequestBuilderNavigationMetadata, ProtectedAppLockerFilesRequestBuilderRequestsMetadata, type ProtectedAppLockerFilesRequestBuilder } from './protectedAppLockerFiles/index.js';
// @ts-ignore
...
export const WindowsInformationProtectionPolicyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
