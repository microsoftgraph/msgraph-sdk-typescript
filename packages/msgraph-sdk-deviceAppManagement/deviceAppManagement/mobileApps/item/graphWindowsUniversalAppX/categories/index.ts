...
// @ts-ignore
import { createMobileAppCategoryCollectionResponseFromDiscriminatorValue, type MobileAppCategoryCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CategoriesRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsUniversalAppX/categories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
