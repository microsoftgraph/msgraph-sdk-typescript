...
// @ts-ignore
import { createMicrosoftStoreForBusinessAppCollectionResponseFromDiscriminatorValue, type MicrosoftStoreForBusinessAppCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export interface GraphMicrosoftStoreForBusinessAppRequestBuilder extends BaseRequestBuilder<GraphMicrosoftStoreForBusinessAppRequestBuilder> {
     ...
     * @returns {Promise<MicrosoftStoreForBusinessAppCollectionResponse>}
