...
// @ts-ignore
import { createMobileAppCategoryCollectionResponseFromDiscriminatorValue, createMobileAppCategoryFromDiscriminatorValue, serializeMobileAppCategory, type MobileAppCategory, type MobileAppCategoryCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { MobileAppCategoryItemRequestBuilderRequestsMetadata, type MobileAppCategoryItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const MobileAppCategoriesRequestBuilderUriTemplate = "";
/**
...
export const MobileAppCategoriesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceAppManagement/mobileAppCategories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceAppManagement/mobileAppCategories",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
