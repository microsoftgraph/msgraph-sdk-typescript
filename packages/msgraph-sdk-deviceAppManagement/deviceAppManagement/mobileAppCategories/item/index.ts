...
// @ts-ignore
import { createMobileAppCategoryFromDiscriminatorValue, serializeMobileAppCategory, type MobileAppCategory } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const MobileAppCategoryItemRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileAppCategories/{mobileAppCategory%2Did}";
/**
...
export const MobileAppCategoryItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceAppManagement/mobileAppCategories/{mobileAppCategory%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
