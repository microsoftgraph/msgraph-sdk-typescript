...
// @ts-ignore
import { createManagedDeviceMobileAppConfigurationDeviceStatusFromDiscriminatorValue, serializeManagedDeviceMobileAppConfigurationDeviceStatus, type ManagedDeviceMobileAppConfigurationDeviceStatus } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}/deviceStatuses/{managedDeviceMobileAppConfigurationDeviceStatus%2Did}";
/**
...
export const ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}/deviceStatuses/{managedDeviceMobileAppConfigurationDeviceStatus%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
