...
// @ts-ignore
import { createManagedEBookAssignmentCollectionResponseFromDiscriminatorValue, createManagedEBookAssignmentFromDiscriminatorValue, serializeManagedEBookAssignment, type ManagedEBookAssignment, type ManagedEBookAssignmentCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const AssignmentsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/assignments",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
