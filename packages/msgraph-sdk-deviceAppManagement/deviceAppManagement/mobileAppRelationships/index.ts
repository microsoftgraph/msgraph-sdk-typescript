...
// @ts-ignore
import { createMobileAppRelationshipCollectionResponseFromDiscriminatorValue, createMobileAppRelationshipFromDiscriminatorValue, serializeMobileAppRelationship, type MobileAppRelationship, type MobileAppRelationshipCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const MobileAppRelationshipsRequestBuilderUriTemplate = "";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const MobileAppRelationshipsRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "count": "%24count",
    "expand": "%24expand",
    "filter": "%24filter",
    "orderby": "%24orderby",
 ...
 */
export const MobileAppRelationshipsRequestBuilderNavigationMetadata: Record<Exclude<keyof MobileAppRelationshipsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
 ...
 */
export const MobileAppRelationshipsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceAppManagement/mobileAppRelationships{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceAppManagement/mobileAppRelationships",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
