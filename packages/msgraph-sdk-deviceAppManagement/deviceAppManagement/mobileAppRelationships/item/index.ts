 ...
 */
export const MobileAppRelationshipItemRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileAppRelationships/{mobileAppRelationship%2Did}";
/**
...
export const MobileAppRelationshipItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceAppManagement/mobileAppRelationships/{mobileAppRelationship%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
