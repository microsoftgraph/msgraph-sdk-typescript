...
import { createTermsAndConditionsAssignmentCollectionResponseFromDiscriminatorValue, createTermsAndConditionsAssignmentFromDiscriminatorValue, serializeTermsAndConditionsAssignment, type TermsAndConditionsAssignment, type TermsAndConditionsAssignmentCollectionResponse } from 'deviceManagement/models/';
...
import { TermsAndConditionsAssignmentItemRequestBuilderRequestsMetadata, TermsAndConditionsAssignmentItemRequestBuilderUriTemplate, type TermsAndConditionsAssignmentItemRequestBuilder } from './item/';
...
export const AssignmentsRequestBuilderNavigationMetadata: Record<Exclude<keyof AssignmentsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byTermsAndConditionsAssignmentId: {
        uriTemplate: TermsAndConditionsAssignmentItemRequestBuilderUriTemplate,
        requestsMetadata: TermsAndConditionsAssignmentItemRequestBuilderRequestsMetadata,
        pathParametersMappings: ["termsAndConditionsAssignment%2Did"],
    },
    count: {
...
export const AssignmentsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createTermsAndConditionsAssignmentCollectionResponseFromDiscriminatorValue,
 ...
 */
export const AssignmentsRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
