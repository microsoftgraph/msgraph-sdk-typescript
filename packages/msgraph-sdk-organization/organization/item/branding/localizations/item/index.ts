...
// @ts-ignore
import { createOrganizationalBrandingLocalizationFromDiscriminatorValue, serializeOrganizationalBrandingLocalization, type OrganizationalBrandingLocalization } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const OrganizationalBrandingLocalizationItemRequestBuilderUriTemplate = "{+baseurl}/organization/{organization%2Did}/branding/localizations/{organizationalBrandingLocalization%2Did}";
/**
...
export const OrganizationalBrandingLocalizationItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/organization/{organization%2Did}/branding/localizations/{organizationalBrandingLocalization%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
