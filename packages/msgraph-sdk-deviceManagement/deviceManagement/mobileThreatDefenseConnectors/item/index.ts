...
// @ts-ignore
import { createMobileThreatDefenseConnectorFromDiscriminatorValue, serializeMobileThreatDefenseConnector, type MobileThreatDefenseConnector } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const MobileThreatDefenseConnectorItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/mobileThreatDefenseConnectors/{mobileThreatDefenseConnector%2Did}";
/**
...
export const MobileThreatDefenseConnectorItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/mobileThreatDefenseConnectors/{mobileThreatDefenseConnector%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
