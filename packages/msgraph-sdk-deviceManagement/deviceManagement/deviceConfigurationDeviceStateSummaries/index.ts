 ...
 */
export const DeviceConfigurationDeviceStateSummariesRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/deviceConfigurationDeviceStateSummaries";
/**
...
export const DeviceConfigurationDeviceStateSummariesRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/deviceConfigurationDeviceStateSummaries{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
