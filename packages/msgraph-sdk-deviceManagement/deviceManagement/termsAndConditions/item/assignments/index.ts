...
// @ts-ignore
import { createTermsAndConditionsAssignmentCollectionResponseFromDiscriminatorValue, createTermsAndConditionsAssignmentFromDiscriminatorValue, serializeTermsAndConditionsAssignment, type TermsAndConditionsAssignment, type TermsAndConditionsAssignmentCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { TermsAndConditionsAssignmentItemRequestBuilderRequestsMetadata, type TermsAndConditionsAssignmentItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const AssignmentsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/assignments",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
