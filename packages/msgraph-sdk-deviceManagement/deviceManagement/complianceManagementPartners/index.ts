...
// @ts-ignore
import { createComplianceManagementPartnerCollectionResponseFromDiscriminatorValue, createComplianceManagementPartnerFromDiscriminatorValue, serializeComplianceManagementPartner, type ComplianceManagementPartner, type ComplianceManagementPartnerCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ComplianceManagementPartnersRequestBuilderUriTemplate = "";
/**
...
export const ComplianceManagementPartnersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/complianceManagementPartners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceManagement/complianceManagementPartners",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
