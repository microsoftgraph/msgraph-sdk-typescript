...
// @ts-ignore
import { createCloudPcDeviceImageCollectionResponseFromDiscriminatorValue, createCloudPcDeviceImageFromDiscriminatorValue, serializeCloudPcDeviceImage, type CloudPcDeviceImage, type CloudPcDeviceImageCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { CloudPcDeviceImageItemRequestBuilderRequestsMetadata, type CloudPcDeviceImageItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const DeviceImagesRequestBuilderUriTemplate = "";
/**
...
export const DeviceImagesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/virtualEndpoint/deviceImages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceManagement/virtualEndpoint/deviceImages",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
