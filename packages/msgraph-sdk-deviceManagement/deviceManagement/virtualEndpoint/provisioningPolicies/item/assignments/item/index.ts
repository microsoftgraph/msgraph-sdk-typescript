...
// @ts-ignore
import { createCloudPcProvisioningPolicyAssignmentFromDiscriminatorValue, serializeCloudPcProvisioningPolicyAssignment, type CloudPcProvisioningPolicyAssignment } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CloudPcProvisioningPolicyAssignmentItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/assignments/{cloudPcProvisioningPolicyAssignment%2Did}";
/**
...
export const CloudPcProvisioningPolicyAssignmentItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/assignments/{cloudPcProvisioningPolicyAssignment%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
