 ...
 */
const AssignedUsersWithUserPrincipalNameRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "expand": "%24expand",
    "select": "%24select",
};
/**
 ...
 */
export const AssignedUsersWithUserPrincipalNameRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
