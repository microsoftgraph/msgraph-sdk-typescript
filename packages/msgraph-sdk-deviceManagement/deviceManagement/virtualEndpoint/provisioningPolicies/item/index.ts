...
// @ts-ignore
import { createCloudPcProvisioningPolicyFromDiscriminatorValue, serializeCloudPcProvisioningPolicy, type CloudPcProvisioningPolicy } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CloudPcProvisioningPolicyItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}";
/**
...
export const CloudPcProvisioningPolicyItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
