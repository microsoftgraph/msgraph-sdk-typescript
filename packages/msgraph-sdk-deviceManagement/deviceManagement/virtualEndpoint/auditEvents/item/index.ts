...
// @ts-ignore
import { createCloudPcAuditEventFromDiscriminatorValue, serializeCloudPcAuditEvent, type CloudPcAuditEvent } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CloudPcAuditEventItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/auditEvents/{cloudPcAuditEvent%2Did}";
/**
...
export const CloudPcAuditEventItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/virtualEndpoint/auditEvents/{cloudPcAuditEvent%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
