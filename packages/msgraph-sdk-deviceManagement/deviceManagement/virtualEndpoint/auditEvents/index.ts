...
// @ts-ignore
import { createCloudPcAuditEventCollectionResponseFromDiscriminatorValue, createCloudPcAuditEventFromDiscriminatorValue, serializeCloudPcAuditEvent, type CloudPcAuditEvent, type CloudPcAuditEventCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AuditEventsRequestBuilderUriTemplate = "";
/**
...
export const AuditEventsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/virtualEndpoint/auditEvents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceManagement/virtualEndpoint/auditEvents",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
