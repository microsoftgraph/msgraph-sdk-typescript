...
// @ts-ignore
import { createCloudPcUserSettingFromDiscriminatorValue, serializeCloudPcUserSetting, type CloudPcUserSetting } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export interface CloudPcUserSettingItemRequestBuilder extends BaseRequestBuilder<CloudPcUserSettingItemRequestBuilder> {
    /**
 ...
 */
const CloudPcUserSettingItemRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "expand": "%24expand",
    "select": "%24select",
};
/**
 ...
 */
export const CloudPcUserSettingItemRequestBuilderNavigationMetadata: Record<Exclude<keyof CloudPcUserSettingItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    assign: {
...
export const CloudPcUserSettingItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
