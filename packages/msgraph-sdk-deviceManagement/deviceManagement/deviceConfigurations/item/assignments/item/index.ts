...
// @ts-ignore
import { createDeviceConfigurationAssignmentFromDiscriminatorValue, serializeDeviceConfigurationAssignment, type DeviceConfigurationAssignment } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const DeviceConfigurationAssignmentItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/assignments/{deviceConfigurationAssignment%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
