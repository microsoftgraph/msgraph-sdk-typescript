...
export interface DeviceConfigurationItemRequestBuilder extends BaseRequestBuilder<DeviceConfigurationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/intune-deviceconfig-windows10generalconfiguration-delete?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @returns {Promise<DeviceConfiguration>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/intune-deviceconfig-androidgeneraldeviceconfiguration-update?view=graph-rest-1.0|Find more info here}
     */
