...
// @ts-ignore
import { createDeviceConfigurationUserOverviewFromDiscriminatorValue, serializeDeviceConfigurationUserOverview, type DeviceConfigurationUserOverview } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const UserStatusOverviewRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatusOverview";
/**
...
export const UserStatusOverviewRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatusOverview{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
