...
// @ts-ignore
import { createDeviceLogCollectionResponseCollectionResponseFromDiscriminatorValue, createDeviceLogCollectionResponseFromDiscriminatorValue, serializeDeviceLogCollectionResponse, type DeviceLogCollectionResponse, type DeviceLogCollectionResponseCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { DeviceLogCollectionResponseItemRequestBuilderNavigationMetadata, DeviceLogCollectionResponseItemRequestBuilderRequestsMetadata, type DeviceLogCollectionResponseItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const LogCollectionRequestsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/logCollectionRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/logCollectionRequests",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
