 ...
 */
export const DetectedAppItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/detectedApps/{detectedApp%2Did}";
/**
...
export const DetectedAppItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/detectedApps/{detectedApp%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
