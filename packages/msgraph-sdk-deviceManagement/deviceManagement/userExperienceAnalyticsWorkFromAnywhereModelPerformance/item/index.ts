...
// @ts-ignore
import { createUserExperienceAnalyticsWorkFromAnywhereModelPerformanceFromDiscriminatorValue, serializeUserExperienceAnalyticsWorkFromAnywhereModelPerformance, type UserExperienceAnalyticsWorkFromAnywhereModelPerformance } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const UserExperienceAnalyticsWorkFromAnywhereModelPerformanceItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsWorkFromAnywhereModelPerformance/{userExperienceAnalyticsWorkFromAnywhereModelPerformance%2Did}";
/**
...
export const UserExperienceAnalyticsWorkFromAnywhereModelPerformanceItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/userExperienceAnalyticsWorkFromAnywhereModelPerformance/{userExperienceAnalyticsWorkFromAnywhereModelPerformance%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
