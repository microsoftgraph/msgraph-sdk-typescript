...
// @ts-ignore
import { createDeviceCompliancePolicySettingStateSummaryFromDiscriminatorValue, serializeDeviceCompliancePolicySettingStateSummary, type DeviceCompliancePolicySettingStateSummary } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { DeviceComplianceSettingStatesRequestBuilderNavigationMetadata, DeviceComplianceSettingStatesRequestBuilderRequestsMetadata, type DeviceComplianceSettingStatesRequestBuilder } from './deviceComplianceSettingStates/index.js';
// @ts-ignore
 ...
 */
export const DeviceCompliancePolicySettingStateSummaryItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummary%2Did}";
/**
...
export const DeviceCompliancePolicySettingStateSummaryItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummary%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
