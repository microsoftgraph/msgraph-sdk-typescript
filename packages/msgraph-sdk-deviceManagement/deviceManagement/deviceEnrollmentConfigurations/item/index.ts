 ...
 */
export const DeviceEnrollmentConfigurationItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
