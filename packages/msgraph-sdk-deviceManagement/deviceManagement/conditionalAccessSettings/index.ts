...
// @ts-ignore
import { createOnPremisesConditionalAccessSettingsFromDiscriminatorValue, serializeOnPremisesConditionalAccessSettings, type OnPremisesConditionalAccessSettings } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const ConditionalAccessSettingsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/conditionalAccessSettings{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
