...
// @ts-ignore
import { createWindowsInformationProtectionNetworkLearningSummaryCollectionResponseFromDiscriminatorValue, createWindowsInformationProtectionNetworkLearningSummaryFromDiscriminatorValue, serializeWindowsInformationProtectionNetworkLearningSummary, type WindowsInformationProtectionNetworkLearningSummary, type WindowsInformationProtectionNetworkLearningSummaryCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const WindowsInformationProtectionNetworkLearningSummariesRequestBuilderUriTemplate = "";
/**
...
export const WindowsInformationProtectionNetworkLearningSummariesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/windowsInformationProtectionNetworkLearningSummaries{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/deviceManagement/windowsInformationProtectionNetworkLearningSummaries",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
