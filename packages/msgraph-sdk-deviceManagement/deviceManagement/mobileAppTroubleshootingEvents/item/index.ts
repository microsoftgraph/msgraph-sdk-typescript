...
// @ts-ignore
import { createMobileAppTroubleshootingEventFromDiscriminatorValue, serializeMobileAppTroubleshootingEvent, type MobileAppTroubleshootingEvent } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const MobileAppTroubleshootingEventItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
