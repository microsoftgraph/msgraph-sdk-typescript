...
// @ts-ignore
import { createAppLogCollectionRequestFromDiscriminatorValue, serializeAppLogCollectionRequest, type AppLogCollectionRequest } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const AppLogCollectionRequestItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
