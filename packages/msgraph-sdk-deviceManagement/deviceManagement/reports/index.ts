...
// @ts-ignore
import { createDeviceManagementReportsFromDiscriminatorValue, serializeDeviceManagementReports, type DeviceManagementReports } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const ReportsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/reports{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
