...
export function deserializeIntoGetReportFiltersPostRequestBody(getReportFiltersPostRequestBody: Partial<GetReportFiltersPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { getReportFiltersPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "name": n => { getReportFiltersPostRequestBody.name = n.getStringValue(); },
        "orderBy": n => { getReportFiltersPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "search": n => { getReportFiltersPostRequestBody.search = n.getStringValue(); },
        "select": n => { getReportFiltersPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
