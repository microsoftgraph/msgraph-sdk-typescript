...
// @ts-ignore
import { createUserExperienceAnalyticsMetricHistoryFromDiscriminatorValue, serializeUserExperienceAnalyticsMetricHistory, type UserExperienceAnalyticsMetricHistory } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const UserExperienceAnalyticsMetricHistoryItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsMetricHistory/{userExperienceAnalyticsMetricHistory%2Did}";
/**
...
export const UserExperienceAnalyticsMetricHistoryItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/userExperienceAnalyticsMetricHistory/{userExperienceAnalyticsMetricHistory%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
