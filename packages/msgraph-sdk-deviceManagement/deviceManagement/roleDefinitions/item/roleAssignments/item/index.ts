...
// @ts-ignore
import { createRoleAssignmentFromDiscriminatorValue, serializeRoleAssignment, type RoleAssignment } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const RoleAssignmentItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}/roleAssignments/{roleAssignment%2Did}";
/**
...
export const RoleAssignmentItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}/roleAssignments/{roleAssignment%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
