...
export function deserializeIntoDispositionReviewStage(dispositionReviewStage: Partial<DispositionReviewStage> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "backingStoreEnabled": n => { dispositionReviewStage.backingStoreEnabled = true; },
        "name": n => { dispositionReviewStage.name = n.getStringValue(); },
        "@odata.type": n => { dispositionReviewStage.odataType = n.getStringValue(); },
...
export interface DispositionReviewStage extends AdditionalDataHolder, BackedModel, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export function serializeDispositionReviewStage(writer: SerializationWriter, dispositionReviewStage: Partial<DispositionReviewStage> | undefined = {}) : void {
    ...
    writer.writeStringValue("@odata.type", dispositionReviewStage.odataType);
    ...
    writer.writeAdditionalData(dispositionReviewStage.additionalData);
}
/**
 * Serializes information the current object
 * @param writer Serialization writer to use to serialize this model
