...
// @ts-ignore
import { BinaryOperatorObject, createPublicErrorFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, deserializeIntoEntity, serializeBaseCollectionPaginationCountResponse, serializeEntity, serializePublicError, type BaseCollectionPaginationCountResponse, type BinaryOperator, type Entity, type PublicError } from '../index.js';
// @ts-ignore
