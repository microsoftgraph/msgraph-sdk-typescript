...
import { createAppConsentRequestFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeAppConsentRequest, serializeBaseCollectionPaginationCountResponse, type AppConsentRequest, type BaseCollectionPaginationCountResponse } from 'identityGovernance/models/';
...
export function serializeFilterByCurrentUserWithOnGetResponse(writer: SerializationWriter, filterByCurrentUserWithOnGetResponse: FilterByCurrentUserWithOnGetResponse | undefined = {} as FilterByCurrentUserWithOnGetResponse) : void {
    ...
    writer.writeCollectionOfObjectValues<AppConsentRequest>("value", filterByCurrentUserWithOnGetResponse.value, serializeAppConsentRequest);
}
/**
 ...
 */
export const FilterByCurrentUserWithOnRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/appConsent/appConsentRequests/filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
