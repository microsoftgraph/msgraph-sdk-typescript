...
import { createCustomTaskExtensionCallbackDataFromDiscriminatorValue, serializeCustomTaskExtensionCallbackData, type CustomTaskExtensionCallbackData } from '@microsoft/msgraph-sdk-javascript/models/identityGovernance/';
 ...
 */
export const MicrosoftGraphIdentityGovernanceResumeRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs/{run%2Did}/userProcessingResults/{userProcessingResult%2Did}/taskProcessingResults/{taskProcessingResult%2Did}/microsoft.graph.identityGovernance.resume";
/* tslint:enable */
/* eslint-enable */
