...
import { createTaskCollectionResponseFromDiscriminatorValue, createTaskFromDiscriminatorValue, serializeTask, type Task, type TaskCollectionResponse } from 'identityGovernance/models/identityGovernance/';
...
import { TaskItemRequestBuilderNavigationMetadata, TaskItemRequestBuilderRequestsMetadata, TaskItemRequestBuilderUriTemplate, type TaskItemRequestBuilder } from './item/';
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
