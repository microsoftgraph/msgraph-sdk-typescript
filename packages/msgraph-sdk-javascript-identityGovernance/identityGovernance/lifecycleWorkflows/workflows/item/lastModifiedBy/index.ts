 ...
 */
export const LastModifiedByRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/lastModifiedBy{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
