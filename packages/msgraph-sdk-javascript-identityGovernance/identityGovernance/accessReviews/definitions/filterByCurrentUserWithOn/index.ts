...
import { createAccessReviewScheduleDefinitionFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeAccessReviewScheduleDefinition, serializeBaseCollectionPaginationCountResponse, type AccessReviewScheduleDefinition, type BaseCollectionPaginationCountResponse } from 'identityGovernance/models/';
 ...
 */
export const FilterByCurrentUserWithOnRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/accessReviews/definitions/filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
