...
import { createAccessReviewStageFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeAccessReviewStage, serializeBaseCollectionPaginationCountResponse, type AccessReviewStage, type BaseCollectionPaginationCountResponse } from 'identityGovernance/models/';
 ...
 */
export const FilterByCurrentUserWithOnRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/stages/filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
