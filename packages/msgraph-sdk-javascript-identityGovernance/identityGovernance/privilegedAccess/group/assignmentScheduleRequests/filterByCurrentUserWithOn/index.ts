...
import { createPrivilegedAccessGroupAssignmentScheduleRequestFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializePrivilegedAccessGroupAssignmentScheduleRequest, type BaseCollectionPaginationCountResponse, type PrivilegedAccessGroupAssignmentScheduleRequest } from 'identityGovernance/models/';
...
export function deserializeIntoFilterByCurrentUserWithOnGetResponse(filterByCurrentUserWithOnGetResponse: FilterByCurrentUserWithOnGetResponse | undefined = {} as FilterByCurrentUserWithOnGetResponse) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { filterByCurrentUserWithOnGetResponse.value = n.getCollectionOfObjectValues<PrivilegedAccessGroupAssignmentScheduleRequest>(createPrivilegedAccessGroupAssignmentScheduleRequestFromDiscriminatorValue); },
    }
}
 ...
 */
export const FilterByCurrentUserWithOnRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleRequests/filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
