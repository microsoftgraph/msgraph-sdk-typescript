...
export function newEducationServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<EducationServiceClient>(requestAdapter, pathParameters, EducationServiceClientUriTemplate, EducationServiceClientNavigationMetadata, undefined);
}
/**
