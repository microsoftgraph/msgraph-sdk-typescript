...
import { createEducationAssignmentFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeEducationAssignment, type BaseDeltaFunctionResponse, type EducationAssignment } from 'education/models/';
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
