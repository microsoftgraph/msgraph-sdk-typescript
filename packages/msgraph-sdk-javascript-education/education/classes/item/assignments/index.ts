...
import { createEducationAssignmentCollectionResponseFromDiscriminatorValue, createEducationAssignmentFromDiscriminatorValue, serializeEducationAssignment, type EducationAssignment, type EducationAssignmentCollectionResponse } from 'education/models/';
 ...
 */
export const AssignmentsRequestBuilderUriTemplate = "{+baseurl}/education/classes/{educationClass%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
