...
import { createEducationClassFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeEducationClass, type BaseDeltaFunctionResponse, type EducationClass } from 'education/models/';
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/education/classes/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
