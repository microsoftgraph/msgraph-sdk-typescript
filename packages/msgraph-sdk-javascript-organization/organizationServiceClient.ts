 ...
 */
export function newOrganizationServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<OrganizationServiceClient>(requestAdapter, pathParameters, OrganizationServiceClientUriTemplate, OrganizationServiceClientNavigationMetadata, undefined);
}
/**
