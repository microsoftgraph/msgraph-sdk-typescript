...
import { createSubjectRightsRequestCollectionResponseFromDiscriminatorValue, createSubjectRightsRequestFromDiscriminatorValue, serializeSubjectRightsRequest, type SubjectRightsRequest, type SubjectRightsRequestCollectionResponse } from 'privacy/models/';
 ...
 */
export const SubjectRightsRequestsRequestBuilderUriTemplate = "{+baseurl}/privacy/subjectRightsRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
