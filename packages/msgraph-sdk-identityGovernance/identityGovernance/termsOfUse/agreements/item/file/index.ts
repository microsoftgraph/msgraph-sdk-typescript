...
// @ts-ignore
import { createAgreementFileFromDiscriminatorValue, serializeAgreementFile, type AgreementFile } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const FileRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/file";
/**
...
export const FileRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/file{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
