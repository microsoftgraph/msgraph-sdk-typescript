...
// @ts-ignore
import { createAgreementFileLocalizationCollectionResponseFromDiscriminatorValue, createAgreementFileLocalizationFromDiscriminatorValue, serializeAgreementFileLocalization, type AgreementFileLocalization, type AgreementFileLocalizationCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { AgreementFileLocalizationItemRequestBuilderNavigationMetadata, AgreementFileLocalizationItemRequestBuilderRequestsMetadata, type AgreementFileLocalizationItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export const FilesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/files{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/files",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
