...
// @ts-ignore
import { createAgreementFromDiscriminatorValue, serializeAgreement, type Agreement } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { AcceptancesRequestBuilderNavigationMetadata, AcceptancesRequestBuilderRequestsMetadata, type AcceptancesRequestBuilder } from './acceptances/index.js';
// @ts-ignore
 ...
 */
export const AgreementItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}";
/**
...
export const AgreementItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
