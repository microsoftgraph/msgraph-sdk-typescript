...
// @ts-ignore
import { createEntitlementManagementSettingsFromDiscriminatorValue, serializeEntitlementManagementSettings, type EntitlementManagementSettings } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const SettingsRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/settings";
/**
...
export const SettingsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/entitlementManagement/settings{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
