 ...
 */
export const AccessPackageResourceItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}{?%24expand,%24select}";
/* tslint:enable */
/* eslint-enable */
