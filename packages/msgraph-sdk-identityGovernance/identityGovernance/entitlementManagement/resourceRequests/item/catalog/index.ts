...
// @ts-ignore
import { createAccessPackageCatalogFromDiscriminatorValue, serializeAccessPackageCatalog, type AccessPackageCatalog } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { CustomWorkflowExtensionsRequestBuilderNavigationMetadata, CustomWorkflowExtensionsRequestBuilderRequestsMetadata, type CustomWorkflowExtensionsRequestBuilder } from './customWorkflowExtensions/index.js';
// @ts-ignore
import { ResourceRolesRequestBuilderNavigationMetadata, ResourceRolesRequestBuilderRequestsMetadata, type ResourceRolesRequestBuilder } from './resourceRoles/index.js';
// @ts-ignore
...
// @ts-ignore
import { ResourceScopesRequestBuilderNavigationMetadata, ResourceScopesRequestBuilderRequestsMetadata, type ResourceScopesRequestBuilder } from './resourceScopes/index.js';
// @ts-ignore
 ...
 */
export const CatalogRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}/catalog";
/**
...
export const CatalogRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}/catalog{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
