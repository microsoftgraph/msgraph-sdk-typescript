 ...
 */
export const SubjectsWithObjectIdRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/subjects(objectId='{objectId}')";
/**
...
export const SubjectsWithObjectIdRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/entitlementManagement/subjects(objectId='{objectId}'){?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
