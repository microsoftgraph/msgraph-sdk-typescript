 ...
 */
export const AccessPackageSubjectItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/subjects/{accessPackageSubject%2Did}";
/**
...
export const AccessPackageSubjectItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/entitlementManagement/subjects/{accessPackageSubject%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
