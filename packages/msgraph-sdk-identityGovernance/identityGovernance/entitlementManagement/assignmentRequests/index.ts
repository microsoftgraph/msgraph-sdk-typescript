...
// @ts-ignore
import { createAccessPackageAssignmentRequestCollectionResponseFromDiscriminatorValue, createAccessPackageAssignmentRequestFromDiscriminatorValue, serializeAccessPackageAssignmentRequest, type AccessPackageAssignmentRequest, type AccessPackageAssignmentRequestCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { AccessPackageAssignmentRequestItemRequestBuilderNavigationMetadata, AccessPackageAssignmentRequestItemRequestBuilderRequestsMetadata, type AccessPackageAssignmentRequestItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const AssignmentRequestsRequestBuilderUriTemplate = "";
/**
...
export const AssignmentRequestsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/entitlementManagement/assignmentRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/identityGovernance/entitlementManagement/assignmentRequests",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
