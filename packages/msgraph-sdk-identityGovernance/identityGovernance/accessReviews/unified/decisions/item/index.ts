 ...
 */
export const AccessReviewInstanceDecisionItemItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/accessReviews/unified/decisions/{accessReviewInstanceDecisionItem%2Did}{?%24expand,%24select}";
/**
