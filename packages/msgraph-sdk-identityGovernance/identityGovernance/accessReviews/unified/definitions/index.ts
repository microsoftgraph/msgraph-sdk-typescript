...
export interface DefinitionsRequestBuilder extends BaseRequestBuilder<DefinitionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/unifiedroot-list-definitions?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/unifiedroot-post-definitions?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const DefinitionsRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/accessReviews/unified/definitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
