...
// @ts-ignore
import { createAccessReviewStageCollectionResponseFromDiscriminatorValue, createAccessReviewStageFromDiscriminatorValue, serializeAccessReviewStage, type AccessReviewStage, type AccessReviewStageCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { AccessReviewStageItemRequestBuilderNavigationMetadata, AccessReviewStageItemRequestBuilderRequestsMetadata, type AccessReviewStageItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const StagesRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/accessReviews/unified/instances/{accessReviewInstance%2Did}/stages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
