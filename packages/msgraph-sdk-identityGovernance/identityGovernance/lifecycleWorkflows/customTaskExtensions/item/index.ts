...
// @ts-ignore
import { createCustomTaskExtensionFromDiscriminatorValue, serializeCustomTaskExtension, type CustomTaskExtension } from '@microsoft/msgraph-sdk/models/identityGovernance/index.js';
// @ts-ignore
 ...
 */
export const CustomTaskExtensionItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension%2Did}";
/**
...
export const CustomTaskExtensionItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
