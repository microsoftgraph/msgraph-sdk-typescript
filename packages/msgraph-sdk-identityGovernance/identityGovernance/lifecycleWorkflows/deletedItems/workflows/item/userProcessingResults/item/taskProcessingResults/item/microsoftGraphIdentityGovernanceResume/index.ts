...
// @ts-ignore
import { createCustomTaskExtensionCallbackDataFromDiscriminatorValue, serializeCustomTaskExtensionCallbackData, type CustomTaskExtensionCallbackData } from '@microsoft/msgraph-sdk/models/identityGovernance/';
// @ts-ignore
