 ...
 */
export const CreatedByRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/createdBy{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
