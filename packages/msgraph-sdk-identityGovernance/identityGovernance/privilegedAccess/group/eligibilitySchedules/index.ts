...
// @ts-ignore
import { createPrivilegedAccessGroupEligibilityScheduleCollectionResponseFromDiscriminatorValue, createPrivilegedAccessGroupEligibilityScheduleFromDiscriminatorValue, serializePrivilegedAccessGroupEligibilitySchedule, type PrivilegedAccessGroupEligibilitySchedule, type PrivilegedAccessGroupEligibilityScheduleCollectionResponse } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const EligibilitySchedulesRequestBuilderUriTemplate = "";
/**
...
export const EligibilitySchedulesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilitySchedules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
    ...
    post: {
        uriTemplate: "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilitySchedules",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
