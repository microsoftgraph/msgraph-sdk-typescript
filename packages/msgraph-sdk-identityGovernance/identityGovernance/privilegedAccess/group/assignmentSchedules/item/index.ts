...
// @ts-ignore
import { createPrivilegedAccessGroupAssignmentScheduleFromDiscriminatorValue, serializePrivilegedAccessGroupAssignmentSchedule, type PrivilegedAccessGroupAssignmentSchedule } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const PrivilegedAccessGroupAssignmentScheduleItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentSchedules/{privilegedAccessGroupAssignmentSchedule%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
