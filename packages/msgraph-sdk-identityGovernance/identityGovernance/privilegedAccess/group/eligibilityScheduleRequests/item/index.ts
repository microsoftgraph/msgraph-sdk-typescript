...
// @ts-ignore
import { createPrivilegedAccessGroupEligibilityScheduleRequestFromDiscriminatorValue, serializePrivilegedAccessGroupEligibilityScheduleRequest, type PrivilegedAccessGroupEligibilityScheduleRequest } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const PrivilegedAccessGroupEligibilityScheduleRequestItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilityScheduleRequests/{privilegedAccessGroupEligibilityScheduleRequest%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
