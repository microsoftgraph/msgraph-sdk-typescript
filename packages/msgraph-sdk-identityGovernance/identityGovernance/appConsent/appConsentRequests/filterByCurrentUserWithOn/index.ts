...
import { createAppConsentRequestFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeAppConsentRequest, serializeBaseCollectionPaginationCountResponse, type AppConsentRequest, type BaseCollectionPaginationCountResponse } from '@microsoft/msgraph-sdk/models/';
 ...
 */
export const FilterByCurrentUserWithOnRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/appConsent/appConsentRequests/filterByCurrentUser(on='{on}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
