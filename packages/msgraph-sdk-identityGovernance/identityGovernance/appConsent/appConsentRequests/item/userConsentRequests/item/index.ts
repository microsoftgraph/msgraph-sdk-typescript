...
// @ts-ignore
import { createUserConsentRequestFromDiscriminatorValue, serializeUserConsentRequest, type UserConsentRequest } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export const UserConsentRequestItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}/userConsentRequests/{userConsentRequest%2Did}{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
