...
// @ts-ignore
import { createUserConsentRequestFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeUserConsentRequest, type BaseCollectionPaginationCountResponse, type UserConsentRequest } from '@microsoft/msgraph-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoFilterByCurrentUserWithOnGetResponse(filterByCurrentUserWithOnGetResponse: Partial<FilterByCurrentUserWithOnGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { filterByCurrentUserWithOnGetResponse.value = n.getCollectionOfObjectValues<UserConsentRequest>(createUserConsentRequestFromDiscriminatorValue); },
    }
}
...
export interface FilterByCurrentUserWithOnRequestBuilder extends BaseRequestBuilder<FilterByCurrentUserWithOnRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/userconsentrequest-filterbycurrentuser?view=graph-rest-1.0|Find more info here}
     */
...
export function serializeFilterByCurrentUserWithOnGetResponse(writer: SerializationWriter, filterByCurrentUserWithOnGetResponse: Partial<FilterByCurrentUserWithOnGetResponse> | undefined | null = {}) : void {
    if (filterByCurrentUserWithOnGetResponse) {
        ...
        writer.writeCollectionOfObjectValues<UserConsentRequest>("value", filterByCurrentUserWithOnGetResponse.value, serializeUserConsentRequest);
    }
}
/**
 * Uri template for the request builder.
 */
export const FilterByCurrentUserWithOnRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}/userConsentRequests/filterByCurrentUser(on='{on}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
