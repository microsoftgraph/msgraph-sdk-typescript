...
// @ts-ignore
import { createUserConsentRequestFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeUserConsentRequest, type BaseCollectionPaginationCountResponse, type UserConsentRequest } from '@microsoft/msgraph-sdk/models/';
// @ts-ignore
