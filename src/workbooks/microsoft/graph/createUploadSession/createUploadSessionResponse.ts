...
export class Microsoft.graph.createUploadSessionResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["item", (o, n) => { (o as unknown as Microsoft.graph.createUploadSessionResponse).item = n.getObjectValue<DriveItemUploadableProperties>(DriveItemUploadableProperties); }],
        ]);
    };
    /**
