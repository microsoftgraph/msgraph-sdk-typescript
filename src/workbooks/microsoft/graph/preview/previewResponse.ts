...
export class Microsoft.graph.previewResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["page", (o, n) => { (o as unknown as Microsoft.graph.previewResponse).page = n.getStringValue(); }],
            ["zoom", (o, n) => { (o as unknown as Microsoft.graph.previewResponse).zoom = n.getNumberValue(); }],
        ]);
    };
    /**
