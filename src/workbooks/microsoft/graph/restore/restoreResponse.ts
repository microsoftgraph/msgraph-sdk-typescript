...
export class Microsoft.graph.restoreResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["name", (o, n) => { (o as unknown as Microsoft.graph.restoreResponse).name = n.getStringValue(); }],
            ["parentReference", (o, n) => { (o as unknown as Microsoft.graph.restoreResponse).parentReference = n.getObjectValue<ItemReference>(ItemReference); }],
        ]);
    };
    /**
