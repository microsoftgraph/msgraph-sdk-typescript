...
export class Microsoft.graph.inviteResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["expirationDateTime", (o, n) => { (o as unknown as Microsoft.graph.inviteResponse).expirationDateTime = n.getStringValue(); }],
            ["message", (o, n) => { (o as unknown as Microsoft.graph.inviteResponse).message = n.getStringValue(); }],
            ["password", (o, n) => { (o as unknown as Microsoft.graph.inviteResponse).password = n.getStringValue(); }],
            ["recipients", (o, n) => { (o as unknown as Microsoft.graph.inviteResponse).recipients = n.getCollectionOfObjectValues<DriveRecipient>(DriveRecipient); }],
            ["requireSignIn", (o, n) => { (o as unknown as Microsoft.graph.inviteResponse).requireSignIn = n.getBooleanValue(); }],
            ["roles", (o, n) => { (o as unknown as Microsoft.graph.inviteResponse).roles = n.getCollectionOfPrimitiveValues<string>(); }],
            ["sendInvitation", (o, n) => { (o as unknown as Microsoft.graph.inviteResponse).sendInvitation = n.getBooleanValue(); }],
        ]);
    };
    /**
