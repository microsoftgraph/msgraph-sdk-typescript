...
export class Microsoft.graph.validatePermissionResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["challengeToken", (o, n) => { (o as unknown as Microsoft.graph.validatePermissionResponse).challengeToken = n.getStringValue(); }],
            ["password", (o, n) => { (o as unknown as Microsoft.graph.validatePermissionResponse).password = n.getStringValue(); }],
        ]);
    };
    /**
