...
export class Microsoft.graph.checkinResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["checkInAs", (o, n) => { (o as unknown as Microsoft.graph.checkinResponse).checkInAs = n.getStringValue(); }],
            ["comment", (o, n) => { (o as unknown as Microsoft.graph.checkinResponse).comment = n.getStringValue(); }],
        ]);
    };
    /**
