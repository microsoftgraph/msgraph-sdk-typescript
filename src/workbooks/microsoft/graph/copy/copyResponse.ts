...
export class Microsoft.graph.copyResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["name", (o, n) => { (o as unknown as Microsoft.graph.copyResponse).name = n.getStringValue(); }],
            ["parentReference", (o, n) => { (o as unknown as Microsoft.graph.copyResponse).parentReference = n.getObjectValue<ItemReference>(ItemReference); }],
        ]);
    };
    /**
