...
export class WorkbooksRequestBuilder {
     ...
     */
    public get(requestConfiguration?: WorkbooksRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DriveItemCollectionResponseImpl | undefined> {
     ...
     */
    public post(body: DriveItem | undefined, requestConfiguration?: WorkbooksRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DriveItemImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
