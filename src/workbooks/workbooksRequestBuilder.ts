...
export class WorkbooksRequestBuilder {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: WorkbooksRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DriveItem | undefined, requestConfiguration?: WorkbooksRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
