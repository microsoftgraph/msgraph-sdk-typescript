...
export class ValidatePermissionResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _challengeToken?: string | undefined;
    private _password?: string | undefined;
    /**
     * Instantiates a new validatePermissionResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["challengeToken", (o, n) => { (o as unknown as ValidatePermissionResponse).challengeToken = n.getStringValue(); }],
            ["password", (o, n) => { (o as unknown as ValidatePermissionResponse).password = n.getStringValue(); }],
        ]);
    };
    /**
