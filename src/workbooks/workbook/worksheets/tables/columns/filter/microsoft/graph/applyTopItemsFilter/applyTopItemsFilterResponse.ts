...
export class Microsoft.graph.applyTopItemsFilterResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["count", (o, n) => { (o as unknown as Microsoft.graph.applyTopItemsFilterResponse).count = n.getNumberValue(); }],
        ]);
    };
    /**
