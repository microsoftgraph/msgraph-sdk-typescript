...
export class Microsoft.graph.applyCellColorFilterResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["color", (o, n) => { (o as unknown as Microsoft.graph.applyCellColorFilterResponse).color = n.getStringValue(); }],
        ]);
    };
    /**
