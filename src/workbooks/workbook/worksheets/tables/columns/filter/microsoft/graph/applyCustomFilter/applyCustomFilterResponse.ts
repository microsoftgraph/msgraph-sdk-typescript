...
export class Microsoft.graph.applyCustomFilterResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria1", (o, n) => { (o as unknown as Microsoft.graph.applyCustomFilterResponse).criteria1 = n.getStringValue(); }],
            ["criteria2", (o, n) => { (o as unknown as Microsoft.graph.applyCustomFilterResponse).criteria2 = n.getStringValue(); }],
            ["oper", (o, n) => { (o as unknown as Microsoft.graph.applyCustomFilterResponse).oper = n.getStringValue(); }],
        ]);
    };
    /**
