...
export class Microsoft.graph.applyIconFilterResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["icon", (o, n) => { (o as unknown as Microsoft.graph.applyIconFilterResponse).icon = n.getObjectValue<WorkbookIcon>(WorkbookIcon); }],
        ]);
    };
    /**
