...
export class Microsoft.graph.dataBodyRangeRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.dataBodyRangeRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.dataBodyRangeResponse
     */
