...
export class Microsoft.graph.cellRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.cellRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.cellResponse
     */
