...
import {ImageRequestBuilder} from '../../../names/worksheet/charts/image/imageRequestBuilder';
import {ImageWithWidthRequestBuilder} from '../../../names/worksheet/charts/imageWithWidth/imageWithWidthRequestBuilder';
import {ImageWithWidthWithHeightRequestBuilder} from '../../../names/worksheet/charts/imageWithWidthWithHeight/imageWithWidthWithHeightRequestBuilder';
import {ImageWithWidthWithHeightWithFittingModeRequestBuilder} from '../../../names/worksheet/charts/imageWithWidthWithHeightWithFittingMode/imageWithWidthWithHeightWithFittingModeRequestBuilder';
...
export class WorkbookChartRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.workbook.worksheets.charts.series collection
