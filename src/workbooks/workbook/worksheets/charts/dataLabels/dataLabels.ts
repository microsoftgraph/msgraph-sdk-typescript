...
export class DataLabels extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["format", (o, n) => { (o as unknown as DataLabels).format = n.getObjectValue<WorkbookChartDataLabelFormat>(WorkbookChartDataLabelFormat); }],
            ["position", (o, n) => { (o as unknown as DataLabels).position = n.getStringValue(); }],
            ["separator", (o, n) => { (o as unknown as DataLabels).separator = n.getStringValue(); }],
            ["showBubbleSize", (o, n) => { (o as unknown as DataLabels).showBubbleSize = n.getBooleanValue(); }],
            ["showCategoryName", (o, n) => { (o as unknown as DataLabels).showCategoryName = n.getBooleanValue(); }],
            ["showLegendKey", (o, n) => { (o as unknown as DataLabels).showLegendKey = n.getBooleanValue(); }],
            ["showPercentage", (o, n) => { (o as unknown as DataLabels).showPercentage = n.getBooleanValue(); }],
            ["showSeriesName", (o, n) => { (o as unknown as DataLabels).showSeriesName = n.getBooleanValue(); }],
            ["showValue", (o, n) => { (o as unknown as DataLabels).showValue = n.getBooleanValue(); }],
        ]);
    };
    /**
