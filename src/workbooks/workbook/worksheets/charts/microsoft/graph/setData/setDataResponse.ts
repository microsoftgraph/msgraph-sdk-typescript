...
export class Microsoft.graph.setDataResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["seriesBy", (o, n) => { (o as unknown as Microsoft.graph.setDataResponse).seriesBy = n.getStringValue(); }],
            ["sourceData", (o, n) => { (o as unknown as Microsoft.graph.setDataResponse).sourceData = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
