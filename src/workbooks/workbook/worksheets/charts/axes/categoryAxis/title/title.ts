...
import {WorkbookChartAxisTitleFormat} from './format/workbookChartAxisTitleFormat';
...
export class Title extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["format", (o, n) => { (o as unknown as Title).format = n.getObjectValue<WorkbookChartAxisTitleFormat>(WorkbookChartAxisTitleFormat); }],
            ["text", (o, n) => { (o as unknown as Title).text = n.getStringValue(); }],
            ["visible", (o, n) => { (o as unknown as Title).visible = n.getBooleanValue(); }],
        ]);
    };
    /**
