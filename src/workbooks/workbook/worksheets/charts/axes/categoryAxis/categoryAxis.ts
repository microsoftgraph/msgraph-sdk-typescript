...
export class CategoryAxis extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["format", (o, n) => { (o as unknown as CategoryAxis).format = n.getObjectValue<WorkbookChartAxisFormat>(WorkbookChartAxisFormat); }],
            ["majorGridlines", (o, n) => { (o as unknown as CategoryAxis).majorGridlines = n.getObjectValue<WorkbookChartGridlines>(WorkbookChartGridlines); }],
            ["majorUnit", (o, n) => { (o as unknown as CategoryAxis).majorUnit = n.getObjectValue<Json>(Json); }],
            ["maximum", (o, n) => { (o as unknown as CategoryAxis).maximum = n.getObjectValue<Json>(Json); }],
            ["minimum", (o, n) => { (o as unknown as CategoryAxis).minimum = n.getObjectValue<Json>(Json); }],
            ["minorGridlines", (o, n) => { (o as unknown as CategoryAxis).minorGridlines = n.getObjectValue<WorkbookChartGridlines>(WorkbookChartGridlines); }],
            ["minorUnit", (o, n) => { (o as unknown as CategoryAxis).minorUnit = n.getObjectValue<Json>(Json); }],
            ["title", (o, n) => { (o as unknown as CategoryAxis).title = n.getObjectValue<WorkbookChartAxisTitle>(WorkbookChartAxisTitle); }],
        ]);
    };
    /**
