...
import {WorkbookChartAxisFormat} from '../seriesAxis/format/workbookChartAxisFormat';
import {SerializationWriter, ParseNode, Parsable} from '@microsoft/kiota-abstractions';

export class ValueAxis extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["format", (o, n) => { (o as unknown as ValueAxis).format = n.getObjectValue<WorkbookChartAxisFormat>(WorkbookChartAxisFormat); }],
            ["majorGridlines", (o, n) => { (o as unknown as ValueAxis).majorGridlines = n.getObjectValue<WorkbookChartGridlines>(WorkbookChartGridlines); }],
            ["majorUnit", (o, n) => { (o as unknown as ValueAxis).majorUnit = n.getObjectValue<Json>(Json); }],
            ["maximum", (o, n) => { (o as unknown as ValueAxis).maximum = n.getObjectValue<Json>(Json); }],
            ["minimum", (o, n) => { (o as unknown as ValueAxis).minimum = n.getObjectValue<Json>(Json); }],
            ["minorGridlines", (o, n) => { (o as unknown as ValueAxis).minorGridlines = n.getObjectValue<WorkbookChartGridlines>(WorkbookChartGridlines); }],
            ["minorUnit", (o, n) => { (o as unknown as ValueAxis).minorUnit = n.getObjectValue<Json>(Json); }],
            ["title", (o, n) => { (o as unknown as ValueAxis).title = n.getObjectValue<WorkbookChartAxisTitle>(WorkbookChartAxisTitle); }],
        ]);
    };
    /**
