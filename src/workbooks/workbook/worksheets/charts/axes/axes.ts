...
export class Axes extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["categoryAxis", (o, n) => { (o as unknown as Axes).categoryAxis = n.getObjectValue<WorkbookChartAxis>(WorkbookChartAxis); }],
            ["seriesAxis", (o, n) => { (o as unknown as Axes).seriesAxis = n.getObjectValue<WorkbookChartAxis>(WorkbookChartAxis); }],
            ["valueAxis", (o, n) => { (o as unknown as Axes).valueAxis = n.getObjectValue<WorkbookChartAxis>(WorkbookChartAxis); }],
        ]);
    };
    /**
