...
export class AddResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["seriesBy", (o, n) => { (o as unknown as AddResponse).seriesBy = n.getStringValue(); }],
            ["sourceData", (o, n) => { (o as unknown as AddResponse).sourceData = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as AddResponse).type = n.getStringValue(); }],
        ]);
    };
    /**
