...
export class Title extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["format", (o, n) => { (o as unknown as Title).format = n.getObjectValue<WorkbookChartTitleFormat>(WorkbookChartTitleFormat); }],
            ["overlay", (o, n) => { (o as unknown as Title).overlay = n.getBooleanValue(); }],
