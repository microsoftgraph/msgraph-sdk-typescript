...
import {WorkbookChartLegendFormat} from './format/workbookChartLegendFormat';
...
export class Legend extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["format", (o, n) => { (o as unknown as Legend).format = n.getObjectValue<WorkbookChartLegendFormat>(WorkbookChartLegendFormat); }],
            ["overlay", (o, n) => { (o as unknown as Legend).overlay = n.getBooleanValue(); }],
            ["position", (o, n) => { (o as unknown as Legend).position = n.getStringValue(); }],
            ["visible", (o, n) => { (o as unknown as Legend).visible = n.getBooleanValue(); }],
        ]);
    };
    /**
