...
export class Microsoft.graph.calculateResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["calculationType", (o, n) => { (o as unknown as Microsoft.graph.calculateResponse).calculationType = n.getStringValue(); }],
        ]);
    };
    /**
