...
export class Beta_InvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["a", (o, n) => { (o as unknown as Beta_InvResponse).a = n.getObjectValue<Json>(Json); }],
            ["alpha", (o, n) => { (o as unknown as Beta_InvResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["b", (o, n) => { (o as unknown as Beta_InvResponse).b = n.getObjectValue<Json>(Json); }],
            ["beta", (o, n) => { (o as unknown as Beta_InvResponse).beta = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Beta_InvResponse).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
