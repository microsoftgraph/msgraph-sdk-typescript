...
export class CumPrincResponse implements Parsable {
    ...
    /**
     * Instantiates a new cumPrincResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endPeriod", (o, n) => { (o as unknown as CumPrincResponse).endPeriod = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as CumPrincResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as CumPrincResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as CumPrincResponse).rate = n.getObjectValue<Json>(Json); }],
            ["startPeriod", (o, n) => { (o as unknown as CumPrincResponse).startPeriod = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as CumPrincResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
