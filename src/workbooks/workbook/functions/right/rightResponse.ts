...
export class RightResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numChars", (o, n) => { (o as unknown as RightResponse).numChars = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as RightResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
