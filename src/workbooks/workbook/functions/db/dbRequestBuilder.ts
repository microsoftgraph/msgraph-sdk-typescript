...
export class DbRequestBuilder {
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.db";
     ...
     */
    public createPostRequestInformation(body: DbResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     * @returns a Promise of dbResponse
     */
    public post(body: DbResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
        if(!body) throw new Error("body cannot be undefined");
