...
export class DbResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as DbResponse).cost = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as DbResponse).life = n.getObjectValue<Json>(Json); }],
            ["month", (o, n) => { (o as unknown as DbResponse).month = n.getObjectValue<Json>(Json); }],
            ["period", (o, n) => { (o as unknown as DbResponse).period = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as DbResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
