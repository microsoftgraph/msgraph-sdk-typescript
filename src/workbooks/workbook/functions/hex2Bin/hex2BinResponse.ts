...
export class Hex2BinResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _number?: Json | undefined;
    private _places?: Json | undefined;
    /**
     * Instantiates a new hex2BinResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Hex2BinResponse).number = n.getObjectValue<Json>(Json); }],
            ["places", (o, n) => { (o as unknown as Hex2BinResponse).places = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
