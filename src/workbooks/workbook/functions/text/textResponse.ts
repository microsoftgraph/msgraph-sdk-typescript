...
export class TextResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["formatText", (o, n) => { (o as unknown as TextResponse).formatText = n.getObjectValue<Json>(Json); }],
            ["value", (o, n) => { (o as unknown as TextResponse).value = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
