...
export class TextRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: TextResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     * @returns a Promise of TextResponse
     */
    public post(body: TextResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
        if(!body) throw new Error("body cannot be undefined");
