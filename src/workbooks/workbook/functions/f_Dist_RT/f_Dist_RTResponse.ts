...
export class F_Dist_RTResponse implements Parsable {
    ...
    /**
     * Instantiates a new f_Dist_RTResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom1", (o, n) => { (o as unknown as F_Dist_RTResponse).degFreedom1 = n.getObjectValue<Json>(Json); }],
            ["degFreedom2", (o, n) => { (o as unknown as F_Dist_RTResponse).degFreedom2 = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as F_Dist_RTResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
