...
export class RightbResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numBytes", (o, n) => { (o as unknown as RightbResponse).numBytes = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as RightbResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
