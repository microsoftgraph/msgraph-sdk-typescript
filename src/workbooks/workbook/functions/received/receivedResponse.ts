...
export class ReceivedResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as ReceivedResponse).basis = n.getObjectValue<Json>(Json); }],
            ["discount", (o, n) => { (o as unknown as ReceivedResponse).discount = n.getObjectValue<Json>(Json); }],
            ["investment", (o, n) => { (o as unknown as ReceivedResponse).investment = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as ReceivedResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as ReceivedResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
