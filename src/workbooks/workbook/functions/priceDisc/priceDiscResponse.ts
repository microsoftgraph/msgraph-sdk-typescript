...
export class PriceDiscResponse implements Parsable {
    ...
    /**
     * Instantiates a new priceDiscResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as PriceDiscResponse).basis = n.getObjectValue<Json>(Json); }],
            ["discount", (o, n) => { (o as unknown as PriceDiscResponse).discount = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as PriceDiscResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as PriceDiscResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as PriceDiscResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
