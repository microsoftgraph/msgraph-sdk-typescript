...
export class SlnResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as SlnResponse).cost = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as SlnResponse).life = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as SlnResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
