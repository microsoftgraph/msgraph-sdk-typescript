...
export class VlookupResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["colIndexNum", (o, n) => { (o as unknown as VlookupResponse).colIndexNum = n.getObjectValue<Json>(Json); }],
            ["lookupValue", (o, n) => { (o as unknown as VlookupResponse).lookupValue = n.getObjectValue<Json>(Json); }],
            ["rangeLookup", (o, n) => { (o as unknown as VlookupResponse).rangeLookup = n.getObjectValue<Json>(Json); }],
            ["tableArray", (o, n) => { (o as unknown as VlookupResponse).tableArray = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
