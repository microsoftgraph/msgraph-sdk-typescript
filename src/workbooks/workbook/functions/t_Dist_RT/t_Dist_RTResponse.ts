...
export class T_Dist_RTResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _degFreedom?: Json | undefined;
    private _x?: Json | undefined;
    /**
     * Instantiates a new t_Dist_RTResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom", (o, n) => { (o as unknown as T_Dist_RTResponse).degFreedom = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as T_Dist_RTResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
