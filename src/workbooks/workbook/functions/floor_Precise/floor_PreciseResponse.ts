...
export class Floor_PreciseResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Floor_PreciseResponse).number = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as Floor_PreciseResponse).significance = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
