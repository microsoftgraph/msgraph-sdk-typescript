...
export class IspmtResponse implements Parsable {
    ...
    /**
     * Instantiates a new ispmtResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["nper", (o, n) => { (o as unknown as IspmtResponse).nper = n.getObjectValue<Json>(Json); }],
            ["per", (o, n) => { (o as unknown as IspmtResponse).per = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as IspmtResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as IspmtResponse).rate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
