...
export class AmorLincResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as AmorLincResponse).basis = n.getObjectValue<Json>(Json); }],
            ["cost", (o, n) => { (o as unknown as AmorLincResponse).cost = n.getObjectValue<Json>(Json); }],
            ["datePurchased", (o, n) => { (o as unknown as AmorLincResponse).datePurchased = n.getObjectValue<Json>(Json); }],
            ["firstPeriod", (o, n) => { (o as unknown as AmorLincResponse).firstPeriod = n.getObjectValue<Json>(Json); }],
            ["period", (o, n) => { (o as unknown as AmorLincResponse).period = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as AmorLincResponse).rate = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as AmorLincResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
