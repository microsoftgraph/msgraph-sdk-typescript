...
export class DiscResponse implements Parsable {
    ...
    /**
     * Instantiates a new discResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as DiscResponse).basis = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as DiscResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as DiscResponse).pr = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as DiscResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as DiscResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
