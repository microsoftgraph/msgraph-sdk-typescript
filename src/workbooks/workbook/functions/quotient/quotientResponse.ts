...
export class QuotientResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _denominator?: Json | undefined;
    private _numerator?: Json | undefined;
    /**
     * Instantiates a new quotientResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["denominator", (o, n) => { (o as unknown as QuotientResponse).denominator = n.getObjectValue<Json>(Json); }],
            ["numerator", (o, n) => { (o as unknown as QuotientResponse).numerator = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
