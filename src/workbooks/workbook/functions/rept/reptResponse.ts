...
export class ReptResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numberTimes", (o, n) => { (o as unknown as ReptResponse).numberTimes = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as ReptResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
