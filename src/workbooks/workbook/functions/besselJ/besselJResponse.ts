...
export class BesselJResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["n", (o, n) => { (o as unknown as BesselJResponse).n = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as BesselJResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
