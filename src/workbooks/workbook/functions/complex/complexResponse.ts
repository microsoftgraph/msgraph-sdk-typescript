...
export class ComplexResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["iNum", (o, n) => { (o as unknown as ComplexResponse).iNum = n.getObjectValue<Json>(Json); }],
            ["realNum", (o, n) => { (o as unknown as ComplexResponse).realNum = n.getObjectValue<Json>(Json); }],
            ["suffix", (o, n) => { (o as unknown as ComplexResponse).suffix = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
