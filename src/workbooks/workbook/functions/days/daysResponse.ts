...
export class DaysResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _endDate?: Json | undefined;
    private _startDate?: Json | undefined;
    /**
     * Instantiates a new daysResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endDate", (o, n) => { (o as unknown as DaysResponse).endDate = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as DaysResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
