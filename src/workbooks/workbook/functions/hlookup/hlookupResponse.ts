...
export class HlookupResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["lookupValue", (o, n) => { (o as unknown as HlookupResponse).lookupValue = n.getObjectValue<Json>(Json); }],
            ["rangeLookup", (o, n) => { (o as unknown as HlookupResponse).rangeLookup = n.getObjectValue<Json>(Json); }],
            ["rowIndexNum", (o, n) => { (o as unknown as HlookupResponse).rowIndexNum = n.getObjectValue<Json>(Json); }],
            ["tableArray", (o, n) => { (o as unknown as HlookupResponse).tableArray = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
