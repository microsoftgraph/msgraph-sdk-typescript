...
export class Binom_InvResponse implements Parsable {
    ...
    /**
     * Instantiates a new binom_InvResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alpha", (o, n) => { (o as unknown as Binom_InvResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["probabilityS", (o, n) => { (o as unknown as Binom_InvResponse).probabilityS = n.getObjectValue<Json>(Json); }],
            ["trials", (o, n) => { (o as unknown as Binom_InvResponse).trials = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
