...
import {DvarPResponse} from './dvarPResponse';
...
export class DvarPRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: DvarPResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: DvarPResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
        if(!body) throw new Error("body cannot be undefined");
