...
export class TrimMeanResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as TrimMeanResponse).array = n.getObjectValue<Json>(Json); }],
            ["percent", (o, n) => { (o as unknown as TrimMeanResponse).percent = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
