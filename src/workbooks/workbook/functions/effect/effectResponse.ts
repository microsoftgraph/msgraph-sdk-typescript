...
export class EffectResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["nominalRate", (o, n) => { (o as unknown as EffectResponse).nominalRate = n.getObjectValue<Json>(Json); }],
            ["npery", (o, n) => { (o as unknown as EffectResponse).npery = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
