...
export class RoundUpResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as RoundUpResponse).number = n.getObjectValue<Json>(Json); }],
            ["numDigits", (o, n) => { (o as unknown as RoundUpResponse).numDigits = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
