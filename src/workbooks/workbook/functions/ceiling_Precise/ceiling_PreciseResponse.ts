...
export class Ceiling_PreciseResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _number?: Json | undefined;
    private _significance?: Json | undefined;
    /**
     * Instantiates a new ceiling_PreciseResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Ceiling_PreciseResponse).number = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as Ceiling_PreciseResponse).significance = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
