...
export class OddFPriceResponse implements Parsable {
    ...
    /**
     * Instantiates a new oddFPriceResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as OddFPriceResponse).basis = n.getObjectValue<Json>(Json); }],
            ["firstCoupon", (o, n) => { (o as unknown as OddFPriceResponse).firstCoupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as OddFPriceResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as OddFPriceResponse).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as OddFPriceResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as OddFPriceResponse).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as OddFPriceResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as OddFPriceResponse).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as OddFPriceResponse).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
