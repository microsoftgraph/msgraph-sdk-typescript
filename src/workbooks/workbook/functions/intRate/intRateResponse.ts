...
export class IntRateResponse implements Parsable {
    ...
    /**
     * Instantiates a new intRateResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as IntRateResponse).basis = n.getObjectValue<Json>(Json); }],
            ["investment", (o, n) => { (o as unknown as IntRateResponse).investment = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as IntRateResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as IntRateResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as IntRateResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
