...
export class Atan2Response implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _xNum?: Json | undefined;
    private _yNum?: Json | undefined;
    /**
     * Instantiates a new atan2Response and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["xNum", (o, n) => { (o as unknown as Atan2Response).xNum = n.getObjectValue<Json>(Json); }],
            ["yNum", (o, n) => { (o as unknown as Atan2Response).yNum = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
