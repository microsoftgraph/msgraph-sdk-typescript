...
export class Microsoft.graph.findBResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["findText", (o, n) => { (o as unknown as Microsoft.graph.findBResponse).findText = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as Microsoft.graph.findBResponse).startNum = n.getObjectValue<Json>(Json); }],
            ["withinText", (o, n) => { (o as unknown as Microsoft.graph.findBResponse).withinText = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
