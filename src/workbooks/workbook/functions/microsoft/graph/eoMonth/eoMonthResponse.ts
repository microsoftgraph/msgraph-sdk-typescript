...
export class Microsoft.graph.eoMonthResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["months", (o, n) => { (o as unknown as Microsoft.graph.eoMonthResponse).months = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Microsoft.graph.eoMonthResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
