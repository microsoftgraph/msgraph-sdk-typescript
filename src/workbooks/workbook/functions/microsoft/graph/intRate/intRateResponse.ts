...
export class Microsoft.graph.intRateResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.intRateResponse).basis = n.getObjectValue<Json>(Json); }],
            ["investment", (o, n) => { (o as unknown as Microsoft.graph.intRateResponse).investment = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.intRateResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as Microsoft.graph.intRateResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.intRateResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
