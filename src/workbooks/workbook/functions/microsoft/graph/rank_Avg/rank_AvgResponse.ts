...
export class Microsoft.graph.rank_AvgResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.rank_AvgResponse).number = n.getObjectValue<Json>(Json); }],
            ["order", (o, n) => { (o as unknown as Microsoft.graph.rank_AvgResponse).order = n.getObjectValue<Json>(Json); }],
            ["ref", (o, n) => { (o as unknown as Microsoft.graph.rank_AvgResponse).ref = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
