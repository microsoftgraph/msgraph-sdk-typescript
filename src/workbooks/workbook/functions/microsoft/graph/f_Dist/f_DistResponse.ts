...
export class Microsoft.graph.f_DistResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.f_DistResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as Microsoft.graph.f_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["degFreedom1", (o, n) => { (o as unknown as Microsoft.graph.f_DistResponse).degFreedom1 = n.getObjectValue<Json>(Json); }],
            ["degFreedom2", (o, n) => { (o as unknown as Microsoft.graph.f_DistResponse).degFreedom2 = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.f_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
