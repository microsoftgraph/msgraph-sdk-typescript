...
export class Microsoft.graph.ceiling_MathResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mode", (o, n) => { (o as unknown as Microsoft.graph.ceiling_MathResponse).mode = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.ceiling_MathResponse).number = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as Microsoft.graph.ceiling_MathResponse).significance = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
