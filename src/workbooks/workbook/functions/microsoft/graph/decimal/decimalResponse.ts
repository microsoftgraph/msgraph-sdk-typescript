...
export class Microsoft.graph.decimalResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.decimalResponse).number = n.getObjectValue<Json>(Json); }],
            ["radix", (o, n) => { (o as unknown as Microsoft.graph.decimalResponse).radix = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
