...
export class Microsoft.graph.percentile_IncResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Microsoft.graph.percentile_IncResponse).array = n.getObjectValue<Json>(Json); }],
            ["k", (o, n) => { (o as unknown as Microsoft.graph.percentile_IncResponse).k = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
