...
export class Microsoft.graph.tbillYieldResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.tbillYieldResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as Microsoft.graph.tbillYieldResponse).pr = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.tbillYieldResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
