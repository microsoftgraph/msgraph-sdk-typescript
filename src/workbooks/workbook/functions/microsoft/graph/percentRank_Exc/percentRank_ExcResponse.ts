...
export class Microsoft.graph.percentRank_ExcResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.percentRank_ExcResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Microsoft.graph.percentRank_ExcResponse).array = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as Microsoft.graph.percentRank_ExcResponse).significance = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.percentRank_ExcResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
