...
export class Microsoft.graph.dec2HexResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _number?: Json | undefined;
    private _places?: Json | undefined;
    /**
     * Instantiates a new Microsoft.graph.dec2HexResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.dec2HexResponse).number = n.getObjectValue<Json>(Json); }],
            ["places", (o, n) => { (o as unknown as Microsoft.graph.dec2HexResponse).places = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
