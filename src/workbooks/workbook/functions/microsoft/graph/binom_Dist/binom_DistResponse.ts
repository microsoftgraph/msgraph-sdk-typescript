...
export class Microsoft.graph.binom_DistResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as Microsoft.graph.binom_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["numberS", (o, n) => { (o as unknown as Microsoft.graph.binom_DistResponse).numberS = n.getObjectValue<Json>(Json); }],
            ["probabilityS", (o, n) => { (o as unknown as Microsoft.graph.binom_DistResponse).probabilityS = n.getObjectValue<Json>(Json); }],
            ["trials", (o, n) => { (o as unknown as Microsoft.graph.binom_DistResponse).trials = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
