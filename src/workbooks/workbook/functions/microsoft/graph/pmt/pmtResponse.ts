...
export class Microsoft.graph.pmtResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as Microsoft.graph.pmtResponse).fv = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as Microsoft.graph.pmtResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as Microsoft.graph.pmtResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.pmtResponse).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as Microsoft.graph.pmtResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
