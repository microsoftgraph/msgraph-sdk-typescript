...
export class Microsoft.graph.quartile_ExcResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Microsoft.graph.quartile_ExcResponse).array = n.getObjectValue<Json>(Json); }],
            ["quart", (o, n) => { (o as unknown as Microsoft.graph.quartile_ExcResponse).quart = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
