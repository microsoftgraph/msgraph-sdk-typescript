...
export class Microsoft.graph.roundDownResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.roundDownResponse).number = n.getObjectValue<Json>(Json); }],
            ["numDigits", (o, n) => { (o as unknown as Microsoft.graph.roundDownResponse).numDigits = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
