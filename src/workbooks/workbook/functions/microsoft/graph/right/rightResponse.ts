...
export class Microsoft.graph.rightResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numChars", (o, n) => { (o as unknown as Microsoft.graph.rightResponse).numChars = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as Microsoft.graph.rightResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
