...
export class Microsoft.graph.norm_S_InvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["probability", (o, n) => { (o as unknown as Microsoft.graph.norm_S_InvResponse).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
