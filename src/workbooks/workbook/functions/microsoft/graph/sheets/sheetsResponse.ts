...
export class Microsoft.graph.sheetsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["reference", (o, n) => { (o as unknown as Microsoft.graph.sheetsResponse).reference = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
