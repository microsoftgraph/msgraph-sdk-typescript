...
export class Microsoft.graph.dbResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as Microsoft.graph.dbResponse).cost = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as Microsoft.graph.dbResponse).life = n.getObjectValue<Json>(Json); }],
            ["month", (o, n) => { (o as unknown as Microsoft.graph.dbResponse).month = n.getObjectValue<Json>(Json); }],
            ["period", (o, n) => { (o as unknown as Microsoft.graph.dbResponse).period = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as Microsoft.graph.dbResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
