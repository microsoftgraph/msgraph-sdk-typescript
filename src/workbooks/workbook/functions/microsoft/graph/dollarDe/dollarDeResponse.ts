...
export class Microsoft.graph.dollarDeResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fraction", (o, n) => { (o as unknown as Microsoft.graph.dollarDeResponse).fraction = n.getObjectValue<Json>(Json); }],
            ["fractionalDollar", (o, n) => { (o as unknown as Microsoft.graph.dollarDeResponse).fractionalDollar = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
