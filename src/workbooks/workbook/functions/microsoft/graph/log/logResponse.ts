...
export class Microsoft.graph.logResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _base?: Json | undefined;
    private _number?: Json | undefined;
    /**
     * Instantiates a new Microsoft.graph.logResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["base", (o, n) => { (o as unknown as Microsoft.graph.logResponse).base = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.logResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
