...
export class Microsoft.graph.hlookupResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["lookupValue", (o, n) => { (o as unknown as Microsoft.graph.hlookupResponse).lookupValue = n.getObjectValue<Json>(Json); }],
            ["rangeLookup", (o, n) => { (o as unknown as Microsoft.graph.hlookupResponse).rangeLookup = n.getObjectValue<Json>(Json); }],
            ["rowIndexNum", (o, n) => { (o as unknown as Microsoft.graph.hlookupResponse).rowIndexNum = n.getObjectValue<Json>(Json); }],
            ["tableArray", (o, n) => { (o as unknown as Microsoft.graph.hlookupResponse).tableArray = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
