...
export class Microsoft.graph.receivedResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.receivedResponse).basis = n.getObjectValue<Json>(Json); }],
            ["discount", (o, n) => { (o as unknown as Microsoft.graph.receivedResponse).discount = n.getObjectValue<Json>(Json); }],
            ["investment", (o, n) => { (o as unknown as Microsoft.graph.receivedResponse).investment = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.receivedResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.receivedResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
