...
export class Microsoft.graph.factDoubleResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.factDoubleResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
