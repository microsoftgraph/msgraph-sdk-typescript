...
export class Microsoft.graph.baseResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["minLength", (o, n) => { (o as unknown as Microsoft.graph.baseResponse).minLength = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.baseResponse).number = n.getObjectValue<Json>(Json); }],
            ["radix", (o, n) => { (o as unknown as Microsoft.graph.baseResponse).radix = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
