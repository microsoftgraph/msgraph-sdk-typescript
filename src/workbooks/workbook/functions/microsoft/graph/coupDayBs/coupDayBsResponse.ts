...
export class Microsoft.graph.coupDayBsResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.coupDayBsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.coupDayBsResponse).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as Microsoft.graph.coupDayBsResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.coupDayBsResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.coupDayBsResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
