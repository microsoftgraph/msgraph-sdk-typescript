...
export class Microsoft.graph.reptResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numberTimes", (o, n) => { (o as unknown as Microsoft.graph.reptResponse).numberTimes = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as Microsoft.graph.reptResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
