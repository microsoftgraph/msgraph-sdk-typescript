...
export class Microsoft.graph.imPowerResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["inumber", (o, n) => { (o as unknown as Microsoft.graph.imPowerResponse).inumber = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.imPowerResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
