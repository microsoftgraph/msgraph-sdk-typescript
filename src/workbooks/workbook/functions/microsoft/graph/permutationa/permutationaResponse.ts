...
export class Microsoft.graph.permutationaResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.permutationaResponse).number = n.getObjectValue<Json>(Json); }],
            ["numberChosen", (o, n) => { (o as unknown as Microsoft.graph.permutationaResponse).numberChosen = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
