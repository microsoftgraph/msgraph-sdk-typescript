...
export class Microsoft.graph.permutResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.permutResponse).number = n.getObjectValue<Json>(Json); }],
            ["numberChosen", (o, n) => { (o as unknown as Microsoft.graph.permutResponse).numberChosen = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
