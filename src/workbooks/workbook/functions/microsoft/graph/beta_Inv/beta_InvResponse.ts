...
export class Microsoft.graph.beta_InvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["a", (o, n) => { (o as unknown as Microsoft.graph.beta_InvResponse).a = n.getObjectValue<Json>(Json); }],
            ["alpha", (o, n) => { (o as unknown as Microsoft.graph.beta_InvResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["b", (o, n) => { (o as unknown as Microsoft.graph.beta_InvResponse).b = n.getObjectValue<Json>(Json); }],
            ["beta", (o, n) => { (o as unknown as Microsoft.graph.beta_InvResponse).beta = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Microsoft.graph.beta_InvResponse).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
