...
export class Microsoft.graph.imTanResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["inumber", (o, n) => { (o as unknown as Microsoft.graph.imTanResponse).inumber = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
