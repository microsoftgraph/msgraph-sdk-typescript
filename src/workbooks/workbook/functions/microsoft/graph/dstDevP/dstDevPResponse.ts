...
export class Microsoft.graph.dstDevPResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as Microsoft.graph.dstDevPResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as Microsoft.graph.dstDevPResponse).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as Microsoft.graph.dstDevPResponse).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
