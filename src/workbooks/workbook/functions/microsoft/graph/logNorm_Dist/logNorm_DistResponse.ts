...
export class Microsoft.graph.logNorm_DistResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.logNorm_DistResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as Microsoft.graph.logNorm_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["mean", (o, n) => { (o as unknown as Microsoft.graph.logNorm_DistResponse).mean = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Microsoft.graph.logNorm_DistResponse).standardDev = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.logNorm_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
