...
export class Microsoft.graph.expon_DistResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as Microsoft.graph.expon_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["lambda", (o, n) => { (o as unknown as Microsoft.graph.expon_DistResponse).lambda = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.expon_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
