...
export class Microsoft.graph.lookupResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["lookupValue", (o, n) => { (o as unknown as Microsoft.graph.lookupResponse).lookupValue = n.getObjectValue<Json>(Json); }],
            ["lookupVector", (o, n) => { (o as unknown as Microsoft.graph.lookupResponse).lookupVector = n.getObjectValue<Json>(Json); }],
            ["resultVector", (o, n) => { (o as unknown as Microsoft.graph.lookupResponse).resultVector = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
