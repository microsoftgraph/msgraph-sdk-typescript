...
export class Microsoft.graph.besselJResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["n", (o, n) => { (o as unknown as Microsoft.graph.besselJResponse).n = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.besselJResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
