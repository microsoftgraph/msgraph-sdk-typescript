...
export class Microsoft.graph.averageIfResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["averageRange", (o, n) => { (o as unknown as Microsoft.graph.averageIfResponse).averageRange = n.getObjectValue<Json>(Json); }],
            ["criteria", (o, n) => { (o as unknown as Microsoft.graph.averageIfResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["range", (o, n) => { (o as unknown as Microsoft.graph.averageIfResponse).range = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
