...
export class Microsoft.graph.irrResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["guess", (o, n) => { (o as unknown as Microsoft.graph.irrResponse).guess = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.irrResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
