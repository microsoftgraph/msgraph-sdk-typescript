...
export class Microsoft.graph.accrIntResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.accrIntResponse).basis = n.getObjectValue<Json>(Json); }],
            ["calcMethod", (o, n) => { (o as unknown as Microsoft.graph.accrIntResponse).calcMethod = n.getObjectValue<Json>(Json); }],
            ["firstInterest", (o, n) => { (o as unknown as Microsoft.graph.accrIntResponse).firstInterest = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as Microsoft.graph.accrIntResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as Microsoft.graph.accrIntResponse).issue = n.getObjectValue<Json>(Json); }],
            ["par", (o, n) => { (o as unknown as Microsoft.graph.accrIntResponse).par = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.accrIntResponse).rate = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.accrIntResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
