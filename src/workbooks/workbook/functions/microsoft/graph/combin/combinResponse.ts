...
export class Microsoft.graph.combinResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.combinResponse).number = n.getObjectValue<Json>(Json); }],
            ["numberChosen", (o, n) => { (o as unknown as Microsoft.graph.combinResponse).numberChosen = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
