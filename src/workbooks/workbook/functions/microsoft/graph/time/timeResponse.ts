...
export class Microsoft.graph.timeResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["hour", (o, n) => { (o as unknown as Microsoft.graph.timeResponse).hour = n.getObjectValue<Json>(Json); }],
            ["minute", (o, n) => { (o as unknown as Microsoft.graph.timeResponse).minute = n.getObjectValue<Json>(Json); }],
            ["second", (o, n) => { (o as unknown as Microsoft.graph.timeResponse).second = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
