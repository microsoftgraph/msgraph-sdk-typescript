...
export class Microsoft.graph.mirrResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["financeRate", (o, n) => { (o as unknown as Microsoft.graph.mirrResponse).financeRate = n.getObjectValue<Json>(Json); }],
            ["reinvestRate", (o, n) => { (o as unknown as Microsoft.graph.mirrResponse).reinvestRate = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.mirrResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
