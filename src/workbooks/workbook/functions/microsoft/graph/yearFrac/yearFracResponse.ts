...
export class Microsoft.graph.yearFracResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.yearFracResponse).basis = n.getObjectValue<Json>(Json); }],
            ["endDate", (o, n) => { (o as unknown as Microsoft.graph.yearFracResponse).endDate = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Microsoft.graph.yearFracResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
