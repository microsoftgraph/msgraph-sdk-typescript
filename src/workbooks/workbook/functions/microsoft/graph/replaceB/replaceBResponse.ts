...
export class Microsoft.graph.replaceBResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["newText", (o, n) => { (o as unknown as Microsoft.graph.replaceBResponse).newText = n.getObjectValue<Json>(Json); }],
            ["numBytes", (o, n) => { (o as unknown as Microsoft.graph.replaceBResponse).numBytes = n.getObjectValue<Json>(Json); }],
            ["oldText", (o, n) => { (o as unknown as Microsoft.graph.replaceBResponse).oldText = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as Microsoft.graph.replaceBResponse).startNum = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
