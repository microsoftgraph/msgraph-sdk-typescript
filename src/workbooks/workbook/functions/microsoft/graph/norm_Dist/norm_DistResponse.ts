...
export class Microsoft.graph.norm_DistResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as Microsoft.graph.norm_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["mean", (o, n) => { (o as unknown as Microsoft.graph.norm_DistResponse).mean = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Microsoft.graph.norm_DistResponse).standardDev = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.norm_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
