...
export class Microsoft.graph.areasResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _reference?: Json | undefined;
    /**
     * Instantiates a new Microsoft.graph.areasResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["reference", (o, n) => { (o as unknown as Microsoft.graph.areasResponse).reference = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
