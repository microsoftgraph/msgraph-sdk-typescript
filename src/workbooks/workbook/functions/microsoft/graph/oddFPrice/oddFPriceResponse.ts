...
export class Microsoft.graph.oddFPriceResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.oddFPriceResponse).basis = n.getObjectValue<Json>(Json); }],
            ["firstCoupon", (o, n) => { (o as unknown as Microsoft.graph.oddFPriceResponse).firstCoupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as Microsoft.graph.oddFPriceResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as Microsoft.graph.oddFPriceResponse).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.oddFPriceResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.oddFPriceResponse).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as Microsoft.graph.oddFPriceResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.oddFPriceResponse).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as Microsoft.graph.oddFPriceResponse).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
