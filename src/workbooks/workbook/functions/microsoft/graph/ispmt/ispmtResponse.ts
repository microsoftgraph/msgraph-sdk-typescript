...
export class Microsoft.graph.ispmtResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["nper", (o, n) => { (o as unknown as Microsoft.graph.ispmtResponse).nper = n.getObjectValue<Json>(Json); }],
            ["per", (o, n) => { (o as unknown as Microsoft.graph.ispmtResponse).per = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as Microsoft.graph.ispmtResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.ispmtResponse).rate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
