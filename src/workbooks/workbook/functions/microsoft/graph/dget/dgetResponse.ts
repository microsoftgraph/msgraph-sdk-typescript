...
export class Microsoft.graph.dgetResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as Microsoft.graph.dgetResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as Microsoft.graph.dgetResponse).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as Microsoft.graph.dgetResponse).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
