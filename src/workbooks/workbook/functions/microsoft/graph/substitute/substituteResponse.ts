...
export class Microsoft.graph.substituteResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["instanceNum", (o, n) => { (o as unknown as Microsoft.graph.substituteResponse).instanceNum = n.getObjectValue<Json>(Json); }],
            ["newText", (o, n) => { (o as unknown as Microsoft.graph.substituteResponse).newText = n.getObjectValue<Json>(Json); }],
            ["oldText", (o, n) => { (o as unknown as Microsoft.graph.substituteResponse).oldText = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as Microsoft.graph.substituteResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
