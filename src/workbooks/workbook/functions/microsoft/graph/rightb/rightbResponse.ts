...
export class Microsoft.graph.rightbResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numBytes", (o, n) => { (o as unknown as Microsoft.graph.rightbResponse).numBytes = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as Microsoft.graph.rightbResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
