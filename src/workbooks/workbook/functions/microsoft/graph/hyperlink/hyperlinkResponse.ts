...
export class Microsoft.graph.hyperlinkResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["friendlyName", (o, n) => { (o as unknown as Microsoft.graph.hyperlinkResponse).friendlyName = n.getObjectValue<Json>(Json); }],
            ["linkLocation", (o, n) => { (o as unknown as Microsoft.graph.hyperlinkResponse).linkLocation = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
