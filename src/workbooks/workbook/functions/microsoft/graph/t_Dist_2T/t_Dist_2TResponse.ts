...
export class Microsoft.graph.t_Dist_2TResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom", (o, n) => { (o as unknown as Microsoft.graph.t_Dist_2TResponse).degFreedom = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.t_Dist_2TResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
