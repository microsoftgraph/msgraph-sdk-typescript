...
export class Microsoft.graph.convertResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fromUnit", (o, n) => { (o as unknown as Microsoft.graph.convertResponse).fromUnit = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.convertResponse).number = n.getObjectValue<Json>(Json); }],
            ["toUnit", (o, n) => { (o as unknown as Microsoft.graph.convertResponse).toUnit = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
