...
export class Microsoft.graph.norm_InvResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.norm_InvResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mean", (o, n) => { (o as unknown as Microsoft.graph.norm_InvResponse).mean = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Microsoft.graph.norm_InvResponse).probability = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Microsoft.graph.norm_InvResponse).standardDev = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
