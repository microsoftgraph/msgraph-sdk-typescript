...
export class Microsoft.graph.complexResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["iNum", (o, n) => { (o as unknown as Microsoft.graph.complexResponse).iNum = n.getObjectValue<Json>(Json); }],
            ["realNum", (o, n) => { (o as unknown as Microsoft.graph.complexResponse).realNum = n.getObjectValue<Json>(Json); }],
            ["suffix", (o, n) => { (o as unknown as Microsoft.graph.complexResponse).suffix = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
