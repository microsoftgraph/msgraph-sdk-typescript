...
export class Microsoft.graph.chooseResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["indexNum", (o, n) => { (o as unknown as Microsoft.graph.chooseResponse).indexNum = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.chooseResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
