...
export class Microsoft.graph.midbResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numBytes", (o, n) => { (o as unknown as Microsoft.graph.midbResponse).numBytes = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as Microsoft.graph.midbResponse).startNum = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as Microsoft.graph.midbResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
