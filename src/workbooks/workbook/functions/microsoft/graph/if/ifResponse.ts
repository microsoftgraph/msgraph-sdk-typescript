...
export class Microsoft.graph.ifResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["logicalTest", (o, n) => { (o as unknown as Microsoft.graph.ifResponse).logicalTest = n.getObjectValue<Json>(Json); }],
            ["valueIfFalse", (o, n) => { (o as unknown as Microsoft.graph.ifResponse).valueIfFalse = n.getObjectValue<Json>(Json); }],
            ["valueIfTrue", (o, n) => { (o as unknown as Microsoft.graph.ifResponse).valueIfTrue = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
