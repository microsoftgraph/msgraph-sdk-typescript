...
export class Microsoft.graph.oddFYieldResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.oddFYieldResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.oddFYieldResponse).basis = n.getObjectValue<Json>(Json); }],
            ["firstCoupon", (o, n) => { (o as unknown as Microsoft.graph.oddFYieldResponse).firstCoupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as Microsoft.graph.oddFYieldResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as Microsoft.graph.oddFYieldResponse).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.oddFYieldResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as Microsoft.graph.oddFYieldResponse).pr = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.oddFYieldResponse).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as Microsoft.graph.oddFYieldResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.oddFYieldResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
