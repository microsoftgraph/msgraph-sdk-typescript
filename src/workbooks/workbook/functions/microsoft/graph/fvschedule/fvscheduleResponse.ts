...
export class Microsoft.graph.fvscheduleResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["principal", (o, n) => { (o as unknown as Microsoft.graph.fvscheduleResponse).principal = n.getObjectValue<Json>(Json); }],
            ["schedule", (o, n) => { (o as unknown as Microsoft.graph.fvscheduleResponse).schedule = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
