...
export class Microsoft.graph.floor_MathResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.floor_MathResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mode", (o, n) => { (o as unknown as Microsoft.graph.floor_MathResponse).mode = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.floor_MathResponse).number = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as Microsoft.graph.floor_MathResponse).significance = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
