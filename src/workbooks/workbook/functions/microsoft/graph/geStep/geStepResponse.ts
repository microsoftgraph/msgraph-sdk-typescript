...
export class Microsoft.graph.geStepResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.geStepResponse).number = n.getObjectValue<Json>(Json); }],
            ["step", (o, n) => { (o as unknown as Microsoft.graph.geStepResponse).step = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
