...
export class Microsoft.graph.monthResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["serialNumber", (o, n) => { (o as unknown as Microsoft.graph.monthResponse).serialNumber = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
