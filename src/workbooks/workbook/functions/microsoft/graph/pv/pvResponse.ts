...
export class Microsoft.graph.pvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as Microsoft.graph.pvResponse).fv = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as Microsoft.graph.pvResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pmt", (o, n) => { (o as unknown as Microsoft.graph.pvResponse).pmt = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.pvResponse).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as Microsoft.graph.pvResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
