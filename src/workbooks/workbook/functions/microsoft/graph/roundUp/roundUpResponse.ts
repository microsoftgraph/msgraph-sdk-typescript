...
export class Microsoft.graph.roundUpResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.roundUpResponse).number = n.getObjectValue<Json>(Json); }],
            ["numDigits", (o, n) => { (o as unknown as Microsoft.graph.roundUpResponse).numDigits = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
