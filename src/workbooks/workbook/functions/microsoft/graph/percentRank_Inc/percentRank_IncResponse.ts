...
export class Microsoft.graph.percentRank_IncResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Microsoft.graph.percentRank_IncResponse).array = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as Microsoft.graph.percentRank_IncResponse).significance = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.percentRank_IncResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
