...
export class Microsoft.graph.erfResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["lowerLimit", (o, n) => { (o as unknown as Microsoft.graph.erfResponse).lowerLimit = n.getObjectValue<Json>(Json); }],
            ["upperLimit", (o, n) => { (o as unknown as Microsoft.graph.erfResponse).upperLimit = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
