...
export class Microsoft.graph.pdurationResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as Microsoft.graph.pdurationResponse).fv = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as Microsoft.graph.pdurationResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.pdurationResponse).rate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
