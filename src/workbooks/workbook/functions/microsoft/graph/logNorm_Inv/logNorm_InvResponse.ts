...
export class Microsoft.graph.logNorm_InvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mean", (o, n) => { (o as unknown as Microsoft.graph.logNorm_InvResponse).mean = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Microsoft.graph.logNorm_InvResponse).probability = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Microsoft.graph.logNorm_InvResponse).standardDev = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
