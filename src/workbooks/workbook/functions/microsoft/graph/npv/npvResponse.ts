...
export class Microsoft.graph.npvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.npvResponse).rate = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.npvResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
