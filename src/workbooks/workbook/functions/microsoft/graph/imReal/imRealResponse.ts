...
export class Microsoft.graph.imRealResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["inumber", (o, n) => { (o as unknown as Microsoft.graph.imRealResponse).inumber = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
