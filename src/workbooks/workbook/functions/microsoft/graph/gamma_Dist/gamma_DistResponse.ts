...
export class Microsoft.graph.gamma_DistResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.gamma_DistResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alpha", (o, n) => { (o as unknown as Microsoft.graph.gamma_DistResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["beta", (o, n) => { (o as unknown as Microsoft.graph.gamma_DistResponse).beta = n.getObjectValue<Json>(Json); }],
            ["cumulative", (o, n) => { (o as unknown as Microsoft.graph.gamma_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.gamma_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
