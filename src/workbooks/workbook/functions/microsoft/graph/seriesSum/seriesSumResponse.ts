...
export class Microsoft.graph.seriesSumResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["coefficients", (o, n) => { (o as unknown as Microsoft.graph.seriesSumResponse).coefficients = n.getObjectValue<Json>(Json); }],
            ["m", (o, n) => { (o as unknown as Microsoft.graph.seriesSumResponse).m = n.getObjectValue<Json>(Json); }],
            ["n", (o, n) => { (o as unknown as Microsoft.graph.seriesSumResponse).n = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.seriesSumResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
