...
export class Microsoft.graph.dmaxResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.dmaxResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as Microsoft.graph.dmaxResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as Microsoft.graph.dmaxResponse).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as Microsoft.graph.dmaxResponse).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
