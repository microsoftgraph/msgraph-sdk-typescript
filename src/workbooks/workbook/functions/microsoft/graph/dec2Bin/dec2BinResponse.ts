...
export class Microsoft.graph.dec2BinResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.dec2BinResponse).number = n.getObjectValue<Json>(Json); }],
            ["places", (o, n) => { (o as unknown as Microsoft.graph.dec2BinResponse).places = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
