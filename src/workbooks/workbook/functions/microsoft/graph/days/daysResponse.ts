...
export class Microsoft.graph.daysResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endDate", (o, n) => { (o as unknown as Microsoft.graph.daysResponse).endDate = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Microsoft.graph.daysResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
