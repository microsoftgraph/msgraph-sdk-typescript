...
export class Microsoft.graph.dproductResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.dproductResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as Microsoft.graph.dproductResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as Microsoft.graph.dproductResponse).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as Microsoft.graph.dproductResponse).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
