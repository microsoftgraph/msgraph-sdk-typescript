...
export class Microsoft.graph.besselIResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _n?: Json | undefined;
    private _x?: Json | undefined;
    /**
     * Instantiates a new Microsoft.graph.besselIResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["n", (o, n) => { (o as unknown as Microsoft.graph.besselIResponse).n = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.besselIResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
