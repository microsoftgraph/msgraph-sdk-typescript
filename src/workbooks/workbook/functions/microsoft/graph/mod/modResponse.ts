...
export class Microsoft.graph.modResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["divisor", (o, n) => { (o as unknown as Microsoft.graph.modResponse).divisor = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.modResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
