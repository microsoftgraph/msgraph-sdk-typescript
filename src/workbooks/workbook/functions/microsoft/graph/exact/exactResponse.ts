...
export class Microsoft.graph.exactResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["text1", (o, n) => { (o as unknown as Microsoft.graph.exactResponse).text1 = n.getObjectValue<Json>(Json); }],
            ["text2", (o, n) => { (o as unknown as Microsoft.graph.exactResponse).text2 = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
