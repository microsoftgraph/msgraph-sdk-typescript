...
export class Microsoft.graph.vdbResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as Microsoft.graph.vdbResponse).cost = n.getObjectValue<Json>(Json); }],
            ["endPeriod", (o, n) => { (o as unknown as Microsoft.graph.vdbResponse).endPeriod = n.getObjectValue<Json>(Json); }],
            ["factor", (o, n) => { (o as unknown as Microsoft.graph.vdbResponse).factor = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as Microsoft.graph.vdbResponse).life = n.getObjectValue<Json>(Json); }],
            ["noSwitch", (o, n) => { (o as unknown as Microsoft.graph.vdbResponse).noSwitch = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as Microsoft.graph.vdbResponse).salvage = n.getObjectValue<Json>(Json); }],
            ["startPeriod", (o, n) => { (o as unknown as Microsoft.graph.vdbResponse).startPeriod = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
