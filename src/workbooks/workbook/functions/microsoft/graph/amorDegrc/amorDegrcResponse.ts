...
export class Microsoft.graph.amorDegrcResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.amorDegrcResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.amorDegrcResponse).basis = n.getObjectValue<Json>(Json); }],
            ["cost", (o, n) => { (o as unknown as Microsoft.graph.amorDegrcResponse).cost = n.getObjectValue<Json>(Json); }],
            ["datePurchased", (o, n) => { (o as unknown as Microsoft.graph.amorDegrcResponse).datePurchased = n.getObjectValue<Json>(Json); }],
            ["firstPeriod", (o, n) => { (o as unknown as Microsoft.graph.amorDegrcResponse).firstPeriod = n.getObjectValue<Json>(Json); }],
            ["period", (o, n) => { (o as unknown as Microsoft.graph.amorDegrcResponse).period = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.amorDegrcResponse).rate = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as Microsoft.graph.amorDegrcResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
