...
export class Microsoft.graph.amorLincResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.amorLincResponse).basis = n.getObjectValue<Json>(Json); }],
            ["cost", (o, n) => { (o as unknown as Microsoft.graph.amorLincResponse).cost = n.getObjectValue<Json>(Json); }],
            ["datePurchased", (o, n) => { (o as unknown as Microsoft.graph.amorLincResponse).datePurchased = n.getObjectValue<Json>(Json); }],
            ["firstPeriod", (o, n) => { (o as unknown as Microsoft.graph.amorLincResponse).firstPeriod = n.getObjectValue<Json>(Json); }],
            ["period", (o, n) => { (o as unknown as Microsoft.graph.amorLincResponse).period = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.amorLincResponse).rate = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as Microsoft.graph.amorLincResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
