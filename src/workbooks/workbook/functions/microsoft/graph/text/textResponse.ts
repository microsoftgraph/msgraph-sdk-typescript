...
export class Microsoft.graph.textResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["formatText", (o, n) => { (o as unknown as Microsoft.graph.textResponse).formatText = n.getObjectValue<Json>(Json); }],
            ["value", (o, n) => { (o as unknown as Microsoft.graph.textResponse).value = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
