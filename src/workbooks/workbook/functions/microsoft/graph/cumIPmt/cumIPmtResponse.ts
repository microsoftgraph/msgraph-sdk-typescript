...
export class Microsoft.graph.cumIPmtResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endPeriod", (o, n) => { (o as unknown as Microsoft.graph.cumIPmtResponse).endPeriod = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as Microsoft.graph.cumIPmtResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as Microsoft.graph.cumIPmtResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.cumIPmtResponse).rate = n.getObjectValue<Json>(Json); }],
            ["startPeriod", (o, n) => { (o as unknown as Microsoft.graph.cumIPmtResponse).startPeriod = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as Microsoft.graph.cumIPmtResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
