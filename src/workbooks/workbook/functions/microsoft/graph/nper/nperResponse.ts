...
export class Microsoft.graph.nperResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as Microsoft.graph.nperResponse).fv = n.getObjectValue<Json>(Json); }],
            ["pmt", (o, n) => { (o as unknown as Microsoft.graph.nperResponse).pmt = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as Microsoft.graph.nperResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.nperResponse).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as Microsoft.graph.nperResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
