...
export class Microsoft.graph.negBinom_DistResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as Microsoft.graph.negBinom_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["numberF", (o, n) => { (o as unknown as Microsoft.graph.negBinom_DistResponse).numberF = n.getObjectValue<Json>(Json); }],
            ["numberS", (o, n) => { (o as unknown as Microsoft.graph.negBinom_DistResponse).numberS = n.getObjectValue<Json>(Json); }],
            ["probabilityS", (o, n) => { (o as unknown as Microsoft.graph.negBinom_DistResponse).probabilityS = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
