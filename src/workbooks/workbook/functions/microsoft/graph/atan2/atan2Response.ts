...
export class Microsoft.graph.atan2Response implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["xNum", (o, n) => { (o as unknown as Microsoft.graph.atan2Response).xNum = n.getObjectValue<Json>(Json); }],
            ["yNum", (o, n) => { (o as unknown as Microsoft.graph.atan2Response).yNum = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
