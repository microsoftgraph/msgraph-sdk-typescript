...
export class Microsoft.graph.slnResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as Microsoft.graph.slnResponse).cost = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as Microsoft.graph.slnResponse).life = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as Microsoft.graph.slnResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
