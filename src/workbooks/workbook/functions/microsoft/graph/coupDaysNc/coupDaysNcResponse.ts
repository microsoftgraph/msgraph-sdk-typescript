...
export class Microsoft.graph.coupDaysNcResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.coupDaysNcResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.coupDaysNcResponse).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as Microsoft.graph.coupDaysNcResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.coupDaysNcResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.coupDaysNcResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
