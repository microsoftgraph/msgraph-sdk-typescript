...
export class Microsoft.graph.priceMatResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.priceMatResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.priceMatResponse).basis = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as Microsoft.graph.priceMatResponse).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.priceMatResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.priceMatResponse).rate = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.priceMatResponse).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as Microsoft.graph.priceMatResponse).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
