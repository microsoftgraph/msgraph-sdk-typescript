...
import {Microsoft.graph.deltaResponse} from './microsoft.graph.deltaResponse';
...
export class Microsoft.graph.deltaRequestBuilder {
     ...
     */
    public createPostRequestInfo(body: Microsoft.graph.deltaResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
     ...
     * @returns a Promise of Microsoft.graph.deltaResponse
     */
    public post(body: Microsoft.graph.deltaResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
        if(!body) throw new Error("body cannot be undefined");
