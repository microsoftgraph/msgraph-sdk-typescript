...
export class Microsoft.graph.z_TestResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Microsoft.graph.z_TestResponse).array = n.getObjectValue<Json>(Json); }],
            ["sigma", (o, n) => { (o as unknown as Microsoft.graph.z_TestResponse).sigma = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.z_TestResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
