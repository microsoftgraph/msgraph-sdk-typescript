...
export class Microsoft.graph.trimMeanResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Microsoft.graph.trimMeanResponse).array = n.getObjectValue<Json>(Json); }],
            ["percent", (o, n) => { (o as unknown as Microsoft.graph.trimMeanResponse).percent = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
