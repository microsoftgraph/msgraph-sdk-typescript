...
export class Microsoft.graph.replaceResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["newText", (o, n) => { (o as unknown as Microsoft.graph.replaceResponse).newText = n.getObjectValue<Json>(Json); }],
            ["numChars", (o, n) => { (o as unknown as Microsoft.graph.replaceResponse).numChars = n.getObjectValue<Json>(Json); }],
            ["oldText", (o, n) => { (o as unknown as Microsoft.graph.replaceResponse).oldText = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as Microsoft.graph.replaceResponse).startNum = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
