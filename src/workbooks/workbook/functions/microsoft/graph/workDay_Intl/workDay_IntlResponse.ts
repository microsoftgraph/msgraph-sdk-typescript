...
export class Microsoft.graph.workDay_IntlResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["days", (o, n) => { (o as unknown as Microsoft.graph.workDay_IntlResponse).days = n.getObjectValue<Json>(Json); }],
            ["holidays", (o, n) => { (o as unknown as Microsoft.graph.workDay_IntlResponse).holidays = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Microsoft.graph.workDay_IntlResponse).startDate = n.getObjectValue<Json>(Json); }],
            ["weekend", (o, n) => { (o as unknown as Microsoft.graph.workDay_IntlResponse).weekend = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
