...
export class Microsoft.graph.chiSq_Dist_RTResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom", (o, n) => { (o as unknown as Microsoft.graph.chiSq_Dist_RTResponse).degFreedom = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.chiSq_Dist_RTResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
