...
export class Microsoft.graph.usdollarResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _decimals?: Json | undefined;
    private _number?: Json | undefined;
    /**
     * Instantiates a new Microsoft.graph.usdollarResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimals", (o, n) => { (o as unknown as Microsoft.graph.usdollarResponse).decimals = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.usdollarResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
