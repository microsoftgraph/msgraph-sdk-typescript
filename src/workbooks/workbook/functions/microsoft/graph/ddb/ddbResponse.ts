...
export class Microsoft.graph.ddbResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as Microsoft.graph.ddbResponse).cost = n.getObjectValue<Json>(Json); }],
            ["factor", (o, n) => { (o as unknown as Microsoft.graph.ddbResponse).factor = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as Microsoft.graph.ddbResponse).life = n.getObjectValue<Json>(Json); }],
            ["period", (o, n) => { (o as unknown as Microsoft.graph.ddbResponse).period = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as Microsoft.graph.ddbResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
