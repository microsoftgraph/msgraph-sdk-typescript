...
export class Microsoft.graph.effectResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["nominalRate", (o, n) => { (o as unknown as Microsoft.graph.effectResponse).nominalRate = n.getObjectValue<Json>(Json); }],
            ["npery", (o, n) => { (o as unknown as Microsoft.graph.effectResponse).npery = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
