...
export class Microsoft.graph.imDivResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["inumber1", (o, n) => { (o as unknown as Microsoft.graph.imDivResponse).inumber1 = n.getObjectValue<Json>(Json); }],
            ["inumber2", (o, n) => { (o as unknown as Microsoft.graph.imDivResponse).inumber2 = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
