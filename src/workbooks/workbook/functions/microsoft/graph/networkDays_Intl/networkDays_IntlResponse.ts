...
export class Microsoft.graph.networkDays_IntlResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endDate", (o, n) => { (o as unknown as Microsoft.graph.networkDays_IntlResponse).endDate = n.getObjectValue<Json>(Json); }],
            ["holidays", (o, n) => { (o as unknown as Microsoft.graph.networkDays_IntlResponse).holidays = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Microsoft.graph.networkDays_IntlResponse).startDate = n.getObjectValue<Json>(Json); }],
            ["weekend", (o, n) => { (o as unknown as Microsoft.graph.networkDays_IntlResponse).weekend = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
