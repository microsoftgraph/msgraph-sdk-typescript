...
export class Microsoft.graph.edateResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["months", (o, n) => { (o as unknown as Microsoft.graph.edateResponse).months = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Microsoft.graph.edateResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
