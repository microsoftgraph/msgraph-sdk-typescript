...
export class Microsoft.graph.imSubResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _inumber1?: Json | undefined;
    private _inumber2?: Json | undefined;
    /**
     * Instantiates a new Microsoft.graph.imSubResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["inumber1", (o, n) => { (o as unknown as Microsoft.graph.imSubResponse).inumber1 = n.getObjectValue<Json>(Json); }],
            ["inumber2", (o, n) => { (o as unknown as Microsoft.graph.imSubResponse).inumber2 = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
