...
export class Microsoft.graph.findResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["findText", (o, n) => { (o as unknown as Microsoft.graph.findResponse).findText = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as Microsoft.graph.findResponse).startNum = n.getObjectValue<Json>(Json); }],
            ["withinText", (o, n) => { (o as unknown as Microsoft.graph.findResponse).withinText = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
