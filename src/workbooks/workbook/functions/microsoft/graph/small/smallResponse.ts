...
export class Microsoft.graph.smallResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Microsoft.graph.smallResponse).array = n.getObjectValue<Json>(Json); }],
            ["k", (o, n) => { (o as unknown as Microsoft.graph.smallResponse).k = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
