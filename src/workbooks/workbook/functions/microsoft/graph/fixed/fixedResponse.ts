...
export class Microsoft.graph.fixedResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimals", (o, n) => { (o as unknown as Microsoft.graph.fixedResponse).decimals = n.getObjectValue<Json>(Json); }],
            ["noCommas", (o, n) => { (o as unknown as Microsoft.graph.fixedResponse).noCommas = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.fixedResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
