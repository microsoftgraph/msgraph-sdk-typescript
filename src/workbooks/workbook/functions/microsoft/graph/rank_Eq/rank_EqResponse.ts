...
export class Microsoft.graph.rank_EqResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.rank_EqResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Microsoft.graph.rank_EqResponse).number = n.getObjectValue<Json>(Json); }],
            ["order", (o, n) => { (o as unknown as Microsoft.graph.rank_EqResponse).order = n.getObjectValue<Json>(Json); }],
            ["ref", (o, n) => { (o as unknown as Microsoft.graph.rank_EqResponse).ref = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
