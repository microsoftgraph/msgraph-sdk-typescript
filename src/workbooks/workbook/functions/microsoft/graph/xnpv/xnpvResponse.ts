...
export class Microsoft.graph.xnpvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["dates", (o, n) => { (o as unknown as Microsoft.graph.xnpvResponse).dates = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.xnpvResponse).rate = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.xnpvResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
