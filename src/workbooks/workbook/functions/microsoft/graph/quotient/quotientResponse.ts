...
export class Microsoft.graph.quotientResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["denominator", (o, n) => { (o as unknown as Microsoft.graph.quotientResponse).denominator = n.getObjectValue<Json>(Json); }],
            ["numerator", (o, n) => { (o as unknown as Microsoft.graph.quotientResponse).numerator = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
