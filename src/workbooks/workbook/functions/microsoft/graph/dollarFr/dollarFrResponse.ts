...
export class Microsoft.graph.dollarFrResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimalDollar", (o, n) => { (o as unknown as Microsoft.graph.dollarFrResponse).decimalDollar = n.getObjectValue<Json>(Json); }],
            ["fraction", (o, n) => { (o as unknown as Microsoft.graph.dollarFrResponse).fraction = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
