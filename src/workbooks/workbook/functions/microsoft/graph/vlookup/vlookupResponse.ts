...
export class Microsoft.graph.vlookupResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.vlookupResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["colIndexNum", (o, n) => { (o as unknown as Microsoft.graph.vlookupResponse).colIndexNum = n.getObjectValue<Json>(Json); }],
            ["lookupValue", (o, n) => { (o as unknown as Microsoft.graph.vlookupResponse).lookupValue = n.getObjectValue<Json>(Json); }],
            ["rangeLookup", (o, n) => { (o as unknown as Microsoft.graph.vlookupResponse).rangeLookup = n.getObjectValue<Json>(Json); }],
            ["tableArray", (o, n) => { (o as unknown as Microsoft.graph.vlookupResponse).tableArray = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
