...
export class Microsoft.graph.imSqrtResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["inumber", (o, n) => { (o as unknown as Microsoft.graph.imSqrtResponse).inumber = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
