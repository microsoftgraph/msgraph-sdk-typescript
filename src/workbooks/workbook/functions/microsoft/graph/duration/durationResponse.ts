...
export class Microsoft.graph.durationResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.durationResponse).basis = n.getObjectValue<Json>(Json); }],
            ["coupon", (o, n) => { (o as unknown as Microsoft.graph.durationResponse).coupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as Microsoft.graph.durationResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.durationResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.durationResponse).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as Microsoft.graph.durationResponse).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
