...
export class Microsoft.graph.mdurationResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.mdurationResponse).basis = n.getObjectValue<Json>(Json); }],
            ["coupon", (o, n) => { (o as unknown as Microsoft.graph.mdurationResponse).coupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as Microsoft.graph.mdurationResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.mdurationResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.mdurationResponse).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as Microsoft.graph.mdurationResponse).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
