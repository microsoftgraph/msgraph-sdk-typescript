...
export class Microsoft.graph.daverageResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.daverageResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as Microsoft.graph.daverageResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as Microsoft.graph.daverageResponse).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as Microsoft.graph.daverageResponse).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
