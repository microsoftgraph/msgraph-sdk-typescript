...
export class Microsoft.graph.confidence_NormResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.confidence_NormResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alpha", (o, n) => { (o as unknown as Microsoft.graph.confidence_NormResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["size", (o, n) => { (o as unknown as Microsoft.graph.confidence_NormResponse).size = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Microsoft.graph.confidence_NormResponse).standardDev = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
