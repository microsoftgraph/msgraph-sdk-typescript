...
export class Microsoft.graph.romanResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["form", (o, n) => { (o as unknown as Microsoft.graph.romanResponse).form = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.romanResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
