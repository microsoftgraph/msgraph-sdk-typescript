...
export class Microsoft.graph.workDayResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["days", (o, n) => { (o as unknown as Microsoft.graph.workDayResponse).days = n.getObjectValue<Json>(Json); }],
            ["holidays", (o, n) => { (o as unknown as Microsoft.graph.workDayResponse).holidays = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Microsoft.graph.workDayResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
