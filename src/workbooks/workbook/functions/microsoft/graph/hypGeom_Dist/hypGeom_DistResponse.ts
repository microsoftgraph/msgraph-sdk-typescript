...
export class Microsoft.graph.hypGeom_DistResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as Microsoft.graph.hypGeom_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["numberPop", (o, n) => { (o as unknown as Microsoft.graph.hypGeom_DistResponse).numberPop = n.getObjectValue<Json>(Json); }],
            ["numberSample", (o, n) => { (o as unknown as Microsoft.graph.hypGeom_DistResponse).numberSample = n.getObjectValue<Json>(Json); }],
            ["populationS", (o, n) => { (o as unknown as Microsoft.graph.hypGeom_DistResponse).populationS = n.getObjectValue<Json>(Json); }],
            ["sampleS", (o, n) => { (o as unknown as Microsoft.graph.hypGeom_DistResponse).sampleS = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
