...
export class Microsoft.graph.sumIfsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["sumRange", (o, n) => { (o as unknown as Microsoft.graph.sumIfsResponse).sumRange = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.sumIfsResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
