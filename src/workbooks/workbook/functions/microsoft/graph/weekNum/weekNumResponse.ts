...
export class Microsoft.graph.weekNumResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["returnType", (o, n) => { (o as unknown as Microsoft.graph.weekNumResponse).returnType = n.getObjectValue<Json>(Json); }],
            ["serialNumber", (o, n) => { (o as unknown as Microsoft.graph.weekNumResponse).serialNumber = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
