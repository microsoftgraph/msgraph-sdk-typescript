...
export class Microsoft.graph.sumIfResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as Microsoft.graph.sumIfResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["range", (o, n) => { (o as unknown as Microsoft.graph.sumIfResponse).range = n.getObjectValue<Json>(Json); }],
            ["sumRange", (o, n) => { (o as unknown as Microsoft.graph.sumIfResponse).sumRange = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
