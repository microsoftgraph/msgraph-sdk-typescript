...
export class Microsoft.graph.ipmtResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as Microsoft.graph.ipmtResponse).fv = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as Microsoft.graph.ipmtResponse).nper = n.getObjectValue<Json>(Json); }],
            ["per", (o, n) => { (o as unknown as Microsoft.graph.ipmtResponse).per = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as Microsoft.graph.ipmtResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.ipmtResponse).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as Microsoft.graph.ipmtResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
