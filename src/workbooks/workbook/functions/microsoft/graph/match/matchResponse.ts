...
export class Microsoft.graph.matchResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["lookupArray", (o, n) => { (o as unknown as Microsoft.graph.matchResponse).lookupArray = n.getObjectValue<Json>(Json); }],
            ["lookupValue", (o, n) => { (o as unknown as Microsoft.graph.matchResponse).lookupValue = n.getObjectValue<Json>(Json); }],
            ["matchType", (o, n) => { (o as unknown as Microsoft.graph.matchResponse).matchType = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
