...
export class Microsoft.graph.tbillPriceResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.tbillPriceResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["discount", (o, n) => { (o as unknown as Microsoft.graph.tbillPriceResponse).discount = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.tbillPriceResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.tbillPriceResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
