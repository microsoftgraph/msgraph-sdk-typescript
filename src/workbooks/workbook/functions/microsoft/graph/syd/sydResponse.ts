...
export class Microsoft.graph.sydResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as Microsoft.graph.sydResponse).cost = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as Microsoft.graph.sydResponse).life = n.getObjectValue<Json>(Json); }],
            ["per", (o, n) => { (o as unknown as Microsoft.graph.sydResponse).per = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as Microsoft.graph.sydResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
