...
export class Microsoft.graph.days360Response implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.days360Response and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endDate", (o, n) => { (o as unknown as Microsoft.graph.days360Response).endDate = n.getObjectValue<Json>(Json); }],
            ["method", (o, n) => { (o as unknown as Microsoft.graph.days360Response).method = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Microsoft.graph.days360Response).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
