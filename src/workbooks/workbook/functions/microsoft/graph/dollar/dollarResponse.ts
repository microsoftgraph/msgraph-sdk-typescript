...
export class Microsoft.graph.dollarResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimals", (o, n) => { (o as unknown as Microsoft.graph.dollarResponse).decimals = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Microsoft.graph.dollarResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
