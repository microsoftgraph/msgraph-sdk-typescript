...
export class Microsoft.graph.oddLYieldResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _basis?: Json | undefined;
    private _frequency?: Json | undefined;
    private _lastInterest?: Json | undefined;
     ...
     * @returns a Json
     */
    public get lastInterest() {
        return this._lastInterest;
    };
    /**
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.oddLYieldResponse).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as Microsoft.graph.oddLYieldResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["lastInterest", (o, n) => { (o as unknown as Microsoft.graph.oddLYieldResponse).lastInterest = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.oddLYieldResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as Microsoft.graph.oddLYieldResponse).pr = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.oddLYieldResponse).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as Microsoft.graph.oddLYieldResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.oddLYieldResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<Json>("lastInterest", this.lastInterest);
     ...
     */
    public set lastInterest(value: Json | undefined) {
        this._lastInterest = value;
    };
    /**
