...
export class Microsoft.graph.priceDiscResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.priceDiscResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.priceDiscResponse).basis = n.getObjectValue<Json>(Json); }],
            ["discount", (o, n) => { (o as unknown as Microsoft.graph.priceDiscResponse).discount = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.priceDiscResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as Microsoft.graph.priceDiscResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.priceDiscResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
