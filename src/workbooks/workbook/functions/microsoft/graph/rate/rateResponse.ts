...
export class Microsoft.graph.rateResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as Microsoft.graph.rateResponse).fv = n.getObjectValue<Json>(Json); }],
            ["guess", (o, n) => { (o as unknown as Microsoft.graph.rateResponse).guess = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as Microsoft.graph.rateResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pmt", (o, n) => { (o as unknown as Microsoft.graph.rateResponse).pmt = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as Microsoft.graph.rateResponse).pv = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as Microsoft.graph.rateResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
