...
export class Microsoft.graph.countIfResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as Microsoft.graph.countIfResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["range", (o, n) => { (o as unknown as Microsoft.graph.countIfResponse).range = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
