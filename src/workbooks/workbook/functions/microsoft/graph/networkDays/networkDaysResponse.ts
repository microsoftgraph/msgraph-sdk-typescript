...
export class Microsoft.graph.networkDaysResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endDate", (o, n) => { (o as unknown as Microsoft.graph.networkDaysResponse).endDate = n.getObjectValue<Json>(Json); }],
            ["holidays", (o, n) => { (o as unknown as Microsoft.graph.networkDaysResponse).holidays = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Microsoft.graph.networkDaysResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
