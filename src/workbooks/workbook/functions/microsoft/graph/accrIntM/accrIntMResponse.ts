...
export class Microsoft.graph.accrIntMResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.accrIntMResponse).basis = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as Microsoft.graph.accrIntMResponse).issue = n.getObjectValue<Json>(Json); }],
            ["par", (o, n) => { (o as unknown as Microsoft.graph.accrIntMResponse).par = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as Microsoft.graph.accrIntMResponse).rate = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.accrIntMResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
