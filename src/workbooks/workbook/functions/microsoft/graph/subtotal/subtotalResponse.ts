...
export class Microsoft.graph.subtotalResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["functionNum", (o, n) => { (o as unknown as Microsoft.graph.subtotalResponse).functionNum = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.subtotalResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
