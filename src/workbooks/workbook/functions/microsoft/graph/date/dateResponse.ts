...
export class Microsoft.graph.dateResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["day", (o, n) => { (o as unknown as Microsoft.graph.dateResponse).day = n.getObjectValue<Json>(Json); }],
            ["month", (o, n) => { (o as unknown as Microsoft.graph.dateResponse).month = n.getObjectValue<Json>(Json); }],
            ["year", (o, n) => { (o as unknown as Microsoft.graph.dateResponse).year = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
