...
export class Microsoft.graph.tbillEqResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["discount", (o, n) => { (o as unknown as Microsoft.graph.tbillEqResponse).discount = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.tbillEqResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.tbillEqResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
