...
export class Microsoft.graph.besselYResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["n", (o, n) => { (o as unknown as Microsoft.graph.besselYResponse).n = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.besselYResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
