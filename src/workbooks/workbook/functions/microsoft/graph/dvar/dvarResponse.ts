...
export class Microsoft.graph.dvarResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as Microsoft.graph.dvarResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as Microsoft.graph.dvarResponse).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as Microsoft.graph.dvarResponse).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
