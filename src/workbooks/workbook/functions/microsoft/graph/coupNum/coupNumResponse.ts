...
export class Microsoft.graph.coupNumResponse implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.coupNumResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as Microsoft.graph.coupNumResponse).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as Microsoft.graph.coupNumResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as Microsoft.graph.coupNumResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as Microsoft.graph.coupNumResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
