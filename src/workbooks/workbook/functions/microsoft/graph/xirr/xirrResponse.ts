...
export class Microsoft.graph.xirrResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["dates", (o, n) => { (o as unknown as Microsoft.graph.xirrResponse).dates = n.getObjectValue<Json>(Json); }],
            ["guess", (o, n) => { (o as unknown as Microsoft.graph.xirrResponse).guess = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.xirrResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
