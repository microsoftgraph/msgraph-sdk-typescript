...
export class Microsoft.graph.f_Dist_RTResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom1", (o, n) => { (o as unknown as Microsoft.graph.f_Dist_RTResponse).degFreedom1 = n.getObjectValue<Json>(Json); }],
            ["degFreedom2", (o, n) => { (o as unknown as Microsoft.graph.f_Dist_RTResponse).degFreedom2 = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Microsoft.graph.f_Dist_RTResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
