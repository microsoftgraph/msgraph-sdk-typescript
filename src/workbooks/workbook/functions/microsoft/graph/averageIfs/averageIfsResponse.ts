...
export class Microsoft.graph.averageIfsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["averageRange", (o, n) => { (o as unknown as Microsoft.graph.averageIfsResponse).averageRange = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.averageIfsResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
