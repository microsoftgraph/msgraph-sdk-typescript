...
export class Microsoft.graph.t_InvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom", (o, n) => { (o as unknown as Microsoft.graph.t_InvResponse).degFreedom = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Microsoft.graph.t_InvResponse).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
