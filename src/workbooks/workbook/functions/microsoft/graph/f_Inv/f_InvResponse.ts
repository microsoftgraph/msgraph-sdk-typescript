...
export class Microsoft.graph.f_InvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom1", (o, n) => { (o as unknown as Microsoft.graph.f_InvResponse).degFreedom1 = n.getObjectValue<Json>(Json); }],
            ["degFreedom2", (o, n) => { (o as unknown as Microsoft.graph.f_InvResponse).degFreedom2 = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Microsoft.graph.f_InvResponse).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
