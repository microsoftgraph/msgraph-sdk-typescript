...
export class Microsoft.graph.binom_InvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alpha", (o, n) => { (o as unknown as Microsoft.graph.binom_InvResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["probabilityS", (o, n) => { (o as unknown as Microsoft.graph.binom_InvResponse).probabilityS = n.getObjectValue<Json>(Json); }],
            ["trials", (o, n) => { (o as unknown as Microsoft.graph.binom_InvResponse).trials = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
