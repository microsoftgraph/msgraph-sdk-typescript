...
export class Microsoft.graph.chiSq_Inv_RTResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom", (o, n) => { (o as unknown as Microsoft.graph.chiSq_Inv_RTResponse).degFreedom = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Microsoft.graph.chiSq_Inv_RTResponse).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
