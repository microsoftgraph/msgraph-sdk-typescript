...
export class Microsoft.graph.rriResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as Microsoft.graph.rriResponse).fv = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as Microsoft.graph.rriResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as Microsoft.graph.rriResponse).pv = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
