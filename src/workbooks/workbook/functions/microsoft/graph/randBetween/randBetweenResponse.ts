...
export class Microsoft.graph.randBetweenResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["bottom", (o, n) => { (o as unknown as Microsoft.graph.randBetweenResponse).bottom = n.getObjectValue<Json>(Json); }],
            ["top", (o, n) => { (o as unknown as Microsoft.graph.randBetweenResponse).top = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
