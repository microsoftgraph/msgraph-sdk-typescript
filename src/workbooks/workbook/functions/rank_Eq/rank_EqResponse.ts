...
export class Rank_EqResponse implements Parsable {
    ...
    /**
     * Instantiates a new rank_EqResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Rank_EqResponse).number = n.getObjectValue<Json>(Json); }],
            ["order", (o, n) => { (o as unknown as Rank_EqResponse).order = n.getObjectValue<Json>(Json); }],
            ["ref", (o, n) => { (o as unknown as Rank_EqResponse).ref = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
