...
export class LogNorm_InvResponse implements Parsable {
    ...
    /**
     * Instantiates a new logNorm_InvResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mean", (o, n) => { (o as unknown as LogNorm_InvResponse).mean = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as LogNorm_InvResponse).probability = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as LogNorm_InvResponse).standardDev = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
