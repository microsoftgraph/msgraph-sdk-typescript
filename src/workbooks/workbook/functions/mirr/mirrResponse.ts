...
export class MirrResponse implements Parsable {
    ...
    /**
     * Instantiates a new mirrResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["financeRate", (o, n) => { (o as unknown as MirrResponse).financeRate = n.getObjectValue<Json>(Json); }],
            ["reinvestRate", (o, n) => { (o as unknown as MirrResponse).reinvestRate = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as MirrResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
