...
export class NperResponse implements Parsable {
    ...
    /**
     * Instantiates a new nperResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as NperResponse).fv = n.getObjectValue<Json>(Json); }],
            ["pmt", (o, n) => { (o as unknown as NperResponse).pmt = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as NperResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as NperResponse).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as NperResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
