...
export class ImPowerResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["inumber", (o, n) => { (o as unknown as ImPowerResponse).inumber = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as ImPowerResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
