...
export class Quartile_ExcResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Quartile_ExcResponse).array = n.getObjectValue<Json>(Json); }],
            ["quart", (o, n) => { (o as unknown as Quartile_ExcResponse).quart = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
