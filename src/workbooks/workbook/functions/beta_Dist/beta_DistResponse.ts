...
export class Beta_DistResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["a", (o, n) => { (o as unknown as Beta_DistResponse).a = n.getObjectValue<Json>(Json); }],
            ["alpha", (o, n) => { (o as unknown as Beta_DistResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["b", (o, n) => { (o as unknown as Beta_DistResponse).b = n.getObjectValue<Json>(Json); }],
            ["beta", (o, n) => { (o as unknown as Beta_DistResponse).beta = n.getObjectValue<Json>(Json); }],
            ["cumulative", (o, n) => { (o as unknown as Beta_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Beta_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
