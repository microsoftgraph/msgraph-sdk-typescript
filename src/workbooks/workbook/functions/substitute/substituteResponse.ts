...
export class SubstituteResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["instanceNum", (o, n) => { (o as unknown as SubstituteResponse).instanceNum = n.getObjectValue<Json>(Json); }],
            ["newText", (o, n) => { (o as unknown as SubstituteResponse).newText = n.getObjectValue<Json>(Json); }],
            ["oldText", (o, n) => { (o as unknown as SubstituteResponse).oldText = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as SubstituteResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
