...
export class DateResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["day", (o, n) => { (o as unknown as DateResponse).day = n.getObjectValue<Json>(Json); }],
            ["month", (o, n) => { (o as unknown as DateResponse).month = n.getObjectValue<Json>(Json); }],
            ["year", (o, n) => { (o as unknown as DateResponse).year = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
