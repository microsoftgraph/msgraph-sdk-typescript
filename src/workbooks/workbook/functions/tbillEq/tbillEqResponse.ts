...
export class TbillEqResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["discount", (o, n) => { (o as unknown as TbillEqResponse).discount = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as TbillEqResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as TbillEqResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
