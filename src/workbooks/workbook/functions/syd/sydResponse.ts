...
export class SydResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as SydResponse).cost = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as SydResponse).life = n.getObjectValue<Json>(Json); }],
            ["per", (o, n) => { (o as unknown as SydResponse).per = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as SydResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
