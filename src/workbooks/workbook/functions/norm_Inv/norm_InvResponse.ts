...
export class Norm_InvResponse implements Parsable {
    ...
    /**
     * Instantiates a new norm_InvResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mean", (o, n) => { (o as unknown as Norm_InvResponse).mean = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Norm_InvResponse).probability = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Norm_InvResponse).standardDev = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
