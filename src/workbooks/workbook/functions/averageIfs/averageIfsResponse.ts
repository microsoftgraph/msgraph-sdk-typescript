...
export class AverageIfsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["averageRange", (o, n) => { (o as unknown as AverageIfsResponse).averageRange = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as AverageIfsResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
