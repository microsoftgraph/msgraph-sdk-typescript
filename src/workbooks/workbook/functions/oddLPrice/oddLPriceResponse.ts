...
export class OddLPriceResponse implements Parsable {
    ...
    /**
     * Instantiates a new oddLPriceResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as OddLPriceResponse).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as OddLPriceResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["lastInterest", (o, n) => { (o as unknown as OddLPriceResponse).lastInterest = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as OddLPriceResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as OddLPriceResponse).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as OddLPriceResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as OddLPriceResponse).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as OddLPriceResponse).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
