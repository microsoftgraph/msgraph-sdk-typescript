...
export class StandardizeResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mean", (o, n) => { (o as unknown as StandardizeResponse).mean = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as StandardizeResponse).standardDev = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as StandardizeResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
