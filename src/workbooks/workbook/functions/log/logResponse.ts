...
export class LogResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["base", (o, n) => { (o as unknown as LogResponse).base = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as LogResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
