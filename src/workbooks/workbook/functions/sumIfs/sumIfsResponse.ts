...
export class SumIfsResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _sumRange?: Json | undefined;
    private _values?: Json | undefined;
    /**
     * Instantiates a new sumIfsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["sumRange", (o, n) => { (o as unknown as SumIfsResponse).sumRange = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as SumIfsResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
