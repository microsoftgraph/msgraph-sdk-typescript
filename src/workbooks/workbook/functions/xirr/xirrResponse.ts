...
export class XirrResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["dates", (o, n) => { (o as unknown as XirrResponse).dates = n.getObjectValue<Json>(Json); }],
            ["guess", (o, n) => { (o as unknown as XirrResponse).guess = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as XirrResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
