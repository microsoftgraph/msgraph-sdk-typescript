...
export class WeekNumResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["returnType", (o, n) => { (o as unknown as WeekNumResponse).returnType = n.getObjectValue<Json>(Json); }],
            ["serialNumber", (o, n) => { (o as unknown as WeekNumResponse).serialNumber = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
