...
export class MdurationResponse implements Parsable {
    ...
    /**
     * Instantiates a new mdurationResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as MdurationResponse).basis = n.getObjectValue<Json>(Json); }],
            ["coupon", (o, n) => { (o as unknown as MdurationResponse).coupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as MdurationResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as MdurationResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as MdurationResponse).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as MdurationResponse).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
