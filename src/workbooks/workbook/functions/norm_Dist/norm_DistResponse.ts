...
export class Norm_DistResponse implements Parsable {
    ...
    /**
     * Instantiates a new norm_DistResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as Norm_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["mean", (o, n) => { (o as unknown as Norm_DistResponse).mean = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Norm_DistResponse).standardDev = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Norm_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
