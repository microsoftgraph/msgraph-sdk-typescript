...
export class AccrIntMResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as AccrIntMResponse).basis = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as AccrIntMResponse).issue = n.getObjectValue<Json>(Json); }],
            ["par", (o, n) => { (o as unknown as AccrIntMResponse).par = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as AccrIntMResponse).rate = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as AccrIntMResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
