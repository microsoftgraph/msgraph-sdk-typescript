...
export class FixedResponse implements Parsable {
    ...
    /**
     * Instantiates a new fixedResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimals", (o, n) => { (o as unknown as FixedResponse).decimals = n.getObjectValue<Json>(Json); }],
            ["noCommas", (o, n) => { (o as unknown as FixedResponse).noCommas = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as FixedResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
