...
export class IrrResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["guess", (o, n) => { (o as unknown as IrrResponse).guess = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as IrrResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
