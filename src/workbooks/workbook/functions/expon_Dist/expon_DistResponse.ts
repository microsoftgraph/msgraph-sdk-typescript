...
export class Expon_DistResponse implements Parsable {
    ...
    /**
     * Instantiates a new expon_DistResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as Expon_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["lambda", (o, n) => { (o as unknown as Expon_DistResponse).lambda = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Expon_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
