...
export class CoupDayBsResponse implements Parsable {
    ...
    /**
     * Instantiates a new coupDayBsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as CoupDayBsResponse).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as CoupDayBsResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as CoupDayBsResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as CoupDayBsResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
