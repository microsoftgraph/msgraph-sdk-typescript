...
export class CoupDaysNcResponse implements Parsable {
    ...
    /**
     * Instantiates a new coupDaysNcResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as CoupDaysNcResponse).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as CoupDaysNcResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as CoupDaysNcResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as CoupDaysNcResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
