...
export class DollarFrResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimalDollar", (o, n) => { (o as unknown as DollarFrResponse).decimalDollar = n.getObjectValue<Json>(Json); }],
            ["fraction", (o, n) => { (o as unknown as DollarFrResponse).fraction = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
