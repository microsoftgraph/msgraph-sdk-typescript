...
export class BaseResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["minLength", (o, n) => { (o as unknown as BaseResponse).minLength = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as BaseResponse).number = n.getObjectValue<Json>(Json); }],
            ["radix", (o, n) => { (o as unknown as BaseResponse).radix = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
