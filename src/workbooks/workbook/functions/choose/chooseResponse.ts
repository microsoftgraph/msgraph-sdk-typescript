...
export class ChooseResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["indexNum", (o, n) => { (o as unknown as ChooseResponse).indexNum = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as ChooseResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
