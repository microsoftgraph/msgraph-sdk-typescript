...
export class Weibull_DistResponse implements Parsable {
    ...
    /**
     * Instantiates a new weibull_DistResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alpha", (o, n) => { (o as unknown as Weibull_DistResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["beta", (o, n) => { (o as unknown as Weibull_DistResponse).beta = n.getObjectValue<Json>(Json); }],
            ["cumulative", (o, n) => { (o as unknown as Weibull_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Weibull_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
