...
export class ReplaceResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["newText", (o, n) => { (o as unknown as ReplaceResponse).newText = n.getObjectValue<Json>(Json); }],
            ["numChars", (o, n) => { (o as unknown as ReplaceResponse).numChars = n.getObjectValue<Json>(Json); }],
            ["oldText", (o, n) => { (o as unknown as ReplaceResponse).oldText = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as ReplaceResponse).startNum = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
