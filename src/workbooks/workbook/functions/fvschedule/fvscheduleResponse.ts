...
export class FvscheduleResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["principal", (o, n) => { (o as unknown as FvscheduleResponse).principal = n.getObjectValue<Json>(Json); }],
            ["schedule", (o, n) => { (o as unknown as FvscheduleResponse).schedule = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
