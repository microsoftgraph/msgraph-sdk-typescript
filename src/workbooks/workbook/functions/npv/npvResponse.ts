...
export class NpvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["rate", (o, n) => { (o as unknown as NpvResponse).rate = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as NpvResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
