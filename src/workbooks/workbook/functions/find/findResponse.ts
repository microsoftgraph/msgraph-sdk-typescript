...
export class FindResponse implements Parsable {
    ...
    /**
     * Instantiates a new findResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["findText", (o, n) => { (o as unknown as FindResponse).findText = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as FindResponse).startNum = n.getObjectValue<Json>(Json); }],
            ["withinText", (o, n) => { (o as unknown as FindResponse).withinText = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
