...
export class DcountAResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as DcountAResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as DcountAResponse).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as DcountAResponse).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
