...
export class F_InvResponse implements Parsable {
    ...
    /**
     * Instantiates a new f_InvResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom1", (o, n) => { (o as unknown as F_InvResponse).degFreedom1 = n.getObjectValue<Json>(Json); }],
            ["degFreedom2", (o, n) => { (o as unknown as F_InvResponse).degFreedom2 = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as F_InvResponse).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
