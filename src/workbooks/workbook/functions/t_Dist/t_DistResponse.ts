...
export class T_DistResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as T_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["degFreedom", (o, n) => { (o as unknown as T_DistResponse).degFreedom = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as T_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
