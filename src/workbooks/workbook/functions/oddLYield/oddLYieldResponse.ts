...
export class OddLYieldResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as OddLYieldResponse).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as OddLYieldResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["lastInterest", (o, n) => { (o as unknown as OddLYieldResponse).lastInterest = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as OddLYieldResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as OddLYieldResponse).pr = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as OddLYieldResponse).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as OddLYieldResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as OddLYieldResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
