...
export class TimeResponse implements Parsable {
    ...
    /**
     * Instantiates a new timeResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["hour", (o, n) => { (o as unknown as TimeResponse).hour = n.getObjectValue<Json>(Json); }],
            ["minute", (o, n) => { (o as unknown as TimeResponse).minute = n.getObjectValue<Json>(Json); }],
            ["second", (o, n) => { (o as unknown as TimeResponse).second = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
