...
export class IpmtResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as IpmtResponse).fv = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as IpmtResponse).nper = n.getObjectValue<Json>(Json); }],
            ["per", (o, n) => { (o as unknown as IpmtResponse).per = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as IpmtResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as IpmtResponse).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as IpmtResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
