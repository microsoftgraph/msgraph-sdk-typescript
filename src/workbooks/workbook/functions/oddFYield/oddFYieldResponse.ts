...
export class OddFYieldResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as OddFYieldResponse).basis = n.getObjectValue<Json>(Json); }],
            ["firstCoupon", (o, n) => { (o as unknown as OddFYieldResponse).firstCoupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as OddFYieldResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as OddFYieldResponse).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as OddFYieldResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as OddFYieldResponse).pr = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as OddFYieldResponse).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as OddFYieldResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as OddFYieldResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
