...
export class PriceMatResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as PriceMatResponse).basis = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as PriceMatResponse).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as PriceMatResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as PriceMatResponse).rate = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as PriceMatResponse).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as PriceMatResponse).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
