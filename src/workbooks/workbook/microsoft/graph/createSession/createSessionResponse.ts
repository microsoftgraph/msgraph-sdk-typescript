...
export class Microsoft.graph.createSessionResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["persistChanges", (o, n) => { (o as unknown as Microsoft.graph.createSessionResponse).persistChanges = n.getBooleanValue(); }],
        ]);
    };
    /**
