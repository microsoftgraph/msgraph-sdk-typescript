...
export class AddResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as AddResponse).comment = n.getStringValue(); }],
            ["name", (o, n) => { (o as unknown as AddResponse).name = n.getStringValue(); }],
            ["reference", (o, n) => { (o as unknown as AddResponse).reference = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
