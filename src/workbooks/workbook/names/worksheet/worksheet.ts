...
import {WorkbookWorksheetProtection} from './protection/workbookWorksheetProtection';
...
export class Worksheet extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["charts", (o, n) => { (o as unknown as Worksheet).charts = n.getCollectionOfObjectValues<WorkbookChart>(WorkbookChart); }],
            ["name", (o, n) => { (o as unknown as Worksheet).name = n.getStringValue(); }],
            ["names", (o, n) => { (o as unknown as Worksheet).names = n.getCollectionOfObjectValues<WorkbookNamedItem>(WorkbookNamedItem); }],
            ["pivotTables", (o, n) => { (o as unknown as Worksheet).pivotTables = n.getCollectionOfObjectValues<WorkbookPivotTable>(WorkbookPivotTable); }],
            ["position", (o, n) => { (o as unknown as Worksheet).position = n.getNumberValue(); }],
            ["protection", (o, n) => { (o as unknown as Worksheet).protection = n.getObjectValue<WorkbookWorksheetProtection>(WorkbookWorksheetProtection); }],
            ["tables", (o, n) => { (o as unknown as Worksheet).tables = n.getCollectionOfObjectValues<WorkbookTable>(WorkbookTable); }],
            ["visibility", (o, n) => { (o as unknown as Worksheet).visibility = n.getStringValue(); }],
        ]);
    };
    /**
