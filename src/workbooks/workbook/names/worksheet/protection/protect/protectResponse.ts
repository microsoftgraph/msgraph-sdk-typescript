...
export class ProtectResponse implements Parsable {
    ...
    /**
     * Instantiates a new protectResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["options", (o, n) => { (o as unknown as ProtectResponse).options = n.getObjectValue<WorkbookWorksheetProtectionOptions>(WorkbookWorksheetProtectionOptions); }],
        ]);
    };
    /**
