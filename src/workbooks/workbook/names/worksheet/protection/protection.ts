...
export class Protection extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["options", (o, n) => { (o as unknown as Protection).options = n.getObjectValue<WorkbookWorksheetProtectionOptions>(WorkbookWorksheetProtectionOptions); }],
            ["protected", (o, n) => { (o as unknown as Protection).protected = n.getBooleanValue(); }],
        ]);
    };
    /**
