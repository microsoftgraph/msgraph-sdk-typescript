...
export class Microsoft.graph.applyBottomItemsFilterResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["count", (o, n) => { (o as unknown as Microsoft.graph.applyBottomItemsFilterResponse).count = n.getNumberValue(); }],
        ]);
    };
    /**
