...
export class Microsoft.graph.addResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["index", (o, n) => { (o as unknown as Microsoft.graph.addResponse).index = n.getNumberValue(); }],
            ["values", (o, n) => { (o as unknown as Microsoft.graph.addResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
