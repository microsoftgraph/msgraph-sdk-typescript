...
export class Microsoft.graph.addResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as Microsoft.graph.addResponse).comment = n.getStringValue(); }],
            ["name", (o, n) => { (o as unknown as Microsoft.graph.addResponse).name = n.getStringValue(); }],
            ["reference", (o, n) => { (o as unknown as Microsoft.graph.addResponse).reference = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
