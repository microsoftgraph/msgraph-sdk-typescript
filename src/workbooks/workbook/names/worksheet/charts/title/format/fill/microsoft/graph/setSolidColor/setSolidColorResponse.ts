...
export class Microsoft.graph.setSolidColorResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["color", (o, n) => { (o as unknown as Microsoft.graph.setSolidColorResponse).color = n.getStringValue(); }],
        ]);
    };
    /**
