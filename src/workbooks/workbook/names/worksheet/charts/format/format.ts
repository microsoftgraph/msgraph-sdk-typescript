...
import {WorkbookChartFont} from '../../../../worksheets/charts/axes/seriesAxis/format/font/workbookChartFont';
...
export class Format extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["fill", (o, n) => { (o as unknown as Format).fill = n.getObjectValue<WorkbookChartFill>(WorkbookChartFill); }],
