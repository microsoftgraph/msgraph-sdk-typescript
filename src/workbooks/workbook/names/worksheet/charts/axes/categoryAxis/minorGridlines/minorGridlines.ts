...
export class MinorGridlines extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["format", (o, n) => { (o as unknown as MinorGridlines).format = n.getObjectValue<WorkbookChartGridlinesFormat>(WorkbookChartGridlinesFormat); }],
            ["visible", (o, n) => { (o as unknown as MinorGridlines).visible = n.getBooleanValue(); }],
        ]);
    };
    /**
