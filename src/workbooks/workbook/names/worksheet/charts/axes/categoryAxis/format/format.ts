...
export class Format extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["font", (o, n) => { (o as unknown as Format).font = n.getObjectValue<WorkbookChartFont>(WorkbookChartFont); }],
            ["line", (o, n) => { (o as unknown as Format).line = n.getObjectValue<WorkbookChartLineFormat>(WorkbookChartLineFormat); }],
        ]);
    };
    /**
