...
export class Font extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["bold", (o, n) => { (o as unknown as Font).bold = n.getBooleanValue(); }],
            ["color", (o, n) => { (o as unknown as Font).color = n.getStringValue(); }],
            ["italic", (o, n) => { (o as unknown as Font).italic = n.getBooleanValue(); }],
            ["name", (o, n) => { (o as unknown as Font).name = n.getStringValue(); }],
            ["size", (o, n) => { (o as unknown as Font).size = n.getNumberValue(); }],
            ["underline", (o, n) => { (o as unknown as Font).underline = n.getStringValue(); }],
        ]);
    };
    /**
