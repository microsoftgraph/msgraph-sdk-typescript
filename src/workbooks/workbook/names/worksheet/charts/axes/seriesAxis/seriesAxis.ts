...
import {WorkbookChartAxisFormat} from '../categoryAxis/format/workbookChartAxisFormat';
import {WorkbookChartGridlines} from '../categoryAxis/majorGridlines/workbookChartGridlines';
import {WorkbookChartAxisTitle} from '../categoryAxis/title/workbookChartAxisTitle';
import {SerializationWriter, ParseNode, Parsable} from '@microsoft/kiota-abstractions';

export class SeriesAxis extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["format", (o, n) => { (o as unknown as SeriesAxis).format = n.getObjectValue<WorkbookChartAxisFormat>(WorkbookChartAxisFormat); }],
            ["majorGridlines", (o, n) => { (o as unknown as SeriesAxis).majorGridlines = n.getObjectValue<WorkbookChartGridlines>(WorkbookChartGridlines); }],
            ["majorUnit", (o, n) => { (o as unknown as SeriesAxis).majorUnit = n.getObjectValue<Json>(Json); }],
            ["maximum", (o, n) => { (o as unknown as SeriesAxis).maximum = n.getObjectValue<Json>(Json); }],
            ["minimum", (o, n) => { (o as unknown as SeriesAxis).minimum = n.getObjectValue<Json>(Json); }],
            ["minorGridlines", (o, n) => { (o as unknown as SeriesAxis).minorGridlines = n.getObjectValue<WorkbookChartGridlines>(WorkbookChartGridlines); }],
            ["minorUnit", (o, n) => { (o as unknown as SeriesAxis).minorUnit = n.getObjectValue<Json>(Json); }],
            ["title", (o, n) => { (o as unknown as SeriesAxis).title = n.getObjectValue<WorkbookChartAxisTitle>(WorkbookChartAxisTitle); }],
        ]);
    };
    /**
