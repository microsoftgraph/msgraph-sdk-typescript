...
export class PointsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as PointsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as PointsResponse).value = n.getCollectionOfObjectValues<WorkbookChartPoint>(WorkbookChartPoint); }],
        ]);
    };
    /**
