...
export class Microsoft.graph.setPositionResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endCell", (o, n) => { (o as unknown as Microsoft.graph.setPositionResponse).endCell = n.getObjectValue<Json>(Json); }],
            ["startCell", (o, n) => { (o as unknown as Microsoft.graph.setPositionResponse).startCell = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
