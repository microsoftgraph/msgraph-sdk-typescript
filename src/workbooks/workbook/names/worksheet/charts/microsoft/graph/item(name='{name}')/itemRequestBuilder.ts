...
export class Microsoft.graph.itemRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.itemRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.itemResponse
     */
