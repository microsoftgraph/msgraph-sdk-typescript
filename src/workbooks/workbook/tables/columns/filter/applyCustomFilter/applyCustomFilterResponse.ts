...
export class ApplyCustomFilterResponse implements Parsable {
    ...
    /**
     * Instantiates a new applyCustomFilterResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria1", (o, n) => { (o as unknown as ApplyCustomFilterResponse).criteria1 = n.getStringValue(); }],
            ["criteria2", (o, n) => { (o as unknown as ApplyCustomFilterResponse).criteria2 = n.getStringValue(); }],
            ["oper", (o, n) => { (o as unknown as ApplyCustomFilterResponse).oper = n.getStringValue(); }],
        ]);
    };
    /**
