...
export class TablesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TablesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TablesResponse).value = n.getCollectionOfObjectValues<WorkbookTable>(WorkbookTable); }],
        ]);
    };
    /**
