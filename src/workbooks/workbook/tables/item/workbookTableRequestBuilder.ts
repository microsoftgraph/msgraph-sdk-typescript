...
export class WorkbookTableRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.workbook.tables.columns collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.workbook.tables.rows collection
     * @param id Unique identifier of the item
