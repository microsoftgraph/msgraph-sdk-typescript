...
export class Microsoft.graph.addResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["seriesBy", (o, n) => { (o as unknown as Microsoft.graph.addResponse).seriesBy = n.getStringValue(); }],
            ["sourceData", (o, n) => { (o as unknown as Microsoft.graph.addResponse).sourceData = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as Microsoft.graph.addResponse).type = n.getStringValue(); }],
        ]);
    };
    /**
