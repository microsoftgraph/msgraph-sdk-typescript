...
export class SetDataResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _seriesBy?: string | undefined;
    private _sourceData?: Json | undefined;
    /**
     * Instantiates a new setDataResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["seriesBy", (o, n) => { (o as unknown as SetDataResponse).seriesBy = n.getStringValue(); }],
            ["sourceData", (o, n) => { (o as unknown as SetDataResponse).sourceData = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
