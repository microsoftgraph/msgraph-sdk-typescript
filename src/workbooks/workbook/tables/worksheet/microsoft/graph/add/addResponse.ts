...
export class Microsoft.graph.addResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["address", (o, n) => { (o as unknown as Microsoft.graph.addResponse).address = n.getStringValue(); }],
            ["hasHeaders", (o, n) => { (o as unknown as Microsoft.graph.addResponse).hasHeaders = n.getBooleanValue(); }],
        ]);
    };
    /**
