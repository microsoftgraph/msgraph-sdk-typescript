...
export class Microsoft.graph.protectResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _options?: WorkbookWorksheetProtectionOptions | undefined;
    /**
     * Instantiates a new Microsoft.graph.protectResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["options", (o, n) => { (o as unknown as Microsoft.graph.protectResponse).options = n.getObjectValue<WorkbookWorksheetProtectionOptions>(WorkbookWorksheetProtectionOptions); }],
        ]);
    };
    /**
