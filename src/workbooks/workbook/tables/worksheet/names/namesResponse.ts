...
export class NamesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as NamesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as NamesResponse).value = n.getCollectionOfObjectValues<WorkbookNamedItem>(WorkbookNamedItem); }],
        ]);
    };
    /**
