...
export class PreviewResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["page", (o, n) => { (o as unknown as PreviewResponse).page = n.getStringValue(); }],
            ["zoom", (o, n) => { (o as unknown as PreviewResponse).zoom = n.getNumberValue(); }],
        ]);
    };
    /**
