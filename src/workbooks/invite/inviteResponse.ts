...
export class InviteResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["expirationDateTime", (o, n) => { (o as unknown as InviteResponse).expirationDateTime = n.getStringValue(); }],
            ["message", (o, n) => { (o as unknown as InviteResponse).message = n.getStringValue(); }],
            ["password", (o, n) => { (o as unknown as InviteResponse).password = n.getStringValue(); }],
            ["recipients", (o, n) => { (o as unknown as InviteResponse).recipients = n.getCollectionOfObjectValues<DriveRecipient>(DriveRecipient); }],
            ["requireSignIn", (o, n) => { (o as unknown as InviteResponse).requireSignIn = n.getBooleanValue(); }],
            ["roles", (o, n) => { (o as unknown as InviteResponse).roles = n.getCollectionOfPrimitiveValues<string>(); }],
            ["sendInvitation", (o, n) => { (o as unknown as InviteResponse).sendInvitation = n.getBooleanValue(); }],
        ]);
    };
    /**
