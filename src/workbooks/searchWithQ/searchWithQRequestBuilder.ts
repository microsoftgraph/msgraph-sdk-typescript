...
export class SearchWithQRequestBuilder {
     ...
     * @param q Usage: q={q}
     */
    public constructor(currentPath: string, httpCore: HttpCore, q?: string | undefined, isRawUrl: boolean = true) {
     ...
     */
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SearchWithQ[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.httpCore?.sendCollectionAsync<SearchWithQ>(requestInfo, SearchWithQ, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
