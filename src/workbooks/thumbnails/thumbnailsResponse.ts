...
export class ThumbnailsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ThumbnailsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ThumbnailsResponse).value = n.getCollectionOfObjectValues<ThumbnailSet>(ThumbnailSet); }],
        ]);
    };
    /**
