...
/** Builds and executes requests for operations under /workbooks/{driveItem-id}/versions/{driveItemVersion-id}/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/versions/{driveItemVersion_id}/content";
