...
export class SearchWithQRequestBuilder {
     ...
     */
    public get(h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SearchWithQ[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.requestAdapter?.sendCollectionAsync<SearchWithQ>(requestInfo, SearchWithQ, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
