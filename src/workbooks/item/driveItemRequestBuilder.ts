...
import {DriveItemRequestBuilder as i43975b22cfadb961053dd6f675fe4f6ecc2fc874e7b667c314204de50501260f} from './children/item/driveItemRequestBuilder';
...
export class DriveItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i43975b22cfadb961053dd6f675fe4f6ecc2fc874e7b667c314204de50501260f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("driveItem_id1", id);
        return new i43975b22cfadb961053dd6f675fe4f6ecc2fc874e7b667c314204de50501260f(urlTplParams, this.requestAdapter);
    };
    /**
