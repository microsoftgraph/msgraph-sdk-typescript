...
export class CheckinResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _checkInAs?: string | undefined;
    private _comment?: string | undefined;
    /**
     * Instantiates a new checkinResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["checkInAs", (o, n) => { (o as unknown as CheckinResponse).checkInAs = n.getStringValue(); }],
            ["comment", (o, n) => { (o as unknown as CheckinResponse).comment = n.getStringValue(); }],
        ]);
    };
    /**
