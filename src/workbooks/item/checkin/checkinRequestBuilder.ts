...
export class CheckinRequestBuilder {
     ...
     */
    public post(body: CheckinRequestBodyImpl | undefined, requestConfiguration?: CheckinRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
