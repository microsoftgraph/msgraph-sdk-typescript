...
export class RestoreResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["name", (o, n) => { (o as unknown as RestoreResponse).name = n.getStringValue(); }],
            ["parentReference", (o, n) => { (o as unknown as RestoreResponse).parentReference = n.getObjectValue<ItemReference>(ItemReference); }],
        ]);
    };
    /**
