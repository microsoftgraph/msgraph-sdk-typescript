import {WorkbookFilterCriteria} from '../../../../../../../../../../../../models/microsoft/graph/workbookFilterCriteria';
...
export class ApplyResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as ApplyResponse).criteria = n.getObjectValue<WorkbookFilterCriteria>(WorkbookFilterCriteria); }],
        ]);
    };
    /**
