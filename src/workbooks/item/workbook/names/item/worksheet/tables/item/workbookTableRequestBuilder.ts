...
export class WorkbookTableRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.workbooks.item.workbook.names.item.worksheet.tables.item.columns.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.workbooks.item.workbook.names.item.worksheet.tables.item.rows.item collection
     * @param id Unique identifier of the item
