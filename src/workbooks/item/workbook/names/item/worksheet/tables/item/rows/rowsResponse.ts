...
export class RowsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as RowsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as RowsResponse).value = n.getCollectionOfObjectValues<WorkbookTableRow>(WorkbookTableRow); }],
        ]);
    };
    /**
