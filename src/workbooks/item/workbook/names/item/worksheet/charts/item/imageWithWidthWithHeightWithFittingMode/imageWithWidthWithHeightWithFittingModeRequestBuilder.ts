...
export class ImageWithWidthWithHeightWithFittingModeRequestBuilder {
     ...
     */
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter, width?: number | undefined, height?: number | undefined, fittingMode?: string | undefined) {
        if(!pathParameters) throw new Error("pathParameters cannot be undefined");
        if(!requestAdapter) throw new Error("requestAdapter cannot be undefined");
        this.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/microsoft.graph.image(width={width},height={height},fittingMode='{fittingMode}')";
        const urlTplParams = getPathParameters(pathParameters);
        width && urlTplParams.set("width", width);
        height && urlTplParams.set("height", height);
        fittingMode && urlTplParams.set("fittingMode", fittingMode);
