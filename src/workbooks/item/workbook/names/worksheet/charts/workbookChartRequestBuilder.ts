...
import {WorkbookChartSeriesRequestBuilder} from '../series/item/item/workbookChartSeriesRequestBuilder';
...
export class WorkbookChartRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.names.item.worksheet.charts.item.series.item collection
