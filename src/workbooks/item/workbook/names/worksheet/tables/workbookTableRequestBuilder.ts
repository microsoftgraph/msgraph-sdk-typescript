...
import {WorkbookTableColumnRequestBuilder} from '../columns/item/item/workbookTableColumnRequestBuilder';
...
import {WorkbookTableRowRequestBuilder} from '../rows/item/item/workbookTableRowRequestBuilder';
...
export class WorkbookTableRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.names.item.worksheet.tables.item.columns.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.names.item.worksheet.tables.item.rows.item collection
     * @param id Unique identifier of the item
