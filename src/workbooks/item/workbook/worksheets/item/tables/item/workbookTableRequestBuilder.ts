...
export class WorkbookTableRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.worksheets.item.tables.item.columns.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.worksheets.item.tables.item.rows.item collection
     * @param id Unique identifier of the item
