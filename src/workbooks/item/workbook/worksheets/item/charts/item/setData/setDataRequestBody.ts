...
export class SetDataRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["seriesBy", (o, n) => { (o as unknown as SetDataRequestBody).seriesBy = n.getStringValue(); }],
            ["sourceData", (o, n) => { (o as unknown as SetDataRequestBody).sourceData = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
