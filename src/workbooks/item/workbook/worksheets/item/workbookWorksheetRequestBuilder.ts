...
export class WorkbookWorksheetRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.worksheets.item.charts.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.worksheets.item.names.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.worksheets.item.pivotTables.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.worksheets.item.tables.item collection
     * @param id Unique identifier of the item
