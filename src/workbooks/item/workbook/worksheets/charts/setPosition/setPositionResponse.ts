...
export class SetPositionResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _endCell?: Json | undefined;
    private _startCell?: Json | undefined;
    /**
     * Instantiates a new setPositionResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endCell", (o, n) => { (o as unknown as SetPositionResponse).endCell = n.getObjectValue<Json>(Json); }],
            ["startCell", (o, n) => { (o as unknown as SetPositionResponse).startCell = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
