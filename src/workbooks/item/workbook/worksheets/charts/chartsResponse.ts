...
export class ChartsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ChartsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ChartsResponse).value = n.getCollectionOfObjectValues<WorkbookChart>(WorkbookChart); }],
        ]);
    };
    /**
