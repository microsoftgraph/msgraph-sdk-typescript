...
export class AddFormulaLocalResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as AddFormulaLocalResponse).comment = n.getStringValue(); }],
            ["formula", (o, n) => { (o as unknown as AddFormulaLocalResponse).formula = n.getStringValue(); }],
            ["name", (o, n) => { (o as unknown as AddFormulaLocalResponse).name = n.getStringValue(); }],
        ]);
    };
    /**
