...
export class SessionInfoResourceWithKeyRequestBuilder {
     ...
     */
    public constructor(currentPath: string, httpCore: HttpCore, key?: string | undefined, isRawUrl: boolean = true) {
        if(!currentPath) throw new Error("currentPath cannot be undefined");
        if(!httpCore) throw new Error("httpCore cannot be undefined");
        this.pathSegment = `/microsoft.graph.sessionInfoResource(key='${key ?? ''}')`;
     ...
     * @returns a Promise of SessionInfoResourceWithKeyResponse
     */
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookSessionInfo | undefined> {
