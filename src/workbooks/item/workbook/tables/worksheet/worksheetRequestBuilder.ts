...
import {WorkbookChartRequestBuilder} from './charts/item/item/workbookChartRequestBuilder';
...
import {WorkbookPivotTableRequestBuilder} from './pivotTables/item/item/workbookPivotTableRequestBuilder';
...
export class WorksheetRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.tables.item.worksheet.charts.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.tables.item.worksheet.names.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.tables.item.worksheet.pivotTables.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Builds and executes requests for operations under /workbooks/{driveItem-id}/workbook/tables/{workbookTable-id}/worksheet/microsoft.graph.range(address='{address}')
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.workbooks.item.workbook.tables.item.worksheet.tables.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Builds and executes requests for operations under /workbooks/{driveItem-id}/workbook/tables/{workbookTable-id}/worksheet/microsoft.graph.usedRange(valuesOnly={valuesOnly})
