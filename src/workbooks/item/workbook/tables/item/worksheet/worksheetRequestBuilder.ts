...
export class WorksheetRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.workbooks.item.workbook.tables.item.worksheet.charts.item collection
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.workbooks.item.workbook.tables.item.worksheet.names.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.workbooks.item.workbook.tables.item.worksheet.pivotTables.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.workbooks.item.workbook.tables.item.worksheet.tables.item collection
     * @param id Unique identifier of the item
    ...
    public tablesById(id: string) : WorkbookTableRequestBuilder {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("workbookTable_id1", id);
