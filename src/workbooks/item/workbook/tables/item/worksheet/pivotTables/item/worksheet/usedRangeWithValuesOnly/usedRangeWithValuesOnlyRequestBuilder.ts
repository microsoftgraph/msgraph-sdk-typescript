...
export class UsedRangeWithValuesOnlyRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter, valuesOnly?: boolean | undefined) {
        ...
        this.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/pivotTables/{workbookPivotTable_id}/worksheet/microsoft.graph.usedRange(valuesOnly={valuesOnly})";
