...
export class UsedRangeWithValuesOnlyRequestBuilder {
     ...
     */
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter, valuesOnly?: boolean | undefined) {
        if(!pathParameters) throw new Error("pathParameters cannot be undefined");
        if(!requestAdapter) throw new Error("requestAdapter cannot be undefined");
        this.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/names/{workbookNamedItem_id}/worksheet/microsoft.graph.usedRange(valuesOnly={valuesOnly})";
        const urlTplParams = getPathParameters(pathParameters);
        valuesOnly && urlTplParams.set("valuesOnly", valuesOnly);
     ...
     * @returns a Promise of UsedRangeWithValuesOnlyResponse
     */
