...
export class ApplyTopPercentFilterRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["percent", (o, n) => { (o as unknown as ApplyTopPercentFilterRequestBody).percent = n.getNumberValue(); }],
        ]);
    };
    /**
