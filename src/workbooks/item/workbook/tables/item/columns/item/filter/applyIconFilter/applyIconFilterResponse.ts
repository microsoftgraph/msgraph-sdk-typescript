import {WorkbookIcon} from '../../../../../../../../../models/microsoft/graph/workbookIcon';
...
export class ApplyIconFilterResponse implements Parsable {
    ...
    /**
     * Instantiates a new applyIconFilterResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["icon", (o, n) => { (o as unknown as ApplyIconFilterResponse).icon = n.getObjectValue<WorkbookIcon>(WorkbookIcon); }],
        ]);
    };
    /**
