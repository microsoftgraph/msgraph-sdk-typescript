...
export class DsumRequestBody implements Parsable {
    ...
    /**
     * Instantiates a new dsumRequestBody and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as DsumRequestBody).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as DsumRequestBody).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as DsumRequestBody).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
