...
export class Binom_Dist_RangeResponse implements Parsable {
    ...
    /**
     * Instantiates a new binom_Dist_RangeResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numberS", (o, n) => { (o as unknown as Binom_Dist_RangeResponse).numberS = n.getObjectValue<Json>(Json); }],
            ["numberS2", (o, n) => { (o as unknown as Binom_Dist_RangeResponse).numberS2 = n.getObjectValue<Json>(Json); }],
            ["probabilityS", (o, n) => { (o as unknown as Binom_Dist_RangeResponse).probabilityS = n.getObjectValue<Json>(Json); }],
            ["trials", (o, n) => { (o as unknown as Binom_Dist_RangeResponse).trials = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
