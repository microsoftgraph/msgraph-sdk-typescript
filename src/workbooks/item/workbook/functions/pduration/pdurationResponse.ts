...
export class PdurationResponse implements Parsable {
    ...
    /**
     * Instantiates a new pdurationResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as PdurationResponse).fv = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as PdurationResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as PdurationResponse).rate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
