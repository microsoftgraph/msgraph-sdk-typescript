...
export class YieldMatResponse implements Parsable {
    ...
    /**
     * Instantiates a new yieldMatResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as YieldMatResponse).basis = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as YieldMatResponse).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as YieldMatResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as YieldMatResponse).pr = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as YieldMatResponse).rate = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as YieldMatResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
