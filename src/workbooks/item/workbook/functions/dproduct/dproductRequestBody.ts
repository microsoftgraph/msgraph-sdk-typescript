...
export class DproductRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as DproductRequestBody).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as DproductRequestBody).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as DproductRequestBody).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
