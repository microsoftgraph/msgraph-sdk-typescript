...
export class DproductResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as DproductResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as DproductResponse).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as DproductResponse).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
