...
export class Percentile_IncResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _array?: Json | undefined;
    private _k?: Json | undefined;
    /**
     * Instantiates a new percentile_IncResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Percentile_IncResponse).array = n.getObjectValue<Json>(Json); }],
            ["k", (o, n) => { (o as unknown as Percentile_IncResponse).k = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
