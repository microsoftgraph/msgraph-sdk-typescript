...
export class IfResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["logicalTest", (o, n) => { (o as unknown as IfResponse).logicalTest = n.getObjectValue<Json>(Json); }],
            ["valueIfFalse", (o, n) => { (o as unknown as IfResponse).valueIfFalse = n.getObjectValue<Json>(Json); }],
            ["valueIfTrue", (o, n) => { (o as unknown as IfResponse).valueIfTrue = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
