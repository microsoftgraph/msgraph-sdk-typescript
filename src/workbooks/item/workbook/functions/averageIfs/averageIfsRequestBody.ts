...
export class AverageIfsRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["averageRange", (o, n) => { (o as unknown as AverageIfsRequestBody).averageRange = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as AverageIfsRequestBody).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
