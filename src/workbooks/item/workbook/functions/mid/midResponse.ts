...
export class MidResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numChars", (o, n) => { (o as unknown as MidResponse).numChars = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as MidResponse).startNum = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as MidResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
