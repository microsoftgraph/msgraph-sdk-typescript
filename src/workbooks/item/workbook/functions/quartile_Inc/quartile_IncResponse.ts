...
export class Quartile_IncResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _array?: Json | undefined;
    private _quart?: Json | undefined;
    /**
     * Instantiates a new quartile_IncResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Quartile_IncResponse).array = n.getObjectValue<Json>(Json); }],
            ["quart", (o, n) => { (o as unknown as Quartile_IncResponse).quart = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
