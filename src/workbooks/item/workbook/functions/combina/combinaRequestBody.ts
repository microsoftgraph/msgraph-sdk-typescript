...
export class CombinaRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as CombinaRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["numberChosen", (o, n) => { (o as unknown as CombinaRequestBody).numberChosen = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
