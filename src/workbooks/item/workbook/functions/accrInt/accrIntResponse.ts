...
export class AccrIntResponse implements Parsable {
    ...
    /**
     * Instantiates a new accrIntResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as AccrIntResponse).basis = n.getObjectValue<Json>(Json); }],
            ["calcMethod", (o, n) => { (o as unknown as AccrIntResponse).calcMethod = n.getObjectValue<Json>(Json); }],
            ["firstInterest", (o, n) => { (o as unknown as AccrIntResponse).firstInterest = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as AccrIntResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as AccrIntResponse).issue = n.getObjectValue<Json>(Json); }],
            ["par", (o, n) => { (o as unknown as AccrIntResponse).par = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as AccrIntResponse).rate = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as AccrIntResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
