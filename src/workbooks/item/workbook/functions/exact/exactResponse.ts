...
export class ExactResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _text1?: Json | undefined;
    private _text2?: Json | undefined;
    /**
     * Instantiates a new exactResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["text1", (o, n) => { (o as unknown as ExactResponse).text1 = n.getObjectValue<Json>(Json); }],
            ["text2", (o, n) => { (o as unknown as ExactResponse).text2 = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
