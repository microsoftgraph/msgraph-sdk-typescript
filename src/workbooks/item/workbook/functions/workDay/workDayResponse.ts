...
export class WorkDayResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["days", (o, n) => { (o as unknown as WorkDayResponse).days = n.getObjectValue<Json>(Json); }],
            ["holidays", (o, n) => { (o as unknown as WorkDayResponse).holidays = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as WorkDayResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
