...
export class NumberValueResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimalSeparator", (o, n) => { (o as unknown as NumberValueResponse).decimalSeparator = n.getObjectValue<Json>(Json); }],
            ["groupSeparator", (o, n) => { (o as unknown as NumberValueResponse).groupSeparator = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as NumberValueResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
