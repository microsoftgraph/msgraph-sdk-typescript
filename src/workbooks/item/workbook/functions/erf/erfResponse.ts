...
export class ErfResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["lowerLimit", (o, n) => { (o as unknown as ErfResponse).lowerLimit = n.getObjectValue<Json>(Json); }],
            ["upperLimit", (o, n) => { (o as unknown as ErfResponse).upperLimit = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
