...
export class EoMonthResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["months", (o, n) => { (o as unknown as EoMonthResponse).months = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as EoMonthResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
