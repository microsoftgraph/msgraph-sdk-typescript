...
export class PmtRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as PmtRequestBody).fv = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as PmtRequestBody).nper = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as PmtRequestBody).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as PmtRequestBody).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as PmtRequestBody).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
