...
export class YieldDiscResponse implements Parsable {
    ...
    /**
     * Instantiates a new yieldDiscResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as YieldDiscResponse).basis = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as YieldDiscResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as YieldDiscResponse).pr = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as YieldDiscResponse).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as YieldDiscResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
