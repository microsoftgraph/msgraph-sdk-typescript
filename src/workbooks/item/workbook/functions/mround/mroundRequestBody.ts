...
export class MroundRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["multiple", (o, n) => { (o as unknown as MroundRequestBody).multiple = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as MroundRequestBody).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
