...
export class MatchResponse implements Parsable {
    ...
    /**
     * Instantiates a new matchResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["lookupArray", (o, n) => { (o as unknown as MatchResponse).lookupArray = n.getObjectValue<Json>(Json); }],
            ["lookupValue", (o, n) => { (o as unknown as MatchResponse).lookupValue = n.getObjectValue<Json>(Json); }],
            ["matchType", (o, n) => { (o as unknown as MatchResponse).matchType = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
