...
export class WeekdayResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["returnType", (o, n) => { (o as unknown as WeekdayResponse).returnType = n.getObjectValue<Json>(Json); }],
            ["serialNumber", (o, n) => { (o as unknown as WeekdayResponse).serialNumber = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
