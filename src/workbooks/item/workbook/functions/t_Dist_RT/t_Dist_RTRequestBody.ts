...
export class T_Dist_RTRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom", (o, n) => { (o as unknown as T_Dist_RTRequestBody).degFreedom = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as T_Dist_RTRequestBody).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
