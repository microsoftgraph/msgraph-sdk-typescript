...
export class MdurationRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as MdurationRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["coupon", (o, n) => { (o as unknown as MdurationRequestBody).coupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as MdurationRequestBody).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as MdurationRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as MdurationRequestBody).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as MdurationRequestBody).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
