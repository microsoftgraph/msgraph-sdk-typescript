...
export class CumIPmtResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endPeriod", (o, n) => { (o as unknown as CumIPmtResponse).endPeriod = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as CumIPmtResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as CumIPmtResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as CumIPmtResponse).rate = n.getObjectValue<Json>(Json); }],
            ["startPeriod", (o, n) => { (o as unknown as CumIPmtResponse).startPeriod = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as CumIPmtResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
