...
export class CumIPmtRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endPeriod", (o, n) => { (o as unknown as CumIPmtRequestBody).endPeriod = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as CumIPmtRequestBody).nper = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as CumIPmtRequestBody).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as CumIPmtRequestBody).rate = n.getObjectValue<Json>(Json); }],
            ["startPeriod", (o, n) => { (o as unknown as CumIPmtRequestBody).startPeriod = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as CumIPmtRequestBody).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
