...
export class Gamma_InvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alpha", (o, n) => { (o as unknown as Gamma_InvResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["beta", (o, n) => { (o as unknown as Gamma_InvResponse).beta = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Gamma_InvResponse).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
