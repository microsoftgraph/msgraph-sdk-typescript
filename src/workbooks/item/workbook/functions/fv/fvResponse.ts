...
export class FvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["nper", (o, n) => { (o as unknown as FvResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pmt", (o, n) => { (o as unknown as FvResponse).pmt = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as FvResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as FvResponse).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as FvResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
