...
export class ChiSq_DistResponse implements Parsable {
    ...
    /**
     * Instantiates a new chiSq_DistResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as ChiSq_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["degFreedom", (o, n) => { (o as unknown as ChiSq_DistResponse).degFreedom = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as ChiSq_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
