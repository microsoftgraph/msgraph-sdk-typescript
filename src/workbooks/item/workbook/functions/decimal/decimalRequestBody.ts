...
export class DecimalRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as DecimalRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["radix", (o, n) => { (o as unknown as DecimalRequestBody).radix = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
