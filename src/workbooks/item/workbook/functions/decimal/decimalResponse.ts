...
export class DecimalResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as DecimalResponse).number = n.getObjectValue<Json>(Json); }],
            ["radix", (o, n) => { (o as unknown as DecimalResponse).radix = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
