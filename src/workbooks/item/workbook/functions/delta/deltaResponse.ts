...
export class DeltaResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number1", (o, n) => { (o as unknown as DeltaResponse).number1 = n.getObjectValue<Json>(Json); }],
            ["number2", (o, n) => { (o as unknown as DeltaResponse).number2 = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
