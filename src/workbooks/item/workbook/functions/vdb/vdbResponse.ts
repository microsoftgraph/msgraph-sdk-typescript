...
export class VdbResponse implements Parsable {
    ...
    /**
     * Instantiates a new vdbResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as VdbResponse).cost = n.getObjectValue<Json>(Json); }],
            ["endPeriod", (o, n) => { (o as unknown as VdbResponse).endPeriod = n.getObjectValue<Json>(Json); }],
            ["factor", (o, n) => { (o as unknown as VdbResponse).factor = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as VdbResponse).life = n.getObjectValue<Json>(Json); }],
            ["noSwitch", (o, n) => { (o as unknown as VdbResponse).noSwitch = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as VdbResponse).salvage = n.getObjectValue<Json>(Json); }],
            ["startPeriod", (o, n) => { (o as unknown as VdbResponse).startPeriod = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
