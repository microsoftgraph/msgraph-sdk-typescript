...
export class SeriesSumResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["coefficients", (o, n) => { (o as unknown as SeriesSumResponse).coefficients = n.getObjectValue<Json>(Json); }],
            ["m", (o, n) => { (o as unknown as SeriesSumResponse).m = n.getObjectValue<Json>(Json); }],
            ["n", (o, n) => { (o as unknown as SeriesSumResponse).n = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as SeriesSumResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
