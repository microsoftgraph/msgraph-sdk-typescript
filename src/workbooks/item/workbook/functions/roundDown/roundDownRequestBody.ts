...
export class RoundDownRequestBody implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _number?: Json | undefined;
    private _numDigits?: Json | undefined;
    /**
     * Instantiates a new roundDownRequestBody and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as RoundDownRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["numDigits", (o, n) => { (o as unknown as RoundDownRequestBody).numDigits = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
