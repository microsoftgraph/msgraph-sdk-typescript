...
export class MidbRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numBytes", (o, n) => { (o as unknown as MidbRequestBody).numBytes = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as MidbRequestBody).startNum = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as MidbRequestBody).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
