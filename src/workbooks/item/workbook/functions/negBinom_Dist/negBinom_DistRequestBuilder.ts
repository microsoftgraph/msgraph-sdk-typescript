...
import {NegBinom_DistResponse} from './negBinom_DistResponse';
...
export class NegBinom_DistRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: NegBinom_DistResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: NegBinom_DistResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
        if(!body) throw new Error("body cannot be undefined");
