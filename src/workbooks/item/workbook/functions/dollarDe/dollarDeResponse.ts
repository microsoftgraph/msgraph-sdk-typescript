...
export class DollarDeResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fraction", (o, n) => { (o as unknown as DollarDeResponse).fraction = n.getObjectValue<Json>(Json); }],
            ["fractionalDollar", (o, n) => { (o as unknown as DollarDeResponse).fractionalDollar = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
