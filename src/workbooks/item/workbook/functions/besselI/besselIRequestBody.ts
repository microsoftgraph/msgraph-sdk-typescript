...
export class BesselIRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["n", (o, n) => { (o as unknown as BesselIRequestBody).n = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as BesselIRequestBody).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
