...
export class Confidence_TRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alpha", (o, n) => { (o as unknown as Confidence_TRequestBody).alpha = n.getObjectValue<Json>(Json); }],
            ["size", (o, n) => { (o as unknown as Confidence_TRequestBody).size = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Confidence_TRequestBody).standardDev = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
