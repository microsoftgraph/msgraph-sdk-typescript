...
export class Confidence_TResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alpha", (o, n) => { (o as unknown as Confidence_TResponse).alpha = n.getObjectValue<Json>(Json); }],
            ["size", (o, n) => { (o as unknown as Confidence_TResponse).size = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Confidence_TResponse).standardDev = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
