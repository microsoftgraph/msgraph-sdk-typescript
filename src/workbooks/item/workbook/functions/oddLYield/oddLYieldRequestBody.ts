...
export class OddLYieldRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as OddLYieldRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as OddLYieldRequestBody).frequency = n.getObjectValue<Json>(Json); }],
            ["lastInterest", (o, n) => { (o as unknown as OddLYieldRequestBody).lastInterest = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as OddLYieldRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as OddLYieldRequestBody).pr = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as OddLYieldRequestBody).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as OddLYieldRequestBody).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as OddLYieldRequestBody).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
