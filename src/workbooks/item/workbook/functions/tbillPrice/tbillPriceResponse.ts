...
export class TbillPriceResponse implements Parsable {
    ...
    /**
     * Instantiates a new tbillPriceResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["discount", (o, n) => { (o as unknown as TbillPriceResponse).discount = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as TbillPriceResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as TbillPriceResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
