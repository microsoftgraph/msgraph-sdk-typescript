...
export class BitandResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _number1?: Json | undefined;
    private _number2?: Json | undefined;
    /**
     * Instantiates a new bitandResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number1", (o, n) => { (o as unknown as BitandResponse).number1 = n.getObjectValue<Json>(Json); }],
            ["number2", (o, n) => { (o as unknown as BitandResponse).number2 = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
