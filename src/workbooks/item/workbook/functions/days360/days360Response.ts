...
export class Days360Response implements Parsable {
    ...
    /**
     * Instantiates a new days360Response and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endDate", (o, n) => { (o as unknown as Days360Response).endDate = n.getObjectValue<Json>(Json); }],
            ["method", (o, n) => { (o as unknown as Days360Response).method = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as Days360Response).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
