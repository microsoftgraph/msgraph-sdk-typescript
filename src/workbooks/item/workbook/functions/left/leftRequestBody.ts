...
export class LeftRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numChars", (o, n) => { (o as unknown as LeftRequestBody).numChars = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as LeftRequestBody).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
