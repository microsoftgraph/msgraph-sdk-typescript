...
export class LeftResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _numChars?: Json | undefined;
    private _text?: Json | undefined;
    /**
     * Instantiates a new leftResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numChars", (o, n) => { (o as unknown as LeftResponse).numChars = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as LeftResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
