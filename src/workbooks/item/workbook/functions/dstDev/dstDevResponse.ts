...
export class DstDevResponse implements Parsable {
    ...
    /**
     * Instantiates a new dstDevResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as DstDevResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as DstDevResponse).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as DstDevResponse).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
