...
export class DstDevRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as DstDevRequestBody).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as DstDevRequestBody).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as DstDevRequestBody).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
