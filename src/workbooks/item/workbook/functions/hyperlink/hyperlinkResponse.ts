...
export class HyperlinkResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _friendlyName?: Json | undefined;
    private _linkLocation?: Json | undefined;
    /**
     * Instantiates a new hyperlinkResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["friendlyName", (o, n) => { (o as unknown as HyperlinkResponse).friendlyName = n.getObjectValue<Json>(Json); }],
            ["linkLocation", (o, n) => { (o as unknown as HyperlinkResponse).linkLocation = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
