...
export class Floor_MathResponse implements Parsable {
    ...
    /**
     * Instantiates a new floor_MathResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mode", (o, n) => { (o as unknown as Floor_MathResponse).mode = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Floor_MathResponse).number = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as Floor_MathResponse).significance = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
