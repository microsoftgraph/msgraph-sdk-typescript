...
export class GeStepResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as GeStepResponse).number = n.getObjectValue<Json>(Json); }],
            ["step", (o, n) => { (o as unknown as GeStepResponse).step = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
