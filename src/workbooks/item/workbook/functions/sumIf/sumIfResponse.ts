...
export class SumIfResponse implements Parsable {
    ...
    /**
     * Instantiates a new sumIfResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as SumIfResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["range", (o, n) => { (o as unknown as SumIfResponse).range = n.getObjectValue<Json>(Json); }],
            ["sumRange", (o, n) => { (o as unknown as SumIfResponse).sumRange = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
