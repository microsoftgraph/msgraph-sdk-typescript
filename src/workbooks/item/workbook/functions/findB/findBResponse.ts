...
export class FindBResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["findText", (o, n) => { (o as unknown as FindBResponse).findText = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as FindBResponse).startNum = n.getObjectValue<Json>(Json); }],
            ["withinText", (o, n) => { (o as unknown as FindBResponse).withinText = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
