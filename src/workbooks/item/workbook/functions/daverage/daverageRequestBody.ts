...
export class DaverageRequestBody implements Parsable {
    ...
    /**
     * Instantiates a new daverageRequestBody and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as DaverageRequestBody).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as DaverageRequestBody).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as DaverageRequestBody).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
