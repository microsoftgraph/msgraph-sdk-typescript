...
export class CoupPcdRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as CoupPcdRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as CoupPcdRequestBody).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as CoupPcdRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as CoupPcdRequestBody).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
