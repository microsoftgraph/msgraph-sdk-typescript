...
export class UsdollarResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimals", (o, n) => { (o as unknown as UsdollarResponse).decimals = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as UsdollarResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
