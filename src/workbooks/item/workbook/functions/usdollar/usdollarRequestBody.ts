...
export class UsdollarRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimals", (o, n) => { (o as unknown as UsdollarRequestBody).decimals = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as UsdollarRequestBody).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
