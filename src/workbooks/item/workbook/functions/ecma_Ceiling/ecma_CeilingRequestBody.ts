...
export class Ecma_CeilingRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Ecma_CeilingRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as Ecma_CeilingRequestBody).significance = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
