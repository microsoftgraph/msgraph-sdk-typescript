...
export class F_InvRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom1", (o, n) => { (o as unknown as F_InvRequestBody).degFreedom1 = n.getObjectValue<Json>(Json); }],
            ["degFreedom2", (o, n) => { (o as unknown as F_InvRequestBody).degFreedom2 = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as F_InvRequestBody).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
