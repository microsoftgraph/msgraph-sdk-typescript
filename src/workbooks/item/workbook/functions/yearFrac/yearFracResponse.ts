...
export class YearFracResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as YearFracResponse).basis = n.getObjectValue<Json>(Json); }],
            ["endDate", (o, n) => { (o as unknown as YearFracResponse).endDate = n.getObjectValue<Json>(Json); }],
            ["startDate", (o, n) => { (o as unknown as YearFracResponse).startDate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
