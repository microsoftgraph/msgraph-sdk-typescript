...
export class OddFPriceRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as OddFPriceRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["firstCoupon", (o, n) => { (o as unknown as OddFPriceRequestBody).firstCoupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as OddFPriceRequestBody).frequency = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as OddFPriceRequestBody).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as OddFPriceRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as OddFPriceRequestBody).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as OddFPriceRequestBody).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as OddFPriceRequestBody).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as OddFPriceRequestBody).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
