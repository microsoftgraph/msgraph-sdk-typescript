...
export class RateResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as RateResponse).fv = n.getObjectValue<Json>(Json); }],
            ["guess", (o, n) => { (o as unknown as RateResponse).guess = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as RateResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pmt", (o, n) => { (o as unknown as RateResponse).pmt = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as RateResponse).pv = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as RateResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
