...
export class RomanResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["form", (o, n) => { (o as unknown as RomanResponse).form = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as RomanResponse).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
