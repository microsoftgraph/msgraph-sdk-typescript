...
export class NominalResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["effectRate", (o, n) => { (o as unknown as NominalResponse).effectRate = n.getObjectValue<Json>(Json); }],
            ["npery", (o, n) => { (o as unknown as NominalResponse).npery = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
