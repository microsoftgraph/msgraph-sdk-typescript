...
export class NominalRequestBody implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _effectRate?: Json | undefined;
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["effectRate", (o, n) => { (o as unknown as NominalRequestBody).effectRate = n.getObjectValue<Json>(Json); }],
            ["npery", (o, n) => { (o as unknown as NominalRequestBody).npery = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<Json>("effectRate", this.effectRate);
     ...
     */
    public set effectRate(value: Json | undefined) {
        this._effectRate = value;
    };
    /**
