...
export class DurationResponse implements Parsable {
    ...
    /**
     * Instantiates a new durationResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as DurationResponse).basis = n.getObjectValue<Json>(Json); }],
            ["coupon", (o, n) => { (o as unknown as DurationResponse).coupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as DurationResponse).frequency = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as DurationResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as DurationResponse).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as DurationResponse).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
