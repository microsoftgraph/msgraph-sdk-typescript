...
export class PpmtResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as PpmtResponse).fv = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as PpmtResponse).nper = n.getObjectValue<Json>(Json); }],
            ["per", (o, n) => { (o as unknown as PpmtResponse).per = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as PpmtResponse).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as PpmtResponse).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as PpmtResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
