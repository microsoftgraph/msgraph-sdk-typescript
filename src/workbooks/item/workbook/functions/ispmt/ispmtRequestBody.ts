...
export class IspmtRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["nper", (o, n) => { (o as unknown as IspmtRequestBody).nper = n.getObjectValue<Json>(Json); }],
            ["per", (o, n) => { (o as unknown as IspmtRequestBody).per = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as IspmtRequestBody).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as IspmtRequestBody).rate = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
