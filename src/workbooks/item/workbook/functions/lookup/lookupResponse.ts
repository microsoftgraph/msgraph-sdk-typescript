...
export class LookupResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["lookupValue", (o, n) => { (o as unknown as LookupResponse).lookupValue = n.getObjectValue<Json>(Json); }],
            ["lookupVector", (o, n) => { (o as unknown as LookupResponse).lookupVector = n.getObjectValue<Json>(Json); }],
            ["resultVector", (o, n) => { (o as unknown as LookupResponse).resultVector = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
