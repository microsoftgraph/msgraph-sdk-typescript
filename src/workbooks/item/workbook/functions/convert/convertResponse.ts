...
export class ConvertResponse implements Parsable {
    ...
    /**
     * Instantiates a new convertResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fromUnit", (o, n) => { (o as unknown as ConvertResponse).fromUnit = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as ConvertResponse).number = n.getObjectValue<Json>(Json); }],
            ["toUnit", (o, n) => { (o as unknown as ConvertResponse).toUnit = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
