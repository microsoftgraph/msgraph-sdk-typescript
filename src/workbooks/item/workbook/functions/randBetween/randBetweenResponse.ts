...
export class RandBetweenResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _bottom?: Json | undefined;
    private _top?: Json | undefined;
    /**
     * Instantiates a new randBetweenResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["bottom", (o, n) => { (o as unknown as RandBetweenResponse).bottom = n.getObjectValue<Json>(Json); }],
            ["top", (o, n) => { (o as unknown as RandBetweenResponse).top = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
