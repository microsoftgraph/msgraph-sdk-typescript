...
export class PercentRank_IncRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as PercentRank_IncRequestBody).array = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as PercentRank_IncRequestBody).significance = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as PercentRank_IncRequestBody).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
