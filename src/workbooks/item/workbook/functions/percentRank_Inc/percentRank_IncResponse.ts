...
export class PercentRank_IncResponse implements Parsable {
    ...
    /**
     * Instantiates a new percentRank_IncResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as PercentRank_IncResponse).array = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as PercentRank_IncResponse).significance = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as PercentRank_IncResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
