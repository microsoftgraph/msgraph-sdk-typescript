...
export class F_DistResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as F_DistResponse).cumulative = n.getObjectValue<Json>(Json); }],
            ["degFreedom1", (o, n) => { (o as unknown as F_DistResponse).degFreedom1 = n.getObjectValue<Json>(Json); }],
            ["degFreedom2", (o, n) => { (o as unknown as F_DistResponse).degFreedom2 = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as F_DistResponse).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
