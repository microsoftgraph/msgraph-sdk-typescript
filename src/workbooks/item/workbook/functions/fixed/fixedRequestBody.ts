...
export class FixedRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decimals", (o, n) => { (o as unknown as FixedRequestBody).decimals = n.getObjectValue<Json>(Json); }],
            ["noCommas", (o, n) => { (o as unknown as FixedRequestBody).noCommas = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as FixedRequestBody).number = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
