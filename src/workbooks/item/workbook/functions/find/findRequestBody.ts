...
export class FindRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["findText", (o, n) => { (o as unknown as FindRequestBody).findText = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as FindRequestBody).startNum = n.getObjectValue<Json>(Json); }],
            ["withinText", (o, n) => { (o as unknown as FindRequestBody).withinText = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
