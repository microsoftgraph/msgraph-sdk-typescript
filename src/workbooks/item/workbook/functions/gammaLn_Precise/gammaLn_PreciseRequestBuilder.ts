...
import {GammaLn_PreciseResponse} from './gammaLn_PreciseResponse';
...
export class GammaLn_PreciseRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GammaLn_PreciseResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: GammaLn_PreciseResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
        if(!body) throw new Error("body cannot be undefined");
