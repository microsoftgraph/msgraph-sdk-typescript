...
export class PermutRequestBody implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _number?: Json | undefined;
    private _numberChosen?: Json | undefined;
    /**
     * Instantiates a new permutRequestBody and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as PermutRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["numberChosen", (o, n) => { (o as unknown as PermutRequestBody).numberChosen = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
