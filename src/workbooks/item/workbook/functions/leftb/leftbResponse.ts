...
export class LeftbResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _numBytes?: Json | undefined;
    private _text?: Json | undefined;
    /**
     * Instantiates a new leftbResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numBytes", (o, n) => { (o as unknown as LeftbResponse).numBytes = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as LeftbResponse).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
