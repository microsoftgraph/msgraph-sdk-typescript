...
export class DdbResponse implements Parsable {
    ...
    /**
     * Instantiates a new ddbResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as DdbResponse).cost = n.getObjectValue<Json>(Json); }],
            ["factor", (o, n) => { (o as unknown as DdbResponse).factor = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as DdbResponse).life = n.getObjectValue<Json>(Json); }],
            ["period", (o, n) => { (o as unknown as DdbResponse).period = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as DdbResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
