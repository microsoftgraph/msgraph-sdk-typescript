...
export class ReplaceBResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["newText", (o, n) => { (o as unknown as ReplaceBResponse).newText = n.getObjectValue<Json>(Json); }],
            ["numBytes", (o, n) => { (o as unknown as ReplaceBResponse).numBytes = n.getObjectValue<Json>(Json); }],
            ["oldText", (o, n) => { (o as unknown as ReplaceBResponse).oldText = n.getObjectValue<Json>(Json); }],
            ["startNum", (o, n) => { (o as unknown as ReplaceBResponse).startNum = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
