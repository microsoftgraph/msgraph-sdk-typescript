...
export class TbillEqRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["discount", (o, n) => { (o as unknown as TbillEqRequestBody).discount = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as TbillEqRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as TbillEqRequestBody).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
