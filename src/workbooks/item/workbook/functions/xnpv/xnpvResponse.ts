...
export class XnpvResponse implements Parsable {
    ...
    /**
     * Instantiates a new xnpvResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["dates", (o, n) => { (o as unknown as XnpvResponse).dates = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as XnpvResponse).rate = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as XnpvResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
