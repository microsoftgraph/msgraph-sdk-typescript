...
export class PvResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as PvResponse).fv = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as PvResponse).nper = n.getObjectValue<Json>(Json); }],
            ["pmt", (o, n) => { (o as unknown as PvResponse).pmt = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as PvResponse).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as PvResponse).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
