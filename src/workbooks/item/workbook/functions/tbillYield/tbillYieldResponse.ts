...
export class TbillYieldResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["maturity", (o, n) => { (o as unknown as TbillYieldResponse).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as TbillYieldResponse).pr = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as TbillYieldResponse).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
