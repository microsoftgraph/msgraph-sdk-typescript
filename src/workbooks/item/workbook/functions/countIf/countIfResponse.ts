...
export class CountIfResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as CountIfResponse).criteria = n.getObjectValue<Json>(Json); }],
            ["range", (o, n) => { (o as unknown as CountIfResponse).range = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
