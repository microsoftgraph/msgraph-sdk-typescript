...
export class ChiSq_InvResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _degFreedom?: Json | undefined;
    private _probability?: Json | undefined;
    /**
     * Instantiates a new chiSq_InvResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom", (o, n) => { (o as unknown as ChiSq_InvResponse).degFreedom = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as ChiSq_InvResponse).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
