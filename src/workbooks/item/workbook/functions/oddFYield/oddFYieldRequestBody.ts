...
export class OddFYieldRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as OddFYieldRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["firstCoupon", (o, n) => { (o as unknown as OddFYieldRequestBody).firstCoupon = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as OddFYieldRequestBody).frequency = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as OddFYieldRequestBody).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as OddFYieldRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as OddFYieldRequestBody).pr = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as OddFYieldRequestBody).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as OddFYieldRequestBody).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as OddFYieldRequestBody).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
