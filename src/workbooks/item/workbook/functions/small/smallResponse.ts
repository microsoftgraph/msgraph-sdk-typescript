...
export class SmallResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as SmallResponse).array = n.getObjectValue<Json>(Json); }],
            ["k", (o, n) => { (o as unknown as SmallResponse).k = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
