...
export class SubtotalResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["functionNum", (o, n) => { (o as unknown as SubtotalResponse).functionNum = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as SubtotalResponse).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
