...
export class AmorDegrcResponse implements Parsable {
    ...
    /**
     * Instantiates a new amorDegrcResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as AmorDegrcResponse).basis = n.getObjectValue<Json>(Json); }],
            ["cost", (o, n) => { (o as unknown as AmorDegrcResponse).cost = n.getObjectValue<Json>(Json); }],
            ["datePurchased", (o, n) => { (o as unknown as AmorDegrcResponse).datePurchased = n.getObjectValue<Json>(Json); }],
            ["firstPeriod", (o, n) => { (o as unknown as AmorDegrcResponse).firstPeriod = n.getObjectValue<Json>(Json); }],
            ["period", (o, n) => { (o as unknown as AmorDegrcResponse).period = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as AmorDegrcResponse).rate = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as AmorDegrcResponse).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
