...
export class IntRateRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as IntRateRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["investment", (o, n) => { (o as unknown as IntRateRequestBody).investment = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as IntRateRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as IntRateRequestBody).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as IntRateRequestBody).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
