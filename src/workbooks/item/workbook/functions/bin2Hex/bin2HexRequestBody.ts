...
export class Bin2HexRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Bin2HexRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["places", (o, n) => { (o as unknown as Bin2HexRequestBody).places = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
