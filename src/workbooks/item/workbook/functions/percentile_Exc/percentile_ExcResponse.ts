...
export class Percentile_ExcResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Percentile_ExcResponse).array = n.getObjectValue<Json>(Json); }],
            ["k", (o, n) => { (o as unknown as Percentile_ExcResponse).k = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
