...
export class CopyResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["name", (o, n) => { (o as unknown as CopyResponse).name = n.getStringValue(); }],
            ["parentReference", (o, n) => { (o as unknown as CopyResponse).parentReference = n.getObjectValue<ItemReference>(ItemReference); }],
        ]);
    };
    /**
