...
/** Builds and executes requests for operations under /workbooks/{driveItem-id}/children/{driveItem-id1}  */
export class DriveItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
