...
import { createAppManagementPolicyCollectionResponseFromDiscriminatorValue, createAppManagementPolicyFromDiscriminatorValue, deserializeIntoAppManagementPolicy, serializeAppManagementPolicy, type AppManagementPolicy, type AppManagementPolicyCollectionResponse } from '../../models/';
...
export class AppManagementPoliciesRequestBuilder extends BaseRequestBuilder<AppManagementPoliciesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/appManagementPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AppManagementPoliciesRequestBuilder(x, y));
    }
    /**
