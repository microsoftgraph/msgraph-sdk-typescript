...
import { createUnifiedRoleManagementPolicyCollectionResponseFromDiscriminatorValue, createUnifiedRoleManagementPolicyFromDiscriminatorValue, deserializeIntoUnifiedRoleManagementPolicy, serializeUnifiedRoleManagementPolicy, type UnifiedRoleManagementPolicy, type UnifiedRoleManagementPolicyCollectionResponse } from '../../models/';
 ...
 */
export class RoleManagementPoliciesRequestBuilder extends BaseRequestBuilder<RoleManagementPoliciesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/roleManagementPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RoleManagementPoliciesRequestBuilder(x, y));
    }
    /**
