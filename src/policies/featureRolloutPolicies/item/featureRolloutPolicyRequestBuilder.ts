...
export class FeatureRolloutPolicyRequestBuilder {
    public get appliesTo(): AppliesToRequestBuilder {
        return new AppliesToRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    }
    ...
    public appliesToById(id: String) : DirectoryObjectRequestBuilder {
        ...
        return new DirectoryObjectRequestBuilder(this.currentPath + this.pathSegment + "/appliesTo/" + id, this.httpCore, false);
    };
    /**
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: FeatureRolloutPolicy | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<FeatureRolloutPolicy | undefined> {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: FeatureRolloutPolicy | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
