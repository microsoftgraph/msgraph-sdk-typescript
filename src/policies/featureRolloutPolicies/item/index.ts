...
import { createFeatureRolloutPolicyFromDiscriminatorValue, deserializeIntoFeatureRolloutPolicy, serializeFeatureRolloutPolicy, type FeatureRolloutPolicy } from '../../../models/';
 ...
 */
export class FeatureRolloutPolicyItemRequestBuilder extends BaseRequestBuilder<FeatureRolloutPolicyItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/featureRolloutPolicies/{featureRolloutPolicy%2Did}{?%24select,%24expand}", (x, y) => new FeatureRolloutPolicyItemRequestBuilder(x, y));
    }
    /**
