...
import { createFeatureRolloutPolicyCollectionResponseFromDiscriminatorValue, createFeatureRolloutPolicyFromDiscriminatorValue, deserializeIntoFeatureRolloutPolicy, serializeFeatureRolloutPolicy, type FeatureRolloutPolicy, type FeatureRolloutPolicyCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { FeatureRolloutPolicyItemRequestBuilder } from './item/';
 ...
 */
export class FeatureRolloutPoliciesRequestBuilder extends BaseRequestBuilder<FeatureRolloutPoliciesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/featureRolloutPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new FeatureRolloutPoliciesRequestBuilder(x, y));
    }
    /**
