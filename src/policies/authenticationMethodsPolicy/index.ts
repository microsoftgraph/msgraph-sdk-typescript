...
export class AuthenticationMethodsPolicyRequestBuilder extends BaseRequestBuilder<AuthenticationMethodsPolicyRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/authenticationMethodsPolicy{?%24select,%24expand}", (x, y) => new AuthenticationMethodsPolicyRequestBuilder(x, y));
    }
    /**
