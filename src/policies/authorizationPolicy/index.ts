...
import { createAuthorizationPolicyFromDiscriminatorValue, deserializeIntoAuthorizationPolicy, serializeAuthorizationPolicy, type AuthorizationPolicy } from '../../models/';
 ...
 */
export class AuthorizationPolicyRequestBuilder extends BaseRequestBuilder<AuthorizationPolicyRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/authorizationPolicy{?%24select,%24expand}", (x, y) => new AuthorizationPolicyRequestBuilder(x, y));
    }
    /**
