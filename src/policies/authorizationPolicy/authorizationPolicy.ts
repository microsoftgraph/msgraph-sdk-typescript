...
export class AuthorizationPolicy extends PolicyBase implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["allowInvitesFrom", (o, n) => { (o as unknown as AuthorizationPolicy).allowInvitesFrom = n.getObjectValue<AllowInvitesFrom>(AllowInvitesFrom); }],
            ["blockMsolPowerShell", (o, n) => { (o as unknown as AuthorizationPolicy).blockMsolPowerShell = n.getBooleanValue(); }],
            ["defaultUserRolePermissions", (o, n) => { (o as unknown as AuthorizationPolicy).defaultUserRolePermissions = n.getObjectValue<DefaultUserRolePermissions>(DefaultUserRolePermissions); }],
