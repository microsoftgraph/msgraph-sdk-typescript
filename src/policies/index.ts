...
import { createPolicyRootFromDiscriminatorValue, deserializeIntoPolicyRoot, serializePolicyRoot, type PolicyRoot } from '../models/';
...
export class PoliciesRequestBuilder extends BaseRequestBuilder<PoliciesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies{?%24select,%24expand}", (x, y) => new PoliciesRequestBuilder(x, y));
    }
    /**
     * Get policies
