...
export class ClaimsMappingPoliciesRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: ClaimsMappingPolicy | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: ClaimsMappingPolicy | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ClaimsMappingPolicy | undefined> {
        if(!body) throw new Error("body cannot be undefined");
