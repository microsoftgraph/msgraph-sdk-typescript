...
import { createClaimsMappingPolicyFromDiscriminatorValue, deserializeIntoClaimsMappingPolicy, serializeClaimsMappingPolicy, type ClaimsMappingPolicy } from '../../../models/';
...
export class ClaimsMappingPolicyItemRequestBuilder extends BaseRequestBuilder<ClaimsMappingPolicyItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/claimsMappingPolicies/{claimsMappingPolicy%2Did}{?%24select,%24expand}", (x, y) => new ClaimsMappingPolicyItemRequestBuilder(x, y));
    }
    /**
