...
export class ClaimsMappingPoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ClaimsMappingPoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ClaimsMappingPoliciesResponse).value = n.getCollectionOfObjectValues<ClaimsMappingPolicy>(ClaimsMappingPolicy); }],
        ]);
    };
    /**
