import {createIdentitySecurityDefaultsEnforcementPolicyFromDiscriminatorValue} from '../../models/microsoft/graph/createIdentitySecurityDefaultsEnforcementPolicyFromDiscriminatorValue';
