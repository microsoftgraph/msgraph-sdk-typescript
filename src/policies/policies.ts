...
export class Policies extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["activityBasedTimeoutPolicies", (o, n) => { (o as unknown as Policies).activityBasedTimeoutPolicies = n.getCollectionOfObjectValues<ActivityBasedTimeoutPolicy>(ActivityBasedTimeoutPolicy); }],
            ["adminConsentRequestPolicy", (o, n) => { (o as unknown as Policies).adminConsentRequestPolicy = n.getObjectValue<AdminConsentRequestPolicy>(AdminConsentRequestPolicy); }],
            ["authenticationFlowsPolicy", (o, n) => { (o as unknown as Policies).authenticationFlowsPolicy = n.getObjectValue<AuthenticationFlowsPolicy>(AuthenticationFlowsPolicy); }],
            ["authenticationMethodsPolicy", (o, n) => { (o as unknown as Policies).authenticationMethodsPolicy = n.getObjectValue<AuthenticationMethodsPolicy>(AuthenticationMethodsPolicy); }],
            ["authorizationPolicy", (o, n) => { (o as unknown as Policies).authorizationPolicy = n.getObjectValue<AuthorizationPolicy>(AuthorizationPolicy); }],
            ["claimsMappingPolicies", (o, n) => { (o as unknown as Policies).claimsMappingPolicies = n.getCollectionOfObjectValues<ClaimsMappingPolicy>(ClaimsMappingPolicy); }],
            ["conditionalAccessPolicies", (o, n) => { (o as unknown as Policies).conditionalAccessPolicies = n.getCollectionOfObjectValues<ConditionalAccessPolicy>(ConditionalAccessPolicy); }],
            ["featureRolloutPolicies", (o, n) => { (o as unknown as Policies).featureRolloutPolicies = n.getCollectionOfObjectValues<FeatureRolloutPolicy>(FeatureRolloutPolicy); }],
            ["homeRealmDiscoveryPolicies", (o, n) => { (o as unknown as Policies).homeRealmDiscoveryPolicies = n.getCollectionOfObjectValues<HomeRealmDiscoveryPolicy>(HomeRealmDiscoveryPolicy); }],
            ["identitySecurityDefaultsEnforcementPolicy", (o, n) => { (o as unknown as Policies).identitySecurityDefaultsEnforcementPolicy = n.getObjectValue<IdentitySecurityDefaultsEnforcementPolicy>(IdentitySecurityDefaultsEnforcementPolicy); }],
            ["permissionGrantPolicies", (o, n) => { (o as unknown as Policies).permissionGrantPolicies = n.getCollectionOfObjectValues<PermissionGrantPolicy>(PermissionGrantPolicy); }],
            ["tokenIssuancePolicies", (o, n) => { (o as unknown as Policies).tokenIssuancePolicies = n.getCollectionOfObjectValues<TokenIssuancePolicy>(TokenIssuancePolicy); }],
            ["tokenLifetimePolicies", (o, n) => { (o as unknown as Policies).tokenLifetimePolicies = n.getCollectionOfObjectValues<TokenLifetimePolicy>(TokenLifetimePolicy); }],
        ]);
    };
    /**
