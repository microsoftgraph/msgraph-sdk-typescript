...
export class HomeRealmDiscoveryPoliciesRequestBuilder {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<HomeRealmDiscoveryPoliciesResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.requestAdapter?.sendAsync<HomeRealmDiscoveryPoliciesResponse>(requestInfo, HomeRealmDiscoveryPoliciesResponse, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * The policy to control Azure AD authentication behavior for federated users.
     * @param body 
    ...
    public post(body: HomeRealmDiscoveryPolicy | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<HomeRealmDiscoveryPolicy | undefined> {
        ...
        return this.requestAdapter?.sendAsync<HomeRealmDiscoveryPolicy>(requestInfo, HomeRealmDiscoveryPolicy, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
