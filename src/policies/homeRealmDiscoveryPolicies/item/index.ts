...
import { createHomeRealmDiscoveryPolicyFromDiscriminatorValue, deserializeIntoHomeRealmDiscoveryPolicy, serializeHomeRealmDiscoveryPolicy, type HomeRealmDiscoveryPolicy } from '../../../models/';
...
export class HomeRealmDiscoveryPolicyItemRequestBuilder extends BaseRequestBuilder<HomeRealmDiscoveryPolicyItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicy%2Did}{?%24select,%24expand}", (x, y) => new HomeRealmDiscoveryPolicyItemRequestBuilder(x, y));
    }
    /**
