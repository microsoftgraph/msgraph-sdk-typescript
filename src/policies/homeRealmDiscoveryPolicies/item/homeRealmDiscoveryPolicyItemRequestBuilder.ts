...
export class HomeRealmDiscoveryPolicyItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: HomeRealmDiscoveryPolicyItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
