...
export class CrossTenantAccessPolicyConfigurationPartnerTenantItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, crossTenantAccessPolicyConfigurationPartnerTenantId?: string | undefined) {
