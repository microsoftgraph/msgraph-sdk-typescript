...
import { createCrossTenantAccessPolicyConfigurationPartnerFromDiscriminatorValue, deserializeIntoCrossTenantAccessPolicyConfigurationPartner, serializeCrossTenantAccessPolicyConfigurationPartner, type CrossTenantAccessPolicyConfigurationPartner } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { IdentitySynchronizationRequestBuilder } from './identitySynchronization/';
 ...
 */
export class CrossTenantAccessPolicyConfigurationPartnerTenantItemRequestBuilder extends BaseRequestBuilder<CrossTenantAccessPolicyConfigurationPartnerTenantItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}{?%24select,%24expand}", (x, y) => new CrossTenantAccessPolicyConfigurationPartnerTenantItemRequestBuilder(x, y));
    }
    /**
