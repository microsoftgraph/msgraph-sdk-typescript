...
import { type ResetToSystemDefaultRequestBuilderPostRequestConfiguration } from './resetToSystemDefaultRequestBuilderPostRequestConfiguration';
...
export class ResetToSystemDefaultRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a resetToSystemDefaultRequestBuilder
     */
    public withUrl(rawUrl: string) : ResetToSystemDefaultRequestBuilder {
