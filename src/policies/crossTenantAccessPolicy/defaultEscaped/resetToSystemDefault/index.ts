 ...
 */
export class ResetToSystemDefaultRequestBuilder extends BaseRequestBuilder<ResetToSystemDefaultRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/default/resetToSystemDefault", (x, y) => new ResetToSystemDefaultRequestBuilder(x, y));
    }
    /**
