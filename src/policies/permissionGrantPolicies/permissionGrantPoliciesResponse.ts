...
export class PermissionGrantPoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as PermissionGrantPoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as PermissionGrantPoliciesResponse).value = n.getCollectionOfObjectValues<PermissionGrantPolicy>(PermissionGrantPolicy); }],
        ]);
    };
    /**
