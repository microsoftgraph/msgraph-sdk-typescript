...
export class PermissionGrantPolicyRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: PermissionGrantPolicy | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.policies.permissionGrantPolicies.excludes collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.policies.permissionGrantPolicies.includes collection
     * @param id Unique identifier of the item
     * @returns a PermissionGrantConditionSetRequestBuilder
     */
