...
export class ExcludesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ExcludesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ExcludesResponse).value = n.getCollectionOfObjectValues<PermissionGrantConditionSet>(PermissionGrantConditionSet); }],
        ]);
    };
    /**
