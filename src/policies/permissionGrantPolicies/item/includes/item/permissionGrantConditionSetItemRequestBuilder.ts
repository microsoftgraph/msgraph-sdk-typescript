...
export class PermissionGrantConditionSetItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<PermissionGrantConditionSetItemRequestBuilderGetQueryParameters> | undefined) : Promise<PermissionGrantConditionSet | undefined> {
     ...
     * @returns a Promise of PermissionGrantConditionSet
     */
    public patch(body: PermissionGrantConditionSet, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<PermissionGrantConditionSet | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<PermissionGrantConditionSetItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, permissionGrantConditionSetItemRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    };
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: PermissionGrantConditionSet, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
