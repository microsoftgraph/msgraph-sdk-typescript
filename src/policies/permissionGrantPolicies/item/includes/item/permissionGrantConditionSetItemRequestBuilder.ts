...
export class PermissionGrantConditionSetItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: PermissionGrantConditionSetItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
