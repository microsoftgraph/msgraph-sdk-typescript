...
export class UpdateAllowedCombinationsRequestBuilder extends BaseRequestBuilder<UpdateAllowedCombinationsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/updateAllowedCombinations", (x, y) => new UpdateAllowedCombinationsRequestBuilder(x, y));
    }
    /**
