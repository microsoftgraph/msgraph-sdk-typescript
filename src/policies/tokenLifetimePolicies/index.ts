...
import { createTokenLifetimePolicyCollectionResponseFromDiscriminatorValue, createTokenLifetimePolicyFromDiscriminatorValue, deserializeIntoTokenLifetimePolicy, serializeTokenLifetimePolicy, type TokenLifetimePolicy, type TokenLifetimePolicyCollectionResponse } from '../../models/';
...
export class TokenLifetimePoliciesRequestBuilder extends BaseRequestBuilder<TokenLifetimePoliciesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/tokenLifetimePolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TokenLifetimePoliciesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public post(body: TokenLifetimePolicy, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<TokenLifetimePolicy | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: TokenLifetimePolicy, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
