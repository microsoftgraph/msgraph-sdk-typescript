...
export class PoliciesRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a Promise of PolicyRoot
     */
    public patch(body: PolicyRoot | undefined, requestConfiguration?: PoliciesRequestBuilderPatchRequestConfiguration | undefined) : Promise<PolicyRoot | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: PolicyRoot | undefined, requestConfiguration?: PoliciesRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializePolicyRoot);
        return requestInfo;
    };
}
