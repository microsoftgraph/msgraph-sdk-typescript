...
import { createActivityBasedTimeoutPolicyCollectionResponseFromDiscriminatorValue, createActivityBasedTimeoutPolicyFromDiscriminatorValue, deserializeIntoActivityBasedTimeoutPolicy, serializeActivityBasedTimeoutPolicy, type ActivityBasedTimeoutPolicy, type ActivityBasedTimeoutPolicyCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ActivityBasedTimeoutPolicyItemRequestBuilder } from './item/';
 ...
 */
export class ActivityBasedTimeoutPoliciesRequestBuilder extends BaseRequestBuilder<ActivityBasedTimeoutPoliciesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/policies/activityBasedTimeoutPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ActivityBasedTimeoutPoliciesRequestBuilder(x, y));
    }
    /**
