...
import { createAlertCollectionResponseFromDiscriminatorValue, type AlertCollectionResponse } from '../../../../models/security/';
...
export class AlertsRequestBuilder extends BaseRequestBuilder<AlertsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/incidents/{incident%2Did}/alerts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AlertsRequestBuilder(x, y));
    }
    /**
