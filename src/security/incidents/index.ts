...
import { createIncidentCollectionResponseFromDiscriminatorValue, createIncidentFromDiscriminatorValue, deserializeIntoIncident, serializeIncident, type Incident, type IncidentCollectionResponse } from '../../models/security/';
 ...
 */
export class IncidentsRequestBuilder extends BaseRequestBuilder<IncidentsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/incidents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new IncidentsRequestBuilder(x, y));
    }
    /**
