...
export class TriggerTypesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: TriggerTypesRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
