...
import { type RetentionEventTypeCollectionResponse } from '../../../models/security/';
...
import { type RetentionEventTypesRequestBuilderGetRequestConfiguration } from './retentionEventTypesRequestBuilderGetRequestConfiguration';
import { type RetentionEventTypesRequestBuilderPostRequestConfiguration } from './retentionEventTypesRequestBuilderPostRequestConfiguration';
...
export class RetentionEventTypesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RetentionEventType, requestConfiguration?: RetentionEventTypesRequestBuilderPostRequestConfiguration | undefined) : Promise<RetentionEventType | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: RetentionEventType, requestConfiguration?: RetentionEventTypesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a retentionEventTypesRequestBuilder
     */
    public withUrl(rawUrl: string) : RetentionEventTypesRequestBuilder {
