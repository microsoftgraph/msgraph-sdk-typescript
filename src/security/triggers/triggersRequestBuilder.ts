...
export class TriggersRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: TriggersRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
