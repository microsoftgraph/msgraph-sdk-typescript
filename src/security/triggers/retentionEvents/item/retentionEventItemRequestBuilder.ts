...
import {RetentionEvent} from '../../../../models/security/';
...
export class RetentionEventItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: RetentionEventItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
