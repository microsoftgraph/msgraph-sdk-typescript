...
import { createRetentionEventFromDiscriminatorValue, serializeRetentionEvent, type RetentionEvent } from '../../../../models/security/';
 ...
 */
export const RetentionEventItemRequestBuilderUriTemplate = "{+baseurl}/security/triggers/retentionEvents/{retentionEvent%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
