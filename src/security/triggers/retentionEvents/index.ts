...
import { createRetentionEventCollectionResponseFromDiscriminatorValue, createRetentionEventFromDiscriminatorValue, deserializeIntoRetentionEvent, serializeRetentionEvent, type RetentionEvent, type RetentionEventCollectionResponse } from '../../../models/security/';
import { CountRequestBuilder } from './count/';
import { RetentionEventItemRequestBuilder } from './item/';
 ...
 */
export class RetentionEventsRequestBuilder extends BaseRequestBuilder<RetentionEventsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/triggers/retentionEvents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RetentionEventsRequestBuilder(x, y));
    }
    /**
