...
export class UserItemRequestBuilder extends BaseRequestBuilder<UserItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/collaborators/{user%2Did}{?%24select,%24expand}", (x, y) => new UserItemRequestBuilder(x, y));
    }
    /**
