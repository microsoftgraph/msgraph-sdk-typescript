...
import { createSubjectRightsRequestFromDiscriminatorValue, deserializeIntoSubjectRightsRequest, serializeSubjectRightsRequest, type SubjectRightsRequest } from '../../../models/';
 ...
 */
export class SubjectRightsRequestItemRequestBuilder extends BaseRequestBuilder<SubjectRightsRequestItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}{?%24select,%24expand}", (x, y) => new SubjectRightsRequestItemRequestBuilder(x, y));
    }
    /**
