...
import { createLandingPageCollectionResponseFromDiscriminatorValue, createLandingPageFromDiscriminatorValue, deserializeIntoLandingPage, serializeLandingPage, type LandingPage, type LandingPageCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { LandingPageItemRequestBuilder } from './item/';
 ...
 */
export class LandingPagesRequestBuilder extends BaseRequestBuilder<LandingPagesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/attackSimulation/landingPages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new LandingPagesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<LandingPagesRequestBuilderGetQueryParameters> | undefined) : Promise<LandingPageCollectionResponse | undefined> {
     ...
     */
    public post(body: LandingPage, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<LandingPage | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<LandingPagesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, landingPagesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: LandingPage, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
