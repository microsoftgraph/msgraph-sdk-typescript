...
import { createTrainingCollectionResponseFromDiscriminatorValue, createTrainingFromDiscriminatorValue, deserializeIntoTraining, serializeTraining, type Training, type TrainingCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { TrainingItemRequestBuilder } from './item/';
 ...
 */
export class TrainingsRequestBuilder extends BaseRequestBuilder<TrainingsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/attackSimulation/trainings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TrainingsRequestBuilder(x, y));
    }
    /**
