import { type TrainingCollectionResponse } from '../../../models/';
 ...
 */
export class TrainingsRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    public byTrainingId(trainingId: string) : TrainingItemRequestBuilder {
        if(!trainingId) throw new Error("trainingId cannot be undefined");
    ...
    public get(requestConfiguration?: TrainingsRequestBuilderGetRequestConfiguration | undefined) : Promise<TrainingCollectionResponse | undefined> {
        ...
        return this.requestAdapter.sendAsync<TrainingCollectionResponse>(requestInfo, createTrainingCollectionResponseFromDiscriminatorValue, errorMapping);
    };
    /**
     ...
     * @returns a trainingsRequestBuilder
     */
    public withUrl(rawUrl: string) : TrainingsRequestBuilder {
