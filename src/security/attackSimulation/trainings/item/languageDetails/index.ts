...
import { createTrainingLanguageDetailCollectionResponseFromDiscriminatorValue, createTrainingLanguageDetailFromDiscriminatorValue, deserializeIntoTrainingLanguageDetail, serializeTrainingLanguageDetail, type TrainingLanguageDetail, type TrainingLanguageDetailCollectionResponse } from '../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { TrainingLanguageDetailItemRequestBuilder } from './item/';
 ...
 */
export class LanguageDetailsRequestBuilder extends BaseRequestBuilder<LanguageDetailsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/attackSimulation/trainings/{training%2Did}/languageDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new LanguageDetailsRequestBuilder(x, y));
    }
    /**
