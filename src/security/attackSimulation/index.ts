...
import { createAttackSimulationRootFromDiscriminatorValue, deserializeIntoAttackSimulationRoot, serializeAttackSimulationRoot, type AttackSimulationRoot } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { EndUserNotificationsRequestBuilder } from './endUserNotifications/';
import { LandingPagesRequestBuilder } from './landingPages/';
import { LoginPagesRequestBuilder } from './loginPages/';
import { OperationsRequestBuilder } from './operations/';
import { PayloadsRequestBuilder } from './payloads/';
import { SimulationAutomationsRequestBuilder } from './simulationAutomations/';
import { SimulationsRequestBuilder } from './simulations/';
import { TrainingsRequestBuilder } from './trainings/';
 ...
 */
export class AttackSimulationRequestBuilder extends BaseRequestBuilder<AttackSimulationRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/attackSimulation{?%24select,%24expand}", (x, y) => new AttackSimulationRequestBuilder(x, y));
    }
    /**
