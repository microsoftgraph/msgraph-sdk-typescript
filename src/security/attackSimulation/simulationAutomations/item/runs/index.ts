...
import { createSimulationAutomationRunCollectionResponseFromDiscriminatorValue, createSimulationAutomationRunFromDiscriminatorValue, deserializeIntoSimulationAutomationRun, serializeSimulationAutomationRun, type SimulationAutomationRun, type SimulationAutomationRunCollectionResponse } from '../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { SimulationAutomationRunItemRequestBuilder } from './item/';
 ...
 */
export class RunsRequestBuilder extends BaseRequestBuilder<RunsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RunsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<RunsRequestBuilderGetQueryParameters> | undefined) : Promise<SimulationAutomationRunCollectionResponse | undefined> {
     ...
     */
    public post(body: SimulationAutomationRun, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SimulationAutomationRun | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<RunsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, runsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: SimulationAutomationRun, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
