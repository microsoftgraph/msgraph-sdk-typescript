...
export class RunsRequestBuilder {
    ...
    public get(requestConfiguration?: RunsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SimulationAutomationRunCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SimulationAutomationRunCollectionResponse>(requestInfo, createSimulationAutomationRunCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to runs for security
     * @param body 
