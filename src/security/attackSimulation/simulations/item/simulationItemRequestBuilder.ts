...
export class SimulationItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, simulationId?: string | undefined) {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: Simulation | undefined, requestConfiguration?: SimulationItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
