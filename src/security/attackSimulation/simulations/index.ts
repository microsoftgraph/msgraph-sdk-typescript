...
import { createSimulationCollectionResponseFromDiscriminatorValue, createSimulationFromDiscriminatorValue, deserializeIntoSimulation, serializeSimulation, type Simulation, type SimulationCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { SimulationItemRequestBuilder } from './item/';
 ...
 */
export class SimulationsRequestBuilder extends BaseRequestBuilder<SimulationsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/attackSimulation/simulations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SimulationsRequestBuilder(x, y));
    }
    /**
