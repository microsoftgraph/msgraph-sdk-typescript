...
export class SecurityRunHuntingQueryRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RunHuntingQueryPostRequestBody | undefined, requestConfiguration?: SecurityRunHuntingQueryRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<HuntingQueryResults | undefined> {
     ...
     */
    public toPostRequestInformation(body: RunHuntingQueryPostRequestBody | undefined, requestConfiguration?: SecurityRunHuntingQueryRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
