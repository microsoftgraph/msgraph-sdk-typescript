...
import { createAlertCollectionResponseFromDiscriminatorValue, createAlertFromDiscriminatorValue, deserializeIntoAlert, serializeAlert, type Alert, type AlertCollectionResponse } from '../../models/security/';
 ...
 */
export class Alerts_v2RequestBuilder extends BaseRequestBuilder<Alerts_v2RequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/alerts_v2{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new Alerts_v2RequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<Alerts_v2RequestBuilderGetQueryParameters> | undefined) : Promise<AlertCollectionResponse | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<Alerts_v2RequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, alerts_v2RequestBuilderGetQueryParametersMapper);
