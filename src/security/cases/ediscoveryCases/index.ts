...
import { createEdiscoveryCaseCollectionResponseFromDiscriminatorValue, createEdiscoveryCaseFromDiscriminatorValue, deserializeIntoEdiscoveryCase, serializeEdiscoveryCase, type EdiscoveryCase, type EdiscoveryCaseCollectionResponse } from '../../../models/security/';
import { CountRequestBuilder } from './count/';
import { EdiscoveryCaseItemRequestBuilder } from './item/';
 ...
 */
export class EdiscoveryCasesRequestBuilder extends BaseRequestBuilder<EdiscoveryCasesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new EdiscoveryCasesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<EdiscoveryCasesRequestBuilderGetQueryParameters> | undefined) : Promise<EdiscoveryCaseCollectionResponse | undefined> {
     ...
     */
    public post(body: EdiscoveryCase, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EdiscoveryCase | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<EdiscoveryCasesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, ediscoveryCasesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: EdiscoveryCase, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
