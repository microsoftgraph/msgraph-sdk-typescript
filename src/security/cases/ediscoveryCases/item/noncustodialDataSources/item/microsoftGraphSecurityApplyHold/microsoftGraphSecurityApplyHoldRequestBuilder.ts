...
import { type MicrosoftGraphSecurityApplyHoldRequestBuilderPostRequestConfiguration } from './microsoftGraphSecurityApplyHoldRequestBuilderPostRequestConfiguration';
