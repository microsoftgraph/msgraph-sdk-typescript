...
export class DataSourceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: DataSourceRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
