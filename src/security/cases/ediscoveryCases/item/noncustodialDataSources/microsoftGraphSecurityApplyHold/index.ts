...
export class MicrosoftGraphSecurityApplyHoldRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityApplyHoldRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/noncustodialDataSources/microsoft.graph.security.applyHold", (x, y) => new MicrosoftGraphSecurityApplyHoldRequestBuilder(x, y));
    }
    /**
