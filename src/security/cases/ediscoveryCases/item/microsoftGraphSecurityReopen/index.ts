 ...
 */
export class MicrosoftGraphSecurityReopenRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityReopenRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/microsoft.graph.security.reopen", (x, y) => new MicrosoftGraphSecurityReopenRequestBuilder(x, y));
    }
    /**
