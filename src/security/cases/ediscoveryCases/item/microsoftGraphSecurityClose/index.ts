 ...
 */
export class MicrosoftGraphSecurityCloseRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityCloseRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/microsoft.graph.security.close", (x, y) => new MicrosoftGraphSecurityCloseRequestBuilder(x, y));
    }
    /**
