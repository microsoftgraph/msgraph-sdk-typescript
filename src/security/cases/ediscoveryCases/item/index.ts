...
import { createEdiscoveryCaseFromDiscriminatorValue, deserializeIntoEdiscoveryCase, serializeEdiscoveryCase, type EdiscoveryCase } from '../../../../models/security/';
import { CustodiansRequestBuilder } from './custodians/';
import { MicrosoftGraphSecurityCloseRequestBuilder } from './microsoftGraphSecurityClose/';
import { MicrosoftGraphSecurityReopenRequestBuilder } from './microsoftGraphSecurityReopen/';
import { NoncustodialDataSourcesRequestBuilder } from './noncustodialDataSources/';
import { OperationsRequestBuilder } from './operations/';
import { ReviewSetsRequestBuilder } from './reviewSets/';
import { SearchesRequestBuilder } from './searches/';
 ...
 */
export class EdiscoveryCaseItemRequestBuilder extends BaseRequestBuilder<EdiscoveryCaseItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}{?%24select,%24expand}", (x, y) => new EdiscoveryCaseItemRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<EdiscoveryCaseItemRequestBuilderGetQueryParameters> | undefined) : Promise<EdiscoveryCase | undefined> {
     ...
     */
    public patch(body: EdiscoveryCase, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EdiscoveryCase | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<EdiscoveryCaseItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, ediscoveryCaseItemRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    }
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: EdiscoveryCase, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
