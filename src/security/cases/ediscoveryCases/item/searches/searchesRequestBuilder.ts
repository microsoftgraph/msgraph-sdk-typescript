...
export class SearchesRequestBuilder {
    /** The count property */
     ...
     */
    public createGetRequestInformation(requestConfiguration?: SearchesRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: EdiscoverySearch | undefined, requestConfiguration?: SearchesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
    ...
    public get(requestConfiguration?: SearchesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EdiscoverySearchCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EdiscoverySearchCollectionResponse>(requestInfo, createEdiscoverySearchCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to searches for security
     * @param body 
