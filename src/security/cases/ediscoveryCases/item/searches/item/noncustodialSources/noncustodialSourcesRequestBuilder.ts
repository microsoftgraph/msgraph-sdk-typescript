...
export class NoncustodialSourcesRequestBuilder {
    /** The Count property */
     ...
     */
    public createGetRequestInformation(requestConfiguration?: NoncustodialSourcesRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
    ...
    public get(requestConfiguration?: NoncustodialSourcesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EdiscoveryNoncustodialDataSourceCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EdiscoveryNoncustodialDataSourceCollectionResponse>(requestInfo, createEdiscoveryNoncustodialDataSourceCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
