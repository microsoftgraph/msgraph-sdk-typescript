...
export function deserializeIntoPurgeDataPostRequestBody(purgeDataPostRequestBody: PurgeDataPostRequestBody | undefined = {} as PurgeDataPostRequestBody) : Record<string, (node: ParseNode) => void> {
    return {
        "purgeAreas": n => { purgeDataPostRequestBody.purgeAreas = n.getEnumValue<PurgeDataPostRequestBody_purgeAreas>(PurgeDataPostRequestBody_purgeAreasObject); },
        "purgeType": n => { purgeDataPostRequestBody.purgeType = n.getEnumValue<PurgeDataPostRequestBody_purgeType>(PurgeDataPostRequestBody_purgeTypeObject); },
    }
}
export interface PurgeDataPostRequestBody extends AdditionalDataHolder, Parsable {
     ...
     */
    purgeAreas?: PurgeDataPostRequestBody_purgeAreas;
    /**
     * The purgeType property
     */
    purgeType?: PurgeDataPostRequestBody_purgeType;
}
export function serializePurgeDataPostRequestBody(writer: SerializationWriter, purgeDataPostRequestBody: PurgeDataPostRequestBody | undefined = {} as PurgeDataPostRequestBody) : void {
    writer.writeEnumValue<PurgeDataPostRequestBody_purgeAreas>("purgeAreas", purgeDataPostRequestBody.purgeAreas);
    writer.writeEnumValue<PurgeDataPostRequestBody_purgeType>("purgeType", purgeDataPostRequestBody.purgeType);
