 ...
 */
export class MicrosoftGraphSecurityEstimateStatisticsRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityEstimateStatisticsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/microsoft.graph.security.estimateStatistics", (x, y) => new MicrosoftGraphSecurityEstimateStatisticsRequestBuilder(x, y));
    }
    /**
