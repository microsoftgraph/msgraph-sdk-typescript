...
import { createEdiscoverySearchFromDiscriminatorValue, deserializeIntoEdiscoverySearch, serializeEdiscoverySearch, type EdiscoverySearch } from '../../../../../../models/security/';
import { AdditionalSourcesRequestBuilder } from './additionalSources/';
import { AddToReviewSetOperationRequestBuilder } from './addToReviewSetOperation/';
import { CustodianSourcesRequestBuilder } from './custodianSources/';
import { LastEstimateStatisticsOperationRequestBuilder } from './lastEstimateStatisticsOperation/';
import { MicrosoftGraphSecurityEstimateStatisticsRequestBuilder } from './microsoftGraphSecurityEstimateStatistics/';
import { MicrosoftGraphSecurityPurgeDataRequestBuilder } from './microsoftGraphSecurityPurgeData/';
import { NoncustodialSourcesRequestBuilder } from './noncustodialSources/';
 ...
 */
export class EdiscoverySearchItemRequestBuilder extends BaseRequestBuilder<EdiscoverySearchItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}{?%24select,%24expand}", (x, y) => new EdiscoverySearchItemRequestBuilder(x, y));
    }
    /**
