...
export class DataSourceItemRequestBuilder {
     ...
     * @param dataSourceId key: id of dataSource
     * @param pathParameters The raw url or the Url template parameters for the request.
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, dataSourceId?: string | undefined) {
