 ...
 */
export class ChildTagsRequestBuilder {
     ...
     */
    public createGetRequestInformation(requestConfiguration?: ChildTagsRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
