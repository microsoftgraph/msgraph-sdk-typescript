...
import { createEdiscoveryReviewTagFromDiscriminatorValue, deserializeIntoEdiscoveryReviewTag, serializeEdiscoveryReviewTag, type EdiscoveryReviewTag } from '../../../../../../models/security/';
import { ChildTagsRequestBuilder } from './childTags/';
import { ParentRequestBuilder } from './parent/';
...
export class EdiscoveryReviewTagItemRequestBuilder extends BaseRequestBuilder<EdiscoveryReviewTagItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags/{ediscoveryReviewTag%2Did}{?%24select,%24expand}", (x, y) => new EdiscoveryReviewTagItemRequestBuilder(x, y));
    }
    /**
