...
import { createEdiscoveryCustodianCollectionResponseFromDiscriminatorValue, createEdiscoveryCustodianFromDiscriminatorValue, deserializeIntoEdiscoveryCustodian, serializeEdiscoveryCustodian, type EdiscoveryCustodian, type EdiscoveryCustodianCollectionResponse } from '../../../../../models/security/';
 ...
 */
export class CustodiansRequestBuilder extends BaseRequestBuilder<CustodiansRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new CustodiansRequestBuilder(x, y));
    }
    /**
