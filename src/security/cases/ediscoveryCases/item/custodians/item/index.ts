...
import { createEdiscoveryCustodianFromDiscriminatorValue, deserializeIntoEdiscoveryCustodian, serializeEdiscoveryCustodian, type EdiscoveryCustodian } from '../../../../../../models/security/';
 ...
 */
export class EdiscoveryCustodianItemRequestBuilder extends BaseRequestBuilder<EdiscoveryCustodianItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}{?%24select,%24expand}", (x, y) => new EdiscoveryCustodianItemRequestBuilder(x, y));
    }
    /**
