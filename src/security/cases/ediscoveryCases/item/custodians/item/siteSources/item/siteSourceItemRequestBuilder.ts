...
export class SiteSourceItemRequestBuilder {
     ...
     * @param siteSourceId key: id of siteSource
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, siteSourceId?: string | undefined) {
