...
import { createSiteSourceCollectionResponseFromDiscriminatorValue, createSiteSourceFromDiscriminatorValue, deserializeIntoSiteSource, serializeSiteSource, type SiteSource, type SiteSourceCollectionResponse } from '../../../../../../../models/security/';
import { CountRequestBuilder } from './count/';
import { SiteSourceItemRequestBuilder } from './item/';
 ...
 */
export class SiteSourcesRequestBuilder extends BaseRequestBuilder<SiteSourcesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/siteSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SiteSourcesRequestBuilder(x, y));
    }
    /**
