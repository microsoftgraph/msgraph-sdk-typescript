...
export class MicrosoftGraphSecurityRemoveHoldRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityRemoveHoldRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/microsoft.graph.security.removeHold", (x, y) => new MicrosoftGraphSecurityRemoveHoldRequestBuilder(x, y));
    }
    /**
