...
import { createUnifiedGroupSourceCollectionResponseFromDiscriminatorValue, createUnifiedGroupSourceFromDiscriminatorValue, deserializeIntoUnifiedGroupSource, serializeUnifiedGroupSource, type UnifiedGroupSource, type UnifiedGroupSourceCollectionResponse } from '../../../../../../../models/security/';
import { CountRequestBuilder } from './count/';
import { UnifiedGroupSourceItemRequestBuilder } from './item/';
 ...
 */
export class UnifiedGroupSourcesRequestBuilder extends BaseRequestBuilder<UnifiedGroupSourcesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/unifiedGroupSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UnifiedGroupSourcesRequestBuilder(x, y));
    }
    /**
