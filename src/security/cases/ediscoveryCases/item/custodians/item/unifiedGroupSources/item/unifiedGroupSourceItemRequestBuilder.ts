...
export class UnifiedGroupSourceItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: UnifiedGroupSourceItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
