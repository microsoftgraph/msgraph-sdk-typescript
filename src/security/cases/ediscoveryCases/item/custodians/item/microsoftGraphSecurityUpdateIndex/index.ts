...
export class MicrosoftGraphSecurityUpdateIndexRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityUpdateIndexRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/microsoft.graph.security.updateIndex", (x, y) => new MicrosoftGraphSecurityUpdateIndexRequestBuilder(x, y));
    }
    /**
