 ...
 */
export class MicrosoftGraphSecurityRemoveHoldRequestBuilder {
     ...
     */
    public post(body: RemoveHoldPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphSecurityRemoveHoldRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
