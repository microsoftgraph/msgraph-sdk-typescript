...
import { deserializeIntoRemoveHoldPostRequestBody, serializeRemoveHoldPostRequestBody, type RemoveHoldPostRequestBody } from './removeHoldPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface MicrosoftGraphSecurityRemoveHoldRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
