...
export class ApplyTagsRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: ApplyTagsPostRequestBody | undefined, requestConfiguration?: ApplyTagsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
