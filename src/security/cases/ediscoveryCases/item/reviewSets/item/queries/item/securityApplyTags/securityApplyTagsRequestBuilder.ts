...
import {SecurityApplyTagsRequestBuilderPostRequestConfiguration} from './securityApplyTagsRequestBuilderPostRequestConfiguration';
import {BaseRequestBuilder, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the applyTags method.
 */
export class SecurityApplyTagsRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    public toPostRequestInformation(body: ApplyTagsPostRequestBody | undefined, requestConfiguration?: SecurityApplyTagsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
