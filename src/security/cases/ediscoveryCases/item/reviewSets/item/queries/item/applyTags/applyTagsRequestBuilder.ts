...
import {ApplyTagsRequestBuilderPostRequestConfiguration} from './applyTagsRequestBuilderPostRequestConfiguration';
 ...
 */
export class ApplyTagsRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: ApplyTagsPostRequestBody | undefined, requestConfiguration?: ApplyTagsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public post(body: ApplyTagsPostRequestBody | undefined, requestConfiguration?: ApplyTagsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
