...
import { ExportFileStructure, ExportOptions } from '../../../../../../../models/security/';
...
export class MicrosoftGraphSecurityExportRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityExportRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/microsoft.graph.security.export", (x, y) => new MicrosoftGraphSecurityExportRequestBuilder(x, y));
    }
    /**
