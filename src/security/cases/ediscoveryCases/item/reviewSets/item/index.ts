...
import { createEdiscoveryReviewSetFromDiscriminatorValue, deserializeIntoEdiscoveryReviewSet, serializeEdiscoveryReviewSet, type EdiscoveryReviewSet } from '../../../../../../models/security/';
import { MicrosoftGraphSecurityAddToReviewSetRequestBuilder } from './microsoftGraphSecurityAddToReviewSet/';
import { MicrosoftGraphSecurityExportRequestBuilder } from './microsoftGraphSecurityExport/';
import { QueriesRequestBuilder } from './queries/';
 ...
 */
export class EdiscoveryReviewSetItemRequestBuilder extends BaseRequestBuilder<EdiscoveryReviewSetItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}{?%24select,%24expand}", (x, y) => new EdiscoveryReviewSetItemRequestBuilder(x, y));
    }
    /**
