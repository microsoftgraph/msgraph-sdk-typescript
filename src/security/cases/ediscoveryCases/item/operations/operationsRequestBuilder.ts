...
export class OperationsRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: CaseOperation | undefined, requestConfiguration?: OperationsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
    ...
    public get(requestConfiguration?: OperationsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CaseOperationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CaseOperationCollectionResponse>(requestInfo, createCaseOperationCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to operations for security
     * @param body 
