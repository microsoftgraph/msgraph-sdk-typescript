...
import { createCaseOperationCollectionResponseFromDiscriminatorValue, createCaseOperationFromDiscriminatorValue, deserializeIntoCaseOperation, serializeCaseOperation, type CaseOperation, type CaseOperationCollectionResponse } from '../../../../../models/security/';
import { CountRequestBuilder } from './count/';
import { CaseOperationItemRequestBuilder } from './item/';
...
export class OperationsRequestBuilder extends BaseRequestBuilder<OperationsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new OperationsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<OperationsRequestBuilderGetQueryParameters> | undefined) : Promise<CaseOperationCollectionResponse | undefined> {
     ...
     */
    public post(body: CaseOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<CaseOperation | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: CaseOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
