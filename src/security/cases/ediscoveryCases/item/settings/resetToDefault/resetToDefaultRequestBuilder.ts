...
export class ResetToDefaultRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/settings/microsoft.graph.security.resetToDefault";
     ...
     */
    public createPostRequestInformation(requestConfiguration?: ResetToDefaultRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
