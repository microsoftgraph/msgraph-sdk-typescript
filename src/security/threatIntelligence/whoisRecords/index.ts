...
import { createWhoisRecordCollectionResponseFromDiscriminatorValue, createWhoisRecordFromDiscriminatorValue, deserializeIntoWhoisRecord, serializeWhoisRecord, type WhoisRecord, type WhoisRecordCollectionResponse } from '../../../models/security/';
import { CountRequestBuilder } from './count/';
import { WhoisRecordItemRequestBuilder } from './item/';
 ...
 */
export class WhoisRecordsRequestBuilder extends BaseRequestBuilder<WhoisRecordsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/whoisRecords{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new WhoisRecordsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<WhoisRecordsRequestBuilderGetQueryParameters> | undefined) : Promise<WhoisRecordCollectionResponse | undefined> {
     ...
     */
    public post(body: WhoisRecord, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<WhoisRecord | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<WhoisRecordsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, whoisRecordsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: WhoisRecord, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
