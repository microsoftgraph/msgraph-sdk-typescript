...
export interface WhoisRecordItemRequestBuilderDeleteRequestConfiguration {
    /**
     * Request headers
     */
...
export interface WhoisRecordItemRequestBuilderGetRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
     ...
     */
    queryParameters?: WhoisRecordItemRequestBuilderGetQueryParameters;
}
export interface WhoisRecordItemRequestBuilderPatchRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
...
export class WhoisRecordItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: WhoisRecordItemRequestBuilderDeleteRequestConfiguration | undefined) : Promise<void> {
     ...
     */
    public get(requestConfiguration?: WhoisRecordItemRequestBuilderGetRequestConfiguration | undefined) : Promise<WhoisRecord | undefined> {
     ...
     * @returns a Promise of WhoisRecord
     */
    public patch(body: WhoisRecord, requestConfiguration?: WhoisRecordItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<WhoisRecord | undefined> {
     ...
     */
    public toDeleteRequestInformation(requestConfiguration?: WhoisRecordItemRequestBuilderDeleteRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: WhoisRecordItemRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: WhoisRecord, requestConfiguration?: WhoisRecordItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
