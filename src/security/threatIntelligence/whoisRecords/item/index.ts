...
import { createWhoisRecordFromDiscriminatorValue, deserializeIntoWhoisRecord, serializeWhoisRecord, type WhoisRecord } from '../../../../models/security/';
 ...
 */
export class WhoisRecordItemRequestBuilder extends BaseRequestBuilder<WhoisRecordItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/whoisRecords/{whoisRecord%2Did}{?%24select,%24expand}", (x, y) => new WhoisRecordItemRequestBuilder(x, y));
    }
    /**
