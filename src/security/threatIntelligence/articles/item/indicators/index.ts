...
import { createArticleIndicatorCollectionResponseFromDiscriminatorValue, type ArticleIndicatorCollectionResponse } from '../../../../../models/security/';
...
export class IndicatorsRequestBuilder extends BaseRequestBuilder<IndicatorsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/articles/{article%2Did}/indicators{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new IndicatorsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<IndicatorsRequestBuilderGetQueryParameters> | undefined) : Promise<ArticleIndicatorCollectionResponse | undefined> {
