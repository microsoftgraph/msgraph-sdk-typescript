...
import { createArticleFromDiscriminatorValue, deserializeIntoArticle, serializeArticle, type Article } from '../../../../models/security/';
...
export class ArticleItemRequestBuilder extends BaseRequestBuilder<ArticleItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/articles/{article%2Did}{?%24select,%24expand}", (x, y) => new ArticleItemRequestBuilder(x, y));
    }
    /**
     ...
     * @returns a Promise of Article
     */
    public patch(body: Article, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<Article | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: Article, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
