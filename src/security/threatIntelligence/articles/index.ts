...
import { createArticleCollectionResponseFromDiscriminatorValue, createArticleFromDiscriminatorValue, deserializeIntoArticle, serializeArticle, type Article, type ArticleCollectionResponse } from '../../../models/security/';
 ...
 */
export class ArticlesRequestBuilder extends BaseRequestBuilder<ArticlesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/articles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ArticlesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public post(body: Article, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<Article | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: Article, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
