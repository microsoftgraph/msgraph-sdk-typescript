...
import { createVulnerabilityComponentCollectionResponseFromDiscriminatorValue, createVulnerabilityComponentFromDiscriminatorValue, deserializeIntoVulnerabilityComponent, serializeVulnerabilityComponent, type VulnerabilityComponent, type VulnerabilityComponentCollectionResponse } from '../../../../../models/security/';
import { CountRequestBuilder } from './count/';
import { VulnerabilityComponentItemRequestBuilder } from './item/';
...
export class ComponentsRequestBuilder extends BaseRequestBuilder<ComponentsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/vulnerabilities/{vulnerability%2Did}/components{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ComponentsRequestBuilder(x, y));
    }
    /**
