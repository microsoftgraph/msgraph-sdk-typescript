 ...
 */
export class VulnerabilityItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/vulnerabilities/{vulnerability%2Did}{?%24select,%24expand}");
    };
    /**
     ...
     */
    public withUrl(rawUrl: string) : VulnerabilityItemRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new VulnerabilityItemRequestBuilder(rawUrl, this.requestAdapter);
    };
}
