...
export class IntelProfilesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IntelligenceProfile | undefined, requestConfiguration?: IntelProfilesRequestBuilderPostRequestConfiguration | undefined) : Promise<IntelligenceProfile | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: IntelligenceProfile | undefined, requestConfiguration?: IntelProfilesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
