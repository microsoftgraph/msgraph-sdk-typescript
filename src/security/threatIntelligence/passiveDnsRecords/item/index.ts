...
import { createPassiveDnsRecordFromDiscriminatorValue, deserializeIntoPassiveDnsRecord, serializePassiveDnsRecord, type PassiveDnsRecord } from '../../../../models/security/';
...
export class PassiveDnsRecordItemRequestBuilder extends BaseRequestBuilder<PassiveDnsRecordItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord%2Did}{?%24select,%24expand}", (x, y) => new PassiveDnsRecordItemRequestBuilder(x, y));
    }
    /**
     ...
     * @returns a Promise of PassiveDnsRecord
     */
    public patch(body: PassiveDnsRecord, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<PassiveDnsRecord | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: PassiveDnsRecord, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
