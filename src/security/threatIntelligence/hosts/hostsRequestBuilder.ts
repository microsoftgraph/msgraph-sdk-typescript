...
export class HostsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the hosts property of the microsoft.graph.security.threatIntelligence entity.
     * @param hostId Unique identifier of the item
     ...
     */
    public post(body: Host | undefined, requestConfiguration?: HostsRequestBuilderPostRequestConfiguration | undefined) : Promise<Host | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: Host | undefined, requestConfiguration?: HostsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
