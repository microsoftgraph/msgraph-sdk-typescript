 ...
 */
export class ChildHostPairsRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     * @returns a childHostPairsRequestBuilder
     */
    public withUrl(rawUrl: string) : ChildHostPairsRequestBuilder {
