...
import { createHostFromDiscriminatorValue, deserializeIntoHost, serializeHost, type Host } from '../../../../models/security/';
...
export class HostItemRequestBuilder extends BaseRequestBuilder<HostItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}{?%24select,%24expand}", (x, y) => new HostItemRequestBuilder(x, y));
    }
    /**
