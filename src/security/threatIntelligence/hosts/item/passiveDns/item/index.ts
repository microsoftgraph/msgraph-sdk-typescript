 ...
 */
export class PassiveDnsRecordItemRequestBuilder extends BaseRequestBuilder<PassiveDnsRecordItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/passiveDns/{passiveDnsRecord%2Did}{?%24select,%24expand}", (x, y) => new PassiveDnsRecordItemRequestBuilder(x, y));
    }
    /**
