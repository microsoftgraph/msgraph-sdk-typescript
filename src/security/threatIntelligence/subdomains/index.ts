...
import { createSubdomainCollectionResponseFromDiscriminatorValue, createSubdomainFromDiscriminatorValue, deserializeIntoSubdomain, serializeSubdomain, type Subdomain, type SubdomainCollectionResponse } from '../../../models/security/';
...
export class SubdomainsRequestBuilder extends BaseRequestBuilder<SubdomainsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/subdomains{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SubdomainsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public post(body: Subdomain, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<Subdomain | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: Subdomain, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
