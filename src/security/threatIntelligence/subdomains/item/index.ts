...
import { createSubdomainFromDiscriminatorValue, deserializeIntoSubdomain, serializeSubdomain, type Subdomain } from '../../../../models/security/';
...
export class SubdomainItemRequestBuilder extends BaseRequestBuilder<SubdomainItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/subdomains/{subdomain%2Did}{?%24select,%24expand}", (x, y) => new SubdomainItemRequestBuilder(x, y));
    }
    /**
