...
export interface SubdomainItemRequestBuilderDeleteRequestConfiguration {
    /**
     * Request headers
     */
...
export interface SubdomainItemRequestBuilderPatchRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
...
export class SubdomainItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: SubdomainItemRequestBuilderDeleteRequestConfiguration | undefined) : Promise<void> {
     ...
     * @returns a Promise of Subdomain
     */
    public patch(body: Subdomain, requestConfiguration?: SubdomainItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<Subdomain | undefined> {
     ...
     */
    public toDeleteRequestInformation(requestConfiguration?: SubdomainItemRequestBuilderDeleteRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: Subdomain, requestConfiguration?: SubdomainItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
