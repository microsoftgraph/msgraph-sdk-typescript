...
import { createHostTrackerCollectionResponseFromDiscriminatorValue, createHostTrackerFromDiscriminatorValue, deserializeIntoHostTracker, serializeHostTracker, type HostTracker, type HostTrackerCollectionResponse } from '../../../models/security/';
 ...
 */
export class HostTrackersRequestBuilder extends BaseRequestBuilder<HostTrackersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/hostTrackers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new HostTrackersRequestBuilder(x, y));
    }
    /**
