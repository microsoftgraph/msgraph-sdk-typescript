...
export class HostComponentsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: HostComponent | undefined, requestConfiguration?: HostComponentsRequestBuilderPostRequestConfiguration | undefined) : Promise<HostComponent | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: HostComponent | undefined, requestConfiguration?: HostComponentsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
