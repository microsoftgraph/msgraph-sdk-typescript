...
import { createHostCookieCollectionResponseFromDiscriminatorValue, createHostCookieFromDiscriminatorValue, deserializeIntoHostCookie, serializeHostCookie, type HostCookie, type HostCookieCollectionResponse } from '../../../models/security/';
 ...
 */
export class HostCookiesRequestBuilder extends BaseRequestBuilder<HostCookiesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/threatIntelligence/hostCookies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new HostCookiesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<HostCookiesRequestBuilderGetQueryParameters> | undefined) : Promise<HostCookieCollectionResponse | undefined> {
     ...
     */
    public post(body: HostCookie, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<HostCookie | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<HostCookiesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, hostCookiesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: HostCookie, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
