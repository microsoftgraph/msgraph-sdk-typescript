...
import { createSecureScoreControlProfileCollectionResponseFromDiscriminatorValue, createSecureScoreControlProfileFromDiscriminatorValue, deserializeIntoSecureScoreControlProfile, serializeSecureScoreControlProfile, type SecureScoreControlProfile, type SecureScoreControlProfileCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { SecureScoreControlProfileItemRequestBuilder } from './item/';
 ...
 */
export class SecureScoreControlProfilesRequestBuilder extends BaseRequestBuilder<SecureScoreControlProfilesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/security/secureScoreControlProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SecureScoreControlProfilesRequestBuilder(x, y));
    }
    /**
