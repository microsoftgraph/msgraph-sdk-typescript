...
export class GetAvailableExtensionPropertiesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["isSyncedFromOnPremises", (o, n) => { (o as unknown as GetAvailableExtensionPropertiesResponse).isSyncedFromOnPremises = n.getBooleanValue(); }],
        ]);
    };
    /**
