...
/** Builds and executes requests for operations under /organization/{organization-id}/certificateBasedAuthConfiguration/$ref  */
export class $refRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPostRequestInfo(body: $ref | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
