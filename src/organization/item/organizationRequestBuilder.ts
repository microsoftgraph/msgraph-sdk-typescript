...
import {Microsoft.graph.setMobileDeviceManagementAuthorityRequestBuilder} from '../microsoft/graph/setMobileDeviceManagementAuthority/microsoft.graph.setMobileDeviceManagementAuthorityRequestBuilder';
...
export class OrganizationRequestBuilder {
    ...
    public get microsoft.graph.setMobileDeviceManagementAuthority(): Microsoft.graph.setMobileDeviceManagementAuthorityRequestBuilder {
        return new Microsoft.graph.setMobileDeviceManagementAuthorityRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    }
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: Organization | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
