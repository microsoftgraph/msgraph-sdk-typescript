...
export class HeaderLogoRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a Promise of ArrayBuffer
     */
    public put(body: ArrayBuffer | undefined, contentType: string, requestConfiguration?: HeaderLogoRequestBuilderPutRequestConfiguration | undefined) : Promise<ArrayBuffer | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPutRequestInformation(body: ArrayBuffer | undefined, contentType: string, requestConfiguration?: HeaderLogoRequestBuilderPutRequestConfiguration | undefined) : RequestInformation {
