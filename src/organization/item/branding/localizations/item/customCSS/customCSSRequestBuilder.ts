...
import { type CustomCSSRequestBuilderGetRequestConfiguration } from './customCSSRequestBuilderGetRequestConfiguration';
import { type CustomCSSRequestBuilderPutRequestConfiguration } from './customCSSRequestBuilderPutRequestConfiguration';
...
export class CustomCSSRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/organization/{organization%2Did}/branding/localizations/{organizationalBrandingLocalization%2Did}/customCSS");
    };
    /**
     ...
     * @returns a customCSSRequestBuilder
     */
    public withUrl(rawUrl: string) : CustomCSSRequestBuilder {
