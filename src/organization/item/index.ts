...
import { createOrganizationFromDiscriminatorValue, deserializeIntoOrganization, serializeOrganization, type Organization } from '../../models/';
 ...
 */
export class OrganizationItemRequestBuilder extends BaseRequestBuilder<OrganizationItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/organization/{organization%2Did}{?%24select,%24expand}", (x, y) => new OrganizationItemRequestBuilder(x, y));
    }
    /**
