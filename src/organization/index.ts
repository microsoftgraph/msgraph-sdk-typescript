...
import { createOrganizationCollectionResponseFromDiscriminatorValue, createOrganizationFromDiscriminatorValue, deserializeIntoOrganization, serializeOrganization, type Organization, type OrganizationCollectionResponse } from '../models/';
...
import { OrganizationItemRequestBuilder } from './item/';
 ...
 */
export class OrganizationRequestBuilder extends BaseRequestBuilder<OrganizationRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/organization{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new OrganizationRequestBuilder(x, y));
    }
    /**
