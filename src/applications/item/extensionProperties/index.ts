...
import { createExtensionPropertyCollectionResponseFromDiscriminatorValue, createExtensionPropertyFromDiscriminatorValue, deserializeIntoExtensionProperty, serializeExtensionProperty, type ExtensionProperty, type ExtensionPropertyCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ExtensionPropertyItemRequestBuilder } from './item/';
 ...
 */
export class ExtensionPropertiesRequestBuilder extends BaseRequestBuilder<ExtensionPropertiesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/applications/{application%2Did}/extensionProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ExtensionPropertiesRequestBuilder(x, y));
    }
    /**
