...
export class SetVerifiedPublisherRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: SetVerifiedPublisherRequestBody | undefined, requestConfiguration?: SetVerifiedPublisherRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new SetVerifiedPublisherRequestBodyImpl(body)
     ...
     */
    public post(body: SetVerifiedPublisherRequestBodyImpl | undefined, requestConfiguration?: SetVerifiedPublisherRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
