...
export class SetVerifiedPublisherRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: SetVerifiedPublisherPostRequestBody | undefined, requestConfiguration?: SetVerifiedPublisherRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
