...
export class SetVerifiedPublisherRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: SetVerifiedPublisherRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: SetVerifiedPublisherRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
