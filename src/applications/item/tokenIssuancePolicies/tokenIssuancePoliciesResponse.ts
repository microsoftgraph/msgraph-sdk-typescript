...
export class TokenIssuancePoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TokenIssuancePoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TokenIssuancePoliciesResponse).value = n.getCollectionOfObjectValues<TokenIssuancePolicy>(TokenIssuancePolicy); }],
        ]);
    };
    /**
