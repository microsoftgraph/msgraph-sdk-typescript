...
export class AddKeyRequestBuilder {
    ...
    public post(body: KeyCredentialPostRequestBody | undefined, requestConfiguration?: AddKeyRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<KeyCredentialImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<KeyCredentialImpl>(requestInfo, createKeyCredentialFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
