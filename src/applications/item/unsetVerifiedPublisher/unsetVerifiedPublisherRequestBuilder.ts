...
import { type UnsetVerifiedPublisherRequestBuilderPostRequestConfiguration } from './unsetVerifiedPublisherRequestBuilderPostRequestConfiguration';
...
export class UnsetVerifiedPublisherRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a unsetVerifiedPublisherRequestBuilder
     */
    public withUrl(rawUrl: string) : UnsetVerifiedPublisherRequestBuilder {
