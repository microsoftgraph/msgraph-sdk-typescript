 ...
 */
export class UnsetVerifiedPublisherRequestBuilder extends BaseRequestBuilder<UnsetVerifiedPublisherRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/applications/{application%2Did}/unsetVerifiedPublisher", (x, y) => new UnsetVerifiedPublisherRequestBuilder(x, y));
    }
    /**
