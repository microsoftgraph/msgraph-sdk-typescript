...
export class TemplatesRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/templates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
     ...
     */
    public get(requestConfiguration?: TemplatesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SynchronizationTemplateCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SynchronizationTemplateCollectionResponse>(requestInfo, createSynchronizationTemplateCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     ...
     */
    public post(body: SynchronizationTemplate | undefined, requestConfiguration?: TemplatesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SynchronizationTemplate | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SynchronizationTemplate>(requestInfo, createSynchronizationTemplateFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Get templates from applications
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
