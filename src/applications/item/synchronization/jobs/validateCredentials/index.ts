...
export class ValidateCredentialsRequestBuilder extends BaseRequestBuilder<ValidateCredentialsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/validateCredentials", (x, y) => new ValidateCredentialsRequestBuilder(x, y));
    }
    /**
