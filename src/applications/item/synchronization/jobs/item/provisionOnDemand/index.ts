...
export class ProvisionOnDemandRequestBuilder extends BaseRequestBuilder<ProvisionOnDemandRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/provisionOnDemand", (x, y) => new ProvisionOnDemandRequestBuilder(x, y));
    }
    /**
