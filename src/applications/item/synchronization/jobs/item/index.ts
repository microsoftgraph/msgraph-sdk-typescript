...
import { createSynchronizationJobFromDiscriminatorValue, deserializeIntoSynchronizationJob, serializeSynchronizationJob, type SynchronizationJob } from '../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../models/oDataErrors/';
import { PauseRequestBuilder } from './pause/';
import { ProvisionOnDemandRequestBuilder } from './provisionOnDemand/';
import { RestartRequestBuilder } from './restart/';
 ...
 */
export class SynchronizationJobItemRequestBuilder extends BaseRequestBuilder<SynchronizationJobItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}{?%24select,%24expand}", (x, y) => new SynchronizationJobItemRequestBuilder(x, y));
    }
    /**
