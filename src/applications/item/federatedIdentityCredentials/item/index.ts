...
import { createFederatedIdentityCredentialFromDiscriminatorValue, deserializeIntoFederatedIdentityCredential, serializeFederatedIdentityCredential, type FederatedIdentityCredential } from '../../../../models/';
 ...
 */
export class FederatedIdentityCredentialItemRequestBuilder extends BaseRequestBuilder<FederatedIdentityCredentialItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/applications/{application%2Did}/federatedIdentityCredentials/{federatedIdentityCredential%2Did}{?%24select,%24expand}", (x, y) => new FederatedIdentityCredentialItemRequestBuilder(x, y));
    }
    /**
