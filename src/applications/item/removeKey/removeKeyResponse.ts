...
export class RemoveKeyResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _keyId?: string | undefined;
    private _proof?: string | undefined;
    /**
     * Instantiates a new removeKeyResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["keyId", (o, n) => { (o as unknown as RemoveKeyResponse).keyId = n.getStringValue(); }],
            ["proof", (o, n) => { (o as unknown as RemoveKeyResponse).proof = n.getStringValue(); }],
        ]);
    };
    /**
