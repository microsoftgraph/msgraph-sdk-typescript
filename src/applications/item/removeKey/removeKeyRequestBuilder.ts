...
export class RemoveKeyRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/applications/{application%2Did}/removeKey";
     ...
     */
    public toPostRequestInformation(body: RemoveKeyPostRequestBody | undefined, requestConfiguration?: RemoveKeyRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
