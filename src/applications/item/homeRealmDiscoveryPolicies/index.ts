...
export class HomeRealmDiscoveryPoliciesRequestBuilder extends BaseRequestBuilder<HomeRealmDiscoveryPoliciesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/applications/{application%2Did}/homeRealmDiscoveryPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new HomeRealmDiscoveryPoliciesRequestBuilder(x, y));
    }
    /**
