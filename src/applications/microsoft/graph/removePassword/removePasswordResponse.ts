...
export class Microsoft.graph.removePasswordResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["keyId", (o, n) => { (o as unknown as Microsoft.graph.removePasswordResponse).keyId = n.getStringValue(); }],
        ]);
    };
    /**
