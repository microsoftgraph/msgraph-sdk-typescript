...
export class Microsoft.graph.removeKeyResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["keyId", (o, n) => { (o as unknown as Microsoft.graph.removeKeyResponse).keyId = n.getStringValue(); }],
            ["proof", (o, n) => { (o as unknown as Microsoft.graph.removeKeyResponse).proof = n.getStringValue(); }],
        ]);
    };
    /**
