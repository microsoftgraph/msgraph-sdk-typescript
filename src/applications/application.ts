...
export class Application extends DirectoryObject implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["addIns", (o, n) => { (o as unknown as Application).addIns = n.getCollectionOfObjectValues<AddIn>(AddIn); }],
            ["api", (o, n) => { (o as unknown as Application).api = n.getObjectValue<ApiApplication>(ApiApplication); }],
            ...
            ["appRoles", (o, n) => { (o as unknown as Application).appRoles = n.getCollectionOfObjectValues<AppRole>(AppRole); }],
            ["createdDateTime", (o, n) => { (o as unknown as Application).createdDateTime = n.getDateValue(); }],
            ["createdOnBehalfOf", (o, n) => { (o as unknown as Application).createdOnBehalfOf = n.getObjectValue<DirectoryObject>(DirectoryObject); }],
            ...
            ["extensionProperties", (o, n) => { (o as unknown as Application).extensionProperties = n.getCollectionOfObjectValues<ExtensionProperty>(ExtensionProperty); }],
            ["groupMembershipClaims", (o, n) => { (o as unknown as Application).groupMembershipClaims = n.getStringValue(); }],
            ["homeRealmDiscoveryPolicies", (o, n) => { (o as unknown as Application).homeRealmDiscoveryPolicies = n.getCollectionOfObjectValues<HomeRealmDiscoveryPolicy>(HomeRealmDiscoveryPolicy); }],
            ["identifierUris", (o, n) => { (o as unknown as Application).identifierUris = n.getCollectionOfPrimitiveValues<string>(); }],
            ["info", (o, n) => { (o as unknown as Application).info = n.getObjectValue<InformationalUrl>(InformationalUrl); }],
            ...
            ["owners", (o, n) => { (o as unknown as Application).owners = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
            ["parentalControlSettings", (o, n) => { (o as unknown as Application).parentalControlSettings = n.getObjectValue<ParentalControlSettings>(ParentalControlSettings); }],
            ["passwordCredentials", (o, n) => { (o as unknown as Application).passwordCredentials = n.getCollectionOfObjectValues<PasswordCredential>(PasswordCredential); }],
            ["publicClient", (o, n) => { (o as unknown as Application).publicClient = n.getObjectValue<PublicClientApplication>(PublicClientApplication); }],
            ["publisherDomain", (o, n) => { (o as unknown as Application).publisherDomain = n.getStringValue(); }],
            ["requiredResourceAccess", (o, n) => { (o as unknown as Application).requiredResourceAccess = n.getCollectionOfObjectValues<RequiredResourceAccess>(RequiredResourceAccess); }],
            ["signInAudience", (o, n) => { (o as unknown as Application).signInAudience = n.getStringValue(); }],
            ["spa", (o, n) => { (o as unknown as Application).spa = n.getObjectValue<SpaApplication>(SpaApplication); }],
            ...
            ["tokenIssuancePolicies", (o, n) => { (o as unknown as Application).tokenIssuancePolicies = n.getCollectionOfObjectValues<TokenIssuancePolicy>(TokenIssuancePolicy); }],
            ["tokenLifetimePolicies", (o, n) => { (o as unknown as Application).tokenLifetimePolicies = n.getCollectionOfObjectValues<TokenLifetimePolicy>(TokenLifetimePolicy); }],
            ["web", (o, n) => { (o as unknown as Application).web = n.getObjectValue<WebApplication>(WebApplication); }],
        ]);
    };
    /**
