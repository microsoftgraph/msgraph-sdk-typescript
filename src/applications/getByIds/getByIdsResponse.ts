...
export class GetByIdsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["ids", (o, n) => { (o as unknown as GetByIdsResponse).ids = n.getCollectionOfPrimitiveValues<string>(); }],
            ["types", (o, n) => { (o as unknown as GetByIdsResponse).types = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
