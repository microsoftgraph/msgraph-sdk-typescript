...
import { createOnPremisesDirectorySynchronizationFromDiscriminatorValue, deserializeIntoOnPremisesDirectorySynchronization, serializeOnPremisesDirectorySynchronization, type OnPremisesDirectorySynchronization } from '../../../models/';
 ...
 */
export class OnPremisesDirectorySynchronizationItemRequestBuilder extends BaseRequestBuilder<OnPremisesDirectorySynchronizationItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/directory/onPremisesSynchronization/{onPremisesDirectorySynchronization%2Did}{?%24select,%24expand}", (x, y) => new OnPremisesDirectorySynchronizationItemRequestBuilder(x, y));
    }
    /**
