import {AllowedValue} from '../../../../../models/';
...
export class AllowedValueItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: AllowedValueItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: AllowedValue | undefined, requestConfiguration?: AllowedValueItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
