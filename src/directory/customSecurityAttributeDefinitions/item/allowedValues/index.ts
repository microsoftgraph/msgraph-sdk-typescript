...
import { createAllowedValueCollectionResponseFromDiscriminatorValue, createAllowedValueFromDiscriminatorValue, deserializeIntoAllowedValue, serializeAllowedValue, type AllowedValue, type AllowedValueCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AllowedValueItemRequestBuilder } from './item/';
 ...
 */
export class AllowedValuesRequestBuilder extends BaseRequestBuilder<AllowedValuesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/directory/customSecurityAttributeDefinitions/{customSecurityAttributeDefinition%2Did}/allowedValues{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AllowedValuesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<AllowedValuesRequestBuilderGetQueryParameters> | undefined) : Promise<AllowedValueCollectionResponse | undefined> {
     ...
     */
    public post(body: AllowedValue, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AllowedValue | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<AllowedValuesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, allowedValuesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: AllowedValue, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
