...
import { createAttributeSetCollectionResponseFromDiscriminatorValue, createAttributeSetFromDiscriminatorValue, deserializeIntoAttributeSet, serializeAttributeSet, type AttributeSet, type AttributeSetCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AttributeSetItemRequestBuilder } from './item/';
 ...
 */
export class AttributeSetsRequestBuilder extends BaseRequestBuilder<AttributeSetsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/directory/attributeSets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AttributeSetsRequestBuilder(x, y));
    }
    /**
