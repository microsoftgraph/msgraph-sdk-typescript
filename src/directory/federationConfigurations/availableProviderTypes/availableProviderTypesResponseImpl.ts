...
export class AvailableProviderTypesResponseImpl implements AvailableProviderTypesResponse {
    ...
    public constructor(availableProviderTypesResponseParameterValue?: AvailableProviderTypesResponse | undefined) {
        this._additionalData = availableProviderTypesResponseParameterValue?.additionalData ? availableProviderTypesResponseParameterValue?.additionalData! : {};
        this._value = availableProviderTypesResponseParameterValue?.value;
    };
    /**
