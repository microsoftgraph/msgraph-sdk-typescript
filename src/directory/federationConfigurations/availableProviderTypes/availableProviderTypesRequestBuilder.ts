...
export class AvailableProviderTypesRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/directory/federationConfigurations/microsoft.graph.availableProviderTypes()";
    ...
    public get(requestConfiguration?: AvailableProviderTypesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AvailableProviderTypesResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AvailableProviderTypesResponseImpl>(requestInfo, createAvailableProviderTypesResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
