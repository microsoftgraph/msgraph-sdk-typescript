...
export class ScopedRoleMembersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ScopedRoleMembersResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ScopedRoleMembersResponse).value = n.getCollectionOfObjectValues<ScopedRoleMembership>(ScopedRoleMembership); }],
        ]);
    };
    /**
