...
export class AdministrativeUnitsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AdministrativeUnitsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AdministrativeUnitsResponse).value = n.getCollectionOfObjectValues<AdministrativeUnit>(AdministrativeUnit); }],
        ]);
    };
    /**
