...
import { createDirectoryFromDiscriminatorValue, deserializeIntoDirectory, serializeDirectory, type Directory } from '../models/';
...
export class DirectoryRequestBuilder extends BaseRequestBuilder<DirectoryRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/directory{?%24select,%24expand}", (x, y) => new DirectoryRequestBuilder(x, y));
    }
    /**
     * Get directory
