...
export class GetByIdsResponseImpl implements GetByIdsResponse {
    ...
    public constructor(getByIdsResponseParameterValue?: GetByIdsResponse | undefined) {
        this._additionalData = getByIdsResponseParameterValue?.additionalData ? getByIdsResponseParameterValue?.additionalData! : {};
        this._value = getByIdsResponseParameterValue?.value;
    };
    /**
