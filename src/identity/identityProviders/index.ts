...
import { createIdentityProviderBaseCollectionResponseFromDiscriminatorValue, createIdentityProviderBaseFromDiscriminatorValue, deserializeIntoIdentityProviderBase, serializeIdentityProviderBase, type IdentityProviderBase, type IdentityProviderBaseCollectionResponse } from '../../models/';
...
export class IdentityProvidersRequestBuilder extends BaseRequestBuilder<IdentityProvidersRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/identityProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new IdentityProvidersRequestBuilder(x, y));
    }
    /**
