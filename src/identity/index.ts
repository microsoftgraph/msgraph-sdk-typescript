...
import { createIdentityContainerFromDiscriminatorValue, deserializeIntoIdentityContainer, serializeIdentityContainer, type IdentityContainer } from '../models/';
 ...
 */
export class IdentityRequestBuilder extends BaseRequestBuilder<IdentityRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity{?%24select,%24expand}", (x, y) => new IdentityRequestBuilder(x, y));
    }
    /**
     * Get identity
