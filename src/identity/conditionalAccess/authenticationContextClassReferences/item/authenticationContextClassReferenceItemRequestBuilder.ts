...
export class AuthenticationContextClassReferenceItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, authenticationContextClassReferenceId?: string | undefined) {
