...
import { createNamedLocationFromDiscriminatorValue, deserializeIntoNamedLocation, serializeNamedLocation, type NamedLocation } from '../../../../models/';
 ...
 */
export class NamedLocationItemRequestBuilder extends BaseRequestBuilder<NamedLocationItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/conditionalAccess/namedLocations/{namedLocation%2Did}{?%24select,%24expand}", (x, y) => new NamedLocationItemRequestBuilder(x, y));
    }
    /**
