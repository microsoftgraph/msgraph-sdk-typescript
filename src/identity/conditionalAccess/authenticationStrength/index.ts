...
import { createAuthenticationStrengthRootFromDiscriminatorValue, deserializeIntoAuthenticationStrengthRoot, serializeAuthenticationStrengthRoot, type AuthenticationStrengthRoot } from '../../../models/';
 ...
 */
export class AuthenticationStrengthRequestBuilder extends BaseRequestBuilder<AuthenticationStrengthRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/conditionalAccess/authenticationStrength{?%24select,%24expand}", (x, y) => new AuthenticationStrengthRequestBuilder(x, y));
    }
    /**
