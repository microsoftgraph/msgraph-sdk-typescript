...
import { createAuthenticationMethodModeDetailCollectionResponseFromDiscriminatorValue, createAuthenticationMethodModeDetailFromDiscriminatorValue, deserializeIntoAuthenticationMethodModeDetail, serializeAuthenticationMethodModeDetail, type AuthenticationMethodModeDetail, type AuthenticationMethodModeDetailCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AuthenticationMethodModeDetailItemRequestBuilder } from './item/';
 ...
 */
export class AuthenticationMethodModesRequestBuilder extends BaseRequestBuilder<AuthenticationMethodModesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/conditionalAccess/authenticationStrength/authenticationMethodModes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AuthenticationMethodModesRequestBuilder(x, y));
    }
    /**
