...
import { createUpdateAllowedCombinationsResultFromDiscriminatorValue, deserializeIntoUpdateAllowedCombinationsResult, serializeUpdateAllowedCombinationsResult, type UpdateAllowedCombinationsResult } from '../../../../../../models/';
...
export function deserializeIntoUpdateAllowedCombinationsPostRequestBody(updateAllowedCombinationsPostRequestBody: UpdateAllowedCombinationsPostRequestBody | undefined = {} as UpdateAllowedCombinationsPostRequestBody) : Record<string, (node: ParseNode) => void> {
    return {
        "allowedCombinations": n => { updateAllowedCombinationsPostRequestBody.allowedCombinations = n.getCollectionOfEnumValues<UpdateAllowedCombinationsPostRequestBody_allowedCombinations>(UpdateAllowedCombinationsPostRequestBody_allowedCombinationsObject); },
    }
}
export function serializeUpdateAllowedCombinationsPostRequestBody(writer: SerializationWriter, updateAllowedCombinationsPostRequestBody: UpdateAllowedCombinationsPostRequestBody | undefined = {} as UpdateAllowedCombinationsPostRequestBody) : void {
    ...
    writer.writeEnumValue<UpdateAllowedCombinationsPostRequestBody_allowedCombinations>("allowedCombinations", ...updateAllowedCombinationsPostRequestBody.allowedCombinations);
...
export interface UpdateAllowedCombinationsPostRequestBody extends AdditionalDataHolder, Parsable {
     ...
     */
    allowedCombinations?: UpdateAllowedCombinationsPostRequestBody_allowedCombinations[];
}
/**
