...
import { createConditionalAccessPolicyCollectionResponseFromDiscriminatorValue, createConditionalAccessPolicyFromDiscriminatorValue, deserializeIntoConditionalAccessPolicy, serializeConditionalAccessPolicy, type ConditionalAccessPolicy, type ConditionalAccessPolicyCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ConditionalAccessPolicyItemRequestBuilder } from './item/';
 ...
 */
export class PoliciesRequestBuilder extends BaseRequestBuilder<PoliciesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/conditionalAccess/policies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new PoliciesRequestBuilder(x, y));
    }
    /**
