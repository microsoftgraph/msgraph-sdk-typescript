...
import { createConditionalAccessRootFromDiscriminatorValue, deserializeIntoConditionalAccessRoot, serializeConditionalAccessRoot, type ConditionalAccessRoot } from '../../models/';
 ...
 */
export class ConditionalAccessRequestBuilder extends BaseRequestBuilder<ConditionalAccessRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/conditionalAccess{?%24select,%24expand}", (x, y) => new ConditionalAccessRequestBuilder(x, y));
    }
    /**
