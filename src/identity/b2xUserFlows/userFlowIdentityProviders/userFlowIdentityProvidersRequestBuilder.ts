...
export class UserFlowIdentityProvidersRequestBuilder {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserFlowIdentityProvidersResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<UserFlowIdentityProvidersResponse>(requestInfo, UserFlowIdentityProvidersResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
