...
export class Microsoft.graph.availableProviderTypesRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.availableProviderTypesRequestBuilder and sets the default values.
