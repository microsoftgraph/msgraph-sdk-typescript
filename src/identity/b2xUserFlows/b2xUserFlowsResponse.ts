...
export class B2xUserFlowsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as B2xUserFlowsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as B2xUserFlowsResponse).value = n.getCollectionOfObjectValues<B2xIdentityUserFlow>(B2xIdentityUserFlow); }],
        ]);
    };
    /**
