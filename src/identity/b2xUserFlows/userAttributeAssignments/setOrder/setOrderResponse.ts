...
export class SetOrderResponse implements Parsable {
    ...
    /**
     * Instantiates a new setOrderResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["newAssignmentOrder", (o, n) => { (o as unknown as SetOrderResponse).newAssignmentOrder = n.getObjectValue<AssignmentOrder>(AssignmentOrder); }],
        ]);
    };
    /**
