...
export class Microsoft.graph.setOrderResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["newAssignmentOrder", (o, n) => { (o as unknown as Microsoft.graph.setOrderResponse).newAssignmentOrder = n.getObjectValue<AssignmentOrder>(AssignmentOrder); }],
        ]);
    };
    /**
