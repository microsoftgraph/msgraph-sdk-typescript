...
export class LanguagesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as LanguagesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as LanguagesResponse).value = n.getCollectionOfObjectValues<UserFlowLanguageConfiguration>(UserFlowLanguageConfiguration); }],
        ]);
    };
    /**
