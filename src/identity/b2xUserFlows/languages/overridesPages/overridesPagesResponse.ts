...
export class OverridesPagesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as OverridesPagesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as OverridesPagesResponse).value = n.getCollectionOfObjectValues<UserFlowLanguagePage>(UserFlowLanguagePage); }],
        ]);
    };
    /**
