...
export class DefaultPagesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DefaultPagesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DefaultPagesResponse).value = n.getCollectionOfObjectValues<UserFlowLanguagePage>(UserFlowLanguagePage); }],
        ]);
    };
    /**
