...
export class DefaultPagesRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPostRequestInfo(body: UserFlowLanguagePage | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DefaultPagesResponse | undefined> {
        const requestInfo = this.createGetRequestInfo(
            q, h, o
        );
        return this.httpCore?.sendAsync<DefaultPagesResponse>(requestInfo, DefaultPagesResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Collection of pages with the default content to display in a user flow for a specified language. This collection does not allow any kind of modification.
     * @param body 
