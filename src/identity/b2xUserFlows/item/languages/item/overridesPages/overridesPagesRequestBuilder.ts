...
export class OverridesPagesRequestBuilder {
     ...
     */
    public get(requestConfiguration?: OverridesPagesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserFlowLanguagePageCollectionResponseImpl | undefined> {
     ...
     */
    public post(body: UserFlowLanguagePage | undefined, requestConfiguration?: OverridesPagesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserFlowLanguagePageImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
