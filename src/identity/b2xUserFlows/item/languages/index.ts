...
import { createUserFlowLanguageConfigurationCollectionResponseFromDiscriminatorValue, createUserFlowLanguageConfigurationFromDiscriminatorValue, deserializeIntoUserFlowLanguageConfiguration, serializeUserFlowLanguageConfiguration, type UserFlowLanguageConfiguration, type UserFlowLanguageConfigurationCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { UserFlowLanguageConfigurationItemRequestBuilder } from './item/';
 ...
 */
export class LanguagesRequestBuilder extends BaseRequestBuilder<LanguagesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new LanguagesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<LanguagesRequestBuilderGetQueryParameters> | undefined) : Promise<UserFlowLanguageConfigurationCollectionResponse | undefined> {
     ...
     */
    public post(body: UserFlowLanguageConfiguration, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<UserFlowLanguageConfiguration | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<LanguagesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, languagesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: UserFlowLanguageConfiguration, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
