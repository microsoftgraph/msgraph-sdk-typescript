...
import { createIdentityUserFlowAttributeAssignmentCollectionResponseFromDiscriminatorValue, createIdentityUserFlowAttributeAssignmentFromDiscriminatorValue, deserializeIntoIdentityUserFlowAttributeAssignment, serializeIdentityUserFlowAttributeAssignment, type IdentityUserFlowAttributeAssignment, type IdentityUserFlowAttributeAssignmentCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { GetOrderRequestBuilder } from './getOrder/';
import { IdentityUserFlowAttributeAssignmentItemRequestBuilder } from './item/';
 ...
 */
export class UserAttributeAssignmentsRequestBuilder extends BaseRequestBuilder<UserAttributeAssignmentsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/userAttributeAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UserAttributeAssignmentsRequestBuilder(x, y));
    }
    /**
