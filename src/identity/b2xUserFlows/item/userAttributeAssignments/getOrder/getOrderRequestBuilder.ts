...
export class GetOrderRequestBuilder {
    ...
    public get(requestConfiguration?: GetOrderRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AssignmentOrderImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AssignmentOrderImpl>(requestInfo, createAssignmentOrderFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
