...
import { createIdentityUserFlowAttributeFromDiscriminatorValue, deserializeIntoIdentityUserFlowAttribute, serializeIdentityUserFlowAttribute, type IdentityUserFlowAttribute } from '../../../models/';
 ...
 */
export class IdentityUserFlowAttributeItemRequestBuilder extends BaseRequestBuilder<IdentityUserFlowAttributeItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/userFlowAttributes/{identityUserFlowAttribute%2Did}{?%24select,%24expand}", (x, y) => new IdentityUserFlowAttributeItemRequestBuilder(x, y));
    }
    /**
