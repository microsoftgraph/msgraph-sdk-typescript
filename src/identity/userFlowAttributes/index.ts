...
import { createIdentityUserFlowAttributeCollectionResponseFromDiscriminatorValue, createIdentityUserFlowAttributeFromDiscriminatorValue, deserializeIntoIdentityUserFlowAttribute, serializeIdentityUserFlowAttribute, type IdentityUserFlowAttribute, type IdentityUserFlowAttributeCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { IdentityUserFlowAttributeItemRequestBuilder } from './item/';
 ...
 */
export class UserFlowAttributesRequestBuilder extends BaseRequestBuilder<UserFlowAttributesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identity/userFlowAttributes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UserFlowAttributesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<UserFlowAttributesRequestBuilderGetQueryParameters> | undefined) : Promise<IdentityUserFlowAttributeCollectionResponse | undefined> {
     ...
     */
    public post(body: IdentityUserFlowAttribute, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<IdentityUserFlowAttribute | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<UserFlowAttributesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, userFlowAttributesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: IdentityUserFlowAttribute, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
