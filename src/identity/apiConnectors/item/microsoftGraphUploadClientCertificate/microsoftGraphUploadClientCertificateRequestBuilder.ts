...
import {MicrosoftGraphUploadClientCertificateRequestBuilderPostRequestConfiguration} from './microsoftGraphUploadClientCertificateRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the uploadClientCertificate method.
 */
export class MicrosoftGraphUploadClientCertificateRequestBuilder {
     ...
     */
    public post(body: UploadClientCertificatePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphUploadClientCertificateRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<IdentityApiConnector | undefined> {
     ...
     */
    public toPostRequestInformation(body: UploadClientCertificatePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphUploadClientCertificateRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
