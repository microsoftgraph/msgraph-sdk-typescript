...
export class UploadClientCertificateResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["password", (o, n) => { (o as unknown as UploadClientCertificateResponse).password = n.getStringValue(); }],
            ["pkcs12Value", (o, n) => { (o as unknown as UploadClientCertificateResponse).pkcs12Value = n.getStringValue(); }],
        ]);
    };
    /**
