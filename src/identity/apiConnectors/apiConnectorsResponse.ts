...
export class ApiConnectorsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ApiConnectorsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ApiConnectorsResponse).value = n.getCollectionOfObjectValues<IdentityApiConnector>(IdentityApiConnector); }],
        ]);
    };
    /**
