...
export class Microsoft.graph.uploadClientCertificateResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["password", (o, n) => { (o as unknown as Microsoft.graph.uploadClientCertificateResponse).password = n.getStringValue(); }],
            ["pkcs12Value", (o, n) => { (o as unknown as Microsoft.graph.uploadClientCertificateResponse).pkcs12Value = n.getStringValue(); }],
        ]);
    };
    /**
