...
export class Microsoft.graph.acceptRecommendationsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.acceptRecommendationsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.acceptRecommendations";
