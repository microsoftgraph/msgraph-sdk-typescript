...
export class Microsoft.graph.batchRecordDecisionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decision", (o, n) => { (o as unknown as Microsoft.graph.batchRecordDecisionsResponse).decision = n.getStringValue(); }],
            ["justification", (o, n) => { (o as unknown as Microsoft.graph.batchRecordDecisionsResponse).justification = n.getStringValue(); }],
            ["principalId", (o, n) => { (o as unknown as Microsoft.graph.batchRecordDecisionsResponse).principalId = n.getStringValue(); }],
            ["resourceId", (o, n) => { (o as unknown as Microsoft.graph.batchRecordDecisionsResponse).resourceId = n.getStringValue(); }],
        ]);
    };
    /**
