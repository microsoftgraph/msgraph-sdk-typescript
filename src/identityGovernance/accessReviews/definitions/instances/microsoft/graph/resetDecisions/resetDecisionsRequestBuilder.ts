...
export class Microsoft.graph.resetDecisionsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.resetDecisionsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.resetDecisions";
