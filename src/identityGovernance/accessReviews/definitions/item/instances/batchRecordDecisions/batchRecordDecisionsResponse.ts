...
export class BatchRecordDecisionsResponse implements Parsable {
    ...
    /**
     * Instantiates a new batchRecordDecisionsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["decision", (o, n) => { (o as unknown as BatchRecordDecisionsResponse).decision = n.getStringValue(); }],
            ["justification", (o, n) => { (o as unknown as BatchRecordDecisionsResponse).justification = n.getStringValue(); }],
            ["principalId", (o, n) => { (o as unknown as BatchRecordDecisionsResponse).principalId = n.getStringValue(); }],
            ["resourceId", (o, n) => { (o as unknown as BatchRecordDecisionsResponse).resourceId = n.getStringValue(); }],
        ]);
    };
    /**
