...
import { createAccessReviewInstanceFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeAccessReviewInstance, serializeBaseCollectionPaginationCountResponse, type AccessReviewInstance, type BaseCollectionPaginationCountResponse } from '../../../../../../models/';
...
export function deserializeIntoFilterByCurrentUserWithOnGetResponse(filterByCurrentUserWithOnGetResponse: FilterByCurrentUserWithOnGetResponse | undefined = {} as FilterByCurrentUserWithOnGetResponse) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { filterByCurrentUserWithOnGetResponse.value = n.getCollectionOfObjectValues<AccessReviewInstance>(createAccessReviewInstanceFromDiscriminatorValue); },
    }
}
...
export function serializeFilterByCurrentUserWithOnGetResponse(writer: SerializationWriter, filterByCurrentUserWithOnGetResponse: FilterByCurrentUserWithOnGetResponse | undefined = {} as FilterByCurrentUserWithOnGetResponse) : void {
    ...
    writer.writeCollectionOfObjectValues<AccessReviewInstance>("value", filterByCurrentUserWithOnGetResponse.value, serializeAccessReviewInstance);
}
/**
...
export class FilterByCurrentUserWithOnRequestBuilder extends BaseRequestBuilder<FilterByCurrentUserWithOnRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, on?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", (x, y) => new FilterByCurrentUserWithOnRequestBuilder(x, y));
