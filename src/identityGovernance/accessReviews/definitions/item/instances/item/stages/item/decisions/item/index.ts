...
export class AccessReviewInstanceDecisionItemItemRequestBuilder extends BaseRequestBuilder<AccessReviewInstanceDecisionItemItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}{?%24select,%24expand}", (x, y) => new AccessReviewInstanceDecisionItemItemRequestBuilder(x, y));
    }
    /**
