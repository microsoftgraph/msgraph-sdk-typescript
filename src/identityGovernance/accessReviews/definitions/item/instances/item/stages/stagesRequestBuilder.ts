import {AccessReviewStageCollectionResponseImpl, AccessReviewStageImpl} from '../../../../../../../models/';
...
export class StagesRequestBuilder {
     ...
     */
    public get(requestConfiguration?: StagesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AccessReviewStageCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AccessReviewStageCollectionResponseImpl>(requestInfo, createAccessReviewStageCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to stages for identityGovernance
     * @param body 
     ...
     */
    public post(body: AccessReviewStage | undefined, requestConfiguration?: StagesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AccessReviewStageImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
