import {AccessReviewStage, AccessReviewStageCollectionResponse} from '../../../../../../../models/';
...
export class StagesRequestBuilder {
    ...
    public get(requestConfiguration?: StagesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AccessReviewStageCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AccessReviewStageCollectionResponse>(requestInfo, createAccessReviewStageCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to stages for identityGovernance
     * @param body 
