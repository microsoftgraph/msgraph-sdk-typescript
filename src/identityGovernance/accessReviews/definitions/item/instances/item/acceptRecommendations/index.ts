 ...
 */
export class AcceptRecommendationsRequestBuilder extends BaseRequestBuilder<AcceptRecommendationsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/acceptRecommendations", (x, y) => new AcceptRecommendationsRequestBuilder(x, y));
    }
    /**
