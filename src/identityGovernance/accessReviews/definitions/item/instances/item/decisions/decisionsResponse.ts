...
export class DecisionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DecisionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DecisionsResponse).value = n.getCollectionOfObjectValues<AccessReviewInstanceDecisionItem>(AccessReviewInstanceDecisionItem); }],
        ]);
    };
    /**
