...
export class GovernanceInsightItemRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/insights/{governanceInsight%2Did}{?%24select,%24expand}");
    };
    /**
     ...
     * @returns a Promise of GovernanceInsight
     */
    public patch(body: GovernanceInsight | undefined, requestConfiguration?: GovernanceInsightItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<GovernanceInsight | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: GovernanceInsight | undefined, requestConfiguration?: GovernanceInsightItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeGovernanceInsight);
        return requestInfo;
    };
}
