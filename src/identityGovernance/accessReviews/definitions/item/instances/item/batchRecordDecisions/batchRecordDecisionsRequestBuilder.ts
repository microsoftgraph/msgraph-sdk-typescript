...
export class BatchRecordDecisionsRequestBuilder {
     ...
     */
    public post(body: BatchRecordDecisionsRequestBodyImpl | undefined, requestConfiguration?: BatchRecordDecisionsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
