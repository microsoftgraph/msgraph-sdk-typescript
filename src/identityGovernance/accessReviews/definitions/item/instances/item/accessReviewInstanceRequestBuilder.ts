...
import {AccessReviewReviewerRequestBuilder} from './contactedReviewers/item/accessReviewReviewerRequestBuilder';
...
export class AccessReviewInstanceRequestBuilder {
    ...
    public contactedReviewersById(id: string) : AccessReviewReviewerRequestBuilder {
        ...
        id && urlTplParams.set("accessReviewReviewer_id", id);
