...
import {MicrosoftGraphApplyDecisionsRequestBuilderPostRequestConfiguration} from './microsoftGraphApplyDecisionsRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the applyDecisions method.
 */
export class MicrosoftGraphApplyDecisionsRequestBuilder {
     ...
     */
    public post(requestConfiguration?: MicrosoftGraphApplyDecisionsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(requestConfiguration?: MicrosoftGraphApplyDecisionsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
