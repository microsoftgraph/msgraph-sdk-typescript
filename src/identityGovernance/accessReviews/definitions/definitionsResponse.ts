...
export class DefinitionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DefinitionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DefinitionsResponse).value = n.getCollectionOfObjectValues<AccessReviewScheduleDefinition>(AccessReviewScheduleDefinition); }],
        ]);
    };
    /**
