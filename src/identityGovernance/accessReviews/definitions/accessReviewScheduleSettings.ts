...
export class AccessReviewScheduleSettings implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["applyActions", (o, n) => { (o as unknown as AccessReviewScheduleSettings).applyActions = n.getCollectionOfObjectValues<AccessReviewApplyAction>(AccessReviewApplyAction); }],
            ...
            ["recurrence", (o, n) => { (o as unknown as AccessReviewScheduleSettings).recurrence = n.getObjectValue<PatternedRecurrence>(PatternedRecurrence); }],
