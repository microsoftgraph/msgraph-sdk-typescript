...
export class AccessReviewHistoryDefinitionItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: AccessReviewHistoryDefinitionItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
