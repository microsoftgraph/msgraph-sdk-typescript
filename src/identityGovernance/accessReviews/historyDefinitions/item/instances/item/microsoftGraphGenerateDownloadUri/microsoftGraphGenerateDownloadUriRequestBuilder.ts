...
import {MicrosoftGraphGenerateDownloadUriRequestBuilderPostRequestConfiguration} from './microsoftGraphGenerateDownloadUriRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the generateDownloadUri method.
 */
export class MicrosoftGraphGenerateDownloadUriRequestBuilder {
     ...
     */
    public post(requestConfiguration?: MicrosoftGraphGenerateDownloadUriRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AccessReviewHistoryInstance | undefined> {
     ...
     */
    public toPostRequestInformation(requestConfiguration?: MicrosoftGraphGenerateDownloadUriRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
