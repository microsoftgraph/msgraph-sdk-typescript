...
import { createAccessReviewHistoryInstanceCollectionResponseFromDiscriminatorValue, createAccessReviewHistoryInstanceFromDiscriminatorValue, deserializeIntoAccessReviewHistoryInstance, serializeAccessReviewHistoryInstance, type AccessReviewHistoryInstance, type AccessReviewHistoryInstanceCollectionResponse } from '../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AccessReviewHistoryInstanceItemRequestBuilder } from './item/';
...
export class InstancesRequestBuilder extends BaseRequestBuilder<InstancesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition%2Did}/instances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new InstancesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<InstancesRequestBuilderGetQueryParameters> | undefined) : Promise<AccessReviewHistoryInstanceCollectionResponse | undefined> {
     ...
     */
    public post(body: AccessReviewHistoryInstance, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AccessReviewHistoryInstance | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: AccessReviewHistoryInstance, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
