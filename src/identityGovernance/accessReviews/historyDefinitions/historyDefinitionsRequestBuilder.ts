...
export class HistoryDefinitionsRequestBuilder {
    ...
    public get(requestConfiguration?: HistoryDefinitionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AccessReviewHistoryDefinitionCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AccessReviewHistoryDefinitionCollectionResponseImpl>(requestInfo, createAccessReviewHistoryDefinitionCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to historyDefinitions for identityGovernance
     * @param body 
