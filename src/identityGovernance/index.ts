...
import { createIdentityGovernanceFromDiscriminatorValue, deserializeIntoIdentityGovernance, serializeIdentityGovernance, type IdentityGovernance } from '../models/';
 ...
 */
export class IdentityGovernanceRequestBuilder extends BaseRequestBuilder<IdentityGovernanceRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance{?%24select,%24expand}", (x, y) => new IdentityGovernanceRequestBuilder(x, y));
    }
    /**
