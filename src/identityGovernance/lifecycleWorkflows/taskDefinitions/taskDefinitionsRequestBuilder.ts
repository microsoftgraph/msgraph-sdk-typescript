...
export class TaskDefinitionsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: TaskDefinitionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TaskDefinitionCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TaskDefinitionCollectionResponse>(requestInfo, createTaskDefinitionCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Get a list of the taskDefinition objects and their properties.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
