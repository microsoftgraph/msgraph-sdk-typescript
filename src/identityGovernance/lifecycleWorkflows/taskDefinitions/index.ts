...
import { TaskDefinitionItemRequestBuilder } from './item/';
...
export class TaskDefinitionsRequestBuilder extends BaseRequestBuilder<TaskDefinitionsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/taskDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TaskDefinitionsRequestBuilder(x, y));
    }
    /**
