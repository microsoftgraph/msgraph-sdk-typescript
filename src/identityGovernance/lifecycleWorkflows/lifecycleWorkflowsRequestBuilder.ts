...
export class LifecycleWorkflowsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: LifecycleWorkflowsRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public get(requestConfiguration?: LifecycleWorkflowsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<LifecycleWorkflowsContainer | undefined> {
        ...
        return this.requestAdapter?.sendAsync<LifecycleWorkflowsContainer>(requestInfo, createLifecycleWorkflowsContainerFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     ...
     * @returns a Promise of LifecycleWorkflowsContainer
     */
    public patch(body: LifecycleWorkflowsContainer | undefined, requestConfiguration?: LifecycleWorkflowsRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<LifecycleWorkflowsContainer | undefined> {
