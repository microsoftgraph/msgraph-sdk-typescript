...
export class WorkflowTemplatesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: WorkflowTemplatesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkflowTemplateCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<WorkflowTemplateCollectionResponse>(requestInfo, createWorkflowTemplateCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Get a list of the workflowTemplate objects and their properties.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
