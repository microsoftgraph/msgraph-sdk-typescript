 ...
 */
export const WorkflowTemplateItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflowTemplates/{workflowTemplate%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
