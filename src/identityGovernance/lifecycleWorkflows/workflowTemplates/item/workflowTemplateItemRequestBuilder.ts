...
export class WorkflowTemplateItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: WorkflowTemplateItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkflowTemplate | undefined> {
        ...
        return this.requestAdapter?.sendAsync<WorkflowTemplate>(requestInfo, createWorkflowTemplateFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Read the properties and relationships of a workflowTemplate object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
