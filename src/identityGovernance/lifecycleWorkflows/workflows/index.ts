...
import { createWorkflowCollectionResponseFromDiscriminatorValue, createWorkflowFromDiscriminatorValue, deserializeIntoWorkflow, serializeWorkflow, type Workflow, type WorkflowCollectionResponse } from '../../../models/identityGovernance/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { WorkflowItemRequestBuilder } from './item/';
 ...
 */
export class WorkflowsRequestBuilder extends BaseRequestBuilder<WorkflowsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new WorkflowsRequestBuilder(x, y));
    }
    /**
