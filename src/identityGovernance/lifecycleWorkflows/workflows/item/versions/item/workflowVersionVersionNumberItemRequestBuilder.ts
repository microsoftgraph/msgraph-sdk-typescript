...
export class WorkflowVersionVersionNumberItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: WorkflowVersionVersionNumberItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkflowVersion | undefined> {
        ...
        return this.requestAdapter?.sendAsync<WorkflowVersion>(requestInfo, createWorkflowVersionFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Read the properties and relationships of a workflowVersion object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
