...
import { type CreatedByRequestBuilderGetRequestConfiguration } from './createdByRequestBuilderGetRequestConfiguration';
...
export class CreatedByRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/versions/{workflowVersion%2DversionNumber}/createdBy{?%24select,%24expand}");
    };
    /**
     ...
     * @returns a createdByRequestBuilder
     */
    public withUrl(rawUrl: string) : CreatedByRequestBuilder {
