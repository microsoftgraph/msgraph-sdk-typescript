...
export class MicrosoftGraphIdentityGovernanceActivateRequestBuilder extends BaseRequestBuilder {
     ...
     * @see {@link https://docs.microsoft.com/graph/api/identitygovernance-workflow-activate?view=graph-rest-1.0|Find more info here}
     */
    public post(body: ActivatePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphIdentityGovernanceActivateRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
