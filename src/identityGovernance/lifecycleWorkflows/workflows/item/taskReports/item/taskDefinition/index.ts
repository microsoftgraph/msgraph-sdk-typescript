...
export class TaskDefinitionRequestBuilder extends BaseRequestBuilder<TaskDefinitionRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/taskReports/{taskReport%2Did}/taskDefinition{?%24select,%24expand}", (x, y) => new TaskDefinitionRequestBuilder(x, y));
    }
    /**
