...
export class WorkflowsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: WorkflowsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkflowCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<WorkflowCollectionResponse>(requestInfo, createWorkflowCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     ...
     */
    public post(body: Workflow | undefined, requestConfiguration?: WorkflowsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Workflow | undefined> {
