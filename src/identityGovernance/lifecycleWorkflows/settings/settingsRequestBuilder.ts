...
export class SettingsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: SettingsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<LifecycleManagementSettings | undefined> {
        ...
        return this.requestAdapter?.sendAsync<LifecycleManagementSettings>(requestInfo, createLifecycleManagementSettingsFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     ...
     */
    public patch(body: LifecycleManagementSettings | undefined, requestConfiguration?: SettingsRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<LifecycleManagementSettings | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: LifecycleManagementSettings | undefined, requestConfiguration?: SettingsRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeLifecycleManagementSettings);
        return requestInfo;
    };
}
