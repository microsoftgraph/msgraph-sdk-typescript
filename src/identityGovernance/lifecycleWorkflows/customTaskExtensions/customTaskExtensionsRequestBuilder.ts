...
export class CustomTaskExtensionsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: CustomTaskExtensionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CustomTaskExtensionCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CustomTaskExtensionCollectionResponse>(requestInfo, createCustomTaskExtensionCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     ...
     */
    public post(body: CustomTaskExtension | undefined, requestConfiguration?: CustomTaskExtensionsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CustomTaskExtension | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CustomTaskExtension>(requestInfo, createCustomTaskExtensionFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Get a list of the customTaskExtension objects and their properties.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
