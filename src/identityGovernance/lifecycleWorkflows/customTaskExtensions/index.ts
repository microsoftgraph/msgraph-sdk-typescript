...
import { createCustomTaskExtensionCollectionResponseFromDiscriminatorValue, createCustomTaskExtensionFromDiscriminatorValue, deserializeIntoCustomTaskExtension, serializeCustomTaskExtension, type CustomTaskExtension, type CustomTaskExtensionCollectionResponse } from '../../../models/identityGovernance/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { CustomTaskExtensionItemRequestBuilder } from './item/';
 ...
 */
export class CustomTaskExtensionsRequestBuilder extends BaseRequestBuilder<CustomTaskExtensionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/customTaskExtensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new CustomTaskExtensionsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<CustomTaskExtensionsRequestBuilderGetQueryParameters> | undefined) : Promise<CustomTaskExtensionCollectionResponse | undefined> {
     ...
     */
    public post(body: CustomTaskExtension, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<CustomTaskExtension | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<CustomTaskExtensionsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, customTaskExtensionsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: CustomTaskExtension, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
