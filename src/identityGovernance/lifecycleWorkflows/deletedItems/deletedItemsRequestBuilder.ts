...
export class DeletedItemsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: DeletedItemsRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public get(requestConfiguration?: DeletedItemsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeletedItemContainer | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeletedItemContainer>(requestInfo, createDeletedItemContainerFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Delete navigation property deletedItems for identityGovernance
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
