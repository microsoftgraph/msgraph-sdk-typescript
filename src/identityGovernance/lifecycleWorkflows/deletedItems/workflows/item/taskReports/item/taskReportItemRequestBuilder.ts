...
export class TaskReportItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: TaskReportItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TaskReport | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TaskReport>(requestInfo, createTaskReportFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Represents the aggregation of task execution data for tasks within a workflow object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
