...
import { createTaskProcessingResultFromDiscriminatorValue, type TaskProcessingResult } from '../../../../../../../../../../../models/identityGovernance/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../../../../../../models/oDataErrors/';
import { MicrosoftGraphIdentityGovernanceResumeRequestBuilder } from './microsoftGraphIdentityGovernanceResume/';
 ...
 */
export class TaskProcessingResultItemRequestBuilder extends BaseRequestBuilder<TaskProcessingResultItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}/userProcessingResults/{userProcessingResult%2Did}/taskProcessingResults/{taskProcessingResult%2Did}{?%24select,%24expand}", (x, y) => new TaskProcessingResultItemRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<TaskProcessingResultItemRequestBuilderGetQueryParameters> | undefined) : Promise<TaskProcessingResult | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<TaskProcessingResultItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, taskProcessingResultItemRequestBuilderGetQueryParametersMapper);
