...
export class RunItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RunItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Run | undefined> {
        ...
        return this.requestAdapter?.sendAsync<Run>(requestInfo, createRunFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Read the properties and relationships of a run object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
