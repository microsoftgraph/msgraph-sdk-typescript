...
export class VersionsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public byWorkflowVersionVersionNumber(workflowVersionVersionNumber: string) : WorkflowVersionVersionNumberItemRequestBuilder {
     ...
     */
    public get(requestConfiguration?: VersionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkflowVersionCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<WorkflowVersionCollectionResponse>(requestInfo, createWorkflowVersionCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Get a list of the workflowVersion objects and their properties.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
