...
export class WorkflowVersionVersionNumberItemRequestBuilder extends BaseRequestBuilder<WorkflowVersionVersionNumberItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/versions/{workflowVersion%2DversionNumber}{?%24select,%24expand}", (x, y) => new WorkflowVersionVersionNumberItemRequestBuilder(x, y));
    }
    /**
