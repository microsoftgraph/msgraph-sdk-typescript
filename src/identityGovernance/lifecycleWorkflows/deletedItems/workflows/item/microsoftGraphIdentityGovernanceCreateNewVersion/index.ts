...
export class MicrosoftGraphIdentityGovernanceCreateNewVersionRequestBuilder extends BaseRequestBuilder<MicrosoftGraphIdentityGovernanceCreateNewVersionRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/microsoft.graph.identityGovernance.createNewVersion", (x, y) => new MicrosoftGraphIdentityGovernanceCreateNewVersionRequestBuilder(x, y));
    }
    /**
