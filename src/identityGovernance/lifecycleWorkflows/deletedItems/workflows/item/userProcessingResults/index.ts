...
import { createUserProcessingResultCollectionResponseFromDiscriminatorValue, type UserProcessingResultCollectionResponse } from '../../../../../../models/identityGovernance/';
 ...
 */
export class UserProcessingResultsRequestBuilder extends BaseRequestBuilder<UserProcessingResultsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/userProcessingResults{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UserProcessingResultsRequestBuilder(x, y));
    }
    /**
