...
import { createAppConsentRequestCollectionResponseFromDiscriminatorValue, createAppConsentRequestFromDiscriminatorValue, deserializeIntoAppConsentRequest, serializeAppConsentRequest, type AppConsentRequest, type AppConsentRequestCollectionResponse } from '../../../models/';
...
import { AppConsentRequestItemRequestBuilder } from './item/';
 ...
 */
export class AppConsentRequestsRequestBuilder extends BaseRequestBuilder<AppConsentRequestsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/appConsent/appConsentRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AppConsentRequestsRequestBuilder(x, y));
    }
    /**
