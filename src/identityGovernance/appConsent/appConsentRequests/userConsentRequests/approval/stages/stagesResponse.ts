...
export class StagesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as StagesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as StagesResponse).value = n.getCollectionOfObjectValues<ApprovalStage>(ApprovalStage); }],
        ]);
    };
    /**
