...
export class UserConsentRequestRequestBuilder {
    public get approval(): ApprovalRequestBuilder {
        return new ApprovalRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    }
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: UserConsentRequest | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserConsentRequest | undefined> {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: UserConsentRequest | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
