...
export class StagesRequestBuilder {
    ...
    public get(requestConfiguration?: StagesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApprovalStageCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ApprovalStageCollectionResponseImpl>(requestInfo, createApprovalStageCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to stages for identityGovernance
     * @param body 
