...
export class ApprovalRequestBuilder {
     ...
     */
    public get(requestConfiguration?: ApprovalRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApprovalImpl | undefined> {
