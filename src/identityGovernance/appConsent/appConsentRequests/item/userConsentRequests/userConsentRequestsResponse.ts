...
export class UserConsentRequestsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as UserConsentRequestsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as UserConsentRequestsResponse).value = n.getCollectionOfObjectValues<UserConsentRequest>(UserConsentRequest); }],
        ]);
    };
    /**
