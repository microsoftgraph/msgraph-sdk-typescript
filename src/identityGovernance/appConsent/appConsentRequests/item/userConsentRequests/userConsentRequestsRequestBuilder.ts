...
export class UserConsentRequestsRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: UserConsentRequest | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserConsentRequestsResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.requestAdapter?.sendAsync<UserConsentRequestsResponse>(requestInfo, UserConsentRequestsResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * A list of pending user consent requests.
     * @param body 
     ...
     */
    public post(body: UserConsentRequest | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserConsentRequest | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = this.createPostRequestInformation(
            body, h, o
        );
        return this.requestAdapter?.sendAsync<UserConsentRequest>(requestInfo, UserConsentRequest, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
