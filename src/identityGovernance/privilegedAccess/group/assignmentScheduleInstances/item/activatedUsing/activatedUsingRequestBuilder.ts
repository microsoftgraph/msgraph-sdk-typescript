import { type PrivilegedAccessGroupEligibilityScheduleInstance } from '../../../../../../models/';
import { type ODataError } from '../../../../../../models/oDataErrors/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError } from '../../../../../../models/oDataErrors/oDataError';
import { createPrivilegedAccessGroupEligibilityScheduleInstanceFromDiscriminatorValue } from '../../../../../../models/privilegedAccessGroupEligibilityScheduleInstance';
...
export class ActivatedUsingRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance%2Did}/activatedUsing{?%24select,%24expand}");
    };
    /**
     ...
     */
    public get(requestConfiguration?: ActivatedUsingRequestBuilderGetRequestConfiguration | undefined) : Promise<PrivilegedAccessGroupEligibilityScheduleInstance | undefined> {
