...
export class ApprovalItemRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentApprovals/{approval%2Did}{?%24select,%24expand}");
    };
    /**
     * Delete navigation property assignmentApprovals for identityGovernance
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     */
    public delete(requestConfiguration?: ApprovalItemRequestBuilderDeleteRequestConfiguration | undefined) : Promise<void> {
     ...
     * @returns a Promise of Approval
     */
    public patch(body: Approval, requestConfiguration?: ApprovalItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<Approval | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: Approval, requestConfiguration?: ApprovalItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
