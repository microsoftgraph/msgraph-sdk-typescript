...
import { createPrivilegedAccessGroupAssignmentScheduleRequestFromDiscriminatorValue, deserializeIntoPrivilegedAccessGroupAssignmentScheduleRequest, serializePrivilegedAccessGroupAssignmentScheduleRequest, type PrivilegedAccessGroupAssignmentScheduleRequest } from '../../../../../models/';
 ...
 */
export class PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder extends BaseRequestBuilder<PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleRequests/{privilegedAccessGroupAssignmentScheduleRequest%2Did}{?%24select,%24expand}", (x, y) => new PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilderGetQueryParameters> | undefined) : Promise<PrivilegedAccessGroupAssignmentScheduleRequest | undefined> {
     ...
     * @returns a Promise of PrivilegedAccessGroupAssignmentScheduleRequest
     */
    public patch(body: PrivilegedAccessGroupAssignmentScheduleRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<PrivilegedAccessGroupAssignmentScheduleRequest | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, privilegedAccessGroupAssignmentScheduleRequestItemRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    }
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: PrivilegedAccessGroupAssignmentScheduleRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
