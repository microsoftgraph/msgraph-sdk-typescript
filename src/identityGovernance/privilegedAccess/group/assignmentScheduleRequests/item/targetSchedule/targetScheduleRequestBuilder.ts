...
export class TargetScheduleRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleRequests/{privilegedAccessGroupAssignmentScheduleRequest%2Did}/targetSchedule{?%24select,%24expand}");
    };
    /**
     ...
     */
    public get(requestConfiguration?: TargetScheduleRequestBuilderGetRequestConfiguration | undefined) : Promise<PrivilegedAccessGroupEligibilitySchedule | undefined> {
     ...
     * @returns a targetScheduleRequestBuilder
     */
    public withUrl(rawUrl: string) : TargetScheduleRequestBuilder {
