...
export interface GroupRequestBuilderDeleteRequestConfiguration {
    /**
     * Request headers
     */
...
export interface GroupRequestBuilderPatchRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
...
export class GroupRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: GroupRequestBuilderDeleteRequestConfiguration | undefined) : Promise<void> {
     ...
     */
    public get(requestConfiguration?: GroupRequestBuilderGetRequestConfiguration | undefined) : Promise<PrivilegedAccessGroup | undefined> {
     ...
     * @returns a Promise of PrivilegedAccessGroup
     */
    public patch(body: PrivilegedAccessGroup, requestConfiguration?: GroupRequestBuilderPatchRequestConfiguration | undefined) : Promise<PrivilegedAccessGroup | undefined> {
     ...
     */
    public toDeleteRequestInformation(requestConfiguration?: GroupRequestBuilderDeleteRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: PrivilegedAccessGroup, requestConfiguration?: GroupRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
