...
import { createPrivilegedAccessGroupFromDiscriminatorValue, deserializeIntoPrivilegedAccessGroup, serializePrivilegedAccessGroup, type PrivilegedAccessGroup } from '../../../models/';
...
export class GroupRequestBuilder extends BaseRequestBuilder<GroupRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group{?%24select,%24expand}", (x, y) => new GroupRequestBuilder(x, y));
    }
    /**
