...
export class TermsOfUse extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["agreementAcceptances", (o, n) => { (o as unknown as TermsOfUse).agreementAcceptances = n.getCollectionOfObjectValues<AgreementAcceptance>(AgreementAcceptance); }],
            ["agreements", (o, n) => { (o as unknown as TermsOfUse).agreements = n.getCollectionOfObjectValues<Agreement>(Agreement); }],
        ]);
    };
    /**
