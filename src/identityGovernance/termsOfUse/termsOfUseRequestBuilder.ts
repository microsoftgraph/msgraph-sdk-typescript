...
export class TermsOfUseRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: TermsOfUseRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
