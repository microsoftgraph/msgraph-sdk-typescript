...
export class TermsOfUseRequestBuilder {
    ...
    public get agreements(): AgreementsRequestBuilder {
        return new AgreementsRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    }
    ...
    public agreementsById(id: String) : AgreementRequestBuilder {
        if(!id) throw new Error("id cannot be undefined");
        return new AgreementRequestBuilder(this.currentPath + this.pathSegment + "/agreements/" + id, this.httpCore, false);
    };
    /**
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: TermsOfUseContainer | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: TermsOfUseContainer | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
