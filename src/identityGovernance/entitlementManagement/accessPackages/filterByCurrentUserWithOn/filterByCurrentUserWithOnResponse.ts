import { createAccessPackageFromDiscriminatorValue, serializeAccessPackage, type AccessPackage } from '../../../../models/accessPackage';
...
export function serializeFilterByCurrentUserWithOnResponse(writer: SerializationWriter, filterByCurrentUserWithOnResponse: FilterByCurrentUserWithOnResponse | undefined = {} as FilterByCurrentUserWithOnResponse) : void {
        ...
        writer.writeCollectionOfObjectValues<AccessPackage>("value", filterByCurrentUserWithOnResponse.value, );
}
