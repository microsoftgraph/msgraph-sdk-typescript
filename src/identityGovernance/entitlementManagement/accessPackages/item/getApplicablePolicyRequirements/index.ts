 ...
 */
export class GetApplicablePolicyRequirementsRequestBuilder extends BaseRequestBuilder<GetApplicablePolicyRequirementsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/getApplicablePolicyRequirements", (x, y) => new GetApplicablePolicyRequirementsRequestBuilder(x, y));
    }
    /**
