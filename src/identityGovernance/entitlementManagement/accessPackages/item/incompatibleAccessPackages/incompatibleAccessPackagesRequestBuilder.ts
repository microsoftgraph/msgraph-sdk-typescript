...
export class IncompatibleAccessPackagesRequestBuilder {
    /** The Count property */
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/incompatibleAccessPackages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
     ...
     */
    public createGetRequestInformation(requestConfiguration?: IncompatibleAccessPackagesRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
