...
import { createAccessPackageCollectionResponseFromDiscriminatorValue, createAccessPackageFromDiscriminatorValue, deserializeIntoAccessPackage, serializeAccessPackage, type AccessPackage, type AccessPackageCollectionResponse } from '../../../models/';
 ...
 */
export class AccessPackagesRequestBuilder extends BaseRequestBuilder<AccessPackagesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AccessPackagesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public post(body: AccessPackage, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AccessPackage | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: AccessPackage, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
