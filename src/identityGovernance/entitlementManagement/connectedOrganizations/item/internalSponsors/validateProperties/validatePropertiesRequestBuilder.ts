...
export class ValidatePropertiesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: ValidatePropertiesPostRequestBody | undefined, requestConfiguration?: ValidatePropertiesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeValidatePropertiesPostRequestBody);
        return requestInfo;
    };
}
