...
import { createConnectedOrganizationCollectionResponseFromDiscriminatorValue, createConnectedOrganizationFromDiscriminatorValue, deserializeIntoConnectedOrganization, serializeConnectedOrganization, type ConnectedOrganization, type ConnectedOrganizationCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ConnectedOrganizationItemRequestBuilder } from './item/';
 ...
 */
export class ConnectedOrganizationsRequestBuilder extends BaseRequestBuilder<ConnectedOrganizationsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/connectedOrganizations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ConnectedOrganizationsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<ConnectedOrganizationsRequestBuilderGetQueryParameters> | undefined) : Promise<ConnectedOrganizationCollectionResponse | undefined> {
     ...
     */
    public post(body: ConnectedOrganization, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ConnectedOrganization | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<ConnectedOrganizationsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, connectedOrganizationsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: ConnectedOrganization, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
