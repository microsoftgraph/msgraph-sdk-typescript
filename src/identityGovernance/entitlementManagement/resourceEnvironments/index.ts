...
import { createAccessPackageResourceEnvironmentCollectionResponseFromDiscriminatorValue, createAccessPackageResourceEnvironmentFromDiscriminatorValue, deserializeIntoAccessPackageResourceEnvironment, serializeAccessPackageResourceEnvironment, type AccessPackageResourceEnvironment, type AccessPackageResourceEnvironmentCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AccessPackageResourceEnvironmentItemRequestBuilder } from './item/';
 ...
 */
export class ResourceEnvironmentsRequestBuilder extends BaseRequestBuilder<ResourceEnvironmentsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceEnvironments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ResourceEnvironmentsRequestBuilder(x, y));
    }
    /**
