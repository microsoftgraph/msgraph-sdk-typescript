...
import { createAccessPackageResourceFromDiscriminatorValue, deserializeIntoAccessPackageResource, serializeAccessPackageResource, type AccessPackageResource } from '../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../models/oDataErrors/';
import { EnvironmentRequestBuilder } from './environment/';
import { RolesRequestBuilder } from './roles/';
import { ScopesRequestBuilder } from './scopes/';
 ...
 */
export class AccessPackageResourceItemRequestBuilder extends BaseRequestBuilder<AccessPackageResourceItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment%2Did}/resources/{accessPackageResource%2Did}{?%24select,%24expand}", (x, y) => new AccessPackageResourceItemRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<AccessPackageResourceItemRequestBuilderGetQueryParameters> | undefined) : Promise<AccessPackageResource | undefined> {
     ...
     * @returns a Promise of AccessPackageResource
     */
    public patch(body: AccessPackageResource, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AccessPackageResource | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<AccessPackageResourceItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, accessPackageResourceItemRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    }
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: AccessPackageResource, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
