...
export interface ResourceEnvironmentsRequestBuilderGetRequestConfiguration {
     ...
     */
    queryParameters?: ResourceEnvironmentsRequestBuilderGetQueryParameters;
}
export interface ResourceEnvironmentsRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
...
export class ResourceEnvironmentsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AccessPackageResourceEnvironment, requestConfiguration?: ResourceEnvironmentsRequestBuilderPostRequestConfiguration | undefined) : Promise<AccessPackageResourceEnvironment | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: AccessPackageResourceEnvironment, requestConfiguration?: ResourceEnvironmentsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
