...
import { createAccessPackageAssignmentRequestFromDiscriminatorValue, deserializeIntoAccessPackageAssignmentRequest, serializeAccessPackageAssignmentRequest, type AccessPackageAssignmentRequest } from '../../../../models/';
...
import { ResumeRequestBuilder } from './resume/';
 ...
 */
export class AccessPackageAssignmentRequestItemRequestBuilder extends BaseRequestBuilder<AccessPackageAssignmentRequestItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequest%2Did}{?%24select,%24expand}", (x, y) => new AccessPackageAssignmentRequestItemRequestBuilder(x, y));
    }
    /**
