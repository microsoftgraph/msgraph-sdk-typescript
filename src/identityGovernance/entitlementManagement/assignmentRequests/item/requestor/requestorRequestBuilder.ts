...
import { type RequestorRequestBuilderGetRequestConfiguration } from './requestorRequestBuilderGetRequestConfiguration';
 ...
 */
export class RequestorRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequest%2Did}/requestor{?%24select,%24expand}");
    };
    /**
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestorRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a requestorRequestBuilder
     */
    public withUrl(rawUrl: string) : RequestorRequestBuilder {
