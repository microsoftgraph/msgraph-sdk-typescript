...
export class FilterByCurrentUserWithOnResponse implements AdditionalDataHolder, Parsable {
    ...
    /** The value property */
    private _value?: Approval | FilterByCurrentUserWithOnMember1[] | undefined;
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "value": n => { this.value = n.getObjectValue<Approval>(createApprovalFromDiscriminatorValue); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<Approval>("value", this.value);
     ...
     */
    public set value(value: Approval | FilterByCurrentUserWithOnMember1[] | undefined) {
        this._value = value;
    };
}
