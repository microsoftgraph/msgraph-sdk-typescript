import {ApprovalImpl} from '../../../../models/';
...
export class ApprovalItemRequestBuilder {
     ...
     */
    public createDeleteRequestInformation(requestConfiguration?: ApprovalItemRequestBuilderDeleteRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createGetRequestInformation(requestConfiguration?: ApprovalItemRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: Approval | undefined, requestConfiguration?: ApprovalItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public get(requestConfiguration?: ApprovalItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApprovalImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ApprovalImpl>(requestInfo, createApprovalFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Update the navigation property accessPackageAssignmentApprovals in identityGovernance
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: Approval | undefined, requestConfiguration?: ApprovalItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
