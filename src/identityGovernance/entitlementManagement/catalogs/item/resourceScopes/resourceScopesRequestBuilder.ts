...
export class ResourceScopesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AccessPackageResourceScope | undefined, requestConfiguration?: ResourceScopesRequestBuilderPostRequestConfiguration | undefined) : Promise<AccessPackageResourceScope | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: AccessPackageResourceScope | undefined, requestConfiguration?: ResourceScopesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
