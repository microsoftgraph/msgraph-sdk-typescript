...
import { type ResourceScopesRequestBuilderGetRequestConfiguration } from './resourceScopesRequestBuilderGetRequestConfiguration';
import { type ResourceScopesRequestBuilderPostRequestConfiguration } from './resourceScopesRequestBuilderPostRequestConfiguration';
 ...
 */
export class ResourceScopesRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/resourceScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
     ...
     */
    public get(requestConfiguration?: ResourceScopesRequestBuilderGetRequestConfiguration | undefined) : Promise<AccessPackageResourceScopeCollectionResponse | undefined> {
     ...
     */
    public post(body: AccessPackageResourceScope, requestConfiguration?: ResourceScopesRequestBuilderPostRequestConfiguration | undefined) : Promise<AccessPackageResourceScope | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: ResourceScopesRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: AccessPackageResourceScope, requestConfiguration?: ResourceScopesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a resourceScopesRequestBuilder
     */
    public withUrl(rawUrl: string) : ResourceScopesRequestBuilder {
