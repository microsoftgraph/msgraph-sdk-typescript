...
export class RolesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the roles property of the microsoft.graph.accessPackageResource entity.
     * @param accessPackageResourceRoleId1 Unique identifier of the item
     * @returns a AccessPackageResourceRoleItemRequestBuilder
     */
    public byAccessPackageResourceRoleId1(accessPackageResourceRoleId1: string) : AccessPackageResourceRoleItemRequestBuilder {
        if(!accessPackageResourceRoleId1) throw new Error("accessPackageResourceRoleId1 cannot be undefined");
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/resourceRoles/{accessPackageResourceRole%2Did}/resource/scopes/{accessPackageResourceScope%2Did}/resource/roles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
     ...
     */
    public post(body: AccessPackageResourceRole | undefined, requestConfiguration?: RolesRequestBuilderPostRequestConfiguration | undefined) : Promise<AccessPackageResourceRole | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: AccessPackageResourceRole | undefined, requestConfiguration?: RolesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
