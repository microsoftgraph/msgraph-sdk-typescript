 ...
 */
export class IncompatibleGroupsRequestBuilder {
     ...
     */
    public createGetRequestInformation(requestConfiguration?: IncompatibleGroupsRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
