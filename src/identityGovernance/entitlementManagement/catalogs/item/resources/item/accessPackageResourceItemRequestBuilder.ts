...
import { type AccessPackageResourceItemRequestBuilderDeleteRequestConfiguration } from './accessPackageResourceItemRequestBuilderDeleteRequestConfiguration';
import { type AccessPackageResourceItemRequestBuilderGetRequestConfiguration } from './accessPackageResourceItemRequestBuilderGetRequestConfiguration';
import { type AccessPackageResourceItemRequestBuilderPatchRequestConfiguration } from './accessPackageResourceItemRequestBuilderPatchRequestConfiguration';
...
export class AccessPackageResourceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/resources/{accessPackageResource%2Did}{?%24select,%24expand}");
    };
    /**
     ...
     * @returns a Promise of AccessPackageResource
     */
    public patch(body: AccessPackageResource, requestConfiguration?: AccessPackageResourceItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<AccessPackageResource | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: AccessPackageResource, requestConfiguration?: AccessPackageResourceItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public withUrl(rawUrl: string) : AccessPackageResourceItemRequestBuilder {
