...
export interface AccessPackageResourceItemRequestBuilderDeleteRequestConfiguration {
    /**
     * Request headers
     */
...
export interface AccessPackageResourceItemRequestBuilderPatchRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
