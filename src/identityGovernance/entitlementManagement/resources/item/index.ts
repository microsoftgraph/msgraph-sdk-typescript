...
export class AccessPackageResourceItemRequestBuilder extends BaseRequestBuilder<AccessPackageResourceItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}{?%24select,%24expand}", (x, y) => new AccessPackageResourceItemRequestBuilder(x, y));
    }
    /**
