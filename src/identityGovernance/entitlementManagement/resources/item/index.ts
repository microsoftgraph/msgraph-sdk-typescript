 ...
 */
export const AccessPackageResourceItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
