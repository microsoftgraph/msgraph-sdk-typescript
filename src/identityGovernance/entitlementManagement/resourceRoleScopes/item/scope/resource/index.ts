...
export class ResourceRequestBuilder extends BaseRequestBuilder<ResourceRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/scope/resource{?%24select,%24expand}", (x, y) => new ResourceRequestBuilder(x, y));
    }
    /**
