...
import {AdditionalAccessRequestBuilder} from './microsoftGraphAdditionalAccess/additionalAccessRequestBuilder';
import {AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder} from './microsoftGraphAdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageId/additionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder';
...
export class AssignmentsRequestBuilder {
    ...
    public get microsoftGraphAdditionalAccess(): AdditionalAccessRequestBuilder {
     ...
     * @see {@link https://docs.microsoft.com/graph/api/entitlementmanagement-list-assignments?view=graph-rest-1.0|Find more info here}
     */
     ...
     */
    public microsoftGraphAdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageId(accessPackageId: string | undefined, incompatibleAccessPackageId: string | undefined) : AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder {
