...
import { createAccessPackageAssignmentFromDiscriminatorValue, deserializeIntoAccessPackageAssignment, serializeAccessPackageAssignment, type AccessPackageAssignment } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { AccessPackageRequestBuilder } from './accessPackage/';
import { AssignmentPolicyRequestBuilder } from './assignmentPolicy/';
import { ReprocessRequestBuilder } from './reprocess/';
import { TargetRequestBuilder } from './target/';
 ...
 */
export class AccessPackageAssignmentItemRequestBuilder extends BaseRequestBuilder<AccessPackageAssignmentItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment%2Did}{?%24select,%24expand}", (x, y) => new AccessPackageAssignmentItemRequestBuilder(x, y));
    }
    /**
