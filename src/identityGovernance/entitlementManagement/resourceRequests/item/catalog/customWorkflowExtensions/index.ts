...
import { createCustomCalloutExtensionCollectionResponseFromDiscriminatorValue, createCustomCalloutExtensionFromDiscriminatorValue, deserializeIntoCustomCalloutExtension, serializeCustomCalloutExtension, type CustomCalloutExtension, type CustomCalloutExtensionCollectionResponse } from '../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { CustomCalloutExtensionItemRequestBuilder } from './item/';
 ...
 */
export class CustomWorkflowExtensionsRequestBuilder extends BaseRequestBuilder<CustomWorkflowExtensionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}/catalog/customWorkflowExtensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new CustomWorkflowExtensionsRequestBuilder(x, y));
    }
    /**
