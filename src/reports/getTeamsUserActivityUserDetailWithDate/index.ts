 ...
 */
export class GetTeamsUserActivityUserDetailWithDateRequestBuilder extends BaseRequestBuilder<GetTeamsUserActivityUserDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsUserActivityUserDetail(date={date})", (x, y) => new GetTeamsUserActivityUserDetailWithDateRequestBuilder(x, y));
