...
import {GetTeamsUserActivityUserDetailWithDateResponse} from './getTeamsUserActivityUserDetailWithDateResponse';
...
export class GetTeamsUserActivityUserDetailWithDateRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetTeamsUserActivityUserDetailWithDateResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            requestConfiguration
        );
        return this.requestAdapter?.sendAsync<GetTeamsUserActivityUserDetailWithDateResponseImpl>(requestInfo, createGetTeamsUserActivityUserDetailWithDateResponseFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
