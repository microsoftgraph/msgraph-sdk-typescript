...
import { type GetTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration } from './getTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration';
