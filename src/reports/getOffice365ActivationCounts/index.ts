 ...
 */
export class GetOffice365ActivationCountsRequestBuilder extends BaseRequestBuilder<GetOffice365ActivationCountsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365ActivationCounts()", (x, y) => new GetOffice365ActivationCountsRequestBuilder(x, y));
    }
    /**
