 ...
 */
export class GetSharePointSiteUsageFileCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSharePointSiteUsageFileCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointSiteUsageFileCounts(period='{period}')", (x, y) => new GetSharePointSiteUsageFileCountsWithPeriodRequestBuilder(x, y));
