...
export class GetOneDriveUsageAccountCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetOneDriveUsageAccountCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getOneDriveUsageAccountCounts(period='${period ?? ''}')`;
