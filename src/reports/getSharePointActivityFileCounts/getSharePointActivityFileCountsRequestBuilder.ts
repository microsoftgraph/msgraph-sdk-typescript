...
export class GetSharePointActivityFileCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSharePointActivityFileCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSharePointActivityFileCounts(period='${period ?? ''}')`;
