 ...
 */
export class GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365GroupsActivityFileCounts(period='{period}')", (x, y) => new GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder(x, y));
