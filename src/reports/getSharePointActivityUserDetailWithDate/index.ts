 ...
 */
export class GetSharePointActivityUserDetailWithDateRequestBuilder extends BaseRequestBuilder<GetSharePointActivityUserDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointActivityUserDetail(date={date})", (x, y) => new GetSharePointActivityUserDetailWithDateRequestBuilder(x, y));
