...
import { type GetSharePointActivityUserDetailWithDateRequestBuilderGetRequestConfiguration } from './getSharePointActivityUserDetailWithDateRequestBuilderGetRequestConfiguration';
...
export class GetSharePointActivityUserDetailWithDateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetSharePointActivityUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined) : Promise<ArrayBuffer | undefined> {
     ...
     */
    public withUrl(rawUrl: string) : GetSharePointActivityUserDetailWithDateRequestBuilder {
