 ...
 */
export class GetYammerDeviceUsageUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetYammerDeviceUsageUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerDeviceUsageUserCounts(period='{period}')", (x, y) => new GetYammerDeviceUsageUserCountsWithPeriodRequestBuilder(x, y));
