...
export class GetEmailAppUsageUserDetailWithDateRequestBuilder {
     ...
     */
    public createGetRequestInformation(requestConfiguration?: GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public get(requestConfiguration?: GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetEmailAppUsageUserDetailWithDateResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            requestConfiguration
        );
        return this.requestAdapter?.sendAsync<GetEmailAppUsageUserDetailWithDateResponseImpl>(requestInfo, createGetEmailAppUsageUserDetailWithDateResponseFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
