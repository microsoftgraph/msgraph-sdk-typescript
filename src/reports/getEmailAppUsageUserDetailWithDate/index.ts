 ...
 */
export class GetEmailAppUsageUserDetailWithDateRequestBuilder extends BaseRequestBuilder<GetEmailAppUsageUserDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getEmailAppUsageUserDetail(date={date})", (x, y) => new GetEmailAppUsageUserDetailWithDateRequestBuilder(x, y));
