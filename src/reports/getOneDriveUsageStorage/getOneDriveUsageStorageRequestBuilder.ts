...
export class GetOneDriveUsageStorageRequestBuilder {
    ...
    /**
     * Instantiates a new getOneDriveUsageStorageRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getOneDriveUsageStorage(period='{period}')";
