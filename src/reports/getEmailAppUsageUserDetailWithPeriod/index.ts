 ...
 */
export class GetEmailAppUsageUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetEmailAppUsageUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getEmailAppUsageUserDetail(period='{period}')", (x, y) => new GetEmailAppUsageUserDetailWithPeriodRequestBuilder(x, y));
