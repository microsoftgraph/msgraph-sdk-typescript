...
export class GetEmailAppUsageUserDetailWithPeriodRequestBuilder {
     ...
     */
    public get(headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetEmailAppUsageUserDetailWithPeriodResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            headers, options
        );
        return this.requestAdapter?.sendAsync<GetEmailAppUsageUserDetailWithPeriodResponse>(requestInfo, createGetEmailAppUsageUserDetailWithPeriodResponseFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
