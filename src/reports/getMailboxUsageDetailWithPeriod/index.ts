 ...
 */
export class GetMailboxUsageDetailWithPeriodRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getMailboxUsageDetail(period='{period}')");
     ...
     */
    public withUrl(rawUrl: string) : GetMailboxUsageDetailWithPeriodRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new GetMailboxUsageDetailWithPeriodRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
