 ...
 */
export class GetMailboxUsageDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetMailboxUsageDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getMailboxUsageDetail(period='{period}')", (x, y) => new GetMailboxUsageDetailWithPeriodRequestBuilder(x, y));
