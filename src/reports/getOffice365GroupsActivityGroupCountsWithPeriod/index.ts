 ...
 */
export class GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365GroupsActivityGroupCounts(period='{period}')", (x, y) => new GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilder(x, y));
