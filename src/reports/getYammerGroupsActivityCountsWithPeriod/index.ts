 ...
 */
export class GetYammerGroupsActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetYammerGroupsActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerGroupsActivityCounts(period='{period}')", (x, y) => new GetYammerGroupsActivityCountsWithPeriodRequestBuilder(x, y));
