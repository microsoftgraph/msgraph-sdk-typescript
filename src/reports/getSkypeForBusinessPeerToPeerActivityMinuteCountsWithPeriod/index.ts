 ...
 */
export class GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='{period}')", (x, y) => new GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder(x, y));
