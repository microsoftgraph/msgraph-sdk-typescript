 ...
 */
export class GetOffice365ActivationsUserDetailRequestBuilder extends BaseRequestBuilder<GetOffice365ActivationsUserDetailRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365ActivationsUserDetail()", (x, y) => new GetOffice365ActivationsUserDetailRequestBuilder(x, y));
    }
    /**
