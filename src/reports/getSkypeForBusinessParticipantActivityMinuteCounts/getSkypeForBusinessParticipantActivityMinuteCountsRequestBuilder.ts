...
export class GetSkypeForBusinessParticipantActivityMinuteCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessParticipantActivityMinuteCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSkypeForBusinessParticipantActivityMinuteCounts(period='${period ?? ''}')`;
