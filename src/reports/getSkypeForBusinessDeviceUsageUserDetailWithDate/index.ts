 ...
 */
export class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessDeviceUsageUserDetail(date={date})", (x, y) => new GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder(x, y));
