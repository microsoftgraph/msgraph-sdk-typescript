 ...
 */
export class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessDeviceUsageUserDetail(date={date})");
     ...
     */
    public withUrl(rawUrl: string) : GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder {
