 ...
 */
export class GetTeamsTeamActivityDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsTeamActivityDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsTeamActivityDetail(period='{period}')", (x, y) => new GetTeamsTeamActivityDetailWithPeriodRequestBuilder(x, y));
