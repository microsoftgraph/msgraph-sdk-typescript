...
export class GetMailboxUsageQuotaStatusMailboxCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetMailboxUsageQuotaStatusMailboxCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getMailboxUsageQuotaStatusMailboxCounts(period='${period ?? ''}')`;
