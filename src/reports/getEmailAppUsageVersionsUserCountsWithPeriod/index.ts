 ...
 */
export class GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getEmailAppUsageVersionsUserCounts(period='{period}')", (x, y) => new GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(x, y));
