 ...
 */
export class GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getEmailAppUsageAppsUserCounts(period='{period}')", (x, y) => new GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder(x, y));
