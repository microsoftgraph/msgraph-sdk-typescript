...
export class GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
