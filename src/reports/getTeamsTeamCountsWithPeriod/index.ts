 ...
 */
export class GetTeamsTeamCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsTeamCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsTeamCounts(period='{period}')", (x, y) => new GetTeamsTeamCountsWithPeriodRequestBuilder(x, y));
