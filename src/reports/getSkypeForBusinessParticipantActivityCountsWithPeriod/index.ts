 ...
 */
export class GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessParticipantActivityCounts(period='{period}')", (x, y) => new GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder(x, y));
