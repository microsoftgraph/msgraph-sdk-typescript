...
export class GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ReportImpl | undefined> {
