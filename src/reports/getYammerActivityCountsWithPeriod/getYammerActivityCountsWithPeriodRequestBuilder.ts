...
export class GetYammerActivityCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetYammerActivityCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
