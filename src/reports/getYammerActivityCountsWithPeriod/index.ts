 ...
 */
export class GetYammerActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetYammerActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerActivityCounts(period='{period}')", (x, y) => new GetYammerActivityCountsWithPeriodRequestBuilder(x, y));
