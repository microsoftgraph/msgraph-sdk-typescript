...
export class Microsoft.graph.getYammerActivityUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getYammerActivityUserDetailRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getYammerActivityUserDetail(date={date})";
