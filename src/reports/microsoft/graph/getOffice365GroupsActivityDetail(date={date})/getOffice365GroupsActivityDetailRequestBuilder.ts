...
export class Microsoft.graph.getOffice365GroupsActivityDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getOffice365GroupsActivityDetailRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getOffice365GroupsActivityDetail(date={date})";
