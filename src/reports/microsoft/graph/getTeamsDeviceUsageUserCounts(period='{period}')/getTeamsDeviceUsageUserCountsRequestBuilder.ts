...
export class Microsoft.graph.getTeamsDeviceUsageUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getTeamsDeviceUsageUserCountsRequestBuilder and sets the default values.
