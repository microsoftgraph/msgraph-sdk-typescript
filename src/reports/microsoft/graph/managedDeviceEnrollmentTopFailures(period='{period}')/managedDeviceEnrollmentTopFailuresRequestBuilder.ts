...
export class Microsoft.graph.managedDeviceEnrollmentTopFailuresRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.managedDeviceEnrollmentTopFailuresRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.managedDeviceEnrollmentTopFailures(period='{period}')";
     ...
     * @returns a Promise of Microsoft.graph.managedDeviceEnrollmentTopFailuresResponse
     */
