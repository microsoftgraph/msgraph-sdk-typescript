...
export class Microsoft.graph.getSkypeForBusinessDeviceUsageDistributionUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSkypeForBusinessDeviceUsageDistributionUserCountsRequestBuilder and sets the default values.
