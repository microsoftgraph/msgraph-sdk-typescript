...
export class Microsoft.graph.getSharePointSiteUsageDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSharePointSiteUsageDetailRequestBuilder and sets the default values.
