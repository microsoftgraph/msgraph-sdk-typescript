...
export class Microsoft.graph.getEmailAppUsageAppsUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getEmailAppUsageAppsUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getEmailAppUsageAppsUserCounts(period='{period}')";
