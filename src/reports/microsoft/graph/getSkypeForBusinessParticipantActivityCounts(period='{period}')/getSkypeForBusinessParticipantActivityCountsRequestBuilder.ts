...
export class Microsoft.graph.getSkypeForBusinessParticipantActivityCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSkypeForBusinessParticipantActivityCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getSkypeForBusinessParticipantActivityCounts(period='{period}')";
