...
export class Microsoft.graph.getTeamsUserActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getTeamsUserActivityUserCountsRequestBuilder and sets the default values.
