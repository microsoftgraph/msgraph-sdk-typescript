...
export class Microsoft.graph.getEmailActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getEmailActivityUserCountsRequestBuilder and sets the default values.
