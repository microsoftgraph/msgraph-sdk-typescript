...
export class Microsoft.graph.deviceConfigurationUserActivityRequestBuilder {
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.deviceConfigurationUserActivity()";
     ...
     * @returns a Promise of Microsoft.graph.deviceConfigurationUserActivityResponse
     */
