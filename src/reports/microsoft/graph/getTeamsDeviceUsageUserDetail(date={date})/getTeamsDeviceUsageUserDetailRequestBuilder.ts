...
export class Microsoft.graph.getTeamsDeviceUsageUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getTeamsDeviceUsageUserDetailRequestBuilder and sets the default values.
