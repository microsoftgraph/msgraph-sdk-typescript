...
export class Microsoft.graph.getSkypeForBusinessActivityUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSkypeForBusinessActivityUserDetailRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getSkypeForBusinessActivityUserDetail(period='{period}')";
