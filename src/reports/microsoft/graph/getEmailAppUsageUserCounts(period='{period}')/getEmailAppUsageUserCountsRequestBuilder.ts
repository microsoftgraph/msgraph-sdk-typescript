...
export class Microsoft.graph.getEmailAppUsageUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getEmailAppUsageUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getEmailAppUsageUserCounts(period='{period}')";
