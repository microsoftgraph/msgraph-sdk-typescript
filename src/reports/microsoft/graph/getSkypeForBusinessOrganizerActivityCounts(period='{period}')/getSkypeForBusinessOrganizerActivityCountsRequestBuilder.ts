...
export class Microsoft.graph.getSkypeForBusinessOrganizerActivityCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSkypeForBusinessOrganizerActivityCountsRequestBuilder and sets the default values.
