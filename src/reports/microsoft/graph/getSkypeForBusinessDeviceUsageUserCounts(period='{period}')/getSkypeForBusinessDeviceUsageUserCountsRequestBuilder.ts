...
export class Microsoft.graph.getSkypeForBusinessDeviceUsageUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSkypeForBusinessDeviceUsageUserCountsRequestBuilder and sets the default values.
