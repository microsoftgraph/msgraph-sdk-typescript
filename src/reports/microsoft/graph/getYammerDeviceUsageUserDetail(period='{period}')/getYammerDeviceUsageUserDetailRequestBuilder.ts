...
export class Microsoft.graph.getYammerDeviceUsageUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getYammerDeviceUsageUserDetailRequestBuilder and sets the default values.
