...
export class Microsoft.graph.getOneDriveUsageAccountDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getOneDriveUsageAccountDetailRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getOneDriveUsageAccountDetail(period='{period}')";
