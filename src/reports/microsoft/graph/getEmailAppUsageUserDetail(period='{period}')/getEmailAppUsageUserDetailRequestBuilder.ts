...
export class Microsoft.graph.getEmailAppUsageUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getEmailAppUsageUserDetailRequestBuilder and sets the default values.
