...
export class Microsoft.graph.getSkypeForBusinessDeviceUsageUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSkypeForBusinessDeviceUsageUserDetailRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getSkypeForBusinessDeviceUsageUserDetail(period='{period}')";
