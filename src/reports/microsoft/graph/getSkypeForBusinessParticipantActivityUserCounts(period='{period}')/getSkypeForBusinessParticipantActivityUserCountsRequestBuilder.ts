...
export class Microsoft.graph.getSkypeForBusinessParticipantActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSkypeForBusinessParticipantActivityUserCountsRequestBuilder and sets the default values.
