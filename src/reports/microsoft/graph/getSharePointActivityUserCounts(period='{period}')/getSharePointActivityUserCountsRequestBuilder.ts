...
export class Microsoft.graph.getSharePointActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSharePointActivityUserCountsRequestBuilder and sets the default values.
