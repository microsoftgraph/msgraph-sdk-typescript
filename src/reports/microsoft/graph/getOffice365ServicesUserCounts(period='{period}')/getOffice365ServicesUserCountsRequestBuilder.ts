...
export class Microsoft.graph.getOffice365ServicesUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getOffice365ServicesUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getOffice365ServicesUserCounts(period='{period}')";
