...
export class Microsoft.graph.getYammerGroupsActivityDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getYammerGroupsActivityDetailRequestBuilder and sets the default values.
