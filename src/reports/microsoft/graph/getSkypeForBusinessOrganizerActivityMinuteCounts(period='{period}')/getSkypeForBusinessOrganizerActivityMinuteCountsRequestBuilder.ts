...
export class Microsoft.graph.getSkypeForBusinessOrganizerActivityMinuteCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSkypeForBusinessOrganizerActivityMinuteCountsRequestBuilder and sets the default values.
