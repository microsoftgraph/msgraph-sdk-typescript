...
export class Microsoft.graph.getMailboxUsageStorageRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getMailboxUsageStorageRequestBuilder and sets the default values.
