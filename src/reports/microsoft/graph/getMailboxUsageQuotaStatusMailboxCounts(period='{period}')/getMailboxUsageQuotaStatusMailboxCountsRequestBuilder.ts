...
export class Microsoft.graph.getMailboxUsageQuotaStatusMailboxCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getMailboxUsageQuotaStatusMailboxCountsRequestBuilder and sets the default values.
