...
export class Microsoft.graph.getSkypeForBusinessPeerToPeerActivityMinuteCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSkypeForBusinessPeerToPeerActivityMinuteCountsRequestBuilder and sets the default values.
