...
export class Microsoft.graph.deviceConfigurationDeviceActivityRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.deviceConfigurationDeviceActivityRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.deviceConfigurationDeviceActivity()";
     ...
     * @returns a Promise of Microsoft.graph.deviceConfigurationDeviceActivityResponse
     */
