...
export class Microsoft.graph.managedDeviceEnrollmentFailureDetailsRequestBuilder {
     ...
     * @returns a Promise of Microsoft.graph.managedDeviceEnrollmentFailureDetailsResponse
     */
