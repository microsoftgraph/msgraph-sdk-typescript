...
export class Microsoft.graph.getTeamsUserActivityUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getTeamsUserActivityUserDetailRequestBuilder and sets the default values.
