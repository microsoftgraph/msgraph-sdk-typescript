...
export class Microsoft.graph.getOneDriveActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getOneDriveActivityUserCountsRequestBuilder and sets the default values.
