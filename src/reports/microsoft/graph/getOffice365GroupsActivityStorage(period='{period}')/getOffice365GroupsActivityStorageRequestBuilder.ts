...
export class Microsoft.graph.getOffice365GroupsActivityStorageRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getOffice365GroupsActivityStorageRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getOffice365GroupsActivityStorage(period='{period}')";
