...
export class Microsoft.graph.getOffice365GroupsActivityCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getOffice365GroupsActivityCountsRequestBuilder and sets the default values.
