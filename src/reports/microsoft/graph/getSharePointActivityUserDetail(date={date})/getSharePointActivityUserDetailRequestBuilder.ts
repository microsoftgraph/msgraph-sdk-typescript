...
export class Microsoft.graph.getSharePointActivityUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSharePointActivityUserDetailRequestBuilder and sets the default values.
