...
export class Microsoft.graph.getEmailActivityUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getEmailActivityUserDetailRequestBuilder and sets the default values.
