...
export class Microsoft.graph.getSharePointSiteUsageFileCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSharePointSiteUsageFileCountsRequestBuilder and sets the default values.
