...
export class Microsoft.graph.getTeamsDeviceUsageDistributionUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getTeamsDeviceUsageDistributionUserCountsRequestBuilder and sets the default values.
