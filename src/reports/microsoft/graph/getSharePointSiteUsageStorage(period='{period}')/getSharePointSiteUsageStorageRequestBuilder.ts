...
export class Microsoft.graph.getSharePointSiteUsageStorageRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getSharePointSiteUsageStorageRequestBuilder and sets the default values.
