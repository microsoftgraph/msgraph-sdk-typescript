...
export class Microsoft.graph.getOffice365GroupsActivityFileCountsRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getOffice365GroupsActivityFileCountsRequestBuilder and sets the default values.
