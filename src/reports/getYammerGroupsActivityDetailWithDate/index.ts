 ...
 */
export class GetYammerGroupsActivityDetailWithDateRequestBuilder extends BaseRequestBuilder<GetYammerGroupsActivityDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerGroupsActivityDetail(date={date})", (x, y) => new GetYammerGroupsActivityDetailWithDateRequestBuilder(x, y));
