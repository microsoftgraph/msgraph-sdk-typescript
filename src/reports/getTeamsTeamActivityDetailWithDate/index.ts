 ...
 */
export class GetTeamsTeamActivityDetailWithDateRequestBuilder extends BaseRequestBuilder<GetTeamsTeamActivityDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsTeamActivityDetail(date={date})", (x, y) => new GetTeamsTeamActivityDetailWithDateRequestBuilder(x, y));
