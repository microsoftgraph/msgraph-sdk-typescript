 ...
 */
export class GetSharePointSiteUsagePagesWithPeriodRequestBuilder extends BaseRequestBuilder<GetSharePointSiteUsagePagesWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointSiteUsagePages(period='{period}')", (x, y) => new GetSharePointSiteUsagePagesWithPeriodRequestBuilder(x, y));
