 ...
 */
export class GetSharePointSiteUsagePagesWithPeriodRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointSiteUsagePages(period='{period}')");
     ...
     */
    public withUrl(rawUrl: string) : GetSharePointSiteUsagePagesWithPeriodRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new GetSharePointSiteUsagePagesWithPeriodRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
