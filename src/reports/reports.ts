...
export class Reports extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["dailyPrintUsageByPrinter", (o, n) => { (o as unknown as Reports).dailyPrintUsageByPrinter = n.getCollectionOfObjectValues<PrintUsageByPrinter>(PrintUsageByPrinter); }],
            ["dailyPrintUsageByUser", (o, n) => { (o as unknown as Reports).dailyPrintUsageByUser = n.getCollectionOfObjectValues<PrintUsageByUser>(PrintUsageByUser); }],
            ["monthlyPrintUsageByPrinter", (o, n) => { (o as unknown as Reports).monthlyPrintUsageByPrinter = n.getCollectionOfObjectValues<PrintUsageByPrinter>(PrintUsageByPrinter); }],
            ["monthlyPrintUsageByUser", (o, n) => { (o as unknown as Reports).monthlyPrintUsageByUser = n.getCollectionOfObjectValues<PrintUsageByUser>(PrintUsageByUser); }],
        ]);
    };
    /**
