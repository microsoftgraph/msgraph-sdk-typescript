...
export class GetOffice365GroupsActivityGroupCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetOffice365GroupsActivityGroupCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getOffice365GroupsActivityGroupCounts(period='${period ?? ''}')`;
