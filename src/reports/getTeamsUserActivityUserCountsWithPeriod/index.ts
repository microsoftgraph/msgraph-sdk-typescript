 ...
 */
export class GetTeamsUserActivityUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsUserActivityUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsUserActivityUserCounts(period='{period}')", (x, y) => new GetTeamsUserActivityUserCountsWithPeriodRequestBuilder(x, y));
