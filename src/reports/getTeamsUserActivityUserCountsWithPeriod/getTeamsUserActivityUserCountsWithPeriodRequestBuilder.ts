...
export class GetTeamsUserActivityUserCountsWithPeriodRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        ...
        this.urlTemplate = "{+baseurl}/reports/microsoft.graph.getTeamsUserActivityUserCounts(period='{period}')";
     ...
     */
    public get(headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetTeamsUserActivityUserCountsWithPeriodResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            headers, options
        );
        return this.requestAdapter?.sendAsync<GetTeamsUserActivityUserCountsWithPeriodResponse>(requestInfo, createGetTeamsUserActivityUserCountsWithPeriodResponseFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
