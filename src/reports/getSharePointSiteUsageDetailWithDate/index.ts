 ...
 */
export class GetSharePointSiteUsageDetailWithDateRequestBuilder extends BaseRequestBuilder<GetSharePointSiteUsageDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointSiteUsageDetail(date={date})", (x, y) => new GetSharePointSiteUsageDetailWithDateRequestBuilder(x, y));
