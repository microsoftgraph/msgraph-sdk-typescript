 ...
 */
export class GetOneDriveActivityUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetOneDriveActivityUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOneDriveActivityUserCounts(period='{period}')", (x, y) => new GetOneDriveActivityUserCountsWithPeriodRequestBuilder(x, y));
