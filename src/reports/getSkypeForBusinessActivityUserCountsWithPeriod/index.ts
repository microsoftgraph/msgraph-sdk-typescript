 ...
 */
export class GetSkypeForBusinessActivityUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessActivityUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessActivityUserCounts(period='{period}')", (x, y) => new GetSkypeForBusinessActivityUserCountsWithPeriodRequestBuilder(x, y));
