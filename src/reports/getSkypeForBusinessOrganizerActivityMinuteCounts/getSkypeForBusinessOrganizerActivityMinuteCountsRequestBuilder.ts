...
export class GetSkypeForBusinessOrganizerActivityMinuteCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessOrganizerActivityMinuteCountsRequestBuilder and sets the default values.
