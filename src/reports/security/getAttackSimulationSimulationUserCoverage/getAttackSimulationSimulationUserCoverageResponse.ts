import {AttackSimulationSimulationUserCoverage} from '../../../models/';
...
export class GetAttackSimulationSimulationUserCoverageResponse implements AdditionalDataHolder, Parsable {
