import {AttackSimulationTrainingUserCoverage} from '../../../models/';
...
export class GetAttackSimulationTrainingUserCoverageResponse implements AdditionalDataHolder, Parsable {
