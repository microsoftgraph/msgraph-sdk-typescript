...
import { createSecurityReportsRootFromDiscriminatorValue, deserializeIntoSecurityReportsRoot, serializeSecurityReportsRoot, type SecurityReportsRoot } from '../../models/';
...
export class SecurityRequestBuilder extends BaseRequestBuilder<SecurityRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/security{?%24select,%24expand}", (x, y) => new SecurityRequestBuilder(x, y));
    }
    /**
