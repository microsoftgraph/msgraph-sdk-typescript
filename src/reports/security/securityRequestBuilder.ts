...
export class SecurityRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: SecurityRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
