 ...
 */
export class GetYammerGroupsActivityDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetYammerGroupsActivityDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerGroupsActivityDetail(period='{period}')", (x, y) => new GetYammerGroupsActivityDetailWithPeriodRequestBuilder(x, y));
