 ...
 */
export class GetYammerGroupsActivityDetailWithPeriodRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerGroupsActivityDetail(period='{period}')");
     ...
     */
    public withUrl(rawUrl: string) : GetYammerGroupsActivityDetailWithPeriodRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new GetYammerGroupsActivityDetailWithPeriodRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
