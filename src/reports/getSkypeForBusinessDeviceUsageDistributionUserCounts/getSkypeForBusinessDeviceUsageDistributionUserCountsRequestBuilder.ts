...
export class GetSkypeForBusinessDeviceUsageDistributionUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessDeviceUsageDistributionUserCountsRequestBuilder and sets the default values.
     * @param currentPath Current path for the request
     * @param httpCore The http core service to use to execute the requests.
     * @param isRawUrl Whether the current path is a raw URL
     * @param period Usage: period={period}
     */
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        if(!currentPath) throw new Error("currentPath cannot be undefined");
        if(!httpCore) throw new Error("httpCore cannot be undefined");
        this.pathSegment = `/microsoft.graph.getSkypeForBusinessDeviceUsageDistributionUserCounts(period='${period ?? ''}')`;
