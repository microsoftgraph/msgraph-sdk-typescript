...
export class GetSkypeForBusinessActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessActivityUserCountsRequestBuilder and sets the default values.
