 ...
 */
export class GetTeamsDeviceUsageUserDetailWithDateRequestBuilder extends BaseRequestBuilder<GetTeamsDeviceUsageUserDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsDeviceUsageUserDetail(date={date})", (x, y) => new GetTeamsDeviceUsageUserDetailWithDateRequestBuilder(x, y));
