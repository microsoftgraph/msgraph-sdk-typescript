...
import { type GetTeamsDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration } from './getTeamsDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration';
...
export class GetTeamsDeviceUsageUserDetailWithDateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetTeamsDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined) : Promise<ArrayBuffer | undefined> {
     ...
     */
    public withUrl(rawUrl: string) : GetTeamsDeviceUsageUserDetailWithDateRequestBuilder {
