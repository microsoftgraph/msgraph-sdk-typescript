...
export class GetSkypeForBusinessDeviceUsageUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessDeviceUsageUserCountsRequestBuilder and sets the default values.
