...
export class GetTeamsDeviceUsageUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetTeamsDeviceUsageUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getTeamsDeviceUsageUserCounts(period='${period ?? ''}')`;
