 ...
 */
export class GetYammerDeviceUsageUserDetailWithDateRequestBuilder extends BaseRequestBuilder<GetYammerDeviceUsageUserDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerDeviceUsageUserDetail(date={date})", (x, y) => new GetYammerDeviceUsageUserDetailWithDateRequestBuilder(x, y));
