 ...
 */
export class GetOneDriveUsageStorageWithPeriodRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOneDriveUsageStorage(period='{period}')");
     ...
     */
    public withUrl(rawUrl: string) : GetOneDriveUsageStorageWithPeriodRequestBuilder {
