 ...
 */
export class GetOneDriveUsageStorageWithPeriodRequestBuilder extends BaseRequestBuilder<GetOneDriveUsageStorageWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOneDriveUsageStorage(period='{period}')", (x, y) => new GetOneDriveUsageStorageWithPeriodRequestBuilder(x, y));
