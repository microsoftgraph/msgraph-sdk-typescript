...
export class GetOneDriveUsageStorageWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetOneDriveUsageStorageWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
