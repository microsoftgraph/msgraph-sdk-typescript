...
export class GetSkypeForBusinessOrganizerActivityCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessOrganizerActivityCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSkypeForBusinessOrganizerActivityCounts(period='${period ?? ''}')`;
