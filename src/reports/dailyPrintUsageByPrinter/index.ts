 ...
 */
export class DailyPrintUsageByPrinterRequestBuilder extends BaseRequestBuilder<DailyPrintUsageByPrinterRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/dailyPrintUsageByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DailyPrintUsageByPrinterRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<DailyPrintUsageByPrinterRequestBuilderGetQueryParameters> | undefined) : Promise<PrintUsageByPrinterCollectionResponse | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<DailyPrintUsageByPrinterRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, dailyPrintUsageByPrinterRequestBuilderGetQueryParametersMapper);
