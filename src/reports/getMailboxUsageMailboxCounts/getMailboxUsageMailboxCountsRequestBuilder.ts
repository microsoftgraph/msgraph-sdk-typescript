...
export class GetMailboxUsageMailboxCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetMailboxUsageMailboxCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getMailboxUsageMailboxCounts(period='${period ?? ''}')`;
