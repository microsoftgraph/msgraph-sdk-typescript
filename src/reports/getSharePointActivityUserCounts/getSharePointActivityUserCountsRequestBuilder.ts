...
export class GetSharePointActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new getSharePointActivityUserCountsRequestBuilder and sets the default values.
