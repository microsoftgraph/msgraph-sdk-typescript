...
export class ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, skipToken?: string | undefined, filter?: string | undefined, skip?: number | undefined, top?: number | undefined) {
