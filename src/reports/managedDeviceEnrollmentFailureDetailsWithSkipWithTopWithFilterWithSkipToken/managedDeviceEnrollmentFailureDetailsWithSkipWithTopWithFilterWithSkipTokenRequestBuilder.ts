...
export class ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder {
     ...
     */
    public constructor(currentPath: string, httpCore: HttpCore, skip?: number | undefined, top?: number | undefined, filter?: string | undefined, skipToken?: string | undefined, isRawUrl: boolean = true) {
