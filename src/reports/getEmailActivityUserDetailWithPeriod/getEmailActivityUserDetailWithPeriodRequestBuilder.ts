...
export class GetEmailActivityUserDetailWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetEmailActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
