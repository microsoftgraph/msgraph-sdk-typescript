 ...
 */
export class GetEmailActivityUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetEmailActivityUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getEmailActivityUserDetail(period='{period}')", (x, y) => new GetEmailActivityUserDetailWithPeriodRequestBuilder(x, y));
