...
export class GetSharePointSiteUsageStorageRequestBuilder {
    ...
    /**
     * Instantiates a new GetSharePointSiteUsageStorageRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSharePointSiteUsageStorage(period='${period ?? ''}')`;
