...
export class GetSkypeForBusinessParticipantActivityCountsRequestBuilder {
    ...
    /**
     * Instantiates a new getSkypeForBusinessParticipantActivityCountsRequestBuilder and sets the default values.
