 ...
 */
export class GetEmailActivityUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetEmailActivityUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getEmailActivityUserCounts(period='{period}')", (x, y) => new GetEmailActivityUserCountsWithPeriodRequestBuilder(x, y));
