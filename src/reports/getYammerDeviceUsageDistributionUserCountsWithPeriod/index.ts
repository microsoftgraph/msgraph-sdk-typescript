 ...
 */
export class GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerDeviceUsageDistributionUserCounts(period='{period}')", (x, y) => new GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder(x, y));
