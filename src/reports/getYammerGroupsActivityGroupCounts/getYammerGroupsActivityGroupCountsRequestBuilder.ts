...
export class GetYammerGroupsActivityGroupCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetYammerGroupsActivityGroupCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getYammerGroupsActivityGroupCounts(period='${period ?? ''}')`;
