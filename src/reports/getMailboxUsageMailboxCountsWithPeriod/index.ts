 ...
 */
export class GetMailboxUsageMailboxCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetMailboxUsageMailboxCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getMailboxUsageMailboxCounts(period='{period}')", (x, y) => new GetMailboxUsageMailboxCountsWithPeriodRequestBuilder(x, y));
