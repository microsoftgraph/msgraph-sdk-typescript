...
export class GetSkypeForBusinessActivityCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessActivityCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSkypeForBusinessActivityCounts(period='${period ?? ''}')`;
