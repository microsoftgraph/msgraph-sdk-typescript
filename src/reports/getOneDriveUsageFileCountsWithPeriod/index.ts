 ...
 */
export class GetOneDriveUsageFileCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetOneDriveUsageFileCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOneDriveUsageFileCounts(period='{period}')", (x, y) => new GetOneDriveUsageFileCountsWithPeriodRequestBuilder(x, y));
