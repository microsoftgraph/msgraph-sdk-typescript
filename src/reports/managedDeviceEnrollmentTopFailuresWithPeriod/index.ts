 ...
 */
export class ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder extends BaseRequestBuilder<ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/managedDeviceEnrollmentTopFailures(period='{period}')", (x, y) => new ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder(x, y));
