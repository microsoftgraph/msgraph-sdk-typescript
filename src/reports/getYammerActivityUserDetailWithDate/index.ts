 ...
 */
export class GetYammerActivityUserDetailWithDateRequestBuilder extends BaseRequestBuilder<GetYammerActivityUserDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerActivityUserDetail(date={date})", (x, y) => new GetYammerActivityUserDetailWithDateRequestBuilder(x, y));
