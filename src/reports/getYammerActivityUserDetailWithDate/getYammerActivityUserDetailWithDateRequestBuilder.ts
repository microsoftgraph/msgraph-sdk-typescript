...
import { type GetYammerActivityUserDetailWithDateRequestBuilderGetRequestConfiguration } from './getYammerActivityUserDetailWithDateRequestBuilderGetRequestConfiguration';
...
export class GetYammerActivityUserDetailWithDateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public withUrl(rawUrl: string) : GetYammerActivityUserDetailWithDateRequestBuilder {
