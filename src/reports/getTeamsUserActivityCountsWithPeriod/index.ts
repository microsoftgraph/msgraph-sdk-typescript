 ...
 */
export class GetTeamsUserActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsUserActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsUserActivityCounts(period='{period}')", (x, y) => new GetTeamsUserActivityCountsWithPeriodRequestBuilder(x, y));
