...
export class GetTeamsUserActivityCountsWithPeriodRequestBuilder {
     ...
     */
    public get(headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetTeamsUserActivityCountsWithPeriodResponse | undefined> {
