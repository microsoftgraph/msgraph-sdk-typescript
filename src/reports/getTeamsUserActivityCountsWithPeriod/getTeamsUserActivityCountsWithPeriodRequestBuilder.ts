...
import { type GetTeamsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration } from './getTeamsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration';
...
export class GetTeamsUserActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public withUrl(rawUrl: string) : GetTeamsUserActivityCountsWithPeriodRequestBuilder {
