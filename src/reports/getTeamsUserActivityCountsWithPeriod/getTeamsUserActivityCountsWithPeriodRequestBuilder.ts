...
export class GetTeamsUserActivityCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetTeamsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
