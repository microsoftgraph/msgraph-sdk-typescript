...
export class GetTeamsUserActivityCountsWithPeriodRequestBuilder {
     ...
     */
    public createGetRequestInformation(requestConfiguration?: GetTeamsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public get(requestConfiguration?: GetTeamsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetTeamsUserActivityCountsWithPeriodResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            requestConfiguration
        );
        return this.requestAdapter?.sendAsync<GetTeamsUserActivityCountsWithPeriodResponseImpl>(requestInfo, createGetTeamsUserActivityCountsWithPeriodResponseFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
