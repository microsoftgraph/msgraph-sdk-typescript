 ...
 */
export class GetMailboxUsageStorageWithPeriodRequestBuilder extends BaseRequestBuilder<GetMailboxUsageStorageWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getMailboxUsageStorage(period='{period}')", (x, y) => new GetMailboxUsageStorageWithPeriodRequestBuilder(x, y));
