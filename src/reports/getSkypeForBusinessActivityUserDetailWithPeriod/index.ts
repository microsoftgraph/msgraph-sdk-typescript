 ...
 */
export class GetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessActivityUserDetail(period='{period}')", (x, y) => new GetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder(x, y));
