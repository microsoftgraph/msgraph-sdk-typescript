...
export class GetYammerDeviceUsageDistributionUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetYammerDeviceUsageDistributionUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getYammerDeviceUsageDistributionUserCounts(period='${period ?? ''}')`;
