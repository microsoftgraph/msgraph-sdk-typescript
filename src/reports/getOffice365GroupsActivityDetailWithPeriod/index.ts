 ...
 */
export class GetOffice365GroupsActivityDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetOffice365GroupsActivityDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365GroupsActivityDetail(period='{period}')", (x, y) => new GetOffice365GroupsActivityDetailWithPeriodRequestBuilder(x, y));
