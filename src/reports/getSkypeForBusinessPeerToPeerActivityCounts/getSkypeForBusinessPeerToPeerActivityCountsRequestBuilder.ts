...
export class GetSkypeForBusinessPeerToPeerActivityCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessPeerToPeerActivityCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSkypeForBusinessPeerToPeerActivityCounts(period='${period ?? ''}')`;
