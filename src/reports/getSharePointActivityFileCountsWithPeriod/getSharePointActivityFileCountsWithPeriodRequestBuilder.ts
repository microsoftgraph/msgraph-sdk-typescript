...
export class GetSharePointActivityFileCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetSharePointActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Report | undefined> {
