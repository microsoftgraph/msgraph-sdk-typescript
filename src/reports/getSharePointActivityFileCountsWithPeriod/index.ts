 ...
 */
export class GetSharePointActivityFileCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSharePointActivityFileCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointActivityFileCounts(period='{period}')", (x, y) => new GetSharePointActivityFileCountsWithPeriodRequestBuilder(x, y));
