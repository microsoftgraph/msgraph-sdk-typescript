 ...
 */
export class GetSharePointActivityUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSharePointActivityUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointActivityUserCounts(period='{period}')", (x, y) => new GetSharePointActivityUserCountsWithPeriodRequestBuilder(x, y));
