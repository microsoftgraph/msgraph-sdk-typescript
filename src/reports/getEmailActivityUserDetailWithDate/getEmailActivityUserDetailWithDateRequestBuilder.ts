...
export class GetEmailActivityUserDetailWithDateRequestBuilder {
     ...
     */
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: string | undefined) {
        ...
        date && urlTplParams.set("date", date);
