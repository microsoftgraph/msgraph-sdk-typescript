...
export class GetEmailActivityUserDetailWithDateRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetEmailActivityUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
