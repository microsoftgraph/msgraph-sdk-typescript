...
import { type GetEmailActivityUserDetailWithDateRequestBuilderGetRequestConfiguration } from './getEmailActivityUserDetailWithDateRequestBuilderGetRequestConfiguration';
...
export class GetEmailActivityUserDetailWithDateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetEmailActivityUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined) : Promise<ArrayBuffer | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: GetEmailActivityUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public withUrl(rawUrl: string) : GetEmailActivityUserDetailWithDateRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new GetEmailActivityUserDetailWithDateRequestBuilder(rawUrl, this.requestAdapter);
    };
}
