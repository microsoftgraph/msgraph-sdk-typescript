 ...
 */
export class GetYammerActivityUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetYammerActivityUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerActivityUserDetail(period='{period}')", (x, y) => new GetYammerActivityUserDetailWithPeriodRequestBuilder(x, y));
