 ...
 */
export class GetOneDriveUsageAccountDetailWithDateRequestBuilder extends BaseRequestBuilder<GetOneDriveUsageAccountDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOneDriveUsageAccountDetail(date={date})", (x, y) => new GetOneDriveUsageAccountDetailWithDateRequestBuilder(x, y));
