...
export class GetSkypeForBusinessPeerToPeerActivityMinuteCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessPeerToPeerActivityMinuteCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='${period ?? ''}')`;
