...
export class GetSkypeForBusinessActivityUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessActivityUserDetailRequestBuilder and sets the default values.
