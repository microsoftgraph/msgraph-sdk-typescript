 ...
 */
export class GetOneDriveUsageAccountCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetOneDriveUsageAccountCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOneDriveUsageAccountCounts(period='{period}')", (x, y) => new GetOneDriveUsageAccountCountsWithPeriodRequestBuilder(x, y));
