...
import { type GetSkypeForBusinessActivityUserDetailWithDateRequestBuilderGetRequestConfiguration } from './getSkypeForBusinessActivityUserDetailWithDateRequestBuilderGetRequestConfiguration';
...
export class GetSkypeForBusinessActivityUserDetailWithDateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public withUrl(rawUrl: string) : GetSkypeForBusinessActivityUserDetailWithDateRequestBuilder {
