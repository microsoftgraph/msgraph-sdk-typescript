...
export class GetOffice365GroupsActivityDetailRequestBuilder {
    ...
    /**
     * Instantiates a new GetOffice365GroupsActivityDetailRequestBuilder and sets the default values.
