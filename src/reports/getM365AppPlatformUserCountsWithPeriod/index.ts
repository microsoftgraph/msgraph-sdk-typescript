 ...
 */
export class GetM365AppPlatformUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetM365AppPlatformUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getM365AppPlatformUserCounts(period='{period}')", (x, y) => new GetM365AppPlatformUserCountsWithPeriodRequestBuilder(x, y));
