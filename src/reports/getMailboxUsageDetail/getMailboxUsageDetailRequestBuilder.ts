...
export class GetMailboxUsageDetailRequestBuilder {
    ...
    /**
     * Instantiates a new GetMailboxUsageDetailRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getMailboxUsageDetail(period='${period ?? ''}')`;
