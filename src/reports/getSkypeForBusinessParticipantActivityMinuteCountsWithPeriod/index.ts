 ...
 */
export class GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessParticipantActivityMinuteCounts(period='{period}')", (x, y) => new GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder(x, y));
