 ...
 */
export class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder extends BaseRequestBuilder<GetOffice365GroupsActivityStorageWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365GroupsActivityStorage(period='{period}')", (x, y) => new GetOffice365GroupsActivityStorageWithPeriodRequestBuilder(x, y));
