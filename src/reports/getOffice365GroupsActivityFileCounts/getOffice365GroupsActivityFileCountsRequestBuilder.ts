...
export class GetOffice365GroupsActivityFileCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetOffice365GroupsActivityFileCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getOffice365GroupsActivityFileCounts(period='${period ?? ''}')`;
