 ...
 */
export class GetOffice365ServicesUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetOffice365ServicesUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365ServicesUserCounts(period='{period}')", (x, y) => new GetOffice365ServicesUserCountsWithPeriodRequestBuilder(x, y));
