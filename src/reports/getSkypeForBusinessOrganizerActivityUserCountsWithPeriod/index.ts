 ...
 */
export class GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessOrganizerActivityUserCounts(period='{period}')", (x, y) => new GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilder(x, y));
