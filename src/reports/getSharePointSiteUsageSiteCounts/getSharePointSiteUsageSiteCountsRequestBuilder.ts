...
export class GetSharePointSiteUsageSiteCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSharePointSiteUsageSiteCountsRequestBuilder and sets the default values.
