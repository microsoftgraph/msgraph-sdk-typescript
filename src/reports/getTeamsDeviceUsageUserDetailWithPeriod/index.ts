 ...
 */
export class GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsDeviceUsageUserDetail(period='{period}')", (x, y) => new GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilder(x, y));
