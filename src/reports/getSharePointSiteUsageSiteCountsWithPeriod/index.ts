 ...
 */
export class GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointSiteUsageSiteCounts(period='{period}')", (x, y) => new GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder(x, y));
