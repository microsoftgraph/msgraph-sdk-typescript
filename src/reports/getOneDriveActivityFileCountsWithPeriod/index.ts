 ...
 */
export class GetOneDriveActivityFileCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetOneDriveActivityFileCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOneDriveActivityFileCounts(period='{period}')", (x, y) => new GetOneDriveActivityFileCountsWithPeriodRequestBuilder(x, y));
