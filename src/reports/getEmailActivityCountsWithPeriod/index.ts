 ...
 */
export class GetEmailActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetEmailActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getEmailActivityCounts(period='{period}')", (x, y) => new GetEmailActivityCountsWithPeriodRequestBuilder(x, y));
