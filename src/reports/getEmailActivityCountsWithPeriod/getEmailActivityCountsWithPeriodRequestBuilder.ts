...
export class GetEmailActivityCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetEmailActivityCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
