 ...
 */
export class GetYammerGroupsActivityGroupCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetYammerGroupsActivityGroupCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerGroupsActivityGroupCounts(period='{period}')", (x, y) => new GetYammerGroupsActivityGroupCountsWithPeriodRequestBuilder(x, y));
