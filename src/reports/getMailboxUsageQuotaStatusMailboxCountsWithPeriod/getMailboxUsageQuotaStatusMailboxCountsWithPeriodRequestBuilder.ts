...
export class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
