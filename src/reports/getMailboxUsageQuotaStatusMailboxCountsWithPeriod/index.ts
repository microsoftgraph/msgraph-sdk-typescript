 ...
 */
export class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getMailboxUsageQuotaStatusMailboxCounts(period='{period}')", (x, y) => new GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder(x, y));
