 ...
 */
export class GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityUserCounts(period='{period}')", (x, y) => new GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder(x, y));
