 ...
 */
export class GetM365AppUserDetailWithDateRequestBuilder extends BaseRequestBuilder<GetM365AppUserDetailWithDateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getM365AppUserDetail(date={date})", (x, y) => new GetM365AppUserDetailWithDateRequestBuilder(x, y));
