...
export class GetM365AppUserDetailWithDateRequestBuilder {
     ...
     */
    public createGetRequestInformation(requestConfiguration?: GetM365AppUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
