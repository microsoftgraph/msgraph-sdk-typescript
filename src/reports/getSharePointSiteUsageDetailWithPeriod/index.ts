 ...
 */
export class GetSharePointSiteUsageDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetSharePointSiteUsageDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointSiteUsageDetail(period='{period}')", (x, y) => new GetSharePointSiteUsageDetailWithPeriodRequestBuilder(x, y));
