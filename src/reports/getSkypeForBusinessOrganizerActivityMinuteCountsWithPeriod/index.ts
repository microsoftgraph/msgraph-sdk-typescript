 ...
 */
export class GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessOrganizerActivityMinuteCounts(period='{period}')", (x, y) => new GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder(x, y));
