 ...
 */
export class GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessOrganizerActivityMinuteCounts(period='{period}')");
     ...
     */
    public withUrl(rawUrl: string) : GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
