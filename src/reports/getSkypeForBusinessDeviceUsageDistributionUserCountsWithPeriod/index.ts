 ...
 */
export class GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessDeviceUsageDistributionUserCounts(period='{period}')", (x, y) => new GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodRequestBuilder(x, y));
