...
export class ReportsRequestBuilder {
     ...
     */
    public getUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTime(startDateTime: Date | undefined, userId: string | undefined, endDateTime: Date | undefined) : GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTimeRequestBuilder {
        if(!endDateTime) throw new Error("endDateTime cannot be undefined");
        if(!startDateTime) throw new Error("startDateTime cannot be undefined");
        if(!userId) throw new Error("userId cannot be undefined");
        return new GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTimeRequestBuilder(this.pathParameters, this.requestAdapter, startDateTime, userId, endDateTime);
    };
    /**
     ...
     */
    public managedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipToken(top: number | undefined, skipToken: string | undefined, filter: string | undefined, skip: number | undefined) : ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder {
        ...
        return new ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder(this.pathParameters, this.requestAdapter, top, skipToken, filter, skip);
    };
    /**
