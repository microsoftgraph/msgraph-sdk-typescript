...
export class ReportsRequestBuilder {
     ...
     */
    public getGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTime(startDateTime: Date | undefined, groupId: string | undefined, endDateTime: Date | undefined) : GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeRequestBuilder {
        if(!endDateTime) throw new Error("endDateTime cannot be undefined");
        if(!groupId) throw new Error("groupId cannot be undefined");
        if(!startDateTime) throw new Error("startDateTime cannot be undefined");
        return new GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeRequestBuilder(this.pathParameters, this.requestAdapter, startDateTime, groupId, endDateTime);
    };
    /**
     ...
     */
    public getPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTime(startDateTime: Date | undefined, endDateTime: Date | undefined, printerId: string | undefined) : GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimeRequestBuilder {
        if(!endDateTime) throw new Error("endDateTime cannot be undefined");
        if(!printerId) throw new Error("printerId cannot be undefined");
        if(!startDateTime) throw new Error("startDateTime cannot be undefined");
        return new GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimeRequestBuilder(this.pathParameters, this.requestAdapter, startDateTime, endDateTime, printerId);
    };
    /**
     ...
     */
    public getUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTime(startDateTime: Date | undefined, endDateTime: Date | undefined, userId: string | undefined) : GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTimeRequestBuilder {
        if(!endDateTime) throw new Error("endDateTime cannot be undefined");
        if(!startDateTime) throw new Error("startDateTime cannot be undefined");
        if(!userId) throw new Error("userId cannot be undefined");
        return new GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTimeRequestBuilder(this.pathParameters, this.requestAdapter, startDateTime, endDateTime, userId);
    };
    /**
     ...
     */
    public managedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipToken(skipToken: string | undefined, filter: string | undefined, skip: number | undefined, top: number | undefined) : ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder {
        ...
        return new ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder(this.pathParameters, this.requestAdapter, skipToken, filter, skip, top);
    };
    /**
