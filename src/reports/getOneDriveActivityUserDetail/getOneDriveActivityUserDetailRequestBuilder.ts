...
export class GetOneDriveActivityUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new GetOneDriveActivityUserDetailRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: IHttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getOneDriveActivityUserDetail(date=${date ?? ''})`;
