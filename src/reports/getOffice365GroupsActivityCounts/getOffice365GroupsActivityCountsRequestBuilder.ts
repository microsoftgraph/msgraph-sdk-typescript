...
export class GetOffice365GroupsActivityCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetOffice365GroupsActivityCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getOffice365GroupsActivityCounts(period='${period ?? ''}')`;
