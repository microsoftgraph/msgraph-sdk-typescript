 ...
 */
export class GetTeamsTeamActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsTeamActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsTeamActivityCounts(period='{period}')", (x, y) => new GetTeamsTeamActivityCountsWithPeriodRequestBuilder(x, y));
