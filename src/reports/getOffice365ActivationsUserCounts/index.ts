 ...
 */
export class GetOffice365ActivationsUserCountsRequestBuilder extends BaseRequestBuilder<GetOffice365ActivationsUserCountsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365ActivationsUserCounts()", (x, y) => new GetOffice365ActivationsUserCountsRequestBuilder(x, y));
    }
    /**
