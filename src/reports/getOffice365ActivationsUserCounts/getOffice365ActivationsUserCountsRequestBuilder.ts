...
import { type GetOffice365ActivationsUserCountsRequestBuilderGetRequestConfiguration } from './getOffice365ActivationsUserCountsRequestBuilderGetRequestConfiguration';
...
export class GetOffice365ActivationsUserCountsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public withUrl(rawUrl: string) : GetOffice365ActivationsUserCountsRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new GetOffice365ActivationsUserCountsRequestBuilder(rawUrl, this.requestAdapter);
    };
}
