...
export class GetOffice365ActivationsUserCountsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/reports/getOffice365ActivationsUserCounts()";
     ...
     */
    public get(requestConfiguration?: GetOffice365ActivationsUserCountsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
