 ...
 */
export class GetSkypeForBusinessParticipantActivityUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessParticipantActivityUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessParticipantActivityUserCounts(period='{period}')", (x, y) => new GetSkypeForBusinessParticipantActivityUserCountsWithPeriodRequestBuilder(x, y));
