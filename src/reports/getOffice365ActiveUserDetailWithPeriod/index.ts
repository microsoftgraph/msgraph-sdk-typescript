 ...
 */
export class GetOffice365ActiveUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetOffice365ActiveUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365ActiveUserDetail(period='{period}')", (x, y) => new GetOffice365ActiveUserDetailWithPeriodRequestBuilder(x, y));
