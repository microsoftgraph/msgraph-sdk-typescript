 ...
 */
export class GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessActivityCounts(period='{period}')", (x, y) => new GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder(x, y));
