...
export class GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetSkypeForBusinessActivityCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
