 ...
 */
export class GetTeamsUserActivityUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsUserActivityUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsUserActivityUserDetail(period='{period}')", (x, y) => new GetTeamsUserActivityUserDetailWithPeriodRequestBuilder(x, y));
