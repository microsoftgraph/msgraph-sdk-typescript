...
export class GetSharePointActivityPagesWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetSharePointActivityPagesWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
