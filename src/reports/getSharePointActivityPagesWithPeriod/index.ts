 ...
 */
export class GetSharePointActivityPagesWithPeriodRequestBuilder extends BaseRequestBuilder<GetSharePointActivityPagesWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointActivityPages(period='{period}')", (x, y) => new GetSharePointActivityPagesWithPeriodRequestBuilder(x, y));
