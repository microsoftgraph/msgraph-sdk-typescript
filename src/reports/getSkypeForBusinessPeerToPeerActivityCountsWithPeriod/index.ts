 ...
 */
export class GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityCounts(period='{period}')", (x, y) => new GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder(x, y));
