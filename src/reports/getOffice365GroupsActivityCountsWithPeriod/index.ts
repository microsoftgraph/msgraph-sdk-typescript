 ...
 */
export class GetOffice365GroupsActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetOffice365GroupsActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365GroupsActivityCounts(period='{period}')", (x, y) => new GetOffice365GroupsActivityCountsWithPeriodRequestBuilder(x, y));
