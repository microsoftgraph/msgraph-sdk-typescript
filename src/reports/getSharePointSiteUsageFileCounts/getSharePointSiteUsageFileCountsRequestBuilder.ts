...
export class GetSharePointSiteUsageFileCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSharePointSiteUsageFileCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSharePointSiteUsageFileCounts(period='${period ?? ''}')`;
