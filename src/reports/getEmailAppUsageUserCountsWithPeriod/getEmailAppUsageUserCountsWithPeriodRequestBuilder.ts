...
export class GetEmailAppUsageUserCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetEmailAppUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
