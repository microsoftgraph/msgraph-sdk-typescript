 ...
 */
export class GetEmailAppUsageUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetEmailAppUsageUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getEmailAppUsageUserCounts(period='{period}')", (x, y) => new GetEmailAppUsageUserCountsWithPeriodRequestBuilder(x, y));
