...
export class GetTeamsDeviceUsageDistributionUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new getTeamsDeviceUsageDistributionUserCountsRequestBuilder and sets the default values.
