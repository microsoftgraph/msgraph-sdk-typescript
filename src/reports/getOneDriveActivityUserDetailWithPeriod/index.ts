 ...
 */
export class GetOneDriveActivityUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetOneDriveActivityUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOneDriveActivityUserDetail(period='{period}')", (x, y) => new GetOneDriveActivityUserDetailWithPeriodRequestBuilder(x, y));
