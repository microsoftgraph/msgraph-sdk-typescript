 ...
 */
export class GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getYammerDeviceUsageUserDetail(period='{period}')", (x, y) => new GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder(x, y));
