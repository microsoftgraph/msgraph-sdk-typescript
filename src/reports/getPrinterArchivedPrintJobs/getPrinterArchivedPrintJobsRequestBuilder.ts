import {GetPrinterArchivedPrintJobs} from './getPrinterArchivedPrintJobs';
...
export class GetPrinterArchivedPrintJobsRequestBuilder {
     ...
     * @returns a Promise of getPrinterArchivedPrintJobs
     */
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetPrinterArchivedPrintJobs[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.httpCore?.sendCollectionAsync<GetPrinterArchivedPrintJobs>(requestInfo, GetPrinterArchivedPrintJobs, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
