 ...
 */
export class GetSharePointActivityUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetSharePointActivityUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointActivityUserDetail(period='{period}')", (x, y) => new GetSharePointActivityUserDetailWithPeriodRequestBuilder(x, y));
