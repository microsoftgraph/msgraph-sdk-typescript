...
export class GetSkypeForBusinessOrganizerActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessOrganizerActivityUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSkypeForBusinessOrganizerActivityUserCounts(period='${period ?? ''}')`;
