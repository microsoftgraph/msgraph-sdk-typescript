 ...
 */
export class GetM365AppUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetM365AppUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getM365AppUserDetail(period='{period}')", (x, y) => new GetM365AppUserDetailWithPeriodRequestBuilder(x, y));
