...
export class GetM365AppUserDetailWithPeriodRequestBuilder {
     ...
     */
    public createGetRequestInformation(requestConfiguration?: GetM365AppUserDetailWithPeriodRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
