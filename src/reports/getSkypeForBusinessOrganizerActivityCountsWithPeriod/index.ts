 ...
 */
export class GetSkypeForBusinessOrganizerActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessOrganizerActivityCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessOrganizerActivityCounts(period='{period}')", (x, y) => new GetSkypeForBusinessOrganizerActivityCountsWithPeriodRequestBuilder(x, y));
