 ...
 */
export class GetSharePointActivityUserDetailWithDateRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, date?: DateOnly | undefined) {
        ...
        this.urlTemplate = "{+baseurl}/reports/microsoft.graph.getSharePointActivityUserDetail(date={date})";
