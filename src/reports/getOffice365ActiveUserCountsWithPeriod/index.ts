 ...
 */
export class GetOffice365ActiveUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetOffice365ActiveUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOffice365ActiveUserCounts(period='{period}')", (x, y) => new GetOffice365ActiveUserCountsWithPeriodRequestBuilder(x, y));
