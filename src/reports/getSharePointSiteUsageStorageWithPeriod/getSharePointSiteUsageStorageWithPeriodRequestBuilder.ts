...
export class GetSharePointSiteUsageStorageWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetSharePointSiteUsageStorageWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
