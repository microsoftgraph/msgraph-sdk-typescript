 ...
 */
export class GetSharePointSiteUsageStorageWithPeriodRequestBuilder extends BaseRequestBuilder<GetSharePointSiteUsageStorageWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSharePointSiteUsageStorage(period='{period}')", (x, y) => new GetSharePointSiteUsageStorageWithPeriodRequestBuilder(x, y));
