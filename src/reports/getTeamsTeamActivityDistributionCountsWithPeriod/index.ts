 ...
 */
export class GetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsTeamActivityDistributionCounts(period='{period}')", (x, y) => new GetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilder(x, y));
