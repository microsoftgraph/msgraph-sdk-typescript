...
export class GetSkypeForBusinessPeerToPeerActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessPeerToPeerActivityUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSkypeForBusinessPeerToPeerActivityUserCounts(period='${period ?? ''}')`;
