...
export class ManagedDeviceEnrollmentFailureDetailsRequestBuilder {
     ...
     */
    public get(requestConfiguration?: ManagedDeviceEnrollmentFailureDetailsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Report | ManagedDeviceEnrollmentFailureDetailsResponseMember1 | undefined> {
        ...
        return this.requestAdapter?.sendAsync<Report | ManagedDeviceEnrollmentFailureDetailsResponseMember1>(requestInfo, createReport | ManagedDeviceEnrollmentFailureDetailsResponseMember1FromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
