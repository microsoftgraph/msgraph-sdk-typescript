 ...
 */
export class GetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessDeviceUsageUserDetail(period='{period}')", (x, y) => new GetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder(x, y));
