...
export class GetSkypeForBusinessDeviceUsageUserDetailRequestBuilder {
    ...
    /**
     * Instantiates a new getSkypeForBusinessDeviceUsageUserDetailRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.getSkypeForBusinessDeviceUsageUserDetail(date={date})";
