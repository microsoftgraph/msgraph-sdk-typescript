...
export class GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
