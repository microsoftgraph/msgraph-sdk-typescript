 ...
 */
export class GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsDeviceUsageUserCounts(period='{period}')", (x, y) => new GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder(x, y));
