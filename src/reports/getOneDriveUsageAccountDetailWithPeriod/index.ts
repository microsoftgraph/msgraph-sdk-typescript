 ...
 */
export class GetOneDriveUsageAccountDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetOneDriveUsageAccountDetailWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getOneDriveUsageAccountDetail(period='{period}')", (x, y) => new GetOneDriveUsageAccountDetailWithPeriodRequestBuilder(x, y));
