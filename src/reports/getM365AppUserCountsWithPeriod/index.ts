 ...
 */
export class GetM365AppUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetM365AppUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getM365AppUserCounts(period='{period}')", (x, y) => new GetM365AppUserCountsWithPeriodRequestBuilder(x, y));
