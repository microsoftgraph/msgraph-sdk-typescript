import {GetGroupArchivedPrintJobs} from './getGroupArchivedPrintJobs';
...
export class GetGroupArchivedPrintJobsRequestBuilder {
     ...
     * @returns a Promise of getGroupArchivedPrintJobs
     */
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetGroupArchivedPrintJobs[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.httpCore?.sendCollectionAsync<GetGroupArchivedPrintJobs>(requestInfo, GetGroupArchivedPrintJobs, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
