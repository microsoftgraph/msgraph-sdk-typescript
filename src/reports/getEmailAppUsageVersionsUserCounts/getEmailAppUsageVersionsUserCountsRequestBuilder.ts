...
export class GetEmailAppUsageVersionsUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetEmailAppUsageVersionsUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getEmailAppUsageVersionsUserCounts(period='${period ?? ''}')`;
