...
export class GetOffice365ActiveUserDetailWithDateRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
