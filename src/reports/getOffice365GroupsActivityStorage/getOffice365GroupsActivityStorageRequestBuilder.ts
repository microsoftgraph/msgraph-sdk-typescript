...
export class GetOffice365GroupsActivityStorageRequestBuilder {
    ...
    /**
     * Instantiates a new GetOffice365GroupsActivityStorageRequestBuilder and sets the default values.
