...
export class GetSkypeForBusinessParticipantActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetSkypeForBusinessParticipantActivityUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getSkypeForBusinessParticipantActivityUserCounts(period='${period ?? ''}')`;
