...
export class GetTeamsDeviceUsageDistributionUserCountsWithPeriodRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        ...
        this.urlTemplate = "{+baseurl}/reports/microsoft.graph.getTeamsDeviceUsageDistributionUserCounts(period='{period}')";
    ...
    public get(requestConfiguration?: GetTeamsDeviceUsageDistributionUserCountsWithPeriodRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetTeamsDeviceUsageDistributionUserCountsWithPeriodResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetTeamsDeviceUsageDistributionUserCountsWithPeriodResponseImpl>(requestInfo, createGetTeamsDeviceUsageDistributionUserCountsWithPeriodResponseFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
