 ...
 */
export class GetTeamsDeviceUsageDistributionUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsDeviceUsageDistributionUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getTeamsDeviceUsageDistributionUserCounts(period='{period}')", (x, y) => new GetTeamsDeviceUsageDistributionUserCountsWithPeriodRequestBuilder(x, y));
