...
export class GetYammerDeviceUsageUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetYammerDeviceUsageUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getYammerDeviceUsageUserCounts(period='${period ?? ''}')`;
