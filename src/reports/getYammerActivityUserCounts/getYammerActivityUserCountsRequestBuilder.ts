...
export class GetYammerActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetYammerActivityUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getYammerActivityUserCounts(period='${period ?? ''}')`;
