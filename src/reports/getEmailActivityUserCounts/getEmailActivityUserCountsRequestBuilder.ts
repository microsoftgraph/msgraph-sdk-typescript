...
export class GetEmailActivityUserCountsRequestBuilder {
    ...
    /**
     * Instantiates a new GetEmailActivityUserCountsRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, period?: string | undefined, isRawUrl: boolean = true) {
        ...
        this.pathSegment = `/microsoft.graph.getEmailActivityUserCounts(period='${period ?? ''}')`;
