 ...
 */
export class GetSkypeForBusinessDeviceUsageUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetSkypeForBusinessDeviceUsageUserCountsWithPeriodRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/reports/getSkypeForBusinessDeviceUsageUserCounts(period='{period}')", (x, y) => new GetSkypeForBusinessDeviceUsageUserCountsWithPeriodRequestBuilder(x, y));
