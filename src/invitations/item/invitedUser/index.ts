 ...
 */
export class InvitedUserRequestBuilder extends BaseRequestBuilder<InvitedUserRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/invitations/{invitation%2Did}/invitedUser{?%24select,%24expand}", (x, y) => new InvitedUserRequestBuilder(x, y));
    }
    /**
