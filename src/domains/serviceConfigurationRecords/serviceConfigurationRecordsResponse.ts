...
export class ServiceConfigurationRecordsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ServiceConfigurationRecordsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ServiceConfigurationRecordsResponse).value = n.getCollectionOfObjectValues<DomainDnsRecord>(DomainDnsRecord); }],
        ]);
    };
    /**
