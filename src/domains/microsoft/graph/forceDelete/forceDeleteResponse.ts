...
export class Microsoft.graph.forceDeleteResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["disableUserAccounts", (o, n) => { (o as unknown as Microsoft.graph.forceDeleteResponse).disableUserAccounts = n.getBooleanValue(); }],
        ]);
    };
    /**
