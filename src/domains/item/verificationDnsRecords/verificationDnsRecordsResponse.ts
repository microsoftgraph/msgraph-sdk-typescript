...
export class VerificationDnsRecordsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as VerificationDnsRecordsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as VerificationDnsRecordsResponse).value = n.getCollectionOfObjectValues<DomainDnsRecord>(DomainDnsRecord); }],
        ]);
    };
    /**
