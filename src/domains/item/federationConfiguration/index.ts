...
import { createInternalDomainFederationCollectionResponseFromDiscriminatorValue, createInternalDomainFederationFromDiscriminatorValue, deserializeIntoInternalDomainFederation, serializeInternalDomainFederation, type InternalDomainFederation, type InternalDomainFederationCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { InternalDomainFederationItemRequestBuilder } from './item/';
 ...
 */
export class FederationConfigurationRequestBuilder extends BaseRequestBuilder<FederationConfigurationRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/domains/{domain%2Did}/federationConfiguration{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new FederationConfigurationRequestBuilder(x, y));
    }
    /**
