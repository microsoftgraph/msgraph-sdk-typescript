 ...
 */
export class ForceDeleteRequestBuilder extends BaseRequestBuilder<ForceDeleteRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/domains/{domain%2Did}/forceDelete", (x, y) => new ForceDeleteRequestBuilder(x, y));
    }
    /**
