...
export class ForceDeleteRequestBuilder {
     ...
     */
    public post(body: ForceDeleteRequestBodyImpl | undefined, requestConfiguration?: ForceDeleteRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
