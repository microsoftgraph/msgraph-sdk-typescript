 ...
 */
export class PromoteRequestBuilder {
     ...
     */
    public createPostRequestInformation(requestConfiguration?: PromoteRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
