...
import { createDomainFromDiscriminatorValue, deserializeIntoDomain, serializeDomain, type Domain } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { DomainNameReferencesRequestBuilder } from './domainNameReferences/';
import { FederationConfigurationRequestBuilder } from './federationConfiguration/';
import { ForceDeleteRequestBuilder } from './forceDelete/';
import { PromoteRequestBuilder } from './promote/';
 ...
 */
export class DomainItemRequestBuilder extends BaseRequestBuilder<DomainItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/domains/{domain%2Did}{?%24select,%24expand}", (x, y) => new DomainItemRequestBuilder(x, y));
    }
    /**
