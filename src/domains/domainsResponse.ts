...
export class DomainsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DomainsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DomainsResponse).value = n.getCollectionOfObjectValues<Domain>(Domain); }],
        ]);
    };
    /**
