...
export class PlannerPlanRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.planner.plans.buckets collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.planner.plans.tasks collection
     * @param id Unique identifier of the item
