...
export class PlannerPlanRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.planner.plans.buckets collection
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: PlannerPlan | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.planner.plans.tasks collection
     * @param id Unique identifier of the item
