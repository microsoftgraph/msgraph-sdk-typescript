...
export class PostRequestBuilder {
    ...
    public get inReplyTo(): InReplyToRequestBuilder {
        return new InReplyToRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    }
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.threads.posts.attachments collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.threads.posts.extensions collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.threads.posts.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.threads.posts.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
