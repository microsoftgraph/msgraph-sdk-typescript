...
export class InReplyTo extends OutlookItem implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["attachments", (o, n) => { (o as unknown as InReplyTo).attachments = n.getCollectionOfObjectValues<Attachment>(Attachment); }],
            ["body", (o, n) => { (o as unknown as InReplyTo).body = n.getObjectValue<ItemBody>(ItemBody); }],
            ["conversationId", (o, n) => { (o as unknown as InReplyTo).conversationId = n.getStringValue(); }],
            ["conversationThreadId", (o, n) => { (o as unknown as InReplyTo).conversationThreadId = n.getStringValue(); }],
            ["extensions", (o, n) => { (o as unknown as InReplyTo).extensions = n.getCollectionOfObjectValues<Extension>(Extension); }],
            ["from", (o, n) => { (o as unknown as InReplyTo).from = n.getObjectValue<Recipient>(Recipient); }],
            ["hasAttachments", (o, n) => { (o as unknown as InReplyTo).hasAttachments = n.getBooleanValue(); }],
            ["inReplyTo", (o, n) => { (o as unknown as InReplyTo).inReplyTo = n.getObjectValue<Post>(Post); }],
            ["multiValueExtendedProperties", (o, n) => { (o as unknown as InReplyTo).multiValueExtendedProperties = n.getCollectionOfObjectValues<MultiValueLegacyExtendedProperty>(MultiValueLegacyExtendedProperty); }],
            ["newParticipants", (o, n) => { (o as unknown as InReplyTo).newParticipants = n.getCollectionOfObjectValues<Recipient>(Recipient); }],
            ["receivedDateTime", (o, n) => { (o as unknown as InReplyTo).receivedDateTime = n.getDateValue(); }],
            ["sender", (o, n) => { (o as unknown as InReplyTo).sender = n.getObjectValue<Recipient>(Recipient); }],
            ["singleValueExtendedProperties", (o, n) => { (o as unknown as InReplyTo).singleValueExtendedProperties = n.getCollectionOfObjectValues<SingleValueLegacyExtendedProperty>(SingleValueLegacyExtendedProperty); }],
        ]);
    };
    /**
