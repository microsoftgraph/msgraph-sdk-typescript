...
export class Photo extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["height", (o, n) => { (o as unknown as Photo).height = n.getNumberValue(); }],
            ["width", (o, n) => { (o as unknown as Photo).width = n.getNumberValue(); }],
        ]);
    };
    /**
