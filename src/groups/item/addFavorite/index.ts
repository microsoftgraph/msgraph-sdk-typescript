 ...
 */
export class AddFavoriteRequestBuilder extends BaseRequestBuilder<AddFavoriteRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/addFavorite", (x, y) => new AddFavoriteRequestBuilder(x, y));
    }
    /**
