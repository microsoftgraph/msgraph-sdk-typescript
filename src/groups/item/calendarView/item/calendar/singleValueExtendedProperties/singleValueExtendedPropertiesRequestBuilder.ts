...
export class SingleValueExtendedPropertiesRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/calendar/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
