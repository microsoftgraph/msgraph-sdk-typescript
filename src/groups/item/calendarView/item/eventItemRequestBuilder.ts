...
import {EventItemRequestBuilder as i790a730aa2f32933bb50db247cd1369b737e08043f2333f5544390c4c89ca78f} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i790a730aa2f32933bb50db247cd1369b737e08043f2333f5544390c4c89ca78f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i790a730aa2f32933bb50db247cd1369b737e08043f2333f5544390c4c89ca78f(urlTplParams, this.requestAdapter);
    };
    /**
