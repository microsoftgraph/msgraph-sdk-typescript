...
import {EventRequestBuilder as i5c169e3f054cc5e7b9fcc89150868052338e561a981b782b47df7221cc2ac245} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : i5c169e3f054cc5e7b9fcc89150868052338e561a981b782b47df7221cc2ac245 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new i5c169e3f054cc5e7b9fcc89150868052338e561a981b782b47df7221cc2ac245(urlTplParams, this.requestAdapter);
    };
    /**
