...
/** Builds and executes requests for operations under /groups/{group-id}/calendarView/{event-id}/instances/{event-id1}  */
export class EventRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/instances/{event_id1}{?select}";
