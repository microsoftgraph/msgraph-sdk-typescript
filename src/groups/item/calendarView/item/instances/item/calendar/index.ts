...
export class CalendarRequestBuilder extends BaseRequestBuilder<CalendarRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/calendar{?%24select}", (x, y) => new CalendarRequestBuilder(x, y));
    }
    /**
