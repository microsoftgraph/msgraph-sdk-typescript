...
import { createCheckGrantedPermissionsForAppPostResponseFromDiscriminatorValue } from './checkGrantedPermissionsForAppPostResponse';
import { type CheckGrantedPermissionsForAppPostResponse } from './index';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
...
export class CheckGrantedPermissionsForAppRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(requestConfiguration?: CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration | undefined) : Promise<CheckGrantedPermissionsForAppPostResponse | undefined> {
