...
export class CheckGrantedPermissionsForAppRequestBuilder {
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.checkGrantedPermissionsForApp";
     ...
     */
    public post(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CheckGrantedPermissionsForApp[] | undefined> {
        const requestInfo = this.createPostRequestInformation(
            h, o
        );
        return this.httpCore?.sendCollectionAsync<CheckGrantedPermissionsForApp>(requestInfo, CheckGrantedPermissionsForApp, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
