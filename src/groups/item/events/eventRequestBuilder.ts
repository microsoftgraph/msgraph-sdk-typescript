...
export class EventRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.events.item.attachments.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.events.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.events.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.events.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
