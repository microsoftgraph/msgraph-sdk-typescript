...
import {EventRequestBuilder as i3de478007708348c897d1617e9da942fc6908cead73b2e9e31442505d6094473} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : i3de478007708348c897d1617e9da942fc6908cead73b2e9e31442505d6094473 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new i3de478007708348c897d1617e9da942fc6908cead73b2e9e31442505d6094473(urlTplParams, this.requestAdapter);
    };
    /**
