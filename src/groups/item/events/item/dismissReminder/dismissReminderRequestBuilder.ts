...
/** Builds and executes requests for operations under /groups/{group-id}/events/{event-id}/microsoft.graph.dismissReminder  */
export class DismissReminderRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}/microsoft.graph.dismissReminder";
