...
import {EventItemRequestBuilder as i40a12f5976cafef6c0d894c7e623db63d8bafd13915280c6b5c36938a939a68e} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i40a12f5976cafef6c0d894c7e623db63d8bafd13915280c6b5c36938a939a68e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i40a12f5976cafef6c0d894c7e623db63d8bafd13915280c6b5c36938a939a68e(urlTplParams, this.requestAdapter);
    };
    /**
