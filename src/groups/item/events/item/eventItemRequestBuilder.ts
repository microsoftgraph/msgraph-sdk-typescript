...
import {EventItemRequestBuilder as i56d02d25e06dc8f1e939861110e93facea32ddd0d945ca802f84e2aaeadce2b0} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.events.item.attachments.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.events.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.events.item.instances.item collection
     * @param id Unique identifier of the item
     * @returns a eventItemRequestBuilder
     */
    public instancesById(id: string) : i56d02d25e06dc8f1e939861110e93facea32ddd0d945ca802f84e2aaeadce2b0 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i56d02d25e06dc8f1e939861110e93facea32ddd0d945ca802f84e2aaeadce2b0(urlTplParams, this.requestAdapter);
    };
    /**
     * Gets an item from the MicrosoftGraph.groups.item.events.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.events.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
