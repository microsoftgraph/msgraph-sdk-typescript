...
export class ThreadsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ThreadsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ThreadsResponse).value = n.getCollectionOfObjectValues<ConversationThread>(ConversationThread); }],
        ]);
    };
    /**
