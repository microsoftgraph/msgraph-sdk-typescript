...
import { createConversationThreadCollectionResponseFromDiscriminatorValue, createConversationThreadFromDiscriminatorValue, deserializeIntoConversationThread, serializeConversationThread, type ConversationThread, type ConversationThreadCollectionResponse } from '../../../../../models/';
 ...
 */
export class ThreadsRequestBuilder extends BaseRequestBuilder<ThreadsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ThreadsRequestBuilder(x, y));
    }
    /**
