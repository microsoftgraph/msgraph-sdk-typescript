...
export class ConversationRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: Conversation | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Conversation | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<Conversation>(requestInfo, Conversation, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * The group's conversations.
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: Conversation | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.conversations.item.threads.item collection
