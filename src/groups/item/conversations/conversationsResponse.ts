...
export class ConversationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ConversationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ConversationsResponse).value = n.getCollectionOfObjectValues<Conversation>(Conversation); }],
        ]);
    };
    /**
