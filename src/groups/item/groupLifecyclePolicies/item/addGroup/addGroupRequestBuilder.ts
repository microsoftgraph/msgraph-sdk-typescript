...
export class AddGroupRequestBuilder {
    ...
    public post(body: AddGroupPostRequestBody | undefined, requestConfiguration?: AddGroupRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AddGroupResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AddGroupResponseImpl>(requestInfo, createAddGroupResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
