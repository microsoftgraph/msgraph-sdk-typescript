 ...
 */
export class SubscribeByMailRequestBuilder extends BaseRequestBuilder<SubscribeByMailRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/subscribeByMail", (x, y) => new SubscribeByMailRequestBuilder(x, y));
    }
    /**
