 ...
 */
export class UnsubscribeByMailRequestBuilder extends BaseRequestBuilder<UnsubscribeByMailRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/unsubscribeByMail", (x, y) => new UnsubscribeByMailRequestBuilder(x, y));
    }
    /**
