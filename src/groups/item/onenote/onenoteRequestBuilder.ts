...
export class OnenoteRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.onenote.notebooks.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.onenote.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.onenote.pages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.onenote.resources.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.onenote.sectionGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.onenote.sections.item collection
     * @param id Unique identifier of the item
