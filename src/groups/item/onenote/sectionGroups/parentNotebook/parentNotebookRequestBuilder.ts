...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.onenote.sectionGroups.item.parentNotebook.sectionGroups.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.onenote.sectionGroups.item.parentNotebook.sections.item collection
     * @param id Unique identifier of the item
