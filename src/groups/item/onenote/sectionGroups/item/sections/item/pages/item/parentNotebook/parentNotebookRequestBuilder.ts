...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.onenote.sectionGroups.item.sections.item.pages.item.parentNotebook.sectionGroups.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.onenote.sectionGroups.item.sections.item.pages.item.parentNotebook.sections.item collection
     * @param id Unique identifier of the item
