...
import {SectionGroupRequestBuilder as ic8a807de1d462541c825d55c2ab67e569af938aea7b4955bc4b72db60f64462b} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.onenote.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: string) : ic8a807de1d462541c825d55c2ab67e569af938aea7b4955bc4b72db60f64462b {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("sectionGroup_id1", id);
        return new ic8a807de1d462541c825d55c2ab67e569af938aea7b4955bc4b72db60f64462b(urlTplParams, this.requestAdapter);
    };
    /**
