...
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.onenote.pages.item.parentSection.parentSectionGroup.sectionGroups.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.onenote.pages.item.parentSection.parentSectionGroup.sections.item collection
     * @param id Unique identifier of the item
