...
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.onenote.pages.item.parentNotebook.sections.item.parentSectionGroup.sectionGroups.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.onenote.pages.item.parentNotebook.sections.item.parentSectionGroup.sections.item collection
     * @param id Unique identifier of the item
