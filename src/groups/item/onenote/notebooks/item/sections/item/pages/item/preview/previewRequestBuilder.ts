...
export class PreviewRequestBuilder {
    ...
    public get(requestConfiguration?: PreviewRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OnenotePagePreviewImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<OnenotePagePreviewImpl>(requestInfo, createOnenotePagePreviewFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
