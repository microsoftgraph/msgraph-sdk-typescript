...
/** Builds and executes requests for operations under /groups/{group-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}  */
export class OnenoteSectionRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.groups.item.onenote.notebooks.item.sections.item.pages.item collection
