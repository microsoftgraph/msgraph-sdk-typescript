...
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.onenote.notebooks.item.sections.item.parentSectionGroup.sectionGroups.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.onenote.notebooks.item.sections.item.parentSectionGroup.sections.item collection
     * @param id Unique identifier of the item
