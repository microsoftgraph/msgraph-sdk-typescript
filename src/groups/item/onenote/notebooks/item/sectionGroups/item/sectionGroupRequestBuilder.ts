...
import {SectionGroupRequestBuilder as i09341bd731da804cd85e40241919ef4c4704bcc3dab360211874457a0426e645} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : i09341bd731da804cd85e40241919ef4c4704bcc3dab360211874457a0426e645 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup_id1"] = id
        return new i09341bd731da804cd85e40241919ef4c4704bcc3dab360211874457a0426e645(urlTplParams, this.requestAdapter);
    };
    /**
