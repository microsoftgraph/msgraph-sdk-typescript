...
export class NotebookItemRequestBuilder extends BaseRequestBuilder<NotebookItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}{?%24select,%24expand}", (x, y) => new NotebookItemRequestBuilder(x, y));
    }
    /**
