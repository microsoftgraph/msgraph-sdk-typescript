...
export class OperationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as OperationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as OperationsResponse).value = n.getCollectionOfObjectValues<OnenoteOperation>(OnenoteOperation); }],
        ]);
    };
    /**
