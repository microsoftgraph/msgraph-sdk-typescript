...
export class GroupSettingItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: GroupSettingItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
