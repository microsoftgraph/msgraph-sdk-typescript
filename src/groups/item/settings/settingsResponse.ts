...
export class SettingsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SettingsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SettingsResponse).value = n.getCollectionOfObjectValues<GroupSetting>(GroupSetting); }],
        ]);
    };
    /**
