...
export class TransitiveMembersRequestBuilder {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TransitiveMembersResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<TransitiveMembersResponse>(requestInfo, TransitiveMembersResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
