...
import { type GraphDeviceRequestBuilderGetRequestConfiguration } from './graphDeviceRequestBuilderGetRequestConfiguration';
...
export class GraphDeviceRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
