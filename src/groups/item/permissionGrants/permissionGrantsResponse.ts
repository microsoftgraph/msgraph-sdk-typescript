...
export class PermissionGrantsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as PermissionGrantsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as PermissionGrantsResponse).value = n.getCollectionOfObjectValues<ResourceSpecificPermissionGrant>(ResourceSpecificPermissionGrant); }],
        ]);
    };
    /**
