...
export class BaseRequestBuilderEscaped extends BaseRequestBuilder<BaseRequestBuilderEscaped> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/base{?%24select,%24expand}", (x, y) => new BaseRequestBuilderEscaped(x, y));
    }
    /**
