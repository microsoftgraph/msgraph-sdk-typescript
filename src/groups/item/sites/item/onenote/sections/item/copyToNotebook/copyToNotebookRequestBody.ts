...
export class CopyToNotebookRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "groupId": (o, n) => { (o as unknown as CopyToNotebookRequestBody).groupId = n.getStringValue(); },
            "id": (o, n) => { (o as unknown as CopyToNotebookRequestBody).id = n.getStringValue(); },
            "renameAs": (o, n) => { (o as unknown as CopyToNotebookRequestBody).renameAs = n.getStringValue(); },
            "siteCollectionId": (o, n) => { (o as unknown as CopyToNotebookRequestBody).siteCollectionId = n.getStringValue(); },
            "siteId": (o, n) => { (o as unknown as CopyToNotebookRequestBody).siteId = n.getStringValue(); },
        };
    };
    /**
