...
export class CopyToNotebookRequestBuilder extends BaseRequestBuilder<CopyToNotebookRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/copyToNotebook", (x, y) => new CopyToNotebookRequestBuilder(x, y));
    }
    /**
