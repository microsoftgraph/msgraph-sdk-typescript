...
export class ContentRequestBuilder extends BaseRequestBuilder<ContentRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/resources/{onenoteResource%2Did}/content", (x, y) => new ContentRequestBuilder(x, y));
    }
    /**
     * The content stream
