...
import { createOnenoteResourceCollectionResponseFromDiscriminatorValue, createOnenoteResourceFromDiscriminatorValue, deserializeIntoOnenoteResource, serializeOnenoteResource, type OnenoteResource, type OnenoteResourceCollectionResponse } from '../../../../../../models/';
...
export class ResourcesRequestBuilder extends BaseRequestBuilder<ResourcesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/resources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ResourcesRequestBuilder(x, y));
    }
    /**
