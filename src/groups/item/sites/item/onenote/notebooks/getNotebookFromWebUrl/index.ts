...
import { deserializeIntoGetNotebookFromWebUrlPostRequestBody, serializeGetNotebookFromWebUrlPostRequestBody, type GetNotebookFromWebUrlPostRequestBody } from './';
...
export class GetNotebookFromWebUrlRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/getNotebookFromWebUrl");
    };
    /**
