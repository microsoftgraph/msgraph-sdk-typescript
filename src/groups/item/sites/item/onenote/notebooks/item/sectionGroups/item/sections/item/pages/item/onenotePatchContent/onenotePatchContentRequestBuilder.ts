...
import { deserializeIntoOnenotePatchContentPostRequestBody, serializeOnenotePatchContentPostRequestBody, type OnenotePatchContentPostRequestBody } from './onenotePatchContentPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface OnenotePatchContentRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
