...
export class CopyToSectionGroupRequestBuilder extends BaseRequestBuilder<CopyToSectionGroupRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/copyToSectionGroup", (x, y) => new CopyToSectionGroupRequestBuilder(x, y));
    }
    /**
