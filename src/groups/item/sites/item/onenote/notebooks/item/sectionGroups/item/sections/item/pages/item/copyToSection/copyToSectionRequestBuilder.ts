...
export class CopyToSectionRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: CopyToSectionRequestBody | undefined, requestConfiguration?: CopyToSectionRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new CopyToSectionRequestBodyImpl(body)
     ...
     */
    public post(body: CopyToSectionRequestBody | undefined, requestConfiguration?: CopyToSectionRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OnenoteOperation | undefined> {
        if(!body) throw new Error("body cannot be undefined");
