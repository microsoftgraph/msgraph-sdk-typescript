...
export class OnenoteSectionItemRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.groups.item.sites.item.onenote.notebooks.item.sections.item.pages.item collection
