...
import {TermItemRequestBuilder as I025e2d06d22a53b8598ce30292049aa34b9a771841e8dffda59dedc8366f2760} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public childrenById(id: string) : I025e2d06d22a53b8598ce30292049aa34b9a771841e8dffda59dedc8366f2760 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new I025e2d06d22a53b8598ce30292049aa34b9a771841e8dffda59dedc8366f2760(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}{?%24select,%24expand}");
    };
    /**
     ...
     */
    public delete(requestConfiguration?: TermItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
