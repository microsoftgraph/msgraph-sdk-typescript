...
export class StoreItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: StoreItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
