...
export class ListsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Get the collection of [lists][] for a [site][]. Lists with the [system][] facet are hidden by default.To list them, include system in your $select statement. This API is supported in the following national cloud deployments.
    ...
    /**
     * Create a new list][] in a [site][]. This API is supported in the following [national cloud deployments.
     ...
     */
    public post(body: List, requestConfiguration?: ListsRequestBuilderPostRequestConfiguration | undefined) : Promise<List | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: List, requestConfiguration?: ListsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
