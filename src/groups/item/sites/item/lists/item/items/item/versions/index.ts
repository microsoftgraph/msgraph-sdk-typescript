...
import { createListItemVersionCollectionResponseFromDiscriminatorValue, createListItemVersionFromDiscriminatorValue, deserializeIntoListItemVersion, serializeListItemVersion, type ListItemVersion, type ListItemVersionCollectionResponse } from '../../../../../../../../../models/';
...
export class VersionsRequestBuilder extends BaseRequestBuilder<VersionsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new VersionsRequestBuilder(x, y));
    }
    /**
