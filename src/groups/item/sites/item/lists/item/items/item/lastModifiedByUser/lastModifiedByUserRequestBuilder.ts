...
import { type LastModifiedByUserRequestBuilderGetRequestConfiguration } from './lastModifiedByUserRequestBuilderGetRequestConfiguration';
...
export class LastModifiedByUserRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/lastModifiedByUser{?%24select,%24expand}");
    };
    /**
     ...
     */
    public get(requestConfiguration?: LastModifiedByUserRequestBuilderGetRequestConfiguration | undefined) : Promise<User | undefined> {
