...
export interface ColumnPositionsRequestBuilderGetRequestConfiguration {
     ...
     */
    queryParameters?: ColumnPositionsRequestBuilderGetQueryParameters;
}
/**
...
export class ColumnPositionsRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columnPositions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
     ...
     * @returns a columnPositionsRequestBuilder
     */
    public withUrl(rawUrl: string) : ColumnPositionsRequestBuilder {
