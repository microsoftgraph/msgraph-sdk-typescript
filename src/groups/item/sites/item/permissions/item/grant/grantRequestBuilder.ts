...
export class GrantRequestBuilder {
    ...
    public post(body: GrantPostRequestBody | undefined, requestConfiguration?: GrantRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GrantResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GrantResponseImpl>(requestInfo, createGrantResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
