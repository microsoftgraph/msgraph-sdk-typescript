...
import { type ExternalColumnsRequestBuilderGetRequestConfiguration } from './externalColumnsRequestBuilderGetRequestConfiguration';
...
export class ExternalColumnsRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a externalColumnsRequestBuilder
     */
    public withUrl(rawUrl: string) : ExternalColumnsRequestBuilder {
