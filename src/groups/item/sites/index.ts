...
import { GetAllSitesRequestBuilder } from './getAllSites/';
import { SiteItemRequestBuilder } from './item/';
import { RemoveRequestBuilder } from './remove/';
...
export class SitesRequestBuilder extends BaseRequestBuilder<SitesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SitesRequestBuilder(x, y));
    }
    /**
