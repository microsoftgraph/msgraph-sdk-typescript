 ...
 */
export class RemoveRequestBuilder extends BaseRequestBuilder<RemoveRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/remove", (x, y) => new RemoveRequestBuilder(x, y));
    }
    /**
