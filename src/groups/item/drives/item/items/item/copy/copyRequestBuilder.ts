...
export class CopyRequestBuilder {
     ...
     */
    public post(body: CopyPostRequestBody | undefined, requestConfiguration?: CopyRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DriveItemImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
