...
export class BucketsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as BucketsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as BucketsResponse).value = n.getCollectionOfObjectValues<PlannerBucket>(PlannerBucket); }],
        ]);
    };
    /**
