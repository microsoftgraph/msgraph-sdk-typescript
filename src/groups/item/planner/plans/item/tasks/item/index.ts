...
export class PlannerTaskItemRequestBuilder extends BaseRequestBuilder<PlannerTaskItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}", (x, y) => new PlannerTaskItemRequestBuilder(x, y));
    }
    /**
