...
export class PlannerPlanRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.planner.plans.item.buckets.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.item.planner.plans.item.tasks.item collection
     * @param id Unique identifier of the item
