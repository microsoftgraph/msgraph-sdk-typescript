...
export class GraphOrgContactRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}";
     ...
     */
    public get(requestConfiguration?: GraphOrgContactRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OrgContact | undefined> {
