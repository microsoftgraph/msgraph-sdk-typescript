...
export class PostItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.threads.item.posts.item.attachments.item collection
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: PostImpl | undefined, requestConfiguration?: PostItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
