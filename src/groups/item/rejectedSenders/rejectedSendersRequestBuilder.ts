 ...
 */
export class RejectedSendersRequestBuilder {
     ...
     */
    public createGetRequestInformation(requestConfiguration?: RejectedSendersRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
