 ...
 */
export class RejectedSendersRequestBuilder extends BaseRequestBuilder<RejectedSendersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/rejectedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", (x, y) => new RejectedSendersRequestBuilder(x, y));
    }
    /**
