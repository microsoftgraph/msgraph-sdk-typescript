...
import { type RenewRequestBuilderPostRequestConfiguration } from './renewRequestBuilderPostRequestConfiguration';
...
export class RenewRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a renewRequestBuilder
     */
    public withUrl(rawUrl: string) : RenewRequestBuilder {
