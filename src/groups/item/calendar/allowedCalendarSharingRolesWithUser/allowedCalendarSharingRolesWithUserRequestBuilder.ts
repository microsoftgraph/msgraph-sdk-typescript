...
export class AllowedCalendarSharingRolesWithUserRequestBuilder {
    ...
    public get(requestConfiguration?: AllowedCalendarSharingRolesWithUserRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AllowedCalendarSharingRolesWithUserResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AllowedCalendarSharingRolesWithUserResponseImpl>(requestInfo, createAllowedCalendarSharingRolesWithUserResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
