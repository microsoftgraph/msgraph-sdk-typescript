...
import {EventRequestBuilder as i88f966ad22fe3684a579870a5f9fc49363fa317efddb3c571d523c9a993220d5} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: String) : i88f966ad22fe3684a579870a5f9fc49363fa317efddb3c571d523c9a993220d5 {
        if(!id) throw new Error("id cannot be undefined");
        return new i88f966ad22fe3684a579870a5f9fc49363fa317efddb3c571d523c9a993220d5(this.currentPath + this.pathSegment + "/instances/" + id, this.httpCore, false);
    };
    /**
