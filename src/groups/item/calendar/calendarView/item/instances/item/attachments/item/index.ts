 ...
 */
export const AttachmentItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/attachments/{attachment%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
