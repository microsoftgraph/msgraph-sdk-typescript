...
export class SnoozeReminderRequestBuilder extends BaseRequestBuilder<SnoozeReminderRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/snoozeReminder", (x, y) => new SnoozeReminderRequestBuilder(x, y));
    }
    /**
