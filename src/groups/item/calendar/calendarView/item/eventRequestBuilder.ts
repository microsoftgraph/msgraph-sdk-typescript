...
import {EventRequestBuilder as i041123df21d06507fbeaa472e0c5396b928fd312198e328aea907f6028ef0bca} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: String) : i041123df21d06507fbeaa472e0c5396b928fd312198e328aea907f6028ef0bca {
        if(!id) throw new Error("id cannot be undefined");
        return new i041123df21d06507fbeaa472e0c5396b928fd312198e328aea907f6028ef0bca(this.currentPath + this.pathSegment + "/instances/" + id, this.httpCore, false);
    };
    /**
