...
export class TentativelyAcceptRequestBuilder extends BaseRequestBuilder<TentativelyAcceptRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/tentativelyAccept", (x, y) => new TentativelyAcceptRequestBuilder(x, y));
    }
    /**
