...
export class SharedWithChannelTeamInfoItemRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.groups.item.team.channels.item.sharedWithTeams.item.allowedMembers.item collection
