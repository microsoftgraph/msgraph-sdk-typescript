...
import {ChatMessageItemRequestBuilder as i814181103e77dcd868d0ce94633541207d936a1ef4fedff42bc264c8d72145a3} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.groups.item.team.channels.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.groups.item.team.channels.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
     * @returns a chatMessageItemRequestBuilder
     */
    public repliesById(id: string) : i814181103e77dcd868d0ce94633541207d936a1ef4fedff42bc264c8d72145a3 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage_id1"] = id
        return new i814181103e77dcd868d0ce94633541207d936a1ef4fedff42bc264c8d72145a3(urlTplParams, this.requestAdapter);
    };
}
