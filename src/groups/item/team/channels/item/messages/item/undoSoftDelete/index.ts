...
export class UndoSoftDeleteRequestBuilder extends BaseRequestBuilder<UndoSoftDeleteRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}/undoSoftDelete", (x, y) => new UndoSoftDeleteRequestBuilder(x, y));
    }
    /**
