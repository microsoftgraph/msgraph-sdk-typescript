...
import { type IncomingChannelsRequestBuilderGetRequestConfiguration } from './incomingChannelsRequestBuilderGetRequestConfiguration';
...
export class IncomingChannelsRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/team/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
     ...
     * @returns a incomingChannelsRequestBuilder
     */
    public withUrl(rawUrl: string) : IncomingChannelsRequestBuilder {
