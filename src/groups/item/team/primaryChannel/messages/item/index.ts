...
export class ChatMessageItemRequestBuilder extends BaseRequestBuilder<ChatMessageItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}{?%24select,%24expand}", (x, y) => new ChatMessageItemRequestBuilder(x, y));
    }
    /**
