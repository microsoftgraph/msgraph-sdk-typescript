...
import {ChatMessageItemRequestBuilder as ib4e39dc0dce9f2ebea1bb2c173b07c83d4788fec1086067378cefbf2b666999f} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.primaryChannel.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.primaryChannel.messages.item.replies.item collection
     * @param id Unique identifier of the item
     * @returns a chatMessageItemRequestBuilder
     */
    public repliesById(id: string) : ib4e39dc0dce9f2ebea1bb2c173b07c83d4788fec1086067378cefbf2b666999f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new ib4e39dc0dce9f2ebea1bb2c173b07c83d4788fec1086067378cefbf2b666999f(urlTplParams, this.requestAdapter);
    };
}
