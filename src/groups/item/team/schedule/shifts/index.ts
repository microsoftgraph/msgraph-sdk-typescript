...
import { createShiftCollectionResponseFromDiscriminatorValue, createShiftFromDiscriminatorValue, deserializeIntoShift, serializeShift, type Shift, type ShiftCollectionResponse } from '../../../../../models/';
 ...
 */
export class ShiftsRequestBuilder extends BaseRequestBuilder<ShiftsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/shifts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", (x, y) => new ShiftsRequestBuilder(x, y));
    }
    /**
