...
import { createSchedulingGroupCollectionResponseFromDiscriminatorValue, createSchedulingGroupFromDiscriminatorValue, deserializeIntoSchedulingGroup, serializeSchedulingGroup, type SchedulingGroup, type SchedulingGroupCollectionResponse } from '../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { SchedulingGroupItemRequestBuilder } from './item/';
 ...
 */
export class SchedulingGroupsRequestBuilder extends BaseRequestBuilder<SchedulingGroupsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/schedulingGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", (x, y) => new SchedulingGroupsRequestBuilder(x, y));
    }
    /**
