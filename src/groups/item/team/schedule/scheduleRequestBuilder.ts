...
export class ScheduleRequestBuilder {
    ...
    public createPatchRequestInformation(body: Schedule | undefined, requestConfiguration?: ScheduleRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new ScheduleImpl(body)
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.schedule.offerShiftRequests.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.schedule.openShiftChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.schedule.openShifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.schedule.schedulingGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.schedule.shifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.schedule.swapShiftsChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.schedule.timeOffReasons.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.schedule.timeOffRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.schedule.timesOff.item collection
     * @param id Unique identifier of the item
