...
import { ClonableTeamParts, TeamVisibilityType } from '../../../../models/';
...
export class CloneRequestBuilder extends BaseRequestBuilder<CloneRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/team/clone", (x, y) => new CloneRequestBuilder(x, y));
    }
    /**
