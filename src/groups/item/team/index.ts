...
import { createTeamFromDiscriminatorValue, deserializeIntoTeam, serializeTeam, type Team } from '../../../models/';
...
export class TeamRequestBuilder extends BaseRequestBuilder<TeamRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/team{?%24select,%24expand}", (x, y) => new TeamRequestBuilder(x, y));
    }
    /**
     ...
     * @returns a Promise of Team
     */
    public put(body: Team, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<Team | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPutRequestInformation(body: Team, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
