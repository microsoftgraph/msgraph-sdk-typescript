...
import { createTeamsAsyncOperationCollectionResponseFromDiscriminatorValue, createTeamsAsyncOperationFromDiscriminatorValue, deserializeIntoTeamsAsyncOperation, serializeTeamsAsyncOperation, type TeamsAsyncOperation, type TeamsAsyncOperationCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { TeamsAsyncOperationItemRequestBuilder } from './item/';
...
export class OperationsRequestBuilder extends BaseRequestBuilder<OperationsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/team/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new OperationsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<OperationsRequestBuilderGetQueryParameters> | undefined) : Promise<TeamsAsyncOperationCollectionResponse | undefined> {
     ...
     */
    public post(body: TeamsAsyncOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<TeamsAsyncOperation | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: TeamsAsyncOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
