...
export class TeamsAppInstallationItemRequestBuilder extends BaseRequestBuilder<TeamsAppInstallationItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groups/{group%2Did}/team/installedApps/{teamsAppInstallation%2Did}{?%24select,%24expand}", (x, y) => new TeamsAppInstallationItemRequestBuilder(x, y));
    }
    /**
