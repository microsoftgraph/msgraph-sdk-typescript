...
export class Microsoft.graph.declineResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as Microsoft.graph.declineResponse).comment = n.getStringValue(); }],
            ["proposedNewTime", (o, n) => { (o as unknown as Microsoft.graph.declineResponse).proposedNewTime = n.getObjectValue<TimeSlot>(TimeSlot); }],
            ["sendResponse", (o, n) => { (o as unknown as Microsoft.graph.declineResponse).sendResponse = n.getBooleanValue(); }],
        ]);
    };
    /**
