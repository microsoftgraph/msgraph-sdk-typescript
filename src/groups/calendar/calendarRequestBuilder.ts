...
import {AllowedCalendarSharingRolesWithUserRequestBuilder} from '../calendarView/calendar/allowedCalendarSharingRolesWithUser/allowedCalendarSharingRolesWithUserRequestBuilder';
...
export class CalendarRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.calendar.calendarPermissions collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.calendar.calendarView collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.calendar.events collection
     * @param id Unique identifier of the item
     * @returns a eventRequestBuilder
     */
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.calendar.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.calendar.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
