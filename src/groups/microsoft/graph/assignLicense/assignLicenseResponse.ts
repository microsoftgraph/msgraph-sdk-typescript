...
export class Microsoft.graph.assignLicenseResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["addLicenses", (o, n) => { (o as unknown as Microsoft.graph.assignLicenseResponse).addLicenses = n.getCollectionOfObjectValues<AssignedLicense>(AssignedLicense); }],
            ["removeLicenses", (o, n) => { (o as unknown as Microsoft.graph.assignLicenseResponse).removeLicenses = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
