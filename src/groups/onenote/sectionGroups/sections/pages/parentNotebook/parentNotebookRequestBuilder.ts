...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sectionGroups.sections.pages.parentNotebook.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sectionGroups.sections.pages.parentNotebook.sections collection
     * @param id Unique identifier of the item
