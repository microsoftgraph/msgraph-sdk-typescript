...
export class ParentSection extends OnenoteEntityHierarchyModel implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["isDefault", (o, n) => { (o as unknown as ParentSection).isDefault = n.getBooleanValue(); }],
            ["links", (o, n) => { (o as unknown as ParentSection).links = n.getObjectValue<SectionLinks>(SectionLinks); }],
            ["pages", (o, n) => { (o as unknown as ParentSection).pages = n.getCollectionOfObjectValues<OnenotePage>(OnenotePage); }],
            ["pagesUrl", (o, n) => { (o as unknown as ParentSection).pagesUrl = n.getStringValue(); }],
            ["parentNotebook", (o, n) => { (o as unknown as ParentSection).parentNotebook = n.getObjectValue<Notebook>(Notebook); }],
            ["parentSectionGroup", (o, n) => { (o as unknown as ParentSection).parentSectionGroup = n.getObjectValue<SectionGroup>(SectionGroup); }],
        ]);
    };
    /**
