...
export class NotebookRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: Notebook | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.notebooks.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.notebooks.sections collection
     * @param id Unique identifier of the item
