...
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sections.parentSectionGroup.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sections.parentSectionGroup.sections collection
     * @param id Unique identifier of the item
