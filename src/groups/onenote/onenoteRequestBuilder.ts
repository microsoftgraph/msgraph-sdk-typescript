...
export class OnenoteRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: Onenote | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.notebooks collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.operations collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.pages collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.resources collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sectionGroups collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sections collection
     * @param id Unique identifier of the item
