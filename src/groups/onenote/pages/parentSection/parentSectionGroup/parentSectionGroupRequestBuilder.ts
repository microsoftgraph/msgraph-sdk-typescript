...
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.onenote.pages.parentSection.parentSectionGroup.sectionGroups collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.onenote.pages.parentSection.parentSectionGroup.sections collection
     * @param id Unique identifier of the item
