...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.onenote.pages.parentSection.parentSectionGroup.parentNotebook.sectionGroups collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.groups.onenote.pages.parentSection.parentSectionGroup.parentNotebook.sections collection
     * @param id Unique identifier of the item
