...
export class Microsoft.graph.copyToSectionResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupId", (o, n) => { (o as unknown as Microsoft.graph.copyToSectionResponse).groupId = n.getStringValue(); }],
            ["id", (o, n) => { (o as unknown as Microsoft.graph.copyToSectionResponse).id = n.getStringValue(); }],
            ["siteCollectionId", (o, n) => { (o as unknown as Microsoft.graph.copyToSectionResponse).siteCollectionId = n.getStringValue(); }],
            ["siteId", (o, n) => { (o as unknown as Microsoft.graph.copyToSectionResponse).siteId = n.getStringValue(); }],
        ]);
    };
    /**
