...
export class Microsoft.graph.getUserIdsWithFlaggedAppRegistrationRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.getUserIdsWithFlaggedAppRegistrationRequestBuilder and sets the default values.
