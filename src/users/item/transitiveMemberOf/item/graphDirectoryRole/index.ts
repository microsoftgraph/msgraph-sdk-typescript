...
export class GraphDirectoryRoleRequestBuilder extends BaseRequestBuilder<GraphDirectoryRoleRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}/graph.directoryRole{?%24select,%24expand}", (x, y) => new GraphDirectoryRoleRequestBuilder(x, y));
    }
    /**
