...
import {MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration} from './microsoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the exportDeviceAndAppManagementData method.
 */
export class MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder {
     ...
     */
    public get(requestConfiguration?: MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceAndAppManagementData | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
