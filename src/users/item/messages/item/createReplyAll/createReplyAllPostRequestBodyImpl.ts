...
export class CreateReplyAllPostRequestBodyImpl implements CreateReplyAllPostRequestBody {
    ...
    public constructor(createReplyAllPostRequestBodyParameterValue?: CreateReplyAllPostRequestBody | undefined) {
        this._additionalData = createReplyAllPostRequestBodyParameterValue?.additionalData ? createReplyAllPostRequestBodyParameterValue?.additionalData! : {};
        this._comment = createReplyAllPostRequestBodyParameterValue?.comment;
        this._message = createReplyAllPostRequestBodyParameterValue?.message;
    };
    /**
