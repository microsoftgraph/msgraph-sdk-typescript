...
export class CreateReplyAllRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: CreateReplyAllRequestBody | undefined, requestConfiguration?: CreateReplyAllRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new CreateReplyAllRequestBodyImpl(body)
     ...
     */
    public post(body: CreateReplyAllRequestBody | undefined, requestConfiguration?: CreateReplyAllRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Message | undefined> {
        if(!body) throw new Error("body cannot be undefined");
