...
export class CreateReplyResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as CreateReplyResponse).comment = n.getStringValue(); }],
            ["message", (o, n) => { (o as unknown as CreateReplyResponse).message = n.getObjectValue<Message>(Message); }],
        ]);
    };
    /**
