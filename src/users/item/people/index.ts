...
import { PersonItemRequestBuilder } from './item/';
...
export class PeopleRequestBuilder extends BaseRequestBuilder<PeopleRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/people{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", (x, y) => new PeopleRequestBuilder(x, y));
    }
    /**
