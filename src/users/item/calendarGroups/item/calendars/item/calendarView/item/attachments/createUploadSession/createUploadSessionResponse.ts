import {AttachmentItem} from '../../../../../../../../../../models/microsoft/graph/attachmentItem';
...
export class CreateUploadSessionResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["attachmentItem", (o, n) => { (o as unknown as CreateUploadSessionResponse).attachmentItem = n.getObjectValue<AttachmentItem>(AttachmentItem); }],
        ]);
    };
    /**
