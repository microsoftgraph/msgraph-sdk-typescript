...
export class CalendarPermissionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as CalendarPermissionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as CalendarPermissionsResponse).value = n.getCollectionOfObjectValues<CalendarPermission>(CalendarPermission); }],
        ]);
    };
    /**
