...
export class GetScheduleRequestBuilder extends BaseRequestBuilder<GetScheduleRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/getSchedule", (x, y) => new GetScheduleRequestBuilder(x, y));
    }
    /**
