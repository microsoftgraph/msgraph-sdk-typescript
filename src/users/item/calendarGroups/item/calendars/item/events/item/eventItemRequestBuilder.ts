...
export class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.calendarGroups.item.calendars.item.events.item.attachments.item collection
     ...
     */
    public instancesById(id: string) : i7b81d2a371565806d5c36a0e009aad43e97145b9ceeafdf24ee78e0d595df6fb {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i7b81d2a371565806d5c36a0e009aad43e97145b9ceeafdf24ee78e0d595df6fb(urlTplParams, this.requestAdapter);
    };
    /**
     * Gets an item from the MicrosoftGraph.users.item.calendarGroups.item.calendars.item.events.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
