...
export class MasterCategoriesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as MasterCategoriesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as MasterCategoriesResponse).value = n.getCollectionOfObjectValues<OutlookCategory>(OutlookCategory); }],
        ]);
    };
    /**
