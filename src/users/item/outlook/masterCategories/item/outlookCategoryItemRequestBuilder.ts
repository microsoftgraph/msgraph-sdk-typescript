...
export class OutlookCategoryItemRequestBuilder {
    ...
    public createPatchRequestInformation(body: OutlookCategory | undefined, requestConfiguration?: OutlookCategoryItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new OutlookCategoryImpl(body)
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: OutlookCategoryImpl | undefined, requestConfiguration?: OutlookCategoryItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
