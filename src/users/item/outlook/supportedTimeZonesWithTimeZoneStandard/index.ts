 ...
 */
export class SupportedTimeZonesWithTimeZoneStandardRequestBuilder extends BaseRequestBuilder<SupportedTimeZonesWithTimeZoneStandardRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, timeZoneStandard?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/supportedTimeZones(TimeZoneStandard='{TimeZoneStandard}'){?%24top,%24skip,%24search,%24filter,%24count}", (x, y) => new SupportedTimeZonesWithTimeZoneStandardRequestBuilder(x, y));
