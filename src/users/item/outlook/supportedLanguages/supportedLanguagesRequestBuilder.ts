...
export class SupportedLanguagesRequestBuilder {
    ...
    public get(requestConfiguration?: SupportedLanguagesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SupportedLanguagesResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SupportedLanguagesResponseImpl>(requestInfo, createSupportedLanguagesResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
