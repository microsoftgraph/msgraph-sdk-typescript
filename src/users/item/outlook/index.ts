...
import { createOutlookUserFromDiscriminatorValue, type OutlookUser } from '../../../models/';
 ...
 */
export class OutlookRequestBuilder extends BaseRequestBuilder<OutlookRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/outlook{?%24select}", (x, y) => new OutlookRequestBuilder(x, y));
    }
    /**
