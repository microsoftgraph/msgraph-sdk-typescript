...
export class ManagedAppRegistrationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ManagedAppRegistrationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ManagedAppRegistrationsResponse).value = n.getCollectionOfObjectValues<ManagedAppRegistration>(ManagedAppRegistration); }],
        ]);
    };
    /**
