...
import { createUserActivityCollectionResponseFromDiscriminatorValue, createUserActivityFromDiscriminatorValue, deserializeIntoUserActivity, serializeUserActivity, type UserActivity, type UserActivityCollectionResponse } from '../../../models/';
...
export class ActivitiesRequestBuilder extends BaseRequestBuilder<ActivitiesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ActivitiesRequestBuilder(x, y));
    }
    /**
