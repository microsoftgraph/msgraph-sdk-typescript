...
import { createActivityHistoryItemFromDiscriminatorValue, deserializeIntoActivityHistoryItem, serializeActivityHistoryItem, type ActivityHistoryItem } from '../../../../../../models/';
 ...
 */
export class ActivityHistoryItemItemRequestBuilder extends BaseRequestBuilder<ActivityHistoryItemItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}/historyItems/{activityHistoryItem%2Did}{?%24select,%24expand}", (x, y) => new ActivityHistoryItemItemRequestBuilder(x, y));
    }
    /**
