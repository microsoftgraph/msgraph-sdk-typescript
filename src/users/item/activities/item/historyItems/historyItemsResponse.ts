...
export class HistoryItemsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as HistoryItemsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as HistoryItemsResponse).value = n.getCollectionOfObjectValues<ActivityHistoryItem>(ActivityHistoryItem); }],
        ]);
    };
    /**
