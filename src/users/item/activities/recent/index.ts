...
import { createUserActivityFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeUserActivity, type BaseCollectionPaginationCountResponse, type UserActivity } from '../../../../models/';
...
export class RecentRequestBuilder extends BaseRequestBuilder<RecentRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/activities/recent(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", (x, y) => new RecentRequestBuilder(x, y));
    }
    /**
