import {UserActivity, UserActivityCollectionResponse} from '../../../models/';
...
export class ActivitiesRequestBuilder {
     ...
     */
    public createGetRequestInformation(queryParameters?: ActivitiesRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: UserActivity | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public get(queryParameters?: ActivitiesRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserActivityCollectionResponse | undefined> {
     ...
     */
    public post(body: UserActivity | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserActivity | undefined> {
        if(!body) throw new Error("body cannot be undefined");
