 ...
 */
export class GetManagedDevicesWithAppFailuresRequestBuilder extends BaseRequestBuilder<GetManagedDevicesWithAppFailuresRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/getManagedDevicesWithAppFailures(){?%24top,%24skip,%24search,%24filter,%24count}", (x, y) => new GetManagedDevicesWithAppFailuresRequestBuilder(x, y));
    }
    /**
