...
import { type GraphApplicationRequestBuilderGetRequestConfiguration } from './graphApplicationRequestBuilderGetRequestConfiguration';
...
export class GraphApplicationRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/ownedObjects/graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
