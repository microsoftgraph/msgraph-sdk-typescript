...
export class MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, microsoftAuthenticatorAuthenticationMethodId?: string | undefined) {
