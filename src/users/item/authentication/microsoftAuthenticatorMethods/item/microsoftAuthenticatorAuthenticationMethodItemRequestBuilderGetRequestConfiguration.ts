import { type MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilderGetQueryParameters } from './microsoftAuthenticatorAuthenticationMethodItemRequestBuilderGetQueryParameters';
