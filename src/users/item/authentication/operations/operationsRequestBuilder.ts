import {LongRunningOperation, LongRunningOperationCollectionResponse} from '../../../../models/';
...
export class OperationsRequestBuilder {
    ...
    public get(requestConfiguration?: OperationsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<LongRunningOperationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<LongRunningOperationCollectionResponse>(requestInfo, createLongRunningOperationCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to operations for users
     * @param body 
