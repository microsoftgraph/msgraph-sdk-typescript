...
import { createLongRunningOperationCollectionResponseFromDiscriminatorValue, createLongRunningOperationFromDiscriminatorValue, deserializeIntoLongRunningOperation, serializeLongRunningOperation, type LongRunningOperation, type LongRunningOperationCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { LongRunningOperationItemRequestBuilder } from './item/';
...
export class OperationsRequestBuilder extends BaseRequestBuilder<OperationsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new OperationsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<OperationsRequestBuilderGetQueryParameters> | undefined) : Promise<LongRunningOperationCollectionResponse | undefined> {
     ...
     */
    public post(body: LongRunningOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<LongRunningOperation | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: LongRunningOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
