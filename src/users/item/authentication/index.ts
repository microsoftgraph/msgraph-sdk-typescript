...
import { createAuthenticationFromDiscriminatorValue, deserializeIntoAuthentication, serializeAuthentication, type Authentication } from '../../../models/';
 ...
 */
export class AuthenticationRequestBuilder extends BaseRequestBuilder<AuthenticationRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/authentication{?%24select,%24expand}", (x, y) => new AuthenticationRequestBuilder(x, y));
    }
    /**
