 ...
 */
export class EnableSmsSignInRequestBuilder extends BaseRequestBuilder<EnableSmsSignInRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/phoneMethods/{phoneAuthenticationMethod%2Did}/enableSmsSignIn", (x, y) => new EnableSmsSignInRequestBuilder(x, y));
    }
    /**
