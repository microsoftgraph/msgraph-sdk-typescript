...
import { createPhoneAuthenticationMethodCollectionResponseFromDiscriminatorValue, createPhoneAuthenticationMethodFromDiscriminatorValue, deserializeIntoPhoneAuthenticationMethod, serializePhoneAuthenticationMethod, type PhoneAuthenticationMethod, type PhoneAuthenticationMethodCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { PhoneAuthenticationMethodItemRequestBuilder } from './item/';
 ...
 */
export class PhoneMethodsRequestBuilder extends BaseRequestBuilder<PhoneMethodsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/phoneMethods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new PhoneMethodsRequestBuilder(x, y));
    }
    /**
