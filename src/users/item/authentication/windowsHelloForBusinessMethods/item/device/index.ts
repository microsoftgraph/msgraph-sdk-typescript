 ...
 */
export const DeviceRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
