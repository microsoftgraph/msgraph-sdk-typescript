import {ServicePrincipalCollectionResponseImpl} from '../../../../../../../../models/';
...
export class ServicePrincipalRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
     ...
     */
    public createGetRequestInformation(requestConfiguration?: ServicePrincipalRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public get(requestConfiguration?: ServicePrincipalRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ServicePrincipalCollectionResponseImpl | undefined> {
