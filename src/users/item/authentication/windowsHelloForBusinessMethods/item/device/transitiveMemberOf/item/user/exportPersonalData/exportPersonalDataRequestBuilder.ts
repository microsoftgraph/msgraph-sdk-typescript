...
export class ExportPersonalDataRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.exportPersonalData";
     ...
     */
    public createPostRequestInformation(body: ExportPersonalDataPostRequestBody | undefined, requestConfiguration?: ExportPersonalDataRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
