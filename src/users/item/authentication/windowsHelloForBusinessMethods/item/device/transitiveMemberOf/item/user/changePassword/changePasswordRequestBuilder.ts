...
export class ChangePasswordRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.changePassword";
     ...
     */
    public createPostRequestInformation(body: ChangePasswordPostRequestBody | undefined, requestConfiguration?: ChangePasswordRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
