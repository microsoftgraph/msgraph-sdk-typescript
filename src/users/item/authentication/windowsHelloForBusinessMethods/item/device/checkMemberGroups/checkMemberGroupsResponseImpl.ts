...
export class CheckMemberGroupsResponseImpl implements CheckMemberGroupsResponse {
    ...
    public constructor(checkMemberGroupsResponseParameterValue?: CheckMemberGroupsResponse | undefined) {
        this._additionalData = checkMemberGroupsResponseParameterValue?.additionalData ? checkMemberGroupsResponseParameterValue?.additionalData! : {};
        this._value = checkMemberGroupsResponseParameterValue?.value;
    };
    /**
