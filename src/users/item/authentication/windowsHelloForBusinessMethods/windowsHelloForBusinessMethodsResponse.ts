...
export class WindowsHelloForBusinessMethodsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as WindowsHelloForBusinessMethodsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as WindowsHelloForBusinessMethodsResponse).value = n.getCollectionOfObjectValues<WindowsHelloForBusinessAuthenticationMethod>(WindowsHelloForBusinessAuthenticationMethod); }],
        ]);
    };
    /**
