...
export class PasswordMethodsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: PasswordAuthenticationMethod | undefined, requestConfiguration?: PasswordMethodsRequestBuilderPostRequestConfiguration | undefined) : Promise<PasswordAuthenticationMethod | undefined> {
