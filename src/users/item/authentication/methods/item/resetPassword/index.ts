...
import { createPasswordResetResponseFromDiscriminatorValue, deserializeIntoPasswordResetResponse, serializePasswordResetResponse, type PasswordResetResponse } from '../../../../../../models/';
 ...
 */
export class ResetPasswordRequestBuilder extends BaseRequestBuilder<ResetPasswordRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/methods/{authenticationMethod%2Did}/resetPassword", (x, y) => new ResetPasswordRequestBuilder(x, y));
    }
    /**
