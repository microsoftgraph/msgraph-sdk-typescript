import {TemporaryAccessPassAuthenticationMethodCollectionResponseImpl, TemporaryAccessPassAuthenticationMethodImpl} from '../../../../models/';
...
export class TemporaryAccessPassMethodsRequestBuilder {
     ...
     */
    public get(requestConfiguration?: TemporaryAccessPassMethodsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TemporaryAccessPassAuthenticationMethodCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TemporaryAccessPassAuthenticationMethodCollectionResponseImpl>(requestInfo, createTemporaryAccessPassAuthenticationMethodCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to temporaryAccessPassMethods for users
     * @param body 
     ...
     */
    public post(body: TemporaryAccessPassAuthenticationMethod | undefined, requestConfiguration?: TemporaryAccessPassMethodsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TemporaryAccessPassAuthenticationMethodImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
