...
import { createSoftwareOathAuthenticationMethodCollectionResponseFromDiscriminatorValue, type SoftwareOathAuthenticationMethodCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { SoftwareOathAuthenticationMethodItemRequestBuilder } from './item/';
 ...
 */
export class SoftwareOathMethodsRequestBuilder extends BaseRequestBuilder<SoftwareOathMethodsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/softwareOathMethods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SoftwareOathMethodsRequestBuilder(x, y));
    }
    /**
