...
import { createSoftwareOathAuthenticationMethodFromDiscriminatorValue, type SoftwareOathAuthenticationMethod } from '../../../../../models/';
 ...
 */
export class SoftwareOathAuthenticationMethodItemRequestBuilder extends BaseRequestBuilder<SoftwareOathAuthenticationMethodItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/softwareOathMethods/{softwareOathAuthenticationMethod%2Did}{?%24select,%24expand}", (x, y) => new SoftwareOathAuthenticationMethodItemRequestBuilder(x, y));
    }
    /**
