...
export class AuthenticationRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.authentication.fido2Methods.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.authentication.methods.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.authentication.microsoftAuthenticatorMethods.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.authentication.windowsHelloForBusinessMethods.item collection
     * @param id Unique identifier of the item
