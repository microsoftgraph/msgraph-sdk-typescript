...
import {CalendarRequestBuilder as i1c37cbd3b6e1e317cf2c56ce96c05cb84e3223571cf9f8f71e8275a7adf58545} from './calendar/calendarRequestBuilder';
...
import {CalendarRequestBuilder as i43268436427f84798b52d19db0110f43280c2390e027654c1a87e0b7ae05454d} from './calendars/item/calendarRequestBuilder';
import {CalendarViewRequestBuilder} from './calendarView/calendarViewRequestBuilder';
import {EventRequestBuilder as i45411db7f9e2560e8d4aa618f9dfd53a35a23d59ecd301d9f4d92b144486f6a4} from './calendarView/item/eventRequestBuilder';
...
import {DriveRequestBuilder as i753e9c4e0899470af1b521f8272c3534a7334d235909425b3e9482f44fe13062} from './drive/driveRequestBuilder';
import {DrivesRequestBuilder} from './drives/drivesRequestBuilder';
import {DriveRequestBuilder as i5d6a51915a6122d3bceb8a2403a2b3e90a5ef3ad9c1ce6ecf266e0f7e26d1f70} from './drives/item/driveRequestBuilder';
import {EventsRequestBuilder} from './events/eventsRequestBuilder';
import {EventRequestBuilder as if20931266b1b33dc07828250101c5b223f1bc11eddb954de0b13a1250d0f7f08} from './events/item/eventRequestBuilder';
...
export class UserRequestBuilder {
    ...
    public get calendar(): i1c37cbd3b6e1e317cf2c56ce96c05cb84e3223571cf9f8f71e8275a7adf58545 {
        return new i1c37cbd3b6e1e317cf2c56ce96c05cb84e3223571cf9f8f71e8275a7adf58545(this.pathParameters, this.requestAdapter);
    }
    ...
    public get drive(): i753e9c4e0899470af1b521f8272c3534a7334d235909425b3e9482f44fe13062 {
        return new i753e9c4e0899470af1b521f8272c3534a7334d235909425b3e9482f44fe13062(this.pathParameters, this.requestAdapter);
    }
     ...
     */
    public calendarsById(id: string) : i43268436427f84798b52d19db0110f43280c2390e027654c1a87e0b7ae05454d {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("calendar_id", id);
        return new i43268436427f84798b52d19db0110f43280c2390e027654c1a87e0b7ae05454d(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     */
    public calendarViewById(id: string) : i45411db7f9e2560e8d4aa618f9dfd53a35a23d59ecd301d9f4d92b144486f6a4 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("event_id", id);
        return new i45411db7f9e2560e8d4aa618f9dfd53a35a23d59ecd301d9f4d92b144486f6a4(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     */
    public drivesById(id: string) : i5d6a51915a6122d3bceb8a2403a2b3e90a5ef3ad9c1ce6ecf266e0f7e26d1f70 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("drive_id", id);
        return new i5d6a51915a6122d3bceb8a2403a2b3e90a5ef3ad9c1ce6ecf266e0f7e26d1f70(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a eventRequestBuilder
     */
    public eventsById(id: string) : if20931266b1b33dc07828250101c5b223f1bc11eddb954de0b13a1250d0f7f08 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("event_id", id);
        return new if20931266b1b33dc07828250101c5b223f1bc11eddb954de0b13a1250d0f7f08(urlTplParams, this.requestAdapter);
    };
    /**
