...
export class ClearPresencePostRequestBodyImpl implements ClearPresencePostRequestBody {
    ...
    public constructor(clearPresencePostRequestBodyParameterValue?: ClearPresencePostRequestBody | undefined) {
        this._additionalData = clearPresencePostRequestBodyParameterValue?.additionalData ? clearPresencePostRequestBodyParameterValue?.additionalData! : {};
        this._sessionId = clearPresencePostRequestBodyParameterValue?.sessionId;
    };
    /**
