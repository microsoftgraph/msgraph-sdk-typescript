...
import {MicrosoftGraphFindMeetingTimesRequestBuilderPostRequestConfiguration} from './microsoftGraphFindMeetingTimesRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the findMeetingTimes method.
 */
export class MicrosoftGraphFindMeetingTimesRequestBuilder {
     ...
     */
    public post(body: FindMeetingTimesPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphFindMeetingTimesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<MeetingTimeSuggestionsResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: FindMeetingTimesPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphFindMeetingTimesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
