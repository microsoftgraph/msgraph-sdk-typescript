...
export class ChangePasswordResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _currentPassword?: string | undefined;
    private _newPassword?: string | undefined;
    /**
     * Instantiates a new changePasswordResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["currentPassword", (o, n) => { (o as unknown as ChangePasswordResponse).currentPassword = n.getStringValue(); }],
            ["newPassword", (o, n) => { (o as unknown as ChangePasswordResponse).newPassword = n.getStringValue(); }],
        ]);
    };
    /**
