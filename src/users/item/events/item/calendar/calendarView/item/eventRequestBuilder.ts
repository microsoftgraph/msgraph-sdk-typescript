...
/** Builds and executes requests for operations under /users/{user-id}/events/{event-id}/calendar/calendarView/{event-id1}  */
export class EventRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/events/{event_id}/calendar/calendarView/{event_id1}{?select}";
