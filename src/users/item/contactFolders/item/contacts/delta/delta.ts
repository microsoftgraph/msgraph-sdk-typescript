...
export class Delta extends OutlookItem implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["assistantName", (o, n) => { (o as unknown as Delta).assistantName = n.getStringValue(); }],
            ["birthday", (o, n) => { (o as unknown as Delta).birthday = n.getDateValue(); }],
            ["businessAddress", (o, n) => { (o as unknown as Delta).businessAddress = n.getObjectValue<PhysicalAddress>(PhysicalAddress); }],
            ["businessHomePage", (o, n) => { (o as unknown as Delta).businessHomePage = n.getStringValue(); }],
            ["businessPhones", (o, n) => { (o as unknown as Delta).businessPhones = n.getCollectionOfPrimitiveValues<string>(); }],
            ["children", (o, n) => { (o as unknown as Delta).children = n.getCollectionOfPrimitiveValues<string>(); }],
            ...
            ["givenName", (o, n) => { (o as unknown as Delta).givenName = n.getStringValue(); }],
            ["homeAddress", (o, n) => { (o as unknown as Delta).homeAddress = n.getObjectValue<PhysicalAddress>(PhysicalAddress); }],
            ["homePhones", (o, n) => { (o as unknown as Delta).homePhones = n.getCollectionOfPrimitiveValues<string>(); }],
            ["imAddresses", (o, n) => { (o as unknown as Delta).imAddresses = n.getCollectionOfPrimitiveValues<string>(); }],
            ["initials", (o, n) => { (o as unknown as Delta).initials = n.getStringValue(); }],
            ["jobTitle", (o, n) => { (o as unknown as Delta).jobTitle = n.getStringValue(); }],
            ["manager", (o, n) => { (o as unknown as Delta).manager = n.getStringValue(); }],
            ["middleName", (o, n) => { (o as unknown as Delta).middleName = n.getStringValue(); }],
            ["mobilePhone", (o, n) => { (o as unknown as Delta).mobilePhone = n.getStringValue(); }],
            ...
            ["nickName", (o, n) => { (o as unknown as Delta).nickName = n.getStringValue(); }],
            ["officeLocation", (o, n) => { (o as unknown as Delta).officeLocation = n.getStringValue(); }],
            ["otherAddress", (o, n) => { (o as unknown as Delta).otherAddress = n.getObjectValue<PhysicalAddress>(PhysicalAddress); }],
            ["parentFolderId", (o, n) => { (o as unknown as Delta).parentFolderId = n.getStringValue(); }],
            ["personalNotes", (o, n) => { (o as unknown as Delta).personalNotes = n.getStringValue(); }],
            ["photo", (o, n) => { (o as unknown as Delta).photo = n.getObjectValue<ProfilePhoto>(ProfilePhoto); }],
            ["profession", (o, n) => { (o as unknown as Delta).profession = n.getStringValue(); }],
            ...
            ["spouseName", (o, n) => { (o as unknown as Delta).spouseName = n.getStringValue(); }],
            ["surname", (o, n) => { (o as unknown as Delta).surname = n.getStringValue(); }],
            ["title", (o, n) => { (o as unknown as Delta).title = n.getStringValue(); }],
            ["yomiCompanyName", (o, n) => { (o as unknown as Delta).yomiCompanyName = n.getStringValue(); }],
            ["yomiGivenName", (o, n) => { (o as unknown as Delta).yomiGivenName = n.getStringValue(); }],
            ["yomiSurname", (o, n) => { (o as unknown as Delta).yomiSurname = n.getStringValue(); }],
        ]);
    };
    /**
