...
import {ContactFolderRequestBuilder as i64aa1550acecdfd20c5217591dc7d9d68d34f63b03e9d8238d6dbc72b68c5020} from './childFolders/item/contactFolderRequestBuilder';
...
export class ContactFolderRequestBuilder {
     ...
     */
    public childFoldersById(id: string) : i64aa1550acecdfd20c5217591dc7d9d68d34f63b03e9d8238d6dbc72b68c5020 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("contactFolder_id1", id);
        return new i64aa1550acecdfd20c5217591dc7d9d68d34f63b03e9d8238d6dbc72b68c5020(urlTplParams, this.requestAdapter);
    };
    /**
