...
export class ContactFolderRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.contactFolders.item.childFolders.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.contactFolders.item.contacts.item collection
     * @param id Unique identifier of the item
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: ContactFolder | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ContactFolder | undefined> {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.contactFolders.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: ContactFolder | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.contactFolders.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
