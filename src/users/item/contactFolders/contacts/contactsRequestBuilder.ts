...
export class ContactsRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: Contact | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    /**
     * Builds and executes requests for operations under /users/{user-id}/contactFolders/{contactFolder-id}/contacts/microsoft.graph.delta()
     ...
     */
    public post(body: Contact | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Contact | undefined> {
        if(!body) throw new Error("body cannot be undefined");
