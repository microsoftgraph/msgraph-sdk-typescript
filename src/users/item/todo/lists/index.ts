...
import { createTodoTaskListCollectionResponseFromDiscriminatorValue, createTodoTaskListFromDiscriminatorValue, deserializeIntoTodoTaskList, serializeTodoTaskList, type TodoTaskList, type TodoTaskListCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeltaRequestBuilder } from './delta/';
import { TodoTaskListItemRequestBuilder } from './item/';
...
export class ListsRequestBuilder extends BaseRequestBuilder<ListsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ListsRequestBuilder(x, y));
    }
    /**
