...
import { createAttachmentBaseCollectionResponseFromDiscriminatorValue, createAttachmentBaseFromDiscriminatorValue, deserializeIntoAttachmentBase, serializeAttachmentBase, type AttachmentBase, type AttachmentBaseCollectionResponse } from '../../../../../../../../models/';
...
import { AttachmentBaseItemRequestBuilder } from './item/';
...
export class AttachmentsRequestBuilder extends BaseRequestBuilder<AttachmentsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", (x, y) => new AttachmentsRequestBuilder(x, y));
    }
    /**
