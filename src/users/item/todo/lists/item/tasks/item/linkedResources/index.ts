...
import { createLinkedResourceCollectionResponseFromDiscriminatorValue, createLinkedResourceFromDiscriminatorValue, deserializeIntoLinkedResource, serializeLinkedResource, type LinkedResource, type LinkedResourceCollectionResponse } from '../../../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { LinkedResourceItemRequestBuilder } from './item/';
 ...
 */
export class LinkedResourcesRequestBuilder extends BaseRequestBuilder<LinkedResourcesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/linkedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new LinkedResourcesRequestBuilder(x, y));
    }
    /**
