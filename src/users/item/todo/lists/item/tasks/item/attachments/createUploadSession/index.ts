...
import { createAttachmentInfoFromDiscriminatorValue, createUploadSessionFromDiscriminatorValue, deserializeIntoUploadSession, serializeAttachmentInfo, serializeUploadSession, type AttachmentInfo, type UploadSession } from '../../../../../../../../../models/';
...
export class CreateUploadSessionRequestBuilder extends BaseRequestBuilder<CreateUploadSessionRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachments/createUploadSession", (x, y) => new CreateUploadSessionRequestBuilder(x, y));
    }
    /**
