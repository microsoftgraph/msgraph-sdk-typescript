...
import { createAttachmentBaseFromDiscriminatorValue, type AttachmentBase } from '../../../../../../../../../models/';
 ...
 */
export class AttachmentBaseItemRequestBuilder extends BaseRequestBuilder<AttachmentBaseItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachments/{attachmentBase%2Did}{?%24select}", (x, y) => new AttachmentBaseItemRequestBuilder(x, y));
    }
    /**
