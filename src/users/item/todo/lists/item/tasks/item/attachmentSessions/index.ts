...
import { createAttachmentSessionCollectionResponseFromDiscriminatorValue, type AttachmentSessionCollectionResponse } from '../../../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AttachmentSessionItemRequestBuilder } from './item/';
 ...
 */
export class AttachmentSessionsRequestBuilder extends BaseRequestBuilder<AttachmentSessionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachmentSessions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", (x, y) => new AttachmentSessionsRequestBuilder(x, y));
    }
    /**
