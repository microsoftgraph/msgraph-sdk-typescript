...
import { createChecklistItemCollectionResponseFromDiscriminatorValue, createChecklistItemFromDiscriminatorValue, deserializeIntoChecklistItem, serializeChecklistItem, type ChecklistItem, type ChecklistItemCollectionResponse } from '../../../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ChecklistItemItemRequestBuilder } from './item/';
 ...
 */
export class ChecklistItemsRequestBuilder extends BaseRequestBuilder<ChecklistItemsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/checklistItems{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ChecklistItemsRequestBuilder(x, y));
    }
    /**
