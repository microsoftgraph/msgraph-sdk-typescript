...
export class ReprocessLicenseAssignmentRequestBuilder {
     ...
     */
    public post(requestConfiguration?: ReprocessLicenseAssignmentRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<User | ReprocessLicenseAssignmentResponseMember1 | undefined> {
        ...
        return this.requestAdapter?.sendAsync<User | ReprocessLicenseAssignmentResponseMember1>(requestInfo, createUser | ReprocessLicenseAssignmentResponseMember1FromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
