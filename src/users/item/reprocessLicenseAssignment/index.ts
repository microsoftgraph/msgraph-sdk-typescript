 ...
 */
export class ReprocessLicenseAssignmentRequestBuilder extends BaseRequestBuilder<ReprocessLicenseAssignmentRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/reprocessLicenseAssignment", (x, y) => new ReprocessLicenseAssignmentRequestBuilder(x, y));
    }
    /**
