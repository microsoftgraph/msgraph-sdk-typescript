 ...
 */
export class ExportDeviceAndAppManagementDataRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/microsoft.graph.exportDeviceAndAppManagementData()";
     ...
     */
    public get(requestConfiguration?: ExportDeviceAndAppManagementDataRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceAndAppManagementData | undefined> {
