 ...
 */
export class RemoveAllDevicesFromManagementRequestBuilder extends BaseRequestBuilder<RemoveAllDevicesFromManagementRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/removeAllDevicesFromManagement", (x, y) => new RemoveAllDevicesFromManagementRequestBuilder(x, y));
    }
    /**
