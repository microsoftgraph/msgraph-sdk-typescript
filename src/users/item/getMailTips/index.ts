...
import { createMailTipsFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeMailTips, type BaseCollectionPaginationCountResponse, type MailTips } from '../../../models/';
...
export function deserializeIntoGetMailTipsPostRequestBody(getMailTipsPostRequestBody: GetMailTipsPostRequestBody | undefined = {} as GetMailTipsPostRequestBody) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "mailTipsOptions": n => { getMailTipsPostRequestBody.mailTipsOptions = n.getEnumValue<GetMailTipsPostRequestBody_MailTipsOptions>(GetMailTipsPostRequestBody_MailTipsOptionsObject); },
    }
}
...
export interface GetMailTipsPostRequestBody extends AdditionalDataHolder, Parsable {
     ...
     */
    mailTipsOptions?: GetMailTipsPostRequestBody_MailTipsOptions;
}
...
export function serializeGetMailTipsPostRequestBody(writer: SerializationWriter, getMailTipsPostRequestBody: GetMailTipsPostRequestBody | undefined = {} as GetMailTipsPostRequestBody) : void {
    ...
    writer.writeEnumValue<GetMailTipsPostRequestBody_MailTipsOptions>("MailTipsOptions", getMailTipsPostRequestBody.mailTipsOptions);
