...
import { createEventFromDiscriminatorValue, serializeEvent, type Event } from '../../../../../models/';
 ...
 */
export const EventItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
