...
export class ListRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.list.columns.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.list.contentTypes.item collection
     * @param id Unique identifier of the item
    ...
    public createPatchRequestInformation(body: List | undefined, requestConfiguration?: ListRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new ListImpl(body)
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.list.items.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.list.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.list.subscriptions.item collection
     * @param id Unique identifier of the item
