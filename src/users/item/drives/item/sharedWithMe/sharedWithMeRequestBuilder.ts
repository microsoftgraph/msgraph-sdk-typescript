...
export class SharedWithMeRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/microsoft.graph.sharedWithMe()";
    ...
    public get(requestConfiguration?: SharedWithMeRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SharedWithMeResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SharedWithMeResponseImpl>(requestInfo, createSharedWithMeResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
