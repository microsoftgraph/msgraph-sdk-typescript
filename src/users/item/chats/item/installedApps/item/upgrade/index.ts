...
export class UpgradeRequestBuilder extends BaseRequestBuilder<UpgradeRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/installedApps/{teamsAppInstallation%2Did}/upgrade", (x, y) => new UpgradeRequestBuilder(x, y));
    }
    /**
