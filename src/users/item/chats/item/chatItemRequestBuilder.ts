...
export class ChatItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.chats.item.installedApps.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.chats.item.members.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.chats.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.chats.item.tabs.item collection
     * @param id Unique identifier of the item
