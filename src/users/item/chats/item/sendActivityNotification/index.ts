...
export class SendActivityNotificationRequestBuilder extends BaseRequestBuilder<SendActivityNotificationRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/sendActivityNotification", (x, y) => new SendActivityNotificationRequestBuilder(x, y));
    }
    /**
