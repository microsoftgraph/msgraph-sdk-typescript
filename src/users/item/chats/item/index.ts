...
import { createChatFromDiscriminatorValue, serializeChat, type Chat } from '../../../../models/';
 ...
 */
export const ChatItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
