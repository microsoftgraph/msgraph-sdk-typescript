...
export class JoinedTeamsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as JoinedTeamsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as JoinedTeamsResponse).value = n.getCollectionOfObjectValues<Team>(Team); }],
        ]);
    };
    /**
