...
import {MicrosoftGraphCloneRequestBuilderPostRequestConfiguration} from './microsoftGraphCloneRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the clone method.
 */
export class MicrosoftGraphCloneRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/microsoft.graph.clone";
     ...
     */
    public post(body: ClonePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphCloneRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: ClonePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphCloneRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
