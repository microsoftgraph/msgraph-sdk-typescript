...
export class ChannelItemRequestBuilder extends BaseRequestBuilder<ChannelItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}{?%24select,%24expand}", (x, y) => new ChannelItemRequestBuilder(x, y));
    }
    /**
     * Delete the channel.
