...
import {ConversationMemberCollectionResponse} from '../../../../../../../models/microsoft/graph/conversationMemberCollectionResponse';
...
export class MembersRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/channels/{channel_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: ConversationMember | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ConversationMemberCollectionResponse | undefined> {
     ...
     */
    public post(body: ConversationMember | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ConversationMember | undefined> {
        if(!body) throw new Error("body cannot be undefined");
