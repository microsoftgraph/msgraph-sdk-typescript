...
import { createSharedWithChannelTeamInfoCollectionResponseFromDiscriminatorValue, createSharedWithChannelTeamInfoFromDiscriminatorValue, deserializeIntoSharedWithChannelTeamInfo, serializeSharedWithChannelTeamInfo, type SharedWithChannelTeamInfo, type SharedWithChannelTeamInfoCollectionResponse } from '../../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { SharedWithChannelTeamInfoItemRequestBuilder } from './item/';
 ...
 */
export class SharedWithTeamsRequestBuilder extends BaseRequestBuilder<SharedWithTeamsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SharedWithTeamsRequestBuilder(x, y));
    }
    /**
