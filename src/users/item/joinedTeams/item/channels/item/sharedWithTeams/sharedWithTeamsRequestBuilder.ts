import {SharedWithChannelTeamInfoCollectionResponseImpl, SharedWithChannelTeamInfoImpl} from '../../../../../../../models/';
...
export class SharedWithTeamsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
    ...
    public createPostRequestInformation(body: SharedWithChannelTeamInfo | undefined, requestConfiguration?: SharedWithTeamsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new SharedWithChannelTeamInfoImpl(body)
     ...
     */
    public get(requestConfiguration?: SharedWithTeamsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SharedWithChannelTeamInfoCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SharedWithChannelTeamInfoCollectionResponseImpl>(requestInfo, createSharedWithChannelTeamInfoCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to sharedWithTeams for users
     * @param body 
     ...
     */
    public post(body: SharedWithChannelTeamInfo | undefined, requestConfiguration?: SharedWithTeamsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SharedWithChannelTeamInfoImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        ...
        return this.requestAdapter?.sendAsync<SharedWithChannelTeamInfoImpl>(requestInfo, createSharedWithChannelTeamInfoFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
