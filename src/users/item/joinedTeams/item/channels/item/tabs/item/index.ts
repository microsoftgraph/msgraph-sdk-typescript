...
export class TeamsTabItemRequestBuilder extends BaseRequestBuilder<TeamsTabItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/tabs/{teamsTab%2Did}{?%24select,%24expand}", (x, y) => new TeamsTabItemRequestBuilder(x, y));
    }
    /**
