...
export class CloneRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: ClonePostRequestBody | undefined, requestConfiguration?: CloneRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
