...
import { createShiftFromDiscriminatorValue, deserializeIntoShift, serializeShift, type Shift } from '../../../../../../../models/';
 ...
 */
export class ShiftItemRequestBuilder extends BaseRequestBuilder<ShiftItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/shifts/{shift%2Did}{?%24select}", (x, y) => new ShiftItemRequestBuilder(x, y));
    }
    /**
