...
import { createOfferShiftRequestCollectionResponseFromDiscriminatorValue, createOfferShiftRequestFromDiscriminatorValue, deserializeIntoOfferShiftRequest, serializeOfferShiftRequest, type OfferShiftRequest, type OfferShiftRequestCollectionResponse } from '../../../../../../models/';
 ...
 */
export class OfferShiftRequestsRequestBuilder extends BaseRequestBuilder<OfferShiftRequestsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/offerShiftRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new OfferShiftRequestsRequestBuilder(x, y));
    }
    /**
