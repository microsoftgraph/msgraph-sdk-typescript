...
import { createOpenShiftChangeRequestCollectionResponseFromDiscriminatorValue, createOpenShiftChangeRequestFromDiscriminatorValue, deserializeIntoOpenShiftChangeRequest, serializeOpenShiftChangeRequest, type OpenShiftChangeRequest, type OpenShiftChangeRequestCollectionResponse } from '../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { OpenShiftChangeRequestItemRequestBuilder } from './item/';
 ...
 */
export class OpenShiftChangeRequestsRequestBuilder extends BaseRequestBuilder<OpenShiftChangeRequestsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/openShiftChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new OpenShiftChangeRequestsRequestBuilder(x, y));
    }
    /**
