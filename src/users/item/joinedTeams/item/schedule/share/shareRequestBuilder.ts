...
export class ShareRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: SharePostRequestBody | undefined, requestConfiguration?: ShareRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
