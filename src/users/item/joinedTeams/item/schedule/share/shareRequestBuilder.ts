...
import { deserializeIntoSharePostRequestBody, serializeSharePostRequestBody, type SharePostRequestBody } from './sharePostRequestBody';
...
export class ShareRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SharePostRequestBody, requestConfiguration?: ShareRequestBuilderPostRequestConfiguration | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: SharePostRequestBody, requestConfiguration?: ShareRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
