...
import { createSwapShiftsChangeRequestCollectionResponseFromDiscriminatorValue, createSwapShiftsChangeRequestFromDiscriminatorValue, deserializeIntoSwapShiftsChangeRequest, serializeSwapShiftsChangeRequest, type SwapShiftsChangeRequest, type SwapShiftsChangeRequestCollectionResponse } from '../../../../../../models/';
 ...
 */
export class SwapShiftsChangeRequestsRequestBuilder extends BaseRequestBuilder<SwapShiftsChangeRequestsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/swapShiftsChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SwapShiftsChangeRequestsRequestBuilder(x, y));
    }
    /**
