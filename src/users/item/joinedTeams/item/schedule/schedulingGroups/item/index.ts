...
export class SchedulingGroupItemRequestBuilder extends BaseRequestBuilder<SchedulingGroupItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/schedulingGroups/{schedulingGroup%2Did}{?%24select}", (x, y) => new SchedulingGroupItemRequestBuilder(x, y));
    }
    /**
