...
import {SchedulingGroupCollectionResponse} from '../../../../../../models/microsoft/graph/schedulingGroupCollectionResponse';
...
export class SchedulingGroupsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/schedule/schedulingGroups{?top,skip,search,filter,count,orderby,select}";
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SchedulingGroupCollectionResponse | undefined> {
