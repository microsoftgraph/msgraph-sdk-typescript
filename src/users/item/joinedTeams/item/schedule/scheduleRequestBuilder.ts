...
import {MicrosoftGraphShareRequestBuilder} from './microsoftGraphShare/microsoftGraphShareRequestBuilder';
...
export class ScheduleRequestBuilder {
    ...
    public get microsoftGraphShare(): MicrosoftGraphShareRequestBuilder {
