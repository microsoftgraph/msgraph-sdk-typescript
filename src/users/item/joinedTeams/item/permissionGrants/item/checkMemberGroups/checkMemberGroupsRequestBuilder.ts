...
import { createCheckMemberGroupsResponseFromDiscriminatorValue, deserializeIntoCheckMemberGroupsResponse, serializeCheckMemberGroupsResponse, type CheckMemberGroupsResponse } from './checkMemberGroupsResponse';
...
export class CheckMemberGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/checkMemberGroups");
    };
    /**
