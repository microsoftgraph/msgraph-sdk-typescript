...
export class CompleteMigrationRequestBuilder extends BaseRequestBuilder<CompleteMigrationRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/completeMigration", (x, y) => new CompleteMigrationRequestBuilder(x, y));
    }
    /**
