...
export class PrimaryChannelRequestBuilder extends BaseRequestBuilder<PrimaryChannelRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel{?%24select,%24expand}", (x, y) => new PrimaryChannelRequestBuilder(x, y));
    }
    /**
