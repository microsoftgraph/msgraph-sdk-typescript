...
export class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.users.item.joinedTeams.item.primaryChannel.messages.item.replies.item.hostedContents.item collection
