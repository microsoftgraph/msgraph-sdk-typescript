...
import {TeamsAppInstallationCollectionResponse} from '../../../../../models/microsoft/graph/teamsAppInstallationCollectionResponse';
...
export class InstalledAppsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/installedApps{?top,skip,search,filter,count,orderby,select,expand}";
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: TeamsAppInstallation | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TeamsAppInstallationCollectionResponse | undefined> {
     ...
     */
    public post(body: TeamsAppInstallation | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TeamsAppInstallation | undefined> {
        if(!body) throw new Error("body cannot be undefined");
