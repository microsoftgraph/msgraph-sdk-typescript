 ...
 */
export class TeamItemRequestBuilder extends BaseRequestBuilder<TeamItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}{?%24select,%24expand}", (x, y) => new TeamItemRequestBuilder(x, y));
    }
    /**
