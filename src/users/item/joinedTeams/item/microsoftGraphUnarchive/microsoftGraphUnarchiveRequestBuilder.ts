...
export class MicrosoftGraphUnarchiveRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/microsoft.graph.unarchive";
     ...
     */
    public post(requestConfiguration?: MicrosoftGraphUnarchiveRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(requestConfiguration?: MicrosoftGraphUnarchiveRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
