...
export class GetAllMessagesRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/microsoft.graph.getAllMessages()";
    ...
    public get(requestConfiguration?: GetAllMessagesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetAllMessagesResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetAllMessagesResponseImpl>(requestInfo, createGetAllMessagesResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
