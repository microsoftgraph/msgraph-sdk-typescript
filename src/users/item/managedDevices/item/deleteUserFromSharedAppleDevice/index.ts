...
export class DeleteUserFromSharedAppleDeviceRequestBuilder extends BaseRequestBuilder<DeleteUserFromSharedAppleDeviceRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deleteUserFromSharedAppleDevice", (x, y) => new DeleteUserFromSharedAppleDeviceRequestBuilder(x, y));
    }
    /**
