...
import { type RequestRemoteAssistanceRequestBuilderPostRequestConfiguration } from './requestRemoteAssistanceRequestBuilderPostRequestConfiguration';
...
export class RequestRemoteAssistanceRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/requestRemoteAssistance");
    };
    /**
