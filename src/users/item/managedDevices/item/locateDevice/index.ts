 ...
 */
export class LocateDeviceRequestBuilder extends BaseRequestBuilder<LocateDeviceRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/locateDevice", (x, y) => new LocateDeviceRequestBuilder(x, y));
    }
    /**
     * Locate a device
