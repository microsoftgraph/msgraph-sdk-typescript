...
export class CreateDownloadUrlRequestBuilder extends BaseRequestBuilder<CreateDownloadUrlRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/logCollectionRequests/{deviceLogCollectionResponse%2Did}/createDownloadUrl", (x, y) => new CreateDownloadUrlRequestBuilder(x, y));
    }
    /**
