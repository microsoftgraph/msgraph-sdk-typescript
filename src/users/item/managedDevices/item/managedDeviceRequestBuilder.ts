...
export class ManagedDeviceRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.managedDevices.item.deviceCompliancePolicyStates.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.managedDevices.item.deviceConfigurationStates.item collection
     * @param id Unique identifier of the item
