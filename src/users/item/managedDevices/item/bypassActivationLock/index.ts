...
export class BypassActivationLockRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a bypassActivationLockRequestBuilder
     */
    public withUrl(rawUrl: string) : BypassActivationLockRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new BypassActivationLockRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
