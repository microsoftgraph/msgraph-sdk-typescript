...
export class DeviceCompliancePolicyStatesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceCompliancePolicyStatesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceCompliancePolicyStatesResponse).value = n.getCollectionOfObjectValues<DeviceCompliancePolicyState>(DeviceCompliancePolicyState); }],
        ]);
    };
    /**
