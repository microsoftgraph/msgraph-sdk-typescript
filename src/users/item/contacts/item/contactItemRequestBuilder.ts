...
export class ContactItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.contacts.item.extensions.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.contacts.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.contacts.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
