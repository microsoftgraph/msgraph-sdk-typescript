...
export class GetManagedAppPoliciesRequestBuilder {
    ...
    public get(requestConfiguration?: GetManagedAppPoliciesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetManagedAppPoliciesResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetManagedAppPoliciesResponseImpl>(requestInfo, createGetManagedAppPoliciesResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
