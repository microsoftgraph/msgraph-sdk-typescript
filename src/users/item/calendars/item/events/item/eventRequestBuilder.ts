...
import {EventRequestBuilder as idc0ebacf7211f22a018cfb7bfa7bcd64b02abc6325a5fd89cad0d634e02277b2} from './instances/item/eventRequestBuilder';
...
/** Builds and executes requests for operations under /users/{user-id}/calendars/{calendar-id}/events/{event-id}  */
export class EventRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.calendars.item.events.item.attachments.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.calendars.item.events.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.calendars.item.events.item.instances.item collection
     * @param id Unique identifier of the item
     * @returns a eventRequestBuilder
     */
    public instancesById(id: String) : idc0ebacf7211f22a018cfb7bfa7bcd64b02abc6325a5fd89cad0d634e02277b2 {
        if(!id) throw new Error("id cannot be undefined");
        return new idc0ebacf7211f22a018cfb7bfa7bcd64b02abc6325a5fd89cad0d634e02277b2(this.currentPath + this.pathSegment + "/instances/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.calendars.item.events.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.calendars.item.events.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
