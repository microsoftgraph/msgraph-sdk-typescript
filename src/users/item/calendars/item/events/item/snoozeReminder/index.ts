...
export class SnoozeReminderRequestBuilder extends BaseRequestBuilder<SnoozeReminderRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/snoozeReminder", (x, y) => new SnoozeReminderRequestBuilder(x, y));
    }
    /**
