...
import {EventRequestBuilder as ib045d32f12da94cf2d8547dfbd0448843483ea0829e1439a109bbcf7eb61598c} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : ib045d32f12da94cf2d8547dfbd0448843483ea0829e1439a109bbcf7eb61598c {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("event_id1", id);
        return new ib045d32f12da94cf2d8547dfbd0448843483ea0829e1439a109bbcf7eb61598c(urlTplParams, this.requestAdapter);
    };
    /**
