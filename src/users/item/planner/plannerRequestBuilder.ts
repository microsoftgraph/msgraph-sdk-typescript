...
export class PlannerRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.planner.plans.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.planner.tasks.item collection
     * @param id Unique identifier of the item
