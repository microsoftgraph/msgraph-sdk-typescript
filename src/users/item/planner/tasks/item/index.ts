...
export class PlannerTaskItemRequestBuilder extends BaseRequestBuilder<PlannerTaskItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/planner/tasks/{plannerTask%2Did}{?%24select,%24expand}", (x, y) => new PlannerTaskItemRequestBuilder(x, y));
    }
    /**
