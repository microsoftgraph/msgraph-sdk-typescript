...
export class PlannerPlanItemRequestBuilder extends BaseRequestBuilder<PlannerPlanItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}{?%24select,%24expand}", (x, y) => new PlannerPlanItemRequestBuilder(x, y));
    }
    /**
