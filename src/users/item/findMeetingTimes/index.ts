...
import { createAttendeeBaseFromDiscriminatorValue, createLocationConstraintFromDiscriminatorValue, createMeetingTimeSuggestionsResultFromDiscriminatorValue, createTimeConstraintFromDiscriminatorValue, deserializeIntoMeetingTimeSuggestionsResult, serializeAttendeeBase, serializeLocationConstraint, serializeMeetingTimeSuggestionsResult, serializeTimeConstraint, type AttendeeBase, type LocationConstraint, type MeetingTimeSuggestionsResult, type TimeConstraint } from '../../../models/';
 ...
 */
export class FindMeetingTimesRequestBuilder extends BaseRequestBuilder<FindMeetingTimesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/findMeetingTimes", (x, y) => new FindMeetingTimesRequestBuilder(x, y));
    }
    /**
