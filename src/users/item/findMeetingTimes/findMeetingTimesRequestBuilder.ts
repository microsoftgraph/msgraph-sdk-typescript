...
export class FindMeetingTimesRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: FindMeetingTimesRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: FindMeetingTimesRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<MeetingTimeSuggestionsResult | undefined> {
        if(!body) throw new Error("body cannot be undefined");
