...
export class CopyToSectionGroupRequestBuilder extends BaseRequestBuilder<CopyToSectionGroupRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/copyToSectionGroup", (x, y) => new CopyToSectionGroupRequestBuilder(x, y));
    }
    /**
