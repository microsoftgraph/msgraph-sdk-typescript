...
export class SectionGroupsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/sectionGroups{?top,skip,search,filter,count,orderby,select,expand}";
