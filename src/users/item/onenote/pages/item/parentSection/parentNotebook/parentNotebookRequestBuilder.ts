...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.pages.item.parentSection.parentNotebook.sectionGroups.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.pages.item.parentSection.parentNotebook.sections.item collection
     * @param id Unique identifier of the item
