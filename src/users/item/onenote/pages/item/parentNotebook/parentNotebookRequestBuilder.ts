...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.users.item.onenote.pages.item.parentNotebook.sectionGroups.item collection
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.users.item.onenote.pages.item.parentNotebook.sections.item collection
     * @param id Unique identifier of the item
