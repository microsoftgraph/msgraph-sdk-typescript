...
export class OnenotePatchContentRequestBuilder extends BaseRequestBuilder<OnenotePatchContentRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/pages/{onenotePage%2Did}/onenotePatchContent", (x, y) => new OnenotePatchContentRequestBuilder(x, y));
    }
    /**
