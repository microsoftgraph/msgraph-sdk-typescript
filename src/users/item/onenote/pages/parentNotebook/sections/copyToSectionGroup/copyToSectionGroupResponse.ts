...
export class CopyToSectionGroupResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupId", (o, n) => { (o as unknown as CopyToSectionGroupResponse).groupId = n.getStringValue(); }],
            ["id", (o, n) => { (o as unknown as CopyToSectionGroupResponse).id = n.getStringValue(); }],
            ["renameAs", (o, n) => { (o as unknown as CopyToSectionGroupResponse).renameAs = n.getStringValue(); }],
            ["siteCollectionId", (o, n) => { (o as unknown as CopyToSectionGroupResponse).siteCollectionId = n.getStringValue(); }],
            ["siteId", (o, n) => { (o as unknown as CopyToSectionGroupResponse).siteId = n.getStringValue(); }],
        ]);
    };
    /**
