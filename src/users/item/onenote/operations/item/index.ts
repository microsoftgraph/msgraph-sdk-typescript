...
export class OnenoteOperationItemRequestBuilder extends BaseRequestBuilder<OnenoteOperationItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/operations/{onenoteOperation%2Did}{?%24select,%24expand}", (x, y) => new OnenoteOperationItemRequestBuilder(x, y));
    }
    /**
