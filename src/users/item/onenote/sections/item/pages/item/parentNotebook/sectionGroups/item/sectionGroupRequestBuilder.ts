...
import {SectionGroupRequestBuilder as i5b6a47cab5c7fd7fc99debb769f9311e8791c37fc83aa818698da2d00db061fd} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.sections.item.pages.item.parentNotebook.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: String) : i5b6a47cab5c7fd7fc99debb769f9311e8791c37fc83aa818698da2d00db061fd {
        if(!id) throw new Error("id cannot be undefined");
        return new i5b6a47cab5c7fd7fc99debb769f9311e8791c37fc83aa818698da2d00db061fd(this.currentPath + this.pathSegment + "/sectionGroups/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.sections.item.pages.item.parentNotebook.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
