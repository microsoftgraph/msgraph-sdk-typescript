...
/** Builds and executes requests for operations under /users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook  */
export class ParentNotebookRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook{?select,expand}";
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.users.item.onenote.sections.item.pages.item.parentNotebook.sectionGroups.item collection
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.users.item.onenote.sections.item.pages.item.parentNotebook.sections.item collection
     * @param id Unique identifier of the item
