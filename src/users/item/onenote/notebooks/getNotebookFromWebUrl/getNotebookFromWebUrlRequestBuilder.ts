...
export class GetNotebookFromWebUrlRequestBuilder {
    ...
    public post(body: GetNotebookFromWebUrlRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CopyNotebookModel | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CopyNotebookModel>(requestInfo, CopyNotebookModel, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
}
