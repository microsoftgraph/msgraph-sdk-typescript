...
export class GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder {
     ...
     */
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetRecentNotebooksWithIncludePersonalNotebooks[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.httpCore?.sendCollectionAsync<GetRecentNotebooksWithIncludePersonalNotebooks>(requestInfo, GetRecentNotebooksWithIncludePersonalNotebooks, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
