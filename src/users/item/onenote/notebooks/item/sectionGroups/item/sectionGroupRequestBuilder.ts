...
import {SectionGroupRequestBuilder as i0d99e4a9b03b090c6a02414bc88c97b3675782f0170327f075fa38232f4eaa7e} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.notebooks.item.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: String) : i0d99e4a9b03b090c6a02414bc88c97b3675782f0170327f075fa38232f4eaa7e {
        if(!id) throw new Error("id cannot be undefined");
        return new i0d99e4a9b03b090c6a02414bc88c97b3675782f0170327f075fa38232f4eaa7e(this.currentPath + this.pathSegment + "/sectionGroups/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.notebooks.item.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
