...
export class OnenotePatchContentRequestBuilder {
     ...
     */
    public post(body: OnenotePatchContentRequestBodyImpl | undefined, requestConfiguration?: OnenotePatchContentRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
