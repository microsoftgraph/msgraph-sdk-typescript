...
import {SectionGroupItemRequestBuilder as i9f1e3337af6a01875fa8f2a2dffb7e00a2da07c92df2c951f9c6cc344ade6b36} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.notebooks.item.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupItemRequestBuilder
     */
    public sectionGroupsById(id: string) : i9f1e3337af6a01875fa8f2a2dffb7e00a2da07c92df2c951f9c6cc344ade6b36 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup%2Did1"] = id
        return new i9f1e3337af6a01875fa8f2a2dffb7e00a2da07c92df2c951f9c6cc344ade6b36(urlTplParams, this.requestAdapter);
    };
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.notebooks.item.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
