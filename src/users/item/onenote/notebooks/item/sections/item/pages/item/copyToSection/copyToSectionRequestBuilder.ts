...
export class CopyToSectionRequestBuilder {
    ...
    public createPostRequestInformation(body: CopyToSectionPostRequestBody | undefined, requestConfiguration?: CopyToSectionRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new CopyToSectionPostRequestBodyImpl(body)
     ...
     */
    public post(body: CopyToSectionPostRequestBody | undefined, requestConfiguration?: CopyToSectionRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OnenoteOperationImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
