...
export class PagesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as PagesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as PagesResponse).value = n.getCollectionOfObjectValues<OnenotePage>(OnenotePage); }],
        ]);
    };
    /**
