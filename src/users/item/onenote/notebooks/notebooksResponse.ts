...
export class NotebooksResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as NotebooksResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as NotebooksResponse).value = n.getCollectionOfObjectValues<Notebook>(Notebook); }],
        ]);
    };
    /**
