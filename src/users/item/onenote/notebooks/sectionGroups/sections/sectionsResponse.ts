...
export class SectionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SectionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SectionsResponse).value = n.getCollectionOfObjectValues<OnenoteSection>(OnenoteSection); }],
        ]);
    };
    /**
