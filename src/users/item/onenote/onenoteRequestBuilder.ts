...
export class OnenoteRequestBuilder {
    ...
    public createPatchRequestInformation(body: Onenote | undefined, requestConfiguration?: OnenoteRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new OnenoteImpl(body)
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.notebooks.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.pages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.resources.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.sectionGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onenote.sections.item collection
     * @param id Unique identifier of the item
