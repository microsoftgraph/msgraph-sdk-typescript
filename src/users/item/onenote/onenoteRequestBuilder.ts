...
export class OnenoteRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.notebooks.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.pages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.resources.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.sectionGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.item.onenote.sections.item collection
     * @param id Unique identifier of the item
