import { type CallTranscript } from '../../../../../../../models/';
import { createCallTranscriptFromDiscriminatorValue } from '../../../../../../../models/callTranscript';
...
export class ContentRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}/content");
    };
    /**
     ...
     */
    public put(body: ArrayBuffer | undefined, requestConfiguration?: ContentRequestBuilderPutRequestConfiguration | undefined) : Promise<CallTranscript | undefined> {
