...
export class AttendanceReportsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AttendanceReportsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AttendanceReportsResponse).value = n.getCollectionOfObjectValues<MeetingAttendanceReport>(MeetingAttendanceReport); }],
        ]);
    };
    /**
