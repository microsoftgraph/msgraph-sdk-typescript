...
/** Builds and executes requests for operations under /users/{user-id}/onlineMeetings/{onlineMeeting-id}/attendeeReport  */
export class AttendeeReportRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/onlineMeetings/{onlineMeeting_id}/attendeeReport";
