import {ChatInfo} from '../../../../models/microsoft/graph/chatInfo';
import {MeetingParticipants} from '../../../../models/microsoft/graph/meetingParticipants';
...
export class CreateOrGetResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["chatInfo", (o, n) => { (o as unknown as CreateOrGetResponse).chatInfo = n.getObjectValue<ChatInfo>(ChatInfo); }],
            ["endDateTime", (o, n) => { (o as unknown as CreateOrGetResponse).endDateTime = n.getDateValue(); }],
            ["externalId", (o, n) => { (o as unknown as CreateOrGetResponse).externalId = n.getStringValue(); }],
            ["participants", (o, n) => { (o as unknown as CreateOrGetResponse).participants = n.getObjectValue<MeetingParticipants>(MeetingParticipants); }],
            ["startDateTime", (o, n) => { (o as unknown as CreateOrGetResponse).startDateTime = n.getDateValue(); }],
            ["subject", (o, n) => { (o as unknown as CreateOrGetResponse).subject = n.getStringValue(); }],
        ]);
    };
    /**
