...
export class TargetAppsResponse implements Parsable {
    ...
    /**
     * Instantiates a new targetAppsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["apps", (o, n) => { (o as unknown as TargetAppsResponse).apps = n.getCollectionOfObjectValues<ManagedMobileApp>(ManagedMobileApp); }],
        ]);
    };
    /**
