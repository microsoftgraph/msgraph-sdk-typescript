...
import { createSharedInsightCollectionResponseFromDiscriminatorValue, createSharedInsightFromDiscriminatorValue, deserializeIntoSharedInsight, serializeSharedInsight, type SharedInsight, type SharedInsightCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { SharedInsightItemRequestBuilder } from './item/';
 ...
 */
export class SharedRequestBuilder extends BaseRequestBuilder<SharedRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/insights/shared{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SharedRequestBuilder(x, y));
    }
    /**
