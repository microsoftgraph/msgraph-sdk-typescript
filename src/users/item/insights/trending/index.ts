...
import { createTrendingCollectionResponseFromDiscriminatorValue, createTrendingFromDiscriminatorValue, deserializeIntoTrending, serializeTrending, type Trending, type TrendingCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { TrendingItemRequestBuilder } from './item/';
 ...
 */
export class TrendingRequestBuilder extends BaseRequestBuilder<TrendingRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/insights/trending{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TrendingRequestBuilder(x, y));
    }
    /**
