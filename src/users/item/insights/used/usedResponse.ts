...
export class UsedResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as UsedResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as UsedResponse).value = n.getCollectionOfObjectValues<UsedInsight>(UsedInsight); }],
        ]);
    };
    /**
