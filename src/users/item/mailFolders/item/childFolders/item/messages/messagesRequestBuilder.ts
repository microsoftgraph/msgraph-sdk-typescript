import {createMessageCollectionResponseFromDiscriminatorValue} from '../../../../../../../models/microsoft/graph/createMessageCollectionResponseFromDiscriminatorValue';
...
import {MessageCollectionResponse} from '../../../../../../../models/microsoft/graph/messageCollectionResponse';
...
export class MessagesRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}/messages{?top,skip,search,filter,count,orderby,select,expand}";
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<MessageCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<MessageCollectionResponse>(requestInfo, createMessageCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to messages for users
     * @param body 
