...
import {MicrosoftGraphCreateReplyAllRequestBuilderPostRequestConfiguration} from './microsoftGraphCreateReplyAllRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the createReplyAll method.
 */
export class MicrosoftGraphCreateReplyAllRequestBuilder {
     ...
     */
    public post(body: CreateReplyAllPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphCreateReplyAllRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Message | undefined> {
     ...
     */
    public toPostRequestInformation(body: CreateReplyAllPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphCreateReplyAllRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
