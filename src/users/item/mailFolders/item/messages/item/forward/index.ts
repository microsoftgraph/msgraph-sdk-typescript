...
export class ForwardRequestBuilder extends BaseRequestBuilder<ForwardRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/forward", (x, y) => new ForwardRequestBuilder(x, y));
    }
    /**
