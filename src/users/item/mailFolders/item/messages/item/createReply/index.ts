 ...
 */
export class CreateReplyRequestBuilder extends BaseRequestBuilder<CreateReplyRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/createReply", (x, y) => new CreateReplyRequestBuilder(x, y));
    }
    /**
