...
export class GetManagedAppDiagnosticStatusesResponseImpl implements GetManagedAppDiagnosticStatusesResponse {
    ...
    public constructor(getManagedAppDiagnosticStatusesResponseParameterValue?: GetManagedAppDiagnosticStatusesResponse | undefined) {
        this._additionalData = getManagedAppDiagnosticStatusesResponseParameterValue?.additionalData ? getManagedAppDiagnosticStatusesResponseParameterValue?.additionalData! : {};
        this._value = getManagedAppDiagnosticStatusesResponseParameterValue?.value;
    };
    /**
     ...
     * @returns a ManagedAppDiagnosticStatusInterface
     */
    public get value() {
        return this._value;
    };
