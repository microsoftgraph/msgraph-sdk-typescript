...
export class GetManagedAppDiagnosticStatusesRequestBuilder {
     ...
     */
    public get(h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetManagedAppDiagnosticStatuses[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.requestAdapter?.sendCollectionAsync<GetManagedAppDiagnosticStatuses>(requestInfo, GetManagedAppDiagnosticStatuses, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
