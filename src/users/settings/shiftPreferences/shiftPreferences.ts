...
export class ShiftPreferences extends ChangeTrackedEntity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["availability", (o, n) => { (o as unknown as ShiftPreferences).availability = n.getCollectionOfPrimitiveValues<shiftAvailability>(); }],
        ]);
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfPrimitiveValues<shiftAvailability>("availability", this.availability);
    };
    /**
