...
export class ExportPersonalDataResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _storageLocation?: string | undefined;
    /**
     * Instantiates a new exportPersonalDataResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["storageLocation", (o, n) => { (o as unknown as ExportPersonalDataResponse).storageLocation = n.getStringValue(); }],
        ]);
    };
    /**
