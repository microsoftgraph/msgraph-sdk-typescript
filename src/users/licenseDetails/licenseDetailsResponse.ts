...
export class LicenseDetailsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as LicenseDetailsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as LicenseDetailsResponse).value = n.getCollectionOfObjectValues<LicenseDetails>(LicenseDetails); }],
        ]);
    };
    /**
