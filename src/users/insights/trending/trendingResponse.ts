...
export class TrendingResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TrendingResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TrendingResponse).value = n.getCollectionOfObjectValues<Trending>(Trending); }],
        ]);
    };
    /**
