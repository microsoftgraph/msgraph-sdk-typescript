import {PrintDocumentUploadProperties} from '../../../../../../../../../../me/insights/shared/lastSharedMethod/microsoft/graph/printDocument/microsoft/graph/printDocumentUploadProperties';
import {SerializationWriter, ParseNode, Parsable} from '@microsoft/kiota-abstractions';

export class Microsoft.graph.createUploadSessionResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["properties", (o, n) => { (o as unknown as Microsoft.graph.createUploadSessionResponse).properties = n.getObjectValue<PrintDocumentUploadProperties>(PrintDocumentUploadProperties); }],
        ]);
    };
    /**
