...
export class Microsoft.graph.commitResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fileEncryptionInfo", (o, n) => { (o as unknown as Microsoft.graph.commitResponse).fileEncryptionInfo = n.getObjectValue<FileEncryptionInfo>(FileEncryptionInfo); }],
        ]);
    };
    /**
