...
export class Microsoft.graph.rowRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.rowRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.rowResponse
     */
