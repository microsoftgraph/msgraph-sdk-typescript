...
export class Microsoft.graph.entireColumnRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.entireColumnRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.entireColumnResponse
     */
