...
export class Microsoft.graph.rowsAboveRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.rowsAboveRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.rowsAboveResponse
     */
