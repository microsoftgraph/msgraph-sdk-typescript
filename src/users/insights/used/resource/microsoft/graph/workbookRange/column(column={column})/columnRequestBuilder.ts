...
export class Microsoft.graph.columnRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.columnRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.columnResponse
     */
