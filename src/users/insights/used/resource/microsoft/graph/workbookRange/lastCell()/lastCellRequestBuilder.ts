...
export class Microsoft.graph.lastCellRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.lastCellRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.lastCellResponse
     */
