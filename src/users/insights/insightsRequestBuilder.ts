...
export class InsightsRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: Insights | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: Insights | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.insights.shared collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.insights.trending collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.insights.used collection
     * @param id Unique identifier of the item
