...
export class CalendarGroupsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as CalendarGroupsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as CalendarGroupsResponse).value = n.getCollectionOfObjectValues<CalendarGroup>(CalendarGroup); }],
        ]);
    };
    /**
