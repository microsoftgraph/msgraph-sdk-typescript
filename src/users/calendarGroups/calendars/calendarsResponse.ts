...
export class CalendarsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as CalendarsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as CalendarsResponse).value = n.getCollectionOfObjectValues<Calendar>(Calendar); }],
        ]);
    };
    /**
