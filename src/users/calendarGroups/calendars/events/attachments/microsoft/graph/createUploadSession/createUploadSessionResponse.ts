import {AttachmentItem} from '../../../../../../../../groups/calendarView/attachments/microsoft/graph/attachmentItem';
...
export class Microsoft.graph.createUploadSessionResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["attachmentItem", (o, n) => { (o as unknown as Microsoft.graph.createUploadSessionResponse).attachmentItem = n.getObjectValue<AttachmentItem>(AttachmentItem); }],
        ]);
    };
    /**
