...
export class EventRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.events.attachments collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.events.extensions collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.events.instances collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.events.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.events.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
