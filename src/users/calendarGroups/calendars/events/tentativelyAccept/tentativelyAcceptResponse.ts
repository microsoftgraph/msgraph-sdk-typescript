...
export class TentativelyAcceptResponse implements Parsable {
    ...
    /**
     * Instantiates a new tentativelyAcceptResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as TentativelyAcceptResponse).comment = n.getStringValue(); }],
            ["proposedNewTime", (o, n) => { (o as unknown as TentativelyAcceptResponse).proposedNewTime = n.getObjectValue<TimeSlot>(TimeSlot); }],
            ["sendResponse", (o, n) => { (o as unknown as TentativelyAcceptResponse).sendResponse = n.getBooleanValue(); }],
        ]);
    };
    /**
