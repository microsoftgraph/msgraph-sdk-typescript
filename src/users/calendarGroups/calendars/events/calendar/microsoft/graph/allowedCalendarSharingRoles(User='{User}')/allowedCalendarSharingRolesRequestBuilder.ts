...
export class Microsoft.graph.allowedCalendarSharingRolesRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.allowedCalendarSharingRolesRequestBuilder and sets the default values.
