...
export class CalendarRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.calendarPermissions collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.calendarView collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.events collection
     * @param id Unique identifier of the item
     * @returns a EventRequestBuilder
     */
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarGroups.calendars.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
