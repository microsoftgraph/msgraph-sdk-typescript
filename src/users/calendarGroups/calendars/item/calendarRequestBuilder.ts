...
import {AllowedCalendarSharingRolesWithUserRequestBuilder} from '../../../../me/events/calendar/allowedCalendarSharingRolesWithUser/allowedCalendarSharingRolesWithUserRequestBuilder';
...
export class CalendarRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendarGroups.calendars.calendarPermissions collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendarGroups.calendars.calendarView collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendarGroups.calendars.events collection
     * @param id Unique identifier of the item
     * @returns a eventRequestBuilder
     */
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendarGroups.calendars.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendarGroups.calendars.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
