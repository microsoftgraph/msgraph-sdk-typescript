...
import {Entity} from '../../insights/trending/resource/entity';
...
export class Delta extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["childFolderCount", (o, n) => { (o as unknown as Delta).childFolderCount = n.getNumberValue(); }],
            ["childFolders", (o, n) => { (o as unknown as Delta).childFolders = n.getCollectionOfObjectValues<MailFolder>(MailFolder); }],
            ["displayName", (o, n) => { (o as unknown as Delta).displayName = n.getStringValue(); }],
            ["isHidden", (o, n) => { (o as unknown as Delta).isHidden = n.getBooleanValue(); }],
            ["messageRules", (o, n) => { (o as unknown as Delta).messageRules = n.getCollectionOfObjectValues<MessageRule>(MessageRule); }],
            ["messages", (o, n) => { (o as unknown as Delta).messages = n.getCollectionOfObjectValues<Message>(Message); }],
            ...
            ["totalItemCount", (o, n) => { (o as unknown as Delta).totalItemCount = n.getNumberValue(); }],
            ["unreadItemCount", (o, n) => { (o as unknown as Delta).unreadItemCount = n.getNumberValue(); }],
        ]);
    };
    /**
