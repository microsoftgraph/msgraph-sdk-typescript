...
export class Microsoft.graph.delta extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["childFolderCount", (o, n) => { (o as unknown as Microsoft.graph.delta).childFolderCount = n.getNumberValue(); }],
            ["childFolders", (o, n) => { (o as unknown as Microsoft.graph.delta).childFolders = n.getCollectionOfObjectValues<MailFolder>(MailFolder); }],
            ["displayName", (o, n) => { (o as unknown as Microsoft.graph.delta).displayName = n.getStringValue(); }],
            ["isHidden", (o, n) => { (o as unknown as Microsoft.graph.delta).isHidden = n.getBooleanValue(); }],
            ["messageRules", (o, n) => { (o as unknown as Microsoft.graph.delta).messageRules = n.getCollectionOfObjectValues<MessageRule>(MessageRule); }],
            ["messages", (o, n) => { (o as unknown as Microsoft.graph.delta).messages = n.getCollectionOfObjectValues<Message>(Message); }],
            ...
            ["totalItemCount", (o, n) => { (o as unknown as Microsoft.graph.delta).totalItemCount = n.getNumberValue(); }],
            ["unreadItemCount", (o, n) => { (o as unknown as Microsoft.graph.delta).unreadItemCount = n.getNumberValue(); }],
        ]);
    };
    /**
