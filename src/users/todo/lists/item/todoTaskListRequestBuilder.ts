...
export class TodoTaskListRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.todo.lists.extensions collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.todo.lists.tasks collection
     * @param id Unique identifier of the item
