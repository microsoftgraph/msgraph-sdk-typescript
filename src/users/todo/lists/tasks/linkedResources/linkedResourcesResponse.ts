...
export class LinkedResourcesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as LinkedResourcesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as LinkedResourcesResponse).value = n.getCollectionOfObjectValues<LinkedResource>(LinkedResource); }],
        ]);
    };
    /**
