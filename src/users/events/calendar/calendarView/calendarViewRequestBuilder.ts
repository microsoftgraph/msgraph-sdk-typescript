...
/** Builds and executes requests for operations under /users/{user-id}/events/{event-id}/calendar/calendarView  */
export class CalendarViewRequestBuilder {
    ...
    /**
     * Builds and executes requests for operations under /users/{user-id}/events/{event-id}/calendar/calendarView/microsoft.graph.delta()
