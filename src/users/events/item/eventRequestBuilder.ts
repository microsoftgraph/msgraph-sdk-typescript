...
export class EventRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.events.attachments collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.events.extensions collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.events.instances collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.events.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.events.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
