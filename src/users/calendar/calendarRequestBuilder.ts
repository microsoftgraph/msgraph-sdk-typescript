...
export class CalendarRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendar.calendarPermissions collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendar.calendarView collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendar.events collection
     * @param id Unique identifier of the item
     * @returns a eventRequestBuilder
     */
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendar.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendar.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
