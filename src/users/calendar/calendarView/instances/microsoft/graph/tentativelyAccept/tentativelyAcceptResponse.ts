...
export class Microsoft.graph.tentativelyAcceptResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as Microsoft.graph.tentativelyAcceptResponse).comment = n.getStringValue(); }],
            ["proposedNewTime", (o, n) => { (o as unknown as Microsoft.graph.tentativelyAcceptResponse).proposedNewTime = n.getObjectValue<TimeSlot>(TimeSlot); }],
            ["sendResponse", (o, n) => { (o as unknown as Microsoft.graph.tentativelyAcceptResponse).sendResponse = n.getBooleanValue(); }],
        ]);
    };
    /**
