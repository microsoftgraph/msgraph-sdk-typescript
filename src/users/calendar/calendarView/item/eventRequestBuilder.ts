...
export class EventRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.calendarView.attachments collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.calendarView.extensions collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.calendarView.instances collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.calendarView.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.calendarView.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
