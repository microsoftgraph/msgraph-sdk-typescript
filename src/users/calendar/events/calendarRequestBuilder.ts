...
/** Builds and executes requests for operations under /users/{user-id}/calendar/events/{event-id}/calendar  */
export class CalendarRequestBuilder {
    ...
    /**
     * Builds and executes requests for operations under /users/{user-id}/calendar/events/{event-id}/calendar/microsoft.graph.allowedCalendarSharingRoles(User='{User}')
