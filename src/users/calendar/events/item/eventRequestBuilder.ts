...
export class EventRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.events.attachments collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.events.extensions collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.events.instances collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.events.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendar.events.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
