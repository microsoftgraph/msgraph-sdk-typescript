...
export class SendActivityNotificationResponse implements Parsable {
    ...
    /**
     * Instantiates a new sendActivityNotificationResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["topic", (o, n) => { (o as unknown as SendActivityNotificationResponse).topic = n.getObjectValue<TeamworkActivityTopic>(TeamworkActivityTopic); }],
        ]);
    };
    /**
