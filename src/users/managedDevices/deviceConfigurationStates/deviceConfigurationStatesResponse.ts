...
export class DeviceConfigurationStatesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceConfigurationStatesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceConfigurationStatesResponse).value = n.getCollectionOfObjectValues<DeviceConfigurationState>(DeviceConfigurationState); }],
        ]);
    };
    /**
