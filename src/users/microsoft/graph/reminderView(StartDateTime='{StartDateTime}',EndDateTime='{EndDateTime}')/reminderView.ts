...
export class Microsoft.graph.reminderView implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.reminderView and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["changeKey", (o, n) => { (o as unknown as Microsoft.graph.reminderView).changeKey = n.getStringValue(); }],
            ["eventEndTime", (o, n) => { (o as unknown as Microsoft.graph.reminderView).eventEndTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
            ["eventId", (o, n) => { (o as unknown as Microsoft.graph.reminderView).eventId = n.getStringValue(); }],
            ["eventLocation", (o, n) => { (o as unknown as Microsoft.graph.reminderView).eventLocation = n.getObjectValue<Location>(Location); }],
            ["eventStartTime", (o, n) => { (o as unknown as Microsoft.graph.reminderView).eventStartTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
            ["eventSubject", (o, n) => { (o as unknown as Microsoft.graph.reminderView).eventSubject = n.getStringValue(); }],
            ["eventWebLink", (o, n) => { (o as unknown as Microsoft.graph.reminderView).eventWebLink = n.getStringValue(); }],
            ["reminderFireTime", (o, n) => { (o as unknown as Microsoft.graph.reminderView).reminderFireTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
        ]);
    };
    /**
