...
export class Microsoft.graph.getMailTips implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["automaticReplies", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).automaticReplies = n.getObjectValue<AutomaticRepliesMailTips>(AutomaticRepliesMailTips); }],
            ["customMailTip", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).customMailTip = n.getStringValue(); }],
            ["deliveryRestricted", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).deliveryRestricted = n.getBooleanValue(); }],
            ["emailAddress", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).emailAddress = n.getObjectValue<EmailAddress>(EmailAddress); }],
            ["error", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).error = n.getObjectValue<MailTipsError>(MailTipsError); }],
            ["externalMemberCount", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).externalMemberCount = n.getNumberValue(); }],
            ["isModerated", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).isModerated = n.getBooleanValue(); }],
            ["mailboxFull", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).mailboxFull = n.getBooleanValue(); }],
            ["maxMessageSize", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).maxMessageSize = n.getNumberValue(); }],
            ["recipientScope", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).recipientScope = n.getObjectValue<RecipientScopeType>(RecipientScopeType); }],
            ["recipientSuggestions", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).recipientSuggestions = n.getCollectionOfObjectValues<Recipient>(Recipient); }],
            ["totalMemberCount", (o, n) => { (o as unknown as Microsoft.graph.getMailTips).totalMemberCount = n.getNumberValue(); }],
        ]);
    };
    /**
