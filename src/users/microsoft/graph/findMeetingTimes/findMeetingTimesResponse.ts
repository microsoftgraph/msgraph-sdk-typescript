...
export class Microsoft.graph.findMeetingTimesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["attendees", (o, n) => { (o as unknown as Microsoft.graph.findMeetingTimesResponse).attendees = n.getCollectionOfPrimitiveValues<attendeeBase>(); }],
            ["isOrganizerOptional", (o, n) => { (o as unknown as Microsoft.graph.findMeetingTimesResponse).isOrganizerOptional = n.getBooleanValue(); }],
            ["locationConstraint", (o, n) => { (o as unknown as Microsoft.graph.findMeetingTimesResponse).locationConstraint = n.getObjectValue<LocationConstraint>(LocationConstraint); }],
            ["maxCandidates", (o, n) => { (o as unknown as Microsoft.graph.findMeetingTimesResponse).maxCandidates = n.getNumberValue(); }],
            ["meetingDuration", (o, n) => { (o as unknown as Microsoft.graph.findMeetingTimesResponse).meetingDuration = n.getStringValue(); }],
            ["minimumAttendeePercentage", (o, n) => { (o as unknown as Microsoft.graph.findMeetingTimesResponse).minimumAttendeePercentage = n.getNumberValue(); }],
            ["returnSuggestionReasons", (o, n) => { (o as unknown as Microsoft.graph.findMeetingTimesResponse).returnSuggestionReasons = n.getBooleanValue(); }],
            ["timeConstraint", (o, n) => { (o as unknown as Microsoft.graph.findMeetingTimesResponse).timeConstraint = n.getObjectValue<TimeConstraint>(TimeConstraint); }],
        ]);
    };
    /**
