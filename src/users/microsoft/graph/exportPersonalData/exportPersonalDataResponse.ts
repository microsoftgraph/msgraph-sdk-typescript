...
export class Microsoft.graph.exportPersonalDataResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["storageLocation", (o, n) => { (o as unknown as Microsoft.graph.exportPersonalDataResponse).storageLocation = n.getStringValue(); }],
        ]);
    };
    /**
