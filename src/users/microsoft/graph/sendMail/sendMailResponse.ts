...
export class Microsoft.graph.sendMailResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["message", (o, n) => { (o as unknown as Microsoft.graph.sendMailResponse).message = n.getObjectValue<Message>(Message); }],
            ["saveToSentItems", (o, n) => { (o as unknown as Microsoft.graph.sendMailResponse).saveToSentItems = n.getBooleanValue(); }],
        ]);
    };
    /**
