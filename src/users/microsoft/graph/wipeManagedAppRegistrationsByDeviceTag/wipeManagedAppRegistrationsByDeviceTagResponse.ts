...
export class Microsoft.graph.wipeManagedAppRegistrationsByDeviceTagResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["deviceTag", (o, n) => { (o as unknown as Microsoft.graph.wipeManagedAppRegistrationsByDeviceTagResponse).deviceTag = n.getStringValue(); }],
        ]);
    };
    /**
