...
export class SupportedLanguages implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["displayName", (o, n) => { (o as unknown as SupportedLanguages).displayName = n.getStringValue(); }],
            ["locale", (o, n) => { (o as unknown as SupportedLanguages).locale = n.getStringValue(); }],
        ]);
    };
    /**
