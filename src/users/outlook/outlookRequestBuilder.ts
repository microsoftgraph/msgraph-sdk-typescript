...
export class OutlookRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: Outlook | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.outlook.masterCategories collection
