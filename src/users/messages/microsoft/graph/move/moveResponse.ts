...
export class Microsoft.graph.moveResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["destinationId", (o, n) => { (o as unknown as Microsoft.graph.moveResponse).destinationId = n.getStringValue(); }],
        ]);
    };
    /**
