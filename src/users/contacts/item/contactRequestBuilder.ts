...
export class ContactRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.contacts.extensions collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.contacts.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.contacts.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
