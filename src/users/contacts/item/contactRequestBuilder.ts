...
export class ContactRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.contacts.extensions collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.contacts.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.contacts.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
