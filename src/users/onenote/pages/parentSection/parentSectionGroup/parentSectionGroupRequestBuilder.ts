...
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.pages.parentSection.parentSectionGroup.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.pages.parentSection.parentSectionGroup.sections collection
     * @param id Unique identifier of the item
