...
/** Builds and executes requests for operations under /users/{user-id}/onenote/pages/{onenotePage-id}/parentSection  */
export class ParentSectionRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.pages.parentSection.pages collection
