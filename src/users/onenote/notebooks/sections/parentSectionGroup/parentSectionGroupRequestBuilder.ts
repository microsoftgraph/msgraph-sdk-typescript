...
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.onenote.notebooks.sections.parentSectionGroup.sectionGroups collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.onenote.notebooks.sections.parentSectionGroup.sections collection
     * @param id Unique identifier of the item
