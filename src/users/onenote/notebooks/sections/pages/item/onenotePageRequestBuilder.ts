import {PreviewRequestBuilder} from '../../../../../../groups/onenote/pages/parentNotebook/sectionGroups/sections/pages/preview/previewRequestBuilder';
...
/** Builds and executes requests for operations under /users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}  */
export class OnenotePageRequestBuilder {
    ...
    public get parentSection(): ParentSectionRequestBuilder {
        return new ParentSectionRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    }
    ...
    /**
     * Builds and executes requests for operations under /users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/microsoft.graph.preview()
