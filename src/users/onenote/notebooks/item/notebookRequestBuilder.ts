...
export class NotebookRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.notebooks.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.notebooks.sections collection
     * @param id Unique identifier of the item
