...
export class CopyToNotebookResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupId", (o, n) => { (o as unknown as CopyToNotebookResponse).groupId = n.getStringValue(); }],
            ["id", (o, n) => { (o as unknown as CopyToNotebookResponse).id = n.getStringValue(); }],
            ["renameAs", (o, n) => { (o as unknown as CopyToNotebookResponse).renameAs = n.getStringValue(); }],
            ["siteCollectionId", (o, n) => { (o as unknown as CopyToNotebookResponse).siteCollectionId = n.getStringValue(); }],
            ["siteId", (o, n) => { (o as unknown as CopyToNotebookResponse).siteId = n.getStringValue(); }],
        ]);
    };
    /**
