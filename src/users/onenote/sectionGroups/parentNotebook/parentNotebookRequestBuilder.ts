...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.onenote.sectionGroups.parentNotebook.sectionGroups collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.onenote.sectionGroups.parentNotebook.sections collection
     * @param id Unique identifier of the item
