...
export class Microsoft.graph.copyToSectionGroupResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupId", (o, n) => { (o as unknown as Microsoft.graph.copyToSectionGroupResponse).groupId = n.getStringValue(); }],
            ["id", (o, n) => { (o as unknown as Microsoft.graph.copyToSectionGroupResponse).id = n.getStringValue(); }],
            ["renameAs", (o, n) => { (o as unknown as Microsoft.graph.copyToSectionGroupResponse).renameAs = n.getStringValue(); }],
            ["siteCollectionId", (o, n) => { (o as unknown as Microsoft.graph.copyToSectionGroupResponse).siteCollectionId = n.getStringValue(); }],
            ["siteId", (o, n) => { (o as unknown as Microsoft.graph.copyToSectionGroupResponse).siteId = n.getStringValue(); }],
        ]);
    };
    /**
