...
export class Microsoft.graph.copyToNotebookResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupId", (o, n) => { (o as unknown as Microsoft.graph.copyToNotebookResponse).groupId = n.getStringValue(); }],
            ["id", (o, n) => { (o as unknown as Microsoft.graph.copyToNotebookResponse).id = n.getStringValue(); }],
            ["renameAs", (o, n) => { (o as unknown as Microsoft.graph.copyToNotebookResponse).renameAs = n.getStringValue(); }],
            ["siteCollectionId", (o, n) => { (o as unknown as Microsoft.graph.copyToNotebookResponse).siteCollectionId = n.getStringValue(); }],
            ["siteId", (o, n) => { (o as unknown as Microsoft.graph.copyToNotebookResponse).siteId = n.getStringValue(); }],
        ]);
    };
    /**
