...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.sections.parentNotebook.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.sections.parentNotebook.sections collection
     * @param id Unique identifier of the item
