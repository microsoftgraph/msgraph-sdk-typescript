...
export class OnenoteRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.notebooks collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.operations collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.pages collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.resources collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.sectionGroups collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.sections collection
     * @param id Unique identifier of the item
