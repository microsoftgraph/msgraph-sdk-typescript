...
export class DeviceManagementTroubleshootingEventsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceManagementTroubleshootingEventsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceManagementTroubleshootingEventsResponse).value = n.getCollectionOfObjectValues<DeviceManagementTroubleshootingEvent>(DeviceManagementTroubleshootingEvent); }],
        ]);
    };
    /**
