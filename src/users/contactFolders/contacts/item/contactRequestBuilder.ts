...
export class ContactRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: Contact | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.contactFolders.contacts.extensions collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.contactFolders.contacts.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.contactFolders.contacts.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
