...
export class Microsoft.graph.getScheduleResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["availabilityViewInterval", (o, n) => { (o as unknown as Microsoft.graph.getScheduleResponse).availabilityViewInterval = n.getNumberValue(); }],
            ["endTime", (o, n) => { (o as unknown as Microsoft.graph.getScheduleResponse).endTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
            ["schedules", (o, n) => { (o as unknown as Microsoft.graph.getScheduleResponse).schedules = n.getCollectionOfPrimitiveValues<string>(); }],
            ["startTime", (o, n) => { (o as unknown as Microsoft.graph.getScheduleResponse).startTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
        ]);
    };
    /**
