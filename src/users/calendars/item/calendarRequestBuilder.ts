...
export class CalendarRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendars.calendarPermissions collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendars.calendarView collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendars.events collection
     * @param id Unique identifier of the item
     * @returns a eventRequestBuilder
     */
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendars.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.users.calendars.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
