...
import { createRemoveGroupPostResponseFromDiscriminatorValue, deserializeIntoRemoveGroupPostResponse, serializeRemoveGroupPostResponse, type RemoveGroupPostResponse } from './removeGroupPostResponse';
...
export class RemoveGroupRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RemoveGroupPostRequestBody, requestConfiguration?: RemoveGroupRequestBuilderPostRequestConfiguration | undefined) : Promise<RemoveGroupPostResponse | undefined> {
