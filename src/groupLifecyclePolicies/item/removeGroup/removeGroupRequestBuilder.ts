...
export class RemoveGroupRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: RemoveGroupRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: RemoveGroupRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<boolean | undefined> {
        if(!body) throw new Error("body cannot be undefined");
