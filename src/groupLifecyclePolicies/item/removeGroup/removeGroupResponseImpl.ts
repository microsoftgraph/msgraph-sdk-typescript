...
export class RemoveGroupResponseImpl implements RemoveGroupResponse {
    ...
    public constructor(removeGroupResponseParameterValue?: RemoveGroupResponse | undefined) {
        this._additionalData = removeGroupResponseParameterValue?.additionalData ? removeGroupResponseParameterValue?.additionalData! : {};
        this._value = removeGroupResponseParameterValue?.value;
    };
    /**
