...
export class GroupLifecyclePoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as GroupLifecyclePoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as GroupLifecyclePoliciesResponse).value = n.getCollectionOfObjectValues<GroupLifecyclePolicy>(GroupLifecyclePolicy); }],
        ]);
    };
    /**
