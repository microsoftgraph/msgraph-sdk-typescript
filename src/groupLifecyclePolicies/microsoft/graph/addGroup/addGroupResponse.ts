...
export class Microsoft.graph.addGroupResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupId", (o, n) => { (o as unknown as Microsoft.graph.addGroupResponse).groupId = n.getStringValue(); }],
        ]);
    };
    /**
