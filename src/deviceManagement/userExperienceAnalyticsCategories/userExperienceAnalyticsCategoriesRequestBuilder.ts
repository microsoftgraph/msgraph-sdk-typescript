...
import {UserExperienceAnalyticsCategory} from '../../models/userExperienceAnalyticsCategory';
...
export class UserExperienceAnalyticsCategoriesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the userExperienceAnalyticsCategories property of the microsoft.graph.deviceManagement entity.
     * @param userExperienceAnalyticsCategoryId Unique identifier of the item
     ...
     */
    public post(body: UserExperienceAnalyticsCategory | undefined, requestConfiguration?: UserExperienceAnalyticsCategoriesRequestBuilderPostRequestConfiguration | undefined) : Promise<UserExperienceAnalyticsCategory | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: UserExperienceAnalyticsCategory | undefined, requestConfiguration?: UserExperienceAnalyticsCategoriesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
