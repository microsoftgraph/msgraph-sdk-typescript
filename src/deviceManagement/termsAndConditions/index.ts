...
import { createTermsAndConditionsCollectionResponseFromDiscriminatorValue, createTermsAndConditionsFromDiscriminatorValue, deserializeIntoTermsAndConditions, serializeTermsAndConditions, type TermsAndConditions, type TermsAndConditionsCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { TermsAndConditionsItemRequestBuilder } from './item/';
...
export class TermsAndConditionsRequestBuilder extends BaseRequestBuilder<TermsAndConditionsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/termsAndConditions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TermsAndConditionsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<TermsAndConditionsRequestBuilderGetQueryParameters> | undefined) : Promise<TermsAndConditionsCollectionResponse | undefined> {
     ...
     */
    public post(body: TermsAndConditions, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<TermsAndConditions | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: TermsAndConditions, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
