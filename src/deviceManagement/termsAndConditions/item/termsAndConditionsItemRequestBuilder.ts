...
export class TermsAndConditionsItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: TermsAndConditionsItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
