...
export class TermsAndConditionsAssignmentItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: TermsAndConditionsAssignmentItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: TermsAndConditionsAssignment | undefined, requestConfiguration?: TermsAndConditionsAssignmentItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
