...
import { createTermsAndConditionsAssignmentCollectionResponseFromDiscriminatorValue, createTermsAndConditionsAssignmentFromDiscriminatorValue, deserializeIntoTermsAndConditionsAssignment, serializeTermsAndConditionsAssignment, type TermsAndConditionsAssignment, type TermsAndConditionsAssignmentCollectionResponse } from '../../../../models/';
...
export class AssignmentsRequestBuilder extends BaseRequestBuilder<AssignmentsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AssignmentsRequestBuilder(x, y));
    }
    /**
