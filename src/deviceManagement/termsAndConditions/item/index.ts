...
import { createTermsAndConditionsFromDiscriminatorValue, deserializeIntoTermsAndConditions, serializeTermsAndConditions, type TermsAndConditions } from '../../../models/';
 ...
 */
export class TermsAndConditionsItemRequestBuilder extends BaseRequestBuilder<TermsAndConditionsItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}{?%24select,%24expand}", (x, y) => new TermsAndConditionsItemRequestBuilder(x, y));
    }
    /**
