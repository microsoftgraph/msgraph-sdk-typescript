...
export class TermsAndConditionsRequestBuilder {
    ...
    public acceptanceStatusesById(id: string) : TermsAndConditionsAcceptanceStatusRequestBuilder {
        ...
        id && urlTplParams.set("termsAndConditionsAcceptanceStatus_id", id);
    ...
    public assignmentsById(id: string) : TermsAndConditionsAssignmentRequestBuilder {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("termsAndConditionsAssignment_id", id);
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: TermsAndConditions | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: TermsAndConditions | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
