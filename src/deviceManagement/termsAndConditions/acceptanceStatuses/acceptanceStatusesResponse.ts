...
export class AcceptanceStatusesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AcceptanceStatusesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AcceptanceStatusesResponse).value = n.getCollectionOfObjectValues<TermsAndConditionsAcceptanceStatus>(TermsAndConditionsAcceptanceStatus); }],
        ]);
    };
    /**
