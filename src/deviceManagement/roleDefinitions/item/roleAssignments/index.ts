...
import { createRoleAssignmentCollectionResponseFromDiscriminatorValue, createRoleAssignmentFromDiscriminatorValue, deserializeIntoRoleAssignment, serializeRoleAssignment, type RoleAssignment, type RoleAssignmentCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { RoleAssignmentItemRequestBuilder } from './item/';
...
export class RoleAssignmentsRequestBuilder extends BaseRequestBuilder<RoleAssignmentsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RoleAssignmentsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<RoleAssignmentsRequestBuilderGetQueryParameters> | undefined) : Promise<RoleAssignmentCollectionResponse | undefined> {
     ...
     */
    public post(body: RoleAssignment, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<RoleAssignment | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: RoleAssignment, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
