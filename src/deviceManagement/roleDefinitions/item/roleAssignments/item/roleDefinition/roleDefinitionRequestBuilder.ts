...
import { type RoleDefinitionRequestBuilderGetRequestConfiguration } from './roleDefinitionRequestBuilderGetRequestConfiguration';
...
export class RoleDefinitionRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}/roleAssignments/{roleAssignment%2Did}/roleDefinition{?%24select,%24expand}");
    };
    /**
     ...
     */
    public get(requestConfiguration?: RoleDefinitionRequestBuilderGetRequestConfiguration | undefined) : Promise<RoleDefinition | undefined> {
