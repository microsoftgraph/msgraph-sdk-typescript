...
export class UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion, requestConfiguration?: UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilderPostRequestConfiguration | undefined) : Promise<UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion, requestConfiguration?: UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a userExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilder
     */
    public withUrl(rawUrl: string) : UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilder {
