...
import {ComplianceManagementPartnersRequestBuilderGetQueryParameters} from './complianceManagementPartnersRequestBuilderGetQueryParameters';
...
export class ComplianceManagementPartnersRequestBuilder {
     ...
     */
    public createGetRequestInformation(queryParameters?: ComplianceManagementPartnersRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: ComplianceManagementPartner | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public get(queryParameters?: ComplianceManagementPartnersRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ComplianceManagementPartnerCollectionResponse | undefined> {
     ...
     */
    public post(body: ComplianceManagementPartner | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ComplianceManagementPartner | undefined> {
        if(!body) throw new Error("body cannot be undefined");
