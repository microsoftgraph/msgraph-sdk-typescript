...
export class GetEffectivePermissionsWithScopeRequestBuilder {
     ...
     */
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetEffectivePermissionsWithScope[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.httpCore?.sendCollectionAsync<GetEffectivePermissionsWithScope>(requestInfo, GetEffectivePermissionsWithScope, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
