...
import { createDeviceManagementPartnerFromDiscriminatorValue, deserializeIntoDeviceManagementPartner, serializeDeviceManagementPartner, type DeviceManagementPartner } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { TerminateRequestBuilder } from './terminate/';
 ...
 */
export class DeviceManagementPartnerItemRequestBuilder extends BaseRequestBuilder<DeviceManagementPartnerItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceManagementPartners/{deviceManagementPartner%2Did}{?%24select,%24expand}", (x, y) => new DeviceManagementPartnerItemRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<DeviceManagementPartnerItemRequestBuilderGetQueryParameters> | undefined) : Promise<DeviceManagementPartner | undefined> {
     ...
     */
    public patch(body: DeviceManagementPartner, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DeviceManagementPartner | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<DeviceManagementPartnerItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, deviceManagementPartnerItemRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    }
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: DeviceManagementPartner, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
