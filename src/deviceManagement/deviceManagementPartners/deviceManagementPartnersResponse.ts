...
export class DeviceManagementPartnersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceManagementPartnersResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceManagementPartnersResponse).value = n.getCollectionOfObjectValues<DeviceManagementPartner>(DeviceManagementPartner); }],
        ]);
    };
    /**
