...
export class ConditionalAccessSettings extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["enabled", (o, n) => { (o as unknown as ConditionalAccessSettings).enabled = n.getBooleanValue(); }],
            ["excludedGroups", (o, n) => { (o as unknown as ConditionalAccessSettings).excludedGroups = n.getCollectionOfPrimitiveValues<string>(); }],
            ["includedGroups", (o, n) => { (o as unknown as ConditionalAccessSettings).includedGroups = n.getCollectionOfPrimitiveValues<string>(); }],
            ["overrideDefaultRule", (o, n) => { (o as unknown as ConditionalAccessSettings).overrideDefaultRule = n.getBooleanValue(); }],
        ]);
    };
    /**
