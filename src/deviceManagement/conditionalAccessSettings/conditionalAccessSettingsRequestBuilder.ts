...
export class ConditionalAccessSettingsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<ConditionalAccessSettingsRequestBuilderGetQueryParameters> | undefined) : Promise<OnPremisesConditionalAccessSettings | undefined> {
     ...
     */
    public patch(body: OnPremisesConditionalAccessSettings, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<OnPremisesConditionalAccessSettings | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<ConditionalAccessSettingsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, conditionalAccessSettingsRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    };
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: OnPremisesConditionalAccessSettings, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
