...
import { createAppLogCollectionRequestCollectionResponseFromDiscriminatorValue, createAppLogCollectionRequestFromDiscriminatorValue, deserializeIntoAppLogCollectionRequest, serializeAppLogCollectionRequest, type AppLogCollectionRequest, type AppLogCollectionRequestCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AppLogCollectionRequestItemRequestBuilder } from './item/';
 ...
 */
export class AppLogCollectionRequestsRequestBuilder extends BaseRequestBuilder<AppLogCollectionRequestsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AppLogCollectionRequestsRequestBuilder(x, y));
    }
    /**
