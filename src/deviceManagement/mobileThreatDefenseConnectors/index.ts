 ...
 */
export class MobileThreatDefenseConnectorsRequestBuilder extends BaseRequestBuilder<MobileThreatDefenseConnectorsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/mobileThreatDefenseConnectors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new MobileThreatDefenseConnectorsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<MobileThreatDefenseConnectorsRequestBuilderGetQueryParameters> | undefined) : Promise<MobileThreatDefenseConnectorCollectionResponse | undefined> {
     ...
     */
    public post(body: MobileThreatDefenseConnector, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<MobileThreatDefenseConnector | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<MobileThreatDefenseConnectorsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, mobileThreatDefenseConnectorsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: MobileThreatDefenseConnector, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
