...
export class MobileThreatDefenseConnectorsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as MobileThreatDefenseConnectorsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as MobileThreatDefenseConnectorsResponse).value = n.getCollectionOfObjectValues<MobileThreatDefenseConnector>(MobileThreatDefenseConnector); }],
        ]);
    };
    /**
