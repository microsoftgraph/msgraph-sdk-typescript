...
import { createUserExperienceAnalyticsModelScoresCollectionResponseFromDiscriminatorValue, createUserExperienceAnalyticsModelScoresFromDiscriminatorValue, deserializeIntoUserExperienceAnalyticsModelScores, serializeUserExperienceAnalyticsModelScores, type UserExperienceAnalyticsModelScores, type UserExperienceAnalyticsModelScoresCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { UserExperienceAnalyticsModelScoresItemRequestBuilder } from './item/';
 ...
 */
export class UserExperienceAnalyticsModelScoresRequestBuilder extends BaseRequestBuilder<UserExperienceAnalyticsModelScoresRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UserExperienceAnalyticsModelScoresRequestBuilder(x, y));
    }
    /**
