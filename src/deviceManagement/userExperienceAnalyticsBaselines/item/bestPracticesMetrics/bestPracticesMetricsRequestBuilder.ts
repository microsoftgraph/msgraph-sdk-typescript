...
import { type BestPracticesMetricsRequestBuilderGetRequestConfiguration } from './bestPracticesMetricsRequestBuilderGetRequestConfiguration';
...
export class BestPracticesMetricsRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a bestPracticesMetricsRequestBuilder
     */
    public withUrl(rawUrl: string) : BestPracticesMetricsRequestBuilder {
