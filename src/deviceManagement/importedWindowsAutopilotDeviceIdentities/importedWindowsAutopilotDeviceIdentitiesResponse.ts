...
export class ImportedWindowsAutopilotDeviceIdentitiesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ImportedWindowsAutopilotDeviceIdentitiesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ImportedWindowsAutopilotDeviceIdentitiesResponse).value = n.getCollectionOfObjectValues<ImportedWindowsAutopilotDeviceIdentity>(ImportedWindowsAutopilotDeviceIdentity); }],
        ]);
    };
    /**
