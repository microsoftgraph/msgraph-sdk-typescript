...
export class Microsoft.graph.importResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["importedWindowsAutopilotDeviceIdentities", (o, n) => { (o as unknown as Microsoft.graph.importResponse).importedWindowsAutopilotDeviceIdentities = n.getCollectionOfObjectValues<ImportedWindowsAutopilotDeviceIdentity>(ImportedWindowsAutopilotDeviceIdentity); }],
        ]);
    };
    /**
