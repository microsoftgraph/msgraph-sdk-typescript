...
export class ImportRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: ImportResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public post(body: ImportResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Import_escaped[] | undefined> {
        ...
        return this.httpCore?.sendCollectionAsync<Import_escaped>(requestInfo, Import_escaped, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
