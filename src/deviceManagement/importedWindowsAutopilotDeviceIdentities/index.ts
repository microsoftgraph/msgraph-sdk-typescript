...
import { createImportedWindowsAutopilotDeviceIdentityCollectionResponseFromDiscriminatorValue, createImportedWindowsAutopilotDeviceIdentityFromDiscriminatorValue, deserializeIntoImportedWindowsAutopilotDeviceIdentity, serializeImportedWindowsAutopilotDeviceIdentity, type ImportedWindowsAutopilotDeviceIdentity, type ImportedWindowsAutopilotDeviceIdentityCollectionResponse } from '../../models/';
 ...
 */
export class ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder extends BaseRequestBuilder<ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/importedWindowsAutopilotDeviceIdentities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder(x, y));
    }
    /**
