...
export class ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: ImportedWindowsAutopilotDeviceIdentity | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ImportedWindowsAutopilotDeviceIdentitiesResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.requestAdapter?.sendAsync<ImportedWindowsAutopilotDeviceIdentitiesResponse>(requestInfo, ImportedWindowsAutopilotDeviceIdentitiesResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Collection of imported Windows autopilot devices.
     * @param body 
     ...
     */
    public post(body: ImportedWindowsAutopilotDeviceIdentity | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ImportedWindowsAutopilotDeviceIdentity | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = this.createPostRequestInformation(
            body, h, o
        );
        return this.requestAdapter?.sendAsync<ImportedWindowsAutopilotDeviceIdentity>(requestInfo, ImportedWindowsAutopilotDeviceIdentity, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
