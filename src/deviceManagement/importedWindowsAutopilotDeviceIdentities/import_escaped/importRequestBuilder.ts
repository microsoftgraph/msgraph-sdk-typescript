...
export class ImportRequestBuilder {
    ...
    public post(body: ImportPostRequestBody | undefined, requestConfiguration?: ImportRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ImportResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ImportResponseImpl>(requestInfo, createImportResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
