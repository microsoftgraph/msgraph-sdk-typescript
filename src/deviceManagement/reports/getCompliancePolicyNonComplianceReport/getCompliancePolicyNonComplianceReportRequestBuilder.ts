...
import { deserializeIntoGetCompliancePolicyNonComplianceReportPostRequestBody, serializeGetCompliancePolicyNonComplianceReportPostRequestBody, type GetCompliancePolicyNonComplianceReportPostRequestBody } from './getCompliancePolicyNonComplianceReportPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface GetCompliancePolicyNonComplianceReportRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
