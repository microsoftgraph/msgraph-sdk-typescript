...
export class GetCompliancePolicyNonComplianceReportPostRequestBodyImpl implements GetCompliancePolicyNonComplianceReportPostRequestBody {
    ...
    public constructor(getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?: GetCompliancePolicyNonComplianceReportPostRequestBody | undefined) {
        this._additionalData = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.additionalData ? getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.filter;
        this._groupBy = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.groupBy;
        this._name = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.name;
        this._orderBy = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.orderBy;
        this._search = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.search;
        this._select = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.select;
        this._sessionId = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.sessionId;
        this._skip = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.skip;
        this._top = getCompliancePolicyNonComplianceReportPostRequestBodyParameterValue?.top;
    };
    /**
