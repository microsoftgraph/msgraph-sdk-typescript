...
export class GetDeviceNonComplianceReportPostRequestBodyImpl implements GetDeviceNonComplianceReportPostRequestBody {
    ...
    public constructor(getDeviceNonComplianceReportPostRequestBodyParameterValue?: GetDeviceNonComplianceReportPostRequestBody | undefined) {
        this._additionalData = getDeviceNonComplianceReportPostRequestBodyParameterValue?.additionalData ? getDeviceNonComplianceReportPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getDeviceNonComplianceReportPostRequestBodyParameterValue?.filter;
        this._groupBy = getDeviceNonComplianceReportPostRequestBodyParameterValue?.groupBy;
        this._name = getDeviceNonComplianceReportPostRequestBodyParameterValue?.name;
        this._orderBy = getDeviceNonComplianceReportPostRequestBodyParameterValue?.orderBy;
        this._search = getDeviceNonComplianceReportPostRequestBodyParameterValue?.search;
        this._select = getDeviceNonComplianceReportPostRequestBodyParameterValue?.select;
        this._sessionId = getDeviceNonComplianceReportPostRequestBodyParameterValue?.sessionId;
        this._skip = getDeviceNonComplianceReportPostRequestBodyParameterValue?.skip;
        this._top = getDeviceNonComplianceReportPostRequestBodyParameterValue?.top;
    };
    /**
