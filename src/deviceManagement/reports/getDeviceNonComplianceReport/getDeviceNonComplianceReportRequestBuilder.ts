...
import { deserializeIntoGetDeviceNonComplianceReportPostRequestBody, serializeGetDeviceNonComplianceReportPostRequestBody, type GetDeviceNonComplianceReportPostRequestBody } from './getDeviceNonComplianceReportPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface GetDeviceNonComplianceReportRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
