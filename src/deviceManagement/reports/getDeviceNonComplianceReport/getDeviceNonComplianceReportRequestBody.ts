...
export class GetDeviceNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "filter": (o, n) => { (o as unknown as GetDeviceNonComplianceReportRequestBody).filter = n.getStringValue(); },
            "groupBy": (o, n) => { (o as unknown as GetDeviceNonComplianceReportRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); },
            "name": (o, n) => { (o as unknown as GetDeviceNonComplianceReportRequestBody).name = n.getStringValue(); },
            "orderBy": (o, n) => { (o as unknown as GetDeviceNonComplianceReportRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); },
            "search": (o, n) => { (o as unknown as GetDeviceNonComplianceReportRequestBody).search = n.getStringValue(); },
            "select": (o, n) => { (o as unknown as GetDeviceNonComplianceReportRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); },
            "sessionId": (o, n) => { (o as unknown as GetDeviceNonComplianceReportRequestBody).sessionId = n.getStringValue(); },
            "skip": (o, n) => { (o as unknown as GetDeviceNonComplianceReportRequestBody).skip = n.getNumberValue(); },
            "top": (o, n) => { (o as unknown as GetDeviceNonComplianceReportRequestBody).top = n.getNumberValue(); },
        };
    };
    /**
