...
export class GetConfigurationPolicyNonComplianceSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "filter": (o, n) => { (o as unknown as GetConfigurationPolicyNonComplianceSummaryReportRequestBody).filter = n.getStringValue(); },
            "groupBy": (o, n) => { (o as unknown as GetConfigurationPolicyNonComplianceSummaryReportRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); },
            "name": (o, n) => { (o as unknown as GetConfigurationPolicyNonComplianceSummaryReportRequestBody).name = n.getStringValue(); },
            "orderBy": (o, n) => { (o as unknown as GetConfigurationPolicyNonComplianceSummaryReportRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); },
            "search": (o, n) => { (o as unknown as GetConfigurationPolicyNonComplianceSummaryReportRequestBody).search = n.getStringValue(); },
            "select": (o, n) => { (o as unknown as GetConfigurationPolicyNonComplianceSummaryReportRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); },
            "sessionId": (o, n) => { (o as unknown as GetConfigurationPolicyNonComplianceSummaryReportRequestBody).sessionId = n.getStringValue(); },
            "skip": (o, n) => { (o as unknown as GetConfigurationPolicyNonComplianceSummaryReportRequestBody).skip = n.getNumberValue(); },
            "top": (o, n) => { (o as unknown as GetConfigurationPolicyNonComplianceSummaryReportRequestBody).top = n.getNumberValue(); },
        };
    };
    /**
