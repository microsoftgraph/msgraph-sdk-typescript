...
export class GetConfigurationPolicyNonComplianceSummaryReportPostRequestBodyImpl implements GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody {
    ...
    public constructor(getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?: GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody | undefined) {
        this._additionalData = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.additionalData ? getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.filter;
        this._groupBy = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.groupBy;
        this._name = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.name;
        this._orderBy = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.orderBy;
        this._search = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.search;
        this._select = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.select;
        this._sessionId = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.sessionId;
        this._skip = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.skip;
        this._top = getConfigurationPolicyNonComplianceSummaryReportPostRequestBodyParameterValue?.top;
    };
    /**
