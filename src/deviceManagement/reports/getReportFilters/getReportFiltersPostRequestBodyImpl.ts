...
export class GetReportFiltersPostRequestBodyImpl implements GetReportFiltersPostRequestBody {
    ...
    public constructor(getReportFiltersPostRequestBodyParameterValue?: GetReportFiltersPostRequestBody | undefined) {
        this._additionalData = getReportFiltersPostRequestBodyParameterValue?.additionalData ? getReportFiltersPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getReportFiltersPostRequestBodyParameterValue?.filter;
        this._groupBy = getReportFiltersPostRequestBodyParameterValue?.groupBy;
        this._name = getReportFiltersPostRequestBodyParameterValue?.name;
        this._orderBy = getReportFiltersPostRequestBodyParameterValue?.orderBy;
        this._search = getReportFiltersPostRequestBodyParameterValue?.search;
        this._select = getReportFiltersPostRequestBodyParameterValue?.select;
        this._sessionId = getReportFiltersPostRequestBodyParameterValue?.sessionId;
        this._skip = getReportFiltersPostRequestBodyParameterValue?.skip;
        this._top = getReportFiltersPostRequestBodyParameterValue?.top;
    };
    /**
