...
export class GetReportFiltersRequestBodyImpl implements AdditionalDataHolder, GetReportFiltersRequestBody, Parsable {
     ...
     * @param getReportFiltersRequestBodyParameterValue 
     */
    public constructor(getReportFiltersRequestBodyParameterValue?: GetReportFiltersRequestBody | undefined) {
        this.additionalData = {};
        this.additionalData = getReportFiltersRequestBodyParameterValue?.additionalData ? {} : getReportFiltersRequestBodyParameterValue?.additionalData!
        this.filter = getReportFiltersRequestBodyParameterValue?.filter ;
        this.groupBy = getReportFiltersRequestBodyParameterValue?.groupBy ;
        this.name = getReportFiltersRequestBodyParameterValue?.name ;
        this.orderBy = getReportFiltersRequestBodyParameterValue?.orderBy ;
        this.search = getReportFiltersRequestBodyParameterValue?.search ;
        this.select = getReportFiltersRequestBodyParameterValue?.select ;
        this.sessionId = getReportFiltersRequestBodyParameterValue?.sessionId ;
        this.skip = getReportFiltersRequestBodyParameterValue?.skip ;
        this.top = getReportFiltersRequestBodyParameterValue?.top ;
    };
    /**
