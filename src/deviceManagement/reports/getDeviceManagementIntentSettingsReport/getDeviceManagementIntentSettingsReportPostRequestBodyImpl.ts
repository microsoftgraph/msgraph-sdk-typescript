...
export class GetDeviceManagementIntentSettingsReportPostRequestBodyImpl implements GetDeviceManagementIntentSettingsReportPostRequestBody {
    ...
    public constructor(getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?: GetDeviceManagementIntentSettingsReportPostRequestBody | undefined) {
        this._additionalData = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.additionalData ? getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.filter;
        this._groupBy = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.groupBy;
        this._name = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.name;
        this._orderBy = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.orderBy;
        this._search = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.search;
        this._select = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.select;
        this._sessionId = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.sessionId;
        this._skip = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.skip;
        this._top = getDeviceManagementIntentSettingsReportPostRequestBodyParameterValue?.top;
    };
    /**
