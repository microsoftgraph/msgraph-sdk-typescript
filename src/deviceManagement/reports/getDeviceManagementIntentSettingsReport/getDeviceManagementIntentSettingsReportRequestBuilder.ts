...
export class GetDeviceManagementIntentSettingsReportRequestBuilder {
     ...
     */
    public post(body: GetDeviceManagementIntentSettingsReportPostRequestBody | undefined, requestConfiguration?: GetDeviceManagementIntentSettingsReportRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
        if(!body) throw new Error("body cannot be undefined");
