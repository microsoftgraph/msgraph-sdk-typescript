...
import { type GetDeviceManagementIntentSettingsReportRequestBuilderPostRequestConfiguration } from './getDeviceManagementIntentSettingsReportRequestBuilderPostRequestConfiguration';
