...
export class GetDeviceManagementIntentSettingsReportRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetDeviceManagementIntentSettingsReportRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: GetDeviceManagementIntentSettingsReportRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ReadableStream | undefined> {
        if(!body) throw new Error("body cannot be undefined");
