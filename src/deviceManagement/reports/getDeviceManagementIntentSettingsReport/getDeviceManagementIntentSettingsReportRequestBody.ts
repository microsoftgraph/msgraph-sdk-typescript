...
export class GetDeviceManagementIntentSettingsReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "filter": (o, n) => { (o as unknown as GetDeviceManagementIntentSettingsReportRequestBody).filter = n.getStringValue(); },
            "groupBy": (o, n) => { (o as unknown as GetDeviceManagementIntentSettingsReportRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); },
            "name": (o, n) => { (o as unknown as GetDeviceManagementIntentSettingsReportRequestBody).name = n.getStringValue(); },
            "orderBy": (o, n) => { (o as unknown as GetDeviceManagementIntentSettingsReportRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); },
            "search": (o, n) => { (o as unknown as GetDeviceManagementIntentSettingsReportRequestBody).search = n.getStringValue(); },
            "select": (o, n) => { (o as unknown as GetDeviceManagementIntentSettingsReportRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); },
            "sessionId": (o, n) => { (o as unknown as GetDeviceManagementIntentSettingsReportRequestBody).sessionId = n.getStringValue(); },
            "skip": (o, n) => { (o as unknown as GetDeviceManagementIntentSettingsReportRequestBody).skip = n.getNumberValue(); },
            "top": (o, n) => { (o as unknown as GetDeviceManagementIntentSettingsReportRequestBody).top = n.getNumberValue(); },
        };
    };
    /**
