...
export class GetConfigurationPolicyNonComplianceReportPostRequestBodyImpl implements GetConfigurationPolicyNonComplianceReportPostRequestBody {
    ...
    public constructor(getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?: GetConfigurationPolicyNonComplianceReportPostRequestBody | undefined) {
        this._additionalData = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.additionalData ? getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.filter;
        this._groupBy = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.groupBy;
        this._name = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.name;
        this._orderBy = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.orderBy;
        this._search = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.search;
        this._select = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.select;
        this._sessionId = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.sessionId;
        this._skip = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.skip;
        this._top = getConfigurationPolicyNonComplianceReportPostRequestBodyParameterValue?.top;
    };
    /**
