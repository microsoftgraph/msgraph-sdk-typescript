...
export class GetCachedReportRequestBuilder {
     ...
     */
    public post(body: GetCachedReportPostRequestBody | undefined, requestConfiguration?: GetCachedReportRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
        if(!body) throw new Error("body cannot be undefined");
