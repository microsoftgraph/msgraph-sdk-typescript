 ...
 */
export class GetCachedReportRequestBuilder extends BaseRequestBuilder<GetCachedReportRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/reports/getCachedReport", (x, y) => new GetCachedReportRequestBuilder(x, y));
    }
    /**
     * Not yet documented
