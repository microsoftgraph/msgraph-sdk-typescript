...
export class GetHistoricalReportPostRequestBodyImpl implements GetHistoricalReportPostRequestBody {
    ...
    public constructor(getHistoricalReportPostRequestBodyParameterValue?: GetHistoricalReportPostRequestBody | undefined) {
        this._additionalData = getHistoricalReportPostRequestBodyParameterValue?.additionalData ? getHistoricalReportPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getHistoricalReportPostRequestBodyParameterValue?.filter;
        this._groupBy = getHistoricalReportPostRequestBodyParameterValue?.groupBy;
        this._name = getHistoricalReportPostRequestBodyParameterValue?.name;
        this._orderBy = getHistoricalReportPostRequestBodyParameterValue?.orderBy;
        this._search = getHistoricalReportPostRequestBodyParameterValue?.search;
        this._select = getHistoricalReportPostRequestBodyParameterValue?.select;
        this._skip = getHistoricalReportPostRequestBodyParameterValue?.skip;
        this._top = getHistoricalReportPostRequestBodyParameterValue?.top;
    };
    /**
