...
export class GetHistoricalReportRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetHistoricalReportRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: GetHistoricalReportRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetHistoricalReportResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
