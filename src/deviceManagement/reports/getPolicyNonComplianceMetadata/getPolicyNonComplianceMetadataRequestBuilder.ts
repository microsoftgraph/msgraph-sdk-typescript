...
import { deserializeIntoGetPolicyNonComplianceMetadataPostRequestBody, serializeGetPolicyNonComplianceMetadataPostRequestBody, type GetPolicyNonComplianceMetadataPostRequestBody } from './getPolicyNonComplianceMetadataPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface GetPolicyNonComplianceMetadataRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
