...
export class GetPolicyNonComplianceMetadataRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetPolicyNonComplianceMetadataPostRequestBody | undefined, requestConfiguration?: GetPolicyNonComplianceMetadataRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public post(body: GetPolicyNonComplianceMetadataPostRequestBody | undefined, requestConfiguration?: GetPolicyNonComplianceMetadataRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
        if(!body) throw new Error("body cannot be undefined");
