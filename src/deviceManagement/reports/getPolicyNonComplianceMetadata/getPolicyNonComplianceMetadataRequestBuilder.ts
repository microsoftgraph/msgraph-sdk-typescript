...
export class GetPolicyNonComplianceMetadataRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetPolicyNonComplianceMetadataRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: GetPolicyNonComplianceMetadataRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ReadableStream | undefined> {
        if(!body) throw new Error("body cannot be undefined");
