...
export class GetPolicyNonComplianceMetadataPostRequestBodyImpl implements GetPolicyNonComplianceMetadataPostRequestBody {
    ...
    public constructor(getPolicyNonComplianceMetadataPostRequestBodyParameterValue?: GetPolicyNonComplianceMetadataPostRequestBody | undefined) {
        this._additionalData = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.additionalData ? getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.filter;
        this._groupBy = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.groupBy;
        this._name = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.name;
        this._orderBy = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.orderBy;
        this._search = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.search;
        this._select = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.select;
        this._sessionId = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.sessionId;
        this._skip = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.skip;
        this._top = getPolicyNonComplianceMetadataPostRequestBodyParameterValue?.top;
    };
    /**
