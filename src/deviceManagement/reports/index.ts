...
import { createDeviceManagementReportsFromDiscriminatorValue, deserializeIntoDeviceManagementReports, serializeDeviceManagementReports, type DeviceManagementReports } from '../../models/';
...
export class ReportsRequestBuilder extends BaseRequestBuilder<ReportsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/reports{?%24select,%24expand}", (x, y) => new ReportsRequestBuilder(x, y));
    }
    /**
