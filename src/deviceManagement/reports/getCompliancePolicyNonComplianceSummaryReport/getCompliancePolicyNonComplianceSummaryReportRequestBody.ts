...
export class GetCompliancePolicyNonComplianceSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "filter": (o, n) => { (o as unknown as GetCompliancePolicyNonComplianceSummaryReportRequestBody).filter = n.getStringValue(); },
            "groupBy": (o, n) => { (o as unknown as GetCompliancePolicyNonComplianceSummaryReportRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); },
            "name": (o, n) => { (o as unknown as GetCompliancePolicyNonComplianceSummaryReportRequestBody).name = n.getStringValue(); },
            "orderBy": (o, n) => { (o as unknown as GetCompliancePolicyNonComplianceSummaryReportRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); },
            "search": (o, n) => { (o as unknown as GetCompliancePolicyNonComplianceSummaryReportRequestBody).search = n.getStringValue(); },
            "select": (o, n) => { (o as unknown as GetCompliancePolicyNonComplianceSummaryReportRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); },
            "sessionId": (o, n) => { (o as unknown as GetCompliancePolicyNonComplianceSummaryReportRequestBody).sessionId = n.getStringValue(); },
            "skip": (o, n) => { (o as unknown as GetCompliancePolicyNonComplianceSummaryReportRequestBody).skip = n.getNumberValue(); },
            "top": (o, n) => { (o as unknown as GetCompliancePolicyNonComplianceSummaryReportRequestBody).top = n.getNumberValue(); },
        };
    };
    /**
