...
export class GetCompliancePolicyNonComplianceSummaryReportRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetCompliancePolicyNonComplianceSummaryReportRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: GetCompliancePolicyNonComplianceSummaryReportRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetCompliancePolicyNonComplianceSummaryReportResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
