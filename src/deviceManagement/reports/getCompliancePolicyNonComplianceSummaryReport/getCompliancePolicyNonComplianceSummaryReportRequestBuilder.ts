...
export class GetCompliancePolicyNonComplianceSummaryReportRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetCompliancePolicyNonComplianceSummaryReportRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: GetCompliancePolicyNonComplianceSummaryReportRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ReadableStream | undefined> {
        if(!body) throw new Error("body cannot be undefined");
