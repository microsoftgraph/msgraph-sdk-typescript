...
export class GetCompliancePolicyNonComplianceSummaryReportRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetCompliancePolicyNonComplianceSummaryReportRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: GetCompliancePolicyNonComplianceSummaryReportRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetCompliancePolicyNonComplianceSummaryReportResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
