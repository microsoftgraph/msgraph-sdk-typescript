...
export class GetSettingNonComplianceReportRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetSettingNonComplianceReportPostRequestBody | undefined, requestConfiguration?: GetSettingNonComplianceReportRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public post(body: GetSettingNonComplianceReportPostRequestBody | undefined, requestConfiguration?: GetSettingNonComplianceReportRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
        if(!body) throw new Error("body cannot be undefined");
