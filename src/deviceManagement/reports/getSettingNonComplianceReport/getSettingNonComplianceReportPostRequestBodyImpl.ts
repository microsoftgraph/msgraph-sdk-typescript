...
export class GetSettingNonComplianceReportPostRequestBodyImpl implements GetSettingNonComplianceReportPostRequestBody {
    ...
    public constructor(getSettingNonComplianceReportPostRequestBodyParameterValue?: GetSettingNonComplianceReportPostRequestBody | undefined) {
        this._additionalData = getSettingNonComplianceReportPostRequestBodyParameterValue?.additionalData ? getSettingNonComplianceReportPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getSettingNonComplianceReportPostRequestBodyParameterValue?.filter;
        this._groupBy = getSettingNonComplianceReportPostRequestBodyParameterValue?.groupBy;
        this._name = getSettingNonComplianceReportPostRequestBodyParameterValue?.name;
        this._orderBy = getSettingNonComplianceReportPostRequestBodyParameterValue?.orderBy;
        this._search = getSettingNonComplianceReportPostRequestBodyParameterValue?.search;
        this._select = getSettingNonComplianceReportPostRequestBodyParameterValue?.select;
        this._sessionId = getSettingNonComplianceReportPostRequestBodyParameterValue?.sessionId;
        this._skip = getSettingNonComplianceReportPostRequestBodyParameterValue?.skip;
        this._top = getSettingNonComplianceReportPostRequestBodyParameterValue?.top;
    };
    /**
