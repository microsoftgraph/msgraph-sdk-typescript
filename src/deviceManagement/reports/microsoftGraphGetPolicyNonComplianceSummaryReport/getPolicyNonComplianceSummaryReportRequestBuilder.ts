...
export class GetPolicyNonComplianceSummaryReportRequestBuilder {
     ...
     */
    public post(body: GetPolicyNonComplianceSummaryReportPostRequestBody | undefined, requestConfiguration?: GetPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
     ...
     */
    public toPostRequestInformation(body: GetPolicyNonComplianceSummaryReportPostRequestBody | undefined, requestConfiguration?: GetPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
