...
export class GetPolicyNonComplianceReportRequestBuilder {
     ...
     */
    public post(body: GetPolicyNonComplianceReportPostRequestBody | undefined, requestConfiguration?: GetPolicyNonComplianceReportRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
        if(!body) throw new Error("body cannot be undefined");
