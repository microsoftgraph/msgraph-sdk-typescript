...
import { deserializeIntoGetPolicyNonComplianceReportPostRequestBody, serializeGetPolicyNonComplianceReportPostRequestBody, type GetPolicyNonComplianceReportPostRequestBody } from './getPolicyNonComplianceReportPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface GetPolicyNonComplianceReportRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
