...
export class GetPolicyNonComplianceSummaryReportRequestBuilder {
     ...
     */
    public post(body: GetPolicyNonComplianceSummaryReportRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
        if(!body) throw new Error("body cannot be undefined");
