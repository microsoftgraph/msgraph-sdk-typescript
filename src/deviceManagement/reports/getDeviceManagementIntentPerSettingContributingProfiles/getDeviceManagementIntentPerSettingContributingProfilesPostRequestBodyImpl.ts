...
export class GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyImpl implements GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody {
    ...
    public constructor(getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?: GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody | undefined) {
        this._additionalData = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.additionalData ? getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.filter;
        this._groupBy = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.groupBy;
        this._name = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.name;
        this._orderBy = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.orderBy;
        this._search = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.search;
        this._select = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.select;
        this._sessionId = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.sessionId;
        this._skip = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.skip;
        this._top = getDeviceManagementIntentPerSettingContributingProfilesPostRequestBodyParameterValue?.top;
    };
    /**
