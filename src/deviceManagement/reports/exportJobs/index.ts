...
import { createDeviceManagementExportJobCollectionResponseFromDiscriminatorValue, createDeviceManagementExportJobFromDiscriminatorValue, deserializeIntoDeviceManagementExportJob, serializeDeviceManagementExportJob, type DeviceManagementExportJob, type DeviceManagementExportJobCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeviceManagementExportJobItemRequestBuilder } from './item/';
 ...
 */
export class ExportJobsRequestBuilder extends BaseRequestBuilder<ExportJobsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/reports/exportJobs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ExportJobsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<ExportJobsRequestBuilderGetQueryParameters> | undefined) : Promise<DeviceManagementExportJobCollectionResponse | undefined> {
     ...
     */
    public post(body: DeviceManagementExportJob, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DeviceManagementExportJob | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<ExportJobsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, exportJobsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DeviceManagementExportJob, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
