...
import { createDeviceManagementExportJobCollectionResponseFromDiscriminatorValue, createDeviceManagementExportJobFromDiscriminatorValue, serializeDeviceManagementExportJob, type DeviceManagementExportJob, type DeviceManagementExportJobCollectionResponse } from '../../../models/';
 ...
 */
export const ExportJobsRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/reports/exportJobs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
