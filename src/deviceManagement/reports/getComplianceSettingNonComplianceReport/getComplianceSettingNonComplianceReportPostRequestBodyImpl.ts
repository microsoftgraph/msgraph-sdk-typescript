...
export class GetComplianceSettingNonComplianceReportPostRequestBodyImpl implements GetComplianceSettingNonComplianceReportPostRequestBody {
    ...
    public constructor(getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?: GetComplianceSettingNonComplianceReportPostRequestBody | undefined) {
        this._additionalData = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.additionalData ? getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.filter;
        this._groupBy = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.groupBy;
        this._name = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.name;
        this._orderBy = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.orderBy;
        this._search = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.search;
        this._select = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.select;
        this._sessionId = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.sessionId;
        this._skip = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.skip;
        this._top = getComplianceSettingNonComplianceReportPostRequestBodyParameterValue?.top;
    };
    /**
