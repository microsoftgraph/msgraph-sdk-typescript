...
export class GetComplianceSettingNonComplianceReportRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetComplianceSettingNonComplianceReportRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: GetComplianceSettingNonComplianceReportRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetComplianceSettingNonComplianceReportResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
