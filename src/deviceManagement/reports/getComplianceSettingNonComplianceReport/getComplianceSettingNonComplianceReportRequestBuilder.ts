...
import { deserializeIntoGetComplianceSettingNonComplianceReportPostRequestBody, serializeGetComplianceSettingNonComplianceReportPostRequestBody, type GetComplianceSettingNonComplianceReportPostRequestBody } from './getComplianceSettingNonComplianceReportPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface GetComplianceSettingNonComplianceReportRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
...
export class GetComplianceSettingNonComplianceReportRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a getComplianceSettingNonComplianceReportRequestBuilder
     */
    public withUrl(rawUrl: string) : GetComplianceSettingNonComplianceReportRequestBuilder {
