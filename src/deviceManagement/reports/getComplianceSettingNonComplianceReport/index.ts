 ...
 */
export class GetComplianceSettingNonComplianceReportRequestBuilder extends BaseRequestBuilder<GetComplianceSettingNonComplianceReportRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/reports/getComplianceSettingNonComplianceReport", (x, y) => new GetComplianceSettingNonComplianceReportRequestBuilder(x, y));
    }
    /**
     * Not yet documented
