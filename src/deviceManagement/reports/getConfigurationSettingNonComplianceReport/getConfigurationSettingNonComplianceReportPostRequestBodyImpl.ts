...
export class GetConfigurationSettingNonComplianceReportPostRequestBodyImpl implements GetConfigurationSettingNonComplianceReportPostRequestBody {
    ...
    public constructor(getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?: GetConfigurationSettingNonComplianceReportPostRequestBody | undefined) {
        this._additionalData = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.additionalData ? getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.additionalData! : {};
        this._filter = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.filter;
        this._groupBy = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.groupBy;
        this._name = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.name;
        this._orderBy = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.orderBy;
        this._search = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.search;
        this._select = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.select;
        this._sessionId = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.sessionId;
        this._skip = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.skip;
        this._top = getConfigurationSettingNonComplianceReportPostRequestBodyParameterValue?.top;
    };
    /**
