...
import { createDeviceAndAppManagementRoleAssignmentCollectionResponseFromDiscriminatorValue, createDeviceAndAppManagementRoleAssignmentFromDiscriminatorValue, deserializeIntoDeviceAndAppManagementRoleAssignment, serializeDeviceAndAppManagementRoleAssignment, type DeviceAndAppManagementRoleAssignment, type DeviceAndAppManagementRoleAssignmentCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeviceAndAppManagementRoleAssignmentItemRequestBuilder } from './item/';
 ...
 */
export class RoleAssignmentsRequestBuilder extends BaseRequestBuilder<RoleAssignmentsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RoleAssignmentsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<RoleAssignmentsRequestBuilderGetQueryParameters> | undefined) : Promise<DeviceAndAppManagementRoleAssignmentCollectionResponse | undefined> {
     ...
     */
    public post(body: DeviceAndAppManagementRoleAssignment, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DeviceAndAppManagementRoleAssignment | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DeviceAndAppManagementRoleAssignment, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
