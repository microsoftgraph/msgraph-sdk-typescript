...
export class RoleAssignmentsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as RoleAssignmentsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as RoleAssignmentsResponse).value = n.getCollectionOfObjectValues<DeviceAndAppManagementRoleAssignment>(DeviceAndAppManagementRoleAssignment); }],
        ]);
    };
    /**
