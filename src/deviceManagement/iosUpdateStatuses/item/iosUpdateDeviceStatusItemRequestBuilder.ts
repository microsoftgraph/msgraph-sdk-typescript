...
export class IosUpdateDeviceStatusItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public patch(body: IosUpdateDeviceStatus, requestConfiguration?: IosUpdateDeviceStatusItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<IosUpdateDeviceStatus | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: IosUpdateDeviceStatus, requestConfiguration?: IosUpdateDeviceStatusItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public withUrl(rawUrl: string) : IosUpdateDeviceStatusItemRequestBuilder {
