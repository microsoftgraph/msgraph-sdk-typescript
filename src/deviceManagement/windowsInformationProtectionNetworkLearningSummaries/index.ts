...
import { createWindowsInformationProtectionNetworkLearningSummaryCollectionResponseFromDiscriminatorValue, createWindowsInformationProtectionNetworkLearningSummaryFromDiscriminatorValue, deserializeIntoWindowsInformationProtectionNetworkLearningSummary, serializeWindowsInformationProtectionNetworkLearningSummary, type WindowsInformationProtectionNetworkLearningSummary, type WindowsInformationProtectionNetworkLearningSummaryCollectionResponse } from '../../models/';
 ...
 */
export class WindowsInformationProtectionNetworkLearningSummariesRequestBuilder extends BaseRequestBuilder<WindowsInformationProtectionNetworkLearningSummariesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/windowsInformationProtectionNetworkLearningSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new WindowsInformationProtectionNetworkLearningSummariesRequestBuilder(x, y));
    }
    /**
