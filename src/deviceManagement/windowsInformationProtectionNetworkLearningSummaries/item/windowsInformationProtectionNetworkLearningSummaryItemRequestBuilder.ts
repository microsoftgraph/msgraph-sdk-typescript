...
export class WindowsInformationProtectionNetworkLearningSummaryItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, windowsInformationProtectionNetworkLearningSummaryId?: string | undefined) {
