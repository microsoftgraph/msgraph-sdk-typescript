...
import {UserExperienceAnalyticsAppHealthOverviewRequestBuilderDeleteRequestConfiguration} from './userExperienceAnalyticsAppHealthOverviewRequestBuilderDeleteRequestConfiguration';
import {UserExperienceAnalyticsAppHealthOverviewRequestBuilderGetRequestConfiguration} from './userExperienceAnalyticsAppHealthOverviewRequestBuilderGetRequestConfiguration';
import {UserExperienceAnalyticsAppHealthOverviewRequestBuilderPatchRequestConfiguration} from './userExperienceAnalyticsAppHealthOverviewRequestBuilderPatchRequestConfiguration';
...
export class UserExperienceAnalyticsAppHealthOverviewRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a Promise of UserExperienceAnalyticsCategory
     */
    public patch(body: UserExperienceAnalyticsCategory | undefined, requestConfiguration?: UserExperienceAnalyticsAppHealthOverviewRequestBuilderPatchRequestConfiguration | undefined) : Promise<UserExperienceAnalyticsCategory | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: UserExperienceAnalyticsCategory | undefined, requestConfiguration?: UserExperienceAnalyticsAppHealthOverviewRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
