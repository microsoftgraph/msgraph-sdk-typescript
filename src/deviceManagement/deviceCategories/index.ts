...
import { createDeviceCategoryCollectionResponseFromDiscriminatorValue, createDeviceCategoryFromDiscriminatorValue, deserializeIntoDeviceCategory, serializeDeviceCategory, type DeviceCategory, type DeviceCategoryCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeviceCategoryItemRequestBuilder } from './item/';
 ...
 */
export class DeviceCategoriesRequestBuilder extends BaseRequestBuilder<DeviceCategoriesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceCategories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DeviceCategoriesRequestBuilder(x, y));
    }
    /**
