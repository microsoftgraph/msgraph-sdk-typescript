...
export class DeviceComplianceDeviceOverview extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["configurationVersion", (o, n) => { (o as unknown as DeviceComplianceDeviceOverview).configurationVersion = n.getNumberValue(); }],
            ["errorCount", (o, n) => { (o as unknown as DeviceComplianceDeviceOverview).errorCount = n.getNumberValue(); }],
            ["failedCount", (o, n) => { (o as unknown as DeviceComplianceDeviceOverview).failedCount = n.getNumberValue(); }],
            ["lastUpdateDateTime", (o, n) => { (o as unknown as DeviceComplianceDeviceOverview).lastUpdateDateTime = n.getDateValue(); }],
            ["notApplicableCount", (o, n) => { (o as unknown as DeviceComplianceDeviceOverview).notApplicableCount = n.getNumberValue(); }],
            ["pendingCount", (o, n) => { (o as unknown as DeviceComplianceDeviceOverview).pendingCount = n.getNumberValue(); }],
            ["successCount", (o, n) => { (o as unknown as DeviceComplianceDeviceOverview).successCount = n.getNumberValue(); }],
        ]);
    };
    /**
