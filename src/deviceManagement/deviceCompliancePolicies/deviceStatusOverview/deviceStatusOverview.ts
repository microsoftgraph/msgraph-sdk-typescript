...
export class DeviceStatusOverview extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["configurationVersion", (o, n) => { (o as unknown as DeviceStatusOverview).configurationVersion = n.getNumberValue(); }],
            ["errorCount", (o, n) => { (o as unknown as DeviceStatusOverview).errorCount = n.getNumberValue(); }],
            ["failedCount", (o, n) => { (o as unknown as DeviceStatusOverview).failedCount = n.getNumberValue(); }],
            ["lastUpdateDateTime", (o, n) => { (o as unknown as DeviceStatusOverview).lastUpdateDateTime = n.getDateValue(); }],
            ["notApplicableCount", (o, n) => { (o as unknown as DeviceStatusOverview).notApplicableCount = n.getNumberValue(); }],
            ["pendingCount", (o, n) => { (o as unknown as DeviceStatusOverview).pendingCount = n.getNumberValue(); }],
            ["successCount", (o, n) => { (o as unknown as DeviceStatusOverview).successCount = n.getNumberValue(); }],
        ]);
    };
    /**
