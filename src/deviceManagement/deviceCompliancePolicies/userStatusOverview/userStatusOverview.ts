...
export class UserStatusOverview extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["configurationVersion", (o, n) => { (o as unknown as UserStatusOverview).configurationVersion = n.getNumberValue(); }],
            ["errorCount", (o, n) => { (o as unknown as UserStatusOverview).errorCount = n.getNumberValue(); }],
            ["failedCount", (o, n) => { (o as unknown as UserStatusOverview).failedCount = n.getNumberValue(); }],
            ["lastUpdateDateTime", (o, n) => { (o as unknown as UserStatusOverview).lastUpdateDateTime = n.getDateValue(); }],
            ["notApplicableCount", (o, n) => { (o as unknown as UserStatusOverview).notApplicableCount = n.getNumberValue(); }],
            ["pendingCount", (o, n) => { (o as unknown as UserStatusOverview).pendingCount = n.getNumberValue(); }],
            ["successCount", (o, n) => { (o as unknown as UserStatusOverview).successCount = n.getNumberValue(); }],
        ]);
    };
    /**
