...
export class AssignmentsRequestBuilder extends BaseRequestBuilder<AssignmentsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AssignmentsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<AssignmentsRequestBuilderGetQueryParameters> | undefined) : Promise<DeviceCompliancePolicyAssignmentCollectionResponse | undefined> {
     ...
     */
    public post(body: DeviceCompliancePolicyAssignment, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DeviceCompliancePolicyAssignment | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DeviceCompliancePolicyAssignment, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
