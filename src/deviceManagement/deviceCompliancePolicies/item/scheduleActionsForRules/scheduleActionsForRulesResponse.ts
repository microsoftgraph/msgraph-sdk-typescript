...
export class ScheduleActionsForRulesResponse implements Parsable {
    ...
    /**
     * Instantiates a new scheduleActionsForRulesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["deviceComplianceScheduledActionForRules", (o, n) => { (o as unknown as ScheduleActionsForRulesResponse).deviceComplianceScheduledActionForRules = n.getCollectionOfObjectValues<DeviceComplianceScheduledActionForRule>(DeviceComplianceScheduledActionForRule); }],
        ]);
    };
    /**
