...
export class DeviceStatusOverviewRequestBuilder {
    ...
    public get(q?: {
        ...
        return this.requestAdapter?.sendAsync<DeviceComplianceDeviceOverview>(requestInfo, DeviceComplianceDeviceOverview, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Device compliance devices status overview
     * @param body 
