...
import { createSettingStateDeviceSummaryCollectionResponseFromDiscriminatorValue, createSettingStateDeviceSummaryFromDiscriminatorValue, deserializeIntoSettingStateDeviceSummary, serializeSettingStateDeviceSummary, type SettingStateDeviceSummary, type SettingStateDeviceSummaryCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { SettingStateDeviceSummaryItemRequestBuilder } from './item/';
 ...
 */
export class DeviceSettingStateSummariesRequestBuilder extends BaseRequestBuilder<DeviceSettingStateSummariesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/deviceSettingStateSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DeviceSettingStateSummariesRequestBuilder(x, y));
    }
    /**
