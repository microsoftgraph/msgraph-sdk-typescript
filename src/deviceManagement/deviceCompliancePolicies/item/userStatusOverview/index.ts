...
import { createDeviceComplianceUserOverviewFromDiscriminatorValue, deserializeIntoDeviceComplianceUserOverview, serializeDeviceComplianceUserOverview, type DeviceComplianceUserOverview } from '../../../../models/';
...
export class UserStatusOverviewRequestBuilder extends BaseRequestBuilder<UserStatusOverviewRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/userStatusOverview{?%24select,%24expand}", (x, y) => new UserStatusOverviewRequestBuilder(x, y));
    }
    /**
