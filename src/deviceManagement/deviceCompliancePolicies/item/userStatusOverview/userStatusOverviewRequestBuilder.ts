import {DeviceComplianceUserOverviewImpl} from '../../../../models/';
...
export class UserStatusOverviewRequestBuilder {
    ...
    public createPatchRequestInformation(body: DeviceComplianceUserOverview | undefined, requestConfiguration?: UserStatusOverviewRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new DeviceComplianceUserOverviewImpl(body)
     ...
     */
    public get(requestConfiguration?: UserStatusOverviewRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceUserOverviewImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceComplianceUserOverviewImpl>(requestInfo, createDeviceComplianceUserOverviewFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Update the navigation property userStatusOverview in deviceManagement
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: DeviceComplianceUserOverview | undefined, requestConfiguration?: UserStatusOverviewRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
