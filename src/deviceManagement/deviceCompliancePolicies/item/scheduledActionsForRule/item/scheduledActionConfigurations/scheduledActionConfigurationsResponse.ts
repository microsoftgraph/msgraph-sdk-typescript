...
export class ScheduledActionConfigurationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ScheduledActionConfigurationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ScheduledActionConfigurationsResponse).value = n.getCollectionOfObjectValues<DeviceComplianceActionItem>(DeviceComplianceActionItem); }],
        ]);
    };
    /**
