...
import { createDeviceComplianceScheduledActionForRuleCollectionResponseFromDiscriminatorValue, createDeviceComplianceScheduledActionForRuleFromDiscriminatorValue, deserializeIntoDeviceComplianceScheduledActionForRule, serializeDeviceComplianceScheduledActionForRule, type DeviceComplianceScheduledActionForRule, type DeviceComplianceScheduledActionForRuleCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeviceComplianceScheduledActionForRuleItemRequestBuilder } from './item/';
 ...
 */
export class ScheduledActionsForRuleRequestBuilder extends BaseRequestBuilder<ScheduledActionsForRuleRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/scheduledActionsForRule{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ScheduledActionsForRuleRequestBuilder(x, y));
    }
    /**
