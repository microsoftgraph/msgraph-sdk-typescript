...
export class DeviceComplianceUserStatusItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: DeviceComplianceUserStatusItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
