import {DeviceComplianceUserStatusCollectionResponseImpl, DeviceComplianceUserStatusImpl} from '../../../../models/';
...
import {DeviceComplianceUserStatusCollectionResponse} from '../../../../models/deviceComplianceUserStatusCollectionResponse';
...
export class UserStatusesRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: DeviceComplianceUserStatus | undefined, requestConfiguration?: UserStatusesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new DeviceComplianceUserStatusImpl(body)
    ...
    public get(requestConfiguration?: UserStatusesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceUserStatusCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceComplianceUserStatusCollectionResponseImpl>(requestInfo, createDeviceComplianceUserStatusCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to userStatuses for deviceManagement
     * @param body 
