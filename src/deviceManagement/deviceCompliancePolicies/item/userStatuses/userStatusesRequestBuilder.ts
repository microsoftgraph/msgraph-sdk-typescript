...
export class UserStatusesRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: DeviceComplianceUserStatus | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public get(queryParameters?: UserStatusesRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceUserStatusCollectionResponse | undefined> {
     ...
     */
    public post(body: DeviceComplianceUserStatus | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceUserStatus | undefined> {
        if(!body) throw new Error("body cannot be undefined");
