...
import { createDeviceComplianceUserStatusCollectionResponseFromDiscriminatorValue, createDeviceComplianceUserStatusFromDiscriminatorValue, deserializeIntoDeviceComplianceUserStatus, serializeDeviceComplianceUserStatus, type DeviceComplianceUserStatus, type DeviceComplianceUserStatusCollectionResponse } from '../../../../models/';
 ...
 */
export class UserStatusesRequestBuilder extends BaseRequestBuilder<UserStatusesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/userStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UserStatusesRequestBuilder(x, y));
    }
    /**
