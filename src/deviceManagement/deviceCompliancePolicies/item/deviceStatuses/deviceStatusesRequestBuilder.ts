...
export class DeviceStatusesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<DeviceStatusesRequestBuilderGetQueryParameters> | undefined) : Promise<DeviceComplianceDeviceStatusCollectionResponse | undefined> {
     ...
     */
    public post(body: DeviceComplianceDeviceStatus, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DeviceComplianceDeviceStatus | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DeviceComplianceDeviceStatus, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
