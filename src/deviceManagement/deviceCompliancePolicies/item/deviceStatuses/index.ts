...
import { createDeviceComplianceDeviceStatusCollectionResponseFromDiscriminatorValue, createDeviceComplianceDeviceStatusFromDiscriminatorValue, deserializeIntoDeviceComplianceDeviceStatus, serializeDeviceComplianceDeviceStatus, type DeviceComplianceDeviceStatus, type DeviceComplianceDeviceStatusCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeviceComplianceDeviceStatusItemRequestBuilder } from './item/';
...
export class DeviceStatusesRequestBuilder extends BaseRequestBuilder<DeviceStatusesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/deviceStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DeviceStatusesRequestBuilder(x, y));
    }
    /**
