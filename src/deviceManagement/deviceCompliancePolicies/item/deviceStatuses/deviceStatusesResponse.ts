...
export class DeviceStatusesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceStatusesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceStatusesResponse).value = n.getCollectionOfObjectValues<DeviceComplianceDeviceStatus>(DeviceComplianceDeviceStatus); }],
        ]);
    };
    /**
