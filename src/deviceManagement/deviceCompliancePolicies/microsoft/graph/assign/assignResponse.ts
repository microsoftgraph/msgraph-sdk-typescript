...
export class Microsoft.graph.assignResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["assignments", (o, n) => { (o as unknown as Microsoft.graph.assignResponse).assignments = n.getCollectionOfObjectValues<DeviceCompliancePolicyAssignment>(DeviceCompliancePolicyAssignment); }],
        ]);
    };
    /**
