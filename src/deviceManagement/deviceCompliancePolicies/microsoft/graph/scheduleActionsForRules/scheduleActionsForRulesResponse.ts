...
export class Microsoft.graph.scheduleActionsForRulesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["deviceComplianceScheduledActionForRules", (o, n) => { (o as unknown as Microsoft.graph.scheduleActionsForRulesResponse).deviceComplianceScheduledActionForRules = n.getCollectionOfObjectValues<DeviceComplianceScheduledActionForRule>(DeviceComplianceScheduledActionForRule); }],
        ]);
    };
    /**
