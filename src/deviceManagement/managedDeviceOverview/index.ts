...
import { createManagedDeviceOverviewFromDiscriminatorValue, type ManagedDeviceOverview } from '../../models/';
 ...
 */
export class ManagedDeviceOverviewRequestBuilder extends BaseRequestBuilder<ManagedDeviceOverviewRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/managedDeviceOverview{?%24select,%24expand}", (x, y) => new ManagedDeviceOverviewRequestBuilder(x, y));
    }
    /**
