...
import {MicrosoftGraphGetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration} from './microsoftGraphGetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the getAuditActivityTypes method.
 */
export class MicrosoftGraphGetAuditActivityTypesWithCategoryRequestBuilder {
     ...
     */
    public get(requestConfiguration?: MicrosoftGraphGetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetAuditActivityTypesWithCategoryResponse | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: MicrosoftGraphGetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
