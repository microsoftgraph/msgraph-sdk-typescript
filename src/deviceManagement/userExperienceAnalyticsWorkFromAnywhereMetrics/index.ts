...
import { createUserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponseFromDiscriminatorValue, createUserExperienceAnalyticsWorkFromAnywhereMetricFromDiscriminatorValue, deserializeIntoUserExperienceAnalyticsWorkFromAnywhereMetric, serializeUserExperienceAnalyticsWorkFromAnywhereMetric, type UserExperienceAnalyticsWorkFromAnywhereMetric, type UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { UserExperienceAnalyticsWorkFromAnywhereMetricItemRequestBuilder } from './item/';
 ...
 */
export class UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilder extends BaseRequestBuilder<UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilderGetQueryParameters> | undefined) : Promise<UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse | undefined> {
     ...
     */
    public post(body: UserExperienceAnalyticsWorkFromAnywhereMetric, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<UserExperienceAnalyticsWorkFromAnywhereMetric | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, userExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: UserExperienceAnalyticsWorkFromAnywhereMetric, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
