...
import {UserExperienceAnalyticsWorkFromAnywhereMetric} from '../../../models/userExperienceAnalyticsWorkFromAnywhereMetric';
...
export class UserExperienceAnalyticsWorkFromAnywhereMetricItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a Promise of UserExperienceAnalyticsWorkFromAnywhereMetric
     */
    public patch(body: UserExperienceAnalyticsWorkFromAnywhereMetric | undefined, requestConfiguration?: UserExperienceAnalyticsWorkFromAnywhereMetricItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<UserExperienceAnalyticsWorkFromAnywhereMetric | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: UserExperienceAnalyticsWorkFromAnywhereMetric | undefined, requestConfiguration?: UserExperienceAnalyticsWorkFromAnywhereMetricItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeUserExperienceAnalyticsWorkFromAnywhereMetric);
        return requestInfo;
    };
}
