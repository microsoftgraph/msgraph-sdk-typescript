...
import { createRemoteAssistancePartnerCollectionResponseFromDiscriminatorValue, createRemoteAssistancePartnerFromDiscriminatorValue, deserializeIntoRemoteAssistancePartner, serializeRemoteAssistancePartner, type RemoteAssistancePartner, type RemoteAssistancePartnerCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { RemoteAssistancePartnerItemRequestBuilder } from './item/';
 ...
 */
export class RemoteAssistancePartnersRequestBuilder extends BaseRequestBuilder<RemoteAssistancePartnersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/remoteAssistancePartners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RemoteAssistancePartnersRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<RemoteAssistancePartnersRequestBuilderGetQueryParameters> | undefined) : Promise<RemoteAssistancePartnerCollectionResponse | undefined> {
     ...
     */
    public post(body: RemoteAssistancePartner, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<RemoteAssistancePartner | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<RemoteAssistancePartnersRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, remoteAssistancePartnersRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: RemoteAssistancePartner, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
