 ...
 */
export class BeginOnboardingRequestBuilder extends BaseRequestBuilder<BeginOnboardingRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/remoteAssistancePartners/{remoteAssistancePartner%2Did}/beginOnboarding", (x, y) => new BeginOnboardingRequestBuilder(x, y));
    }
    /**
