...
import { type DisconnectRequestBuilderPostRequestConfiguration } from './disconnectRequestBuilderPostRequestConfiguration';
...
export class DisconnectRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a disconnectRequestBuilder
     */
    public withUrl(rawUrl: string) : DisconnectRequestBuilder {
