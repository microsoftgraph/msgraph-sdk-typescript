...
export class UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a userExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder
     */
    public withUrl(rawUrl: string) : UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder {
