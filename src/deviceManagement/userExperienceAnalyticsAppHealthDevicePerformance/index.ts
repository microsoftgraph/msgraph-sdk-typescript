 ...
 */
export class UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder extends BaseRequestBuilder<UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderGetQueryParameters> | undefined) : Promise<UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse | undefined> {
     ...
     */
    public post(body: UserExperienceAnalyticsAppHealthDevicePerformance, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<UserExperienceAnalyticsAppHealthDevicePerformance | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, userExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: UserExperienceAnalyticsAppHealthDevicePerformance, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
