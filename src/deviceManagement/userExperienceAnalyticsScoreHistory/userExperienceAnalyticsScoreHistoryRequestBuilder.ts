...
export class UserExperienceAnalyticsScoreHistoryRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: UserExperienceAnalyticsScoreHistory | undefined, requestConfiguration?: UserExperienceAnalyticsScoreHistoryRequestBuilderPostRequestConfiguration | undefined) : Promise<UserExperienceAnalyticsScoreHistory | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: UserExperienceAnalyticsScoreHistory | undefined, requestConfiguration?: UserExperienceAnalyticsScoreHistoryRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
