...
export class VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilder {
     ...
     */
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter, domainName?: string | undefined) {
        ...
        domainName && urlTplParams.set("domainName", domainName);
     ...
     */
    public get(h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<boolean | undefined> {
