...
import { type VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponse } from './index';
import { createVerifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponseFromDiscriminatorValue } from './verifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponse';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilderGetRequestConfiguration {
    /**
     * Request headers
     */
...
export class VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilderGetRequestConfiguration | undefined) : Promise<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponse | undefined> {
