...
import { createResourceOperationCollectionResponseFromDiscriminatorValue, createResourceOperationFromDiscriminatorValue, deserializeIntoResourceOperation, serializeResourceOperation, type ResourceOperation, type ResourceOperationCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ResourceOperationItemRequestBuilder } from './item/';
 ...
 */
export class ResourceOperationsRequestBuilder extends BaseRequestBuilder<ResourceOperationsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/resourceOperations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ResourceOperationsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<ResourceOperationsRequestBuilderGetQueryParameters> | undefined) : Promise<ResourceOperationCollectionResponse | undefined> {
     ...
     */
    public post(body: ResourceOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ResourceOperation | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<ResourceOperationsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, resourceOperationsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: ResourceOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
