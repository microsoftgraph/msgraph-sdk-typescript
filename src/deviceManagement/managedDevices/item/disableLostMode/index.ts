...
export class DisableLostModeRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/disableLostMode");
    };
    /**
     * Disable lost mode
     ...
     * @returns a disableLostModeRequestBuilder
     */
    public withUrl(rawUrl: string) : DisableLostModeRequestBuilder {
