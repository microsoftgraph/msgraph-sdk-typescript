...
import { createManagedDeviceFromDiscriminatorValue, deserializeIntoManagedDevice, serializeManagedDevice, type ManagedDevice } from '../../../models/';
...
import { LogCollectionRequestsRequestBuilder } from './logCollectionRequests/';
...
import { WindowsProtectionStateRequestBuilder } from './windowsProtectionState/';
...
export class ManagedDeviceItemRequestBuilder extends BaseRequestBuilder<ManagedDeviceItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}{?%24select,%24expand}", (x, y) => new ManagedDeviceItemRequestBuilder(x, y));
    }
    /**
