 ...
 */
export const DeleteUserFromSharedAppleDeviceRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deleteUserFromSharedAppleDevice";
/* tslint:enable */
/* eslint-enable */
