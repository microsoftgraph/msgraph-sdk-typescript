...
export interface DeviceConfigurationStateItemRequestBuilderDeleteRequestConfiguration {
    /**
     * Request headers
     */
...
export interface DeviceConfigurationStateItemRequestBuilderPatchRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
