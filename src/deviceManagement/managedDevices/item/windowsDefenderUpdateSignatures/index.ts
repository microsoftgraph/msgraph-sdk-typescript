 ...
 */
export class WindowsDefenderUpdateSignaturesRequestBuilder extends BaseRequestBuilder<WindowsDefenderUpdateSignaturesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures", (x, y) => new WindowsDefenderUpdateSignaturesRequestBuilder(x, y));
    }
    /**
     * Not yet documented
