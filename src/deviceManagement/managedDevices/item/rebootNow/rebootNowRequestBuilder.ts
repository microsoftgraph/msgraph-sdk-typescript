...
/** Builds and executes requests for operations under /deviceManagement/managedDevices/{managedDevice-id}/microsoft.graph.rebootNow  */
export class RebootNowRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice_id}/microsoft.graph.rebootNow";
