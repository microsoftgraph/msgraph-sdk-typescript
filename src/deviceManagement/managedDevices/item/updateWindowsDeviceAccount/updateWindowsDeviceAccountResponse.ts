...
export class UpdateWindowsDeviceAccountResponse implements Parsable {
    ...
    /**
     * Instantiates a new updateWindowsDeviceAccountResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["updateWindowsDeviceAccountActionParameter", (o, n) => { (o as unknown as UpdateWindowsDeviceAccountResponse).updateWindowsDeviceAccountActionParameter = n.getObjectValue<UpdateWindowsDeviceAccountActionParameter>(UpdateWindowsDeviceAccountActionParameter); }],
        ]);
    };
    /**
