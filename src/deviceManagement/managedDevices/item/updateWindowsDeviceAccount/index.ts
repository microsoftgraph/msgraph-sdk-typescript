...
export class UpdateWindowsDeviceAccountRequestBuilder extends BaseRequestBuilder<UpdateWindowsDeviceAccountRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/updateWindowsDeviceAccount", (x, y) => new UpdateWindowsDeviceAccountRequestBuilder(x, y));
    }
    /**
     * Not yet documented
