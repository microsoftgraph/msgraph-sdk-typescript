...
export class ManagedDeviceRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.deviceManagement.managedDevices.item.deviceCompliancePolicyStates.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.deviceManagement.managedDevices.item.deviceConfigurationStates.item collection
     * @param id Unique identifier of the item
