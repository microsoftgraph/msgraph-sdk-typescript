...
export class Microsoft.graph.updateWindowsDeviceAccountResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["updateWindowsDeviceAccountActionParameter", (o, n) => { (o as unknown as Microsoft.graph.updateWindowsDeviceAccountResponse).updateWindowsDeviceAccountActionParameter = n.getObjectValue<UpdateWindowsDeviceAccountActionParameter>(UpdateWindowsDeviceAccountActionParameter); }],
        ]);
    };
    /**
