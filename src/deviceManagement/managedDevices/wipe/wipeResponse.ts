...
export class WipeResponse implements Parsable {
    ...
    /**
     * Instantiates a new wipeResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["keepEnrollmentData", (o, n) => { (o as unknown as WipeResponse).keepEnrollmentData = n.getBooleanValue(); }],
            ["keepUserData", (o, n) => { (o as unknown as WipeResponse).keepUserData = n.getBooleanValue(); }],
            ["macOsUnlockCode", (o, n) => { (o as unknown as WipeResponse).macOsUnlockCode = n.getStringValue(); }],
            ["persistEsimDataPlan", (o, n) => { (o as unknown as WipeResponse).persistEsimDataPlan = n.getBooleanValue(); }],
        ]);
    };
    /**
