...
export class SoftwareUpdateStatusSummaryRequestBuilder {
     ...
     */
    public createGetRequestInformation(queryParameters?: SoftwareUpdateStatusSummaryRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public get(queryParameters?: SoftwareUpdateStatusSummaryRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SoftwareUpdateStatusSummary | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SoftwareUpdateStatusSummary>(requestInfo, createSoftwareUpdateStatusSummaryFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
