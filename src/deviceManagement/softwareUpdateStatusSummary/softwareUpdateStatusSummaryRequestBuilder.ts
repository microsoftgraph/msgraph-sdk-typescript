...
export class SoftwareUpdateStatusSummaryRequestBuilder {
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/softwareUpdateStatusSummary";
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SoftwareUpdateStatusSummary | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<SoftwareUpdateStatusSummary>(requestInfo, SoftwareUpdateStatusSummary, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
