...
export class DeviceConfigurationDeviceStateSummaries extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["compliantDeviceCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceStateSummaries).compliantDeviceCount = n.getNumberValue(); }],
            ["conflictDeviceCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceStateSummaries).conflictDeviceCount = n.getNumberValue(); }],
            ["errorDeviceCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceStateSummaries).errorDeviceCount = n.getNumberValue(); }],
            ["nonCompliantDeviceCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceStateSummaries).nonCompliantDeviceCount = n.getNumberValue(); }],
            ["notApplicableDeviceCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceStateSummaries).notApplicableDeviceCount = n.getNumberValue(); }],
            ["remediatedDeviceCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceStateSummaries).remediatedDeviceCount = n.getNumberValue(); }],
            ["unknownDeviceCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceStateSummaries).unknownDeviceCount = n.getNumberValue(); }],
        ]);
    };
    /**
