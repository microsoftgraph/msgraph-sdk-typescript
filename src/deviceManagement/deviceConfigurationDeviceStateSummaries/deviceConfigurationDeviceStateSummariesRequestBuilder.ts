import {DeviceConfigurationDeviceStateSummaryImpl} from '../../models/';
...
export class DeviceConfigurationDeviceStateSummariesRequestBuilder {
    ...
    public createPatchRequestInformation(body: DeviceConfigurationDeviceStateSummary | undefined, requestConfiguration?: DeviceConfigurationDeviceStateSummariesRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new DeviceConfigurationDeviceStateSummaryImpl(body)
     ...
     */
    public get(requestConfiguration?: DeviceConfigurationDeviceStateSummariesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceConfigurationDeviceStateSummaryImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceConfigurationDeviceStateSummaryImpl>(requestInfo, createDeviceConfigurationDeviceStateSummaryFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Update the navigation property deviceConfigurationDeviceStateSummaries in deviceManagement
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: DeviceConfigurationDeviceStateSummary | undefined, requestConfiguration?: DeviceConfigurationDeviceStateSummariesRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
