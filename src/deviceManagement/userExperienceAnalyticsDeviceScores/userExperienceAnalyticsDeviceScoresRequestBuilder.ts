...
export interface UserExperienceAnalyticsDeviceScoresRequestBuilderGetRequestConfiguration {
    /**
     * Request headers
     */
...
export interface UserExperienceAnalyticsDeviceScoresRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
