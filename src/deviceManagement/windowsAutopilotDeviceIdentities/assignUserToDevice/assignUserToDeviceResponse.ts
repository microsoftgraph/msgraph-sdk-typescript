...
export class AssignUserToDeviceResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _addressableUserName?: string | undefined;
    private _userPrincipalName?: string | undefined;
    /**
     * Instantiates a new assignUserToDeviceResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["addressableUserName", (o, n) => { (o as unknown as AssignUserToDeviceResponse).addressableUserName = n.getStringValue(); }],
            ["userPrincipalName", (o, n) => { (o as unknown as AssignUserToDeviceResponse).userPrincipalName = n.getStringValue(); }],
        ]);
    };
    /**
