...
import { type UnassignUserFromDeviceRequestBuilderPostRequestConfiguration } from './unassignUserFromDeviceRequestBuilderPostRequestConfiguration';
...
export class UnassignUserFromDeviceRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a unassignUserFromDeviceRequestBuilder
     */
    public withUrl(rawUrl: string) : UnassignUserFromDeviceRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new UnassignUserFromDeviceRequestBuilder(rawUrl, this.requestAdapter);
    };
}
