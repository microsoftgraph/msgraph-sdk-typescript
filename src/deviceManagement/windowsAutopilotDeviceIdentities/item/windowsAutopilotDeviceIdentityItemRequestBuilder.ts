import {WindowsAutopilotDeviceIdentityImpl} from '../../../models/';
...
export class WindowsAutopilotDeviceIdentityItemRequestBuilder {
    ...
    public createPatchRequestInformation(body: WindowsAutopilotDeviceIdentity | undefined, requestConfiguration?: WindowsAutopilotDeviceIdentityItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new WindowsAutopilotDeviceIdentityImpl(body)
     ...
     */
    public get(requestConfiguration?: WindowsAutopilotDeviceIdentityItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WindowsAutopilotDeviceIdentityImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<WindowsAutopilotDeviceIdentityImpl>(requestInfo, createWindowsAutopilotDeviceIdentityFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Update the navigation property windowsAutopilotDeviceIdentities in deviceManagement
     * @param body 
