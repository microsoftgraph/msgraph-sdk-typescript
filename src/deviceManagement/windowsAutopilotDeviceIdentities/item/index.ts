...
import { createWindowsAutopilotDeviceIdentityFromDiscriminatorValue, deserializeIntoWindowsAutopilotDeviceIdentity, serializeWindowsAutopilotDeviceIdentity, type WindowsAutopilotDeviceIdentity } from '../../../models/';
 ...
 */
export class WindowsAutopilotDeviceIdentityItemRequestBuilder extends BaseRequestBuilder<WindowsAutopilotDeviceIdentityItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/windowsAutopilotDeviceIdentities/{windowsAutopilotDeviceIdentity%2Did}{?%24select,%24expand}", (x, y) => new WindowsAutopilotDeviceIdentityItemRequestBuilder(x, y));
    }
    /**
