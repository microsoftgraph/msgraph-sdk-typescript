...
export class AssignUserToDeviceRequestBuilder {
     ...
     */
    public post(body: AssignUserToDeviceRequestBodyImpl | undefined, requestConfiguration?: AssignUserToDeviceRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
