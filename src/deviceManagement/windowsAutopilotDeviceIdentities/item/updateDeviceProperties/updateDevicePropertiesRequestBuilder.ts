...
export class UpdateDevicePropertiesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see {@link https://docs.microsoft.com/graph/api/intune-enrollment-windowsautopilotdeviceidentity-updatedeviceproperties?view=graph-rest-1.0|Find more info here}
     */
    public post(body: UpdateDevicePropertiesPostRequestBody | undefined, requestConfiguration?: UpdateDevicePropertiesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: UpdateDevicePropertiesPostRequestBody | undefined, requestConfiguration?: UpdateDevicePropertiesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeUpdateDevicePropertiesPostRequestBody);
        return requestInfo;
    };
}
