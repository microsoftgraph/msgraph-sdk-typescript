...
export class WindowsAutopilotDeviceIdentitiesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as WindowsAutopilotDeviceIdentitiesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as WindowsAutopilotDeviceIdentitiesResponse).value = n.getCollectionOfObjectValues<WindowsAutopilotDeviceIdentity>(WindowsAutopilotDeviceIdentity); }],
        ]);
    };
    /**
