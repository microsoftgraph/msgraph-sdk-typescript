...
export class Microsoft.graph.assignUserToDeviceResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["addressableUserName", (o, n) => { (o as unknown as Microsoft.graph.assignUserToDeviceResponse).addressableUserName = n.getStringValue(); }],
            ["userPrincipalName", (o, n) => { (o as unknown as Microsoft.graph.assignUserToDeviceResponse).userPrincipalName = n.getStringValue(); }],
        ]);
    };
    /**
