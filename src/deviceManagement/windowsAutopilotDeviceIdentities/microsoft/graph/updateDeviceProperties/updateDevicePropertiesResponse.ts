...
export class Microsoft.graph.updateDevicePropertiesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["addressableUserName", (o, n) => { (o as unknown as Microsoft.graph.updateDevicePropertiesResponse).addressableUserName = n.getStringValue(); }],
            ["displayName", (o, n) => { (o as unknown as Microsoft.graph.updateDevicePropertiesResponse).displayName = n.getStringValue(); }],
            ["groupTag", (o, n) => { (o as unknown as Microsoft.graph.updateDevicePropertiesResponse).groupTag = n.getStringValue(); }],
            ["userPrincipalName", (o, n) => { (o as unknown as Microsoft.graph.updateDevicePropertiesResponse).userPrincipalName = n.getStringValue(); }],
        ]);
    };
    /**
