...
export class UpdateDevicePropertiesResponse implements Parsable {
    ...
    /**
     * Instantiates a new updateDevicePropertiesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["addressableUserName", (o, n) => { (o as unknown as UpdateDevicePropertiesResponse).addressableUserName = n.getStringValue(); }],
            ["displayName", (o, n) => { (o as unknown as UpdateDevicePropertiesResponse).displayName = n.getStringValue(); }],
            ["groupTag", (o, n) => { (o as unknown as UpdateDevicePropertiesResponse).groupTag = n.getStringValue(); }],
            ["userPrincipalName", (o, n) => { (o as unknown as UpdateDevicePropertiesResponse).userPrincipalName = n.getStringValue(); }],
        ]);
    };
    /**
