...
import { createWindowsAutopilotDeviceIdentityCollectionResponseFromDiscriminatorValue, createWindowsAutopilotDeviceIdentityFromDiscriminatorValue, deserializeIntoWindowsAutopilotDeviceIdentity, serializeWindowsAutopilotDeviceIdentity, type WindowsAutopilotDeviceIdentity, type WindowsAutopilotDeviceIdentityCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { WindowsAutopilotDeviceIdentityItemRequestBuilder } from './item/';
 ...
 */
export class WindowsAutopilotDeviceIdentitiesRequestBuilder extends BaseRequestBuilder<WindowsAutopilotDeviceIdentitiesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/windowsAutopilotDeviceIdentities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new WindowsAutopilotDeviceIdentitiesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<WindowsAutopilotDeviceIdentitiesRequestBuilderGetQueryParameters> | undefined) : Promise<WindowsAutopilotDeviceIdentityCollectionResponse | undefined> {
     ...
     */
    public post(body: WindowsAutopilotDeviceIdentity, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<WindowsAutopilotDeviceIdentity | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<WindowsAutopilotDeviceIdentitiesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, windowsAutopilotDeviceIdentitiesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: WindowsAutopilotDeviceIdentity, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
