...
import { createTelecomExpenseManagementPartnerCollectionResponseFromDiscriminatorValue, createTelecomExpenseManagementPartnerFromDiscriminatorValue, deserializeIntoTelecomExpenseManagementPartner, serializeTelecomExpenseManagementPartner, type TelecomExpenseManagementPartner, type TelecomExpenseManagementPartnerCollectionResponse } from '../../models/';
 ...
 */
export class TelecomExpenseManagementPartnersRequestBuilder extends BaseRequestBuilder<TelecomExpenseManagementPartnersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/telecomExpenseManagementPartners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TelecomExpenseManagementPartnersRequestBuilder(x, y));
    }
    /**
