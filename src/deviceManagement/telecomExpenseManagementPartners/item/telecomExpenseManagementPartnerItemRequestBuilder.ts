...
export class TelecomExpenseManagementPartnerItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, telecomExpenseManagementPartnerId?: string | undefined) {
