...
export class ApplePushNotificationCertificateRequestBuilder {
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/applePushNotificationCertificate";
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: ApplePushNotificationCertificate | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApplePushNotificationCertificate | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<ApplePushNotificationCertificate>(requestInfo, ApplePushNotificationCertificate, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Apple push notification certificate.
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: ApplePushNotificationCertificate | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
