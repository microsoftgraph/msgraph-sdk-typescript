...
export class Microsoft.graph.downloadApplePushNotificationCertificateSigningRequestRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.downloadApplePushNotificationCertificateSigningRequestRequestBuilder and sets the default values.
