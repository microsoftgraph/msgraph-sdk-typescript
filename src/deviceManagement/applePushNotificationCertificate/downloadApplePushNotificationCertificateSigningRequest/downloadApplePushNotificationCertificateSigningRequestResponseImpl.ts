...
export class DownloadApplePushNotificationCertificateSigningRequestResponseImpl implements DownloadApplePushNotificationCertificateSigningRequestResponse {
    ...
    public constructor(downloadApplePushNotificationCertificateSigningRequestResponseParameterValue?: DownloadApplePushNotificationCertificateSigningRequestResponse | undefined) {
        this._additionalData = downloadApplePushNotificationCertificateSigningRequestResponseParameterValue?.additionalData ? downloadApplePushNotificationCertificateSigningRequestResponseParameterValue?.additionalData! : {};
        this._value = downloadApplePushNotificationCertificateSigningRequestResponseParameterValue?.value;
    };
    /**
