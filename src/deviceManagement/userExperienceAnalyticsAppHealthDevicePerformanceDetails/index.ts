...
import { createUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponseFromDiscriminatorValue, createUserExperienceAnalyticsAppHealthDevicePerformanceDetailsFromDiscriminatorValue, deserializeIntoUserExperienceAnalyticsAppHealthDevicePerformanceDetails, serializeUserExperienceAnalyticsAppHealthDevicePerformanceDetails, type UserExperienceAnalyticsAppHealthDevicePerformanceDetails, type UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponse } from '../../models/';
 ...
 */
export class UserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder extends BaseRequestBuilder<UserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder(x, y));
    }
    /**
