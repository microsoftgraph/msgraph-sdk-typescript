...
export class Microsoft.graph.syncResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["syncType", (o, n) => { (o as unknown as Microsoft.graph.syncResponse).syncType = n.getObjectValue<DeviceManagementExchangeConnectorSyncType>(DeviceManagementExchangeConnectorSyncType); }],
        ]);
    };
    /**
