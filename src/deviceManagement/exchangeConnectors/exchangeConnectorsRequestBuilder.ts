import {DeviceManagementExchangeConnectorCollectionResponseImpl, DeviceManagementExchangeConnectorImpl} from '../../models/';
...
export class ExchangeConnectorsRequestBuilder {
     ...
     */
    public get(requestConfiguration?: ExchangeConnectorsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceManagementExchangeConnectorCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceManagementExchangeConnectorCollectionResponseImpl>(requestInfo, createDeviceManagementExchangeConnectorCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to exchangeConnectors for deviceManagement
     * @param body 
     ...
     */
    public post(body: DeviceManagementExchangeConnector | undefined, requestConfiguration?: ExchangeConnectorsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceManagementExchangeConnectorImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        ...
        return this.requestAdapter?.sendAsync<DeviceManagementExchangeConnectorImpl>(requestInfo, createDeviceManagementExchangeConnectorFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
