...
export class DeviceConfigurationAssignmentItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, deviceConfigurationAssignmentId?: string | undefined) {
