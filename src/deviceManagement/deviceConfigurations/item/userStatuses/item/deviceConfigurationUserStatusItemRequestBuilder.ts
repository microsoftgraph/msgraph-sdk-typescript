...
export class DeviceConfigurationUserStatusItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, deviceConfigurationUserStatusId?: string | undefined) {
