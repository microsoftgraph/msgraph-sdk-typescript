...
import { createDeviceConfigurationUserStatusCollectionResponseFromDiscriminatorValue, createDeviceConfigurationUserStatusFromDiscriminatorValue, deserializeIntoDeviceConfigurationUserStatus, serializeDeviceConfigurationUserStatus, type DeviceConfigurationUserStatus, type DeviceConfigurationUserStatusCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeviceConfigurationUserStatusItemRequestBuilder } from './item/';
...
export class UserStatusesRequestBuilder extends BaseRequestBuilder<UserStatusesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UserStatusesRequestBuilder(x, y));
    }
    /**
