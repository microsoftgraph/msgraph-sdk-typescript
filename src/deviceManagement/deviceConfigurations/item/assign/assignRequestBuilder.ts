...
import { createAssignPostResponseFromDiscriminatorValue, deserializeIntoAssignPostResponse, serializeAssignPostResponse, type AssignPostResponse } from './assignPostResponse';
...
export class AssignRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AssignPostRequestBody, requestConfiguration?: AssignRequestBuilderPostRequestConfiguration | undefined) : Promise<AssignPostResponse | undefined> {
