...
import { createDeviceConfigurationAssignmentFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeDeviceConfigurationAssignment, type BaseCollectionPaginationCountResponse, type DeviceConfigurationAssignment } from '../../../../models/';
...
export class AssignRequestBuilder extends BaseRequestBuilder<AssignRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/assign", (x, y) => new AssignRequestBuilder(x, y));
    }
    /**
     * Not yet documented
