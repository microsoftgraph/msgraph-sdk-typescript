...
export class DeviceSettingStateSummariesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<DeviceSettingStateSummariesRequestBuilderGetQueryParameters> | undefined) : Promise<SettingStateDeviceSummaryCollectionResponse | undefined> {
     ...
     */
    public post(body: SettingStateDeviceSummary, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SettingStateDeviceSummary | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<DeviceSettingStateSummariesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, deviceSettingStateSummariesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: SettingStateDeviceSummary, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
