...
export class DeviceSettingStateSummariesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceSettingStateSummariesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceSettingStateSummariesResponse).value = n.getCollectionOfObjectValues<SettingStateDeviceSummary>(SettingStateDeviceSummary); }],
        ]);
    };
    /**
