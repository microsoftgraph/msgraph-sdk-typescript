import { type DeviceConfigurationDeviceStatusItemRequestBuilderGetQueryParameters } from './deviceConfigurationDeviceStatusItemRequestBuilderGetQueryParameters';
