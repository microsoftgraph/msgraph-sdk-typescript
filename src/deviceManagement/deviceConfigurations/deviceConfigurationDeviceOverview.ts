...
export class DeviceConfigurationDeviceOverview extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["configurationVersion", (o, n) => { (o as unknown as DeviceConfigurationDeviceOverview).configurationVersion = n.getNumberValue(); }],
            ["errorCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceOverview).errorCount = n.getNumberValue(); }],
            ["failedCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceOverview).failedCount = n.getNumberValue(); }],
            ["lastUpdateDateTime", (o, n) => { (o as unknown as DeviceConfigurationDeviceOverview).lastUpdateDateTime = n.getDateValue(); }],
            ["notApplicableCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceOverview).notApplicableCount = n.getNumberValue(); }],
            ["pendingCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceOverview).pendingCount = n.getNumberValue(); }],
            ["successCount", (o, n) => { (o as unknown as DeviceConfigurationDeviceOverview).successCount = n.getNumberValue(); }],
        ]);
    };
    /**
