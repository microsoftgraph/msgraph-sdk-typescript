...
export class DeviceConfigurationsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/intune-deviceconfig-windows10secureassessmentconfiguration-create?view=graph-rest-1.0|Find more info here}
     */
