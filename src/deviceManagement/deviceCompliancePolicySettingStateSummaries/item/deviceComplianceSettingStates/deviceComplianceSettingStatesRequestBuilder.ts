import {DeviceComplianceSettingStateCollectionResponseImpl, DeviceComplianceSettingStateImpl} from '../../../../models/';
...
export class DeviceComplianceSettingStatesRequestBuilder {
    ...
    public get(requestConfiguration?: DeviceComplianceSettingStatesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceSettingStateCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceComplianceSettingStateCollectionResponseImpl>(requestInfo, createDeviceComplianceSettingStateCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to deviceComplianceSettingStates for deviceManagement
     * @param body 
