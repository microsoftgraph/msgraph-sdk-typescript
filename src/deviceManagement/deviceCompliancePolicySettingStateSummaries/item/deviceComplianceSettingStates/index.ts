...
import { createDeviceComplianceSettingStateCollectionResponseFromDiscriminatorValue, createDeviceComplianceSettingStateFromDiscriminatorValue, deserializeIntoDeviceComplianceSettingState, serializeDeviceComplianceSettingState, type DeviceComplianceSettingState, type DeviceComplianceSettingStateCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeviceComplianceSettingStateItemRequestBuilder } from './item/';
 ...
 */
export class DeviceComplianceSettingStatesRequestBuilder extends BaseRequestBuilder<DeviceComplianceSettingStatesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummary%2Did}/deviceComplianceSettingStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DeviceComplianceSettingStatesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<DeviceComplianceSettingStatesRequestBuilderGetQueryParameters> | undefined) : Promise<DeviceComplianceSettingStateCollectionResponse | undefined> {
     ...
     */
    public post(body: DeviceComplianceSettingState, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DeviceComplianceSettingState | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<DeviceComplianceSettingStatesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, deviceComplianceSettingStatesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DeviceComplianceSettingState, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
