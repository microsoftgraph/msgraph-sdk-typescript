...
import { createEnrollmentConfigurationAssignmentCollectionResponseFromDiscriminatorValue, createEnrollmentConfigurationAssignmentFromDiscriminatorValue, deserializeIntoEnrollmentConfigurationAssignment, serializeEnrollmentConfigurationAssignment, type EnrollmentConfigurationAssignment, type EnrollmentConfigurationAssignmentCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { EnrollmentConfigurationAssignmentItemRequestBuilder } from './item/';
...
export class AssignmentsRequestBuilder extends BaseRequestBuilder<AssignmentsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AssignmentsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<AssignmentsRequestBuilderGetQueryParameters> | undefined) : Promise<EnrollmentConfigurationAssignmentCollectionResponse | undefined> {
     ...
     */
    public post(body: EnrollmentConfigurationAssignment, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EnrollmentConfigurationAssignment | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: EnrollmentConfigurationAssignment, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
