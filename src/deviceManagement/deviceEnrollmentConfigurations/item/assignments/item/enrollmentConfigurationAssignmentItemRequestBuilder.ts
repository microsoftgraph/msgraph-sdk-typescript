...
export class EnrollmentConfigurationAssignmentItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public withUrl(rawUrl: string) : EnrollmentConfigurationAssignmentItemRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new EnrollmentConfigurationAssignmentItemRequestBuilder(rawUrl, this.requestAdapter);
    };
}
