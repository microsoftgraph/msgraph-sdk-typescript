...
import { deserializeIntoAssignPostRequestBody, serializeAssignPostRequestBody, type AssignPostRequestBody } from './assignPostRequestBody';
...
export class AssignRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AssignPostRequestBody, requestConfiguration?: AssignRequestBuilderPostRequestConfiguration | undefined) : Promise<void> {
