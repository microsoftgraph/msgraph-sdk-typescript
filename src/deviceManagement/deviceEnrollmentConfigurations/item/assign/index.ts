...
import { createEnrollmentConfigurationAssignmentFromDiscriminatorValue, serializeEnrollmentConfigurationAssignment, type EnrollmentConfigurationAssignment } from '../../../../models/';
...
export class AssignRequestBuilder extends BaseRequestBuilder<AssignRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}/assign", (x, y) => new AssignRequestBuilder(x, y));
    }
    /**
     * Not yet documented
