...
import { createDeviceEnrollmentConfigurationCollectionResponseFromDiscriminatorValue } from '../../models/deviceEnrollmentConfigurationCollectionResponse';
...
export class DeviceEnrollmentConfigurationsRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a deviceEnrollmentConfigurationsRequestBuilder
     */
    public withUrl(rawUrl: string) : DeviceEnrollmentConfigurationsRequestBuilder {
