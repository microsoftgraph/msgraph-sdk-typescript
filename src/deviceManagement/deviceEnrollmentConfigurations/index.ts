...
import { createDeviceEnrollmentConfigurationCollectionResponseFromDiscriminatorValue, createDeviceEnrollmentConfigurationFromDiscriminatorValue, deserializeIntoDeviceEnrollmentConfiguration, serializeDeviceEnrollmentConfiguration, type DeviceEnrollmentConfiguration, type DeviceEnrollmentConfigurationCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeviceEnrollmentConfigurationItemRequestBuilder } from './item/';
 ...
 */
export class DeviceEnrollmentConfigurationsRequestBuilder extends BaseRequestBuilder<DeviceEnrollmentConfigurationsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/deviceEnrollmentConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DeviceEnrollmentConfigurationsRequestBuilder(x, y));
    }
    /**
