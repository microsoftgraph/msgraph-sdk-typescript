...
export class SendTestMessageRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a sendTestMessageRequestBuilder
     */
    public withUrl(rawUrl: string) : SendTestMessageRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new SendTestMessageRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
