 ...
 */
export class SendTestMessageRequestBuilder extends BaseRequestBuilder<SendTestMessageRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/notificationMessageTemplates/{notificationMessageTemplate%2Did}/sendTestMessage", (x, y) => new SendTestMessageRequestBuilder(x, y));
    }
    /**
