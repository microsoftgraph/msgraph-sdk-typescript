...
export class LocalizedNotificationMessagesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as LocalizedNotificationMessagesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as LocalizedNotificationMessagesResponse).value = n.getCollectionOfObjectValues<LocalizedNotificationMessage>(LocalizedNotificationMessage); }],
        ]);
    };
    /**
