...
import { createLocalizedNotificationMessageCollectionResponseFromDiscriminatorValue, createLocalizedNotificationMessageFromDiscriminatorValue, deserializeIntoLocalizedNotificationMessage, serializeLocalizedNotificationMessage, type LocalizedNotificationMessage, type LocalizedNotificationMessageCollectionResponse } from '../../../../models/';
 ...
 */
export class LocalizedNotificationMessagesRequestBuilder extends BaseRequestBuilder<LocalizedNotificationMessagesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/notificationMessageTemplates/{notificationMessageTemplate%2Did}/localizedNotificationMessages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new LocalizedNotificationMessagesRequestBuilder(x, y));
    }
    /**
