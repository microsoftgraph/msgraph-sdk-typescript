...
import { createNotificationMessageTemplateFromDiscriminatorValue, deserializeIntoNotificationMessageTemplate, serializeNotificationMessageTemplate, type NotificationMessageTemplate } from '../../../models/';
 ...
 */
export class NotificationMessageTemplateItemRequestBuilder extends BaseRequestBuilder<NotificationMessageTemplateItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceManagement/notificationMessageTemplates/{notificationMessageTemplate%2Did}{?%24select,%24expand}", (x, y) => new NotificationMessageTemplateItemRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<NotificationMessageTemplateItemRequestBuilderGetQueryParameters> | undefined) : Promise<NotificationMessageTemplate | undefined> {
     ...
     */
    public patch(body: NotificationMessageTemplate, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<NotificationMessageTemplate | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<NotificationMessageTemplateItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, notificationMessageTemplateItemRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    }
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: NotificationMessageTemplate, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
