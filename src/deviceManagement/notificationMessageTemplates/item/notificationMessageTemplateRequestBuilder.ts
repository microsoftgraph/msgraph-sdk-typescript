...
export class NotificationMessageTemplateRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: NotificationMessageTemplate | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<NotificationMessageTemplate | undefined> {
    ...
    public localizedNotificationMessagesById(id: string) : LocalizedNotificationMessageRequestBuilder {
        ...
        id && urlTplParams.set("localizedNotificationMessage_id", id);
        return new LocalizedNotificationMessageRequestBuilder(urlTplParams, this.requestAdapter);
    };
    /**
     * The Notification Message Templates.
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: NotificationMessageTemplate | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
