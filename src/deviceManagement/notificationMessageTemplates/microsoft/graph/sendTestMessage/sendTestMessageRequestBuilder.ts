...
export class Microsoft.graph.sendTestMessageRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.sendTestMessageRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.sendTestMessage";
