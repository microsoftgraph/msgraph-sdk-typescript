...
import { createAttributeMappingFunctionSchemaCollectionResponseFromDiscriminatorValue, createAttributeMappingFunctionSchemaFromDiscriminatorValue, deserializeIntoAttributeMappingFunctionSchema, serializeAttributeMappingFunctionSchema, type AttributeMappingFunctionSchema, type AttributeMappingFunctionSchemaCollectionResponse } from '../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AttributeMappingFunctionSchemaItemRequestBuilder } from './item/';
...
export class FunctionsRequestBuilder extends BaseRequestBuilder<FunctionsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/functions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new FunctionsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<FunctionsRequestBuilderGetQueryParameters> | undefined) : Promise<AttributeMappingFunctionSchemaCollectionResponse | undefined> {
     ...
     */
    public post(body: AttributeMappingFunctionSchema, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AttributeMappingFunctionSchema | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: AttributeMappingFunctionSchema, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
