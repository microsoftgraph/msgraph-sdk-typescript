...
export class DirectoryRoleTemplatesRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: DirectoryRoleTemplate | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DirectoryRoleTemplatesResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<DirectoryRoleTemplatesResponse>(requestInfo, DirectoryRoleTemplatesResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Add new entity to directoryRoleTemplates
     * @param body 
     ...
     */
    public post(body: DirectoryRoleTemplate | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DirectoryRoleTemplate | undefined> {
        if(!body) throw new Error("body cannot be undefined");
