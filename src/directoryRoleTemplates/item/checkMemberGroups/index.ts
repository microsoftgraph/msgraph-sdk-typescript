...
export class CheckMemberGroupsRequestBuilder extends BaseRequestBuilder<CheckMemberGroupsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/directoryRoleTemplates/{directoryRoleTemplate%2Did}/checkMemberGroups", (x, y) => new CheckMemberGroupsRequestBuilder(x, y));
    }
    /**
