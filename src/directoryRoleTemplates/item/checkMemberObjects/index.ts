...
export class CheckMemberObjectsRequestBuilder extends BaseRequestBuilder<CheckMemberObjectsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/directoryRoleTemplates/{directoryRoleTemplate%2Did}/checkMemberObjects", (x, y) => new CheckMemberObjectsRequestBuilder(x, y));
    }
    /**
