...
export class ValidatePropertiesRequestBuilder {
     ...
     */
    public post(body: ValidatePropertiesRequestBodyImpl | undefined, requestConfiguration?: ValidatePropertiesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
