...
import { createSubscribedSkuCollectionResponseFromDiscriminatorValue, createSubscribedSkuFromDiscriminatorValue, deserializeIntoSubscribedSku, serializeSubscribedSku, type SubscribedSku, type SubscribedSkuCollectionResponse } from '../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../models/oDataErrors/';
import { SubscribedSkuItemRequestBuilder } from './item/';
 ...
 */
export class SubscribedSkusRequestBuilder extends BaseRequestBuilder<SubscribedSkusRequestBuilder> {
    /**
     * Provides operations to manage the collection of subscribedSku entities.
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/subscribedSkus{?%24search,%24orderby,%24select}", (x, y) => new SubscribedSkusRequestBuilder(x, y));
    }
    /**
