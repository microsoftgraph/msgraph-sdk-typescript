...
export class AgreementFileLocalizationRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: AgreementFileLocalization | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.agreements.file.localizations.versions collection
