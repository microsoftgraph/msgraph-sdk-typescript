...
export class AcceptancesRequestBuilder {
    ...
    public get(q?: {
        ...
        return this.requestAdapter?.sendAsync<AcceptancesResponse>(requestInfo, AcceptancesResponse, responseHandler, undefined) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Read-only. Information about acceptances of this agreement.
     * @param body 
