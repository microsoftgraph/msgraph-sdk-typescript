...
import { createAgreementFromDiscriminatorValue, deserializeIntoAgreement, serializeAgreement, type Agreement } from '../../models/';
 ...
 */
export class AgreementItemRequestBuilder extends BaseRequestBuilder<AgreementItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/agreements/{agreement%2Did}{?%24select}", (x, y) => new AgreementItemRequestBuilder(x, y));
    }
    /**
