...
export class VersionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as VersionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as VersionsResponse).value = n.getCollectionOfObjectValues<AgreementFileVersion>(AgreementFileVersion); }],
        ]);
    };
    /**
