import {AuthenticationMethodConfiguration, AuthenticationMethodConfigurationCollectionResponse} from '../models/';
...
export class AuthenticationMethodConfigurationsRequestBuilder {
     ...
     */
    public createGetRequestInformation(queryParameters?: AuthenticationMethodConfigurationsRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: AuthenticationMethodConfiguration | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public get(queryParameters?: AuthenticationMethodConfigurationsRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AuthenticationMethodConfigurationCollectionResponse | undefined> {
     ...
     */
    public post(body: AuthenticationMethodConfiguration | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AuthenticationMethodConfiguration | undefined> {
        if(!body) throw new Error("body cannot be undefined");
