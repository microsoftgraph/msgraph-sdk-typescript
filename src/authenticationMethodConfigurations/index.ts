...
export class AuthenticationMethodConfigurationsRequestBuilder extends BaseRequestBuilder<AuthenticationMethodConfigurationsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/authenticationMethodConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AuthenticationMethodConfigurationsRequestBuilder(x, y));
    }
    /**
