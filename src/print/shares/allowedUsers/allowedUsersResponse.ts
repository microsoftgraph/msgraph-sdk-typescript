...
export class AllowedUsersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AllowedUsersResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AllowedUsersResponse).value = n.getCollectionOfObjectValues<User>(User); }],
        ]);
    };
    /**
