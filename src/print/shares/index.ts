...
import { createPrinterShareCollectionResponseFromDiscriminatorValue, createPrinterShareFromDiscriminatorValue, deserializeIntoPrinterShare, serializePrinterShare, type PrinterShare, type PrinterShareCollectionResponse } from '../../models/';
...
export class SharesRequestBuilder extends BaseRequestBuilder<SharesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/print/shares{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SharesRequestBuilder(x, y));
    }
    /**
