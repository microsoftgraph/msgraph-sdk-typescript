...
import { createPrinterShareFromDiscriminatorValue, deserializeIntoPrinterShare, serializePrinterShare, type PrinterShare } from '../../../models/';
...
export class PrinterShareItemRequestBuilder extends BaseRequestBuilder<PrinterShareItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}{?%24select,%24expand}", (x, y) => new PrinterShareItemRequestBuilder(x, y));
    }
    /**
