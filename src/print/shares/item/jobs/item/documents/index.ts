...
import { createPrintDocumentCollectionResponseFromDiscriminatorValue, createPrintDocumentFromDiscriminatorValue, deserializeIntoPrintDocument, serializePrintDocument, type PrintDocument, type PrintDocumentCollectionResponse } from '../../../../../../models/';
 ...
 */
export class DocumentsRequestBuilder extends BaseRequestBuilder<DocumentsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/documents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DocumentsRequestBuilder(x, y));
    }
    /**
