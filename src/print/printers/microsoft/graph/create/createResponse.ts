...
export class Microsoft.graph.createResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["certificateSigningRequest", (o, n) => { (o as unknown as Microsoft.graph.createResponse).certificateSigningRequest = n.getObjectValue<PrintCertificateSigningRequest>(PrintCertificateSigningRequest); }],
            ["connectorId", (o, n) => { (o as unknown as Microsoft.graph.createResponse).connectorId = n.getStringValue(); }],
            ["displayName", (o, n) => { (o as unknown as Microsoft.graph.createResponse).displayName = n.getStringValue(); }],
            ["hasPhysicalDevice", (o, n) => { (o as unknown as Microsoft.graph.createResponse).hasPhysicalDevice = n.getBooleanValue(); }],
            ["manufacturer", (o, n) => { (o as unknown as Microsoft.graph.createResponse).manufacturer = n.getStringValue(); }],
            ["model", (o, n) => { (o as unknown as Microsoft.graph.createResponse).model = n.getStringValue(); }],
            ["physicalDeviceId", (o, n) => { (o as unknown as Microsoft.graph.createResponse).physicalDeviceId = n.getStringValue(); }],
        ]);
    };
    /**
