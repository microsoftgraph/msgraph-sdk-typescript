...
export class PrintersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as PrintersResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as PrintersResponse).value = n.getCollectionOfObjectValues<Printer>(Printer); }],
        ]);
    };
    /**
