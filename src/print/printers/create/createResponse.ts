...
export class CreateResponse implements Parsable {
    ...
    /**
     * Instantiates a new createResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["certificateSigningRequest", (o, n) => { (o as unknown as CreateResponse).certificateSigningRequest = n.getObjectValue<PrintCertificateSigningRequest>(PrintCertificateSigningRequest); }],
            ["connectorId", (o, n) => { (o as unknown as CreateResponse).connectorId = n.getStringValue(); }],
            ["displayName", (o, n) => { (o as unknown as CreateResponse).displayName = n.getStringValue(); }],
            ["hasPhysicalDevice", (o, n) => { (o as unknown as CreateResponse).hasPhysicalDevice = n.getBooleanValue(); }],
            ["manufacturer", (o, n) => { (o as unknown as CreateResponse).manufacturer = n.getStringValue(); }],
            ["model", (o, n) => { (o as unknown as CreateResponse).model = n.getStringValue(); }],
            ["physicalDeviceId", (o, n) => { (o as unknown as CreateResponse).physicalDeviceId = n.getStringValue(); }],
        ]);
    };
    /**
