 ...
 */
export class RestoreFactoryDefaultsRequestBuilder extends BaseRequestBuilder<RestoreFactoryDefaultsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/restoreFactoryDefaults", (x, y) => new RestoreFactoryDefaultsRequestBuilder(x, y));
    }
    /**
