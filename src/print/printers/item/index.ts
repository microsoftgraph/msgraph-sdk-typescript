...
import { createPrinterFromDiscriminatorValue, deserializeIntoPrinter, serializePrinter, type Printer } from '../../../models/';
 ...
 */
export class PrinterItemRequestBuilder extends BaseRequestBuilder<PrinterItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/print/printers/{printer%2Did}{?%24select,%24expand}", (x, y) => new PrinterItemRequestBuilder(x, y));
    }
    /**
