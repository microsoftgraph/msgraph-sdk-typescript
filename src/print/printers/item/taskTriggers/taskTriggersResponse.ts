...
export class TaskTriggersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TaskTriggersResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TaskTriggersResponse).value = n.getCollectionOfObjectValues<PrintTaskTrigger>(PrintTaskTrigger); }],
        ]);
    };
    /**
