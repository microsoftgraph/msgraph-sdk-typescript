...
import { createPrintTaskTriggerCollectionResponseFromDiscriminatorValue, createPrintTaskTriggerFromDiscriminatorValue, deserializeIntoPrintTaskTrigger, serializePrintTaskTrigger, type PrintTaskTrigger, type PrintTaskTriggerCollectionResponse } from '../../../../models/';
 ...
 */
export class TaskTriggersRequestBuilder extends BaseRequestBuilder<TaskTriggersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/taskTriggers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TaskTriggersRequestBuilder(x, y));
    }
    /**
