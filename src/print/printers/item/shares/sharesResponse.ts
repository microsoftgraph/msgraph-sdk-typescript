...
export class SharesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SharesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SharesResponse).value = n.getCollectionOfObjectValues<PrinterShare>(PrinterShare); }],
        ]);
    };
    /**
