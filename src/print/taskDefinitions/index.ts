...
import { createPrintTaskDefinitionCollectionResponseFromDiscriminatorValue, createPrintTaskDefinitionFromDiscriminatorValue, deserializeIntoPrintTaskDefinition, serializePrintTaskDefinition, type PrintTaskDefinition, type PrintTaskDefinitionCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { PrintTaskDefinitionItemRequestBuilder } from './item/';
 ...
 */
export class TaskDefinitionsRequestBuilder extends BaseRequestBuilder<TaskDefinitionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/print/taskDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TaskDefinitionsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<TaskDefinitionsRequestBuilderGetQueryParameters> | undefined) : Promise<PrintTaskDefinitionCollectionResponse | undefined> {
     ...
     */
    public post(body: PrintTaskDefinition, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<PrintTaskDefinition | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: PrintTaskDefinition, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
