...
export class PrintTaskDefinitionItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: PrintTaskDefinitionItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
