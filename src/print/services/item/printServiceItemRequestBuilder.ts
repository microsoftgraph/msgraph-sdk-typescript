...
export class PrintServiceItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a Promise of PrintService
     */
    public patch(body: PrintService | undefined, requestConfiguration?: PrintServiceItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<PrintService | undefined> {
