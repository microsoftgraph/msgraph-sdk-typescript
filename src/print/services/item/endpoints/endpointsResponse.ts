...
export class EndpointsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as EndpointsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as EndpointsResponse).value = n.getCollectionOfObjectValues<PrintServiceEndpoint>(PrintServiceEndpoint); }],
        ]);
    };
    /**
