...
export class EndpointsRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: PrintServiceEndpoint | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: PrintServiceEndpoint | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PrintServiceEndpoint | undefined> {
        if(!body) throw new Error("body cannot be undefined");
