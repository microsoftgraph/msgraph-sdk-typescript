...
import { createPrintConnectorCollectionResponseFromDiscriminatorValue, createPrintConnectorFromDiscriminatorValue, deserializeIntoPrintConnector, serializePrintConnector, type PrintConnector, type PrintConnectorCollectionResponse } from '../../models/';
...
export class ConnectorsRequestBuilder extends BaseRequestBuilder<ConnectorsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/print/connectors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ConnectorsRequestBuilder(x, y));
    }
    /**
