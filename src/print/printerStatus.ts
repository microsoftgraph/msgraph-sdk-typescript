...
export class PrinterStatus implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["details", (o, n) => { (o as unknown as PrinterStatus).details = n.getCollectionOfPrimitiveValues<printerProcessingStateDetail>(); }],
            ["state", (o, n) => { (o as unknown as PrinterStatus).state = n.getObjectValue<PrinterProcessingState>(PrinterProcessingState); }],
        ]);
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfPrimitiveValues<printerProcessingStateDetail>("details", this.details);
        writer.writeObjectValue<PrinterProcessingState>("state", this.state);
