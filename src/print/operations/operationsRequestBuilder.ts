...
export class OperationsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: PrintOperation | undefined, requestConfiguration?: OperationsRequestBuilderPostRequestConfiguration | undefined) : Promise<PrintOperation | undefined> {
