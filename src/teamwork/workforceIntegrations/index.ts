...
import { createWorkforceIntegrationCollectionResponseFromDiscriminatorValue, createWorkforceIntegrationFromDiscriminatorValue, deserializeIntoWorkforceIntegration, serializeWorkforceIntegration, type WorkforceIntegration, type WorkforceIntegrationCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { WorkforceIntegrationItemRequestBuilder } from './item/';
 ...
 */
export class WorkforceIntegrationsRequestBuilder extends BaseRequestBuilder<WorkforceIntegrationsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teamwork/workforceIntegrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new WorkforceIntegrationsRequestBuilder(x, y));
    }
    /**
