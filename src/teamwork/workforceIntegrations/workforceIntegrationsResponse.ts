...
export class WorkforceIntegrationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as WorkforceIntegrationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as WorkforceIntegrationsResponse).value = n.getCollectionOfObjectValues<WorkforceIntegration>(WorkforceIntegration); }],
        ]);
    };
    /**
