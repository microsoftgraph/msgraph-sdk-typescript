...
import { createDeletedTeamCollectionResponseFromDiscriminatorValue, createDeletedTeamFromDiscriminatorValue, deserializeIntoDeletedTeam, serializeDeletedTeam, type DeletedTeam, type DeletedTeamCollectionResponse } from '../../models/';
 ...
 */
export class DeletedTeamsRequestBuilder extends BaseRequestBuilder<DeletedTeamsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teamwork/deletedTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DeletedTeamsRequestBuilder(x, y));
    }
    /**
