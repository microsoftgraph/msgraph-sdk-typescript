...
import { type RemoveEmailRequestBuilderPostRequestConfiguration } from './removeEmailRequestBuilderPostRequestConfiguration';
...
export class RemoveEmailRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/removeEmail");
    };
    /**
