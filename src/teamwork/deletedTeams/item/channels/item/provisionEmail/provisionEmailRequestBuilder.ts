...
import { createProvisionChannelEmailResultFromDiscriminatorValue } from '../../../../../../models/provisionChannelEmailResult';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface ProvisionEmailRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
...
export class ProvisionEmailRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/provisionEmail");
    };
    /**
