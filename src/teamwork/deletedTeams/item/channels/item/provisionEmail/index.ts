...
export class ProvisionEmailRequestBuilder extends BaseRequestBuilder<ProvisionEmailRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/provisionEmail", (x, y) => new ProvisionEmailRequestBuilder(x, y));
    }
    /**
