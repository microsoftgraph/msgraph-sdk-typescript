...
import { type CompleteMigrationRequestBuilderPostRequestConfiguration } from './completeMigrationRequestBuilderPostRequestConfiguration';
...
export class CompleteMigrationRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/completeMigration");
    };
    /**
