...
import {ChatMessageItemRequestBuilder as Ia959093c65c3994409fd6f2421902181d8a7867c9e8fa4d849d746781fe4ee15} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}");
    };
    /**
     ...
     */
    public delete(requestConfiguration?: ChatMessageItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
     ...
     */
    public repliesById(id: string) : Ia959093c65c3994409fd6f2421902181d8a7867c9e8fa4d849d746781fe4ee15 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new Ia959093c65c3994409fd6f2421902181d8a7867c9e8fa4d849d746781fe4ee15(urlTplParams, this.requestAdapter);
    };
    /**
     * Delete navigation property messages for teamwork
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
