...
import { createChannelCollectionResponseFromDiscriminatorValue, createChannelFromDiscriminatorValue, deserializeIntoChannel, serializeChannel, type Channel, type ChannelCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { GetAllMessagesRequestBuilder } from './getAllMessages/';
import { ChannelItemRequestBuilder } from './item/';
 ...
 */
export class ChannelsRequestBuilder extends BaseRequestBuilder<ChannelsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ChannelsRequestBuilder(x, y));
    }
    /**
