...
import { createTeamworkFromDiscriminatorValue, deserializeIntoTeamwork, serializeTeamwork, type Teamwork } from '../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../models/oDataErrors/';
import { DeletedTeamsRequestBuilder } from './deletedTeams/';
import { SendActivityNotificationToRecipientsRequestBuilder } from './sendActivityNotificationToRecipients/';
import { TeamsAppSettingsRequestBuilder } from './teamsAppSettings/';
...
export class TeamworkRequestBuilder extends BaseRequestBuilder<TeamworkRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teamwork{?%24select,%24expand}", (x, y) => new TeamworkRequestBuilder(x, y));
    }
    /**
     * Get teamwork
