...
export class OrganizationalBrandingProperties extends Entity implements Parsable {
    ...
    private _backgroundImage?: Binary | undefined;
    ...
    private _bannerLogo?: Binary | undefined;
    ...
    private _squareLogo?: Binary | undefined;
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["backgroundImage", (o, n) => { (o as unknown as OrganizationalBrandingProperties).backgroundImage = n.getObjectValue<Binary>(Binary); }],
            ["bannerLogo", (o, n) => { (o as unknown as OrganizationalBrandingProperties).bannerLogo = n.getObjectValue<Binary>(Binary); }],
            ["signInPageText", (o, n) => { (o as unknown as OrganizationalBrandingProperties).signInPageText = n.getStringValue(); }],
            ["squareLogo", (o, n) => { (o as unknown as OrganizationalBrandingProperties).squareLogo = n.getObjectValue<Binary>(Binary); }],
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<Binary>("backgroundImage", this.backgroundImage);
        writer.writeObjectValue<Binary>("bannerLogo", this.bannerLogo);
        writer.writeStringValue("signInPageText", this.signInPageText);
        writer.writeObjectValue<Binary>("squareLogo", this.squareLogo);
     ...
     */
    public set backgroundImage(value: Binary | undefined) {
     ...
     */
    public set bannerLogo(value: Binary | undefined) {
     ...
     */
    public set squareLogo(value: Binary | undefined) {
