...
export class LocalizationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as LocalizationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as LocalizationsResponse).value = n.getCollectionOfObjectValues<OrganizationalBrandingLocalization>(OrganizationalBrandingLocalization); }],
        ]);
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<OrganizationalBrandingLocalization>("value", this.value);
