...
export class BackgroundImageRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/branding/backgroundImage";
     ...
     * @returns a RequestInformation
     */
    public createPutRequestInformation(body: ArrayBuffer, requestConfiguration?: BackgroundImageRequestBuilderPutRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public get(requestConfiguration?: BackgroundImageRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public put(body: ArrayBuffer, requestConfiguration?: BackgroundImageRequestBuilderPutRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
