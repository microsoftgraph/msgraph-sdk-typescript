...
export class CheckMemberGroupsRequestBuilder extends BaseRequestBuilder<CheckMemberGroupsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/checkMemberGroups", (x, y) => new CheckMemberGroupsRequestBuilder(x, y));
    }
    /**
