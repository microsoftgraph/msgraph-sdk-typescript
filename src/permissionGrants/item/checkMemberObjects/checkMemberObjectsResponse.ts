...
export class CheckMemberObjectsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["ids", (o, n) => { (o as unknown as CheckMemberObjectsResponse).ids = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
