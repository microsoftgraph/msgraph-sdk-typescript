...
export class CheckMemberObjectsResponseImpl implements CheckMemberObjectsResponse {
    ...
    public constructor(checkMemberObjectsResponseParameterValue?: CheckMemberObjectsResponse | undefined) {
        this._additionalData = checkMemberObjectsResponseParameterValue?.additionalData ? checkMemberObjectsResponseParameterValue?.additionalData! : {};
        this._value = checkMemberObjectsResponseParameterValue?.value;
    };
    /**
