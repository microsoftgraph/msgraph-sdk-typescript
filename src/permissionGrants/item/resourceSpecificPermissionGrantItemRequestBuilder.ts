...
export class ResourceSpecificPermissionGrantItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, resourceSpecificPermissionGrantId?: string | undefined) {
