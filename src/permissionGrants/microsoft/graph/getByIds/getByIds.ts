...
export class Microsoft.graph.getByIds extends Entity implements Parsable {
    private _deletedDateTime?: Date | undefined;
    /**
     * Instantiates a new Microsoft.graph.getByIds and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["deletedDateTime", (o, n) => { (o as unknown as Microsoft.graph.getByIds).deletedDateTime = n.getDateValue(); }],
        ]);
    };
    /**
