...
export class Communications extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["callRecords", (o, n) => { (o as unknown as Communications).callRecords = n.getCollectionOfObjectValues<CallRecord>(CallRecord); }],
            ["calls", (o, n) => { (o as unknown as Communications).calls = n.getCollectionOfObjectValues<Call>(Call); }],
            ["onlineMeetings", (o, n) => { (o as unknown as Communications).onlineMeetings = n.getCollectionOfObjectValues<OnlineMeeting>(OnlineMeeting); }],
            ["presences", (o, n) => { (o as unknown as Communications).presences = n.getCollectionOfObjectValues<Presence>(Presence); }],
        ]);
    };
    /**
