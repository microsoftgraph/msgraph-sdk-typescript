...
export class GetVirtualAppointmentJoinWebUrlRequestBuilder extends BaseRequestBuilder<GetVirtualAppointmentJoinWebUrlRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/getVirtualAppointmentJoinWebUrl()", (x, y) => new GetVirtualAppointmentJoinWebUrlRequestBuilder(x, y));
    }
    /**
