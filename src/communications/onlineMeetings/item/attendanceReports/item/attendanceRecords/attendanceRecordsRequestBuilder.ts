...
export class AttendanceRecordsRequestBuilder {
     ...
     */
    public createGetRequestInformation(queryParameters?: AttendanceRecordsRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: AttendanceRecord | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public get(queryParameters?: AttendanceRecordsRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AttendanceRecordCollectionResponse | undefined> {
     ...
     */
    public post(body: AttendanceRecord | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AttendanceRecord | undefined> {
        if(!body) throw new Error("body cannot be undefined");
