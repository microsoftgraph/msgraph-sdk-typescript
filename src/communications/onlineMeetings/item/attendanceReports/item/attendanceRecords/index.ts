...
import { createAttendanceRecordCollectionResponseFromDiscriminatorValue, createAttendanceRecordFromDiscriminatorValue, deserializeIntoAttendanceRecord, serializeAttendanceRecord, type AttendanceRecord, type AttendanceRecordCollectionResponse } from '../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AttendanceRecordItemRequestBuilder } from './item/';
 ...
 */
export class AttendanceRecordsRequestBuilder extends BaseRequestBuilder<AttendanceRecordsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/{meetingAttendanceReport%2Did}/attendanceRecords{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AttendanceRecordsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<AttendanceRecordsRequestBuilderGetQueryParameters> | undefined) : Promise<AttendanceRecordCollectionResponse | undefined> {
     ...
     */
    public post(body: AttendanceRecord, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AttendanceRecord | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<AttendanceRecordsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, attendanceRecordsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: AttendanceRecord, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
