...
export class CallTranscriptItemRequestBuilder extends BaseRequestBuilder<CallTranscriptItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}{?%24select,%24expand}", (x, y) => new CallTranscriptItemRequestBuilder(x, y));
    }
    /**
