...
export class Microsoft.graph.createOrGetResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["chatInfo", (o, n) => { (o as unknown as Microsoft.graph.createOrGetResponse).chatInfo = n.getObjectValue<ChatInfo>(ChatInfo); }],
            ["endDateTime", (o, n) => { (o as unknown as Microsoft.graph.createOrGetResponse).endDateTime = n.getDateValue(); }],
            ["externalId", (o, n) => { (o as unknown as Microsoft.graph.createOrGetResponse).externalId = n.getStringValue(); }],
            ["participants", (o, n) => { (o as unknown as Microsoft.graph.createOrGetResponse).participants = n.getObjectValue<MeetingParticipants>(MeetingParticipants); }],
            ["startDateTime", (o, n) => { (o as unknown as Microsoft.graph.createOrGetResponse).startDateTime = n.getDateValue(); }],
            ["subject", (o, n) => { (o as unknown as Microsoft.graph.createOrGetResponse).subject = n.getStringValue(); }],
        ]);
    };
    /**
