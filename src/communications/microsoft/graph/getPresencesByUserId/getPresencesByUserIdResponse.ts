...
export class Microsoft.graph.getPresencesByUserIdResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["ids", (o, n) => { (o as unknown as Microsoft.graph.getPresencesByUserIdResponse).ids = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
