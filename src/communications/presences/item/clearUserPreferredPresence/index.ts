...
export class ClearUserPreferredPresenceRequestBuilder extends BaseRequestBuilder<ClearUserPreferredPresenceRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/communications/presences/{presence%2Did}/clearUserPreferredPresence", (x, y) => new ClearUserPreferredPresenceRequestBuilder(x, y));
    }
    /**
