...
export class PresencesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as PresencesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as PresencesResponse).value = n.getCollectionOfObjectValues<Presence>(Presence); }],
        ]);
    };
    /**
