...
export class Microsoft.graph.logTeleconferenceDeviceQualityResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["quality", (o, n) => { (o as unknown as Microsoft.graph.logTeleconferenceDeviceQualityResponse).quality = n.getObjectValue<TeleconferenceDeviceQuality>(TeleconferenceDeviceQuality); }],
        ]);
    };
    /**
