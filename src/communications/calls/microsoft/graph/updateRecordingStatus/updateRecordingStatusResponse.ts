...
export class Microsoft.graph.updateRecordingStatusResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["clientContext", (o, n) => { (o as unknown as Microsoft.graph.updateRecordingStatusResponse).clientContext = n.getStringValue(); }],
            ["status", (o, n) => { (o as unknown as Microsoft.graph.updateRecordingStatusResponse).status = n.getObjectValue<RecordingStatus>(RecordingStatus); }],
        ]);
    };
    /**
