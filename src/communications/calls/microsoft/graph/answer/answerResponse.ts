...
export class Microsoft.graph.answerResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["acceptedModalities", (o, n) => { (o as unknown as Microsoft.graph.answerResponse).acceptedModalities = n.getCollectionOfPrimitiveValues<modality>(); }],
            ["callbackUri", (o, n) => { (o as unknown as Microsoft.graph.answerResponse).callbackUri = n.getStringValue(); }],
            ["mediaConfig", (o, n) => { (o as unknown as Microsoft.graph.answerResponse).mediaConfig = n.getObjectValue<MediaConfig>(MediaConfig); }],
            ["participantCapacity", (o, n) => { (o as unknown as Microsoft.graph.answerResponse).participantCapacity = n.getNumberValue(); }],
        ]);
    };
    /**
