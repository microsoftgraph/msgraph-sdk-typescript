...
export class Microsoft.graph.transferResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["transferTarget", (o, n) => { (o as unknown as Microsoft.graph.transferResponse).transferTarget = n.getObjectValue<InvitationParticipantInfo>(InvitationParticipantInfo); }],
        ]);
    };
    /**
