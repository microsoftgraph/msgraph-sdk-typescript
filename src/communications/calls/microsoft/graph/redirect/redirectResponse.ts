...
export class Microsoft.graph.redirectResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["callbackUri", (o, n) => { (o as unknown as Microsoft.graph.redirectResponse).callbackUri = n.getStringValue(); }],
            ["targets", (o, n) => { (o as unknown as Microsoft.graph.redirectResponse).targets = n.getCollectionOfObjectValues<InvitationParticipantInfo>(InvitationParticipantInfo); }],
            ["timeout", (o, n) => { (o as unknown as Microsoft.graph.redirectResponse).timeout = n.getNumberValue(); }],
        ]);
    };
    /**
