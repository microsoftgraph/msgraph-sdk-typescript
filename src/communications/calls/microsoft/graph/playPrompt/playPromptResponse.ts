...
export class Microsoft.graph.playPromptResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["clientContext", (o, n) => { (o as unknown as Microsoft.graph.playPromptResponse).clientContext = n.getStringValue(); }],
            ["prompts", (o, n) => { (o as unknown as Microsoft.graph.playPromptResponse).prompts = n.getCollectionOfObjectValues<Prompt>(Prompt); }],
        ]);
    };
    /**
