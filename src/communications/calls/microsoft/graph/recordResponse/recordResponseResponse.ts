import {Prompt} from '../playPrompt/prompt';
import {SerializationWriter, ParseNode, Parsable} from '@microsoft/kiota-abstractions';

export class Microsoft.graph.recordResponseResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["bargeInAllowed", (o, n) => { (o as unknown as Microsoft.graph.recordResponseResponse).bargeInAllowed = n.getBooleanValue(); }],
            ["clientContext", (o, n) => { (o as unknown as Microsoft.graph.recordResponseResponse).clientContext = n.getStringValue(); }],
            ["initialSilenceTimeoutInSeconds", (o, n) => { (o as unknown as Microsoft.graph.recordResponseResponse).initialSilenceTimeoutInSeconds = n.getNumberValue(); }],
            ["maxRecordDurationInSeconds", (o, n) => { (o as unknown as Microsoft.graph.recordResponseResponse).maxRecordDurationInSeconds = n.getNumberValue(); }],
            ["maxSilenceTimeoutInSeconds", (o, n) => { (o as unknown as Microsoft.graph.recordResponseResponse).maxSilenceTimeoutInSeconds = n.getNumberValue(); }],
            ["playBeep", (o, n) => { (o as unknown as Microsoft.graph.recordResponseResponse).playBeep = n.getBooleanValue(); }],
            ["prompts", (o, n) => { (o as unknown as Microsoft.graph.recordResponseResponse).prompts = n.getCollectionOfObjectValues<Prompt>(Prompt); }],
            ["stopTones", (o, n) => { (o as unknown as Microsoft.graph.recordResponseResponse).stopTones = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
