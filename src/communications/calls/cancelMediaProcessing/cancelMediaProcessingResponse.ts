...
export class CancelMediaProcessingResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["clientContext", (o, n) => { (o as unknown as CancelMediaProcessingResponse).clientContext = n.getStringValue(); }],
        ]);
    };
    /**
