...
export class PlayPromptResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["clientContext", (o, n) => { (o as unknown as PlayPromptResponse).clientContext = n.getStringValue(); }],
            ["prompts", (o, n) => { (o as unknown as PlayPromptResponse).prompts = n.getCollectionOfObjectValues<Prompt>(Prompt); }],
        ]);
    };
    /**
