...
export class RedirectResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["callbackUri", (o, n) => { (o as unknown as RedirectResponse).callbackUri = n.getStringValue(); }],
            ["targets", (o, n) => { (o as unknown as RedirectResponse).targets = n.getCollectionOfObjectValues<InvitationParticipantInfo>(InvitationParticipantInfo); }],
            ["timeout", (o, n) => { (o as unknown as RedirectResponse).timeout = n.getNumberValue(); }],
        ]);
    };
    /**
