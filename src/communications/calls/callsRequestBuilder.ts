...
import { createCallCollectionResponseFromDiscriminatorValue } from '../../models/callCollectionResponse';
...
export class CallsRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a callsRequestBuilder
     */
    public withUrl(rawUrl: string) : CallsRequestBuilder {
