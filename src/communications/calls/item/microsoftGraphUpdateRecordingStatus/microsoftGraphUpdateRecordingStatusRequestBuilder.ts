...
import {MicrosoftGraphUpdateRecordingStatusRequestBuilderPostRequestConfiguration} from './microsoftGraphUpdateRecordingStatusRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the updateRecordingStatus method.
 */
export class MicrosoftGraphUpdateRecordingStatusRequestBuilder {
     ...
     */
    public post(body: UpdateRecordingStatusPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphUpdateRecordingStatusRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UpdateRecordingStatusOperation | undefined> {
     ...
     */
    public toPostRequestInformation(body: UpdateRecordingStatusPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphUpdateRecordingStatusRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
