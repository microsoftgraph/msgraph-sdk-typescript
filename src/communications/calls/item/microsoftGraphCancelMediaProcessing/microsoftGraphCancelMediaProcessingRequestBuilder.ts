...
import {MicrosoftGraphCancelMediaProcessingRequestBuilderPostRequestConfiguration} from './microsoftGraphCancelMediaProcessingRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the cancelMediaProcessing method.
 */
export class MicrosoftGraphCancelMediaProcessingRequestBuilder {
     ...
     */
    public post(body: CancelMediaProcessingPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphCancelMediaProcessingRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CancelMediaProcessingOperation | undefined> {
     ...
     */
    public toPostRequestInformation(body: CancelMediaProcessingPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphCancelMediaProcessingRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
