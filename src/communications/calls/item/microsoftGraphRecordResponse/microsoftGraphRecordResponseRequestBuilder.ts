...
import {MicrosoftGraphRecordResponseRequestBuilderPostRequestConfiguration} from './microsoftGraphRecordResponseRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the recordResponse method.
 */
export class MicrosoftGraphRecordResponseRequestBuilder {
     ...
     */
    public post(body: RecordResponsePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphRecordResponseRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RecordOperation | undefined> {
     ...
     */
    public toPostRequestInformation(body: RecordResponsePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphRecordResponseRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
