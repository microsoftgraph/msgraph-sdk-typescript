...
import {MicrosoftGraphPlayPromptRequestBuilderPostRequestConfiguration} from './microsoftGraphPlayPromptRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the playPrompt method.
 */
export class MicrosoftGraphPlayPromptRequestBuilder {
     ...
     */
    public post(body: PlayPromptPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphPlayPromptRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PlayPromptOperation | undefined> {
     ...
     */
    public toPostRequestInformation(body: PlayPromptPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphPlayPromptRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
