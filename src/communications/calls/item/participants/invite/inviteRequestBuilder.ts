...
export class InviteRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: InviteRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: InviteRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<InviteParticipantsOperation | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = this.createPostRequestInformation(
            body, h, o
        );
        return this.requestAdapter?.sendAsync<InviteParticipantsOperation>(requestInfo, InviteParticipantsOperation, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
