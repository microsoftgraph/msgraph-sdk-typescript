...
export class InviteResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["clientContext", (o, n) => { (o as unknown as InviteResponse).clientContext = n.getStringValue(); }],
            ["participants", (o, n) => { (o as unknown as InviteResponse).participants = n.getCollectionOfObjectValues<InvitationParticipantInfo>(InvitationParticipantInfo); }],
        ]);
    };
    /**
