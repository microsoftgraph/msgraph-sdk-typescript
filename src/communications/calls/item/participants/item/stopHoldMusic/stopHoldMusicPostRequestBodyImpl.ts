...
export class StopHoldMusicPostRequestBodyImpl implements StopHoldMusicPostRequestBody {
    ...
    public constructor(stopHoldMusicPostRequestBodyParameterValue?: StopHoldMusicPostRequestBody | undefined) {
        this._additionalData = stopHoldMusicPostRequestBodyParameterValue?.additionalData ? stopHoldMusicPostRequestBodyParameterValue?.additionalData! : {};
        this._clientContext = stopHoldMusicPostRequestBodyParameterValue?.clientContext;
    };
    /**
