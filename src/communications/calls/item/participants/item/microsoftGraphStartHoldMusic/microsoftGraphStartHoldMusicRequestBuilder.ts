...
import {MicrosoftGraphStartHoldMusicRequestBuilderPostRequestConfiguration} from './microsoftGraphStartHoldMusicRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the startHoldMusic method.
 */
export class MicrosoftGraphStartHoldMusicRequestBuilder {
     ...
     */
    public post(body: StartHoldMusicPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphStartHoldMusicRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<StartHoldMusicOperation | undefined> {
     ...
     */
    public toPostRequestInformation(body: StartHoldMusicPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphStartHoldMusicRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
