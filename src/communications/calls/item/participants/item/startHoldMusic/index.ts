...
import { createPromptFromDiscriminatorValue, createStartHoldMusicOperationFromDiscriminatorValue, deserializeIntoStartHoldMusicOperation, serializePrompt, serializeStartHoldMusicOperation, type Prompt, type StartHoldMusicOperation } from '../../../../../../models/';
 ...
 */
export class StartHoldMusicRequestBuilder extends BaseRequestBuilder<StartHoldMusicRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/communications/calls/{call%2Did}/participants/{participant%2Did}/startHoldMusic", (x, y) => new StartHoldMusicRequestBuilder(x, y));
    }
    /**
