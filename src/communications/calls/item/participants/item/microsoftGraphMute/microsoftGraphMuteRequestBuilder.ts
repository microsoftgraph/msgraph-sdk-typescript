...
import {MicrosoftGraphMuteRequestBuilderPostRequestConfiguration} from './microsoftGraphMuteRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the mute method.
 */
export class MicrosoftGraphMuteRequestBuilder {
     ...
     */
    public post(body: MutePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphMuteRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<MuteParticipantOperation | undefined> {
     ...
     */
    public toPostRequestInformation(body: MutePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphMuteRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
