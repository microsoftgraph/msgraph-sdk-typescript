...
export class PlayPromptRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: PlayPromptRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: PlayPromptRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PlayPromptOperation | undefined> {
        if(!body) throw new Error("body cannot be undefined");
