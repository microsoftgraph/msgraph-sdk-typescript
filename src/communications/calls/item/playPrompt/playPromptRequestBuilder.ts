...
export class PlayPromptRequestBuilder {
    ...
    public post(body: PlayPromptPostRequestBody | undefined, requestConfiguration?: PlayPromptRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PlayPromptOperationImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<PlayPromptOperationImpl>(requestInfo, createPlayPromptOperationFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
