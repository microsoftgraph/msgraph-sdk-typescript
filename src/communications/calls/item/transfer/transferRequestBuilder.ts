...
export class TransferRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: TransferPostRequestBody | undefined, requestConfiguration?: TransferRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeTransferPostRequestBody);
        return requestInfo;
    };
}
