...
export class TransferRequestBuilder {
     ...
     */
    public post(body: TransferRequestBodyImpl | undefined, requestConfiguration?: TransferRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
