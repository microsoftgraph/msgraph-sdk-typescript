...
export class UpdateRecordingStatusRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: UpdateRecordingStatusRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: UpdateRecordingStatusRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UpdateRecordingStatusOperation | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = this.createPostRequestInformation(
            body, h, o
        );
        return this.requestAdapter?.sendAsync<UpdateRecordingStatusOperation>(requestInfo, UpdateRecordingStatusOperation, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
