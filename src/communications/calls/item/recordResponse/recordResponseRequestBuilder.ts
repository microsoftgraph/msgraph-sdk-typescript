...
export class RecordResponseRequestBuilder {
    ...
    public post(body: RecordResponsePostRequestBody | undefined, requestConfiguration?: RecordResponseRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RecordOperationImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<RecordOperationImpl>(requestInfo, createRecordOperationFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
