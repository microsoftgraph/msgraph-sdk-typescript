...
export class RecordResponseResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["bargeInAllowed", (o, n) => { (o as unknown as RecordResponseResponse).bargeInAllowed = n.getBooleanValue(); }],
            ["clientContext", (o, n) => { (o as unknown as RecordResponseResponse).clientContext = n.getStringValue(); }],
            ["initialSilenceTimeoutInSeconds", (o, n) => { (o as unknown as RecordResponseResponse).initialSilenceTimeoutInSeconds = n.getNumberValue(); }],
            ["maxRecordDurationInSeconds", (o, n) => { (o as unknown as RecordResponseResponse).maxRecordDurationInSeconds = n.getNumberValue(); }],
            ["maxSilenceTimeoutInSeconds", (o, n) => { (o as unknown as RecordResponseResponse).maxSilenceTimeoutInSeconds = n.getNumberValue(); }],
            ["playBeep", (o, n) => { (o as unknown as RecordResponseResponse).playBeep = n.getBooleanValue(); }],
            ["prompts", (o, n) => { (o as unknown as RecordResponseResponse).prompts = n.getCollectionOfObjectValues<Prompt>(Prompt); }],
            ["stopTones", (o, n) => { (o as unknown as RecordResponseResponse).stopTones = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
