...
export class SubscribeToToneRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "clientContext": (o, n) => { (o as unknown as SubscribeToToneRequestBody).clientContext = n.getStringValue(); },
        };
    };
    /**
