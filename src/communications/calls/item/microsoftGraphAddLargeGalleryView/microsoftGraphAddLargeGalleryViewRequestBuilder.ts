...
import {MicrosoftGraphAddLargeGalleryViewRequestBuilderPostRequestConfiguration} from './microsoftGraphAddLargeGalleryViewRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the addLargeGalleryView method.
 */
export class MicrosoftGraphAddLargeGalleryViewRequestBuilder {
     ...
     */
    public post(body: AddLargeGalleryViewPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphAddLargeGalleryViewRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AddLargeGalleryViewOperation | undefined> {
     ...
     */
    public toPostRequestInformation(body: AddLargeGalleryViewPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphAddLargeGalleryViewRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
