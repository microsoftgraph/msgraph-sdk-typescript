import {CommsOperationCollectionResponseImpl, CommsOperationImpl} from '../../../../models/';
...
export class OperationsRequestBuilder {
    ...
    public createPostRequestInformation(body: CommsOperation | undefined, requestConfiguration?: OperationsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new CommsOperationImpl(body)
     ...
     */
    public get(requestConfiguration?: OperationsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CommsOperationCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CommsOperationCollectionResponseImpl>(requestInfo, createCommsOperationCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to operations for communications
     * @param body 
     ...
     */
    public post(body: CommsOperation | undefined, requestConfiguration?: OperationsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CommsOperationImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        ...
        return this.requestAdapter?.sendAsync<CommsOperationImpl>(requestInfo, createCommsOperationFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
