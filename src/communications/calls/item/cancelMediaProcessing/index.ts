...
import { createCancelMediaProcessingOperationFromDiscriminatorValue, deserializeIntoCancelMediaProcessingOperation, serializeCancelMediaProcessingOperation, type CancelMediaProcessingOperation } from '../../../../models/';
 ...
 */
export class CancelMediaProcessingRequestBuilder extends BaseRequestBuilder<CancelMediaProcessingRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/communications/calls/{call%2Did}/cancelMediaProcessing", (x, y) => new CancelMediaProcessingRequestBuilder(x, y));
    }
    /**
