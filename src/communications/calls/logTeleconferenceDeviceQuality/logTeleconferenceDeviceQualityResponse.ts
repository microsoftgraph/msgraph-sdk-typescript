...
export class LogTeleconferenceDeviceQualityResponse implements Parsable {
    ...
    /**
     * Instantiates a new logTeleconferenceDeviceQualityResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["quality", (o, n) => { (o as unknown as LogTeleconferenceDeviceQualityResponse).quality = n.getObjectValue<TeleconferenceDeviceQuality>(TeleconferenceDeviceQuality); }],
        ]);
    };
    /**
