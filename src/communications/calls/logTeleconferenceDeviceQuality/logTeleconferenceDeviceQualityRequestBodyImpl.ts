...
export class LogTeleconferenceDeviceQualityRequestBodyImpl implements AdditionalDataHolder, LogTeleconferenceDeviceQualityRequestBody, Parsable {
     ...
     * @param logTeleconferenceDeviceQualityRequestBodyParameterValue 
     */
    public constructor(logTeleconferenceDeviceQualityRequestBodyParameterValue?: LogTeleconferenceDeviceQualityRequestBody | undefined) {
        this.additionalData = {};
        this.additionalData = logTeleconferenceDeviceQualityRequestBodyParameterValue?.additionalData ? {} : logTeleconferenceDeviceQualityRequestBodyParameterValue?.additionalData!
        this.quality = logTeleconferenceDeviceQualityRequestBodyParameterValue?.quality ;
    };
    /**
