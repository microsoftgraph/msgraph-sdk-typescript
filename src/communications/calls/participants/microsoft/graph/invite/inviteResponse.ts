import {InvitationParticipantInfo} from '../../../../microsoft/graph/invitationParticipantInfo';
import {SerializationWriter, ParseNode, Parsable} from '@microsoft/kiota-abstractions';

export class Microsoft.graph.inviteResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["clientContext", (o, n) => { (o as unknown as Microsoft.graph.inviteResponse).clientContext = n.getStringValue(); }],
            ["participants", (o, n) => { (o as unknown as Microsoft.graph.inviteResponse).participants = n.getCollectionOfObjectValues<InvitationParticipantInfo>(InvitationParticipantInfo); }],
        ]);
    };
    /**
