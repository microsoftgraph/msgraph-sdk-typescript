...
export class GetPresencesByUserIdResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["ids", (o, n) => { (o as unknown as GetPresencesByUserIdResponse).ids = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
