...
export class GetPresencesByUserIdRequestBuilder {
     ...
     */
    public post(body: GetPresencesByUserIdRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetPresencesByUserId[] | undefined> {
        if(!body) throw new Error("body cannot be undefined");
