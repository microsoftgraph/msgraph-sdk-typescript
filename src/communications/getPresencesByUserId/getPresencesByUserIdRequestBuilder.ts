...
export class GetPresencesByUserIdRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: GetPresencesByUserIdPostRequestBody, requestConfiguration?: GetPresencesByUserIdRequestBuilderPostRequestConfiguration | undefined) : Promise<GetPresencesByUserIdPostResponse | undefined> {
