...
export class GetPresencesByUserIdRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetPresencesByUserIdResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public post(body: GetPresencesByUserIdResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetPresencesByUserId[] | undefined> {
        ...
        return this.httpCore?.sendCollectionAsync<GetPresencesByUserId>(requestInfo, GetPresencesByUserId, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
