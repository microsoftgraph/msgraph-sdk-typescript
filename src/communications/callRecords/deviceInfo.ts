...
export class DeviceInfo implements Parsable {
    ...
    private _captureNotFunctioningEventRatio?: Float | undefined;
    ...
    private _cpuInsufficentEventRatio?: Float | undefined;
    ...
    private _deviceClippingEventRatio?: Float | undefined;
    ...
    private _lowSpeechToNoiseEventRatio?: Float | undefined;
    /** Glitches per 5 minute interval for the media endpoint's microphone.  */
    private _micGlitchRate?: Float | undefined;
    ...
    private _renderMuteEventRatio?: Float | undefined;
    /** Fraction of the call that the media endpoint detected the render device was not working properly.  */
    private _renderNotFunctioningEventRatio?: Float | undefined;
    /** Fraction of the call that media endpoint detected device render volume is set to 0.  */
    private _renderZeroVolumeEventRatio?: Float | undefined;
    ...
    private _speakerGlitchRate?: Float | undefined;
    /**
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["captureNotFunctioningEventRatio", (o, n) => { (o as unknown as DeviceInfo).captureNotFunctioningEventRatio = n.getObjectValue<Float>(Float); }],
            ["cpuInsufficentEventRatio", (o, n) => { (o as unknown as DeviceInfo).cpuInsufficentEventRatio = n.getObjectValue<Float>(Float); }],
            ["deviceClippingEventRatio", (o, n) => { (o as unknown as DeviceInfo).deviceClippingEventRatio = n.getObjectValue<Float>(Float); }],
            ["deviceGlitchEventRatio", (o, n) => { (o as unknown as DeviceInfo).deviceGlitchEventRatio = n.getObjectValue<Float>(Float); }],
            ["howlingEventCount", (o, n) => { (o as unknown as DeviceInfo).howlingEventCount = n.getNumberValue(); }],
            ["initialSignalLevelRootMeanSquare", (o, n) => { (o as unknown as DeviceInfo).initialSignalLevelRootMeanSquare = n.getObjectValue<Float>(Float); }],
            ["lowSpeechLevelEventRatio", (o, n) => { (o as unknown as DeviceInfo).lowSpeechLevelEventRatio = n.getObjectValue<Float>(Float); }],
            ["lowSpeechToNoiseEventRatio", (o, n) => { (o as unknown as DeviceInfo).lowSpeechToNoiseEventRatio = n.getObjectValue<Float>(Float); }],
            ["micGlitchRate", (o, n) => { (o as unknown as DeviceInfo).micGlitchRate = n.getObjectValue<Float>(Float); }],
            ...
            ["renderMuteEventRatio", (o, n) => { (o as unknown as DeviceInfo).renderMuteEventRatio = n.getObjectValue<Float>(Float); }],
            ["renderNotFunctioningEventRatio", (o, n) => { (o as unknown as DeviceInfo).renderNotFunctioningEventRatio = n.getObjectValue<Float>(Float); }],
            ["renderZeroVolumeEventRatio", (o, n) => { (o as unknown as DeviceInfo).renderZeroVolumeEventRatio = n.getObjectValue<Float>(Float); }],
            ...
            ["speakerGlitchRate", (o, n) => { (o as unknown as DeviceInfo).speakerGlitchRate = n.getObjectValue<Float>(Float); }],
        ]);
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<Float>("captureNotFunctioningEventRatio", this.captureNotFunctioningEventRatio);
        writer.writeObjectValue<Float>("cpuInsufficentEventRatio", this.cpuInsufficentEventRatio);
        writer.writeObjectValue<Float>("deviceClippingEventRatio", this.deviceClippingEventRatio);
        writer.writeObjectValue<Float>("deviceGlitchEventRatio", this.deviceGlitchEventRatio);
        writer.writeNumberValue("howlingEventCount", this.howlingEventCount);
        writer.writeObjectValue<Float>("initialSignalLevelRootMeanSquare", this.initialSignalLevelRootMeanSquare);
        writer.writeObjectValue<Float>("lowSpeechLevelEventRatio", this.lowSpeechLevelEventRatio);
        writer.writeObjectValue<Float>("lowSpeechToNoiseEventRatio", this.lowSpeechToNoiseEventRatio);
        writer.writeObjectValue<Float>("micGlitchRate", this.micGlitchRate);
        ...
        writer.writeObjectValue<Float>("renderMuteEventRatio", this.renderMuteEventRatio);
        writer.writeObjectValue<Float>("renderNotFunctioningEventRatio", this.renderNotFunctioningEventRatio);
        writer.writeObjectValue<Float>("renderZeroVolumeEventRatio", this.renderZeroVolumeEventRatio);
        writer.writeNumberValue("sentNoiseLevel", this.sentNoiseLevel);
        writer.writeNumberValue("sentSignalLevel", this.sentSignalLevel);
        writer.writeObjectValue<Float>("speakerGlitchRate", this.speakerGlitchRate);
     ...
     */
    public set captureNotFunctioningEventRatio(value: Float | undefined) {
     ...
     */
    public set cpuInsufficentEventRatio(value: Float | undefined) {
     ...
     */
    public set deviceClippingEventRatio(value: Float | undefined) {
     ...
     */
    public set deviceGlitchEventRatio(value: Float | undefined) {
     ...
     */
    public set initialSignalLevelRootMeanSquare(value: Float | undefined) {
     ...
     */
    public set lowSpeechLevelEventRatio(value: Float | undefined) {
     ...
     */
    public set lowSpeechToNoiseEventRatio(value: Float | undefined) {
     ...
     */
    public set micGlitchRate(value: Float | undefined) {
     ...
     */
    public set renderMuteEventRatio(value: Float | undefined) {
     ...
     */
    public set renderNotFunctioningEventRatio(value: Float | undefined) {
     ...
     */
    public set renderZeroVolumeEventRatio(value: Float | undefined) {
     ...
     */
    public set speakerGlitchRate(value: Float | undefined) {
