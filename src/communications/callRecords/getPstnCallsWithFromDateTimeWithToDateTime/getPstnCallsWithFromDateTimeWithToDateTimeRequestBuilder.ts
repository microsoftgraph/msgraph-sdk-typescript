...
export class GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
