...
export class GetPstnCallsWithFromDateTimeWithToDateTimeResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "value": n => { this.value = n.getCollectionOfObjectValues<PstnCallLogRow>(createPstnCallLogRowFromDiscriminatorValue); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<PstnCallLogRow>("value", this.value);
