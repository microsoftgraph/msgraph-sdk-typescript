...
import { createCallRecordFromDiscriminatorValue, deserializeIntoCallRecord, serializeCallRecord, type CallRecord } from '../../../models/callRecords/';
 ...
 */
export class CallRecordItemRequestBuilder extends BaseRequestBuilder<CallRecordItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/communications/callRecords/{callRecord%2Did}{?%24select,%24expand}", (x, y) => new CallRecordItemRequestBuilder(x, y));
    }
    /**
