...
import {SegmentRequestBuilder} from '../segments/item/item/segmentRequestBuilder';
...
export class SessionRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.communications.callRecords.item.sessions.item.segments.item collection
