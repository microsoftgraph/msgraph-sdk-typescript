...
import { createSessionCollectionResponseFromDiscriminatorValue, createSessionFromDiscriminatorValue, deserializeIntoSession, serializeSession, type Session, type SessionCollectionResponse } from '../../../../models/callRecords/';
...
export class SessionsRequestBuilder extends BaseRequestBuilder<SessionsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/communications/callRecords/{callRecord%2Did}/sessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SessionsRequestBuilder(x, y));
    }
    /**
