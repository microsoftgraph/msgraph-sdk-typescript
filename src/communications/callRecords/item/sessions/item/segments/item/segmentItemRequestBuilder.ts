...
export class SegmentItemRequestBuilder {
    ...
    public createPatchRequestInformation(body: Segment | undefined, requestConfiguration?: SegmentItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new SegmentImpl(body)
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: SegmentImpl | undefined, requestConfiguration?: SegmentItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
