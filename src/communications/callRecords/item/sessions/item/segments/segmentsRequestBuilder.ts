...
import { createSegmentCollectionResponseFromDiscriminatorValue } from '../../../../../../models/callRecords/segmentCollectionResponse';
...
export interface SegmentsRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
