...
export class SessionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SessionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SessionsResponse).value = n.getCollectionOfObjectValues<Session>(Session); }],
        ]);
    };
    /**
