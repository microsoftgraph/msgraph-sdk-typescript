...
import { createThreatAssessmentResultCollectionResponseFromDiscriminatorValue, createThreatAssessmentResultFromDiscriminatorValue, deserializeIntoThreatAssessmentResult, serializeThreatAssessmentResult, type ThreatAssessmentResult, type ThreatAssessmentResultCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ThreatAssessmentResultItemRequestBuilder } from './item/';
 ...
 */
export class ResultsRequestBuilder extends BaseRequestBuilder<ResultsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}/results{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ResultsRequestBuilder(x, y));
    }
    /**
