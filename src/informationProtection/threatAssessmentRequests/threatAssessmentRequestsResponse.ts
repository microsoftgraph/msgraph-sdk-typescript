...
export class ThreatAssessmentRequestsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ThreatAssessmentRequestsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ThreatAssessmentRequestsResponse).value = n.getCollectionOfObjectValues<ThreatAssessmentRequest>(ThreatAssessmentRequest); }],
        ]);
    };
    /**
