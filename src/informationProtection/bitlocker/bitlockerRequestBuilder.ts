...
export class BitlockerRequestBuilder {
     ...
     * @returns a Promise of Bitlocker
     */
    public patch(body: Bitlocker | undefined, requestConfiguration?: BitlockerRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Bitlocker | undefined> {
        if(!body) throw new Error("body cannot be undefined");
