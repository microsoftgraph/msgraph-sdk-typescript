...
import { createBitlockerRecoveryKeyCollectionResponseFromDiscriminatorValue, type BitlockerRecoveryKeyCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { BitlockerRecoveryKeyItemRequestBuilder } from './item/';
 ...
 */
export class RecoveryKeysRequestBuilder extends BaseRequestBuilder<RecoveryKeysRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/informationProtection/bitlocker/recoveryKeys{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RecoveryKeysRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<RecoveryKeysRequestBuilderGetQueryParameters> | undefined) : Promise<BitlockerRecoveryKeyCollectionResponse | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<RecoveryKeysRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, recoveryKeysRequestBuilderGetQueryParametersMapper);
