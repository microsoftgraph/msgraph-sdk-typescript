...
export class AuthenticationMethodsPolicyRequestBuilder {
    public get authenticationMethodConfigurations(): AuthenticationMethodConfigurationsRequestBuilder {
        return new AuthenticationMethodConfigurationsRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    }
    ...
    public authenticationMethodConfigurationsById(id: String) : AuthenticationMethodConfigurationRequestBuilder {
        ...
        return new AuthenticationMethodConfigurationRequestBuilder(this.currentPath + this.pathSegment + "/authenticationMethodConfigurations/" + id, this.httpCore, false);
    };
    /**
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: AuthenticationMethodsPolicy | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AuthenticationMethodsPolicy | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<AuthenticationMethodsPolicy>(requestInfo, AuthenticationMethodsPolicy, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Update authenticationMethodsPolicy
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: AuthenticationMethodsPolicy | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
