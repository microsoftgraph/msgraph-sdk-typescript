...
export class AuthenticationMethodConfigurationsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/authenticationMethodsPolicy/authenticationMethodConfigurations{?top,skip,search,filter,count,orderby,select,expand}";
    ...
    public get(queryParameters?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AuthenticationMethodConfigurationCollectionResponse | undefined> {
