...
export class AuthenticationMethodConfigurationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AuthenticationMethodConfigurationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AuthenticationMethodConfigurationsResponse).value = n.getCollectionOfObjectValues<AuthenticationMethodConfiguration>(AuthenticationMethodConfiguration); }],
        ]);
    };
    /**
