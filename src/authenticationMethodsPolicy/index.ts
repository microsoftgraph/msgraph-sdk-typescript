...
import { createAuthenticationMethodsPolicyFromDiscriminatorValue, serializeAuthenticationMethodsPolicy, type AuthenticationMethodsPolicy } from '../models/';
 ...
 */
export const AuthenticationMethodsPolicyRequestBuilderUriTemplate = "{+baseurl}/authenticationMethodsPolicy{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
