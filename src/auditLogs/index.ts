...
import { createAuditLogRootFromDiscriminatorValue, deserializeIntoAuditLogRoot, serializeAuditLogRoot, type AuditLogRoot } from '../models/';
 ...
 */
export class AuditLogsRequestBuilder extends BaseRequestBuilder<AuditLogsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/auditLogs{?%24select,%24expand}", (x, y) => new AuditLogsRequestBuilder(x, y));
    }
    /**
     * Get auditLogs
