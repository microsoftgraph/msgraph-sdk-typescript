...
import { createSignInCollectionResponseFromDiscriminatorValue, createSignInFromDiscriminatorValue, deserializeIntoSignIn, serializeSignIn, type SignIn, type SignInCollectionResponse } from '../../models/';
 ...
 */
export class SignInsRequestBuilder extends BaseRequestBuilder<SignInsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/auditLogs/signIns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SignInsRequestBuilder(x, y));
    }
    /**
