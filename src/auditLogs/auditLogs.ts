...
export class AuditLogs extends Entity implements Parsable {
    /** Read-only. Nullable.  */
    ...
    /**
     * Instantiates a new AuditLogs and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["directoryAudits", (o, n) => { (o as unknown as AuditLogs).directoryAudits = n.getCollectionOfObjectValues<DirectoryAudit>(DirectoryAudit); }],
            ["provisioning", (o, n) => { (o as unknown as AuditLogs).provisioning = n.getCollectionOfObjectValues<ProvisioningObjectSummary>(ProvisioningObjectSummary); }],
            ["restrictedSignIns", (o, n) => { (o as unknown as AuditLogs).restrictedSignIns = n.getCollectionOfObjectValues<RestrictedSignIn>(RestrictedSignIn); }],
            ["signIns", (o, n) => { (o as unknown as AuditLogs).signIns = n.getCollectionOfObjectValues<SignIn>(SignIn); }],
        ]);
    };
    /**
