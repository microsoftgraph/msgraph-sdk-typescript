...
export class ProvisioningResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ProvisioningResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ProvisioningResponse).value = n.getCollectionOfObjectValues<ProvisioningObjectSummary>(ProvisioningObjectSummary); }],
        ]);
    };
    /**
