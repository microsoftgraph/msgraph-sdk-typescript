...
import { createServicePrincipalRiskDetectionCollectionResponseFromDiscriminatorValue, createServicePrincipalRiskDetectionFromDiscriminatorValue, deserializeIntoServicePrincipalRiskDetection, serializeServicePrincipalRiskDetection, type ServicePrincipalRiskDetection, type ServicePrincipalRiskDetectionCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ServicePrincipalRiskDetectionItemRequestBuilder } from './item/';
 ...
 */
export class ServicePrincipalRiskDetectionsRequestBuilder extends BaseRequestBuilder<ServicePrincipalRiskDetectionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityProtection/servicePrincipalRiskDetections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ServicePrincipalRiskDetectionsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<ServicePrincipalRiskDetectionsRequestBuilderGetQueryParameters> | undefined) : Promise<ServicePrincipalRiskDetectionCollectionResponse | undefined> {
     ...
     */
    public post(body: ServicePrincipalRiskDetection, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ServicePrincipalRiskDetection | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<ServicePrincipalRiskDetectionsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, servicePrincipalRiskDetectionsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: ServicePrincipalRiskDetection, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
