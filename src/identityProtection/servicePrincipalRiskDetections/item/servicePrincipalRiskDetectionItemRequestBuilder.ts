...
export class ServicePrincipalRiskDetectionItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: ServicePrincipalRiskDetectionItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
