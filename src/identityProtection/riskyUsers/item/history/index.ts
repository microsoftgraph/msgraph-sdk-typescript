...
import { createRiskyUserHistoryItemCollectionResponseFromDiscriminatorValue, createRiskyUserHistoryItemFromDiscriminatorValue, deserializeIntoRiskyUserHistoryItem, serializeRiskyUserHistoryItem, type RiskyUserHistoryItem, type RiskyUserHistoryItemCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { RiskyUserHistoryItemItemRequestBuilder } from './item/';
...
export class HistoryRequestBuilder extends BaseRequestBuilder<HistoryRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}/history{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new HistoryRequestBuilder(x, y));
    }
    /**
