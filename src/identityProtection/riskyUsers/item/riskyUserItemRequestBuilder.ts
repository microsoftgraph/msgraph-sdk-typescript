...
export class RiskyUserItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: RiskyUserItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
