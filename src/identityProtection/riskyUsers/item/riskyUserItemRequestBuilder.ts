...
export class RiskyUserItemRequestBuilder {
     ...
     * @param riskyUserId key: id of riskyUser
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, riskyUserId?: string | undefined) {
