...
export class ConfirmCompromisedRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: ConfirmCompromisedPostRequestBody | undefined, requestConfiguration?: ConfirmCompromisedRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
