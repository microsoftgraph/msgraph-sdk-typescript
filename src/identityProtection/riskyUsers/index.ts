...
import { createRiskyUserCollectionResponseFromDiscriminatorValue, createRiskyUserFromDiscriminatorValue, deserializeIntoRiskyUser, serializeRiskyUser, type RiskyUser, type RiskyUserCollectionResponse } from '../../models/';
...
import { RiskyUserItemRequestBuilder } from './item/';
 ...
 */
export class RiskyUsersRequestBuilder extends BaseRequestBuilder<RiskyUsersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityProtection/riskyUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RiskyUsersRequestBuilder(x, y));
    }
    /**
