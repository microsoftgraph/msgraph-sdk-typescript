...
import { createRiskyServicePrincipalCollectionResponseFromDiscriminatorValue, createRiskyServicePrincipalFromDiscriminatorValue, deserializeIntoRiskyServicePrincipal, serializeRiskyServicePrincipal, type RiskyServicePrincipal, type RiskyServicePrincipalCollectionResponse } from '../../models/';
 ...
 */
export class RiskyServicePrincipalsRequestBuilder extends BaseRequestBuilder<RiskyServicePrincipalsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityProtection/riskyServicePrincipals{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RiskyServicePrincipalsRequestBuilder(x, y));
    }
    /**
