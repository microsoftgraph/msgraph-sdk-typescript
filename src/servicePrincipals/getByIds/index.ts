...
import { deserializeIntoGetByIdsPostRequestBody, serializeGetByIdsPostRequestBody, type GetByIdsPostRequestBody } from './';
...
export class GetByIdsRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/getByIds");
    };
    /**
