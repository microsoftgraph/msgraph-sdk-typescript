...
export class ValidatePropertiesResponse implements Parsable {
    ...
    /**
     * Instantiates a new validatePropertiesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["displayName", (o, n) => { (o as unknown as ValidatePropertiesResponse).displayName = n.getStringValue(); }],
            ["entityType", (o, n) => { (o as unknown as ValidatePropertiesResponse).entityType = n.getStringValue(); }],
            ["mailNickname", (o, n) => { (o as unknown as ValidatePropertiesResponse).mailNickname = n.getStringValue(); }],
            ["onBehalfOfUserId", (o, n) => { (o as unknown as ValidatePropertiesResponse).onBehalfOfUserId = n.getStringValue(); }],
        ]);
    };
    /**
