...
export class HomeRealmDiscoveryPoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as HomeRealmDiscoveryPoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as HomeRealmDiscoveryPoliciesResponse).value = n.getCollectionOfObjectValues<HomeRealmDiscoveryPolicy>(HomeRealmDiscoveryPolicy); }],
        ]);
    };
    /**
