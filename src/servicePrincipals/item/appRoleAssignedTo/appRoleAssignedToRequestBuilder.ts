...
export class AppRoleAssignedToRequestBuilder {
     ...
     */
    public get(requestConfiguration?: AppRoleAssignedToRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AppRoleAssignmentCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AppRoleAssignmentCollectionResponseImpl>(requestInfo, createAppRoleAssignmentCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to appRoleAssignedTo for servicePrincipals
     * @param body 
     ...
     */
    public post(body: AppRoleAssignment | undefined, requestConfiguration?: AppRoleAssignedToRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AppRoleAssignmentImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        ...
        return this.requestAdapter?.sendAsync<AppRoleAssignmentImpl>(requestInfo, createAppRoleAssignmentFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
