...
import { createDelegatedPermissionClassificationCollectionResponseFromDiscriminatorValue, createDelegatedPermissionClassificationFromDiscriminatorValue, deserializeIntoDelegatedPermissionClassification, serializeDelegatedPermissionClassification, type DelegatedPermissionClassification, type DelegatedPermissionClassificationCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DelegatedPermissionClassificationItemRequestBuilder } from './item/';
 ...
 */
export class DelegatedPermissionClassificationsRequestBuilder extends BaseRequestBuilder<DelegatedPermissionClassificationsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/delegatedPermissionClassifications{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DelegatedPermissionClassificationsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<DelegatedPermissionClassificationsRequestBuilderGetQueryParameters> | undefined) : Promise<DelegatedPermissionClassificationCollectionResponse | undefined> {
     ...
     */
    public post(body: DelegatedPermissionClassification, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DelegatedPermissionClassification | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<DelegatedPermissionClassificationsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, delegatedPermissionClassificationsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DelegatedPermissionClassification, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
