...
import { deserializeIntoRemovePasswordPostRequestBody, serializeRemovePasswordPostRequestBody, type RemovePasswordPostRequestBody } from './removePasswordPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface RemovePasswordRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
 ...
 */
export class RemovePasswordRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/removePassword");
    };
    /**
     ...
     * @returns a removePasswordRequestBuilder
     */
    public withUrl(rawUrl: string) : RemovePasswordRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new RemovePasswordRequestBuilder(rawUrl, this.requestAdapter);
    };
}
