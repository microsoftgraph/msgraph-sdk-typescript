...
import {MicrosoftGraphRemoveKeyRequestBuilderPostRequestConfiguration} from './microsoftGraphRemoveKeyRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the removeKey method.
 */
export class MicrosoftGraphRemoveKeyRequestBuilder {
     ...
     */
    public post(body: RemoveKeyPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphRemoveKeyRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: RemoveKeyPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphRemoveKeyRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
