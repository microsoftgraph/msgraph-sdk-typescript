...
export class PasswordCredentialPostRequestBody implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** The passwordCredential property */
    private _passwordCredential?: PasswordCredential | AddPasswordMember1 | undefined;
    /**
     ...
     */
    public set passwordCredential(value: PasswordCredential | AddPasswordMember1 | undefined) {
