...
export class KeyCredentialResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["keyCredential", (o, n) => { (o as unknown as KeyCredentialResponse).keyCredential = n.getObjectValue<KeyCredential>(KeyCredential); }],
            ["passwordCredential", (o, n) => { (o as unknown as KeyCredentialResponse).passwordCredential = n.getObjectValue<PasswordCredential>(PasswordCredential); }],
            ["proof", (o, n) => { (o as unknown as KeyCredentialResponse).proof = n.getStringValue(); }],
        ]);
    };
    /**
