...
export class TokenLifetimePoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TokenLifetimePoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TokenLifetimePoliciesResponse).value = n.getCollectionOfObjectValues<TokenLifetimePolicy>(TokenLifetimePolicy); }],
        ]);
    };
    /**
