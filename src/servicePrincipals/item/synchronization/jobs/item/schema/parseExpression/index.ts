...
export class ParseExpressionRequestBuilder extends BaseRequestBuilder<ParseExpressionRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/parseExpression", (x, y) => new ParseExpressionRequestBuilder(x, y));
    }
    /**
