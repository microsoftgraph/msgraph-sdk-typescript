...
import { type PauseRequestBuilderPostRequestConfiguration } from './pauseRequestBuilderPostRequestConfiguration';
...
export class PauseRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a pauseRequestBuilder
     */
    public withUrl(rawUrl: string) : PauseRequestBuilder {
