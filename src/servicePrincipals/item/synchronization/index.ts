...
import { createSynchronizationFromDiscriminatorValue, deserializeIntoSynchronization, serializeSynchronization, type Synchronization } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { AcquireAccessTokenRequestBuilder } from './acquireAccessToken/';
import { JobsRequestBuilder } from './jobs/';
import { SecretsRequestBuilder } from './secrets/';
 ...
 */
export class SynchronizationRequestBuilder extends BaseRequestBuilder<SynchronizationRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization{?%24select,%24expand}", (x, y) => new SynchronizationRequestBuilder(x, y));
    }
    /**
