...
import { createSynchronizationSchemaFromDiscriminatorValue, deserializeIntoSynchronizationSchema, serializeSynchronizationSchema, type SynchronizationSchema } from '../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../models/oDataErrors/';
import { DirectoriesRequestBuilder } from './directories/';
import { FilterOperatorsRequestBuilder } from './filterOperators/';
import { FunctionsRequestBuilder } from './functions/';
import { ParseExpressionRequestBuilder } from './parseExpression/';
...
export class SchemaRequestBuilder extends BaseRequestBuilder<SchemaRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema{?%24select,%24expand}", (x, y) => new SchemaRequestBuilder(x, y));
    }
    /**
