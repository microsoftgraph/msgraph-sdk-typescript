...
export class AcquireAccessTokenRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/acquireAccessToken");
    };
    /**
     ...
     */
    public post(body: AcquireAccessTokenPostRequestBody | undefined, requestConfiguration?: AcquireAccessTokenRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: AcquireAccessTokenPostRequestBody | undefined, requestConfiguration?: AcquireAccessTokenRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeAcquireAccessTokenPostRequestBody);
        return requestInfo;
    };
}
