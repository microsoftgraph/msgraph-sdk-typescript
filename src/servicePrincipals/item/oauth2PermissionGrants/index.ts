...
import { createOAuth2PermissionGrantCollectionResponseFromDiscriminatorValue, type OAuth2PermissionGrantCollectionResponse } from '../../../models/';
...
export class Oauth2PermissionGrantsRequestBuilder extends BaseRequestBuilder<Oauth2PermissionGrantsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/oauth2PermissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new Oauth2PermissionGrantsRequestBuilder(x, y));
    }
    /**
