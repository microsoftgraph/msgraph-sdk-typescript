...
import { createClaimsMappingPolicyCollectionResponseFromDiscriminatorValue, type ClaimsMappingPolicyCollectionResponse } from '../../../models/';
...
export class ClaimsMappingPoliciesRequestBuilder extends BaseRequestBuilder<ClaimsMappingPoliciesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/claimsMappingPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ClaimsMappingPoliciesRequestBuilder(x, y));
    }
    /**
