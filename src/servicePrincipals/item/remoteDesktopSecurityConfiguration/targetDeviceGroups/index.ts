...
import { createTargetDeviceGroupCollectionResponseFromDiscriminatorValue, createTargetDeviceGroupFromDiscriminatorValue, deserializeIntoTargetDeviceGroup, serializeTargetDeviceGroup, type TargetDeviceGroup, type TargetDeviceGroupCollectionResponse } from '../../../../models/';
 ...
 */
export class TargetDeviceGroupsRequestBuilder extends BaseRequestBuilder<TargetDeviceGroupsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/remoteDesktopSecurityConfiguration/targetDeviceGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TargetDeviceGroupsRequestBuilder(x, y));
    }
    /**
