...
export class EndpointsRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: Endpoint | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: Endpoint | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Endpoint | undefined> {
        if(!body) throw new Error("body cannot be undefined");
