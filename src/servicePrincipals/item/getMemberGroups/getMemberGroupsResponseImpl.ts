...
export class GetMemberGroupsResponseImpl implements GetMemberGroupsResponse {
    ...
    public constructor(getMemberGroupsResponseParameterValue?: GetMemberGroupsResponse | undefined) {
        this._additionalData = getMemberGroupsResponseParameterValue?.additionalData ? getMemberGroupsResponseParameterValue?.additionalData! : {};
        this._value = getMemberGroupsResponseParameterValue?.value;
    };
    /**
