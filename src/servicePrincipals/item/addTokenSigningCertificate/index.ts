...
import { createSelfSignedCertificateFromDiscriminatorValue, deserializeIntoSelfSignedCertificate, serializeSelfSignedCertificate, type SelfSignedCertificate } from '../../../models/';
 ...
 */
export class AddTokenSigningCertificateRequestBuilder extends BaseRequestBuilder<AddTokenSigningCertificateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/addTokenSigningCertificate", (x, y) => new AddTokenSigningCertificateRequestBuilder(x, y));
    }
    /**
