...
export class AddTokenSigningCertificateRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: SelfSignedCertificateRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: SelfSignedCertificateRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SelfSignedCertificate | undefined> {
        if(!body) throw new Error("body cannot be undefined");
