...
export class CheckMemberObjectsRequestBuilder {
     ...
     */
    public post(body: CheckMemberObjectsRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<string[] | undefined> {
        if(!body) throw new Error("body cannot be undefined");
