...
export class CheckMemberObjectsRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: CheckMemberObjectsRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: CheckMemberObjectsRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CheckMemberObjectsResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
