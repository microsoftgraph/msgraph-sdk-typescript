...
import {MicrosoftGraphAddKeyRequestBuilderPostRequestConfiguration} from './microsoftGraphAddKeyRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the addKey method.
 */
export class MicrosoftGraphAddKeyRequestBuilder {
     ...
     */
    public post(body: AddKeyPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphAddKeyRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<KeyCredential | undefined> {
     ...
     */
    public toPostRequestInformation(body: AddKeyPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphAddKeyRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
