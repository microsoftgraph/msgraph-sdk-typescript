...
export class GraphDirectoryRoleRequestBuilder extends BaseRequestBuilder<GraphDirectoryRoleRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf/graph.directoryRole{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new GraphDirectoryRoleRequestBuilder(x, y));
    }
    /**
