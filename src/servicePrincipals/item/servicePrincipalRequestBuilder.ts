...
import {AppRoleAssignmentRequestBuilder as i02866529c441500ab6ff700fb3c67b3265755378c842507182a135cc363efc36} from './appRoleAssignedTo/item/appRoleAssignmentRequestBuilder';
import {AppRoleAssignmentsRequestBuilder} from './appRoleAssignments/appRoleAssignmentsRequestBuilder';
import {AppRoleAssignmentRequestBuilder as i8dec51485218f6f1fdb8d7a6f9f9d738cd35d705e777490c52c8468a9faea864} from './appRoleAssignments/item/appRoleAssignmentRequestBuilder';
...
export class ServicePrincipalRequestBuilder {
     ...
     */
    public appRoleAssignedToById(id: string) : i02866529c441500ab6ff700fb3c67b3265755378c842507182a135cc363efc36 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("appRoleAssignment_id", id);
        return new i02866529c441500ab6ff700fb3c67b3265755378c842507182a135cc363efc36(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a appRoleAssignmentRequestBuilder
     */
    public appRoleAssignmentsById(id: string) : i8dec51485218f6f1fdb8d7a6f9f9d738cd35d705e777490c52c8468a9faea864 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("appRoleAssignment_id", id);
        return new i8dec51485218f6f1fdb8d7a6f9f9d738cd35d705e777490c52c8468a9faea864(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: ServicePrincipal | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public delegatedPermissionClassificationsById(id: string) : DelegatedPermissionClassificationRequestBuilder {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("delegatedPermissionClassification_id", id);
    ...
    public endpointsById(id: string) : EndpointRequestBuilder {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("endpoint_id", id);
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ServicePrincipal | undefined> {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: ServicePrincipal | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
