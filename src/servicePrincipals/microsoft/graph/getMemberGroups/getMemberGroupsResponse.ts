...
export class Microsoft.graph.getMemberGroupsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["securityEnabledOnly", (o, n) => { (o as unknown as Microsoft.graph.getMemberGroupsResponse).securityEnabledOnly = n.getBooleanValue(); }],
        ]);
    };
    /**
