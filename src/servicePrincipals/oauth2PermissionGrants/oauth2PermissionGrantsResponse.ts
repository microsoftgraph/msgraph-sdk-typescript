...
export class Oauth2PermissionGrantsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as Oauth2PermissionGrantsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as Oauth2PermissionGrantsResponse).value = n.getCollectionOfObjectValues<OAuth2PermissionGrant>(OAuth2PermissionGrant); }],
        ]);
    };
    /**
