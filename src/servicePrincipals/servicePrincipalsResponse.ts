...
export class ServicePrincipalsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ServicePrincipalsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ServicePrincipalsResponse).value = n.getCollectionOfObjectValues<ServicePrincipal>(ServicePrincipal); }],
        ]);
    };
    /**
