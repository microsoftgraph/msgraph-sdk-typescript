...
import { createServicePrincipalCollectionResponseFromDiscriminatorValue, createServicePrincipalFromDiscriminatorValue, deserializeIntoServicePrincipal, serializeServicePrincipal, type ServicePrincipal, type ServicePrincipalCollectionResponse } from '../models/';
...
import { ServicePrincipalItemRequestBuilder } from './item/';
 ...
 */
export class ServicePrincipalsRequestBuilder extends BaseRequestBuilder<ServicePrincipalsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/servicePrincipals{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ServicePrincipalsRequestBuilder(x, y));
    }
    /**
