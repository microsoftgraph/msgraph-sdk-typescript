...
export class ExternalItemItemRequestBuilder {
    ...
    public createPatchRequestInformation(body: ExternalItem | undefined, requestConfiguration?: ExternalItemItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new ExternalItemImpl(body)
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: ExternalItemImpl | undefined, requestConfiguration?: ExternalItemItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
