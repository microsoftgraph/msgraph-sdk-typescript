...
import { createExternalItemCollectionResponseFromDiscriminatorValue, createExternalItemFromDiscriminatorValue, deserializeIntoExternalItem, serializeExternalItem, type ExternalItem, type ExternalItemCollectionResponse } from '../../../../models/externalConnectors/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ExternalItemItemRequestBuilder } from './item/';
...
export class ItemsRequestBuilder extends BaseRequestBuilder<ItemsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/external/connections/{externalConnection%2Did}/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ItemsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<ItemsRequestBuilderGetQueryParameters> | undefined) : Promise<ExternalItemCollectionResponse | undefined> {
     ...
     */
    public post(body: ExternalItem, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ExternalItem | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: ExternalItem, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
