...
import { createConnectionOperationCollectionResponseFromDiscriminatorValue, createConnectionOperationFromDiscriminatorValue, deserializeIntoConnectionOperation, serializeConnectionOperation, type ConnectionOperation, type ConnectionOperationCollectionResponse } from '../../../../models/externalConnectors/';
...
export class OperationsRequestBuilder extends BaseRequestBuilder<OperationsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/external/connections/{externalConnection%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new OperationsRequestBuilder(x, y));
    }
    /**
