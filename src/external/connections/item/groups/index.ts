...
import { createExternalGroupCollectionResponseFromDiscriminatorValue, createExternalGroupFromDiscriminatorValue, serializeExternalGroup, type ExternalGroup, type ExternalGroupCollectionResponse } from '../../../../models/externalConnectors/';
 ...
 */
export const GroupsRequestBuilderUriTemplate = "{+baseurl}/external/connections/{externalConnection%2Did}/groups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
