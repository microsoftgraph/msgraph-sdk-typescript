...
export class PlansResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as PlansResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as PlansResponse).value = n.getCollectionOfObjectValues<PlannerPlan>(PlannerPlan); }],
        ]);
    };
    /**
