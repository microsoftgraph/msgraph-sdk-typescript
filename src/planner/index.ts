...
import { createPlannerFromDiscriminatorValue, deserializeIntoPlanner, serializePlanner, type Planner } from '../models/';
...
export class PlannerRequestBuilder extends BaseRequestBuilder<PlannerRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/planner{?%24select,%24expand}", (x, y) => new PlannerRequestBuilder(x, y));
    }
    /**
     * Get planner
