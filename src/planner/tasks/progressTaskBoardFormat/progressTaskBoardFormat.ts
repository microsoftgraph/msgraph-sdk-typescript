...
export class ProgressTaskBoardFormat extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["orderHint", (o, n) => { (o as unknown as ProgressTaskBoardFormat).orderHint = n.getStringValue(); }],
        ]);
    };
    /**
