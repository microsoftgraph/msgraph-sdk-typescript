...
export class AssignedToTaskBoardFormatRequestBuilder extends BaseRequestBuilder<AssignedToTaskBoardFormatRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/planner/tasks/{plannerTask%2Did}/assignedToTaskBoardFormat{?%24select,%24expand}", (x, y) => new AssignedToTaskBoardFormatRequestBuilder(x, y));
    }
    /**
