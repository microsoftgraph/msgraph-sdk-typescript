...
import {PlannerOrderHintsByAssignee} from '../../../tasks/plannerOrderHintsByAssignee';
...
export class AssignedToTaskBoardFormat extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["orderHintsByAssignee", (o, n) => { (o as unknown as AssignedToTaskBoardFormat).orderHintsByAssignee = n.getObjectValue<PlannerOrderHintsByAssignee>(PlannerOrderHintsByAssignee); }],
            ["unassignedOrderHint", (o, n) => { (o as unknown as AssignedToTaskBoardFormat).unassignedOrderHint = n.getStringValue(); }],
        ]);
    };
    /**
