...
import { createIdentityProviderFromDiscriminatorValue, deserializeIntoIdentityProvider, serializeIdentityProvider, type IdentityProvider } from '../../models/';
...
export class IdentityProviderItemRequestBuilder extends BaseRequestBuilder<IdentityProviderItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/identityProviders/{identityProvider%2Did}{?%24select,%24expand}", (x, y) => new IdentityProviderItemRequestBuilder(x, y));
    }
    /**
