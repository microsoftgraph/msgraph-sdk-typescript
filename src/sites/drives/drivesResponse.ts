...
export class DrivesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DrivesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DrivesResponse).value = n.getCollectionOfObjectValues<Drive>(Drive); }],
        ]);
    };
    /**
