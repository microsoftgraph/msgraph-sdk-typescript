...
export class RemoveResponseImpl implements RemoveResponse {
    ...
    public constructor(removeResponseParameterValue?: RemoveResponse | undefined) {
        this._additionalData = removeResponseParameterValue?.additionalData ? removeResponseParameterValue?.additionalData! : {};
        this._value = removeResponseParameterValue?.value;
    };
    /**
