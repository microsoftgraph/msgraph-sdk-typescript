...
import { createRemovePostResponseFromDiscriminatorValue, deserializeIntoRemovePostResponse, serializeRemovePostResponse, type RemovePostResponse } from './removePostResponse';
...
export class RemoveRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RemovePostRequestBody, requestConfiguration?: RemoveRequestBuilderPostRequestConfiguration | undefined) : Promise<RemovePostResponse | undefined> {
