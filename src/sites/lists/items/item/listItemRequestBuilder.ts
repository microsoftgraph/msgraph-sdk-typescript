...
export class ListItemRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: ListItem | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.lists.items.versions collection
