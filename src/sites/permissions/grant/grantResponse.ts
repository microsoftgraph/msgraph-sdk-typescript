import {DriveRecipient} from '../../../workbooks/invite/driveRecipient';
import {SerializationWriter, ParseNode, Parsable} from '@microsoft/kiota-abstractions';

export class GrantResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["recipients", (o, n) => { (o as unknown as GrantResponse).recipients = n.getCollectionOfObjectValues<DriveRecipient>(DriveRecipient); }],
            ["roles", (o, n) => { (o as unknown as GrantResponse).roles = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
