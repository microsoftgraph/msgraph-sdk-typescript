...
export class GetAllSitesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetAllSitesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetAllSitesResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetAllSitesResponse>(requestInfo, createGetAllSitesResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Invoke function getAllSites
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
