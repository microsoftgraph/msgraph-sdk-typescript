...
export class ParentSectionGroup extends OnenoteEntityHierarchyModel implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["parentNotebook", (o, n) => { (o as unknown as ParentSectionGroup).parentNotebook = n.getObjectValue<Notebook>(Notebook); }],
            ["parentSectionGroup", (o, n) => { (o as unknown as ParentSectionGroup).parentSectionGroup = n.getObjectValue<SectionGroup>(SectionGroup); }],
            ["sectionGroups", (o, n) => { (o as unknown as ParentSectionGroup).sectionGroups = n.getCollectionOfObjectValues<SectionGroup>(SectionGroup); }],
            ["sectionGroupsUrl", (o, n) => { (o as unknown as ParentSectionGroup).sectionGroupsUrl = n.getStringValue(); }],
            ["sections", (o, n) => { (o as unknown as ParentSectionGroup).sections = n.getCollectionOfObjectValues<OnenoteSection>(OnenoteSection); }],
            ["sectionsUrl", (o, n) => { (o as unknown as ParentSectionGroup).sectionsUrl = n.getStringValue(); }],
        ]);
    };
    /**
