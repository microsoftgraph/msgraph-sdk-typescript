...
/** Builds and executes requests for operations under /sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook  */
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.sections.parentNotebook.sectionGroups collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.sections.parentNotebook.sections collection
     * @param id Unique identifier of the item
