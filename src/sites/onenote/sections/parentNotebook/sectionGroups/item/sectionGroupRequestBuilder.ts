...
/** Builds and executes requests for operations under /sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook/sectionGroups/{sectionGroup-id}  */
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.sections.parentNotebook.sectionGroups.sectionGroups collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.sections.parentNotebook.sectionGroups.sections collection
     * @param id Unique identifier of the item
