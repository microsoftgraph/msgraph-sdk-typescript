...
export class OnenoteRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.notebooks collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.operations collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.pages collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.resources collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.sectionGroups collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.sections collection
     * @param id Unique identifier of the item
