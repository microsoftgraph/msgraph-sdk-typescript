...
export class OnenoteRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.notebooks collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.operations collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.resources collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.sectionGroups collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.sections collection
     * @param id Unique identifier of the item
