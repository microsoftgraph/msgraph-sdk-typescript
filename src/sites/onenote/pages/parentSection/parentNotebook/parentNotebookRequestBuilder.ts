...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.pages.parentSection.parentNotebook.sectionGroups collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.pages.parentSection.parentNotebook.sections collection
     * @param id Unique identifier of the item
