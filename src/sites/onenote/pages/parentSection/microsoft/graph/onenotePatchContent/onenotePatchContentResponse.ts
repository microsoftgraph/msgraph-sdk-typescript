...
export class Microsoft.graph.onenotePatchContentResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["commands", (o, n) => { (o as unknown as Microsoft.graph.onenotePatchContentResponse).commands = n.getCollectionOfPrimitiveValues<onenotePatchContentCommand>(); }],
        ]);
    };
    /**
