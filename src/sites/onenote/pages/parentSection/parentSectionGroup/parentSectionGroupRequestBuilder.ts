...
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentSection.parentSectionGroup.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentSection.parentSectionGroup.sections collection
     * @param id Unique identifier of the item
