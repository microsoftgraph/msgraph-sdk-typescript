...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentSection.parentSectionGroup.parentNotebook.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentSection.parentSectionGroup.parentNotebook.sections collection
     * @param id Unique identifier of the item
