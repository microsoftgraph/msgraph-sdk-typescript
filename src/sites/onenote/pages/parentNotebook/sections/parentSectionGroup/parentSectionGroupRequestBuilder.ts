...
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentNotebook.sections.parentSectionGroup.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentNotebook.sections.parentSectionGroup.sections collection
     * @param id Unique identifier of the item
