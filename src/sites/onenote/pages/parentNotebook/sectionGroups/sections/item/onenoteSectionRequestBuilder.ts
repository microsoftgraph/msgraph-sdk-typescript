...
/** Builds and executes requests for operations under /sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}  */
export class OnenoteSectionRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: OnenoteSection | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentNotebook.sectionGroups.sections.pages collection
