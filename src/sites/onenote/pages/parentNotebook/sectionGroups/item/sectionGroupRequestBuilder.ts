...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentNotebook.sectionGroups.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentNotebook.sectionGroups.sections collection
     * @param id Unique identifier of the item
