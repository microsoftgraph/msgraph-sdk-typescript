...
export class CopyNotebookResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupId", (o, n) => { (o as unknown as CopyNotebookResponse).groupId = n.getStringValue(); }],
            ["notebookFolder", (o, n) => { (o as unknown as CopyNotebookResponse).notebookFolder = n.getStringValue(); }],
            ["renameAs", (o, n) => { (o as unknown as CopyNotebookResponse).renameAs = n.getStringValue(); }],
            ["siteCollectionId", (o, n) => { (o as unknown as CopyNotebookResponse).siteCollectionId = n.getStringValue(); }],
            ["siteId", (o, n) => { (o as unknown as CopyNotebookResponse).siteId = n.getStringValue(); }],
        ]);
    };
    /**
