...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.sectionGroups.sectionGroups collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.onenote.sectionGroups.sections collection
     * @param id Unique identifier of the item
