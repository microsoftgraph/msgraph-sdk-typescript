...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.sectionGroups.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.sectionGroups.sections collection
     * @param id Unique identifier of the item
