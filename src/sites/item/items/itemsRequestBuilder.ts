...
export class ItemsRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: BaseItem | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: BaseItem | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<BaseItem | undefined> {
        if(!body) throw new Error("body cannot be undefined");
