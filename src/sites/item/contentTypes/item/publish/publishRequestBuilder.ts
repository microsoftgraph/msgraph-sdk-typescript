...
/** Builds and executes requests for operations under /sites/{site-id}/contentTypes/{contentType-id}/microsoft.graph.publish  */
export class PublishRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/contentTypes/{contentType_id}/microsoft.graph.publish";
