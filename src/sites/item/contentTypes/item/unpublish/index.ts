 ...
 */
export class UnpublishRequestBuilder extends BaseRequestBuilder<UnpublishRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/unpublish", (x, y) => new UnpublishRequestBuilder(x, y));
    }
    /**
