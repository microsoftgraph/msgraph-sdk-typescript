...
export class GetApplicableContentTypesForListWithListIdRequestBuilder extends BaseRequestBuilder<GetApplicableContentTypesForListWithListIdRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, listId?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getApplicableContentTypesForList(listId='{listId}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", (x, y) => new GetApplicableContentTypesForListWithListIdRequestBuilder(x, y));
