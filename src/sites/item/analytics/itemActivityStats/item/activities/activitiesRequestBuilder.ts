...
export class ActivitiesRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: ItemActivity | undefined, requestConfiguration?: ActivitiesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
