...
export class ActivitiesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<ActivitiesRequestBuilderGetQueryParameters> | undefined) : Promise<ItemActivityCollectionResponse | undefined> {
     ...
     */
    public post(body: ItemActivity, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ItemActivity | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: ItemActivity, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
