...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.onenote.sectionGroups.item.sections.item.parentNotebook.sectionGroups.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.onenote.sectionGroups.item.sections.item.parentNotebook.sections.item collection
     * @param id Unique identifier of the item
