...
import {SectionGroupRequestBuilder as i82dad99c058674e777efecc334e3cbc5db06e7a82e046e9e11045f4c8fb514ab} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: String) : i82dad99c058674e777efecc334e3cbc5db06e7a82e046e9e11045f4c8fb514ab {
        if(!id) throw new Error("id cannot be undefined");
        return new i82dad99c058674e777efecc334e3cbc5db06e7a82e046e9e11045f4c8fb514ab(this.currentPath + this.pathSegment + "/sectionGroups/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
