...
import { deserializeIntoCopyNotebookPostRequestBody, serializeCopyNotebookPostRequestBody, type CopyNotebookPostRequestBody } from './copyNotebookPostRequestBody';
...
export class CopyNotebookRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/copyNotebook");
    };
    /**
