...
export class NotebookRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.notebooks.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.notebooks.item.sections.item collection
     * @param id Unique identifier of the item
