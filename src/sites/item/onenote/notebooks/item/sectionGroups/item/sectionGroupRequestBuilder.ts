...
import {SectionGroupRequestBuilder as ic99f56be0ebc341f3f3331969187ab491d8b488988c37c8408f71f572b7149d2} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : ic99f56be0ebc341f3f3331969187ab491d8b488988c37c8408f71f572b7149d2 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("sectionGroup_id1", id);
        return new ic99f56be0ebc341f3f3331969187ab491d8b488988c37c8408f71f572b7149d2(urlTplParams, this.requestAdapter);
    };
    /**
