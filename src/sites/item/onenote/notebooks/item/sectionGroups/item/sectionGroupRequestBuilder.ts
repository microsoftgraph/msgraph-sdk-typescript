...
import {SectionGroupRequestBuilder as ib70fb9e998b07e90f7b5f8ef753a018506b79843e374f611de9dd81164df549d} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.notebooks.item.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: String) : ib70fb9e998b07e90f7b5f8ef753a018506b79843e374f611de9dd81164df549d {
        if(!id) throw new Error("id cannot be undefined");
        return new ib70fb9e998b07e90f7b5f8ef753a018506b79843e374f611de9dd81164df549d(this.currentPath + this.pathSegment + "/sectionGroups/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.notebooks.item.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
