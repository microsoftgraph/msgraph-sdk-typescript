...
import {SectionGroupRequestBuilder as i2c8d94b1672efa918acd4eec8ea90b2d420726bfae1d8820233d2e2e515781dd} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : i2c8d94b1672efa918acd4eec8ea90b2d420726bfae1d8820233d2e2e515781dd {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup_id1"] = id
        return new i2c8d94b1672efa918acd4eec8ea90b2d420726bfae1d8820233d2e2e515781dd(urlTplParams, this.requestAdapter);
    };
    /**
