...
/** Builds and executes requests for operations under /sites/{site-id}/onenote/resources/{onenoteResource-id}/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/resources/{onenoteResource_id}/content";
