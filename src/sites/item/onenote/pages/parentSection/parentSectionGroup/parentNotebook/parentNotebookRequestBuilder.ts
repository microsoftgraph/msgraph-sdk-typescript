...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.pages.item.parentSection.parentSectionGroup.parentNotebook.sectionGroups.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.pages.item.parentSection.parentSectionGroup.parentNotebook.sections.item collection
     * @param id Unique identifier of the item
