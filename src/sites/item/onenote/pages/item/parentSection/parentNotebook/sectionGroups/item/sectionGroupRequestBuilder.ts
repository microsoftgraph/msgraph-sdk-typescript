...
import {SectionGroupRequestBuilder as i79d93409e77a3a128ca0106d2f0ba302134334660fd0cd21b0bc12677b0e51af} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.onenote.pages.item.parentSection.parentNotebook.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: string) : i79d93409e77a3a128ca0106d2f0ba302134334660fd0cd21b0bc12677b0e51af {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("sectionGroup_id1", id);
        return new i79d93409e77a3a128ca0106d2f0ba302134334660fd0cd21b0bc12677b0e51af(urlTplParams, this.requestAdapter);
    };
    /**
     * Gets an item from the MicrosoftGraph.sites.item.onenote.pages.item.parentSection.parentNotebook.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
