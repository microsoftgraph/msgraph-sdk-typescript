...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.onenote.sections.item.parentSectionGroup.parentNotebook.sectionGroups.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.onenote.sections.item.parentSectionGroup.parentNotebook.sections.item collection
     * @param id Unique identifier of the item
