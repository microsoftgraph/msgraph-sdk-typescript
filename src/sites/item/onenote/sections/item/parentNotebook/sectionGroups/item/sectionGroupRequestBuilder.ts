...
import {SectionGroupRequestBuilder as iea62c072c60ddaf98b5f3a2e9e89cad8555b4e7cd60bbb1ec76cb4ea5db7f00a} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.sections.item.parentNotebook.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: String) : iea62c072c60ddaf98b5f3a2e9e89cad8555b4e7cd60bbb1ec76cb4ea5db7f00a {
        if(!id) throw new Error("id cannot be undefined");
        return new iea62c072c60ddaf98b5f3a2e9e89cad8555b4e7cd60bbb1ec76cb4ea5db7f00a(this.currentPath + this.pathSegment + "/sectionGroups/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.sections.item.parentNotebook.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
