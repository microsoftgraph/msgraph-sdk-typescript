...
import {SectionGroupRequestBuilder as if1db81ae88587cc566b6320459a3c9d6abcce811aa2636d6ad9d29e2b5104b94} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.sections.item.pages.item.parentNotebook.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: String) : if1db81ae88587cc566b6320459a3c9d6abcce811aa2636d6ad9d29e2b5104b94 {
        if(!id) throw new Error("id cannot be undefined");
        return new if1db81ae88587cc566b6320459a3c9d6abcce811aa2636d6ad9d29e2b5104b94(this.currentPath + this.pathSegment + "/sectionGroups/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.onenote.sections.item.pages.item.parentNotebook.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
