...
export class TermStoresResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TermStoresResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TermStoresResponse).value = n.getCollectionOfObjectValues<Store>(Store); }],
        ]);
    };
    /**
