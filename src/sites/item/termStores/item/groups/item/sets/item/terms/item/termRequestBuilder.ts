...
import {TermRequestBuilder as ifcbd29a12347c8356979a6991348a6648027cc3748ddcd1b2e1751330b8977b2} from './children/item/termRequestBuilder';
...
export class TermRequestBuilder {
     ...
     */
    public childrenById(id: string) : ifcbd29a12347c8356979a6991348a6648027cc3748ddcd1b2e1751330b8977b2 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("term_id1", id);
        return new ifcbd29a12347c8356979a6991348a6648027cc3748ddcd1b2e1751330b8977b2(urlTplParams, this.requestAdapter);
    };
    /**
