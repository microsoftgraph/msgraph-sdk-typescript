...
import {TermRequestBuilder as ib658e8875458312122329532e150bd7673cc72d9fbf54a72cf2af84ffa178255} from './children/item/termRequestBuilder';
...
/** Builds and executes requests for operations under /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/children/{term-id}  */
export class TermRequestBuilder {
     ...
     */
    public childrenById(id: string) : ib658e8875458312122329532e150bd7673cc72d9fbf54a72cf2af84ffa178255 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("term_id1", id);
        return new ib658e8875458312122329532e150bd7673cc72d9fbf54a72cf2af84ffa178255(urlTplParams, this.requestAdapter);
    };
    /**
