...
import {TermItemRequestBuilder as id3e647040ac10ad518fdb03e04847d74b908a90e899b768209d3f5f9d722aa0e} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : id3e647040ac10ad518fdb03e04847d74b908a90e899b768209d3f5f9d722aa0e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new id3e647040ac10ad518fdb03e04847d74b908a90e899b768209d3f5f9d722aa0e(urlTplParams, this.requestAdapter);
    };
    /**
