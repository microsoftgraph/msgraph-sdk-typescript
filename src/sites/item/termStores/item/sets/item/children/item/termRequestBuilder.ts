...
import {TermRequestBuilder as i4253b79f4766db519585a024a1259f36ecae71e76131842b7462060cf07cf33f} from './children/item/termRequestBuilder';
...
/** Builds and executes requests for operations under /sites/{site-id}/termStores/{store-id}/sets/{set-id}/children/{term-id}  */
export class TermRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.sites.item.termStores.item.sets.item.children.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a termRequestBuilder
     */
    public childrenById(id: string) : i4253b79f4766db519585a024a1259f36ecae71e76131842b7462060cf07cf33f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("term_id1", id);
        return new i4253b79f4766db519585a024a1259f36ecae71e76131842b7462060cf07cf33f(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/children/{term_id}{?select,expand}";
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.sites.item.termStores.item.sets.item.children.item.relations.item collection
     * @param id Unique identifier of the item
