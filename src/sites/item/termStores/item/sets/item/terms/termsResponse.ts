...
export class TermsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TermsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TermsResponse).value = n.getCollectionOfObjectValues<Term>(Term); }],
        ]);
    };
    /**
