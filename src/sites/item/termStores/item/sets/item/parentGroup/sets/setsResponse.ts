...
export class SetsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SetsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SetsResponse).value = n.getCollectionOfObjectValues<Set>(Set); }],
        ]);
    };
    /**
