...
import { createSiteFromDiscriminatorValue, deserializeIntoSite, serializeSite, type Site } from '../../models/';
...
import { GetByPathWithPathRequestBuilder } from './getByPathWithPath/';
...
export class SiteItemRequestBuilder extends BaseRequestBuilder<SiteItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/sites/{site%2Did}{?%24select,%24expand}", (x, y) => new SiteItemRequestBuilder(x, y));
    }
    /**
     ...
     * @returns a Promise of Site
     */
    public patch(body: Site, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<Site | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: Site, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
