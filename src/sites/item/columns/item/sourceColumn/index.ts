...
export class SourceColumnRequestBuilder extends BaseRequestBuilder<SourceColumnRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/sites/{site%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}", (x, y) => new SourceColumnRequestBuilder(x, y));
    }
    /**
