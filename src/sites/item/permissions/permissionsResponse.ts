...
export class PermissionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as PermissionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as PermissionsResponse).value = n.getCollectionOfObjectValues<Permission>(Permission); }],
        ]);
    };
    /**
