...
import {TermRequestBuilder as i62aaa9e02bf648f862812d835e770532a6d3e03c9780229be40a3f2fd5172be8} from './children/item/termRequestBuilder';
...
export class TermRequestBuilder {
     ...
     */
    public childrenById(id: string) : i62aaa9e02bf648f862812d835e770532a6d3e03c9780229be40a3f2fd5172be8 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term_id1"] = id
        return new i62aaa9e02bf648f862812d835e770532a6d3e03c9780229be40a3f2fd5172be8(urlTplParams, this.requestAdapter);
    };
    /**
