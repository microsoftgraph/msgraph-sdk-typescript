...
/** Builds and executes requests for operations under /sites/{site-id}/termStore/sets/{set-id}/relations/{relation-id}  */
export class RelationItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/relations/{relation_id}{?select,expand}";
