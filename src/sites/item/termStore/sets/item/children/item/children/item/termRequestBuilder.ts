...
/** Builds and executes requests for operations under /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}/children/{term-id1}  */
export class TermRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/children/{term_id}/children/{term_id1}{?select,expand}";
