...
import {TermRequestBuilder as i25d0512c2b7c30fb8037503fef753d0b81229817d9e3604ec7b10ea769337017} from './children/item/termRequestBuilder';
...
/** Builds and executes requests for operations under /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/children/{term-id}  */
export class TermRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.sites.item.termStore.groups.item.sets.item.children.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a termRequestBuilder
     */
    public childrenById(id: string) : i25d0512c2b7c30fb8037503fef753d0b81229817d9e3604ec7b10ea769337017 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("term_id1", id);
        return new i25d0512c2b7c30fb8037503fef753d0b81229817d9e3604ec7b10ea769337017(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/children/{term_id}{?select,expand}";
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.sites.item.termStore.groups.item.sets.item.children.item.relations.item collection
     * @param id Unique identifier of the item
