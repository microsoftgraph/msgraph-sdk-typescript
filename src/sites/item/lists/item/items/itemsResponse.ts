...
export class ItemsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ItemsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ItemsResponse).value = n.getCollectionOfObjectValues<ListItem>(ListItem); }],
        ]);
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<ListItem>("value", this.value);
