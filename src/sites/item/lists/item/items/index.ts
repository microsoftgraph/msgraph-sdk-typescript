...
export class ItemsRequestBuilder extends BaseRequestBuilder<ItemsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items{?%24top,%24skip,%24search,%24filter,%24orderby,%24select,%24expand}", (x, y) => new ItemsRequestBuilder(x, y));
    }
    /**
