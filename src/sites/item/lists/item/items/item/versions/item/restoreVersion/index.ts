...
export class RestoreVersionRequestBuilder extends BaseRequestBuilder<RestoreVersionRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions/{listItemVersion%2Did}/restoreVersion", (x, y) => new RestoreVersionRequestBuilder(x, y));
    }
    /**
