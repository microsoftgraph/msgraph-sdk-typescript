...
export class ListRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.lists.item.columns.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.lists.item.contentTypes.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.lists.item.items.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.sites.item.lists.item.subscriptions.item collection
     * @param id Unique identifier of the item
