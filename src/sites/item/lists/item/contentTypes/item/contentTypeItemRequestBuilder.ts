...
export class ContentTypeItemRequestBuilder {
     ...
     */
    public baseTypesById(id: string) : I0a8bb98fe6d95114f523e0fe77457730ceaabbe1c1ad87a981168489faa3939e | undefined {
     ...
     */
    public columnPositionsById(id: string) : I0f2d2614e3c5ae08207fbee2700243a82e4b41f2415f637f4a628c1a1f700531 | undefined {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
     ...
     * @returns a ColumnDefinitionItemRequestBuilder
     */
    public columnsById(id: string) : Ia5ad194dbbf9a0d205cb7ef776a12ec13cd57de3c7470b05db1225df89cfe1ea | undefined {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
