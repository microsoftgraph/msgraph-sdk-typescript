...
export class ColumnLinksResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ColumnLinksResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ColumnLinksResponse).value = n.getCollectionOfObjectValues<ColumnLink>(ColumnLink); }],
        ]);
    };
    /**
