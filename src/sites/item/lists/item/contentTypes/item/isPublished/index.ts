...
export class IsPublishedRequestBuilder extends BaseRequestBuilder<IsPublishedRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/isPublished()", (x, y) => new IsPublishedRequestBuilder(x, y));
    }
    /**
