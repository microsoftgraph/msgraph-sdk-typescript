import {ListCollectionResponseImpl, ListImpl} from '../../../models/';
...
export class ListsRequestBuilder {
     ...
     */
    public get(requestConfiguration?: ListsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ListCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ListCollectionResponseImpl>(requestInfo, createListCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to lists for sites
     * @param body 
     ...
     */
    public post(body: List | undefined, requestConfiguration?: ListsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ListImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
