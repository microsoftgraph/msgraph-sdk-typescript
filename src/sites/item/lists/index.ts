...
import { createListCollectionResponseFromDiscriminatorValue, createListFromDiscriminatorValue, deserializeIntoList, serializeList, type List, type ListCollectionResponse } from '../../../models/';
 ...
 */
export class ListsRequestBuilder extends BaseRequestBuilder<ListsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/sites/{site%2Did}/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ListsRequestBuilder(x, y));
    }
    /**
