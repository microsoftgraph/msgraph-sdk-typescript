...
import { createGroupSettingTemplateFromDiscriminatorValue, deserializeIntoGroupSettingTemplate, serializeGroupSettingTemplate, type GroupSettingTemplate } from '../../models/';
 ...
 */
export class GroupSettingTemplateItemRequestBuilder extends BaseRequestBuilder<GroupSettingTemplateItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/groupSettingTemplates/{groupSettingTemplate%2Did}{?%24select,%24expand}", (x, y) => new GroupSettingTemplateItemRequestBuilder(x, y));
    }
    /**
