...
export class Microsoft.graph.getByIdsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["ids", (o, n) => { (o as unknown as Microsoft.graph.getByIdsResponse).ids = n.getCollectionOfPrimitiveValues<string>(); }],
            ["types", (o, n) => { (o as unknown as Microsoft.graph.getByIdsResponse).types = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
