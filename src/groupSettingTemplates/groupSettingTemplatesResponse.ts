...
export class GroupSettingTemplatesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as GroupSettingTemplatesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as GroupSettingTemplatesResponse).value = n.getCollectionOfObjectValues<GroupSettingTemplate>(GroupSettingTemplate); }],
        ]);
    };
    /**
