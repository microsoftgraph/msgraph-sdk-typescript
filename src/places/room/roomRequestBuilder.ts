import {RoomCollectionResponseImpl} from '../../models/';
import {createRoomCollectionResponseFromDiscriminatorValue} from '../../models/createRoomCollectionResponseFromDiscriminatorValue';
...
export class RoomRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RoomRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RoomCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<RoomCollectionResponseImpl>(requestInfo, createRoomCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
