...
export class RoomRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RoomRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Room | undefined> {
        ...
        return this.requestAdapter?.sendAsync<Room>(requestInfo, createRoomFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
