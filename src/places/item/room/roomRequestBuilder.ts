...
export class RoomRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RoomRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RoomImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<RoomImpl>(requestInfo, createRoomFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
