...
import { createRoomListCollectionResponseFromDiscriminatorValue, type RoomListCollectionResponse } from '../../models/';
...
export class GraphRoomListRequestBuilder extends BaseRequestBuilder<GraphRoomListRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/places/graph.roomList{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new GraphRoomListRequestBuilder(x, y));
    }
    /**
