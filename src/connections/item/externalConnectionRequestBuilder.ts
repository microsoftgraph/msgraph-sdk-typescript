...
export class ExternalConnectionRequestBuilder {
    ...
    public get schema(): SchemaRequestBuilder {
        return new SchemaRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    }
    /**
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: ExternalConnection | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ExternalConnection | undefined> {
    ...
    public operationsById(id: String) : ConnectionOperationRequestBuilder {
        if(!id) throw new Error("id cannot be undefined");
        return new ConnectionOperationRequestBuilder(this.currentPath + this.pathSegment + "/operations/" + id, this.httpCore, false);
    };
    /**
     * Update entity in connections
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: ExternalConnection | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
