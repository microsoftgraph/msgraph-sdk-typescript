...
import { createIdentityCollectionResponseFromDiscriminatorValue, createIdentityFromDiscriminatorValue, deserializeIntoIdentity, serializeIdentity, type Identity, type IdentityCollectionResponse } from '../../../../../models/externalConnectors/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { IdentityItemRequestBuilder } from './item/';
...
export class MembersRequestBuilder extends BaseRequestBuilder<MembersRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/groups/{externalGroup%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new MembersRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<MembersRequestBuilderGetQueryParameters> | undefined) : Promise<IdentityCollectionResponse | undefined> {
     ...
     */
    public post(body: Identity, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<Identity | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: Identity, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
