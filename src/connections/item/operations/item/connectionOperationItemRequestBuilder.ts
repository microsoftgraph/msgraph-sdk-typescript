...
export class ConnectionOperationItemRequestBuilder {
    ...
    public createPatchRequestInformation(body: ConnectionOperation | undefined, requestConfiguration?: ConnectionOperationItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new ConnectionOperationImpl(body)
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: ConnectionOperationImpl | undefined, requestConfiguration?: ConnectionOperationItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
