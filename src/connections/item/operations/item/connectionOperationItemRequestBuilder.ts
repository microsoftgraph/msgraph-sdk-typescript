...
export class ConnectionOperationItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: ConnectionOperationItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
