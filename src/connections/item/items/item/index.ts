...
export class ExternalItemItemRequestBuilder extends BaseRequestBuilder<ExternalItemItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}{?%24select,%24expand}", (x, y) => new ExternalItemItemRequestBuilder(x, y));
    }
    /**
