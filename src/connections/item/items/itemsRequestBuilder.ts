...
export class ItemsRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: ExternalItem | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: ExternalItem | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ExternalItem | undefined> {
        if(!body) throw new Error("body cannot be undefined");
