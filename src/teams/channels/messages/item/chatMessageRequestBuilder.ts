...
export class ChatMessageRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.channels.messages.hostedContents collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.channels.messages.replies collection
     * @param id Unique identifier of the item
