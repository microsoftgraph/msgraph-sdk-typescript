...
export class ChatMessageRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.teams.channels.messages.hostedContents collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.teams.channels.messages.replies collection
     * @param id Unique identifier of the item
