...
export class FilesFolder extends BaseItem implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["analytics", (o, n) => { (o as unknown as FilesFolder).analytics = n.getObjectValue<ItemAnalytics>(ItemAnalytics); }],
            ["audio", (o, n) => { (o as unknown as FilesFolder).audio = n.getObjectValue<Audio>(Audio); }],
            ["children", (o, n) => { (o as unknown as FilesFolder).children = n.getCollectionOfObjectValues<DriveItem>(DriveItem); }],
            ["content", (o, n) => { (o as unknown as FilesFolder).content = n.getObjectValue<Binary>(Binary); }],
            ["cTag", (o, n) => { (o as unknown as FilesFolder).cTag = n.getStringValue(); }],
            ["deleted", (o, n) => { (o as unknown as FilesFolder).deleted = n.getObjectValue<Deleted>(Deleted); }],
            ["file", (o, n) => { (o as unknown as FilesFolder).file = n.getObjectValue<File>(File); }],
            ["fileSystemInfo", (o, n) => { (o as unknown as FilesFolder).fileSystemInfo = n.getObjectValue<FileSystemInfo>(FileSystemInfo); }],
            ["folder", (o, n) => { (o as unknown as FilesFolder).folder = n.getObjectValue<Folder>(Folder); }],
            ["image", (o, n) => { (o as unknown as FilesFolder).image = n.getObjectValue<Image>(Image); }],
            ["listItem", (o, n) => { (o as unknown as FilesFolder).listItem = n.getObjectValue<ListItem>(ListItem); }],
            ["location", (o, n) => { (o as unknown as FilesFolder).location = n.getObjectValue<GeoCoordinates>(GeoCoordinates); }],
            ["package", (o, n) => { (o as unknown as FilesFolder).package = n.getObjectValue<Package>(Package); }],
            ["pendingOperations", (o, n) => { (o as unknown as FilesFolder).pendingOperations = n.getObjectValue<PendingOperations>(PendingOperations); }],
            ["permissions", (o, n) => { (o as unknown as FilesFolder).permissions = n.getCollectionOfObjectValues<Permission>(Permission); }],
            ["photo", (o, n) => { (o as unknown as FilesFolder).photo = n.getObjectValue<Photo>(Photo); }],
            ["publication", (o, n) => { (o as unknown as FilesFolder).publication = n.getObjectValue<PublicationFacet>(PublicationFacet); }],
            ["remoteItem", (o, n) => { (o as unknown as FilesFolder).remoteItem = n.getObjectValue<RemoteItem>(RemoteItem); }],
            ["root", (o, n) => { (o as unknown as FilesFolder).root = n.getObjectValue<Root>(Root); }],
            ["searchResult", (o, n) => { (o as unknown as FilesFolder).searchResult = n.getObjectValue<SearchResult>(SearchResult); }],
            ["shared", (o, n) => { (o as unknown as FilesFolder).shared = n.getObjectValue<Shared>(Shared); }],
            ["sharepointIds", (o, n) => { (o as unknown as FilesFolder).sharepointIds = n.getObjectValue<SharepointIds>(SharepointIds); }],
            ["size", (o, n) => { (o as unknown as FilesFolder).size = n.getObjectValue<Int64>(Int64); }],
            ["specialFolder", (o, n) => { (o as unknown as FilesFolder).specialFolder = n.getObjectValue<SpecialFolder>(SpecialFolder); }],
            ["subscriptions", (o, n) => { (o as unknown as FilesFolder).subscriptions = n.getCollectionOfObjectValues<Subscription>(Subscription); }],
            ["thumbnails", (o, n) => { (o as unknown as FilesFolder).thumbnails = n.getCollectionOfObjectValues<ThumbnailSet>(ThumbnailSet); }],
            ["versions", (o, n) => { (o as unknown as FilesFolder).versions = n.getCollectionOfObjectValues<DriveItemVersion>(DriveItemVersion); }],
            ["video", (o, n) => { (o as unknown as FilesFolder).video = n.getObjectValue<Video>(Video); }],
            ["webDavUrl", (o, n) => { (o as unknown as FilesFolder).webDavUrl = n.getStringValue(); }],
            ["workbook", (o, n) => { (o as unknown as FilesFolder).workbook = n.getObjectValue<Workbook>(Workbook); }],
        ]);
    };
    /**
