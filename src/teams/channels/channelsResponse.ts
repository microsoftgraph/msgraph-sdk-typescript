...
export class ChannelsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ChannelsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ChannelsResponse).value = n.getCollectionOfObjectValues<Channel>(Channel); }],
        ]);
    };
    /**
