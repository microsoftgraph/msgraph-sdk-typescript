...
export class PrimaryChannel extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["createdDateTime", (o, n) => { (o as unknown as PrimaryChannel).createdDateTime = n.getDateValue(); }],
            ["description", (o, n) => { (o as unknown as PrimaryChannel).description = n.getStringValue(); }],
            ["displayName", (o, n) => { (o as unknown as PrimaryChannel).displayName = n.getStringValue(); }],
            ["email", (o, n) => { (o as unknown as PrimaryChannel).email = n.getStringValue(); }],
