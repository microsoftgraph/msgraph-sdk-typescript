...
export class TimeOffReasonsResponse implements Parsable {
    ...
    /**
     * Instantiates a new timeOffReasonsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TimeOffReasonsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TimeOffReasonsResponse).value = n.getCollectionOfObjectValues<TimeOffReason>(TimeOffReason); }],
        ]);
    };
    /**
