...
export class OfferShiftRequestsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as OfferShiftRequestsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as OfferShiftRequestsResponse).value = n.getCollectionOfObjectValues<OfferShiftRequest>(OfferShiftRequest); }],
        ]);
    };
    /**
