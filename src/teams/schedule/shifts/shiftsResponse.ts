...
export class ShiftsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ShiftsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ShiftsResponse).value = n.getCollectionOfObjectValues<Shift>(Shift); }],
        ]);
    };
    /**
