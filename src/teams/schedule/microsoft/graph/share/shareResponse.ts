...
export class Microsoft.graph.shareResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["endDateTime", (o, n) => { (o as unknown as Microsoft.graph.shareResponse).endDateTime = n.getDateValue(); }],
            ["notifyTeam", (o, n) => { (o as unknown as Microsoft.graph.shareResponse).notifyTeam = n.getBooleanValue(); }],
            ["startDateTime", (o, n) => { (o as unknown as Microsoft.graph.shareResponse).startDateTime = n.getDateValue(); }],
        ]);
    };
    /**
