...
export class PrimaryChannelRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.primaryChannel.members.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.primaryChannel.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.primaryChannel.tabs.item collection
     * @param id Unique identifier of the item
