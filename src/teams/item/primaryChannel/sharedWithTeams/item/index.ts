 ...
 */
export const SharedWithChannelTeamInfoItemRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
