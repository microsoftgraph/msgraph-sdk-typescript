...
export class TeamsTabItemRequestBuilder extends BaseRequestBuilder<TeamsTabItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teams/{team%2Did}/primaryChannel/tabs/{teamsTab%2Did}{?%24select,%24expand}", (x, y) => new TeamsTabItemRequestBuilder(x, y));
    }
    /**
