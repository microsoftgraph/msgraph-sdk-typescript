...
/** Builds and executes requests for operations under /teams/{team-id}/primaryChannel/filesFolder/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teams/{team_id}/primaryChannel/filesFolder/content";
