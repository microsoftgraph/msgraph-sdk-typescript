import {TimeOffRequestImpl} from '../../../../../models/';
...
export class TimeOffRequestItemRequestBuilder {
     ...
     */
    public get(requestConfiguration?: TimeOffRequestItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TimeOffRequestImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TimeOffRequestImpl>(requestInfo, createTimeOffRequestFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Update the navigation property timeOffRequests in teams
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: TimeOffRequest | undefined, requestConfiguration?: TimeOffRequestItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
