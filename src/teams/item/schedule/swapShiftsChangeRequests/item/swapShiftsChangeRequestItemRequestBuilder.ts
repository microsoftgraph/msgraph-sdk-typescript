import {SwapShiftsChangeRequestImpl} from '../../../../../models/';
...
export class SwapShiftsChangeRequestItemRequestBuilder {
    ...
    public createPatchRequestInformation(body: SwapShiftsChangeRequest | undefined, requestConfiguration?: SwapShiftsChangeRequestItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new SwapShiftsChangeRequestImpl(body)
     ...
     */
    public get(requestConfiguration?: SwapShiftsChangeRequestItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SwapShiftsChangeRequestImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SwapShiftsChangeRequestImpl>(requestInfo, createSwapShiftsChangeRequestFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Update the navigation property swapShiftsChangeRequests in teams
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: SwapShiftsChangeRequest | undefined, requestConfiguration?: SwapShiftsChangeRequestItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
