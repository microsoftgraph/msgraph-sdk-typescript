...
import {OfferShiftRequestRequestBuilder} from './offerShiftRequests/item/item/offerShiftRequestRequestBuilder';
import {OfferShiftRequestsRequestBuilder} from './offerShiftRequests/offerShiftRequestsRequestBuilder';
import {OpenShiftChangeRequestRequestBuilder} from './openShiftChangeRequests/item/item/openShiftChangeRequestRequestBuilder';
import {OpenShiftChangeRequestsRequestBuilder} from './openShiftChangeRequests/openShiftChangeRequestsRequestBuilder';
import {OpenShiftRequestBuilder} from './openShifts/item/item/openShiftRequestBuilder';
import {OpenShiftsRequestBuilder} from './openShifts/openShiftsRequestBuilder';
import {SchedulingGroupRequestBuilder} from './schedulingGroups/item/item/schedulingGroupRequestBuilder';
...
import {ShiftRequestBuilder} from './shifts/item/item/shiftRequestBuilder';
import {ShiftsRequestBuilder} from './shifts/shiftsRequestBuilder';
import {SwapShiftsChangeRequestRequestBuilder} from './swapShiftsChangeRequests/item/item/swapShiftsChangeRequestRequestBuilder';
import {SwapShiftsChangeRequestsRequestBuilder} from './swapShiftsChangeRequests/swapShiftsChangeRequestsRequestBuilder';
import {TimeOffReasonRequestBuilder} from './timeOffReasons/item/item/timeOffReasonRequestBuilder';
import {TimeOffReasonsRequestBuilder} from './timeOffReasons/timeOffReasonsRequestBuilder';
import {TimeOffRequestRequestBuilder} from './timeOffRequests/item/item/timeOffRequestRequestBuilder';
import {TimeOffRequestsRequestBuilder} from './timeOffRequests/timeOffRequestsRequestBuilder';
import {TimeOffRequestBuilder} from './timesOff/item/item/timeOffRequestBuilder';
...
export class ScheduleRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.schedule.offerShiftRequests.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.schedule.openShiftChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.schedule.openShifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.schedule.schedulingGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.schedule.shifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.schedule.swapShiftsChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.schedule.timeOffReasons.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.schedule.timeOffRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.schedule.timesOff.item collection
     * @param id Unique identifier of the item
