...
export class SchedulingGroupsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SchedulingGroupsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SchedulingGroupsResponse).value = n.getCollectionOfObjectValues<SchedulingGroup>(SchedulingGroup); }],
        ]);
    };
    /**
