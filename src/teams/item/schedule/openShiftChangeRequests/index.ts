...
export class OpenShiftChangeRequestsRequestBuilder extends BaseRequestBuilder<OpenShiftChangeRequestsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/openShiftChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new OpenShiftChangeRequestsRequestBuilder(x, y));
    }
    /**
