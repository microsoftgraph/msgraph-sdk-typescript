...
export class TimeOffReasonItemRequestBuilder extends BaseRequestBuilder<TimeOffReasonItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons/{timeOffReason%2Did}{?%24select}", (x, y) => new TimeOffReasonItemRequestBuilder(x, y));
    }
    /**
