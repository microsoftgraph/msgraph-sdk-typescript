...
/** Builds and executes requests for operations under /teams/{team-id}/installedApps/{teamsAppInstallation-id}/microsoft.graph.upgrade  */
export class UpgradeRequestBuilder {
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.upgrade";
