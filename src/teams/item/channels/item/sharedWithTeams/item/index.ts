...
export class SharedWithChannelTeamInfoItemRequestBuilder extends BaseRequestBuilder<SharedWithChannelTeamInfoItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}", (x, y) => new SharedWithChannelTeamInfoItemRequestBuilder(x, y));
    }
    /**
