...
import {ChatMessageRequestBuilder as iee683fc1434237cf3171fe9398713629bda50a1b9f3ff6eed3e89d9d94120c50} from './replies/item/chatMessageRequestBuilder';
...
export class ChatMessageRequestBuilder {
     ...
     */
    public repliesById(id: string) : iee683fc1434237cf3171fe9398713629bda50a1b9f3ff6eed3e89d9d94120c50 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("chatMessage_id1", id);
        return new iee683fc1434237cf3171fe9398713629bda50a1b9f3ff6eed3e89d9d94120c50(urlTplParams, this.requestAdapter);
    };
}
