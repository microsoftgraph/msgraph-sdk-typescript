...
export class ChannelRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.channels.item.members.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.channels.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.teams.item.channels.item.tabs.item collection
     * @param id Unique identifier of the item
