...
export class DomainDnsRecordsRequestBuilder {
     ...
     */
    public get(requestConfiguration?: DomainDnsRecordsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DomainDnsRecordCollectionResponseImpl | undefined> {
     ...
     */
    public post(body: DomainDnsRecord | undefined, requestConfiguration?: DomainDnsRecordsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DomainDnsRecordImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
