...
export class DomainDnsRecordsResponse implements Parsable {
    ...
    /**
     * Instantiates a new domainDnsRecordsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DomainDnsRecordsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DomainDnsRecordsResponse).value = n.getCollectionOfObjectValues<DomainDnsRecord>(DomainDnsRecord); }],
        ]);
    };
    /**
