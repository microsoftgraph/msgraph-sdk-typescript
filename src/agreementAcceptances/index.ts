...
import { createAgreementAcceptanceCollectionResponseFromDiscriminatorValue, createAgreementAcceptanceFromDiscriminatorValue, deserializeIntoAgreementAcceptance, serializeAgreementAcceptance, type AgreementAcceptance, type AgreementAcceptanceCollectionResponse } from '../models/';
 ...
 */
export class AgreementAcceptancesRequestBuilder extends BaseRequestBuilder<AgreementAcceptancesRequestBuilder> {
    /**
     * Provides operations to manage the collection of agreementAcceptance entities.
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/agreementAcceptances{?%24search,%24select}", (x, y) => new AgreementAcceptancesRequestBuilder(x, y));
    }
    /**
