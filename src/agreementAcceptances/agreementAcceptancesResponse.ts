...
export class AgreementAcceptancesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AgreementAcceptancesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AgreementAcceptancesResponse).value = n.getCollectionOfObjectValues<AgreementAcceptance>(AgreementAcceptance); }],
        ]);
    };
    /**
