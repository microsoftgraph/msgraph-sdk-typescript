...
import { createSharedDriveItemCollectionResponseFromDiscriminatorValue, createSharedDriveItemFromDiscriminatorValue, deserializeIntoSharedDriveItem, serializeSharedDriveItem, type SharedDriveItem, type SharedDriveItemCollectionResponse } from '../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { SharedDriveItemItemRequestBuilder } from './item/';
...
export class SharesRequestBuilder extends BaseRequestBuilder<SharesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/shares{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SharesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<SharesRequestBuilderGetQueryParameters> | undefined) : Promise<SharedDriveItemCollectionResponse | undefined> {
     ...
     */
    public post(body: SharedDriveItem, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SharedDriveItem | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: SharedDriveItem, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
