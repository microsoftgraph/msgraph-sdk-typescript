...
export class ListRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.shares.list.columns collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.shares.list.contentTypes collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.shares.list.items collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.shares.list.subscriptions collection
     * @param id Unique identifier of the item
