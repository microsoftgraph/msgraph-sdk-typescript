...
import { createSharedDriveItemFromDiscriminatorValue, deserializeIntoSharedDriveItem, serializeSharedDriveItem, type SharedDriveItem } from '../../models/';
 ...
 */
export class SharedDriveItemItemRequestBuilder extends BaseRequestBuilder<SharedDriveItemItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}{?%24select,%24expand}", (x, y) => new SharedDriveItemItemRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<SharedDriveItemItemRequestBuilderGetQueryParameters> | undefined) : Promise<SharedDriveItem | undefined> {
     ...
     * @returns a Promise of SharedDriveItem
     */
    public patch(body: SharedDriveItem, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SharedDriveItem | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<SharedDriveItemItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, sharedDriveItemItemRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    }
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: SharedDriveItem, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
