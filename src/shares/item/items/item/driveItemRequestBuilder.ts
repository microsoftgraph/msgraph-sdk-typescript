...
/** Builds and executes requests for operations under /shares/{sharedDriveItem-id}/items/{driveItem-id}  */
export class DriveItemRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/items/{driveItem_id}{?select,expand}";
