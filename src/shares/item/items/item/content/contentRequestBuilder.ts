...
/** Builds and executes requests for operations under /shares/{sharedDriveItem-id}/items/{driveItem-id}/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/items/{driveItem_id}/content";
