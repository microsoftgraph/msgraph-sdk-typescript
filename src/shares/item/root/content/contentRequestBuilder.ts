...
/** Builds and executes requests for operations under /shares/{sharedDriveItem-id}/root/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/root/content";
