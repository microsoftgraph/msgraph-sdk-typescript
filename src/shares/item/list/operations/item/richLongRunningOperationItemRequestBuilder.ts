...
export class RichLongRunningOperationItemRequestBuilder {
     ...
     * @param richLongRunningOperationId key: id of richLongRunningOperation
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, richLongRunningOperationId?: string | undefined) {
