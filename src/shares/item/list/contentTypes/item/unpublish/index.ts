...
export class UnpublishRequestBuilder extends BaseRequestBuilder<UnpublishRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/unpublish", (x, y) => new UnpublishRequestBuilder(x, y));
    }
    /**
