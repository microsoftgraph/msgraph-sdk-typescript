...
export class IsPublishedRequestBuilder extends BaseRequestBuilder<IsPublishedRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/isPublished()", (x, y) => new IsPublishedRequestBuilder(x, y));
    }
    /**
