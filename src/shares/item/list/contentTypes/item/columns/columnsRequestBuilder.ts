...
export class ColumnsRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: ColumnDefinition | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: ColumnDefinition | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ColumnDefinition | undefined> {
        if(!body) throw new Error("body cannot be undefined");
