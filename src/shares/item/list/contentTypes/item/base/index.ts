...
export class BaseRequestBuilderEscaped extends BaseRequestBuilder<BaseRequestBuilderEscaped> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/base{?%24select,%24expand}", (x, y) => new BaseRequestBuilderEscaped(x, y));
    }
    /**
