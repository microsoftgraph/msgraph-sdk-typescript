...
import {MicrosoftGraphAddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration} from './microsoftGraphAddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the addCopyFromContentTypeHub method.
 */
export class MicrosoftGraphAddCopyFromContentTypeHubRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/microsoft.graph.addCopyFromContentTypeHub";
     ...
     */
    public post(body: AddCopyFromContentTypeHubPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphAddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ContentType | undefined> {
     ...
     */
    public toPostRequestInformation(body: AddCopyFromContentTypeHubPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphAddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
