...
export class ContentTypesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ContentTypesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ContentTypesResponse).value = n.getCollectionOfObjectValues<ContentType>(ContentType); }],
        ]);
    };
    /**
