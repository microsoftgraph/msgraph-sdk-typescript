...
export class ListRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.shares.item.list.columns.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.shares.item.list.contentTypes.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.shares.item.list.items.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.shares.item.list.subscriptions.item collection
     * @param id Unique identifier of the item
