 ...
 */
export const LastModifiedByUserRequestBuilderUriTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/lastModifiedByUser{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
