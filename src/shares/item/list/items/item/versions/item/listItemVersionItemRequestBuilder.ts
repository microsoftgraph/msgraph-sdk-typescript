...
/** Builds and executes requests for operations under /shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions/{listItemVersion-id}  */
export class ListItemVersionItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/items/{listItem_id}/versions/{listItemVersion_id}{?select,expand}";
