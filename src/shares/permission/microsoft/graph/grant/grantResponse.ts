import {DriveRecipient} from '../../../../../workbooks/microsoft/graph/invite/driveRecipient';
import {SerializationWriter, ParseNode, Parsable} from '@microsoft/kiota-abstractions';

export class Microsoft.graph.grantResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["recipients", (o, n) => { (o as unknown as Microsoft.graph.grantResponse).recipients = n.getCollectionOfObjectValues<DriveRecipient>(DriveRecipient); }],
            ["roles", (o, n) => { (o as unknown as Microsoft.graph.grantResponse).roles = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
