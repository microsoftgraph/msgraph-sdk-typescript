...
export class SharesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SharedDriveItem | undefined, requestConfiguration?: SharesRequestBuilderPostRequestConfiguration | undefined) : Promise<SharedDriveItem | undefined> {
