...
export class LearningCourseActivityItemRequestBuilder extends BaseRequestBuilder<LearningCourseActivityItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/employeeExperience/learningCourseActivities/{learningCourseActivity%2Did}{?%24select,%24expand}", (x, y) => new LearningCourseActivityItemRequestBuilder(x, y));
    }
    /**
