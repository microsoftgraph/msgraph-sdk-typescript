...
import { createLearningProviderCollectionResponseFromDiscriminatorValue, createLearningProviderFromDiscriminatorValue, deserializeIntoLearningProvider, serializeLearningProvider, type LearningProvider, type LearningProviderCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { LearningProviderItemRequestBuilder } from './item/';
 ...
 */
export class LearningProvidersRequestBuilder extends BaseRequestBuilder<LearningProvidersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/employeeExperience/learningProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new LearningProvidersRequestBuilder(x, y));
    }
    /**
