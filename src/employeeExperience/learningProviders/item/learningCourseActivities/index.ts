...
import { createLearningCourseActivityCollectionResponseFromDiscriminatorValue, createLearningCourseActivityFromDiscriminatorValue, deserializeIntoLearningCourseActivity, serializeLearningCourseActivity, type LearningCourseActivity, type LearningCourseActivityCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { LearningCourseActivityItemRequestBuilder } from './item/';
 ...
 */
export class LearningCourseActivitiesRequestBuilder extends BaseRequestBuilder<LearningCourseActivitiesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningCourseActivities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new LearningCourseActivitiesRequestBuilder(x, y));
    }
    /**
