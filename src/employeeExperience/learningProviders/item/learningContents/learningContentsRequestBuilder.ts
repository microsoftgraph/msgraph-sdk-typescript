...
export class LearningContentsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: LearningContent | undefined, requestConfiguration?: LearningContentsRequestBuilderPostRequestConfiguration | undefined) : Promise<LearningContent | undefined> {
