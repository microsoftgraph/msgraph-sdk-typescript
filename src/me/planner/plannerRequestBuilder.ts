...
export class PlannerRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<PlannerRequestBuilderGetQueryParameters> | undefined) : Promise<PlannerUser | undefined> {
     ...
     * @returns a Promise of PlannerUser
     */
    public patch(body: PlannerUser, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<PlannerUser | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: PlannerUser, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
