...
export class PlannerPlanItemRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.planner.plans.item.buckets.item collection
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.planner.plans.item.tasks.item collection
     * @param id Unique identifier of the item
