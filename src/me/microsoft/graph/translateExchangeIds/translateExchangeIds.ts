...
export class Microsoft.graph.translateExchangeIds implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.translateExchangeIds and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["errorDetails", (o, n) => { (o as unknown as Microsoft.graph.translateExchangeIds).errorDetails = n.getObjectValue<GenericError>(GenericError); }],
            ["sourceId", (o, n) => { (o as unknown as Microsoft.graph.translateExchangeIds).sourceId = n.getStringValue(); }],
            ["targetId", (o, n) => { (o as unknown as Microsoft.graph.translateExchangeIds).targetId = n.getStringValue(); }],
        ]);
    };
    /**
