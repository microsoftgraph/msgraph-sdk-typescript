...
export class Microsoft.graph.translateExchangeIdsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["inputIds", (o, n) => { (o as unknown as Microsoft.graph.translateExchangeIdsResponse).inputIds = n.getCollectionOfPrimitiveValues<string>(); }],
            ["sourceIdType", (o, n) => { (o as unknown as Microsoft.graph.translateExchangeIdsResponse).sourceIdType = n.getObjectValue<ExchangeIdFormat>(ExchangeIdFormat); }],
            ["targetIdType", (o, n) => { (o as unknown as Microsoft.graph.translateExchangeIdsResponse).targetIdType = n.getObjectValue<ExchangeIdFormat>(ExchangeIdFormat); }],
        ]);
    };
    /**
