...
export class Microsoft.graph.changePasswordResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["currentPassword", (o, n) => { (o as unknown as Microsoft.graph.changePasswordResponse).currentPassword = n.getStringValue(); }],
            ["newPassword", (o, n) => { (o as unknown as Microsoft.graph.changePasswordResponse).newPassword = n.getStringValue(); }],
        ]);
    };
    /**
