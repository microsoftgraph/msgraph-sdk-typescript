...
export class OnlineMeetingsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as OnlineMeetingsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as OnlineMeetingsResponse).value = n.getCollectionOfObjectValues<OnlineMeeting>(OnlineMeeting); }],
        ]);
    };
    /**
