...
import { type GetVirtualAppointmentJoinWebUrlRequestBuilderGetRequestConfiguration } from './getVirtualAppointmentJoinWebUrlRequestBuilderGetRequestConfiguration';
