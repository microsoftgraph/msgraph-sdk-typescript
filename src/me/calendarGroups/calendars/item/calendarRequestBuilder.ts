...
export class CalendarRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.calendarPermissions collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.calendarView collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.events collection
     * @param id Unique identifier of the item
     * @returns a eventRequestBuilder
     */
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
