...
export class Microsoft.graph.acceptResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as Microsoft.graph.acceptResponse).comment = n.getStringValue(); }],
            ["sendResponse", (o, n) => { (o as unknown as Microsoft.graph.acceptResponse).sendResponse = n.getBooleanValue(); }],
        ]);
    };
    /**
