...
export class EventRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.events.attachments collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.events.extensions collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.events.instances collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.events.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendarGroups.calendars.events.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
