...
export class SnoozeReminderRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/snoozeReminder");
    };
    /**
     ...
     */
    public post(body: SnoozeReminderPostRequestBody | undefined, requestConfiguration?: SnoozeReminderRequestBuilderPostRequestConfiguration | undefined) : Promise<void> {
