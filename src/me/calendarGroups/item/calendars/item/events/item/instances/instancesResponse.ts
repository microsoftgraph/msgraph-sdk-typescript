...
export class InstancesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as InstancesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as InstancesResponse).value = n.getCollectionOfObjectValues<Event>(Event); }],
        ]);
    };
    /**
