...
export class DeclineResponse implements Parsable {
    ...
    /**
     * Instantiates a new declineResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as DeclineResponse).comment = n.getStringValue(); }],
            ["proposedNewTime", (o, n) => { (o as unknown as DeclineResponse).proposedNewTime = n.getObjectValue<TimeSlot>(TimeSlot); }],
            ["sendResponse", (o, n) => { (o as unknown as DeclineResponse).sendResponse = n.getBooleanValue(); }],
        ]);
    };
    /**
