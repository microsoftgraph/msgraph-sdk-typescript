...
import {EventItemRequestBuilder as i3b16db7e4cc00e19ab5f9979690525b65cba5d7c5c01d4e3dda75f6911bb92e5} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
    ...
    public createPatchRequestInformation(body: Event | undefined, requestConfiguration?: EventItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new EventImpl(body)
     ...
     */
    public instancesById(id: string) : i3b16db7e4cc00e19ab5f9979690525b65cba5d7c5c01d4e3dda75f6911bb92e5 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i3b16db7e4cc00e19ab5f9979690525b65cba5d7c5c01d4e3dda75f6911bb92e5(urlTplParams, this.requestAdapter);
    };
    /**
