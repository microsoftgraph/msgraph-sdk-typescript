...
export class CalendarGroupRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendarGroups.calendars collection
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: CalendarGroup | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
