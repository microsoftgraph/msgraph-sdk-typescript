...
export class AddResponseImpl implements AddResponse {
    ...
    public constructor(addResponseParameterValue?: AddResponse | undefined) {
        ...
        const valueArrValue: ActionResultPartImpl[] = []; this.value?.forEach(element => {valueArrValue.push(element instanceof ActionResultPartImpl? element : new ActionResultPartImpl(element));});
