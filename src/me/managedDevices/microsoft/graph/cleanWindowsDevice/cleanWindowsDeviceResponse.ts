...
export class Microsoft.graph.cleanWindowsDeviceResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _keepUserData?: boolean | undefined;
    /**
     * Instantiates a new Microsoft.graph.cleanWindowsDeviceResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["keepUserData", (o, n) => { (o as unknown as Microsoft.graph.cleanWindowsDeviceResponse).keepUserData = n.getBooleanValue(); }],
        ]);
    };
    /**
