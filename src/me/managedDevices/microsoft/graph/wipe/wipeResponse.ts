...
export class Microsoft.graph.wipeResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["keepEnrollmentData", (o, n) => { (o as unknown as Microsoft.graph.wipeResponse).keepEnrollmentData = n.getBooleanValue(); }],
            ["keepUserData", (o, n) => { (o as unknown as Microsoft.graph.wipeResponse).keepUserData = n.getBooleanValue(); }],
            ["macOsUnlockCode", (o, n) => { (o as unknown as Microsoft.graph.wipeResponse).macOsUnlockCode = n.getStringValue(); }],
            ["persistEsimDataPlan", (o, n) => { (o as unknown as Microsoft.graph.wipeResponse).persistEsimDataPlan = n.getBooleanValue(); }],
        ]);
    };
    /**
