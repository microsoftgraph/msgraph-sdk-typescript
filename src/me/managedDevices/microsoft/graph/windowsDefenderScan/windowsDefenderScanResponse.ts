...
export class Microsoft.graph.windowsDefenderScanResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["quickScan", (o, n) => { (o as unknown as Microsoft.graph.windowsDefenderScanResponse).quickScan = n.getBooleanValue(); }],
        ]);
    };
    /**
