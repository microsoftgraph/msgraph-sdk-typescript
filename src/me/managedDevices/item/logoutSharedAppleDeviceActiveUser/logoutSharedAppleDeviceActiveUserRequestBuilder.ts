...
export class LogoutSharedAppleDeviceActiveUserRequestBuilder {
     ...
     */
    public createPostRequestInformation(requestConfiguration?: LogoutSharedAppleDeviceActiveUserRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
