...
/** Builds and executes requests for operations under /me/managedDevices/{managedDevice-id}/microsoft.graph.syncDevice  */
export class SyncDeviceRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/managedDevices/{managedDevice_id}/microsoft.graph.syncDevice";
