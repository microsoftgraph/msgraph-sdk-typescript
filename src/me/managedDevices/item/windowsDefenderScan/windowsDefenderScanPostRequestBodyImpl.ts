...
export class WindowsDefenderScanPostRequestBodyImpl implements WindowsDefenderScanPostRequestBody {
    ...
    public constructor(windowsDefenderScanPostRequestBodyParameterValue?: WindowsDefenderScanPostRequestBody | undefined) {
        this._additionalData = windowsDefenderScanPostRequestBodyParameterValue?.additionalData ? windowsDefenderScanPostRequestBodyParameterValue?.additionalData! : {};
        this._quickScan = windowsDefenderScanPostRequestBodyParameterValue?.quickScan;
    };
    /**
