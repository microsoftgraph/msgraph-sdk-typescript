import {DeviceCompliancePolicyState, DeviceCompliancePolicyStateCollectionResponse} from '../../../../models/';
...
export class DeviceCompliancePolicyStatesRequestBuilder {
     ...
     */
    public createGetRequestInformation(queryParameters?: DeviceCompliancePolicyStatesRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: DeviceCompliancePolicyState | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public get(queryParameters?: DeviceCompliancePolicyStatesRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceCompliancePolicyStateCollectionResponse | undefined> {
     ...
     */
    public post(body: DeviceCompliancePolicyState | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceCompliancePolicyState | undefined> {
        if(!body) throw new Error("body cannot be undefined");
