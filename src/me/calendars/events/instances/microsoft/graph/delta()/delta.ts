...
export class Microsoft.graph.delta extends OutlookItem implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["allowNewTimeProposals", (o, n) => { (o as unknown as Microsoft.graph.delta).allowNewTimeProposals = n.getBooleanValue(); }],
            ["attachments", (o, n) => { (o as unknown as Microsoft.graph.delta).attachments = n.getCollectionOfObjectValues<Attachment>(Attachment); }],
            ["attendees", (o, n) => { (o as unknown as Microsoft.graph.delta).attendees = n.getCollectionOfPrimitiveValues<attendee>(); }],
            ["body", (o, n) => { (o as unknown as Microsoft.graph.delta).body = n.getObjectValue<ItemBody>(ItemBody); }],
            ["bodyPreview", (o, n) => { (o as unknown as Microsoft.graph.delta).bodyPreview = n.getStringValue(); }],
            ["calendar", (o, n) => { (o as unknown as Microsoft.graph.delta).calendar = n.getObjectValue<Calendar>(Calendar); }],
            ["end", (o, n) => { (o as unknown as Microsoft.graph.delta).end = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
            ["extensions", (o, n) => { (o as unknown as Microsoft.graph.delta).extensions = n.getCollectionOfObjectValues<Extension>(Extension); }],
            ["hasAttachments", (o, n) => { (o as unknown as Microsoft.graph.delta).hasAttachments = n.getBooleanValue(); }],
            ["hideAttendees", (o, n) => { (o as unknown as Microsoft.graph.delta).hideAttendees = n.getBooleanValue(); }],
            ["iCalUId", (o, n) => { (o as unknown as Microsoft.graph.delta).iCalUId = n.getStringValue(); }],
            ["importance", (o, n) => { (o as unknown as Microsoft.graph.delta).importance = n.getObjectValue<Importance>(Importance); }],
            ["instances", (o, n) => { (o as unknown as Microsoft.graph.delta).instances = n.getCollectionOfObjectValues<Event>(Event); }],
            ["isAllDay", (o, n) => { (o as unknown as Microsoft.graph.delta).isAllDay = n.getBooleanValue(); }],
            ["isCancelled", (o, n) => { (o as unknown as Microsoft.graph.delta).isCancelled = n.getBooleanValue(); }],
            ["isDraft", (o, n) => { (o as unknown as Microsoft.graph.delta).isDraft = n.getBooleanValue(); }],
            ["isOnlineMeeting", (o, n) => { (o as unknown as Microsoft.graph.delta).isOnlineMeeting = n.getBooleanValue(); }],
            ["isOrganizer", (o, n) => { (o as unknown as Microsoft.graph.delta).isOrganizer = n.getBooleanValue(); }],
            ["isReminderOn", (o, n) => { (o as unknown as Microsoft.graph.delta).isReminderOn = n.getBooleanValue(); }],
            ["location", (o, n) => { (o as unknown as Microsoft.graph.delta).location = n.getObjectValue<Location>(Location); }],
            ["locations", (o, n) => { (o as unknown as Microsoft.graph.delta).locations = n.getCollectionOfPrimitiveValues<location>(); }],
            ...
            ["onlineMeeting", (o, n) => { (o as unknown as Microsoft.graph.delta).onlineMeeting = n.getObjectValue<OnlineMeetingInfo>(OnlineMeetingInfo); }],
            ["onlineMeetingProvider", (o, n) => { (o as unknown as Microsoft.graph.delta).onlineMeetingProvider = n.getObjectValue<OnlineMeetingProviderType>(OnlineMeetingProviderType); }],
            ["onlineMeetingUrl", (o, n) => { (o as unknown as Microsoft.graph.delta).onlineMeetingUrl = n.getStringValue(); }],
            ["organizer", (o, n) => { (o as unknown as Microsoft.graph.delta).organizer = n.getObjectValue<Recipient>(Recipient); }],
            ["originalEndTimeZone", (o, n) => { (o as unknown as Microsoft.graph.delta).originalEndTimeZone = n.getStringValue(); }],
            ["originalStart", (o, n) => { (o as unknown as Microsoft.graph.delta).originalStart = n.getDateValue(); }],
            ["originalStartTimeZone", (o, n) => { (o as unknown as Microsoft.graph.delta).originalStartTimeZone = n.getStringValue(); }],
            ["recurrence", (o, n) => { (o as unknown as Microsoft.graph.delta).recurrence = n.getObjectValue<PatternedRecurrence>(PatternedRecurrence); }],
            ["reminderMinutesBeforeStart", (o, n) => { (o as unknown as Microsoft.graph.delta).reminderMinutesBeforeStart = n.getNumberValue(); }],
            ["responseRequested", (o, n) => { (o as unknown as Microsoft.graph.delta).responseRequested = n.getBooleanValue(); }],
            ["responseStatus", (o, n) => { (o as unknown as Microsoft.graph.delta).responseStatus = n.getObjectValue<ResponseStatus>(ResponseStatus); }],
            ["sensitivity", (o, n) => { (o as unknown as Microsoft.graph.delta).sensitivity = n.getObjectValue<Sensitivity>(Sensitivity); }],
            ["seriesMasterId", (o, n) => { (o as unknown as Microsoft.graph.delta).seriesMasterId = n.getStringValue(); }],
            ["showAs", (o, n) => { (o as unknown as Microsoft.graph.delta).showAs = n.getObjectValue<FreeBusyStatus>(FreeBusyStatus); }],
            ...
            ["start", (o, n) => { (o as unknown as Microsoft.graph.delta).start = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
            ["subject", (o, n) => { (o as unknown as Microsoft.graph.delta).subject = n.getStringValue(); }],
            ["transactionId", (o, n) => { (o as unknown as Microsoft.graph.delta).transactionId = n.getStringValue(); }],
            ["type", (o, n) => { (o as unknown as Microsoft.graph.delta).type = n.getObjectValue<EventType>(EventType); }],
            ["webLink", (o, n) => { (o as unknown as Microsoft.graph.delta).webLink = n.getStringValue(); }],
        ]);
    };
    /**
