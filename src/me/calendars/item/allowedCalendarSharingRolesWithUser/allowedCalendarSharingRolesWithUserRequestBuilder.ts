...
export class AllowedCalendarSharingRolesWithUserRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, user?: string | undefined) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendars/{calendar_id}/microsoft.graph.allowedCalendarSharingRoles(User='{User}')";
     ...
     */
    public get(headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AllowedCalendarSharingRolesWithUserResponse | undefined> {
