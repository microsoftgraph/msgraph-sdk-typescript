...
import {EventRequestBuilder as ia75c674966dea3b294b8932094cd85ff0d63fceecb23f108bfb91042fcfac0f6} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : ia75c674966dea3b294b8932094cd85ff0d63fceecb23f108bfb91042fcfac0f6 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("event_id1", id);
        return new ia75c674966dea3b294b8932094cd85ff0d63fceecb23f108bfb91042fcfac0f6(urlTplParams, this.requestAdapter);
    };
    /**
