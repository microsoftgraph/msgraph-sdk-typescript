...
/** Builds and executes requests for operations under /me/calendars/{calendar-id}/events/{event-id}/microsoft.graph.dismissReminder  */
export class DismissReminderRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}/microsoft.graph.dismissReminder";
