...
import {EventRequestBuilder as ib737080162282b9289aad7f0870bb342e1fbd998da86751978bbb5a3c709259b} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : ib737080162282b9289aad7f0870bb342e1fbd998da86751978bbb5a3c709259b {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new ib737080162282b9289aad7f0870bb342e1fbd998da86751978bbb5a3c709259b(urlTplParams, this.requestAdapter);
    };
    /**
