...
export class RevokeSignInSessionsRequestBuilder {
    ...
    public post(requestConfiguration?: RevokeSignInSessionsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RevokeSignInSessionsResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<RevokeSignInSessionsResponseImpl>(requestInfo, createRevokeSignInSessionsResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
