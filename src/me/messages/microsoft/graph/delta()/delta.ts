...
export class Microsoft.graph.delta extends OutlookItem implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["bccRecipients", (o, n) => { (o as unknown as Microsoft.graph.delta).bccRecipients = n.getCollectionOfObjectValues<Recipient>(Recipient); }],
            ...
            ["ccRecipients", (o, n) => { (o as unknown as Microsoft.graph.delta).ccRecipients = n.getCollectionOfObjectValues<Recipient>(Recipient); }],
            ["conversationId", (o, n) => { (o as unknown as Microsoft.graph.delta).conversationId = n.getStringValue(); }],
            ["conversationIndex", (o, n) => { (o as unknown as Microsoft.graph.delta).conversationIndex = n.getObjectValue<Binary>(Binary); }],
            ["extensions", (o, n) => { (o as unknown as Microsoft.graph.delta).extensions = n.getCollectionOfObjectValues<Extension>(Extension); }],
            ["flag", (o, n) => { (o as unknown as Microsoft.graph.delta).flag = n.getObjectValue<FollowupFlag>(FollowupFlag); }],
            ["from", (o, n) => { (o as unknown as Microsoft.graph.delta).from = n.getObjectValue<Recipient>(Recipient); }],
            ...
            ["inferenceClassification", (o, n) => { (o as unknown as Microsoft.graph.delta).inferenceClassification = n.getObjectValue<InferenceClassificationType>(InferenceClassificationType); }],
            ["internetMessageHeaders", (o, n) => { (o as unknown as Microsoft.graph.delta).internetMessageHeaders = n.getCollectionOfPrimitiveValues<internetMessageHeader>(); }],
            ["internetMessageId", (o, n) => { (o as unknown as Microsoft.graph.delta).internetMessageId = n.getStringValue(); }],
            ["isDeliveryReceiptRequested", (o, n) => { (o as unknown as Microsoft.graph.delta).isDeliveryReceiptRequested = n.getBooleanValue(); }],
            ["isDraft", (o, n) => { (o as unknown as Microsoft.graph.delta).isDraft = n.getBooleanValue(); }],
            ["isRead", (o, n) => { (o as unknown as Microsoft.graph.delta).isRead = n.getBooleanValue(); }],
            ["isReadReceiptRequested", (o, n) => { (o as unknown as Microsoft.graph.delta).isReadReceiptRequested = n.getBooleanValue(); }],
            ...
            ["receivedDateTime", (o, n) => { (o as unknown as Microsoft.graph.delta).receivedDateTime = n.getDateValue(); }],
            ["replyTo", (o, n) => { (o as unknown as Microsoft.graph.delta).replyTo = n.getCollectionOfObjectValues<Recipient>(Recipient); }],
            ["sender", (o, n) => { (o as unknown as Microsoft.graph.delta).sender = n.getObjectValue<Recipient>(Recipient); }],
            ["sentDateTime", (o, n) => { (o as unknown as Microsoft.graph.delta).sentDateTime = n.getDateValue(); }],
            ...
            ["toRecipients", (o, n) => { (o as unknown as Microsoft.graph.delta).toRecipients = n.getCollectionOfObjectValues<Recipient>(Recipient); }],
            ["uniqueBody", (o, n) => { (o as unknown as Microsoft.graph.delta).uniqueBody = n.getObjectValue<ItemBody>(ItemBody); }],
