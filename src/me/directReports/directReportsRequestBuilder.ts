...
import { type DirectReportsRequestBuilderGetRequestConfiguration } from './directReportsRequestBuilderGetRequestConfiguration';
...
export class DirectReportsRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/me/directReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
     ...
     * @returns a directReportsRequestBuilder
     */
    public withUrl(rawUrl: string) : DirectReportsRequestBuilder {
