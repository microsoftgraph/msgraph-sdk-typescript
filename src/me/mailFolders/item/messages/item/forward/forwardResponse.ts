...
export class ForwardResponse implements Parsable {
    ...
    /**
     * Instantiates a new forwardResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as ForwardResponse).comment = n.getStringValue(); }],
            ["message", (o, n) => { (o as unknown as ForwardResponse).message = n.getObjectValue<Message>(Message); }],
            ["toRecipients", (o, n) => { (o as unknown as ForwardResponse).toRecipients = n.getCollectionOfObjectValues<Recipient>(Recipient); }],
        ]);
    };
    /**
