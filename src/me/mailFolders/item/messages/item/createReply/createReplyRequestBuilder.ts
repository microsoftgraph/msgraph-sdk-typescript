...
export class CreateReplyRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/createReply");
    };
    /**
     ...
     */
    public post(body: CreateReplyPostRequestBody | undefined, requestConfiguration?: CreateReplyRequestBuilderPostRequestConfiguration | undefined) : Promise<Message | undefined> {
