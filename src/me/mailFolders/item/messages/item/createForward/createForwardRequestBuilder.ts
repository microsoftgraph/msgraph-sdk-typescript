...
import { type CreateForwardRequestBuilderPostRequestConfiguration } from './createForwardRequestBuilderPostRequestConfiguration';
...
export class CreateForwardRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a createForwardRequestBuilder
     */
    public withUrl(rawUrl: string) : CreateForwardRequestBuilder {
