...
export class CreateReplyAllPostRequestBody implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** The Comment property */
    private _comment?: string | undefined;
    /** The Message property */
    private _message?: Message | CreateReplyAllMember1 | undefined;
    /**
     ...
     */
    public set message(value: Message | CreateReplyAllMember1 | undefined) {
        this._message = value;
    };
    /**
