...
export class MessageRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.mailFolders.item.messages.item.attachments.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.mailFolders.item.messages.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.mailFolders.item.messages.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.mailFolders.item.messages.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
