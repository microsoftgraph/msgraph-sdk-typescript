...
export class CreateForwardResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as CreateForwardResponse).comment = n.getStringValue(); }],
            ["message", (o, n) => { (o as unknown as CreateForwardResponse).message = n.getObjectValue<Message>(Message); }],
            ["toRecipients", (o, n) => { (o as unknown as CreateForwardResponse).toRecipients = n.getCollectionOfObjectValues<Recipient>(Recipient); }],
        ]);
    };
    /**
