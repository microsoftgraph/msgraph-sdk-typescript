...
import {MailFolderRequestBuilder as iba49dbbb39672da86191af906861f40a69b5814171ad2f11fb73c96e0147ffd7} from './childFolders/item/mailFolderRequestBuilder';
...
export class MailFolderRequestBuilder {
     ...
     */
    public childFoldersById(id: string) : iba49dbbb39672da86191af906861f40a69b5814171ad2f11fb73c96e0147ffd7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("mailFolder_id1", id);
        return new iba49dbbb39672da86191af906861f40a69b5814171ad2f11fb73c96e0147ffd7(urlTplParams, this.requestAdapter);
    };
    /**
