...
import {MailFolderRequestBuilder as idc965d243f34e1f490a31393e22ad6e5c3cc55c5aad346ef9f4a330d835e4172} from './childFolders/item/mailFolderRequestBuilder';
...
export class MailFolderRequestBuilder {
     ...
     */
    public childFoldersById(id: string) : idc965d243f34e1f490a31393e22ad6e5c3cc55c5aad346ef9f4a330d835e4172 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["mailFolder_id1"] = id
        return new idc965d243f34e1f490a31393e22ad6e5c3cc55c5aad346ef9f4a330d835e4172(urlTplParams, this.requestAdapter);
    };
    /**
