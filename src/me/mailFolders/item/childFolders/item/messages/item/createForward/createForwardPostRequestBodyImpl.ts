...
export class CreateForwardPostRequestBodyImpl implements CreateForwardPostRequestBody {
    ...
    public constructor(createForwardPostRequestBodyParameterValue?: CreateForwardPostRequestBody | undefined) {
        this._additionalData = createForwardPostRequestBodyParameterValue?.additionalData ? createForwardPostRequestBodyParameterValue?.additionalData! : {};
        this._comment = createForwardPostRequestBodyParameterValue?.comment;
        this._message = createForwardPostRequestBodyParameterValue?.message;
        this._toRecipients = createForwardPostRequestBodyParameterValue?.toRecipients;
    };
    /**
