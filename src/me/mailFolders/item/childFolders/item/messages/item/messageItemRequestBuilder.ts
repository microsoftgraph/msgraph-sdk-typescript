...
export class MessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.mailFolders.item.childFolders.item.messages.item.attachments.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.mailFolders.item.childFolders.item.messages.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    public get(requestConfiguration?: MessageItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<MessageImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<MessageImpl>(requestInfo, createMessageFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Gets an item from the MicrosoftGraph.me.mailFolders.item.childFolders.item.messages.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.mailFolders.item.childFolders.item.messages.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
