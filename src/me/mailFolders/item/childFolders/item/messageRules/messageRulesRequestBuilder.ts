import {createMessageRuleCollectionResponseFromDiscriminatorValue} from '../../../../../../models/microsoft/graph/createMessageRuleCollectionResponseFromDiscriminatorValue';
...
import {MessageRuleCollectionResponse} from '../../../../../../models/microsoft/graph/messageRuleCollectionResponse';
...
export class MessageRulesRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}/messageRules{?top,skip,filter,count,orderby,select}";
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<MessageRuleCollectionResponse | undefined> {
