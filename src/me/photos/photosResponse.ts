...
export class PhotosResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as PhotosResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as PhotosResponse).value = n.getCollectionOfObjectValues<ProfilePhoto>(ProfilePhoto); }],
        ]);
    };
    /**
