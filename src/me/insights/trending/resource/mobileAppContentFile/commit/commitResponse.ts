import {FileEncryptionInfo} from '../../../../shared/lastSharedMethod/mobileAppContentFile/fileEncryptionInfo';
...
export class CommitResponse implements Parsable {
    ...
    /**
     * Instantiates a new commitResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fileEncryptionInfo", (o, n) => { (o as unknown as CommitResponse).fileEncryptionInfo = n.getObjectValue<FileEncryptionInfo>(FileEncryptionInfo); }],
        ]);
    };
    /**
