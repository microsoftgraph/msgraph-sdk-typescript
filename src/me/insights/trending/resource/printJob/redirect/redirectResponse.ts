import {PrintJobConfiguration} from '../../../../shared/lastSharedMethod/printJob/printJobConfiguration';
...
export class RedirectResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["configuration", (o, n) => { (o as unknown as RedirectResponse).configuration = n.getObjectValue<PrintJobConfiguration>(PrintJobConfiguration); }],
            ["destinationPrinterId", (o, n) => { (o as unknown as RedirectResponse).destinationPrinterId = n.getStringValue(); }],
        ]);
    };
    /**
