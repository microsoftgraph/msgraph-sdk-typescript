...
export class Microsoft.graph.rowsBelowRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.rowsBelowRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.rowsBelowResponse
     */
