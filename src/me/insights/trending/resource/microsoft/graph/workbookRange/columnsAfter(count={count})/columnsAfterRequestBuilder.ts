...
export class Microsoft.graph.columnsAfterRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.columnsAfterRequestBuilder and sets the default values.
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/microsoft.graph.columnsAfter(count={count})";
     ...
     * @returns a Promise of Microsoft.graph.columnsAfterResponse
     */
