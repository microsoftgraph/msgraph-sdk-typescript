...
export class IntersectionRequestBuilder {
    ...
    /**
     * Instantiates a new IntersectionRequestBuilder and sets the default values.
     ...
     * @returns a Promise of intersectionResponse
     */
