...
export class Microsoft.graph.redirectResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["configuration", (o, n) => { (o as unknown as Microsoft.graph.redirectResponse).configuration = n.getObjectValue<PrintJobConfiguration>(PrintJobConfiguration); }],
            ["destinationPrinterId", (o, n) => { (o as unknown as Microsoft.graph.redirectResponse).destinationPrinterId = n.getStringValue(); }],
        ]);
    };
    /**
