...
export class SharedResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SharedResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SharedResponse).value = n.getCollectionOfObjectValues<SharedInsight>(SharedInsight); }],
        ]);
    };
    /**
