...
export class SharedInsightItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: SharedInsightItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
