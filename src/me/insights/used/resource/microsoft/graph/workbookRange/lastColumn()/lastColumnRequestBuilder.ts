...
export class Microsoft.graph.lastColumnRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.lastColumnRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.lastColumnResponse
     */
