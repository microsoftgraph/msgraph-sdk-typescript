...
export class Microsoft.graph.applyResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fields", (o, n) => { (o as unknown as Microsoft.graph.applyResponse).fields = n.getCollectionOfPrimitiveValues<workbookSortField>(); }],
            ["hasHeaders", (o, n) => { (o as unknown as Microsoft.graph.applyResponse).hasHeaders = n.getBooleanValue(); }],
            ["matchCase", (o, n) => { (o as unknown as Microsoft.graph.applyResponse).matchCase = n.getBooleanValue(); }],
            ["method", (o, n) => { (o as unknown as Microsoft.graph.applyResponse).method = n.getStringValue(); }],
            ["orientation", (o, n) => { (o as unknown as Microsoft.graph.applyResponse).orientation = n.getStringValue(); }],
        ]);
    };
    /**
