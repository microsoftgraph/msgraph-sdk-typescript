...
export class ResizedRangeRequestBuilder {
    ...
    /**
     * Instantiates a new ResizedRangeRequestBuilder and sets the default values.
     ...
     */
    public constructor(currentPath: string, httpCore: HttpCore, deltaRows?: number | undefined, deltaColumns?: number | undefined, isRawUrl: boolean = true) {
     ...
     * @returns a Promise of resizedRangeResponse
     */
