...
export class ChangePasswordRequestBuilder {
     ...
     */
    public post(body: ChangePasswordRequestBody | undefined, requestConfiguration?: ChangePasswordRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
