...
/** Builds and executes requests for operations under /me/calendar/events/{event-id}/calendar/microsoft.graph.allowedCalendarSharingRoles(User='{User}')  */
export class AllowedCalendarSharingRolesWithUserRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter, user?: string | undefined) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendar/events/{event_id}/calendar/microsoft.graph.allowedCalendarSharingRoles(User='{User}')";
