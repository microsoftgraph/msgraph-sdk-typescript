...
export class AcceptResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _comment?: string | undefined;
    private _sendResponse?: boolean | undefined;
    /**
     * Instantiates a new acceptResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["comment", (o, n) => { (o as unknown as AcceptResponse).comment = n.getStringValue(); }],
            ["sendResponse", (o, n) => { (o as unknown as AcceptResponse).sendResponse = n.getBooleanValue(); }],
        ]);
    };
    /**
