...
import {EventRequestBuilder as i2f5dbbbbf781d816a9ae27d1eb7809830dd488618a926e7e62207db41c7e70c4} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : i2f5dbbbbf781d816a9ae27d1eb7809830dd488618a926e7e62207db41c7e70c4 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("event_id1", id);
        return new i2f5dbbbbf781d816a9ae27d1eb7809830dd488618a926e7e62207db41c7e70c4(urlTplParams, this.requestAdapter);
    };
    /**
