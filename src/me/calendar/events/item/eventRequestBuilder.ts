...
import {EventRequestBuilder as i78a819598003e19515ac9ba5c411c0126826895afa1a1f9a8044d5503d1b55d6} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendar.events.item.attachments.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendar.events.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendar.events.item.instances.item collection
     * @param id Unique identifier of the item
     * @returns a eventRequestBuilder
     */
    public instancesById(id: String) : i78a819598003e19515ac9ba5c411c0126826895afa1a1f9a8044d5503d1b55d6 {
        if(!id) throw new Error("id cannot be undefined");
        return new i78a819598003e19515ac9ba5c411c0126826895afa1a1f9a8044d5503d1b55d6(this.currentPath + this.pathSegment + "/instances/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendar.events.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.calendar.events.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
