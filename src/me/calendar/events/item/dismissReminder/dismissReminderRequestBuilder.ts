...
/** Builds and executes requests for operations under /me/calendar/events/{event-id}/microsoft.graph.dismissReminder  */
export class DismissReminderRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendar/events/{event_id}/microsoft.graph.dismissReminder";
