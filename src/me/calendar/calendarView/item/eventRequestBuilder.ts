...
import {EventRequestBuilder as if728ed5f898d67bc0ca1c8563cce0e80c3273c7d940369ceccbb8afdff138ea7} from './instances/item/eventRequestBuilder';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : if728ed5f898d67bc0ca1c8563cce0e80c3273c7d940369ceccbb8afdff138ea7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("event_id1", id);
        return new if728ed5f898d67bc0ca1c8563cce0e80c3273c7d940369ceccbb8afdff138ea7(urlTplParams, this.requestAdapter);
    };
    /**
