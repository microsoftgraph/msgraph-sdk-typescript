...
/** Builds and executes requests for operations under /me/calendar/calendarView/{event-id}/microsoft.graph.dismissReminder  */
export class DismissReminderRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendar/calendarView/{event_id}/microsoft.graph.dismissReminder";
