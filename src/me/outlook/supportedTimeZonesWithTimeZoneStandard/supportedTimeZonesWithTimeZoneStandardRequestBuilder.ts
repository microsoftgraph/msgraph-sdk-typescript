...
export class SupportedTimeZonesWithTimeZoneStandardRequestBuilder {
     ...
     */
    public constructor(currentPath: string, httpCore: HttpCore, TimeZoneStandard?: string | undefined, isRawUrl: boolean = true) {
     ...
     */
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SupportedTimeZonesWithTimeZoneStandard[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.httpCore?.sendCollectionAsync<SupportedTimeZonesWithTimeZoneStandard>(requestInfo, SupportedTimeZonesWithTimeZoneStandard, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
