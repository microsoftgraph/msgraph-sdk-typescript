...
export class Microsoft.graph.supportedTimeZones implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alias", (o, n) => { (o as unknown as Microsoft.graph.supportedTimeZones).alias = n.getStringValue(); }],
            ["displayName", (o, n) => { (o as unknown as Microsoft.graph.supportedTimeZones).displayName = n.getStringValue(); }],
        ]);
    };
    /**
