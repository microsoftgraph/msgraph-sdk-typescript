...
export class Microsoft.graph.supportedLanguages implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["displayName", (o, n) => { (o as unknown as Microsoft.graph.supportedLanguages).displayName = n.getStringValue(); }],
            ["locale", (o, n) => { (o as unknown as Microsoft.graph.supportedLanguages).locale = n.getStringValue(); }],
        ]);
    };
    /**
