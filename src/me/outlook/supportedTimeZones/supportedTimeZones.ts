...
export class SupportedTimeZones implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alias", (o, n) => { (o as unknown as SupportedTimeZones).alias = n.getStringValue(); }],
            ["displayName", (o, n) => { (o as unknown as SupportedTimeZones).displayName = n.getStringValue(); }],
        ]);
    };
    /**
