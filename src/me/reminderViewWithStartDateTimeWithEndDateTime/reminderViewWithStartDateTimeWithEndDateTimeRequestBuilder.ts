...
export class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder {
     ...
     */
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ReminderViewWithStartDateTimeWithEndDateTime[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.httpCore?.sendCollectionAsync<ReminderViewWithStartDateTimeWithEndDateTime>(requestInfo, ReminderViewWithStartDateTimeWithEndDateTime, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
