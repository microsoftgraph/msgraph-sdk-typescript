...
import {MicrosoftGraphGetMemberObjectsRequestBuilderPostRequestConfiguration} from './microsoftGraphGetMemberObjectsRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the getMemberObjects method.
 */
export class MicrosoftGraphGetMemberObjectsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/microsoft.graph.getMemberObjects";
     ...
     */
    public post(body: GetMemberObjectsPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphGetMemberObjectsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetMemberObjectsResponse | undefined> {
     ...
     */
    public toPostRequestInformation(body: GetMemberObjectsPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphGetMemberObjectsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
