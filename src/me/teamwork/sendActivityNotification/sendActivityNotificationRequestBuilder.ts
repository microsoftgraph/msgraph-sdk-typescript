...
export class SendActivityNotificationRequestBuilder {
     ...
     */
    public post(body: SendActivityNotificationRequestBodyImpl | undefined, requestConfiguration?: SendActivityNotificationRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
