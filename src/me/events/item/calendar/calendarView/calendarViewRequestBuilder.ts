...
/** Builds and executes requests for operations under /me/events/{event-id}/calendar/calendarView  */
export class CalendarViewRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/events/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
