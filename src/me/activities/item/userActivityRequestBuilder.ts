...
export class UserActivityRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: UserActivity | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInfo {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.activities.historyItems collection
