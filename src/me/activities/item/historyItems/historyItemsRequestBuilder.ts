...
import { createActivityHistoryItemCollectionResponseFromDiscriminatorValue } from '../../../../models/activityHistoryItemCollectionResponse';
...
export interface HistoryItemsRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
...
export class HistoryItemsRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/me/activities/{userActivity%2Did}/historyItems{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
     ...
     */
    public post(body: ActivityHistoryItem, requestConfiguration?: HistoryItemsRequestBuilderPostRequestConfiguration | undefined) : Promise<ActivityHistoryItem | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: ActivityHistoryItem, requestConfiguration?: HistoryItemsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a historyItemsRequestBuilder
     */
    public withUrl(rawUrl: string) : HistoryItemsRequestBuilder {
