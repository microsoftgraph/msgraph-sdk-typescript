...
export class HistoryItemsRequestBuilder {
     ...
     */
    public createGetRequestInformation(queryParameters?: HistoryItemsRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: ActivityHistoryItem | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public get(queryParameters?: HistoryItemsRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ActivityHistoryItemCollectionResponse | undefined> {
     ...
     */
    public post(body: ActivityHistoryItem | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ActivityHistoryItem | undefined> {
        if(!body) throw new Error("body cannot be undefined");
