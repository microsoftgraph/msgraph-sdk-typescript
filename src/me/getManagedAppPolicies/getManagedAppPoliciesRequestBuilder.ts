...
export class GetManagedAppPoliciesRequestBuilder {
    ...
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetManagedAppPolicies[] | undefined> {
        ...
        return this.httpCore?.sendCollectionAsync<GetManagedAppPolicies>(requestInfo, GetManagedAppPolicies, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
