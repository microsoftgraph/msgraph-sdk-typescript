...
/** Builds and executes requests for operations under /me/calendarView/{event-id}/calendar/events/{event-id1}/microsoft.graph.dismissReminder  */
export class DismissReminderRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendarView/{event_id}/calendar/events/{event_id1}/microsoft.graph.dismissReminder";
