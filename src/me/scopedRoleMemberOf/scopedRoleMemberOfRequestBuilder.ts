...
export class ScopedRoleMemberOfRequestBuilder {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ScopedRoleMemberOfResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<ScopedRoleMemberOfResponse>(requestInfo, ScopedRoleMemberOfResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * The scoped-role administrative unit memberships for this user. Read-only. Nullable.
     * @param body 
