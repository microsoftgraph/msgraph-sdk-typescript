import {TemporaryAccessPassAuthenticationMethodImpl} from '../../../../models/';
...
import {TemporaryAccessPassAuthenticationMethodItemRequestBuilderPatchRequestConfiguration} from './temporaryAccessPassAuthenticationMethodItemRequestBuilderPatchRequestConfiguration';
...
export class TemporaryAccessPassAuthenticationMethodItemRequestBuilder {
    ...
    /**
     * Update the navigation property temporaryAccessPassMethods in me
     * @param body 
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: TemporaryAccessPassAuthenticationMethod | undefined, requestConfiguration?: TemporaryAccessPassAuthenticationMethodItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new TemporaryAccessPassAuthenticationMethodImpl(body)
     ...
     */
    public get(requestConfiguration?: TemporaryAccessPassAuthenticationMethodItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TemporaryAccessPassAuthenticationMethodImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TemporaryAccessPassAuthenticationMethodImpl>(requestInfo, createTemporaryAccessPassAuthenticationMethodFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Update the navigation property temporaryAccessPassMethods in me
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: TemporaryAccessPassAuthenticationMethod | undefined, requestConfiguration?: TemporaryAccessPassAuthenticationMethodItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
