...
import { createTemporaryAccessPassAuthenticationMethodFromDiscriminatorValue, deserializeIntoTemporaryAccessPassAuthenticationMethod, serializeTemporaryAccessPassAuthenticationMethod, type TemporaryAccessPassAuthenticationMethod } from '../../../models/temporaryAccessPassAuthenticationMethod';
import { createTemporaryAccessPassAuthenticationMethodCollectionResponseFromDiscriminatorValue } from '../../../models/temporaryAccessPassAuthenticationMethodCollectionResponse';
...
export interface TemporaryAccessPassMethodsRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
...
export class TemporaryAccessPassMethodsRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a temporaryAccessPassMethodsRequestBuilder
     */
    public withUrl(rawUrl: string) : TemporaryAccessPassMethodsRequestBuilder {
