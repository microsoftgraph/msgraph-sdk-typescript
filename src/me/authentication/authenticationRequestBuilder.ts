...
export class AuthenticationRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.authentication.fido2Methods collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.authentication.methods collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.authentication.microsoftAuthenticatorMethods collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.authentication.windowsHelloForBusinessMethods collection
     * @param id Unique identifier of the item
