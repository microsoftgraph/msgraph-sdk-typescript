...
import { type EnableSmsSignInRequestBuilderPostRequestConfiguration } from './enableSmsSignInRequestBuilderPostRequestConfiguration';
...
export class EnableSmsSignInRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a enableSmsSignInRequestBuilder
     */
