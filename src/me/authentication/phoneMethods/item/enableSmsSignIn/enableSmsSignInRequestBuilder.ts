...
export class EnableSmsSignInRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/phoneMethods/{phoneAuthenticationMethod%2Did}/microsoft.graph.enableSmsSignIn";
     ...
     */
    public createPostRequestInformation(requestConfiguration?: EnableSmsSignInRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
