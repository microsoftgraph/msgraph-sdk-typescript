...
export class Fido2MethodsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as Fido2MethodsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as Fido2MethodsResponse).value = n.getCollectionOfObjectValues<Fido2AuthenticationMethod>(Fido2AuthenticationMethod); }],
        ]);
    };
    /**
