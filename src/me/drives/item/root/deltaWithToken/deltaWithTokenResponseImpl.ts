...
export class DeltaWithTokenResponseImpl implements DeltaWithTokenResponse {
     ...
     * @param deltaWithTokenResponseParameterValue 
     */
    public constructor(deltaWithTokenResponseParameterValue?: DeltaWithTokenResponse | undefined) {
        this._additionalData = deltaWithTokenResponseParameterValue?.additionalData ? deltaWithTokenResponseParameterValue?.additionalData! : {};
        this._value = deltaWithTokenResponseParameterValue?.value;
    };
    /**
