...
import {DriveItemItemRequestBuilder as id1d5a2a7be1a9ad81ada0f40a8a442fb588dcd5365326a0c90ac3738114e8cf2} from './children/item/driveItemItemRequestBuilder';
...
export class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.drives.item.following.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a driveItemItemRequestBuilder
     */
    public childrenById(id: string) : id1d5a2a7be1a9ad81ada0f40a8a442fb588dcd5365326a0c90ac3738114e8cf2 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem_id1"] = id
        return new id1d5a2a7be1a9ad81ada0f40a8a442fb588dcd5365326a0c90ac3738114e8cf2(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.drives.item.following.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.drives.item.following.item.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.drives.item.following.item.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.drives.item.following.item.versions.item collection
     * @param id Unique identifier of the item
