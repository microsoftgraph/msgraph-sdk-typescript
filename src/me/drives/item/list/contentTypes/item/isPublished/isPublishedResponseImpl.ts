...
export class IsPublishedResponseImpl implements IsPublishedResponse {
    ...
    public constructor(isPublishedResponseParameterValue?: IsPublishedResponse | undefined) {
        this._additionalData = isPublishedResponseParameterValue?.additionalData ? isPublishedResponseParameterValue?.additionalData! : {};
        this._value = isPublishedResponseParameterValue?.value;
    };
    /**
