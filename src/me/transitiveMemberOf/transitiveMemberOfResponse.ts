...
export class TransitiveMemberOfResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TransitiveMemberOfResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TransitiveMemberOfResponse).value = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
        ]);
    };
    /**
