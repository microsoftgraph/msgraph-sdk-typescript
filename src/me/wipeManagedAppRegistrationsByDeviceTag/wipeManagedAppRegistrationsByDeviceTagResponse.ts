...
export class WipeManagedAppRegistrationsByDeviceTagResponse implements Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private _additionalData: Map<string, unknown>;
    private _deviceTag?: string | undefined;
    /**
     * Instantiates a new wipeManagedAppRegistrationsByDeviceTagResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["deviceTag", (o, n) => { (o as unknown as WipeManagedAppRegistrationsByDeviceTagResponse).deviceTag = n.getStringValue(); }],
        ]);
    };
    /**
