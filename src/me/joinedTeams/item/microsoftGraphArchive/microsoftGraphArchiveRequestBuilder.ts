...
export class MicrosoftGraphArchiveRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/microsoft.graph.archive";
     ...
     */
    public post(body: ArchivePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphArchiveRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
