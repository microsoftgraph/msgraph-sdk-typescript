...
import { type TimeOffReasonsRequestBuilderGetRequestConfiguration } from './timeOffReasonsRequestBuilderGetRequestConfiguration';
import { type TimeOffReasonsRequestBuilderPostRequestConfiguration } from './timeOffReasonsRequestBuilderPostRequestConfiguration';
...
export class TimeOffReasonsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: TimeOffReason, requestConfiguration?: TimeOffReasonsRequestBuilderPostRequestConfiguration | undefined) : Promise<TimeOffReason | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: TimeOffReason, requestConfiguration?: TimeOffReasonsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
