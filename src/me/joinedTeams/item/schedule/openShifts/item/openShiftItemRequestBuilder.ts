...
export class OpenShiftItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: OpenShiftItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
