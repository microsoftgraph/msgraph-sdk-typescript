...
export class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.joinedTeams.item.channels.item.messages.item.replies.item.hostedContents.item collection
