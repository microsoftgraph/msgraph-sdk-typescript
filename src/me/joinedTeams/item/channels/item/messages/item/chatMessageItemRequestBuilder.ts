...
import {ChatMessageItemRequestBuilder as i632a151d8aa5316e425495e2066f8b5ecdbe7279706991b838cda03b4df4e5f7} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.joinedTeams.item.channels.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.joinedTeams.item.channels.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
     * @returns a chatMessageItemRequestBuilder
     */
    public repliesById(id: string) : i632a151d8aa5316e425495e2066f8b5ecdbe7279706991b838cda03b4df4e5f7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i632a151d8aa5316e425495e2066f8b5ecdbe7279706991b838cda03b4df4e5f7(urlTplParams, this.requestAdapter);
    };
}
