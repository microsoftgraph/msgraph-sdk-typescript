...
export class FindMeetingTimesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["meetingDuration", (o, n) => { (o as unknown as FindMeetingTimesResponse).meetingDuration = n.getStringValue(); }],
            ["minimumAttendeePercentage", (o, n) => { (o as unknown as FindMeetingTimesResponse).minimumAttendeePercentage = n.getNumberValue(); }],
            ["returnSuggestionReasons", (o, n) => { (o as unknown as FindMeetingTimesResponse).returnSuggestionReasons = n.getBooleanValue(); }],
            ["timeConstraint", (o, n) => { (o as unknown as FindMeetingTimesResponse).timeConstraint = n.getObjectValue<TimeConstraint>(TimeConstraint); }],
        ]);
    };
    /**
