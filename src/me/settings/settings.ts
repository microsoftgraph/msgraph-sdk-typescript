...
import {ShiftPreferences} from './shiftPreferences/shiftPreferences';
...
export class Settings extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["contributionToContentDiscoveryAsOrganizationDisabled", (o, n) => { (o as unknown as Settings).contributionToContentDiscoveryAsOrganizationDisabled = n.getBooleanValue(); }],
            ["contributionToContentDiscoveryDisabled", (o, n) => { (o as unknown as Settings).contributionToContentDiscoveryDisabled = n.getBooleanValue(); }],
            ["shiftPreferences", (o, n) => { (o as unknown as Settings).shiftPreferences = n.getObjectValue<ShiftPreferences>(ShiftPreferences); }],
        ]);
    };
    /**
