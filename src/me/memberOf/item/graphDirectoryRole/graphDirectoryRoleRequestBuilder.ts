...
import {GraphDirectoryRoleRequestBuilderGetRequestConfiguration} from './graphDirectoryRoleRequestBuilderGetRequestConfiguration';
...
export class GraphDirectoryRoleRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/me/memberOf/{directoryObject%2Did}/graph.directoryRole{?%24select,%24expand}");
    };
    /**
     ...
     */
    public get(requestConfiguration?: GraphDirectoryRoleRequestBuilderGetRequestConfiguration | undefined) : Promise<DirectoryRole | undefined> {
