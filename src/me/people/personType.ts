...
export class PersonType implements Parsable {
    ...
    /**
     * Gets the class_escaped property value. The type of data source, such as Person.
     * @returns a string
     */
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["class_escaped", (o, n) => { (o as unknown as PersonType).class_escaped = n.getStringValue(); }],
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeStringValue("class_escaped", this.class_escaped);
    ...
    /**
     * Sets the class_escaped property value. The type of data source, such as Person.
