...
/** Builds and executes requests for operations under /me/onenote/sectionGroups/{sectionGroup-id}/parentNotebook/sections/{onenoteSection-id}  */
export class OnenoteSectionRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.onenote.sectionGroups.item.parentNotebook.sections.item.pages.item collection
