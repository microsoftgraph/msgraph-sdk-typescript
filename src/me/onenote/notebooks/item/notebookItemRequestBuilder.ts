...
export class NotebookItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.onenote.notebooks.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.onenote.notebooks.item.sections.item collection
     * @param id Unique identifier of the item
