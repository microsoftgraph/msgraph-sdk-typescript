...
import {MicrosoftGraphPreviewRequestBuilderGetRequestConfiguration} from './microsoftGraphPreviewRequestBuilderGetRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the preview method.
 */
export class MicrosoftGraphPreviewRequestBuilder {
     ...
     */
    public get(requestConfiguration?: MicrosoftGraphPreviewRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OnenotePagePreview | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: MicrosoftGraphPreviewRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
