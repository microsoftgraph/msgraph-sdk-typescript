...
import {SectionGroupRequestBuilder as ia7946d32d9187b42e652ba6fb6f7d7f464bda93e93c0bdb2d193b5f59773ef3f} from './sectionGroups/item/sectionGroupRequestBuilder';
...
/** Builds and executes requests for operations under /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}  */
export class SectionGroupRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}{?select,expand}";
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.onenote.notebooks.item.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: string) : ia7946d32d9187b42e652ba6fb6f7d7f464bda93e93c0bdb2d193b5f59773ef3f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("sectionGroup_id1", id);
        return new ia7946d32d9187b42e652ba6fb6f7d7f464bda93e93c0bdb2d193b5f59773ef3f(urlTplParams, this.requestAdapter);
    };
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.onenote.notebooks.item.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
