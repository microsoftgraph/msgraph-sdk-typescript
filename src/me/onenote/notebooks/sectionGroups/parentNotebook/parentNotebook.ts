...
export class ParentNotebook extends OnenoteEntityHierarchyModel implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["isDefault", (o, n) => { (o as unknown as ParentNotebook).isDefault = n.getBooleanValue(); }],
            ["isShared", (o, n) => { (o as unknown as ParentNotebook).isShared = n.getBooleanValue(); }],
            ["links", (o, n) => { (o as unknown as ParentNotebook).links = n.getObjectValue<NotebookLinks>(NotebookLinks); }],
            ["sectionGroups", (o, n) => { (o as unknown as ParentNotebook).sectionGroups = n.getCollectionOfObjectValues<SectionGroup>(SectionGroup); }],
