...
import {GetNotebookFromWebUrlPostRequestBody, GetNotebookFromWebUrlResponseMember1} from './index';
...
export class GetNotebookFromWebUrlRequestBuilder {
     ...
     */
    public post(body: GetNotebookFromWebUrlPostRequestBody | undefined, requestConfiguration?: GetNotebookFromWebUrlRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CopyNotebookModel | GetNotebookFromWebUrlResponseMember1 | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        ...
        return this.requestAdapter?.sendAsync<CopyNotebookModel | GetNotebookFromWebUrlResponseMember1>(requestInfo, createCopyNotebookModel | GetNotebookFromWebUrlResponseMember1FromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
