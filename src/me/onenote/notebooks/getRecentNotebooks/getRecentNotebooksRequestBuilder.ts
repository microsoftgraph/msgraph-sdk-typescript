import {GetRecentNotebooks} from './getRecentNotebooks';
...
export class GetRecentNotebooksRequestBuilder {
     ...
     * @returns a Promise of getRecentNotebooks
     */
    public get(h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetRecentNotebooks[] | undefined> {
        const requestInfo = this.createGetRequestInformation(
            h, o
        );
        return this.httpCore?.sendCollectionAsync<GetRecentNotebooks>(requestInfo, GetRecentNotebooks, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
