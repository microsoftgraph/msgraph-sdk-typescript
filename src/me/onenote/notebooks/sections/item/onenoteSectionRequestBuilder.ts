...
/** Builds and executes requests for operations under /me/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}  */
export class OnenoteSectionRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.onenote.notebooks.sections.pages collection
