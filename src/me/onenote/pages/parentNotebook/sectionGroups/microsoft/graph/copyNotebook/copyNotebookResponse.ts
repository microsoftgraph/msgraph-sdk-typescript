...
export class Microsoft.graph.copyNotebookResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupId", (o, n) => { (o as unknown as Microsoft.graph.copyNotebookResponse).groupId = n.getStringValue(); }],
            ["notebookFolder", (o, n) => { (o as unknown as Microsoft.graph.copyNotebookResponse).notebookFolder = n.getStringValue(); }],
            ["renameAs", (o, n) => { (o as unknown as Microsoft.graph.copyNotebookResponse).renameAs = n.getStringValue(); }],
            ["siteCollectionId", (o, n) => { (o as unknown as Microsoft.graph.copyNotebookResponse).siteCollectionId = n.getStringValue(); }],
            ["siteId", (o, n) => { (o as unknown as Microsoft.graph.copyNotebookResponse).siteId = n.getStringValue(); }],
        ]);
    };
    /**
