...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.onenote.pages.parentNotebook.sectionGroups collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.onenote.pages.parentNotebook.sections collection
     * @param id Unique identifier of the item
