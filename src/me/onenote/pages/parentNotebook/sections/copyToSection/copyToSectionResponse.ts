...
export class CopyToSectionResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupId", (o, n) => { (o as unknown as CopyToSectionResponse).groupId = n.getStringValue(); }],
            ["id", (o, n) => { (o as unknown as CopyToSectionResponse).id = n.getStringValue(); }],
            ["siteCollectionId", (o, n) => { (o as unknown as CopyToSectionResponse).siteCollectionId = n.getStringValue(); }],
            ["siteId", (o, n) => { (o as unknown as CopyToSectionResponse).siteId = n.getStringValue(); }],
        ]);
    };
    /**
