...
export class ParentNotebookRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.onenote.pages.parentSection.parentNotebook.sectionGroups collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.onenote.pages.parentSection.parentNotebook.sections collection
     * @param id Unique identifier of the item
