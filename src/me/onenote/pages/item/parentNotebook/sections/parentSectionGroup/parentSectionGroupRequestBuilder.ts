...
/** Builds and executes requests for operations under /me/onenote/pages/{onenotePage-id}/parentNotebook/sections/{onenoteSection-id}/parentSectionGroup  */
export class ParentSectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.onenote.pages.item.parentNotebook.sections.item.parentSectionGroup.sectionGroups.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.onenote.pages.item.parentNotebook.sections.item.parentSectionGroup.sections.item collection
     * @param id Unique identifier of the item
