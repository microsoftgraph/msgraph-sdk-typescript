...
/** Builds and executes requests for operations under /me/onenote/pages/{onenotePage-id}/parentSection/pages/{onenotePage-id1}  */
export class OnenotePageRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/onenote/pages/{onenotePage_id}/parentSection/pages/{onenotePage_id1}{?select,expand}";
