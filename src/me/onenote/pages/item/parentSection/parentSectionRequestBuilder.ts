...
export class ParentSectionRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/onenote/pages/{onenotePage_id}/parentSection{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.onenote.pages.item.parentSection.pages.item collection
