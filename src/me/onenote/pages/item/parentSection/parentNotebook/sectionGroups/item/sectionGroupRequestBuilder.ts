...
import {SectionGroupRequestBuilder as id457088317c9f3d790f3306442f316f417f36c7d5baf5040140c7f1f277928db} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.onenote.pages.item.parentSection.parentNotebook.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: String) : id457088317c9f3d790f3306442f316f417f36c7d5baf5040140c7f1f277928db {
        if(!id) throw new Error("id cannot be undefined");
        return new id457088317c9f3d790f3306442f316f417f36c7d5baf5040140c7f1f277928db(this.currentPath + this.pathSegment + "/sectionGroups/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.onenote.pages.item.parentSection.parentNotebook.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
