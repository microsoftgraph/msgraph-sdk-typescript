...
/** Builds and executes requests for operations under /me/onenote/resources/{onenoteResource-id}/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/onenote/resources/{onenoteResource_id}/content";
