...
/** Builds and executes requests for operations under /me/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}  */
export class OnenotePageRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
