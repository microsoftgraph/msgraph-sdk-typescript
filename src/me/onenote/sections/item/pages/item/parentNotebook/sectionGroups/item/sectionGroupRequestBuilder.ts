...
import {SectionGroupRequestBuilder as i60c9c39435580121cafed5eb3dbd5460dc8be60aa1af2c9720f248f21128c3b5} from './sectionGroups/item/sectionGroupRequestBuilder';
...
export class SectionGroupRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.onenote.sections.item.pages.item.parentNotebook.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupRequestBuilder
     */
    public sectionGroupsById(id: String) : i60c9c39435580121cafed5eb3dbd5460dc8be60aa1af2c9720f248f21128c3b5 {
        if(!id) throw new Error("id cannot be undefined");
        return new i60c9c39435580121cafed5eb3dbd5460dc8be60aa1af2c9720f248f21128c3b5(this.currentPath + this.pathSegment + "/sectionGroups/" + id, this.httpCore, false);
    };
    /**
     * Gets an item from the graphtypescriptv4.utilities.me.onenote.sections.item.pages.item.parentNotebook.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
