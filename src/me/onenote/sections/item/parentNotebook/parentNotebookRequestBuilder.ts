...
/** Builds and executes requests for operations under /me/onenote/sections/{onenoteSection-id}/parentNotebook  */
export class ParentNotebookRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/onenote/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.onenote.sections.item.parentNotebook.sectionGroups.item collection
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.me.onenote.sections.item.parentNotebook.sections.item collection
     * @param id Unique identifier of the item
