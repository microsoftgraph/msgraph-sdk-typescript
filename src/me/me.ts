...
export class Me extends DirectoryObject implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["aboutMe", (o, n) => { (o as unknown as Me).aboutMe = n.getStringValue(); }],
            ["accountEnabled", (o, n) => { (o as unknown as Me).accountEnabled = n.getBooleanValue(); }],
            ["activities", (o, n) => { (o as unknown as Me).activities = n.getCollectionOfObjectValues<UserActivity>(UserActivity); }],
            ["ageGroup", (o, n) => { (o as unknown as Me).ageGroup = n.getStringValue(); }],
            ["agreementAcceptances", (o, n) => { (o as unknown as Me).agreementAcceptances = n.getCollectionOfObjectValues<AgreementAcceptance>(AgreementAcceptance); }],
            ["appRoleAssignments", (o, n) => { (o as unknown as Me).appRoleAssignments = n.getCollectionOfObjectValues<AppRoleAssignment>(AppRoleAssignment); }],
            ["assignedLicenses", (o, n) => { (o as unknown as Me).assignedLicenses = n.getCollectionOfObjectValues<AssignedLicense>(AssignedLicense); }],
            ["assignedPlans", (o, n) => { (o as unknown as Me).assignedPlans = n.getCollectionOfObjectValues<AssignedPlan>(AssignedPlan); }],
            ["authentication", (o, n) => { (o as unknown as Me).authentication = n.getObjectValue<Authentication>(Authentication); }],
            ["birthday", (o, n) => { (o as unknown as Me).birthday = n.getDateValue(); }],
            ["businessPhones", (o, n) => { (o as unknown as Me).businessPhones = n.getCollectionOfPrimitiveValues<string>(); }],
            ["calendar", (o, n) => { (o as unknown as Me).calendar = n.getObjectValue<Calendar>(Calendar); }],
            ["calendarGroups", (o, n) => { (o as unknown as Me).calendarGroups = n.getCollectionOfObjectValues<CalendarGroup>(CalendarGroup); }],
            ["calendars", (o, n) => { (o as unknown as Me).calendars = n.getCollectionOfObjectValues<Calendar>(Calendar); }],
            ["calendarView", (o, n) => { (o as unknown as Me).calendarView = n.getCollectionOfObjectValues<Event>(Event); }],
            ["chats", (o, n) => { (o as unknown as Me).chats = n.getCollectionOfObjectValues<Chat>(Chat); }],
            ["city", (o, n) => { (o as unknown as Me).city = n.getStringValue(); }],
            ["companyName", (o, n) => { (o as unknown as Me).companyName = n.getStringValue(); }],
            ["consentProvidedForMinor", (o, n) => { (o as unknown as Me).consentProvidedForMinor = n.getStringValue(); }],
            ["contactFolders", (o, n) => { (o as unknown as Me).contactFolders = n.getCollectionOfObjectValues<ContactFolder>(ContactFolder); }],
            ["contacts", (o, n) => { (o as unknown as Me).contacts = n.getCollectionOfObjectValues<Contact>(Contact); }],
            ["country", (o, n) => { (o as unknown as Me).country = n.getStringValue(); }],
            ["createdDateTime", (o, n) => { (o as unknown as Me).createdDateTime = n.getDateValue(); }],
            ["createdObjects", (o, n) => { (o as unknown as Me).createdObjects = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
            ["creationType", (o, n) => { (o as unknown as Me).creationType = n.getStringValue(); }],
            ["department", (o, n) => { (o as unknown as Me).department = n.getStringValue(); }],
            ["deviceEnrollmentLimit", (o, n) => { (o as unknown as Me).deviceEnrollmentLimit = n.getNumberValue(); }],
            ["deviceManagementTroubleshootingEvents", (o, n) => { (o as unknown as Me).deviceManagementTroubleshootingEvents = n.getCollectionOfObjectValues<DeviceManagementTroubleshootingEvent>(DeviceManagementTroubleshootingEvent); }],
            ["directReports", (o, n) => { (o as unknown as Me).directReports = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
            ["displayName", (o, n) => { (o as unknown as Me).displayName = n.getStringValue(); }],
            ["drive", (o, n) => { (o as unknown as Me).drive = n.getObjectValue<Drive>(Drive); }],
            ["drives", (o, n) => { (o as unknown as Me).drives = n.getCollectionOfObjectValues<Drive>(Drive); }],
            ["employeeHireDate", (o, n) => { (o as unknown as Me).employeeHireDate = n.getDateValue(); }],
            ["employeeId", (o, n) => { (o as unknown as Me).employeeId = n.getStringValue(); }],
            ["employeeOrgData", (o, n) => { (o as unknown as Me).employeeOrgData = n.getObjectValue<EmployeeOrgData>(EmployeeOrgData); }],
            ["employeeType", (o, n) => { (o as unknown as Me).employeeType = n.getStringValue(); }],
            ["events", (o, n) => { (o as unknown as Me).events = n.getCollectionOfObjectValues<Event>(Event); }],
            ["extensions", (o, n) => { (o as unknown as Me).extensions = n.getCollectionOfObjectValues<Extension>(Extension); }],
            ["externalUserState", (o, n) => { (o as unknown as Me).externalUserState = n.getStringValue(); }],
            ["externalUserStateChangeDateTime", (o, n) => { (o as unknown as Me).externalUserStateChangeDateTime = n.getDateValue(); }],
            ["faxNumber", (o, n) => { (o as unknown as Me).faxNumber = n.getStringValue(); }],
            ...
            ["interests", (o, n) => { (o as unknown as Me).interests = n.getCollectionOfPrimitiveValues<string>(); }],
            ["isResourceAccount", (o, n) => { (o as unknown as Me).isResourceAccount = n.getBooleanValue(); }],
            ["jobTitle", (o, n) => { (o as unknown as Me).jobTitle = n.getStringValue(); }],
            ...
            ["mailFolders", (o, n) => { (o as unknown as Me).mailFolders = n.getCollectionOfObjectValues<MailFolder>(MailFolder); }],
            ["mailNickname", (o, n) => { (o as unknown as Me).mailNickname = n.getStringValue(); }],
            ["managedAppRegistrations", (o, n) => { (o as unknown as Me).managedAppRegistrations = n.getCollectionOfObjectValues<ManagedAppRegistration>(ManagedAppRegistration); }],
            ["managedDevices", (o, n) => { (o as unknown as Me).managedDevices = n.getCollectionOfObjectValues<ManagedDevice>(ManagedDevice); }],
            ["manager", (o, n) => { (o as unknown as Me).manager = n.getObjectValue<DirectoryObject>(DirectoryObject); }],
            ["memberOf", (o, n) => { (o as unknown as Me).memberOf = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
            ["messages", (o, n) => { (o as unknown as Me).messages = n.getCollectionOfObjectValues<Message>(Message); }],
            ["mobilePhone", (o, n) => { (o as unknown as Me).mobilePhone = n.getStringValue(); }],
            ["mySite", (o, n) => { (o as unknown as Me).mySite = n.getStringValue(); }],
            ["oauth2PermissionGrants", (o, n) => { (o as unknown as Me).oauth2PermissionGrants = n.getCollectionOfObjectValues<OAuth2PermissionGrant>(OAuth2PermissionGrant); }],
            ["officeLocation", (o, n) => { (o as unknown as Me).officeLocation = n.getStringValue(); }],
            ["onenote", (o, n) => { (o as unknown as Me).onenote = n.getObjectValue<Onenote>(Onenote); }],
            ["onlineMeetings", (o, n) => { (o as unknown as Me).onlineMeetings = n.getCollectionOfObjectValues<OnlineMeeting>(OnlineMeeting); }],
            ["onPremisesDistinguishedName", (o, n) => { (o as unknown as Me).onPremisesDistinguishedName = n.getStringValue(); }],
            ["onPremisesDomainName", (o, n) => { (o as unknown as Me).onPremisesDomainName = n.getStringValue(); }],
            ...
            ["onPremisesUserPrincipalName", (o, n) => { (o as unknown as Me).onPremisesUserPrincipalName = n.getStringValue(); }],
            ["otherMails", (o, n) => { (o as unknown as Me).otherMails = n.getCollectionOfPrimitiveValues<string>(); }],
            ["outlook", (o, n) => { (o as unknown as Me).outlook = n.getObjectValue<OutlookUser>(OutlookUser); }],
            ["ownedDevices", (o, n) => { (o as unknown as Me).ownedDevices = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
            ["ownedObjects", (o, n) => { (o as unknown as Me).ownedObjects = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
            ["passwordPolicies", (o, n) => { (o as unknown as Me).passwordPolicies = n.getStringValue(); }],
            ["passwordProfile", (o, n) => { (o as unknown as Me).passwordProfile = n.getObjectValue<PasswordProfile>(PasswordProfile); }],
            ["pastProjects", (o, n) => { (o as unknown as Me).pastProjects = n.getCollectionOfPrimitiveValues<string>(); }],
            ["people", (o, n) => { (o as unknown as Me).people = n.getCollectionOfObjectValues<Person>(Person); }],
            ["photo", (o, n) => { (o as unknown as Me).photo = n.getObjectValue<ProfilePhoto>(ProfilePhoto); }],
            ["photos", (o, n) => { (o as unknown as Me).photos = n.getCollectionOfObjectValues<ProfilePhoto>(ProfilePhoto); }],
            ["planner", (o, n) => { (o as unknown as Me).planner = n.getObjectValue<PlannerUser>(PlannerUser); }],
            ["postalCode", (o, n) => { (o as unknown as Me).postalCode = n.getStringValue(); }],
            ["preferredLanguage", (o, n) => { (o as unknown as Me).preferredLanguage = n.getStringValue(); }],
            ["preferredName", (o, n) => { (o as unknown as Me).preferredName = n.getStringValue(); }],
            ["presence", (o, n) => { (o as unknown as Me).presence = n.getObjectValue<Presence>(Presence); }],
            ["provisionedPlans", (o, n) => { (o as unknown as Me).provisionedPlans = n.getCollectionOfObjectValues<ProvisionedPlan>(ProvisionedPlan); }],
            ["proxyAddresses", (o, n) => { (o as unknown as Me).proxyAddresses = n.getCollectionOfPrimitiveValues<string>(); }],
            ["registeredDevices", (o, n) => { (o as unknown as Me).registeredDevices = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
            ["responsibilities", (o, n) => { (o as unknown as Me).responsibilities = n.getCollectionOfPrimitiveValues<string>(); }],
            ["schools", (o, n) => { (o as unknown as Me).schools = n.getCollectionOfPrimitiveValues<string>(); }],
            ["scopedRoleMemberOf", (o, n) => { (o as unknown as Me).scopedRoleMemberOf = n.getCollectionOfObjectValues<ScopedRoleMembership>(ScopedRoleMembership); }],
            ["settings", (o, n) => { (o as unknown as Me).settings = n.getObjectValue<UserSettings>(UserSettings); }],
            ["showInAddressList", (o, n) => { (o as unknown as Me).showInAddressList = n.getBooleanValue(); }],
            ["signInSessionsValidFromDateTime", (o, n) => { (o as unknown as Me).signInSessionsValidFromDateTime = n.getDateValue(); }],
            ["skills", (o, n) => { (o as unknown as Me).skills = n.getCollectionOfPrimitiveValues<string>(); }],
            ["state", (o, n) => { (o as unknown as Me).state = n.getStringValue(); }],
            ["streetAddress", (o, n) => { (o as unknown as Me).streetAddress = n.getStringValue(); }],
            ["surname", (o, n) => { (o as unknown as Me).surname = n.getStringValue(); }],
            ["teamwork", (o, n) => { (o as unknown as Me).teamwork = n.getObjectValue<UserTeamwork>(UserTeamwork); }],
            ["todo", (o, n) => { (o as unknown as Me).todo = n.getObjectValue<Todo>(Todo); }],
            ["transitiveMemberOf", (o, n) => { (o as unknown as Me).transitiveMemberOf = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
            ["usageLocation", (o, n) => { (o as unknown as Me).usageLocation = n.getStringValue(); }],
            ["userPrincipalName", (o, n) => { (o as unknown as Me).userPrincipalName = n.getStringValue(); }],
            ["userType", (o, n) => { (o as unknown as Me).userType = n.getStringValue(); }],
        ]);
    };
    /**
