...
export class SetStatusMessageRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: SetStatusMessagePostRequestBody, requestConfiguration?: SetStatusMessageRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
