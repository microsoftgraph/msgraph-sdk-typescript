...
export class OwnedObjectsRequestBuilder {
     ...
     */
    public get(requestConfiguration?: OwnedObjectsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DirectoryObjectCollectionResponseImpl | undefined> {
