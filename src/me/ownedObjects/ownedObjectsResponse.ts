...
export class OwnedObjectsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as OwnedObjectsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as OwnedObjectsResponse).value = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
        ]);
    };
    /**
