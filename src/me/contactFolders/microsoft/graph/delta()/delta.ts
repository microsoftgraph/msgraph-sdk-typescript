...
export class Microsoft.graph.delta extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["childFolders", (o, n) => { (o as unknown as Microsoft.graph.delta).childFolders = n.getCollectionOfObjectValues<ContactFolder>(ContactFolder); }],
            ["contacts", (o, n) => { (o as unknown as Microsoft.graph.delta).contacts = n.getCollectionOfObjectValues<Contact>(Contact); }],
