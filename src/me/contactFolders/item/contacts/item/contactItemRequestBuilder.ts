import {ContactImpl} from '../../../../../models/';
...
export class ContactItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.item.contacts.item.extensions.item collection
     ...
     */
    public get(requestConfiguration?: ContactItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ContactImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ContactImpl>(requestInfo, createContactFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.item.contacts.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: Contact | undefined, requestConfiguration?: ContactItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.item.contacts.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
