...
/** Builds and executes requests for operations under /me/contactFolders/{contactFolder-id}/contacts/{contact-id}/photo/$value  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/contactFolders/{contactFolder_id}/contacts/{contact_id}/photo/$value";
