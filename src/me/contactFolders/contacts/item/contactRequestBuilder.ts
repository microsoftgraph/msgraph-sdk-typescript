...
export class ContactRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.contacts.extensions collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.contacts.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.contacts.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
