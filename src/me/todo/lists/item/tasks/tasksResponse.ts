...
export class TasksResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TasksResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TasksResponse).value = n.getCollectionOfObjectValues<TodoTask>(TodoTask); }],
        ]);
    };
    /**
