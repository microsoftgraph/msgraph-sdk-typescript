...
export class TodoTaskRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.todo.lists.tasks.extensions collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.todo.lists.tasks.linkedResources collection
     * @param id Unique identifier of the item
