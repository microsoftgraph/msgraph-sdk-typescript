...
export class TranslateExchangeIdsRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: TranslateExchangeIdsResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public post(body: TranslateExchangeIdsResponse | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TranslateExchangeIds[] | undefined> {
        ...
        return this.httpCore?.sendCollectionAsync<TranslateExchangeIds>(requestInfo, TranslateExchangeIds, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
