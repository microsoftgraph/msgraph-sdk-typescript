...
export class TranslateExchangeIdsRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: TranslateExchangeIdsRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: TranslateExchangeIdsRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TranslateExchangeIds[] | undefined> {
        if(!body) throw new Error("body cannot be undefined");
