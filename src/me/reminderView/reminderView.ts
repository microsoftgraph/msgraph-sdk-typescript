...
export class ReminderView implements Parsable {
    ...
    /**
     * Instantiates a new reminderView and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["changeKey", (o, n) => { (o as unknown as ReminderView).changeKey = n.getStringValue(); }],
            ["eventEndTime", (o, n) => { (o as unknown as ReminderView).eventEndTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
            ["eventId", (o, n) => { (o as unknown as ReminderView).eventId = n.getStringValue(); }],
            ["eventLocation", (o, n) => { (o as unknown as ReminderView).eventLocation = n.getObjectValue<Location>(Location); }],
            ["eventStartTime", (o, n) => { (o as unknown as ReminderView).eventStartTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
            ["eventSubject", (o, n) => { (o as unknown as ReminderView).eventSubject = n.getStringValue(); }],
            ["eventWebLink", (o, n) => { (o as unknown as ReminderView).eventWebLink = n.getStringValue(); }],
            ["reminderFireTime", (o, n) => { (o as unknown as ReminderView).reminderFireTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
        ]);
    };
    /**
