...
export class FilterOperatorsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: FilterOperatorsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<FilterOperatorSchemaCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<FilterOperatorSchemaCollectionResponse>(requestInfo, createFilterOperatorSchemaCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     ...
     */
    public post(body: FilterOperatorSchema | undefined, requestConfiguration?: FilterOperatorsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<FilterOperatorSchema | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: FilterOperatorSchema | undefined, requestConfiguration?: FilterOperatorsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeFilterOperatorSchema);
        return requestInfo;
    };
}
