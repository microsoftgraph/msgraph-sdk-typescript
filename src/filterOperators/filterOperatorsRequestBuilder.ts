...
export class FilterOperatorsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: FilterOperatorSchema | undefined, requestConfiguration?: FilterOperatorsRequestBuilderPostRequestConfiguration | undefined) : Promise<FilterOperatorSchema | undefined> {
