...
import {ChatMessageRequestBuilder as i8620d3ae350ecf3290f2279a6f3b8dd69f58e9afc4a7c744e10592cd19414ce9} from './replies/item/chatMessageRequestBuilder';
...
export class ChatMessageRequestBuilder {
     ...
     */
    public repliesById(id: string) : i8620d3ae350ecf3290f2279a6f3b8dd69f58e9afc4a7c744e10592cd19414ce9 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage_id1"] = id
        return new i8620d3ae350ecf3290f2279a6f3b8dd69f58e9afc4a7c744e10592cd19414ce9(urlTplParams, this.requestAdapter);
    };
}
