...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : i159aae6b4339ad4566b3d3441c02b1c30accb160227acf0783088660d4fb018e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i159aae6b4339ad4566b3d3441c02b1c30accb160227acf0783088660d4fb018e(urlTplParams, this.requestAdapter);
    };
}
