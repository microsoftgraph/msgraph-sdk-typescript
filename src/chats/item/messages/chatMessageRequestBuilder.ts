...
export class ChatMessageRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.chats.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.chats.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
