...
export class TabsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TabsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TabsResponse).value = n.getCollectionOfObjectValues<TeamsTab>(TeamsTab); }],
        ]);
    };
    /**
