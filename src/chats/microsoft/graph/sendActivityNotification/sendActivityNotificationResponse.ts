...
export class Microsoft.graph.sendActivityNotificationResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["recipient", (o, n) => { (o as unknown as Microsoft.graph.sendActivityNotificationResponse).recipient = n.getObjectValue<TeamworkNotificationRecipient>(TeamworkNotificationRecipient); }],
