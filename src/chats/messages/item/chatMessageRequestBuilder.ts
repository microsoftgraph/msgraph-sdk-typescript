...
export class ChatMessageRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.chats.messages.hostedContents collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.chats.messages.replies collection
     * @param id Unique identifier of the item
