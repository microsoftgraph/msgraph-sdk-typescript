...
import { createEducationUserCollectionResponseFromDiscriminatorValue, createEducationUserFromDiscriminatorValue, deserializeIntoEducationUser, serializeEducationUser, type EducationUser, type EducationUserCollectionResponse } from '../../models/';
...
export class UsersRequestBuilder extends BaseRequestBuilder<UsersRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/users{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new UsersRequestBuilder(x, y));
    }
    /**
