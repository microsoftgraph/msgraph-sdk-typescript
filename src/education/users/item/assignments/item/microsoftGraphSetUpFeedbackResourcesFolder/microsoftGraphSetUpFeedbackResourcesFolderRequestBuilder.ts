...
import {MicrosoftGraphSetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration} from './microsoftGraphSetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the setUpFeedbackResourcesFolder method.
 */
export class MicrosoftGraphSetUpFeedbackResourcesFolderRequestBuilder {
     ...
     */
    public post(requestConfiguration?: MicrosoftGraphSetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationAssignment | undefined> {
     ...
     */
    public toPostRequestInformation(requestConfiguration?: MicrosoftGraphSetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
