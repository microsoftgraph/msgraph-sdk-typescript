...
import { createEducationSubmissionCollectionResponseFromDiscriminatorValue, createEducationSubmissionFromDiscriminatorValue, deserializeIntoEducationSubmission, serializeEducationSubmission, type EducationSubmission, type EducationSubmissionCollectionResponse } from '../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { EducationSubmissionItemRequestBuilder } from './item/';
 ...
 */
export class SubmissionsRequestBuilder extends BaseRequestBuilder<SubmissionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SubmissionsRequestBuilder(x, y));
    }
    /**
