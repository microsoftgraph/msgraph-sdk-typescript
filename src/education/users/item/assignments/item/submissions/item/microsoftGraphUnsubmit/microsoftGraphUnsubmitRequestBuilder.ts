...
import {MicrosoftGraphUnsubmitRequestBuilderPostRequestConfiguration} from './microsoftGraphUnsubmitRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the unsubmit method.
 */
export class MicrosoftGraphUnsubmitRequestBuilder {
     ...
     */
    public post(requestConfiguration?: MicrosoftGraphUnsubmitRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationSubmission | undefined> {
     ...
     */
    public toPostRequestInformation(requestConfiguration?: MicrosoftGraphUnsubmitRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
