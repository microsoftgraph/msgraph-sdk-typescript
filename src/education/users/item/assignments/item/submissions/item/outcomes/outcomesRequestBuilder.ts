...
import { createEducationOutcomeCollectionResponseFromDiscriminatorValue } from '../../../../../../../../models/educationOutcomeCollectionResponse';
...
export interface OutcomesRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
