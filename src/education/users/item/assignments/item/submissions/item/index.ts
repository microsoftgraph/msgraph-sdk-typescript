...
export class EducationSubmissionItemRequestBuilder extends BaseRequestBuilder<EducationSubmissionItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}{?%24select,%24expand}", (x, y) => new EducationSubmissionItemRequestBuilder(x, y));
    }
    /**
