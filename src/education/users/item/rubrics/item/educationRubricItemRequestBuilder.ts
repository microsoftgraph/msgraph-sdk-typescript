...
export class EducationRubricItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: EducationRubricItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
