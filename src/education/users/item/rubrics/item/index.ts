...
export class EducationRubricItemRequestBuilder extends BaseRequestBuilder<EducationRubricItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/rubrics/{educationRubric%2Did}{?%24select,%24expand}", (x, y) => new EducationRubricItemRequestBuilder(x, y));
    }
    /**
