...
import { createEducationUserFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeEducationUser, type BaseDeltaFunctionResponse, type EducationUser } from '../../../models/';
...
export class DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/users/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", (x, y) => new DeltaRequestBuilder(x, y));
    }
    /**
