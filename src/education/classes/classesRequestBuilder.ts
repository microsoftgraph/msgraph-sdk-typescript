import {createEducationClassCollectionResponseFromDiscriminatorValue} from '../../models/microsoft/graph/createEducationClassCollectionResponseFromDiscriminatorValue';
...
import {EducationClassCollectionResponse} from '../../models/microsoft/graph/educationClassCollectionResponse';
...
export class ClassesRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: EducationClass | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationClassCollectionResponse | undefined> {
     ...
     */
    public post(body: EducationClass | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationClass | undefined> {
        if(!body) throw new Error("body cannot be undefined");
