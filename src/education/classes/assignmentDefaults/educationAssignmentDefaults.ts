...
export class EducationAssignmentDefaults extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["addedStudentAction", (o, n) => { (o as unknown as EducationAssignmentDefaults).addedStudentAction = n.getObjectValue<EducationAddedStudentAction>(EducationAddedStudentAction); }],
