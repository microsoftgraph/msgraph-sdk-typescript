...
export class Microsoft.graph.submitRequestBuilder {
    ...
    /**
     * Instantiates a new Microsoft.graph.submitRequestBuilder and sets the default values.
     ...
     * @returns a Promise of Microsoft.graph.submitResponse
     */
