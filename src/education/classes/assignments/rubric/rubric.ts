...
export class Rubric extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["createdBy", (o, n) => { (o as unknown as Rubric).createdBy = n.getObjectValue<IdentitySet>(IdentitySet); }],
            ["createdDateTime", (o, n) => { (o as unknown as Rubric).createdDateTime = n.getDateValue(); }],
            ["description", (o, n) => { (o as unknown as Rubric).description = n.getObjectValue<EducationItemBody>(EducationItemBody); }],
            ["displayName", (o, n) => { (o as unknown as Rubric).displayName = n.getStringValue(); }],
