...
import { createEducationClassCollectionResponseFromDiscriminatorValue, createEducationClassFromDiscriminatorValue, deserializeIntoEducationClass, serializeEducationClass, type EducationClass, type EducationClassCollectionResponse } from '../../models/';
...
export class ClassesRequestBuilder extends BaseRequestBuilder<ClassesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/classes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ClassesRequestBuilder(x, y));
    }
    /**
