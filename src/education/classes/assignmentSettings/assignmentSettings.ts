...
export class AssignmentSettings extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["submissionAnimationDisabled", (o, n) => { (o as unknown as AssignmentSettings).submissionAnimationDisabled = n.getBooleanValue(); }],
        ]);
    };
    /**
