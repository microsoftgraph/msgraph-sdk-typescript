...
export class EducationUserItemRequestBuilder extends BaseRequestBuilder<EducationUserItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/members/{educationUser%2Did}", (x, y) => new EducationUserItemRequestBuilder(x, y));
    }
}
// tslint:enable
// eslint-enable
