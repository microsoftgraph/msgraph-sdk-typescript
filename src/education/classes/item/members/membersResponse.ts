...
export class MembersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as MembersResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as MembersResponse).value = n.getCollectionOfObjectValues<EducationUser>(EducationUser); }],
        ]);
    };
    /**
