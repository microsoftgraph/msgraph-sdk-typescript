...
export class SubmittedResourcesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SubmittedResourcesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SubmittedResourcesResponse).value = n.getCollectionOfObjectValues<EducationSubmissionResource>(EducationSubmissionResource); }],
        ]);
    };
    /**
