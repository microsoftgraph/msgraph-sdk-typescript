...
export class SetUpResourcesFolderRequestBuilder extends BaseRequestBuilder<SetUpResourcesFolderRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/setUpResourcesFolder", (x, y) => new SetUpResourcesFolderRequestBuilder(x, y));
    }
    /**
