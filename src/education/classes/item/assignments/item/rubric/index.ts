...
export class RubricRequestBuilder extends BaseRequestBuilder<RubricRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/rubric{?%24select,%24expand}", (x, y) => new RubricRequestBuilder(x, y));
    }
    /**
