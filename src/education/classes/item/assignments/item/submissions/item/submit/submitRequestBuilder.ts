...
export class SubmitRequestBuilder {
     ...
     */
    public post(requestConfiguration?: SubmitRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationSubmission | SubmitResponseMember1 | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EducationSubmission | SubmitResponseMember1>(requestInfo, createEducationSubmission | SubmitResponseMember1FromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
