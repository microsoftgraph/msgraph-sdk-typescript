...
export class EducationSubmissionResourceItemRequestBuilder extends BaseRequestBuilder<EducationSubmissionResourceItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/resources/{educationSubmissionResource%2Did}{?%24select,%24expand}", (x, y) => new EducationSubmissionResourceItemRequestBuilder(x, y));
    }
    /**
