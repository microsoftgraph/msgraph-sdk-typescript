...
import { createEducationOutcomeCollectionResponseFromDiscriminatorValue, createEducationOutcomeFromDiscriminatorValue, serializeEducationOutcome, type EducationOutcome, type EducationOutcomeCollectionResponse } from '../../../../../../../../models/';
 ...
 */
export const OutcomesRequestBuilderUriTemplate = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/outcomes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
