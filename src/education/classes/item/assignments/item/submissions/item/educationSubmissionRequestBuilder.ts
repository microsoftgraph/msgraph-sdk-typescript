...
import {EducationSubmissionResourceRequestBuilder as i25e4c04eb0937a9065a38a4d3d0a7f10919b6a3ae126334ebea9f8742d357b84} from './resources/item/educationSubmissionResourceRequestBuilder';
...
import {EducationSubmissionResourceRequestBuilder as i740b3cc99f3789f16070c74440c403b84fbe5765c81b23046847ac5ee90c8735} from './submittedResources/item/educationSubmissionResourceRequestBuilder';
...
export class EducationSubmissionRequestBuilder {
     ...
     */
    public resourcesById(id: string) : i25e4c04eb0937a9065a38a4d3d0a7f10919b6a3ae126334ebea9f8742d357b84 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["educationSubmissionResource_id"] = id
        return new i25e4c04eb0937a9065a38a4d3d0a7f10919b6a3ae126334ebea9f8742d357b84(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a educationSubmissionResourceRequestBuilder
     */
    public submittedResourcesById(id: string) : i740b3cc99f3789f16070c74440c403b84fbe5765c81b23046847ac5ee90c8735 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["educationSubmissionResource_id"] = id
        return new i740b3cc99f3789f16070c74440c403b84fbe5765c81b23046847ac5ee90c8735(urlTplParams, this.requestAdapter);
    };
}
