...
export class ReturnRequestBuilder {
     ...
     */
    public post(requestConfiguration?: ReturnRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationSubmission | ReturnResponseMember1 | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EducationSubmission | ReturnResponseMember1>(requestInfo, createEducationSubmission | ReturnResponseMember1FromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
