...
import {MicrosoftGraphSubmitRequestBuilderPostRequestConfiguration} from './microsoftGraphSubmitRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the submit method.
 */
export class MicrosoftGraphSubmitRequestBuilder {
     ...
     * @see {@link https://docs.microsoft.com/graph/api/educationsubmission-submit?view=graph-rest-1.0|Find more info here}
     */
    public post(requestConfiguration?: MicrosoftGraphSubmitRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationSubmission | undefined> {
     ...
     */
    public toPostRequestInformation(requestConfiguration?: MicrosoftGraphSubmitRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
