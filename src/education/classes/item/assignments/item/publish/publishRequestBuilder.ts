...
export class PublishRequestBuilder {
     ...
     */
    public post(requestConfiguration?: PublishRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationAssignment | PublishResponseMember1 | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EducationAssignment | PublishResponseMember1>(requestInfo, createEducationAssignment | PublishResponseMember1FromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
