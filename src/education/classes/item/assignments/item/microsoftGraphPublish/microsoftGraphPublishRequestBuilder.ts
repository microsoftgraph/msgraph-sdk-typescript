...
export class MicrosoftGraphPublishRequestBuilder {
     ...
     */
    public post(requestConfiguration?: MicrosoftGraphPublishRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationAssignment | undefined> {
