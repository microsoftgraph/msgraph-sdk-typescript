...
import { createEducationSchoolCollectionResponseFromDiscriminatorValue, type EducationSchoolCollectionResponse } from '../../../../models/';
...
export class SchoolsRequestBuilder extends BaseRequestBuilder<SchoolsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/schools{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SchoolsRequestBuilder(x, y));
    }
    /**
