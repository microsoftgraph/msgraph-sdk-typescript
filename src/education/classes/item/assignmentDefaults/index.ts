...
import { createEducationAssignmentDefaultsFromDiscriminatorValue, deserializeIntoEducationAssignmentDefaults, serializeEducationAssignmentDefaults, type EducationAssignmentDefaults } from '../../../../models/';
 ...
 */
export class AssignmentDefaultsRequestBuilder extends BaseRequestBuilder<AssignmentDefaultsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignmentDefaults{?%24select,%24expand}", (x, y) => new AssignmentDefaultsRequestBuilder(x, y));
    }
    /**
