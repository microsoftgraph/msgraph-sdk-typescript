...
export class AssignmentCategoriesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AssignmentCategoriesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AssignmentCategoriesResponse).value = n.getCollectionOfObjectValues<EducationCategory>(EducationCategory); }],
        ]);
    };
    /**
