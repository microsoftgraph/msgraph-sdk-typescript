...
export class SetUpFeedbackResourcesFolderRequestBuilder extends BaseRequestBuilder<SetUpFeedbackResourcesFolderRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/setUpFeedbackResourcesFolder", (x, y) => new SetUpFeedbackResourcesFolderRequestBuilder(x, y));
    }
    /**
