...
export class EducationSubmissionItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: EducationSubmissionItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
