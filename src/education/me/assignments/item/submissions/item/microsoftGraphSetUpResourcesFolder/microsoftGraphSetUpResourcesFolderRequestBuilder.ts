...
export class MicrosoftGraphSetUpResourcesFolderRequestBuilder {
     ...
     */
    public post(requestConfiguration?: MicrosoftGraphSetUpResourcesFolderRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationSubmission | undefined> {
