...
export class SetUpResourcesFolderRequestBuilder {
     ...
     */
    public post(requestConfiguration?: SetUpResourcesFolderRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationSubmission | SetUpResourcesFolderResponseMember1 | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EducationSubmission | SetUpResourcesFolderResponseMember1>(requestInfo, createEducationSubmission | SetUpResourcesFolderResponseMember1FromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
