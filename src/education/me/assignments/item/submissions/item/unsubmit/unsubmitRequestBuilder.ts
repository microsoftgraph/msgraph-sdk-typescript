...
export class UnsubmitRequestBuilder {
     ...
     */
    public post(requestConfiguration?: UnsubmitRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationSubmission | UnsubmitResponseMember1 | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EducationSubmission | UnsubmitResponseMember1>(requestInfo, createEducationSubmission | UnsubmitResponseMember1FromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
