...
export class UnsubmitRequestBuilder {
     ...
     */
    public post(requestConfiguration?: UnsubmitRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationSubmissionImpl | undefined> {
