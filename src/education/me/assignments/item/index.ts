...
export class EducationAssignmentItemRequestBuilder extends BaseRequestBuilder<EducationAssignmentItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}{?%24select,%24expand}", (x, y) => new EducationAssignmentItemRequestBuilder(x, y));
    }
    /**
