...
export class Me extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["classes", (o, n) => { (o as unknown as Me).classes = n.getCollectionOfObjectValues<EducationClass>(EducationClass); }],
            ["createdBy", (o, n) => { (o as unknown as Me).createdBy = n.getObjectValue<IdentitySet>(IdentitySet); }],
            ...
            ["externalSource", (o, n) => { (o as unknown as Me).externalSource = n.getObjectValue<EducationExternalSource>(EducationExternalSource); }],
            ["externalSourceDetail", (o, n) => { (o as unknown as Me).externalSourceDetail = n.getStringValue(); }],
            ["givenName", (o, n) => { (o as unknown as Me).givenName = n.getStringValue(); }],
            ["mail", (o, n) => { (o as unknown as Me).mail = n.getStringValue(); }],
            ["mailingAddress", (o, n) => { (o as unknown as Me).mailingAddress = n.getObjectValue<PhysicalAddress>(PhysicalAddress); }],
            ["mailNickname", (o, n) => { (o as unknown as Me).mailNickname = n.getStringValue(); }],
            ["middleName", (o, n) => { (o as unknown as Me).middleName = n.getStringValue(); }],
            ...
            ["onPremisesInfo", (o, n) => { (o as unknown as Me).onPremisesInfo = n.getObjectValue<EducationOnPremisesInfo>(EducationOnPremisesInfo); }],
            ...
            ["primaryRole", (o, n) => { (o as unknown as Me).primaryRole = n.getObjectValue<EducationUserRole>(EducationUserRole); }],
            ["provisionedPlans", (o, n) => { (o as unknown as Me).provisionedPlans = n.getCollectionOfObjectValues<ProvisionedPlan>(ProvisionedPlan); }],
            ["refreshTokensValidFromDateTime", (o, n) => { (o as unknown as Me).refreshTokensValidFromDateTime = n.getDateValue(); }],
            ["residenceAddress", (o, n) => { (o as unknown as Me).residenceAddress = n.getObjectValue<PhysicalAddress>(PhysicalAddress); }],
            ["rubrics", (o, n) => { (o as unknown as Me).rubrics = n.getCollectionOfObjectValues<EducationRubric>(EducationRubric); }],
            ["schools", (o, n) => { (o as unknown as Me).schools = n.getCollectionOfObjectValues<EducationSchool>(EducationSchool); }],
            ["showInAddressList", (o, n) => { (o as unknown as Me).showInAddressList = n.getBooleanValue(); }],
            ["student", (o, n) => { (o as unknown as Me).student = n.getObjectValue<EducationStudent>(EducationStudent); }],
            ["surname", (o, n) => { (o as unknown as Me).surname = n.getStringValue(); }],
            ["taughtClasses", (o, n) => { (o as unknown as Me).taughtClasses = n.getCollectionOfObjectValues<EducationClass>(EducationClass); }],
            ["teacher", (o, n) => { (o as unknown as Me).teacher = n.getObjectValue<EducationTeacher>(EducationTeacher); }],
            ["usageLocation", (o, n) => { (o as unknown as Me).usageLocation = n.getStringValue(); }],
            ["user", (o, n) => { (o as unknown as Me).user = n.getObjectValue<User>(User); }],
