...
export class RubricsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as RubricsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as RubricsResponse).value = n.getCollectionOfObjectValues<EducationRubric>(EducationRubric); }],
        ]);
    };
    /**
