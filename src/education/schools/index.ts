...
import { createEducationSchoolCollectionResponseFromDiscriminatorValue, createEducationSchoolFromDiscriminatorValue, deserializeIntoEducationSchool, serializeEducationSchool, type EducationSchool, type EducationSchoolCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DeltaRequestBuilder } from './delta/';
import { EducationSchoolItemRequestBuilder } from './item/';
 ...
 */
export class SchoolsRequestBuilder extends BaseRequestBuilder<SchoolsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/schools{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SchoolsRequestBuilder(x, y));
    }
    /**
