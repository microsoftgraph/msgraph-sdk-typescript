...
export class EducationSchoolItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: EducationSchoolItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
