...
import { createEducationSchoolFromDiscriminatorValue, deserializeIntoEducationSchool, serializeEducationSchool, type EducationSchool } from '../../../models/';
...
export class EducationSchoolItemRequestBuilder extends BaseRequestBuilder<EducationSchoolItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/education/schools/{educationSchool%2Did}{?%24select,%24expand}", (x, y) => new EducationSchoolItemRequestBuilder(x, y));
    }
    /**
     * Delete a school.
