...
export class BotRequestBuilder {
    ...
    public createPatchRequestInformation(body: TeamworkBot | undefined, requestConfiguration?: BotRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new TeamworkBotImpl(body)
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: TeamworkBotImpl | undefined, requestConfiguration?: BotRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
