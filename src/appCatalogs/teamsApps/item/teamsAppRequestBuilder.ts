...
export class TeamsAppRequestBuilder {
    public get appDefinitions(): AppDefinitionsRequestBuilder {
        return new AppDefinitionsRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    }
    ...
    public appDefinitionsById(id: String) : TeamsAppDefinitionRequestBuilder {
        ...
        return new TeamsAppDefinitionRequestBuilder(this.currentPath + this.pathSegment + "/appDefinitions/" + id, this.httpCore, false);
    };
    /**
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: TeamsApp | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: TeamsApp | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
