...
export class TeamsAppRequestBuilder {
    ...
    public appDefinitionsById(id: string) : TeamsAppDefinitionRequestBuilder {
        ...
        id && urlTplParams.set("teamsAppDefinition_id", id);
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: TeamsApp | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: TeamsApp | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
