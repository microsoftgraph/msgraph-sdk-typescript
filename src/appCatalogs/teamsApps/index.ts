...
import { createTeamsAppCollectionResponseFromDiscriminatorValue, createTeamsAppFromDiscriminatorValue, deserializeIntoTeamsApp, serializeTeamsApp, type TeamsApp, type TeamsAppCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { TeamsAppItemRequestBuilder } from './item/';
 ...
 */
export class TeamsAppsRequestBuilder extends BaseRequestBuilder<TeamsAppsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/appCatalogs/teamsApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TeamsAppsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<TeamsAppsRequestBuilderGetQueryParameters> | undefined) : Promise<TeamsAppCollectionResponse | undefined> {
     ...
     */
    public post(body: TeamsApp, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<TeamsApp | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<TeamsAppsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, teamsAppsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: TeamsApp, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
