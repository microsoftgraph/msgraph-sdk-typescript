import {DelegatedAdminServiceManagementDetail, DelegatedAdminServiceManagementDetailCollectionResponse} from '../../../../models/';
 ...
 */
export class ServiceManagementDetailsRequestBuilder {
