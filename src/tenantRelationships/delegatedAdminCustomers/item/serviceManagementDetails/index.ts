...
import { createDelegatedAdminServiceManagementDetailCollectionResponseFromDiscriminatorValue, createDelegatedAdminServiceManagementDetailFromDiscriminatorValue, deserializeIntoDelegatedAdminServiceManagementDetail, serializeDelegatedAdminServiceManagementDetail, type DelegatedAdminServiceManagementDetail, type DelegatedAdminServiceManagementDetailCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DelegatedAdminServiceManagementDetailItemRequestBuilder } from './item/';
 ...
 */
export class ServiceManagementDetailsRequestBuilder extends BaseRequestBuilder<ServiceManagementDetailsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/tenantRelationships/delegatedAdminCustomers/{delegatedAdminCustomer%2Did}/serviceManagementDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ServiceManagementDetailsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<ServiceManagementDetailsRequestBuilderGetQueryParameters> | undefined) : Promise<DelegatedAdminServiceManagementDetailCollectionResponse | undefined> {
     ...
     */
    public post(body: DelegatedAdminServiceManagementDetail, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DelegatedAdminServiceManagementDetail | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<ServiceManagementDetailsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, serviceManagementDetailsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DelegatedAdminServiceManagementDetail, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
