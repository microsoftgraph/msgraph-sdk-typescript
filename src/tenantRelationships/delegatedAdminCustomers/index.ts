...
import { createDelegatedAdminCustomerCollectionResponseFromDiscriminatorValue, createDelegatedAdminCustomerFromDiscriminatorValue, deserializeIntoDelegatedAdminCustomer, serializeDelegatedAdminCustomer, type DelegatedAdminCustomer, type DelegatedAdminCustomerCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DelegatedAdminCustomerItemRequestBuilder } from './item/';
 ...
 */
export class DelegatedAdminCustomersRequestBuilder extends BaseRequestBuilder<DelegatedAdminCustomersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/tenantRelationships/delegatedAdminCustomers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DelegatedAdminCustomersRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<DelegatedAdminCustomersRequestBuilderGetQueryParameters> | undefined) : Promise<DelegatedAdminCustomerCollectionResponse | undefined> {
     ...
     */
    public post(body: DelegatedAdminCustomer, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DelegatedAdminCustomer | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<DelegatedAdminCustomersRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, delegatedAdminCustomersRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DelegatedAdminCustomer, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
