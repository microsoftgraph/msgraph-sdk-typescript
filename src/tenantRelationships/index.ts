...
import { createTenantRelationshipFromDiscriminatorValue, deserializeIntoTenantRelationship, serializeTenantRelationship, type TenantRelationship } from '../models/';
 ...
 */
export class TenantRelationshipsRequestBuilder extends BaseRequestBuilder<TenantRelationshipsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/tenantRelationships{?%24select,%24expand}", (x, y) => new TenantRelationshipsRequestBuilder(x, y));
    }
    /**
