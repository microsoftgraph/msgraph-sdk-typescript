...
import { createDelegatedAdminRelationshipRequestCollectionResponseFromDiscriminatorValue, createDelegatedAdminRelationshipRequestFromDiscriminatorValue, deserializeIntoDelegatedAdminRelationshipRequest, serializeDelegatedAdminRelationshipRequest, type DelegatedAdminRelationshipRequest, type DelegatedAdminRelationshipRequestCollectionResponse } from '../../../../models/';
 ...
 */
export class RequestsRequestBuilder extends BaseRequestBuilder<RequestsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship%2Did}/requests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RequestsRequestBuilder(x, y));
    }
    /**
