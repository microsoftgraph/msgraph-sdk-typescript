...
import { createDelegatedAdminAccessAssignmentFromDiscriminatorValue, deserializeIntoDelegatedAdminAccessAssignment, serializeDelegatedAdminAccessAssignment, type DelegatedAdminAccessAssignment } from '../../../../../models/';
 ...
 */
export class DelegatedAdminAccessAssignmentItemRequestBuilder extends BaseRequestBuilder<DelegatedAdminAccessAssignmentItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship%2Did}/accessAssignments/{delegatedAdminAccessAssignment%2Did}{?%24select,%24expand}", (x, y) => new DelegatedAdminAccessAssignmentItemRequestBuilder(x, y));
    }
    /**
