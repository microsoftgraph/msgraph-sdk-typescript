 ...
 */
export class DelegatedAdminAccessAssignmentItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, delegatedAdminAccessAssignmentId?: string | undefined) {
