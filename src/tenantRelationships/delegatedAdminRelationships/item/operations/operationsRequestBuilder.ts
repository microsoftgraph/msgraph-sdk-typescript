import { type DelegatedAdminRelationshipOperationCollectionResponse } from '../../../../models/';
...
import { createDelegatedAdminRelationshipOperationCollectionResponseFromDiscriminatorValue } from '../../../../models/delegatedAdminRelationshipOperationCollectionResponse';
...
export class OperationsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Get a list of the delegatedAdminRelationshipOperation objects and their properties. This API is supported in the following national cloud deployments.
    ...
    public get(requestConfiguration?: OperationsRequestBuilderGetRequestConfiguration | undefined) : Promise<DelegatedAdminRelationshipOperationCollectionResponse | undefined> {
        ...
        return this.requestAdapter.sendAsync<DelegatedAdminRelationshipOperationCollectionResponse>(requestInfo, createDelegatedAdminRelationshipOperationCollectionResponseFromDiscriminatorValue, errorMapping);
    };
    /**
     ...
     */
    public post(body: DelegatedAdminRelationshipOperation, requestConfiguration?: OperationsRequestBuilderPostRequestConfiguration | undefined) : Promise<DelegatedAdminRelationshipOperation | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DelegatedAdminRelationshipOperation, requestConfiguration?: OperationsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
