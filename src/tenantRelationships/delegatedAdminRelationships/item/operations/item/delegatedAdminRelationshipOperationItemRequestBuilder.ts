import {DelegatedAdminRelationshipOperation} from '../../../../../models/';
...
export class DelegatedAdminRelationshipOperationItemRequestBuilder {
     ...
     * @param delegatedAdminRelationshipOperationId key: id of delegatedAdminRelationshipOperation
     * @param pathParameters The raw url or the Url template parameters for the request.
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, delegatedAdminRelationshipOperationId?: string | undefined) {
