...
import { createDelegatedAdminRelationshipOperationCollectionResponseFromDiscriminatorValue, createDelegatedAdminRelationshipOperationFromDiscriminatorValue, deserializeIntoDelegatedAdminRelationshipOperation, serializeDelegatedAdminRelationshipOperation, type DelegatedAdminRelationshipOperation, type DelegatedAdminRelationshipOperationCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DelegatedAdminRelationshipOperationItemRequestBuilder } from './item/';
...
export class OperationsRequestBuilder extends BaseRequestBuilder<OperationsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new OperationsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<OperationsRequestBuilderGetQueryParameters> | undefined) : Promise<DelegatedAdminRelationshipOperationCollectionResponse | undefined> {
     ...
     */
    public post(body: DelegatedAdminRelationshipOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DelegatedAdminRelationshipOperation | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DelegatedAdminRelationshipOperation, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
