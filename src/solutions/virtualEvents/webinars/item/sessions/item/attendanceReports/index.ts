...
import { createMeetingAttendanceReportCollectionResponseFromDiscriminatorValue, createMeetingAttendanceReportFromDiscriminatorValue, deserializeIntoMeetingAttendanceReport, serializeMeetingAttendanceReport, type MeetingAttendanceReport, type MeetingAttendanceReportCollectionResponse } from '../../../../../../../models/';
 ...
 */
export class AttendanceReportsRequestBuilder extends BaseRequestBuilder<AttendanceReportsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/attendanceReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AttendanceReportsRequestBuilder(x, y));
    }
    /**
