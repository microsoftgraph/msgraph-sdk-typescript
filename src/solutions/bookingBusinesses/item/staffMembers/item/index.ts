...
import { createBookingStaffMemberBaseFromDiscriminatorValue, deserializeIntoBookingStaffMemberBase, serializeBookingStaffMemberBase, type BookingStaffMemberBase } from '../../../../../models/';
 ...
 */
export class BookingStaffMemberBaseItemRequestBuilder extends BaseRequestBuilder<BookingStaffMemberBaseItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/staffMembers/{bookingStaffMemberBase%2Did}{?%24select,%24expand}", (x, y) => new BookingStaffMemberBaseItemRequestBuilder(x, y));
    }
    /**
