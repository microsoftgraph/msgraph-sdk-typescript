...
import { createBookingCustomQuestionCollectionResponseFromDiscriminatorValue, createBookingCustomQuestionFromDiscriminatorValue, deserializeIntoBookingCustomQuestion, serializeBookingCustomQuestion, type BookingCustomQuestion, type BookingCustomQuestionCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { BookingCustomQuestionItemRequestBuilder } from './item/';
 ...
 */
export class CustomQuestionsRequestBuilder extends BaseRequestBuilder<CustomQuestionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/customQuestions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new CustomQuestionsRequestBuilder(x, y));
    }
    /**
