...
import { createBookingAppointmentCollectionResponseFromDiscriminatorValue, createBookingAppointmentFromDiscriminatorValue, deserializeIntoBookingAppointment, serializeBookingAppointment, type BookingAppointment, type BookingAppointmentCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { BookingAppointmentItemRequestBuilder } from './item/';
 ...
 */
export class AppointmentsRequestBuilder extends BaseRequestBuilder<AppointmentsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/appointments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AppointmentsRequestBuilder(x, y));
    }
    /**
