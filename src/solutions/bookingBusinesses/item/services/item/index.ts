...
import { createBookingServiceFromDiscriminatorValue, deserializeIntoBookingService, serializeBookingService, type BookingService } from '../../../../../models/';
 ...
 */
export class BookingServiceItemRequestBuilder extends BaseRequestBuilder<BookingServiceItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/services/{bookingService%2Did}{?%24select,%24expand}", (x, y) => new BookingServiceItemRequestBuilder(x, y));
    }
    /**
