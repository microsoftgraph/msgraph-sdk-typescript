...
/** Builds and executes requests for operations under /solutions/bookingBusinesses/{bookingBusiness-id}/microsoft.graph.unpublish  */
export class UnpublishRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness_id}/microsoft.graph.unpublish";
