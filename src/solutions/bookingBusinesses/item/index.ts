...
import { createBookingBusinessFromDiscriminatorValue, deserializeIntoBookingBusiness, serializeBookingBusiness, type BookingBusiness } from '../../../models/';
...
import { GetStaffAvailabilityRequestBuilder } from './getStaffAvailability/';
 ...
 */
export class BookingBusinessItemRequestBuilder extends BaseRequestBuilder<BookingBusinessItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}{?%24select,%24expand}", (x, y) => new BookingBusinessItemRequestBuilder(x, y));
    }
    /**
