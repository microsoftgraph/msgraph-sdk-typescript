...
export class BookingCurrenciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as BookingCurrenciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as BookingCurrenciesResponse).value = n.getCollectionOfObjectValues<BookingCurrency>(BookingCurrency); }],
        ]);
    };
    /**
