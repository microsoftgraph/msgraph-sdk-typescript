...
export interface GroupSettingsRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
...
export class GroupSettingsRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a groupSettingsRequestBuilder
     */
    public withUrl(rawUrl: string) : GroupSettingsRequestBuilder {
