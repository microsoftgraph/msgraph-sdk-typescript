...
export class CertificateBasedAuthConfigurationResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as CertificateBasedAuthConfigurationResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as CertificateBasedAuthConfigurationResponse).value = n.getCollectionOfObjectValues<CertificateBasedAuthConfiguration>(CertificateBasedAuthConfiguration); }],
        ]);
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<CertificateBasedAuthConfiguration>("value", this.value);
