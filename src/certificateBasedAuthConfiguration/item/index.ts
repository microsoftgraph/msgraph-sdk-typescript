...
import { createCertificateBasedAuthConfigurationFromDiscriminatorValue, deserializeIntoCertificateBasedAuthConfiguration, serializeCertificateBasedAuthConfiguration, type CertificateBasedAuthConfiguration } from '../../models/';
...
export class CertificateBasedAuthConfigurationItemRequestBuilder extends BaseRequestBuilder<CertificateBasedAuthConfigurationItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/certificateBasedAuthConfiguration/{certificateBasedAuthConfiguration%2Did}{?%24select,%24expand}", (x, y) => new CertificateBasedAuthConfigurationItemRequestBuilder(x, y));
    }
    /**
