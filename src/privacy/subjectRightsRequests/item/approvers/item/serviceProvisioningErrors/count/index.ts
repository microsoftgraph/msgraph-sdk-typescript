 ...
 */
export const CountRequestBuilderUriTemplate = "{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/approvers/{user%2Did}/serviceProvisioningErrors/$count{?%24search,%24filter}";
/* tslint:enable */
/* eslint-enable */
