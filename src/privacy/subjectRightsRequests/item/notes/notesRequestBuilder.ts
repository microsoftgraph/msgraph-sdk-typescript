...
export class NotesRequestBuilder {
    ...
    public get(requestConfiguration?: NotesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AuthoredNoteCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AuthoredNoteCollectionResponseImpl>(requestInfo, createAuthoredNoteCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to notes for privacy
     * @param body 
