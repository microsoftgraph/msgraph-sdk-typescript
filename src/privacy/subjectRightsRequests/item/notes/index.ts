...
import { createAuthoredNoteCollectionResponseFromDiscriminatorValue, createAuthoredNoteFromDiscriminatorValue, deserializeIntoAuthoredNote, serializeAuthoredNote, type AuthoredNote, type AuthoredNoteCollectionResponse } from '../../../../models/';
 ...
 */
export class NotesRequestBuilder extends BaseRequestBuilder<NotesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/notes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new NotesRequestBuilder(x, y));
    }
    /**
