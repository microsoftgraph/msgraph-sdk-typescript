...
export class GetFinalAttachmentRequestBuilder extends BaseRequestBuilder<GetFinalAttachmentRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/getFinalAttachment()", (x, y) => new GetFinalAttachmentRequestBuilder(x, y));
    }
    /**
