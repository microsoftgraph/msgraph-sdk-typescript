...
export class SubjectRightsRequestsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SubjectRightsRequestsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SubjectRightsRequestsResponse).value = n.getCollectionOfObjectValues<SubjectRightsRequest>(SubjectRightsRequest); }],
        ]);
    };
    /**
