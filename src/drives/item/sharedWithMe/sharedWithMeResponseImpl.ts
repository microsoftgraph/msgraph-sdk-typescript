...
export class SharedWithMeResponseImpl implements SharedWithMeResponse {
    ...
    public constructor(sharedWithMeResponseParameterValue?: SharedWithMeResponse | undefined) {
        this._additionalData = sharedWithMeResponseParameterValue?.additionalData ? sharedWithMeResponseParameterValue?.additionalData! : {};
        this._value = sharedWithMeResponseParameterValue?.value;
    };
    /**
