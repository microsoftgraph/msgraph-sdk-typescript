...
/** Builds and executes requests for operations under /drives/{drive-id}/bundles/{driveItem-id}/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/content";
