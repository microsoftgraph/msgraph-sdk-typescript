...
export class BundlesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as BundlesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as BundlesResponse).value = n.getCollectionOfObjectValues<DriveItem>(DriveItem); }],
        ]);
    };
    /**
