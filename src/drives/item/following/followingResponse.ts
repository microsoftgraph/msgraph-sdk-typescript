...
export class FollowingResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as FollowingResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as FollowingResponse).value = n.getCollectionOfObjectValues<DriveItem>(DriveItem); }],
        ]);
    };
    /**
