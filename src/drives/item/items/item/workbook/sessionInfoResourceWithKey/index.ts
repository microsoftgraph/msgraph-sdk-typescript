 ...
 */
export class SessionInfoResourceWithKeyRequestBuilder extends BaseRequestBuilder<SessionInfoResourceWithKeyRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, key?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/sessionInfoResource(key='{key}')", (x, y) => new SessionInfoResourceWithKeyRequestBuilder(x, y));
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<WorkbookSessionInfo | undefined> {
