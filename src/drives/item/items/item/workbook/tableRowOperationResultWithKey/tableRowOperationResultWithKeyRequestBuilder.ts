...
import { type TableRowOperationResultWithKeyRequestBuilderGetRequestConfiguration } from './tableRowOperationResultWithKeyRequestBuilderGetRequestConfiguration';
