...
import { createWorkbookTableRowFromDiscriminatorValue, type WorkbookTableRow } from '../../../../../../models/';
 ...
 */
export class TableRowOperationResultWithKeyRequestBuilder extends BaseRequestBuilder<TableRowOperationResultWithKeyRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, key?: string | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tableRowOperationResult(key='{key}')", (x, y) => new TableRowOperationResultWithKeyRequestBuilder(x, y));
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<WorkbookTableRow | undefined> {
