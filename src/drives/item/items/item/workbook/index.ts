...
import { createWorkbookFromDiscriminatorValue, deserializeIntoWorkbook, serializeWorkbook, type Workbook } from '../../../../../models/';
 ...
 */
export class WorkbookRequestBuilder extends BaseRequestBuilder<WorkbookRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook{?%24select,%24expand}", (x, y) => new WorkbookRequestBuilder(x, y));
    }
    /**
