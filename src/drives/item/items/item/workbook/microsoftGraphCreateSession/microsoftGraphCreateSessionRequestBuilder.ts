...
import {MicrosoftGraphCreateSessionRequestBuilderPostRequestConfiguration} from './microsoftGraphCreateSessionRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the createSession method.
 */
export class MicrosoftGraphCreateSessionRequestBuilder {
     ...
     */
    public post(body: CreateSessionPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphCreateSessionRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookSessionInfo | undefined> {
     ...
     */
    public toPostRequestInformation(body: CreateSessionPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphCreateSessionRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
