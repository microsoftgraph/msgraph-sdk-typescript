...
import { deserializeIntoApplyTopPercentFilterPostRequestBody, serializeApplyTopPercentFilterPostRequestBody, type ApplyTopPercentFilterPostRequestBody } from './applyTopPercentFilterPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface ApplyTopPercentFilterRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
