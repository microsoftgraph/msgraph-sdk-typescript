...
export class ApplyTopItemsFilterRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ApplyTopItemsFilterPostRequestBody, requestConfiguration?: ApplyTopItemsFilterRequestBuilderPostRequestConfiguration | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: ApplyTopItemsFilterPostRequestBody, requestConfiguration?: ApplyTopItemsFilterRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
