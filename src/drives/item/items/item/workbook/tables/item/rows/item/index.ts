...
export class WorkbookTableRowItemRequestBuilder extends BaseRequestBuilder<WorkbookTableRowItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/{workbookTableRow%2Did}{?%24select,%24expand}", (x, y) => new WorkbookTableRowItemRequestBuilder(x, y));
    }
    /**
