...
export class HeaderRowRangeRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/microsoft.graph.headerRowRange()";
     ...
     * @see {@link https://docs.microsoft.com/graph/api/table-headerrowrange?view=graph-rest-1.0|Find more info here}
     */
