...
import { deserializeIntoApplyCellColorFilterPostRequestBody, serializeApplyCellColorFilterPostRequestBody, type ApplyCellColorFilterPostRequestBody } from './applyCellColorFilterPostRequestBody';
...
export class ApplyCellColorFilterRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ApplyCellColorFilterPostRequestBody, requestConfiguration?: ApplyCellColorFilterRequestBuilderPostRequestConfiguration | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: ApplyCellColorFilterPostRequestBody, requestConfiguration?: ApplyCellColorFilterRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
