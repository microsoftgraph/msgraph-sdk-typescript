...
export class ApplyBottomPercentFilterRequestBuilder extends BaseRequestBuilder<ApplyBottomPercentFilterRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyBottomPercentFilter", (x, y) => new ApplyBottomPercentFilterRequestBuilder(x, y));
    }
    /**
