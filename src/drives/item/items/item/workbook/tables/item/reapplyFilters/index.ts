 ...
 */
export class ReapplyFiltersRequestBuilder extends BaseRequestBuilder<ReapplyFiltersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/reapplyFilters", (x, y) => new ReapplyFiltersRequestBuilder(x, y));
    }
    /**
