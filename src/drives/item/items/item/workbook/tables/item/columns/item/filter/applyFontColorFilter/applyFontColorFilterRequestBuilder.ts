...
export class ApplyFontColorFilterRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: ApplyFontColorFilterPostRequestBody | undefined, requestConfiguration?: ApplyFontColorFilterRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeApplyFontColorFilterPostRequestBody);
        return requestInfo;
    };
}
