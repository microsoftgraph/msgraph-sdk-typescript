...
export class WorkbookTableColumnItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: WorkbookTableColumnItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
