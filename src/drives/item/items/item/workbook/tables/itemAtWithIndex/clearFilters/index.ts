 ...
 */
export class ClearFiltersRequestBuilder extends BaseRequestBuilder<ClearFiltersRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/itemAt(index={index})/clearFilters", (x, y) => new ClearFiltersRequestBuilder(x, y));
    }
    /**
