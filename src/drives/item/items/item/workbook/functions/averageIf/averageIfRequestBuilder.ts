...
export class AverageIfRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AverageIfPostRequestBody | undefined, requestConfiguration?: AverageIfRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: AverageIfPostRequestBody | undefined, requestConfiguration?: AverageIfRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeAverageIfPostRequestBody);
        return requestInfo;
    };
}
