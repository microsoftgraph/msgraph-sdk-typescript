...
import { deserializeIntoFloor_MathPostRequestBody, serializeFloor_MathPostRequestBody, type Floor_MathPostRequestBody } from './floor_MathPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface Floor_MathRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
