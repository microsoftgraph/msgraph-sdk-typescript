 ...
 */
export class UnicodeRequestBuilder extends BaseRequestBuilder<UnicodeRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/unicode", (x, y) => new UnicodeRequestBuilder(x, y));
    }
    /**
