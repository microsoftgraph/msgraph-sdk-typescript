...
export class UnicodeRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: UnicodePostRequestBody | undefined, requestConfiguration?: UnicodeRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: UnicodePostRequestBody | undefined, requestConfiguration?: UnicodeRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeUnicodePostRequestBody);
        return requestInfo;
    };
}
