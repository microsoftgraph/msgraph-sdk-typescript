...
import {Oct2HexRequestBuilderPostRequestConfiguration} from './oct2HexRequestBuilderPostRequestConfiguration';
import {serializeOct2HexPostRequestBody} from './serializeOct2HexPostRequestBody';
...
export class Oct2HexRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Oct2HexPostRequestBody | undefined, requestConfiguration?: Oct2HexRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Oct2HexPostRequestBody | undefined, requestConfiguration?: Oct2HexRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeOct2HexPostRequestBody);
        return requestInfo;
    };
}
