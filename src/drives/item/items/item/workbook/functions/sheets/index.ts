 ...
 */
export class SheetsRequestBuilder extends BaseRequestBuilder<SheetsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/sheets", (x, y) => new SheetsRequestBuilder(x, y));
    }
    /**
