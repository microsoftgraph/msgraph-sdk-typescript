...
export class KurtRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: KurtPostRequestBody | undefined, requestConfiguration?: KurtRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: KurtPostRequestBody | undefined, requestConfiguration?: KurtRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeKurtPostRequestBody);
        return requestInfo;
    };
}
