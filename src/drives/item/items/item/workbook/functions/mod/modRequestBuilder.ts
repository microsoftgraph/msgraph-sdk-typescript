...
export class ModRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ModPostRequestBody | undefined, requestConfiguration?: ModRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
