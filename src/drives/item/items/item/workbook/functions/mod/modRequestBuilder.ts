...
export class ModRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ModPostRequestBody | undefined, requestConfiguration?: ModRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ModPostRequestBody | undefined, requestConfiguration?: ModRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeModPostRequestBody);
        return requestInfo;
    };
}
