...
export class EdateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: EdatePostRequestBody | undefined, requestConfiguration?: EdateRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
