...
export class EdateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: EdatePostRequestBody | undefined, requestConfiguration?: EdateRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: EdatePostRequestBody | undefined, requestConfiguration?: EdateRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeEdatePostRequestBody);
        return requestInfo;
    };
}
