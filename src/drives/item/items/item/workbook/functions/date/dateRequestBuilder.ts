...
export class DateRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DatePostRequestBody | undefined, requestConfiguration?: DateRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: DatePostRequestBody | undefined, requestConfiguration?: DateRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeDatePostRequestBody);
        return requestInfo;
    };
}
