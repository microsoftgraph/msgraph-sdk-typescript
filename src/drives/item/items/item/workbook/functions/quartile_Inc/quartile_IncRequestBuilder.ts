...
import { deserializeIntoQuartile_IncPostRequestBody, serializeQuartile_IncPostRequestBody, type Quartile_IncPostRequestBody } from './quartile_IncPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface Quartile_IncRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
