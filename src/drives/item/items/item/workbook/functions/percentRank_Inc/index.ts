 ...
 */
export class PercentRank_IncRequestBuilder extends BaseRequestBuilder<PercentRank_IncRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/percentRank_Inc", (x, y) => new PercentRank_IncRequestBuilder(x, y));
    }
    /**
