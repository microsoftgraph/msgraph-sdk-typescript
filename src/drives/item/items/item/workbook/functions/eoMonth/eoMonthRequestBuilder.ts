...
export class EoMonthRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: EoMonthPostRequestBody | undefined, requestConfiguration?: EoMonthRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: EoMonthPostRequestBody | undefined, requestConfiguration?: EoMonthRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeEoMonthPostRequestBody);
        return requestInfo;
    };
}
