...
export class StDevPARequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: StDevPAPostRequestBody | undefined, requestConfiguration?: StDevPARequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
