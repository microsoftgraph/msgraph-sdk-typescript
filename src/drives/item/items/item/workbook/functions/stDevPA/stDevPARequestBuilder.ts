...
export class StDevPARequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: StDevPAPostRequestBody | undefined, requestConfiguration?: StDevPARequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: StDevPAPostRequestBody | undefined, requestConfiguration?: StDevPARequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeStDevPAPostRequestBody);
        return requestInfo;
    };
}
