...
export class DcountARequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DcountAPostRequestBody | undefined, requestConfiguration?: DcountARequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: DcountAPostRequestBody | undefined, requestConfiguration?: DcountARequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeDcountAPostRequestBody);
        return requestInfo;
    };
}
