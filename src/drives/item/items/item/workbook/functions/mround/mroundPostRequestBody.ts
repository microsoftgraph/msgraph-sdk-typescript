...
export class MroundPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "multiple": n => { this.multiple = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
