...
export class Ceiling_PreciseRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Ceiling_PrecisePostRequestBody | undefined, requestConfiguration?: Ceiling_PreciseRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Ceiling_PrecisePostRequestBody | undefined, requestConfiguration?: Ceiling_PreciseRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCeiling_PrecisePostRequestBody);
        return requestInfo;
    };
}
