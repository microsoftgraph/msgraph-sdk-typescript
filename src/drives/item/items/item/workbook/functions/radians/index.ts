 ...
 */
export class RadiansRequestBuilder extends BaseRequestBuilder<RadiansRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/radians", (x, y) => new RadiansRequestBuilder(x, y));
    }
    /**
