...
export class CountRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CountPostRequestBody | undefined, requestConfiguration?: CountRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CountPostRequestBody | undefined, requestConfiguration?: CountRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCountPostRequestBody);
        return requestInfo;
    };
}
