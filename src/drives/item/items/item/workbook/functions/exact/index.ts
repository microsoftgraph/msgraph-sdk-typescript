 ...
 */
export class ExactRequestBuilder extends BaseRequestBuilder<ExactRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/exact", (x, y) => new ExactRequestBuilder(x, y));
    }
    /**
     * Invoke action exact
