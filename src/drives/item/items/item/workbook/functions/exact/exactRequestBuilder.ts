...
import { deserializeIntoExactPostRequestBody, serializeExactPostRequestBody, type ExactPostRequestBody } from './exactPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface ExactRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
