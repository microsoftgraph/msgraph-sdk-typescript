...
export class HlookupPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "rowIndexNum": n => { this.rowIndexNum = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
