...
export class HlookupRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: HlookupPostRequestBody | undefined, requestConfiguration?: HlookupRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: HlookupPostRequestBody | undefined, requestConfiguration?: HlookupRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeHlookupPostRequestBody);
        return requestInfo;
    };
}
