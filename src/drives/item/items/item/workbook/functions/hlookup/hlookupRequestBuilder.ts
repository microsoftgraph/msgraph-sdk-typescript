...
export class HlookupRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: HlookupPostRequestBody | undefined, requestConfiguration?: HlookupRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
