...
export class BitrshiftRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: BitrshiftPostRequestBody | undefined, requestConfiguration?: BitrshiftRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: BitrshiftPostRequestBody | undefined, requestConfiguration?: BitrshiftRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeBitrshiftPostRequestBody);
        return requestInfo;
    };
}
