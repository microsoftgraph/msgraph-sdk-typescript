 ...
 */
export class CumIPmtRequestBuilder extends BaseRequestBuilder<CumIPmtRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/cumIPmt", (x, y) => new CumIPmtRequestBuilder(x, y));
    }
    /**
