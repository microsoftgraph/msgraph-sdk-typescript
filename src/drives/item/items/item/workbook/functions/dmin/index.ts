 ...
 */
export class DminRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dmin");
    };
    /**
     * Invoke action dmin
     ...
     * @returns a dminRequestBuilder
     */
    public withUrl(rawUrl: string) : DminRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new DminRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
