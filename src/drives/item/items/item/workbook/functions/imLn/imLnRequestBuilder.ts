...
export class ImLnRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImLnPostRequestBody | undefined, requestConfiguration?: ImLnRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: ImLnPostRequestBody | undefined, requestConfiguration?: ImLnRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeImLnPostRequestBody);
        return requestInfo;
    };
}
