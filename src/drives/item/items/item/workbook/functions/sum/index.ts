 ...
 */
export class SumRequestBuilder extends BaseRequestBuilder<SumRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/sum", (x, y) => new SumRequestBuilder(x, y));
    }
    /**
     * Invoke action sum
