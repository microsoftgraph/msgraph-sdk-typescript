 ...
 */
export class CosRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/cos");
    };
    /**
     * Invoke action cos
     ...
     * @returns a cosRequestBuilder
     */
    public withUrl(rawUrl: string) : CosRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new CosRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
