...
export class SinhRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SinhPostRequestBody, requestConfiguration?: SinhRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: SinhPostRequestBody, requestConfiguration?: SinhRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
