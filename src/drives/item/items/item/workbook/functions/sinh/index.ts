 ...
 */
export class SinhRequestBuilder extends BaseRequestBuilder<SinhRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/sinh", (x, y) => new SinhRequestBuilder(x, y));
    }
    /**
     * Invoke action sinh
