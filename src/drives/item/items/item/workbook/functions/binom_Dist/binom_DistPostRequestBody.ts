...
export function serializeBinom_DistPostRequestBody(writer: SerializationWriter, binom_DistPostRequestBody: Binom_DistPostRequestBody | undefined = {} as Binom_DistPostRequestBody) : void {
        writer.writeObjectValue<Json>("cumulative", binom_DistPostRequestBody.cumulative, );
        writer.writeObjectValue<Json>("numberS", binom_DistPostRequestBody.numberS, );
        writer.writeObjectValue<Json>("probabilityS", binom_DistPostRequestBody.probabilityS, );
        writer.writeObjectValue<Json>("trials", binom_DistPostRequestBody.trials, );
