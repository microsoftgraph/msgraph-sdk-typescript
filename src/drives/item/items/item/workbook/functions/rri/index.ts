 ...
 */
export class RriRequestBuilder extends BaseRequestBuilder<RriRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/rri", (x, y) => new RriRequestBuilder(x, y));
    }
    /**
     * Invoke action rri
