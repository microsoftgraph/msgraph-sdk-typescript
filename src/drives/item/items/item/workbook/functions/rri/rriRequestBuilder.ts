...
export class RriRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RriPostRequestBody | undefined, requestConfiguration?: RriRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: RriPostRequestBody | undefined, requestConfiguration?: RriRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeRriPostRequestBody);
        return requestInfo;
    };
}
