...
export class CombinRequestBuilder {
     ...
     */
    public post(body: CombinPostRequestBody | undefined, requestConfiguration?: CombinRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CombinPostRequestBody | undefined, requestConfiguration?: CombinRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
