 ...
 */
export class SqrtPiRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/sqrtPi");
    };
    /**
     ...
     * @returns a sqrtPiRequestBuilder
     */
    public withUrl(rawUrl: string) : SqrtPiRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new SqrtPiRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
