 ...
 */
export class WorkDay_IntlRequestBuilder {
     ...
     */
    public post(body: WorkDay_IntlPostRequestBody | undefined, requestConfiguration?: WorkDay_IntlRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
