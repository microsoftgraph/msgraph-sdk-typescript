...
export class RightRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RightPostRequestBody | undefined, requestConfiguration?: RightRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
