...
export class RightRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RightPostRequestBody | undefined, requestConfiguration?: RightRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: RightPostRequestBody | undefined, requestConfiguration?: RightRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeRightPostRequestBody);
        return requestInfo;
    };
}
