...
export class MidRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: MidPostRequestBody | undefined, requestConfiguration?: MidRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: MidPostRequestBody | undefined, requestConfiguration?: MidRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeMidPostRequestBody);
        return requestInfo;
    };
}
