...
export class MidRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: MidPostRequestBody | undefined, requestConfiguration?: MidRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
