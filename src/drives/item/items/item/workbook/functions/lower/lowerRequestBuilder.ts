...
export class LowerRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: LowerPostRequestBody | undefined, requestConfiguration?: LowerRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: LowerPostRequestBody | undefined, requestConfiguration?: LowerRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeLowerPostRequestBody);
        return requestInfo;
    };
}
