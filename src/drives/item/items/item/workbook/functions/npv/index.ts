 ...
 */
export class NpvRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/npv");
    };
    /**
     * Invoke action npv
     ...
     * @returns a npvRequestBuilder
     */
    public withUrl(rawUrl: string) : NpvRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new NpvRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
