...
import { deserializeIntoFvschedulePostRequestBody, serializeFvschedulePostRequestBody, type FvschedulePostRequestBody } from './fvschedulePostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface FvscheduleRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
