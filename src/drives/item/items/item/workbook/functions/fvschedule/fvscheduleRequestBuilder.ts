...
export class FvscheduleRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: FvschedulePostRequestBody | undefined, requestConfiguration?: FvscheduleRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
