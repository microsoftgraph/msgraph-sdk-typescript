...
export class DstDevPRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DstDevPPostRequestBody | undefined, requestConfiguration?: DstDevPRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: DstDevPPostRequestBody | undefined, requestConfiguration?: DstDevPRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeDstDevPPostRequestBody);
        return requestInfo;
    };
}
