...
export class UpperRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: UpperPostRequestBody | undefined, requestConfiguration?: UpperRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: UpperPostRequestBody | undefined, requestConfiguration?: UpperRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeUpperPostRequestBody);
        return requestInfo;
    };
}
