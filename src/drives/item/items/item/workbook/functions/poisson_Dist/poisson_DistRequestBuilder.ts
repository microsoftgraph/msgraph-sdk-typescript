...
import { deserializeIntoPoisson_DistPostRequestBody, serializePoisson_DistPostRequestBody, type Poisson_DistPostRequestBody } from './poisson_DistPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface Poisson_DistRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
 ...
 */
export class Poisson_DistRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/poisson_Dist");
    };
    /**
     ...
     * @returns a poisson_DistRequestBuilder
     */
    public withUrl(rawUrl: string) : Poisson_DistRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new Poisson_DistRequestBuilder(rawUrl, this.requestAdapter);
    };
}
