...
export class AndRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AndPostRequestBody | undefined, requestConfiguration?: AndRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: AndPostRequestBody | undefined, requestConfiguration?: AndRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeAndPostRequestBody);
        return requestInfo;
    };
}
