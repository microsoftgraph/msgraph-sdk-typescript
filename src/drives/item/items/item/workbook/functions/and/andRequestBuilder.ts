...
export class AndRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AndPostRequestBody | undefined, requestConfiguration?: AndRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
