 ...
 */
export class AtanRequestBuilder extends BaseRequestBuilder<AtanRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/atan", (x, y) => new AtanRequestBuilder(x, y));
    }
    /**
     * Invoke action atan
