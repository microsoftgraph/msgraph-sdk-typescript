...
export class ImPowerRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImPowerPostRequestBody | undefined, requestConfiguration?: ImPowerRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ImPowerPostRequestBody | undefined, requestConfiguration?: ImPowerRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeImPowerPostRequestBody);
        return requestInfo;
    };
}
