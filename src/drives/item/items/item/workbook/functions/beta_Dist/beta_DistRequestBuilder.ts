...
import { deserializeIntoBeta_DistPostRequestBody, serializeBeta_DistPostRequestBody, type Beta_DistPostRequestBody } from './beta_DistPostRequestBody';
...
export class Beta_DistRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Beta_DistPostRequestBody, requestConfiguration?: Beta_DistRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Beta_DistPostRequestBody, requestConfiguration?: Beta_DistRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a beta_DistRequestBuilder
     */
    public withUrl(rawUrl: string) : Beta_DistRequestBuilder {
