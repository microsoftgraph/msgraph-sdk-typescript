...
export class CotRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CotPostRequestBody | undefined, requestConfiguration?: CotRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CotPostRequestBody | undefined, requestConfiguration?: CotRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCotPostRequestBody);
        return requestInfo;
    };
}
