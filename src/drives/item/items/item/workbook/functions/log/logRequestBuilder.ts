...
export class LogRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: LogPostRequestBody | undefined, requestConfiguration?: LogRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: LogPostRequestBody | undefined, requestConfiguration?: LogRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeLogPostRequestBody);
        return requestInfo;
    };
}
