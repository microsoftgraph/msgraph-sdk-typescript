...
export class F_Dist_RTRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.f_Dist_RT";
     ...
     */
    public toPostRequestInformation(body: F_Dist_RTPostRequestBody | undefined, requestConfiguration?: F_Dist_RTRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
