...
export class MonthRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: MonthPostRequestBody | undefined, requestConfiguration?: MonthRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
