...
export class MonthRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: MonthPostRequestBody | undefined, requestConfiguration?: MonthRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: MonthPostRequestBody | undefined, requestConfiguration?: MonthRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeMonthPostRequestBody);
        return requestInfo;
    };
}
