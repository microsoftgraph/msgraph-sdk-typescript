 ...
 */
export class HypGeom_DistRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.hypGeom_Dist";
     ...
     */
    public post(body: HypGeom_DistPostRequestBody | undefined, requestConfiguration?: HypGeom_DistRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: HypGeom_DistPostRequestBody | undefined, requestConfiguration?: HypGeom_DistRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
