 ...
 */
export class OddFPriceRequestBuilder extends BaseRequestBuilder<OddFPriceRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/oddFPrice", (x, y) => new OddFPriceRequestBuilder(x, y));
    }
    /**
