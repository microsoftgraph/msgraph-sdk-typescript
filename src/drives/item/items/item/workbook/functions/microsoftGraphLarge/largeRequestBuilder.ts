...
export class LargeRequestBuilder {
     ...
     */
    public post(body: LargePostRequestBody | undefined, requestConfiguration?: LargeRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
