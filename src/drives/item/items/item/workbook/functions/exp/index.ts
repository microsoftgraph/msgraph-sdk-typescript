 ...
 */
export class ExpRequestBuilder extends BaseRequestBuilder<ExpRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/exp", (x, y) => new ExpRequestBuilder(x, y));
    }
    /**
     * Invoke action exp
