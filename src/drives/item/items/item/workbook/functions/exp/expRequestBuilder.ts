...
export class ExpRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ExpPostRequestBody | undefined, requestConfiguration?: ExpRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ExpPostRequestBody | undefined, requestConfiguration?: ExpRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeExpPostRequestBody);
        return requestInfo;
    };
}
