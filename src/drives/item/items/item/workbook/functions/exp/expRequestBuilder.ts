...
export class ExpRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ExpPostRequestBody | undefined, requestConfiguration?: ExpRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
