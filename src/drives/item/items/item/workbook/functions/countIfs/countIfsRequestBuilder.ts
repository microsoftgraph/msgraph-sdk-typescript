...
export class CountIfsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CountIfsPostRequestBody | undefined, requestConfiguration?: CountIfsRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
