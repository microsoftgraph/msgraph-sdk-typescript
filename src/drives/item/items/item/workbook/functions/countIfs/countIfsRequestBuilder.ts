...
export class CountIfsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CountIfsPostRequestBody | undefined, requestConfiguration?: CountIfsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CountIfsPostRequestBody | undefined, requestConfiguration?: CountIfsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCountIfsPostRequestBody);
        return requestInfo;
    };
}
