...
export function serializeAcoshPostRequestBody(acoshPostRequestBody: AcoshPostRequestBody | undefined = {} as AcoshPostRequestBody, writer: SerializationWriter) : void {
