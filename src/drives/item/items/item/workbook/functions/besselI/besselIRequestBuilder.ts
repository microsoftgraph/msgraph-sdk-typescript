...
export class BesselIRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: BesselIPostRequestBody | undefined, requestConfiguration?: BesselIRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: BesselIPostRequestBody | undefined, requestConfiguration?: BesselIRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeBesselIPostRequestBody);
        return requestInfo;
    };
}
