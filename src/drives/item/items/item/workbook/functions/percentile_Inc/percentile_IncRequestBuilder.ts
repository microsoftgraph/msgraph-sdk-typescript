...
export class Percentile_IncRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Percentile_IncPostRequestBody | undefined, requestConfiguration?: Percentile_IncRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Percentile_IncPostRequestBody | undefined, requestConfiguration?: Percentile_IncRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializePercentile_IncPostRequestBody);
        return requestInfo;
    };
}
