...
export class Ceiling_MathRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Ceiling_MathPostRequestBody | undefined, requestConfiguration?: Ceiling_MathRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: Ceiling_MathPostRequestBody | undefined, requestConfiguration?: Ceiling_MathRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCeiling_MathPostRequestBody);
        return requestInfo;
    };
}
