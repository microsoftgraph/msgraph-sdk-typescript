 ...
 */
export class Confidence_TRequestBuilder extends BaseRequestBuilder<Confidence_TRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/confidence_T", (x, y) => new Confidence_TRequestBuilder(x, y));
    }
    /**
