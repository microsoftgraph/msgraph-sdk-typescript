 ...
 */
export class F_InvRequestBuilder extends BaseRequestBuilder<F_InvRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/f_Inv", (x, y) => new F_InvRequestBuilder(x, y));
    }
    /**
     * Invoke action f_Inv
