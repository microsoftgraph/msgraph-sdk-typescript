...
export function serializeF_InvPostRequestBody(f_InvPostRequestBody: F_InvPostRequestBody | undefined = {} as F_InvPostRequestBody, writer: SerializationWriter) : void {
