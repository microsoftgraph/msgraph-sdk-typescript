...
export class F_InvRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: F_InvPostRequestBody | undefined, requestConfiguration?: F_InvRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: F_InvPostRequestBody | undefined, requestConfiguration?: F_InvRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeF_InvPostRequestBody);
        return requestInfo;
    };
}
