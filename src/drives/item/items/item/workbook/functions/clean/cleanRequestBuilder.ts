...
export class CleanRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CleanPostRequestBody | undefined, requestConfiguration?: CleanRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
