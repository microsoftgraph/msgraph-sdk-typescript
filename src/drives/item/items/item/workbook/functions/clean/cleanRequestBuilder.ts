...
export class CleanRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CleanPostRequestBody | undefined, requestConfiguration?: CleanRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CleanPostRequestBody | undefined, requestConfiguration?: CleanRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCleanPostRequestBody);
        return requestInfo;
    };
}
