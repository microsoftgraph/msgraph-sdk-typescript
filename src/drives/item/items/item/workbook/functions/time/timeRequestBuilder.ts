...
export class TimeRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: TimePostRequestBody | undefined, requestConfiguration?: TimeRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: TimePostRequestBody | undefined, requestConfiguration?: TimeRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeTimePostRequestBody);
        return requestInfo;
    };
}
