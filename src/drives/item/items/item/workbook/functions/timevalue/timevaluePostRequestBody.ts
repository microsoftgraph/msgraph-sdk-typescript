...
export class TimevaluePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "timeText": n => { this.timeText = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
        };
    };
    /**
