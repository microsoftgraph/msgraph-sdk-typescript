 ...
 */
export class TimevalueRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/timevalue");
    };
    /**
     ...
     * @returns a timevalueRequestBuilder
     */
    public withUrl(rawUrl: string) : TimevalueRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new TimevalueRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
