...
export class CothRequestBuilder {
     ...
     */
    public post(body: CothPostRequestBody | undefined, requestConfiguration?: CothRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CothPostRequestBody | undefined, requestConfiguration?: CothRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
