...
export class CombinRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CombinPostRequestBody | undefined, requestConfiguration?: CombinRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: CombinPostRequestBody | undefined, requestConfiguration?: CombinRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCombinPostRequestBody);
        return requestInfo;
    };
}
