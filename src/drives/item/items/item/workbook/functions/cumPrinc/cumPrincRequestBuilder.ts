...
export class CumPrincRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CumPrincPostRequestBody | undefined, requestConfiguration?: CumPrincRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: CumPrincPostRequestBody | undefined, requestConfiguration?: CumPrincRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCumPrincPostRequestBody);
        return requestInfo;
    };
}
