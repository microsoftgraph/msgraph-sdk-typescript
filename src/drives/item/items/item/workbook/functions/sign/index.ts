 ...
 */
export class SignRequestBuilder extends BaseRequestBuilder<SignRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/sign", (x, y) => new SignRequestBuilder(x, y));
    }
    /**
     * Invoke action sign
