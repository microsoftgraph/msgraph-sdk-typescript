...
export class Norm_S_InvRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Norm_S_InvPostRequestBody | undefined, requestConfiguration?: Norm_S_InvRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
