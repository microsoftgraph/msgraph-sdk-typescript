...
export class Bin2DecRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Bin2DecPostRequestBody | undefined, requestConfiguration?: Bin2DecRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
