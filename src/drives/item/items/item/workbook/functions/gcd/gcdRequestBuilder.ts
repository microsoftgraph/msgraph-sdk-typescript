...
export class GcdRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: GcdPostRequestBody | undefined, requestConfiguration?: GcdRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeGcdPostRequestBody);
        return requestInfo;
    };
}
