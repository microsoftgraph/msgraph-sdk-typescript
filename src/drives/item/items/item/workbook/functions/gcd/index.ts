 ...
 */
export class GcdRequestBuilder extends BaseRequestBuilder<GcdRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/gcd", (x, y) => new GcdRequestBuilder(x, y));
    }
    /**
     * Invoke action gcd
