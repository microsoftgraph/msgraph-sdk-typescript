...
import { type OddLYieldRequestBuilderPostRequestConfiguration } from './oddLYieldRequestBuilderPostRequestConfiguration';
...
export class OddLYieldRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: OddLYieldPostRequestBody, requestConfiguration?: OddLYieldRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: OddLYieldPostRequestBody, requestConfiguration?: OddLYieldRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
