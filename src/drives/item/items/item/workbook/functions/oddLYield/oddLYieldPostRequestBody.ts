...
export class OddLYieldPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "lastInterest": n => { this.lastInterest = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
