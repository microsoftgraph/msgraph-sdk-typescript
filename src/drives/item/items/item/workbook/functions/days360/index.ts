 ...
 */
export class Days360RequestBuilder extends BaseRequestBuilder<Days360RequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/days360", (x, y) => new Days360RequestBuilder(x, y));
    }
    /**
