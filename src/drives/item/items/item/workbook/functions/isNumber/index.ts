 ...
 */
export class IsNumberRequestBuilder extends BaseRequestBuilder<IsNumberRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/isNumber", (x, y) => new IsNumberRequestBuilder(x, y));
    }
    /**
