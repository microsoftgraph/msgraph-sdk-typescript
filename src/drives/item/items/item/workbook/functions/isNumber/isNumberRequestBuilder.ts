...
import { deserializeIntoIsNumberPostRequestBody, serializeIsNumberPostRequestBody, type IsNumberPostRequestBody } from './isNumberPostRequestBody';
...
export class IsNumberRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsNumberPostRequestBody, requestConfiguration?: IsNumberRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: IsNumberPostRequestBody, requestConfiguration?: IsNumberRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
