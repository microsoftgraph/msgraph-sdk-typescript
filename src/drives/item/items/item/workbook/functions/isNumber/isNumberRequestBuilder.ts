...
export class IsNumberRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsNumberPostRequestBody | undefined, requestConfiguration?: IsNumberRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
