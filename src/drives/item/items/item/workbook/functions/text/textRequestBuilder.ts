...
import { deserializeIntoTextPostRequestBody, serializeTextPostRequestBody, type TextPostRequestBody } from './textPostRequestBody';
...
export class TextRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: TextPostRequestBody, requestConfiguration?: TextRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: TextPostRequestBody, requestConfiguration?: TextRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
