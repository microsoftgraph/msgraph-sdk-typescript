 ...
 */
export class SqrtRequestBuilder extends BaseRequestBuilder<SqrtRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/sqrt", (x, y) => new SqrtRequestBuilder(x, y));
    }
    /**
     * Invoke action sqrt
