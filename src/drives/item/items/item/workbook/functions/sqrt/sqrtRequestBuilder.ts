...
export class SqrtRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SqrtPostRequestBody | undefined, requestConfiguration?: SqrtRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: SqrtPostRequestBody | undefined, requestConfiguration?: SqrtRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeSqrtPostRequestBody);
        return requestInfo;
    };
}
