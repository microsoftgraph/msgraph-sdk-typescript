...
export class ImSinhRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImSinhPostRequestBody | undefined, requestConfiguration?: ImSinhRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ImSinhPostRequestBody | undefined, requestConfiguration?: ImSinhRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeImSinhPostRequestBody);
        return requestInfo;
    };
}
