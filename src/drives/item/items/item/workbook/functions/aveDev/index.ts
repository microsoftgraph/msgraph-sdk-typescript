 ...
 */
export class AveDevRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/aveDev");
    };
    /**
     ...
     * @returns a aveDevRequestBuilder
     */
    public withUrl(rawUrl: string) : AveDevRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new AveDevRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
