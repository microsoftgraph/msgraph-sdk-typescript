...
import { deserializeIntoEcma_CeilingPostRequestBody, serializeEcma_CeilingPostRequestBody, type Ecma_CeilingPostRequestBody } from './ecma_CeilingPostRequestBody';
