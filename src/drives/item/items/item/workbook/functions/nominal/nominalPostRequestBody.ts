...
export class NominalPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "effectRate": n => { this.effectRate = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
