...
export class DollarRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DollarPostRequestBody | undefined, requestConfiguration?: DollarRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: DollarPostRequestBody | undefined, requestConfiguration?: DollarRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeDollarPostRequestBody);
        return requestInfo;
    };
}
