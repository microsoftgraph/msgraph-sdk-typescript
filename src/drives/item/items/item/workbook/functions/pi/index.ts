 ...
 */
export class PiRequestBuilder extends BaseRequestBuilder<PiRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/pi", (x, y) => new PiRequestBuilder(x, y));
    }
    /**
     * Invoke action pi
