 ...
 */
export class IsTextRequestBuilder extends BaseRequestBuilder<IsTextRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/isText", (x, y) => new IsTextRequestBuilder(x, y));
    }
    /**
