...
export class IsTextRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsTextPostRequestBody | undefined, requestConfiguration?: IsTextRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
