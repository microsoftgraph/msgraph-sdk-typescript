...
export class IsTextRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsTextPostRequestBody | undefined, requestConfiguration?: IsTextRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: IsTextPostRequestBody | undefined, requestConfiguration?: IsTextRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeIsTextPostRequestBody);
        return requestInfo;
    };
}
