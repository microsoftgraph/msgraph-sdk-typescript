 ...
 */
export class ImAbsRequestBuilder extends BaseRequestBuilder<ImAbsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/imAbs", (x, y) => new ImAbsRequestBuilder(x, y));
    }
    /**
     * Invoke action imAbs
