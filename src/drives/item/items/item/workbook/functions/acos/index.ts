 ...
 */
export class AcosRequestBuilder extends BaseRequestBuilder<AcosRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/acos", (x, y) => new AcosRequestBuilder(x, y));
    }
    /**
     * Invoke action acos
