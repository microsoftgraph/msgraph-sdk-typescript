...
export class T_InvRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: T_InvPostRequestBody | undefined, requestConfiguration?: T_InvRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: T_InvPostRequestBody | undefined, requestConfiguration?: T_InvRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
