...
export class IsLogicalRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsLogicalPostRequestBody | undefined, requestConfiguration?: IsLogicalRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: IsLogicalPostRequestBody | undefined, requestConfiguration?: IsLogicalRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeIsLogicalPostRequestBody);
        return requestInfo;
    };
}
