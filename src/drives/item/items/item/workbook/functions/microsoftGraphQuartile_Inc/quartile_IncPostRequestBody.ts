...
export class Quartile_IncPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "quart": n => { this.quart = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
        };
    };
    /**
