...
export class ArabicRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ArabicPostRequestBody | undefined, requestConfiguration?: ArabicRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ArabicPostRequestBody | undefined, requestConfiguration?: ArabicRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeArabicPostRequestBody);
        return requestInfo;
    };
}
