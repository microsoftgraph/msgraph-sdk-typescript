...
export class ArabicRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ArabicPostRequestBody | undefined, requestConfiguration?: ArabicRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
