 ...
 */
export class AtanhRequestBuilder extends BaseRequestBuilder<AtanhRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/atanh", (x, y) => new AtanhRequestBuilder(x, y));
    }
    /**
     * Invoke action atanh
