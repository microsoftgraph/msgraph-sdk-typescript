...
export class BitxorRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: BitxorPostRequestBody | undefined, requestConfiguration?: BitxorRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
