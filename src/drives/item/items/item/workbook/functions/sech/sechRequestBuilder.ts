...
export class SechRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SechPostRequestBody | undefined, requestConfiguration?: SechRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: SechPostRequestBody | undefined, requestConfiguration?: SechRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeSechPostRequestBody);
        return requestInfo;
    };
}
