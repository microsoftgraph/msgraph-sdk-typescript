...
export class ImLog10RequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImLog10PostRequestBody | undefined, requestConfiguration?: ImLog10RequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ImLog10PostRequestBody | undefined, requestConfiguration?: ImLog10RequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeImLog10PostRequestBody);
        return requestInfo;
    };
}
