...
export class ImLog10RequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImLog10PostRequestBody | undefined, requestConfiguration?: ImLog10RequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
