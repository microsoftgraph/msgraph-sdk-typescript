...
export class IsEvenRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsEvenPostRequestBody | undefined, requestConfiguration?: IsEvenRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: IsEvenPostRequestBody | undefined, requestConfiguration?: IsEvenRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeIsEvenPostRequestBody);
        return requestInfo;
    };
}
