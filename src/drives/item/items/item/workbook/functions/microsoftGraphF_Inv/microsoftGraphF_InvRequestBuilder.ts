...
import {MicrosoftGraphF_InvRequestBuilderPostRequestConfiguration} from './microsoftGraphF_InvRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the f_Inv method.
 */
export class MicrosoftGraphF_InvRequestBuilder {
     ...
     */
    public post(body: F_InvPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphF_InvRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: F_InvPostRequestBody | undefined, requestConfiguration?: MicrosoftGraphF_InvRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
