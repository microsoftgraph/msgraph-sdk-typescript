...
export class CoupNumRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CoupNumPostRequestBody | undefined, requestConfiguration?: CoupNumRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
