...
export class CoupNumRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CoupNumPostRequestBody | undefined, requestConfiguration?: CoupNumRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CoupNumPostRequestBody | undefined, requestConfiguration?: CoupNumRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCoupNumPostRequestBody);
        return requestInfo;
    };
}
