...
import { type ImSumRequestBuilderPostRequestConfiguration } from './imSumRequestBuilderPostRequestConfiguration';
...
export class ImSumRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImSumPostRequestBody, requestConfiguration?: ImSumRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ImSumPostRequestBody, requestConfiguration?: ImSumRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
