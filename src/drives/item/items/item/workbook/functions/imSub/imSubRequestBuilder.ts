...
import {ImSubPostRequestBody} from './imSubPostRequestBody';
...
export class ImSubRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImSubPostRequestBody | undefined, requestConfiguration?: ImSubRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ImSubPostRequestBody | undefined, requestConfiguration?: ImSubRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeImSubPostRequestBody);
        return requestInfo;
    };
}
