...
export function serializeImSubPostRequestBody(imSubPostRequestBody: ImSubPostRequestBody | undefined = {} as ImSubPostRequestBody, writer: SerializationWriter) : void {
