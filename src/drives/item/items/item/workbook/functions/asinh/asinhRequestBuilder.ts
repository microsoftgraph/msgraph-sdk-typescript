...
export class AsinhRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AsinhPostRequestBody | undefined, requestConfiguration?: AsinhRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: AsinhPostRequestBody | undefined, requestConfiguration?: AsinhRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeAsinhPostRequestBody);
        return requestInfo;
    };
}
