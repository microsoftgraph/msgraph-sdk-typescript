...
export class CoupDayBsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CoupDayBsPostRequestBody | undefined, requestConfiguration?: CoupDayBsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CoupDayBsPostRequestBody | undefined, requestConfiguration?: CoupDayBsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCoupDayBsPostRequestBody);
        return requestInfo;
    };
}
