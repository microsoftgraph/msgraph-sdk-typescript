...
export class CoupDayBsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CoupDayBsPostRequestBody | undefined, requestConfiguration?: CoupDayBsRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
