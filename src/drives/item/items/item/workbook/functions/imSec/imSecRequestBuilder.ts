...
export class ImSecRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImSecPostRequestBody | undefined, requestConfiguration?: ImSecRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ImSecPostRequestBody | undefined, requestConfiguration?: ImSecRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeImSecPostRequestBody);
        return requestInfo;
    };
}
