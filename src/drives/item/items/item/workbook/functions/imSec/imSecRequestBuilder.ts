...
export class ImSecRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImSecPostRequestBody | undefined, requestConfiguration?: ImSecRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
