...
export class ReceivedPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "investment": n => { this.investment = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
