 ...
 */
export class GeStepRequestBuilder extends BaseRequestBuilder<GeStepRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/geStep", (x, y) => new GeStepRequestBuilder(x, y));
    }
    /**
