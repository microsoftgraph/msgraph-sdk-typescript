...
export class ProperRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ProperPostRequestBody | undefined, requestConfiguration?: ProperRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ProperPostRequestBody | undefined, requestConfiguration?: ProperRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeProperPostRequestBody);
        return requestInfo;
    };
}
