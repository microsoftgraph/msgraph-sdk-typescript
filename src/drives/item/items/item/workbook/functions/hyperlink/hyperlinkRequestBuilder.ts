...
export class HyperlinkRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: HyperlinkPostRequestBody | undefined, requestConfiguration?: HyperlinkRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: HyperlinkPostRequestBody | undefined, requestConfiguration?: HyperlinkRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeHyperlinkPostRequestBody);
        return requestInfo;
    };
}
