...
import { type DeltaRequestBuilderPostRequestConfiguration } from './deltaRequestBuilderPostRequestConfiguration';
import { deserializeIntoDeltaPostRequestBody } from './deserializeIntoDeltaPostRequestBody';
import { serializeDeltaPostRequestBody } from './serializeDeltaPostRequestBody';
...
export class DeltaRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DeltaPostRequestBody, requestConfiguration?: DeltaRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: DeltaPostRequestBody, requestConfiguration?: DeltaRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
