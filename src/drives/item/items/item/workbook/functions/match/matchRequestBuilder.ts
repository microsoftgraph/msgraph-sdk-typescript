...
import { type MatchRequestBuilderPostRequestConfiguration } from './matchRequestBuilderPostRequestConfiguration';
...
export class MatchRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: MatchPostRequestBody, requestConfiguration?: MatchRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: MatchPostRequestBody, requestConfiguration?: MatchRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
