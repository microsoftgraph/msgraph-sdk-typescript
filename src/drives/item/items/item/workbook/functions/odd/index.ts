 ...
 */
export class OddRequestBuilder extends BaseRequestBuilder<OddRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/odd", (x, y) => new OddRequestBuilder(x, y));
    }
    /**
     * Invoke action odd
