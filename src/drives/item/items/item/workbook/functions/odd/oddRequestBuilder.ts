...
export class OddRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: OddPostRequestBody | undefined, requestConfiguration?: OddRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: OddPostRequestBody | undefined, requestConfiguration?: OddRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeOddPostRequestBody);
        return requestInfo;
    };
}
