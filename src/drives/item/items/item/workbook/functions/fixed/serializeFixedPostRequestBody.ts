...
export function serializeFixedPostRequestBody(fixedPostRequestBody: FixedPostRequestBody | undefined = {} as FixedPostRequestBody, writer: SerializationWriter) : void {
