...
export class Binom_InvRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Binom_InvPostRequestBody | undefined, requestConfiguration?: Binom_InvRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
