...
export class SumIfRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SumIfPostRequestBody | undefined, requestConfiguration?: SumIfRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: SumIfPostRequestBody | undefined, requestConfiguration?: SumIfRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeSumIfPostRequestBody);
        return requestInfo;
    };
}
