 ...
 */
export class SumIfRequestBuilder extends BaseRequestBuilder<SumIfRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/sumIf", (x, y) => new SumIfRequestBuilder(x, y));
    }
    /**
     * Invoke action sumIf
