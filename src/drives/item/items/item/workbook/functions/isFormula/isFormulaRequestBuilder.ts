...
export class IsFormulaRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsFormulaPostRequestBody | undefined, requestConfiguration?: IsFormulaRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
