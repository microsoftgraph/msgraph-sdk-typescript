...
export class IsFormulaRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsFormulaPostRequestBody | undefined, requestConfiguration?: IsFormulaRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: IsFormulaPostRequestBody | undefined, requestConfiguration?: IsFormulaRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeIsFormulaPostRequestBody);
        return requestInfo;
    };
}
