...
export class Hex2DecRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Hex2DecPostRequestBody | undefined, requestConfiguration?: Hex2DecRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Hex2DecPostRequestBody | undefined, requestConfiguration?: Hex2DecRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeHex2DecPostRequestBody);
        return requestInfo;
    };
}
