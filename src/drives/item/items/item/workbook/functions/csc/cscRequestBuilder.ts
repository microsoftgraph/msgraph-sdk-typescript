...
export class CscRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CscPostRequestBody | undefined, requestConfiguration?: CscRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CscPostRequestBody | undefined, requestConfiguration?: CscRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCscPostRequestBody);
        return requestInfo;
    };
}
