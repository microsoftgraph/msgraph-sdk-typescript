...
export class CscRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CscPostRequestBody | undefined, requestConfiguration?: CscRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
