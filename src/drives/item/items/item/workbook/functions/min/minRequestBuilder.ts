...
export class MinRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: MinPostRequestBody | undefined, requestConfiguration?: MinRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: MinPostRequestBody | undefined, requestConfiguration?: MinRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeMinPostRequestBody);
        return requestInfo;
    };
}
