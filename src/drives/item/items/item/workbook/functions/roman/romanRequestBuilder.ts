...
export class RomanRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RomanPostRequestBody | undefined, requestConfiguration?: RomanRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: RomanPostRequestBody | undefined, requestConfiguration?: RomanRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeRomanPostRequestBody);
        return requestInfo;
    };
}
