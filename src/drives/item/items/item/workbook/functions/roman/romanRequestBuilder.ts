...
export class RomanRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RomanPostRequestBody | undefined, requestConfiguration?: RomanRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
