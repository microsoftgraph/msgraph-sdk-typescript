 ...
 */
export class AbsRequestBuilder extends BaseRequestBuilder<AbsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/abs", (x, y) => new AbsRequestBuilder(x, y));
    }
    /**
     * Invoke action abs
