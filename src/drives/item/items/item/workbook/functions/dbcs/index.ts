 ...
 */
export class DbcsRequestBuilder extends BaseRequestBuilder<DbcsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dbcs", (x, y) => new DbcsRequestBuilder(x, y));
    }
    /**
     * Invoke action dbcs
