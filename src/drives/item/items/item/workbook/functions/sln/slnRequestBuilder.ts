...
export class SlnRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SlnPostRequestBody | undefined, requestConfiguration?: SlnRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
