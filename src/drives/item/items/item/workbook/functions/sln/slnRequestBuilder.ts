...
export class SlnRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SlnPostRequestBody | undefined, requestConfiguration?: SlnRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: SlnPostRequestBody | undefined, requestConfiguration?: SlnRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeSlnPostRequestBody);
        return requestInfo;
    };
}
