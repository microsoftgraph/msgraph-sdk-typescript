...
import {StDev_SRequestBuilderPostRequestConfiguration} from './stDev_SRequestBuilderPostRequestConfiguration';
...
export class StDev_SRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: StDev_SPostRequestBody | undefined, requestConfiguration?: StDev_SRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: StDev_SPostRequestBody | undefined, requestConfiguration?: StDev_SRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeStDev_SPostRequestBody);
        return requestInfo;
    };
}
