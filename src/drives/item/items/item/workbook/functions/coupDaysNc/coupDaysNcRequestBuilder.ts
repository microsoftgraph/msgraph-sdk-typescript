...
export class CoupDaysNcRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CoupDaysNcPostRequestBody | undefined, requestConfiguration?: CoupDaysNcRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CoupDaysNcPostRequestBody | undefined, requestConfiguration?: CoupDaysNcRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCoupDaysNcPostRequestBody);
        return requestInfo;
    };
}
