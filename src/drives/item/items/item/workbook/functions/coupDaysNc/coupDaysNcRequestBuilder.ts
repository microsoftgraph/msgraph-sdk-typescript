...
export class CoupDaysNcRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CoupDaysNcPostRequestBody | undefined, requestConfiguration?: CoupDaysNcRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
