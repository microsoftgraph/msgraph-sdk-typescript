...
export class IsErrRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsErrPostRequestBody | undefined, requestConfiguration?: IsErrRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
