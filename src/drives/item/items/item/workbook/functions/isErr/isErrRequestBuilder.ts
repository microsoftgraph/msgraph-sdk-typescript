...
export class IsErrRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsErrPostRequestBody | undefined, requestConfiguration?: IsErrRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: IsErrPostRequestBody | undefined, requestConfiguration?: IsErrRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeIsErrPostRequestBody);
        return requestInfo;
    };
}
