...
export class TruncRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: TruncPostRequestBody | undefined, requestConfiguration?: TruncRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: TruncPostRequestBody | undefined, requestConfiguration?: TruncRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeTruncPostRequestBody);
        return requestInfo;
    };
}
