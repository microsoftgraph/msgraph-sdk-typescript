...
export class TruncRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: TruncPostRequestBody | undefined, requestConfiguration?: TruncRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
