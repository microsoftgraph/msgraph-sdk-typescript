...
import { deserializeIntoAtan2PostRequestBody, serializeAtan2PostRequestBody, type Atan2PostRequestBody } from './atan2PostRequestBody';
...
export class Atan2RequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a atan2RequestBuilder
     */
    public withUrl(rawUrl: string) : Atan2RequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new Atan2RequestBuilder(rawUrl, this.requestAdapter);
    };
}
