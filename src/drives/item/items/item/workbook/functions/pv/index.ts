 ...
 */
export class PvRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/pv");
    };
    /**
     * Invoke action pv
     ...
     * @returns a pvRequestBuilder
     */
    public withUrl(rawUrl: string) : PvRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new PvRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
