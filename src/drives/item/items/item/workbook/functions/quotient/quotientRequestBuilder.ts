...
export class QuotientRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: QuotientPostRequestBody | undefined, requestConfiguration?: QuotientRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
