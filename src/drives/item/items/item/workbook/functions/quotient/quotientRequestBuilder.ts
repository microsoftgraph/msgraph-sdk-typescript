...
import {QuotientRequestBuilderPostRequestConfiguration} from './quotientRequestBuilderPostRequestConfiguration';
...
export class QuotientRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: QuotientPostRequestBody | undefined, requestConfiguration?: QuotientRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: QuotientPostRequestBody | undefined, requestConfiguration?: QuotientRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeQuotientPostRequestBody);
        return requestInfo;
    };
}
