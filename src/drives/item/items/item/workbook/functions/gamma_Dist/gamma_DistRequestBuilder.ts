...
import { deserializeIntoGamma_DistPostRequestBody, serializeGamma_DistPostRequestBody, type Gamma_DistPostRequestBody } from './gamma_DistPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface Gamma_DistRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
