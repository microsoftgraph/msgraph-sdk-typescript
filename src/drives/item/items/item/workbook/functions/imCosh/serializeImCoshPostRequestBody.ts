...
export function serializeImCoshPostRequestBody(imCoshPostRequestBody: ImCoshPostRequestBody | undefined = {} as ImCoshPostRequestBody, writer: SerializationWriter) : void {
