 ...
 */
export class TodayRequestBuilder extends BaseRequestBuilder<TodayRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/today", (x, y) => new TodayRequestBuilder(x, y));
    }
    /**
     * Invoke action today
