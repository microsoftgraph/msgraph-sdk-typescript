...
export class Expon_DistPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "lambda": n => { this.lambda = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
