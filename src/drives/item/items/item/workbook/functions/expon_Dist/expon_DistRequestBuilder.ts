...
export class Expon_DistRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Expon_DistPostRequestBody | undefined, requestConfiguration?: Expon_DistRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Expon_DistPostRequestBody | undefined, requestConfiguration?: Expon_DistRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeExpon_DistPostRequestBody);
        return requestInfo;
    };
}
