...
export class Expon_DistRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Expon_DistPostRequestBody | undefined, requestConfiguration?: Expon_DistRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
