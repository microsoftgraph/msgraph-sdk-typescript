...
export class DvarPRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DvarPPostRequestBody | undefined, requestConfiguration?: DvarPRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
