...
export class DvarPRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DvarPPostRequestBody | undefined, requestConfiguration?: DvarPRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: DvarPPostRequestBody | undefined, requestConfiguration?: DvarPRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeDvarPPostRequestBody);
        return requestInfo;
    };
}
