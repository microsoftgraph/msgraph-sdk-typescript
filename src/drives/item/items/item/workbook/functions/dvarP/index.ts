 ...
 */
export class DvarPRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dvarP");
    };
    /**
     * Invoke action dvarP
     ...
     * @returns a dvarPRequestBuilder
     */
    public withUrl(rawUrl: string) : DvarPRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new DvarPRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
