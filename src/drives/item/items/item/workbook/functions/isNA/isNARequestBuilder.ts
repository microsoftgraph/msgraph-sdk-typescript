...
export class IsNARequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IsNAPostRequestBody | undefined, requestConfiguration?: IsNARequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
