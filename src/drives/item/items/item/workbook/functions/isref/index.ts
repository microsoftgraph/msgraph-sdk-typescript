 ...
 */
export class IsrefRequestBuilder extends BaseRequestBuilder<IsrefRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/isref", (x, y) => new IsrefRequestBuilder(x, y));
    }
    /**
     * Invoke action isref
