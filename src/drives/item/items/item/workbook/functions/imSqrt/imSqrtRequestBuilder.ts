...
export class ImSqrtRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImSqrtPostRequestBody | undefined, requestConfiguration?: ImSqrtRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
