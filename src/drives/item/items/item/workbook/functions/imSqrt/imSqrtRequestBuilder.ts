...
export class ImSqrtRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImSqrtPostRequestBody | undefined, requestConfiguration?: ImSqrtRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ImSqrtPostRequestBody | undefined, requestConfiguration?: ImSqrtRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeImSqrtPostRequestBody);
        return requestInfo;
    };
}
