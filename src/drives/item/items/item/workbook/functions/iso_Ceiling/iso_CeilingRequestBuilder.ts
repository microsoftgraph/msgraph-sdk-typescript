...
export class Iso_CeilingRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Iso_CeilingPostRequestBody | undefined, requestConfiguration?: Iso_CeilingRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Iso_CeilingPostRequestBody | undefined, requestConfiguration?: Iso_CeilingRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeIso_CeilingPostRequestBody);
        return requestInfo;
    };
}
