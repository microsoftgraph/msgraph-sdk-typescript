...
export class Iso_CeilingRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Iso_CeilingPostRequestBody | undefined, requestConfiguration?: Iso_CeilingRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
