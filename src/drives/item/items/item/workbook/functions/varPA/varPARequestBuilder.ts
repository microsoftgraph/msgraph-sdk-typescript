...
export class VarPARequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: VarPAPostRequestBody | undefined, requestConfiguration?: VarPARequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: VarPAPostRequestBody | undefined, requestConfiguration?: VarPARequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeVarPAPostRequestBody);
        return requestInfo;
    };
}
