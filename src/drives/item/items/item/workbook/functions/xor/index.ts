 ...
 */
export class XorRequestBuilder extends BaseRequestBuilder<XorRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/xor", (x, y) => new XorRequestBuilder(x, y));
    }
    /**
     * Invoke action xor
