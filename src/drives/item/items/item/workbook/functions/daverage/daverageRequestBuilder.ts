...
import {serializeDaveragePostRequestBody} from './serializeDaveragePostRequestBody';
...
export class DaverageRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DaveragePostRequestBody | undefined, requestConfiguration?: DaverageRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: DaveragePostRequestBody | undefined, requestConfiguration?: DaverageRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeDaveragePostRequestBody);
        return requestInfo;
    };
}
