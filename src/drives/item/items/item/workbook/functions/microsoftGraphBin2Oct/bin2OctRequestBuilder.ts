 ...
 */
export class Bin2OctRequestBuilder {
     ...
     */
    public post(body: Bin2OctPostRequestBody | undefined, requestConfiguration?: Bin2OctRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Bin2OctPostRequestBody | undefined, requestConfiguration?: Bin2OctRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
