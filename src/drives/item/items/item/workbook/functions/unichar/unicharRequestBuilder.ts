...
export class UnicharRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: UnicharPostRequestBody | undefined, requestConfiguration?: UnicharRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: UnicharPostRequestBody | undefined, requestConfiguration?: UnicharRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeUnicharPostRequestBody);
        return requestInfo;
    };
}
