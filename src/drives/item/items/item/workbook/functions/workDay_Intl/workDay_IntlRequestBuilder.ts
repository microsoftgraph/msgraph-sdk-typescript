...
import { deserializeIntoWorkDay_IntlPostRequestBody, serializeWorkDay_IntlPostRequestBody, type WorkDay_IntlPostRequestBody } from './workDay_IntlPostRequestBody';
 ...
 */
export class WorkDay_IntlRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/workDay_Intl");
    };
    /**
     ...
     * @returns a workDay_IntlRequestBuilder
     */
    public withUrl(rawUrl: string) : WorkDay_IntlRequestBuilder {
