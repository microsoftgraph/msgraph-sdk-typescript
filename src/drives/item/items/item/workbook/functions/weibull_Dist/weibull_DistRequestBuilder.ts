...
export class Weibull_DistRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Weibull_DistPostRequestBody | undefined, requestConfiguration?: Weibull_DistRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Weibull_DistPostRequestBody | undefined, requestConfiguration?: Weibull_DistRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeWeibull_DistPostRequestBody);
        return requestInfo;
    };
}
