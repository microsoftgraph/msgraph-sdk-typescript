 ...
 */
export class IsNonTextRequestBuilder extends BaseRequestBuilder<IsNonTextRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/isNonText", (x, y) => new IsNonTextRequestBuilder(x, y));
    }
    /**
