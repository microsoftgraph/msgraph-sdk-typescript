...
export class Error_TypePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "errorVal": n => { this.errorVal = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
        };
    };
    /**
