...
export class Error_TypeRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Error_TypePostRequestBody | undefined, requestConfiguration?: Error_TypeRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Error_TypePostRequestBody | undefined, requestConfiguration?: Error_TypeRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeError_TypePostRequestBody);
        return requestInfo;
    };
}
