 ...
 */
export class BitlshiftRequestBuilder extends BaseRequestBuilder<BitlshiftRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/bitlshift", (x, y) => new BitlshiftRequestBuilder(x, y));
    }
    /**
