...
export class BitlshiftPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "shiftAmount": n => { this.shiftAmount = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
        };
    };
    /**
