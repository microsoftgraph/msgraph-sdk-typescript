...
export class DollarFrRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DollarFrPostRequestBody | undefined, requestConfiguration?: DollarFrRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: DollarFrPostRequestBody | undefined, requestConfiguration?: DollarFrRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeDollarFrPostRequestBody);
        return requestInfo;
    };
}
