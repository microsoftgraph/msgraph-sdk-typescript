...
export class DollarFrRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DollarFrPostRequestBody | undefined, requestConfiguration?: DollarFrRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
