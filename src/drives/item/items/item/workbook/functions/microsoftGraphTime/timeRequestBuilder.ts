...
export class TimeRequestBuilder {
     ...
     */
    public post(body: TimePostRequestBody | undefined, requestConfiguration?: TimeRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: TimePostRequestBody | undefined, requestConfiguration?: TimeRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
