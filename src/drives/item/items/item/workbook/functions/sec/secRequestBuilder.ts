...
export class SecRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SecPostRequestBody | undefined, requestConfiguration?: SecRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: SecPostRequestBody | undefined, requestConfiguration?: SecRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeSecPostRequestBody);
        return requestInfo;
    };
}
