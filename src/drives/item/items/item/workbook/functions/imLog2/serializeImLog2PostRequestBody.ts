...
export function serializeImLog2PostRequestBody(imLog2PostRequestBody: ImLog2PostRequestBody | undefined = {} as ImLog2PostRequestBody, writer: SerializationWriter) : void {
