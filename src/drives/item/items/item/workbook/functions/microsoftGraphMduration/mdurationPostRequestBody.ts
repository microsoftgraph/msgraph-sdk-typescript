...
export class MdurationPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "coupon": n => { this.coupon = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
