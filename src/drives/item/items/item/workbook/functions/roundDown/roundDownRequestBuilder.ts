...
export class RoundDownRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RoundDownPostRequestBody | undefined, requestConfiguration?: RoundDownRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: RoundDownPostRequestBody | undefined, requestConfiguration?: RoundDownRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeRoundDownPostRequestBody);
        return requestInfo;
    };
}
