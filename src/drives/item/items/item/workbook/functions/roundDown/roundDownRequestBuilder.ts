...
export class RoundDownRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: RoundDownPostRequestBody | undefined, requestConfiguration?: RoundDownRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
