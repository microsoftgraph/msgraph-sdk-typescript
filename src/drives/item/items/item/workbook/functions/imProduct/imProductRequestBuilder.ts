...
export class ImProductRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImProductPostRequestBody | undefined, requestConfiguration?: ImProductRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
