...
import { deserializeIntoImProductPostRequestBody, serializeImProductPostRequestBody, type ImProductPostRequestBody } from './imProductPostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface ImProductRequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
