 ...
 */
export class RoundRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/round");
    };
    /**
     * Invoke action round
     ...
     * @returns a roundRequestBuilder
     */
    public withUrl(rawUrl: string) : RoundRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new RoundRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
