...
export class YieldDiscRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: YieldDiscPostRequestBody | undefined, requestConfiguration?: YieldDiscRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: YieldDiscPostRequestBody | undefined, requestConfiguration?: YieldDiscRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeYieldDiscPostRequestBody);
        return requestInfo;
    };
}
