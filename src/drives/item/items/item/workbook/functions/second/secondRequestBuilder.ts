...
export class SecondRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SecondPostRequestBody | undefined, requestConfiguration?: SecondRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: SecondPostRequestBody | undefined, requestConfiguration?: SecondRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeSecondPostRequestBody);
        return requestInfo;
    };
}
