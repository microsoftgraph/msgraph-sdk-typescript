...
export class SecondRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SecondPostRequestBody | undefined, requestConfiguration?: SecondRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
