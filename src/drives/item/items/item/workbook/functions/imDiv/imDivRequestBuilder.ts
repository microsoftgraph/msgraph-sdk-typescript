...
export class ImDivRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImDivPostRequestBody | undefined, requestConfiguration?: ImDivRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: ImDivPostRequestBody | undefined, requestConfiguration?: ImDivRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeImDivPostRequestBody);
        return requestInfo;
    };
}
