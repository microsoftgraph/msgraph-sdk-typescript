...
export class Ceiling_MathPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "mode": n => { this.mode = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
