...
import {serializeImExpPostRequestBody} from './serializeImExpPostRequestBody';
...
export class ImExpRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ImExpPostRequestBody | undefined, requestConfiguration?: ImExpRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: ImExpPostRequestBody | undefined, requestConfiguration?: ImExpRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeImExpPostRequestBody);
        return requestInfo;
    };
}
