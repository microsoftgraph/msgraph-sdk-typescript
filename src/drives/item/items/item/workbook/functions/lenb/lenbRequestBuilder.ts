...
export class LenbRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: LenbPostRequestBody | undefined, requestConfiguration?: LenbRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: LenbPostRequestBody | undefined, requestConfiguration?: LenbRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeLenbPostRequestBody);
        return requestInfo;
    };
}
