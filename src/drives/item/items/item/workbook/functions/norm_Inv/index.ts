 ...
 */
export class Norm_InvRequestBuilder extends BaseRequestBuilder<Norm_InvRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/norm_Inv", (x, y) => new Norm_InvRequestBuilder(x, y));
    }
    /**
