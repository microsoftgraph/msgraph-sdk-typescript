...
export class Norm_InvRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Norm_InvPostRequestBody | undefined, requestConfiguration?: Norm_InvRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
