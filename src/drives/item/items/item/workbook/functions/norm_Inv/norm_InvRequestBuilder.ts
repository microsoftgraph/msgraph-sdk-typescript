...
export class Norm_InvRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Norm_InvPostRequestBody | undefined, requestConfiguration?: Norm_InvRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Norm_InvPostRequestBody | undefined, requestConfiguration?: Norm_InvRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeNorm_InvPostRequestBody);
        return requestInfo;
    };
}
