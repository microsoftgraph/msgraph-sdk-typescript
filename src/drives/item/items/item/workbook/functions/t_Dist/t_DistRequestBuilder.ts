...
import { deserializeIntoT_DistPostRequestBody, serializeT_DistPostRequestBody, type T_DistPostRequestBody } from './t_DistPostRequestBody';
...
export class T_DistRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: T_DistPostRequestBody, requestConfiguration?: T_DistRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: T_DistPostRequestBody, requestConfiguration?: T_DistRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a t_DistRequestBuilder
     */
    public withUrl(rawUrl: string) : T_DistRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new T_DistRequestBuilder(rawUrl, this.requestAdapter);
    };
}
