...
export function serializeConfidence_NormPostRequestBody(confidence_NormPostRequestBody: Confidence_NormPostRequestBody | undefined = {} as Confidence_NormPostRequestBody, writer: SerializationWriter) : void {
