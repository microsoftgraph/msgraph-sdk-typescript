 ...
 */
export class Confidence_NormRequestBuilder extends BaseRequestBuilder<Confidence_NormRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/confidence_Norm", (x, y) => new Confidence_NormRequestBuilder(x, y));
    }
    /**
