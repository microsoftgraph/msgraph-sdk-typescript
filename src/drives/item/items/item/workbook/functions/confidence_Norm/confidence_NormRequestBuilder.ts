...
export class Confidence_NormRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: Confidence_NormPostRequestBody | undefined, requestConfiguration?: Confidence_NormRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: Confidence_NormPostRequestBody | undefined, requestConfiguration?: Confidence_NormRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeConfidence_NormPostRequestBody);
        return requestInfo;
    };
}
