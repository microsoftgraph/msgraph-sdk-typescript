...
export class VlookupRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: VlookupPostRequestBody | undefined, requestConfiguration?: VlookupRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
