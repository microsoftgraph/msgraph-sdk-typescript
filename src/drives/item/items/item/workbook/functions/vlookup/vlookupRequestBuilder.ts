...
export class VlookupRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: VlookupPostRequestBody | undefined, requestConfiguration?: VlookupRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: VlookupPostRequestBody | undefined, requestConfiguration?: VlookupRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeVlookupPostRequestBody);
        return requestInfo;
    };
}
