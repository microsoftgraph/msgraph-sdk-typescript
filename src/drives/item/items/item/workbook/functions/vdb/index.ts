 ...
 */
export class VdbRequestBuilder extends BaseRequestBuilder<VdbRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/vdb", (x, y) => new VdbRequestBuilder(x, y));
    }
    /**
     * Invoke action vdb
