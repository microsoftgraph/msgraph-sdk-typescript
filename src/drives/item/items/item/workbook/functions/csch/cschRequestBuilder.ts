...
export class CschRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: CschPostRequestBody | undefined, requestConfiguration?: CschRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: CschPostRequestBody | undefined, requestConfiguration?: CschRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeCschPostRequestBody);
        return requestInfo;
    };
}
