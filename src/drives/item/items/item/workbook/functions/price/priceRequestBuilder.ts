...
import {PricePostRequestBody} from './pricePostRequestBody';
...
export class PriceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: PricePostRequestBody | undefined, requestConfiguration?: PriceRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: PricePostRequestBody | undefined, requestConfiguration?: PriceRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializePricePostRequestBody);
        return requestInfo;
    };
}
