...
export class PriceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: PricePostRequestBody | undefined, requestConfiguration?: PriceRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
