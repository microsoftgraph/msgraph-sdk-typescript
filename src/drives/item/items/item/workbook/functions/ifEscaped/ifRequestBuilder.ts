...
export class IfRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IfPostRequestBody | undefined, requestConfiguration?: IfRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: IfPostRequestBody | undefined, requestConfiguration?: IfRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeIfPostRequestBody);
        return requestInfo;
    };
}
