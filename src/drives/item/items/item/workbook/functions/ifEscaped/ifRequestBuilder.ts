...
export class IfRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IfPostRequestBody | undefined, requestConfiguration?: IfRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
