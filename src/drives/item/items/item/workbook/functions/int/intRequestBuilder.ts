...
import { deserializeIntoIntPostRequestBody, serializeIntPostRequestBody, type IntPostRequestBody } from './intPostRequestBody';
...
export class IntRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a intRequestBuilder
     */
    public withUrl(rawUrl: string) : IntRequestBuilder {
