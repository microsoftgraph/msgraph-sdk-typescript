...
export class TrimMeanPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "percent": n => { this.percent = n.getObjectValue<Json>(createJsonFromDiscriminatorValue); },
        };
    };
    /**
