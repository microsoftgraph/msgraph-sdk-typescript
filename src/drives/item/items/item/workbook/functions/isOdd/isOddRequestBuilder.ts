...
import {IsOddRequestBuilderPostRequestConfiguration} from './isOddRequestBuilderPostRequestConfiguration';
 ...
 */
export class IsOddRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/isOdd");
    };
    /**
     * Invoke action isOdd
     ...
     */
    public post(body: IsOddPostRequestBody | undefined, requestConfiguration?: IsOddRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: IsOddPostRequestBody | undefined, requestConfiguration?: IsOddRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeIsOddPostRequestBody);
        return requestInfo;
    };
}
