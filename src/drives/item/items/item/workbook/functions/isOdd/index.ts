 ...
 */
export class IsOddRequestBuilder extends BaseRequestBuilder<IsOddRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/isOdd", (x, y) => new IsOddRequestBuilder(x, y));
    }
    /**
     * Invoke action isOdd
