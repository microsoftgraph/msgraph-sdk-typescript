...
export class FisherRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: FisherPostRequestBody | undefined, requestConfiguration?: FisherRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: FisherPostRequestBody | undefined, requestConfiguration?: FisherRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeFisherPostRequestBody);
        return requestInfo;
    };
}
