...
import {PpmtPostRequestBody} from './ppmtPostRequestBody';
...
export class PpmtRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: PpmtPostRequestBody | undefined, requestConfiguration?: PpmtRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: PpmtPostRequestBody | undefined, requestConfiguration?: PpmtRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializePpmtPostRequestBody);
        return requestInfo;
    };
}
