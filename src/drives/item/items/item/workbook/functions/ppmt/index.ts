 ...
 */
export class PpmtRequestBuilder extends BaseRequestBuilder<PpmtRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/ppmt", (x, y) => new PpmtRequestBuilder(x, y));
    }
    /**
     * Invoke action ppmt
