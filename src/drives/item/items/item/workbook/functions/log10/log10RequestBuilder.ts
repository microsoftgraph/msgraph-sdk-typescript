...
import { deserializeIntoLog10PostRequestBody, serializeLog10PostRequestBody, type Log10PostRequestBody } from './log10PostRequestBody';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface Log10RequestBuilderPostRequestConfiguration {
    /**
     * Request headers
     */
 ...
 */
export class Log10RequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/log10");
    };
    /**
     * Invoke action log10
     ...
     * @returns a log10RequestBuilder
     */
    public withUrl(rawUrl: string) : Log10RequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new Log10RequestBuilder(rawUrl, this.requestAdapter);
    };
}
