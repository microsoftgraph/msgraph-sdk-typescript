...
export class IspmtRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IspmtPostRequestBody | undefined, requestConfiguration?: IspmtRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
