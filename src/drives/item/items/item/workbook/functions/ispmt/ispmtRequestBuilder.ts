...
export class IspmtRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: IspmtPostRequestBody | undefined, requestConfiguration?: IspmtRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: IspmtPostRequestBody | undefined, requestConfiguration?: IspmtRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeIspmtPostRequestBody);
        return requestInfo;
    };
}
