...
export class SheetRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SheetPostRequestBody | undefined, requestConfiguration?: SheetRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: SheetPostRequestBody | undefined, requestConfiguration?: SheetRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeSheetPostRequestBody);
        return requestInfo;
    };
}
