...
export class SheetRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SheetPostRequestBody | undefined, requestConfiguration?: SheetRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
