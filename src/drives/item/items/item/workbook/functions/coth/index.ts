 ...
 */
export class CothRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/coth");
    };
    /**
     * Invoke action coth
     ...
     * @returns a cothRequestBuilder
     */
    public withUrl(rawUrl: string) : CothRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new CothRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
