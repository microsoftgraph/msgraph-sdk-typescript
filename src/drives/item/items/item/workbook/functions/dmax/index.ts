 ...
 */
export class DmaxRequestBuilder extends BaseRequestBuilder<DmaxRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dmax", (x, y) => new DmaxRequestBuilder(x, y));
    }
    /**
     * Invoke action dmax
