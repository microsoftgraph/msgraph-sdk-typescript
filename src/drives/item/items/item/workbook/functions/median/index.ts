 ...
 */
export class MedianRequestBuilder extends BaseRequestBuilder<MedianRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/median", (x, y) => new MedianRequestBuilder(x, y));
    }
    /**
