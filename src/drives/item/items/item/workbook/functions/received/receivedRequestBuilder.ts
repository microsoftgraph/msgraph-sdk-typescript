...
export class ReceivedRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ReceivedPostRequestBody | undefined, requestConfiguration?: ReceivedRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ReceivedPostRequestBody | undefined, requestConfiguration?: ReceivedRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeReceivedPostRequestBody);
        return requestInfo;
    };
}
