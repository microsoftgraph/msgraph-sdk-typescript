...
export class AccrIntRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AccrIntPostRequestBody | undefined, requestConfiguration?: AccrIntRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
