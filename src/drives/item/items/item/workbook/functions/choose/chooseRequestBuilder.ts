...
export class ChooseRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ChoosePostRequestBody | undefined, requestConfiguration?: ChooseRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
