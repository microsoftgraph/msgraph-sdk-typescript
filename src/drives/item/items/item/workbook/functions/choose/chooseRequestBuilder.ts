...
export class ChooseRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ChoosePostRequestBody | undefined, requestConfiguration?: ChooseRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ChoosePostRequestBody | undefined, requestConfiguration?: ChooseRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeChoosePostRequestBody);
        return requestInfo;
    };
}
