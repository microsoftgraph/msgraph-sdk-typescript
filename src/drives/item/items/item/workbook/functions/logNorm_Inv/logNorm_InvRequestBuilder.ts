...
export class LogNorm_InvRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: LogNorm_InvPostRequestBody | undefined, requestConfiguration?: LogNorm_InvRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: LogNorm_InvPostRequestBody | undefined, requestConfiguration?: LogNorm_InvRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeLogNorm_InvPostRequestBody);
        return requestInfo;
    };
}
