 ...
 */
export class PercentRank_ExcRequestBuilder extends BaseRequestBuilder<PercentRank_ExcRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/percentRank_Exc", (x, y) => new PercentRank_ExcRequestBuilder(x, y));
    }
    /**
