...
export class PercentRank_ExcRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: PercentRank_ExcPostRequestBody | undefined, requestConfiguration?: PercentRank_ExcRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: PercentRank_ExcPostRequestBody | undefined, requestConfiguration?: PercentRank_ExcRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializePercentRank_ExcPostRequestBody);
        return requestInfo;
    };
}
