 ...
 */
export class TrimMeanRequestBuilder extends BaseRequestBuilder<TrimMeanRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/trimMean", (x, y) => new TrimMeanRequestBuilder(x, y));
    }
    /**
