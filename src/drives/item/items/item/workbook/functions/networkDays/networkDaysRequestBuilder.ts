...
export class NetworkDaysRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: NetworkDaysPostRequestBody | undefined, requestConfiguration?: NetworkDaysRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: NetworkDaysPostRequestBody | undefined, requestConfiguration?: NetworkDaysRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeNetworkDaysPostRequestBody);
        return requestInfo;
    };
}
