...
export class NetworkDaysRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: NetworkDaysPostRequestBody | undefined, requestConfiguration?: NetworkDaysRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
