 ...
 */
export class ChiSq_DistRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/chiSq_Dist");
    };
    /**
     ...
     * @returns a chiSq_DistRequestBuilder
     */
    public withUrl(rawUrl: string) : ChiSq_DistRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new ChiSq_DistRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
