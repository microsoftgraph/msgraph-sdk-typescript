...
export class ChiSq_DistRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ChiSq_DistPostRequestBody | undefined, requestConfiguration?: ChiSq_DistRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ChiSq_DistPostRequestBody | undefined, requestConfiguration?: ChiSq_DistRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeChiSq_DistPostRequestBody);
        return requestInfo;
    };
}
