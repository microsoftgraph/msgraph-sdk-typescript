...
export class ChiSq_DistRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ChiSq_DistPostRequestBody | undefined, requestConfiguration?: ChiSq_DistRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
