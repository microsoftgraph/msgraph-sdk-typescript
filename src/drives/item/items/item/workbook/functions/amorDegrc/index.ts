 ...
 */
export class AmorDegrcRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/amorDegrc");
    };
    /**
     ...
     * @returns a amorDegrcRequestBuilder
     */
    public withUrl(rawUrl: string) : AmorDegrcRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new AmorDegrcRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
