...
export class BesselYRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: BesselYPostRequestBody | undefined, requestConfiguration?: BesselYRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: BesselYPostRequestBody | undefined, requestConfiguration?: BesselYRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeBesselYPostRequestBody);
        return requestInfo;
    };
}
