 ...
 */
export class Percentile_ExcRequestBuilder extends BaseRequestBuilder<Percentile_ExcRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/percentile_Exc", (x, y) => new Percentile_ExcRequestBuilder(x, y));
    }
    /**
