...
export class MaxRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: MaxPostRequestBody | undefined, requestConfiguration?: MaxRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
    ...
    public toPostRequestInformation(body: MaxPostRequestBody | undefined, requestConfiguration?: MaxRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeMaxPostRequestBody);
        return requestInfo;
    };
}
