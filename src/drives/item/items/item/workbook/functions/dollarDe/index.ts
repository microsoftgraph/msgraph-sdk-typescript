 ...
 */
export class DollarDeRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dollarDe");
    };
    /**
     ...
     * @returns a dollarDeRequestBuilder
     */
    public withUrl(rawUrl: string) : DollarDeRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new DollarDeRequestBuilder(rawUrl, this.requestAdapter);
    };
}
// tslint:enable
// eslint-enable
