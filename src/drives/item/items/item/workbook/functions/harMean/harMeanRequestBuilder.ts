...
export class HarMeanRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: HarMeanPostRequestBody | undefined, requestConfiguration?: HarMeanRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: HarMeanPostRequestBody | undefined, requestConfiguration?: HarMeanRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeHarMeanPostRequestBody);
        return requestInfo;
    };
}
