...
export class AmorLincRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AmorLincPostRequestBody | undefined, requestConfiguration?: AmorLincRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: AmorLincPostRequestBody | undefined, requestConfiguration?: AmorLincRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeAmorLincPostRequestBody);
        return requestInfo;
    };
}
