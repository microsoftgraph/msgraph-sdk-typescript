 ...
 */
export class AmorLincRequestBuilder extends BaseRequestBuilder<AmorLincRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/amorLinc", (x, y) => new AmorLincRequestBuilder(x, y));
    }
    /**
