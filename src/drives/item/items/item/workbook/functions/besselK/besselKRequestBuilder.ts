...
export class BesselKRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: BesselKPostRequestBody | undefined, requestConfiguration?: BesselKRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: BesselKPostRequestBody | undefined, requestConfiguration?: BesselKRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeBesselKPostRequestBody);
        return requestInfo;
    };
}
