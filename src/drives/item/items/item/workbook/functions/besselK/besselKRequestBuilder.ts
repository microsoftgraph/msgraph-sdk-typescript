...
export class BesselKRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: BesselKPostRequestBody | undefined, requestConfiguration?: BesselKRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
