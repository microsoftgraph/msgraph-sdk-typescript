...
export class ColumnsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ColumnsPostRequestBody | undefined, requestConfiguration?: ColumnsRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
