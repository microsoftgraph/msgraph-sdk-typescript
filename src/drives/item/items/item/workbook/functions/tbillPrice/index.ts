 ...
 */
export class TbillPriceRequestBuilder extends BaseRequestBuilder<TbillPriceRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/tbillPrice", (x, y) => new TbillPriceRequestBuilder(x, y));
    }
    /**
