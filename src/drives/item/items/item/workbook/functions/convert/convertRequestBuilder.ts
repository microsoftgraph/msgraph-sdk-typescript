...
export class ConvertRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ConvertPostRequestBody | undefined, requestConfiguration?: ConvertRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: ConvertPostRequestBody | undefined, requestConfiguration?: ConvertRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeConvertPostRequestBody);
        return requestInfo;
    };
}
