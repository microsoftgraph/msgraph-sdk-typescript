...
import { type AverageRequestBuilderPostRequestConfiguration } from './averageRequestBuilderPostRequestConfiguration';
...
export class AverageRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: AveragePostRequestBody, requestConfiguration?: AverageRequestBuilderPostRequestConfiguration | undefined) : Promise<WorkbookFunctionResult | undefined> {
     ...
     */
    public toPostRequestInformation(body: AveragePostRequestBody, requestConfiguration?: AverageRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
