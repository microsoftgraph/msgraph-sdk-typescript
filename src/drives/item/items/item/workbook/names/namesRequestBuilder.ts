...
import {AddFormulaLocalRequestBuilder} from './microsoftGraphAddFormulaLocal/addFormulaLocalRequestBuilder';
...
export class NamesRequestBuilder {
    ...
    public get microsoftGraphAddFormulaLocal(): AddFormulaLocalRequestBuilder {
