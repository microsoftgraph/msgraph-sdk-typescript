...
export class WorkbookNamedItemItemRequestBuilder extends BaseRequestBuilder<WorkbookNamedItemItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}{?%24select,%24expand}", (x, y) => new WorkbookNamedItemItemRequestBuilder(x, y));
    }
    /**
