...
export class WorkbookCommentReplyItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<WorkbookCommentReplyItemRequestBuilderGetQueryParameters> | undefined) : Promise<WorkbookCommentReply | undefined> {
     ...
     * @returns a Promise of WorkbookCommentReply
     */
    public patch(body: WorkbookCommentReply, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<WorkbookCommentReply | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<WorkbookCommentReplyItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, workbookCommentReplyItemRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    };
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: WorkbookCommentReply, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
