...
export class ImageWithWidthWithHeightWithFittingModeRequestBuilder extends BaseRequestBuilder<ImageWithWidthWithHeightWithFittingModeRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, fittingMode?: string | undefined, height?: number | undefined, width?: number | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/image(width={width},height={height},fittingMode='{fittingMode}')", (x, y) => new ImageWithWidthWithHeightWithFittingModeRequestBuilder(x, y));
