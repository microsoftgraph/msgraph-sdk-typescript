import {createWorkbookChartSeriesFormatFromDiscriminatorValue} from '../../../../../../../../../../../../models/createWorkbookChartSeriesFormatFromDiscriminatorValue';
import {deserializeIntoWorkbookChartSeriesFormat} from '../../../../../../../../../../../../models/deserializeIntoWorkbookChartSeriesFormat';
import {ODataError} from '../../../../../../../../../../../../models/oDataErrors/';
import {createODataErrorFromDiscriminatorValue} from '../../../../../../../../../../../../models/oDataErrors/createODataErrorFromDiscriminatorValue';
import {deserializeIntoODataError} from '../../../../../../../../../../../../models/oDataErrors/deserializeIntoODataError';
import {serializeODataError} from '../../../../../../../../../../../../models/oDataErrors/serializeODataError';
import {serializeWorkbookChartSeriesFormat} from '../../../../../../../../../../../../models/serializeWorkbookChartSeriesFormat';
import type {WorkbookChartSeriesFormat} from '../../../../../../../../../../../../models/workbookChartSeriesFormat';
...
export class FormatRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/series/{workbookChartSeries%2Did}/format{?%24select,%24expand}");
    };
    /**
     ...
     * @returns a Promise of WorkbookChartSeriesFormat
     */
    public patch(body: WorkbookChartSeriesFormat, requestConfiguration?: FormatRequestBuilderPatchRequestConfiguration | undefined) : Promise<WorkbookChartSeriesFormat | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: WorkbookChartSeriesFormat, requestConfiguration?: FormatRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body, serializeWorkbookChartSeriesFormat);
        return requestInfo;
    };
}
