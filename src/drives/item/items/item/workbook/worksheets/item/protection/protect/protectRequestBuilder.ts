...
export class ProtectRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ProtectPostRequestBody, requestConfiguration?: ProtectRequestBuilderPostRequestConfiguration | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: ProtectPostRequestBody, requestConfiguration?: ProtectRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
