...
import { createWorkbookChartTitleFromDiscriminatorValue, deserializeIntoWorkbookChartTitle, serializeWorkbookChartTitle, type WorkbookChartTitle } from '../../../../../../../../../../models/workbookChartTitle';
...
export class TitleRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public patch(body: WorkbookChartTitle, requestConfiguration?: TitleRequestBuilderPatchRequestConfiguration | undefined) : Promise<WorkbookChartTitle | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: WorkbookChartTitle, requestConfiguration?: TitleRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
