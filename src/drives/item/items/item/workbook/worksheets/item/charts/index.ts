...
import { createWorkbookChartCollectionResponseFromDiscriminatorValue, createWorkbookChartFromDiscriminatorValue, deserializeIntoWorkbookChart, serializeWorkbookChart, type WorkbookChart, type WorkbookChartCollectionResponse } from '../../../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../../../models/oDataErrors/';
import { AddRequestBuilder } from './add/';
import { CountRequestBuilder } from './count/';
import { WorkbookChartItemRequestBuilder } from './item/';
 ...
 */
export class ChartsRequestBuilder extends BaseRequestBuilder<ChartsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ChartsRequestBuilder(x, y));
    }
    /**
