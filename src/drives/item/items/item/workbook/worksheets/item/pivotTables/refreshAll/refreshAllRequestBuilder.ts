...
import { type RefreshAllRequestBuilderPostRequestConfiguration } from './refreshAllRequestBuilderPostRequestConfiguration';
...
export class RefreshAllRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(requestConfiguration?: RefreshAllRequestBuilderPostRequestConfiguration | undefined) : Promise<void> {
