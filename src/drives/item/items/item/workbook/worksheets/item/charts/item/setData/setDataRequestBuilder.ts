...
export class SetDataRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: SetDataPostRequestBody | undefined, requestConfiguration?: SetDataRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: SetDataPostRequestBody | undefined, requestConfiguration?: SetDataRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeSetDataPostRequestBody);
        return requestInfo;
    };
}
