...
import {WorksheetRequestBuilderGetRequestConfiguration} from './worksheetRequestBuilderGetRequestConfiguration';
...
export class WorksheetRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/worksheet{?%24select,%24expand}");
    };
    /**
     ...
     */
    public get(requestConfiguration?: WorksheetRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookWorksheet | undefined> {
