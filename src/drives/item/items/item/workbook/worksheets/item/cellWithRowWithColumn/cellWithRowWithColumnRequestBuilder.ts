...
import { type CellWithRowWithColumnRequestBuilderGetRequestConfiguration } from './cellWithRowWithColumnRequestBuilderGetRequestConfiguration';
...
export class CellWithRowWithColumnRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: CellWithRowWithColumnRequestBuilderGetRequestConfiguration | undefined) : Promise<WorkbookRange | undefined> {
     ...
     */
    public withUrl(rawUrl: string) : CellWithRowWithColumnRequestBuilder {
