...
import {WorkbookChartFill} from '../../../../../../../../../../../../../../../models/workbookChartFill';
...
export class FillRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/series/{workbookChartSeries%2Did}/points/{workbookChartPoint%2Did}/format/fill{?%24select,%24expand}");
    };
    /**
    ...
    public toPatchRequestInformation(body: WorkbookChartFill | undefined, requestConfiguration?: FillRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeWorkbookChartFill);
        return requestInfo;
    };
}
