...
import { createWorkbookNamedItemCollectionResponseFromDiscriminatorValue, createWorkbookNamedItemFromDiscriminatorValue, deserializeIntoWorkbookNamedItem, serializeWorkbookNamedItem, type WorkbookNamedItem, type WorkbookNamedItemCollectionResponse } from '../../../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../../../models/oDataErrors/';
import { AddRequestBuilder } from './add/';
import { AddFormulaLocalRequestBuilder } from './addFormulaLocal/';
import { CountRequestBuilder } from './count/';
import { WorkbookNamedItemItemRequestBuilder } from './item/';
 ...
 */
export class NamesRequestBuilder extends BaseRequestBuilder<NamesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/names{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new NamesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public post(body: WorkbookNamedItem, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<WorkbookNamedItem | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<NamesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, namesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: WorkbookNamedItem, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
