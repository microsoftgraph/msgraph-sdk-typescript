...
export class SetPositionRequestBuilder extends BaseRequestBuilder {
     ...
     * @see {@link https://docs.microsoft.com/graph/api/chart-setposition?view=graph-rest-1.0|Find more info here}
     */
    public post(body: SetPositionPostRequestBody | undefined, requestConfiguration?: SetPositionRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
     ...
     */
    public toPostRequestInformation(body: SetPositionPostRequestBody | undefined, requestConfiguration?: SetPositionRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeSetPositionPostRequestBody);
        return requestInfo;
    };
}
