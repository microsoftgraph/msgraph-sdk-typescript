 ...
 */
export class ImageRequestBuilder extends BaseRequestBuilder<ImageRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/itemAt(index={index})/image()", (x, y) => new ImageRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ImageGetResponse | undefined> {
        ...
        return this.requestAdapter.sendAsync<ImageGetResponse>(requestInfo, createImageGetResponseFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function image
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
