...
export class WorkbookNamedItemItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: WorkbookNamedItemItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
