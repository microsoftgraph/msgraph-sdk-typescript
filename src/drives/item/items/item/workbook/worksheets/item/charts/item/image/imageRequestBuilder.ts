...
import { createImageGetResponseFromDiscriminatorValue } from './imageGetResponse';
import { type ImageGetResponse } from './index';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestOption } from '@microsoft/kiota-abstractions';

export interface ImageRequestBuilderGetRequestConfiguration {
    /**
     * Request headers
     */
...
export class ImageRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: ImageRequestBuilderGetRequestConfiguration | undefined) : Promise<ImageGetResponse | undefined> {
