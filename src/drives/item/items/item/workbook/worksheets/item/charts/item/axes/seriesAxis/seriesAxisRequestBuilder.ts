...
export class SeriesAxisRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: SeriesAxisRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
