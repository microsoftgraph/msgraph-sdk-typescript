...
import {MicrosoftGraphUsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration} from './microsoftGraphUsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the usedRange method.
 */
export class MicrosoftGraphUsedRangeWithValuesOnlyRequestBuilder {
     ...
     */
    public get(requestConfiguration?: MicrosoftGraphUsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookRange | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: MicrosoftGraphUsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
