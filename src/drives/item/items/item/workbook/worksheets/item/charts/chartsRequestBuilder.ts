...
import {ItemWithNameRequestBuilder} from './microsoftGraphItemWithName/itemWithNameRequestBuilder';
...
export class ChartsRequestBuilder {
     ...
     */
    public microsoftGraphItemWithName(name: string | undefined) : ItemWithNameRequestBuilder {
