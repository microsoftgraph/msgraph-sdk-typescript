...
import {WorkbookChartPointFormat} from '../../../../../../../../../../../../../../models/workbookChartPointFormat';
...
export class FormatRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: FormatRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookChartPointFormat | undefined> {
        ...
        return this.requestAdapter?.sendAsync<WorkbookChartPointFormat>(requestInfo, createWorkbookChartPointFormatFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     ...
     * @returns a Promise of WorkbookChartPointFormat
     */
    public patch(body: WorkbookChartPointFormat | undefined, requestConfiguration?: FormatRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookChartPointFormat | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: WorkbookChartPointFormat | undefined, requestConfiguration?: FormatRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeWorkbookChartPointFormat);
        return requestInfo;
    };
}
