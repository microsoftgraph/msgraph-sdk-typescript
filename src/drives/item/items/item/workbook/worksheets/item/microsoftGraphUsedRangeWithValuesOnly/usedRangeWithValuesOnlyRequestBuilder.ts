...
export class UsedRangeWithValuesOnlyRequestBuilder {
     ...
     */
    public get(requestConfiguration?: UsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookRange | undefined> {
