 ...
 */
export class ConvertToRangeRequestBuilder extends BaseRequestBuilder<ConvertToRangeRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/itemAt(index={index})/convertToRange", (x, y) => new ConvertToRangeRequestBuilder(x, y));
    }
    /**
