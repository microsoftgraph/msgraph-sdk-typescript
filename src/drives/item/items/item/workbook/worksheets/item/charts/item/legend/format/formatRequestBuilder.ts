...
export class FormatRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a Promise of WorkbookChartLegendFormat
     */
    public patch(body: WorkbookChartLegendFormat | undefined, requestConfiguration?: FormatRequestBuilderPatchRequestConfiguration | undefined) : Promise<WorkbookChartLegendFormat | undefined> {
