...
import { type RangeWithAddressRequestBuilderGetRequestConfiguration } from './rangeWithAddressRequestBuilderGetRequestConfiguration';
...
export class RangeWithAddressRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RangeWithAddressRequestBuilderGetRequestConfiguration | undefined) : Promise<WorkbookRange | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RangeWithAddressRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public withUrl(rawUrl: string) : RangeWithAddressRequestBuilder {
        if(!rawUrl) throw new Error("rawUrl cannot be undefined");
        return new RangeWithAddressRequestBuilder(rawUrl, this.requestAdapter);
    };
}
