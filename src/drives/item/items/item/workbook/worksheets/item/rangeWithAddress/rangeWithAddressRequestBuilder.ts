...
export class RangeWithAddressRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RangeWithAddressRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WorkbookRange | undefined> {
