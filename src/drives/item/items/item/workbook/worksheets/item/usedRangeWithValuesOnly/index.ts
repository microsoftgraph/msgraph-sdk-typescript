 ...
 */
export class UsedRangeWithValuesOnlyRequestBuilder extends BaseRequestBuilder<UsedRangeWithValuesOnlyRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, valuesOnly?: boolean | undefined) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/usedRange(valuesOnly={valuesOnly})", (x, y) => new UsedRangeWithValuesOnlyRequestBuilder(x, y));
