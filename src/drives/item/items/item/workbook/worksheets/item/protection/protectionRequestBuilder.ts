...
export class ProtectionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: ProtectionRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
