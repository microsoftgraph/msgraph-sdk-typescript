...
export class DataLabelsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: DataLabelsRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
