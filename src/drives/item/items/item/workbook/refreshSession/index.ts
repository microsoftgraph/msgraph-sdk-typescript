 ...
 */
export class RefreshSessionRequestBuilder extends BaseRequestBuilder<RefreshSessionRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/refreshSession", (x, y) => new RefreshSessionRequestBuilder(x, y));
    }
    /**
