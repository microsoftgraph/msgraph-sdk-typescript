...
export class ItemActivityStatItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: ItemActivityStatItemRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
