...
export class CopyPostRequestBody implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** The name property */
    private _name?: string | undefined;
    /** The parentReference property */
    private _parentReference?: ItemReference | CopyMember1 | undefined;
    /**
     ...
     */
    public set parentReference(value: ItemReference | CopyMember1 | undefined) {
