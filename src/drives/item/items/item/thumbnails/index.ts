...
import { createThumbnailSetCollectionResponseFromDiscriminatorValue, createThumbnailSetFromDiscriminatorValue, deserializeIntoThumbnailSet, serializeThumbnailSet, type ThumbnailSet, type ThumbnailSetCollectionResponse } from '../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ThumbnailSetItemRequestBuilder } from './item/';
 ...
 */
export class ThumbnailsRequestBuilder extends BaseRequestBuilder<ThumbnailsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/thumbnails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ThumbnailsRequestBuilder(x, y));
    }
    /**
