...
export class ExtractSensitivityLabelsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(requestConfiguration?: ExtractSensitivityLabelsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ExtractSensitivityLabelsResult | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ExtractSensitivityLabelsResult>(requestInfo, createExtractSensitivityLabelsResultFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Invoke action extractSensitivityLabels
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
