...
import { createDeltaWithTokenGetResponseFromDiscriminatorValue } from './deltaWithTokenGetResponse';
import { type DeltaWithTokenGetResponse } from './index';
...
export class DeltaWithTokenRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: DeltaWithTokenRequestBuilderGetRequestConfiguration | undefined) : Promise<DeltaWithTokenGetResponse | undefined> {
