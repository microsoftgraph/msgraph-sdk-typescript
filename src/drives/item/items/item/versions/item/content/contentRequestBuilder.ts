import { type DriveItemVersion } from '../../../../../../../models/';
import { createDriveItemVersionFromDiscriminatorValue } from '../../../../../../../models/driveItemVersion';
...
export class ContentRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/versions/{driveItemVersion%2Did}/content");
    };
    /**
     ...
     */
    public put(body: ArrayBuffer | undefined, requestConfiguration?: ContentRequestBuilderPutRequestConfiguration | undefined) : Promise<DriveItemVersion | undefined> {
