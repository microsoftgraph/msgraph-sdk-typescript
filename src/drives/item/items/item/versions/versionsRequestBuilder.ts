...
export class VersionsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DriveItemVersion | undefined, requestConfiguration?: VersionsRequestBuilderPostRequestConfiguration | undefined) : Promise<DriveItemVersion | undefined> {
