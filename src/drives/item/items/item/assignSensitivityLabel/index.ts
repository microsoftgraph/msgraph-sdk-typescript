...
export interface AssignSensitivityLabelPostRequestBody extends AdditionalDataHolder, Parsable {
     ...
     */
    assignmentMethod?: AssignSensitivityLabelPostRequestBody_assignmentMethod;
    /**
...
export function deserializeIntoAssignSensitivityLabelPostRequestBody(assignSensitivityLabelPostRequestBody: AssignSensitivityLabelPostRequestBody | undefined = {} as AssignSensitivityLabelPostRequestBody) : Record<string, (node: ParseNode) => void> {
    return {
        "assignmentMethod": n => { assignSensitivityLabelPostRequestBody.assignmentMethod = n.getEnumValue<AssignSensitivityLabelPostRequestBody_assignmentMethod>(AssignSensitivityLabelPostRequestBody_assignmentMethodObject); },
...
export function serializeAssignSensitivityLabelPostRequestBody(writer: SerializationWriter, assignSensitivityLabelPostRequestBody: AssignSensitivityLabelPostRequestBody | undefined = {} as AssignSensitivityLabelPostRequestBody) : void {
    writer.writeEnumValue<AssignSensitivityLabelPostRequestBody_assignmentMethod>("assignmentMethod", assignSensitivityLabelPostRequestBody.assignmentMethod);
