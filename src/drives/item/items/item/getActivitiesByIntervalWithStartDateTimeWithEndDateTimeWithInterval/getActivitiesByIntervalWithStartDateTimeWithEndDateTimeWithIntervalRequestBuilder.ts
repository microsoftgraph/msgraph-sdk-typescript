...
import { createGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalResponseFromDiscriminatorValue } from './getActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalResponse';
