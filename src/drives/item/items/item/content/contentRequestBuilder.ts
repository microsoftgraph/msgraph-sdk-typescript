...
/** Builds and executes requests for operations under /drives/{drive-id}/items/{driveItem-id}/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive_id}/items/{driveItem_id}/content";
