...
export class PermissionItemRequestBuilder extends BaseRequestBuilder<PermissionItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions/{permission%2Did}{?%24select,%24expand}", (x, y) => new PermissionItemRequestBuilder(x, y));
    }
    /**
