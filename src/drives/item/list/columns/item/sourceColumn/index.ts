...
export class SourceColumnRequestBuilder extends BaseRequestBuilder<SourceColumnRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}", (x, y) => new SourceColumnRequestBuilder(x, y));
    }
    /**
