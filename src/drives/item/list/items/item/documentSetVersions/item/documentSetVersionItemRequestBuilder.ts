...
export class DocumentSetVersionItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a Promise of DocumentSetVersion
     */
    public patch(body: DocumentSetVersion | undefined, requestConfiguration?: DocumentSetVersionItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<DocumentSetVersion | undefined> {
