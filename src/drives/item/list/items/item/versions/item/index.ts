 ...
 */
export const ListItemVersionItemRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
