...
/** Builds and executes requests for operations under /drives/{drive-id}/list/contentTypes/{contentType-id}/base/microsoft.graph.publish  */
export class PublishRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive_id}/list/contentTypes/{contentType_id}/base/microsoft.graph.publish";
