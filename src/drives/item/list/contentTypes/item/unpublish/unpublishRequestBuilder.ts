...
/** Builds and executes requests for operations under /drives/{drive-id}/list/contentTypes/{contentType-id}/microsoft.graph.unpublish  */
export class UnpublishRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive_id}/list/contentTypes/{contentType_id}/microsoft.graph.unpublish";
