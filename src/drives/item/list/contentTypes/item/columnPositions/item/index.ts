 ...
 */
export const ColumnDefinitionItemRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnPositions/{columnDefinition%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
