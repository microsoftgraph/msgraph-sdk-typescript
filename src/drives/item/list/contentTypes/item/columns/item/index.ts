...
export class ColumnDefinitionItemRequestBuilder extends BaseRequestBuilder<ColumnDefinitionItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}{?%24select,%24expand}", (x, y) => new ColumnDefinitionItemRequestBuilder(x, y));
    }
    /**
