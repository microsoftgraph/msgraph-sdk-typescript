...
export class ListRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.list.columns collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.list.contentTypes collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.list.items collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.list.subscriptions collection
     * @param id Unique identifier of the item
