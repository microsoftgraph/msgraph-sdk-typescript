...
export class ListRequestBuilder {
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.drives.list.columns collection
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.drives.list.contentTypes collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.drives.list.items collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the graphtypescriptv4.utilities.drives.list.subscriptions collection
     * @param id Unique identifier of the item
