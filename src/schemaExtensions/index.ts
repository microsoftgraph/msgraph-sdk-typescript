...
import { createSchemaExtensionCollectionResponseFromDiscriminatorValue, createSchemaExtensionFromDiscriminatorValue, deserializeIntoSchemaExtension, serializeSchemaExtension, type SchemaExtension, type SchemaExtensionCollectionResponse } from '../models/';
 ...
 */
export class SchemaExtensionsRequestBuilder extends BaseRequestBuilder<SchemaExtensionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/schemaExtensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SchemaExtensionsRequestBuilder(x, y));
    }
    /**
