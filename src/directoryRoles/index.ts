...
import { createDirectoryRoleCollectionResponseFromDiscriminatorValue, createDirectoryRoleFromDiscriminatorValue, deserializeIntoDirectoryRole, serializeDirectoryRole, type DirectoryRole, type DirectoryRoleCollectionResponse } from '../models/';
 ...
 */
export class DirectoryRolesRequestBuilder extends BaseRequestBuilder<DirectoryRolesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/directoryRoles{?%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DirectoryRolesRequestBuilder(x, y));
    }
    /**
