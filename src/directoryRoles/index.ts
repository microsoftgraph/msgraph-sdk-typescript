...
import { createDirectoryRoleCollectionResponseFromDiscriminatorValue, createDirectoryRoleFromDiscriminatorValue, serializeDirectoryRole, type DirectoryRole, type DirectoryRoleCollectionResponse } from '../models/';
