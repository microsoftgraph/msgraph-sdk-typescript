...
export class ScopedMembersRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ScopedRoleMembership | undefined, requestConfiguration?: ScopedMembersRequestBuilderPostRequestConfiguration | undefined) : Promise<ScopedRoleMembership | undefined> {
