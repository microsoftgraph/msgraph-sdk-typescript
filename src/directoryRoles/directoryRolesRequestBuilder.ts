...
export class DirectoryRolesRequestBuilder {
    ...
    public constructor(currentPath: string, httpCore: HttpCore, isRawUrl: boolean = true) {
        ...
        this.pathSegment = "/directoryRoles";
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: DirectoryRole | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DirectoryRolesResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<DirectoryRolesResponse>(requestInfo, DirectoryRolesResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Add new entity to directoryRoles
     * @param body 
     ...
     */
    public post(body: DirectoryRole | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DirectoryRole | undefined> {
        if(!body) throw new Error("body cannot be undefined");
