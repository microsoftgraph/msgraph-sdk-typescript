...
export class DirectoryRolesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DirectoryRolesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DirectoryRolesResponse).value = n.getCollectionOfObjectValues<DirectoryRole>(DirectoryRole); }],
        ]);
    };
    /**
