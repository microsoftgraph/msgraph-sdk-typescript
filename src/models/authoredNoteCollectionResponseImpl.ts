...
export class AuthoredNoteCollectionResponseImpl implements AuthoredNoteCollectionResponse {
    ...
    public constructor(authoredNoteCollectionResponseParameterValue?: AuthoredNoteCollectionResponse | undefined) {
        this._additionalData = authoredNoteCollectionResponseParameterValue?.additionalData ? authoredNoteCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = authoredNoteCollectionResponseParameterValue?.nextLink;
        this._value = authoredNoteCollectionResponseParameterValue?.value;
    };
    /**
