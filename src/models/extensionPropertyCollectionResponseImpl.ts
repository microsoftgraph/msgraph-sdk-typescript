...
export class ExtensionPropertyCollectionResponseImpl implements ExtensionPropertyCollectionResponse {
    ...
    public constructor(extensionPropertyCollectionResponseParameterValue?: ExtensionPropertyCollectionResponse | undefined) {
        this._additionalData = extensionPropertyCollectionResponseParameterValue?.additionalData ? extensionPropertyCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = extensionPropertyCollectionResponseParameterValue?.nextLink;
        this._value = extensionPropertyCollectionResponseParameterValue?.value;
    };
    /**
