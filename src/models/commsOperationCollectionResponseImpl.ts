...
export class CommsOperationCollectionResponseImpl implements CommsOperationCollectionResponse {
    ...
    public constructor(commsOperationCollectionResponseParameterValue?: CommsOperationCollectionResponse | undefined) {
        this._additionalData = commsOperationCollectionResponseParameterValue?.additionalData ? commsOperationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = commsOperationCollectionResponseParameterValue?.nextLink;
        this._value = commsOperationCollectionResponseParameterValue?.value;
    };
    /**
