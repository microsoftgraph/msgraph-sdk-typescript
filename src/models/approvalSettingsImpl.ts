...
export class ApprovalSettingsImpl implements ApprovalSettings {
    ...
    public constructor(approvalSettingsParameterValue?: ApprovalSettings | undefined) {
        ...
        const approvalStagesArrValue: UnifiedApprovalStageImpl[] = []; this.approvalStages?.forEach(element => {approvalStagesArrValue.push(element instanceof UnifiedApprovalStageImpl? element : new UnifiedApprovalStageImpl(element));});
