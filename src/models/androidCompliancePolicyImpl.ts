...
export class AndroidCompliancePolicyImpl extends DeviceCompliancePolicyImpl implements AndroidCompliancePolicy {
    ...
    public constructor(androidCompliancePolicyParameterValue?: AndroidCompliancePolicy | undefined) {
        ...
        this._deviceThreatProtectionEnabled = androidCompliancePolicyParameterValue?.deviceThreatProtectionEnabled;
        this._deviceThreatProtectionRequiredSecurityLevel = androidCompliancePolicyParameterValue?.deviceThreatProtectionRequiredSecurityLevel;
        this._minAndroidSecurityPatchLevel = androidCompliancePolicyParameterValue?.minAndroidSecurityPatchLevel;
        this._osMaximumVersion = androidCompliancePolicyParameterValue?.osMaximumVersion;
        this._osMinimumVersion = androidCompliancePolicyParameterValue?.osMinimumVersion;
        this._passwordExpirationDays = androidCompliancePolicyParameterValue?.passwordExpirationDays;
        this._passwordMinimumLength = androidCompliancePolicyParameterValue?.passwordMinimumLength;
        this._passwordMinutesOfInactivityBeforeLock = androidCompliancePolicyParameterValue?.passwordMinutesOfInactivityBeforeLock;
        this._passwordPreviousPasswordBlockCount = androidCompliancePolicyParameterValue?.passwordPreviousPasswordBlockCount;
        this._passwordRequired = androidCompliancePolicyParameterValue?.passwordRequired;
        this._passwordRequiredType = androidCompliancePolicyParameterValue?.passwordRequiredType;
        this._securityBlockJailbrokenDevices = androidCompliancePolicyParameterValue?.securityBlockJailbrokenDevices;
        this._securityDisableUsbDebugging = androidCompliancePolicyParameterValue?.securityDisableUsbDebugging;
        this._securityPreventInstallAppsFromUnknownSources = androidCompliancePolicyParameterValue?.securityPreventInstallAppsFromUnknownSources;
        this._securityRequireCompanyPortalAppIntegrity = androidCompliancePolicyParameterValue?.securityRequireCompanyPortalAppIntegrity;
        this._securityRequireGooglePlayServices = androidCompliancePolicyParameterValue?.securityRequireGooglePlayServices;
        this._securityRequireSafetyNetAttestationBasicIntegrity = androidCompliancePolicyParameterValue?.securityRequireSafetyNetAttestationBasicIntegrity;
        this._securityRequireSafetyNetAttestationCertifiedDevice = androidCompliancePolicyParameterValue?.securityRequireSafetyNetAttestationCertifiedDevice;
        this._securityRequireUpToDateSecurityProviders = androidCompliancePolicyParameterValue?.securityRequireUpToDateSecurityProviders;
        this._securityRequireVerifyApps = androidCompliancePolicyParameterValue?.securityRequireVerifyApps;
        this._storageRequireEncryption = androidCompliancePolicyParameterValue?.storageRequireEncryption;
    };
    /**
