...
import {AuthenticationMethodConfiguration, AuthenticationMethodConfigurationsMember1, AuthenticationMethodTarget, Fido2KeyRestrictions} from './index';
...
export class Fido2AuthenticationMethodConfiguration extends AuthenticationMethodConfiguration implements Parsable {
    ...
    private _keyRestrictions?: Fido2KeyRestrictions | AuthenticationMethodConfigurationsMember1 | undefined;
    /**
     ...
     */
    public set keyRestrictions(value: Fido2KeyRestrictions | AuthenticationMethodConfigurationsMember1 | undefined) {
