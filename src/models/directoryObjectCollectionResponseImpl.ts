...
export class DirectoryObjectCollectionResponseImpl implements DirectoryObjectCollectionResponse {
    ...
    public constructor(directoryObjectCollectionResponseParameterValue?: DirectoryObjectCollectionResponse | undefined) {
        this._additionalData = directoryObjectCollectionResponseParameterValue?.additionalData ? directoryObjectCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = directoryObjectCollectionResponseParameterValue?.nextLink;
        this._value = directoryObjectCollectionResponseParameterValue?.value;
    };
    /**
