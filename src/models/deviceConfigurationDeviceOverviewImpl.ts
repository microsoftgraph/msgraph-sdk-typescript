...
export class DeviceConfigurationDeviceOverviewImpl extends EntityImpl implements DeviceConfigurationDeviceOverview {
    ...
    public constructor(deviceConfigurationDeviceOverviewParameterValue?: DeviceConfigurationDeviceOverview | undefined) {
        super(deviceConfigurationDeviceOverviewParameterValue);
        this._configurationVersion = deviceConfigurationDeviceOverviewParameterValue?.configurationVersion;
        this._errorCount = deviceConfigurationDeviceOverviewParameterValue?.errorCount;
        this._failedCount = deviceConfigurationDeviceOverviewParameterValue?.failedCount;
        this._lastUpdateDateTime = deviceConfigurationDeviceOverviewParameterValue?.lastUpdateDateTime;
        this._notApplicableCount = deviceConfigurationDeviceOverviewParameterValue?.notApplicableCount;
        this._pendingCount = deviceConfigurationDeviceOverviewParameterValue?.pendingCount;
        this._successCount = deviceConfigurationDeviceOverviewParameterValue?.successCount;
    };
    /**
