...
import {AuthenticationMethodConfiguration, AuthenticationMethodConfigurationsMember1, AuthenticationMethodTarget} from './index';
...
export class EmailAuthenticationMethodConfiguration extends AuthenticationMethodConfiguration implements Parsable {
    ...
    private _allowExternalIdToUseEmailOtp?: ExternalEmailOtpState | AuthenticationMethodConfigurationsMember1 | undefined;
     ...
     */
    public set allowExternalIdToUseEmailOtp(value: ExternalEmailOtpState | AuthenticationMethodConfigurationsMember1 | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "allowExternalIdToUseEmailOtp": n => { this.allowExternalIdToUseEmailOtp = n.getObjectValue<ExternalEmailOtpState>(createExternalEmailOtpStateFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<ExternalEmailOtpState>("allowExternalIdToUseEmailOtp", this.allowExternalIdToUseEmailOtp);
