...
export class PrintTaskDefinitionCollectionResponseImpl implements PrintTaskDefinitionCollectionResponse {
    ...
    public constructor(printTaskDefinitionCollectionResponseParameterValue?: PrintTaskDefinitionCollectionResponse | undefined) {
        this._additionalData = printTaskDefinitionCollectionResponseParameterValue?.additionalData ? printTaskDefinitionCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = printTaskDefinitionCollectionResponseParameterValue?.nextLink;
        this._value = printTaskDefinitionCollectionResponseParameterValue?.value;
    };
    /**
