...
export class SharingLinkImpl implements SharingLink {
    ...
    public constructor(sharingLinkParameterValue?: SharingLink | undefined) {
        this._additionalData = sharingLinkParameterValue?.additionalData ? sharingLinkParameterValue?.additionalData! : {};
        this._application = sharingLinkParameterValue?.application;
        this._preventsDownload = sharingLinkParameterValue?.preventsDownload;
        this._scope = sharingLinkParameterValue?.scope;
        this._type = sharingLinkParameterValue?.type;
        this._webHtml = sharingLinkParameterValue?.webHtml;
        this._webUrl = sharingLinkParameterValue?.webUrl;
    };
    /**
