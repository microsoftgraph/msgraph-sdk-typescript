...
export class ChatMessageCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ChatMessageCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ChatMessageCollectionResponse).value = n.getCollectionOfObjectValues<ChatMessage>(createChatMessageFromDiscriminatorValue); },
        };
    };
    /**
