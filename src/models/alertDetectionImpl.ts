...
export class AlertDetectionImpl implements AlertDetection {
    ...
    public constructor(alertDetectionParameterValue?: AlertDetection | undefined) {
        this._additionalData = alertDetectionParameterValue?.additionalData ? alertDetectionParameterValue?.additionalData! : {};
        this._detectionType = alertDetectionParameterValue?.detectionType;
        this._method = alertDetectionParameterValue?.method;
        this._name = alertDetectionParameterValue?.name;
    };
    /**
