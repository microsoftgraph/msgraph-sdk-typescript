...
export class DeviceConfigurationUserOverviewImpl extends EntityImpl implements DeviceConfigurationUserOverview {
    ...
    public constructor(deviceConfigurationUserOverviewParameterValue?: DeviceConfigurationUserOverview | undefined) {
        ...
        this._configurationVersion = deviceConfigurationUserOverviewParameterValue?.configurationVersion;
        this._errorCount = deviceConfigurationUserOverviewParameterValue?.errorCount;
        this._failedCount = deviceConfigurationUserOverviewParameterValue?.failedCount;
        this._lastUpdateDateTime = deviceConfigurationUserOverviewParameterValue?.lastUpdateDateTime;
        this._notApplicableCount = deviceConfigurationUserOverviewParameterValue?.notApplicableCount;
        this._pendingCount = deviceConfigurationUserOverviewParameterValue?.pendingCount;
        this._successCount = deviceConfigurationUserOverviewParameterValue?.successCount;
    };
    /**
