...
export class DeviceAndAppManagementRoleAssignmentCollectionResponseImpl implements AdditionalDataHolder, DeviceAndAppManagementRoleAssignmentCollectionResponse, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value){
        const valueArrValue: DeviceAndAppManagementRoleAssignmentImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new DeviceAndAppManagementRoleAssignmentImpl(element));});
