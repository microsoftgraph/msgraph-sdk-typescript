...
export class EducationAssignmentCollectionResponseImpl implements AdditionalDataHolder, EducationAssignmentCollectionResponse, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value){
        const valueArrValue: EducationAssignmentImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new EducationAssignmentImpl(element));});
