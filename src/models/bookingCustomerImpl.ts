...
export class BookingCustomerImpl extends BookingCustomerBaseImpl implements BookingCustomer {
    ...
    public constructor(bookingCustomerParameterValue?: BookingCustomer | undefined) {
        ...
        const addressesArrValue: PhysicalAddressImpl[] = []; this.addresses?.forEach(element => {addressesArrValue.push(element instanceof PhysicalAddressImpl? element : new PhysicalAddressImpl(element));});
