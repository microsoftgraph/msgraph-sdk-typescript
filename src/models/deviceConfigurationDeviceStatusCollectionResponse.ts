...
export class DeviceConfigurationDeviceStatusCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DeviceConfigurationDeviceStatusCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DeviceConfigurationDeviceStatusCollectionResponse).value = n.getCollectionOfObjectValues<DeviceConfigurationDeviceStatus>(createDeviceConfigurationDeviceStatusFromDiscriminatorValue); },
        };
    };
    /**
