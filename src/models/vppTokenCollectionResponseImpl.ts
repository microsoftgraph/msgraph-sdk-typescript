...
export class VppTokenCollectionResponseImpl implements VppTokenCollectionResponse {
    ...
    public constructor(vppTokenCollectionResponseParameterValue?: VppTokenCollectionResponse | undefined) {
        this._additionalData = vppTokenCollectionResponseParameterValue?.additionalData ? vppTokenCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = vppTokenCollectionResponseParameterValue?.nextLink;
        this._value = vppTokenCollectionResponseParameterValue?.value;
    };
    /**
