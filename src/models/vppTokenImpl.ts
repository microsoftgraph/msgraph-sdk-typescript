...
export class VppTokenImpl extends EntityImpl implements VppToken {
    ...
    public constructor(vppTokenParameterValue?: VppToken | undefined) {
        ...
        this._appleId = vppTokenParameterValue?.appleId;
        this._automaticallyUpdateApps = vppTokenParameterValue?.automaticallyUpdateApps;
        this._countryOrRegion = vppTokenParameterValue?.countryOrRegion;
        this._expirationDateTime = vppTokenParameterValue?.expirationDateTime;
        this._lastModifiedDateTime = vppTokenParameterValue?.lastModifiedDateTime;
        this._lastSyncDateTime = vppTokenParameterValue?.lastSyncDateTime;
        this._lastSyncStatus = vppTokenParameterValue?.lastSyncStatus;
        this._organizationName = vppTokenParameterValue?.organizationName;
        this._state = vppTokenParameterValue?.state;
        this._token = vppTokenParameterValue?.token;
        this._vppTokenAccountType = vppTokenParameterValue?.vppTokenAccountType;
    };
    /**
