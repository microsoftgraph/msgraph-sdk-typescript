...
export class TeleconferenceDeviceMediaQualityImpl implements TeleconferenceDeviceMediaQuality {
    ...
    public constructor(teleconferenceDeviceMediaQualityParameterValue?: TeleconferenceDeviceMediaQuality | undefined) {
        this._additionalData = teleconferenceDeviceMediaQualityParameterValue?.additionalData ? teleconferenceDeviceMediaQualityParameterValue?.additionalData! : {};
        this._averageInboundJitter = teleconferenceDeviceMediaQualityParameterValue?.averageInboundJitter;
        this._averageInboundPacketLossRateInPercentage = teleconferenceDeviceMediaQualityParameterValue?.averageInboundPacketLossRateInPercentage;
        this._averageInboundRoundTripDelay = teleconferenceDeviceMediaQualityParameterValue?.averageInboundRoundTripDelay;
        this._averageOutboundJitter = teleconferenceDeviceMediaQualityParameterValue?.averageOutboundJitter;
        this._averageOutboundPacketLossRateInPercentage = teleconferenceDeviceMediaQualityParameterValue?.averageOutboundPacketLossRateInPercentage;
        this._averageOutboundRoundTripDelay = teleconferenceDeviceMediaQualityParameterValue?.averageOutboundRoundTripDelay;
        this._channelIndex = teleconferenceDeviceMediaQualityParameterValue?.channelIndex;
        this._inboundPackets = teleconferenceDeviceMediaQualityParameterValue?.inboundPackets;
        this._localIPAddress = teleconferenceDeviceMediaQualityParameterValue?.localIPAddress;
        this._localPort = teleconferenceDeviceMediaQualityParameterValue?.localPort;
        this._maximumInboundJitter = teleconferenceDeviceMediaQualityParameterValue?.maximumInboundJitter;
        this._maximumInboundPacketLossRateInPercentage = teleconferenceDeviceMediaQualityParameterValue?.maximumInboundPacketLossRateInPercentage;
        this._maximumInboundRoundTripDelay = teleconferenceDeviceMediaQualityParameterValue?.maximumInboundRoundTripDelay;
        this._maximumOutboundJitter = teleconferenceDeviceMediaQualityParameterValue?.maximumOutboundJitter;
        this._maximumOutboundPacketLossRateInPercentage = teleconferenceDeviceMediaQualityParameterValue?.maximumOutboundPacketLossRateInPercentage;
        this._maximumOutboundRoundTripDelay = teleconferenceDeviceMediaQualityParameterValue?.maximumOutboundRoundTripDelay;
        this._mediaDuration = teleconferenceDeviceMediaQualityParameterValue?.mediaDuration;
        this._networkLinkSpeedInBytes = teleconferenceDeviceMediaQualityParameterValue?.networkLinkSpeedInBytes;
        this._outboundPackets = teleconferenceDeviceMediaQualityParameterValue?.outboundPackets;
        this._remoteIPAddress = teleconferenceDeviceMediaQualityParameterValue?.remoteIPAddress;
        this._remotePort = teleconferenceDeviceMediaQualityParameterValue?.remotePort;
    };
    /**
