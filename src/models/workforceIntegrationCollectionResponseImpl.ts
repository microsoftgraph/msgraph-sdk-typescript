...
export class WorkforceIntegrationCollectionResponseImpl implements WorkforceIntegrationCollectionResponse {
    ...
    public constructor(workforceIntegrationCollectionResponseParameterValue?: WorkforceIntegrationCollectionResponse | undefined) {
        this._additionalData = workforceIntegrationCollectionResponseParameterValue?.additionalData ? workforceIntegrationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = workforceIntegrationCollectionResponseParameterValue?.nextLink;
        this._value = workforceIntegrationCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "value": n => { this.value = n.getCollectionOfObjectValues<WorkforceIntegrationImpl>(createWorkforceIntegrationFromDiscriminatorValue); },
        };
    };
    /**
