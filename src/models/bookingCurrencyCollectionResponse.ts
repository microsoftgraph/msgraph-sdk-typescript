...
export class BookingCurrencyCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as BookingCurrencyCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as BookingCurrencyCollectionResponse).value = n.getCollectionOfObjectValues<BookingCurrency>(createBookingCurrencyFromDiscriminatorValue); },
        };
    };
    /**
