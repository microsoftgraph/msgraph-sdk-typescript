...
export class ManagedDeviceMobileAppConfigurationUserStatusCollectionResponseImpl implements ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse {
    ...
    public constructor(managedDeviceMobileAppConfigurationUserStatusCollectionResponseParameterValue?: ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse | undefined) {
        this._additionalData = managedDeviceMobileAppConfigurationUserStatusCollectionResponseParameterValue?.additionalData ? managedDeviceMobileAppConfigurationUserStatusCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = managedDeviceMobileAppConfigurationUserStatusCollectionResponseParameterValue?.nextLink;
        this._value = managedDeviceMobileAppConfigurationUserStatusCollectionResponseParameterValue?.value;
    };
    /**
