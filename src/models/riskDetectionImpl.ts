...
export class RiskDetectionImpl extends EntityImpl implements RiskDetection {
    ...
    public constructor(riskDetectionParameterValue?: RiskDetection | undefined) {
        ...
        this._activity = riskDetectionParameterValue?.activity;
        this._activityDateTime = riskDetectionParameterValue?.activityDateTime;
        this._additionalInfo = riskDetectionParameterValue?.additionalInfo;
        this._correlationId = riskDetectionParameterValue?.correlationId;
        this._detectedDateTime = riskDetectionParameterValue?.detectedDateTime;
        this._detectionTimingType = riskDetectionParameterValue?.detectionTimingType;
        this._ipAddress = riskDetectionParameterValue?.ipAddress;
        this._lastUpdatedDateTime = riskDetectionParameterValue?.lastUpdatedDateTime;
        this._location = riskDetectionParameterValue?.location;
        this._requestId = riskDetectionParameterValue?.requestId;
        this._riskDetail = riskDetectionParameterValue?.riskDetail;
        this._riskEventType = riskDetectionParameterValue?.riskEventType;
        this._riskLevel = riskDetectionParameterValue?.riskLevel;
        this._riskState = riskDetectionParameterValue?.riskState;
        this._source = riskDetectionParameterValue?.source;
        this._tokenIssuerType = riskDetectionParameterValue?.tokenIssuerType;
        this._userDisplayName = riskDetectionParameterValue?.userDisplayName;
        this._userId = riskDetectionParameterValue?.userId;
        this._userPrincipalName = riskDetectionParameterValue?.userPrincipalName;
    };
    /**
