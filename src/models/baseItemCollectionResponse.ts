...
export class BaseItemCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as BaseItemCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as BaseItemCollectionResponse).value = n.getCollectionOfObjectValues<BaseItem>(createBaseItemFromDiscriminatorValue); },
        };
    };
    /**
