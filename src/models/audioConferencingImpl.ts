...
export class AudioConferencingImpl implements AudioConferencing {
    ...
    public constructor(audioConferencingParameterValue?: AudioConferencing | undefined) {
        this._additionalData = audioConferencingParameterValue?.additionalData ? audioConferencingParameterValue?.additionalData! : {};
        this._conferenceId = audioConferencingParameterValue?.conferenceId;
        this._dialinUrl = audioConferencingParameterValue?.dialinUrl;
        this._tollFreeNumber = audioConferencingParameterValue?.tollFreeNumber;
        this._tollFreeNumbers = audioConferencingParameterValue?.tollFreeNumbers;
        this._tollNumber = audioConferencingParameterValue?.tollNumber;
        this._tollNumbers = audioConferencingParameterValue?.tollNumbers;
    };
    /**
