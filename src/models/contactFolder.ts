...
export function serializeContactFolder(writer: SerializationWriter, contactFolder: ContactFolder | undefined = {} as ContactFolder) : void {
        ...
        writer.writeCollectionOfObjectValues<ContactFolder>("childFolders", contactFolder.childFolders, );
        writer.writeCollectionOfObjectValues<Contact>("contacts", contactFolder.contacts, );
        writer.writeStringValue("displayName", contactFolder.displayName);
        writer.writeCollectionOfObjectValues<MultiValueLegacyExtendedProperty>("multiValueExtendedProperties", contactFolder.multiValueExtendedProperties, );
        writer.writeStringValue("parentFolderId", contactFolder.parentFolderId);
        writer.writeCollectionOfObjectValues<SingleValueLegacyExtendedProperty>("singleValueExtendedProperties", contactFolder.singleValueExtendedProperties, );
}
// tslint:enable
// eslint-enable
