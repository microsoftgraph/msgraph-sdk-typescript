...
export class ServiceHealthCollectionResponseImpl implements ServiceHealthCollectionResponse {
    ...
    public constructor(serviceHealthCollectionResponseParameterValue?: ServiceHealthCollectionResponse | undefined) {
        this._additionalData = serviceHealthCollectionResponseParameterValue?.additionalData ? serviceHealthCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = serviceHealthCollectionResponseParameterValue?.nextLink;
        this._value = serviceHealthCollectionResponseParameterValue?.value;
    };
    /**
