...
export class AdministrativeUnitCollectionResponseImpl implements AdministrativeUnitCollectionResponse {
    ...
    public constructor(administrativeUnitCollectionResponseParameterValue?: AdministrativeUnitCollectionResponse | undefined) {
        this._additionalData = administrativeUnitCollectionResponseParameterValue?.additionalData ? administrativeUnitCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = administrativeUnitCollectionResponseParameterValue?.nextLink;
        this._value = administrativeUnitCollectionResponseParameterValue?.value;
    };
    /**
