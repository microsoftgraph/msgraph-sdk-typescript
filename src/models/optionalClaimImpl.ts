...
export class OptionalClaimImpl implements OptionalClaim {
    ...
    public constructor(optionalClaimParameterValue?: OptionalClaim | undefined) {
        this._additionalData = optionalClaimParameterValue?.additionalData ? optionalClaimParameterValue?.additionalData! : {};
        this._additionalProperties = optionalClaimParameterValue?.additionalProperties;
        this._essential = optionalClaimParameterValue?.essential;
        this._name = optionalClaimParameterValue?.name;
        this._source = optionalClaimParameterValue?.source;
    };
    /**
