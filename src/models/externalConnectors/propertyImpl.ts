...
export class PropertyImpl implements Property {
    ...
    public constructor(propertyParameterValue?: Property | undefined) {
        this._additionalData = propertyParameterValue?.additionalData ? propertyParameterValue?.additionalData! : {};
        this._aliases = propertyParameterValue?.aliases;
        this._isQueryable = propertyParameterValue?.isQueryable;
        this._isRefinable = propertyParameterValue?.isRefinable;
        this._isRetrievable = propertyParameterValue?.isRetrievable;
        this._isSearchable = propertyParameterValue?.isSearchable;
        this._labels = propertyParameterValue?.labels;
        this._name = propertyParameterValue?.name;
        this._type = propertyParameterValue?.type;
    };
    /**
