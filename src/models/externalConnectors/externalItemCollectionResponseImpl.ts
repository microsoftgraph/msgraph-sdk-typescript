...
export class ExternalItemCollectionResponseImpl implements ExternalItemCollectionResponse {
    ...
    public constructor(externalItemCollectionResponseParameterValue?: ExternalItemCollectionResponse | undefined) {
        this._additionalData = externalItemCollectionResponseParameterValue?.additionalData ? externalItemCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = externalItemCollectionResponseParameterValue?.nextLink;
        this._value = externalItemCollectionResponseParameterValue?.value;
    };
    /**
