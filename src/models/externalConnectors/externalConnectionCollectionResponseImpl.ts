...
export class ExternalConnectionCollectionResponseImpl implements ExternalConnectionCollectionResponse {
    ...
    public constructor(externalConnectionCollectionResponseParameterValue?: ExternalConnectionCollectionResponse | undefined) {
        this._additionalData = externalConnectionCollectionResponseParameterValue?.additionalData ? externalConnectionCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = externalConnectionCollectionResponseParameterValue?.nextLink;
        this._value = externalConnectionCollectionResponseParameterValue?.value;
    };
    /**
