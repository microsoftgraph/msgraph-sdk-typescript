...
export class ThreatAssessmentResultImpl extends EntityImpl implements ThreatAssessmentResult {
    ...
    public constructor(threatAssessmentResultParameterValue?: ThreatAssessmentResult | undefined) {
        ...
        this._createdDateTime = threatAssessmentResultParameterValue?.createdDateTime;
        this._message = threatAssessmentResultParameterValue?.message;
        this._resultType = threatAssessmentResultParameterValue?.resultType;
    };
    /**
