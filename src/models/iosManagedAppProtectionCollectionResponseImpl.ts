...
export class IosManagedAppProtectionCollectionResponseImpl implements IosManagedAppProtectionCollectionResponse {
    ...
    public constructor(iosManagedAppProtectionCollectionResponseParameterValue?: IosManagedAppProtectionCollectionResponse | undefined) {
        this._additionalData = iosManagedAppProtectionCollectionResponseParameterValue?.additionalData ? iosManagedAppProtectionCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = iosManagedAppProtectionCollectionResponseParameterValue?.nextLink;
        this._value = iosManagedAppProtectionCollectionResponseParameterValue?.value;
    };
    /**
