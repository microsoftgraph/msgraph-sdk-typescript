...
export class ResourceVisualizationImpl implements ResourceVisualization {
    ...
    public constructor(resourceVisualizationParameterValue?: ResourceVisualization | undefined) {
        this._additionalData = resourceVisualizationParameterValue?.additionalData ? resourceVisualizationParameterValue?.additionalData! : {};
        this._containerDisplayName = resourceVisualizationParameterValue?.containerDisplayName;
        this._containerType = resourceVisualizationParameterValue?.containerType;
        this._containerWebUrl = resourceVisualizationParameterValue?.containerWebUrl;
        this._mediaType = resourceVisualizationParameterValue?.mediaType;
        this._previewImageUrl = resourceVisualizationParameterValue?.previewImageUrl;
        this._previewText = resourceVisualizationParameterValue?.previewText;
        this._title = resourceVisualizationParameterValue?.title;
        this._type = resourceVisualizationParameterValue?.type;
    };
    /**
