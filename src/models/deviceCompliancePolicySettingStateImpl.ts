...
export class DeviceCompliancePolicySettingStateImpl implements DeviceCompliancePolicySettingState {
    ...
    public constructor(deviceCompliancePolicySettingStateParameterValue?: DeviceCompliancePolicySettingState | undefined) {
        this._additionalData = deviceCompliancePolicySettingStateParameterValue?.additionalData ? deviceCompliancePolicySettingStateParameterValue?.additionalData! : {};
        this._currentValue = deviceCompliancePolicySettingStateParameterValue?.currentValue;
        this._errorCode = deviceCompliancePolicySettingStateParameterValue?.errorCode;
        this._errorDescription = deviceCompliancePolicySettingStateParameterValue?.errorDescription;
        this._instanceDisplayName = deviceCompliancePolicySettingStateParameterValue?.instanceDisplayName;
        this._setting = deviceCompliancePolicySettingStateParameterValue?.setting;
        this._settingName = deviceCompliancePolicySettingStateParameterValue?.settingName;
        this._sources = deviceCompliancePolicySettingStateParameterValue?.sources;
        this._state = deviceCompliancePolicySettingStateParameterValue?.state;
        this._userEmail = deviceCompliancePolicySettingStateParameterValue?.userEmail;
        this._userId = deviceCompliancePolicySettingStateParameterValue?.userId;
        this._userName = deviceCompliancePolicySettingStateParameterValue?.userName;
        this._userPrincipalName = deviceCompliancePolicySettingStateParameterValue?.userPrincipalName;
    };
    /**
