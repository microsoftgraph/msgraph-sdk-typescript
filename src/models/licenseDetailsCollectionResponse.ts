...
export class LicenseDetailsCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as LicenseDetailsCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as LicenseDetailsCollectionResponse).value = n.getCollectionOfObjectValues<LicenseDetails>(createLicenseDetailsFromDiscriminatorValue); },
        };
    };
    /**
