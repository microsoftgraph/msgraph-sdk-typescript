...
export class TermCollectionResponseImpl implements TermCollectionResponse {
    ...
    public constructor(termCollectionResponseParameterValue?: TermCollectionResponse | undefined) {
        this._additionalData = termCollectionResponseParameterValue?.additionalData ? termCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = termCollectionResponseParameterValue?.nextLink;
        this._value = termCollectionResponseParameterValue?.value;
    };
    /**
