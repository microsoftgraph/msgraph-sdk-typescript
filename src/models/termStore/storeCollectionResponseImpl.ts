...
export class StoreCollectionResponseImpl implements StoreCollectionResponse {
     ...
     * @param storeCollectionResponseParameterValue 
     */
    public constructor(storeCollectionResponseParameterValue?: StoreCollectionResponse | undefined) {
        this._additionalData = storeCollectionResponseParameterValue?.additionalData ? storeCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = storeCollectionResponseParameterValue?.nextLink;
        this._value = storeCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "value": n => { this.value = n.getCollectionOfObjectValues<StoreImpl>(createStoreFromDiscriminatorValue); },
        };
    };
    /**
