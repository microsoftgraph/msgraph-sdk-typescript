...
export class LocalizedNameImpl implements LocalizedName {
    ...
    public constructor(localizedNameParameterValue?: LocalizedName | undefined) {
        this._additionalData = localizedNameParameterValue?.additionalData ? localizedNameParameterValue?.additionalData! : {};
        this._languageTag = localizedNameParameterValue?.languageTag;
        this._name = localizedNameParameterValue?.name;
    };
    /**
