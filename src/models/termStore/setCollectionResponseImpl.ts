...
export class SetCollectionResponseImpl implements SetCollectionResponse {
    ...
    public constructor(setCollectionResponseParameterValue?: SetCollectionResponse | undefined) {
        this._additionalData = setCollectionResponseParameterValue?.additionalData ? setCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = setCollectionResponseParameterValue?.nextLink;
        this._value = setCollectionResponseParameterValue?.value;
    };
    /**
