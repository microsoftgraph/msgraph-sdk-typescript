...
export class OfferShiftRequestCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as OfferShiftRequestCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as OfferShiftRequestCollectionResponse).value = n.getCollectionOfObjectValues<OfferShiftRequest>(createOfferShiftRequestFromDiscriminatorValue); },
        };
    };
    /**
