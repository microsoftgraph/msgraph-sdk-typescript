...
export class Windows10MobileCompliancePolicyImpl extends DeviceCompliancePolicyImpl implements Windows10MobileCompliancePolicy {
    ...
    public constructor(windows10MobileCompliancePolicyParameterValue?: Windows10MobileCompliancePolicy | undefined) {
        ...
        this._bitLockerEnabled = windows10MobileCompliancePolicyParameterValue?.bitLockerEnabled;
        this._codeIntegrityEnabled = windows10MobileCompliancePolicyParameterValue?.codeIntegrityEnabled;
        this._earlyLaunchAntiMalwareDriverEnabled = windows10MobileCompliancePolicyParameterValue?.earlyLaunchAntiMalwareDriverEnabled;
        this._osMaximumVersion = windows10MobileCompliancePolicyParameterValue?.osMaximumVersion;
        this._osMinimumVersion = windows10MobileCompliancePolicyParameterValue?.osMinimumVersion;
        this._passwordBlockSimple = windows10MobileCompliancePolicyParameterValue?.passwordBlockSimple;
        this._passwordExpirationDays = windows10MobileCompliancePolicyParameterValue?.passwordExpirationDays;
        this._passwordMinimumCharacterSetCount = windows10MobileCompliancePolicyParameterValue?.passwordMinimumCharacterSetCount;
        this._passwordMinimumLength = windows10MobileCompliancePolicyParameterValue?.passwordMinimumLength;
        this._passwordMinutesOfInactivityBeforeLock = windows10MobileCompliancePolicyParameterValue?.passwordMinutesOfInactivityBeforeLock;
        this._passwordPreviousPasswordBlockCount = windows10MobileCompliancePolicyParameterValue?.passwordPreviousPasswordBlockCount;
        this._passwordRequired = windows10MobileCompliancePolicyParameterValue?.passwordRequired;
        this._passwordRequiredType = windows10MobileCompliancePolicyParameterValue?.passwordRequiredType;
        this._passwordRequireToUnlockFromIdle = windows10MobileCompliancePolicyParameterValue?.passwordRequireToUnlockFromIdle;
        this._secureBootEnabled = windows10MobileCompliancePolicyParameterValue?.secureBootEnabled;
        this._storageRequireEncryption = windows10MobileCompliancePolicyParameterValue?.storageRequireEncryption;
    };
    /**
