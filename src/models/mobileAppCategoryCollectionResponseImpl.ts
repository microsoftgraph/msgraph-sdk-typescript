...
export class MobileAppCategoryCollectionResponseImpl implements MobileAppCategoryCollectionResponse {
    ...
    public constructor(mobileAppCategoryCollectionResponseParameterValue?: MobileAppCategoryCollectionResponse | undefined) {
        this._additionalData = mobileAppCategoryCollectionResponseParameterValue?.additionalData ? mobileAppCategoryCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = mobileAppCategoryCollectionResponseParameterValue?.nextLink;
        this._value = mobileAppCategoryCollectionResponseParameterValue?.value;
    };
    /**
