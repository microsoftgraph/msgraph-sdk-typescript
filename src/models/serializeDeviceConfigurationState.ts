...
export function serializeDeviceConfigurationState(deviceConfigurationState: DeviceConfigurationState | undefined = {} as DeviceConfigurationState, writer: SerializationWriter) : void {
