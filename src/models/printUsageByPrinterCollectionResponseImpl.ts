...
export class PrintUsageByPrinterCollectionResponseImpl implements PrintUsageByPrinterCollectionResponse {
    ...
    public constructor(printUsageByPrinterCollectionResponseParameterValue?: PrintUsageByPrinterCollectionResponse | undefined) {
        this._additionalData = printUsageByPrinterCollectionResponseParameterValue?.additionalData ? printUsageByPrinterCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = printUsageByPrinterCollectionResponseParameterValue?.nextLink;
        this._value = printUsageByPrinterCollectionResponseParameterValue?.value;
    };
    /**
