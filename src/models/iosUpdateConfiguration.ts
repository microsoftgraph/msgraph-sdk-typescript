...
export interface IosUpdateConfiguration extends Partial<AdditionalDataHolder>, DeviceConfiguration, Partial<Parsable> {
    ...
    scheduledInstallDays?: string[] | undefined;
