...
export class IosUpdateConfiguration extends DeviceConfiguration implements Parsable {
    ...
    private _scheduledInstallDays?: DayOfWeek[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "scheduledInstallDays": n => { this.scheduledInstallDays = n.getEnumValues<DayOfWeek>(DayOfWeek); },
     ...
     */
    public set scheduledInstallDays(value: DayOfWeek[] | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        this.scheduledInstallDays && writer.writeEnumValue<DayOfWeek>("scheduledInstallDays", ...this.scheduledInstallDays);
