...
export class ClaimsMappingPolicyCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ClaimsMappingPolicyCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ClaimsMappingPolicyCollectionResponse).value = n.getCollectionOfObjectValues<ClaimsMappingPolicy>(createClaimsMappingPolicyFromDiscriminatorValue); },
        };
    };
    /**
