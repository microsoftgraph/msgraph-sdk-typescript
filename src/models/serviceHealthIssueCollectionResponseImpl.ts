...
export class ServiceHealthIssueCollectionResponseImpl implements ServiceHealthIssueCollectionResponse {
    ...
    public constructor(serviceHealthIssueCollectionResponseParameterValue?: ServiceHealthIssueCollectionResponse | undefined) {
        this._additionalData = serviceHealthIssueCollectionResponseParameterValue?.additionalData ? serviceHealthIssueCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = serviceHealthIssueCollectionResponseParameterValue?.nextLink;
        this._value = serviceHealthIssueCollectionResponseParameterValue?.value;
    };
    /**
