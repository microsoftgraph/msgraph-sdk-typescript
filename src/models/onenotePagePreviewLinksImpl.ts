...
export class OnenotePagePreviewLinksImpl implements OnenotePagePreviewLinks {
    ...
    public constructor(onenotePagePreviewLinksParameterValue?: OnenotePagePreviewLinks | undefined) {
        this._additionalData = onenotePagePreviewLinksParameterValue?.additionalData ? onenotePagePreviewLinksParameterValue?.additionalData! : {};
        this._previewImageUrl = onenotePagePreviewLinksParameterValue?.previewImageUrl;
    };
    /**
