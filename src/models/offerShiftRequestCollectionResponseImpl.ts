...
export class OfferShiftRequestCollectionResponseImpl implements OfferShiftRequestCollectionResponse {
    ...
    public constructor(offerShiftRequestCollectionResponseParameterValue?: OfferShiftRequestCollectionResponse | undefined) {
        this._additionalData = offerShiftRequestCollectionResponseParameterValue?.additionalData ? offerShiftRequestCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = offerShiftRequestCollectionResponseParameterValue?.nextLink;
        this._value = offerShiftRequestCollectionResponseParameterValue?.value;
    };
    /**
