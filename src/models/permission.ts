...
export function serializePermission(writer: SerializationWriter, permission: Permission | undefined = {} as Permission) : void {
        ...
        writer.writeObjectValue<IdentitySet>("grantedTo", permission.grantedTo, );
        writer.writeCollectionOfObjectValues<IdentitySet>("grantedToIdentities", permission.grantedToIdentities, );
        writer.writeCollectionOfObjectValues<SharePointIdentitySet>("grantedToIdentitiesV2", permission.grantedToIdentitiesV2, );
        writer.writeObjectValue<SharePointIdentitySet>("grantedToV2", permission.grantedToV2, );
        writer.writeBooleanValue("hasPassword", permission.hasPassword);
        writer.writeObjectValue<ItemReference>("inheritedFrom", permission.inheritedFrom, );
        writer.writeObjectValue<SharingInvitation>("invitation", permission.invitation, );
        writer.writeObjectValue<SharingLink>("link", permission.link, );
