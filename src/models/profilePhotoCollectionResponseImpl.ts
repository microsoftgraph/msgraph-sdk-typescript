...
export class ProfilePhotoCollectionResponseImpl implements ProfilePhotoCollectionResponse {
    ...
    public constructor(profilePhotoCollectionResponseParameterValue?: ProfilePhotoCollectionResponse | undefined) {
        this._additionalData = profilePhotoCollectionResponseParameterValue?.additionalData ? profilePhotoCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = profilePhotoCollectionResponseParameterValue?.nextLink;
        this._value = profilePhotoCollectionResponseParameterValue?.value;
    };
    /**
