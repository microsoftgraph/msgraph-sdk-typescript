...
export class ConditionalAccessApplicationsImpl implements ConditionalAccessApplications {
    ...
    public constructor(conditionalAccessApplicationsParameterValue?: ConditionalAccessApplications | undefined) {
        this._additionalData = conditionalAccessApplicationsParameterValue?.additionalData ? conditionalAccessApplicationsParameterValue?.additionalData! : {};
        this._excludeApplications = conditionalAccessApplicationsParameterValue?.excludeApplications;
        this._includeApplications = conditionalAccessApplicationsParameterValue?.includeApplications;
        this._includeAuthenticationContextClassReferences = conditionalAccessApplicationsParameterValue?.includeAuthenticationContextClassReferences;
        this._includeUserActions = conditionalAccessApplicationsParameterValue?.includeUserActions;
    };
    /**
