...
export class WindowsAutopilotDeviceIdentityCollectionResponseImpl implements WindowsAutopilotDeviceIdentityCollectionResponse {
    ...
    public constructor(windowsAutopilotDeviceIdentityCollectionResponseParameterValue?: WindowsAutopilotDeviceIdentityCollectionResponse | undefined) {
        this._additionalData = windowsAutopilotDeviceIdentityCollectionResponseParameterValue?.additionalData ? windowsAutopilotDeviceIdentityCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = windowsAutopilotDeviceIdentityCollectionResponseParameterValue?.nextLink;
        this._value = windowsAutopilotDeviceIdentityCollectionResponseParameterValue?.value;
    };
    /**
