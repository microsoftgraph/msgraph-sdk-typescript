...
export class BookingStaffMemberBaseCollectionResponseImpl implements BookingStaffMemberBaseCollectionResponse {
    ...
    public constructor(bookingStaffMemberBaseCollectionResponseParameterValue?: BookingStaffMemberBaseCollectionResponse | undefined) {
        this._additionalData = bookingStaffMemberBaseCollectionResponseParameterValue?.additionalData ? bookingStaffMemberBaseCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = bookingStaffMemberBaseCollectionResponseParameterValue?.nextLink;
        this._value = bookingStaffMemberBaseCollectionResponseParameterValue?.value;
    };
    /**
