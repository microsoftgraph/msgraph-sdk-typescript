...
export class ChatMessageHostedContentCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ChatMessageHostedContentCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ChatMessageHostedContentCollectionResponse).value = n.getCollectionOfObjectValues<ChatMessageHostedContent>(createChatMessageHostedContentFromDiscriminatorValue); },
        };
    };
    /**
