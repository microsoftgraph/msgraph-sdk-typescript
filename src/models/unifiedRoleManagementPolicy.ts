...
import {AdminMember1, Entity, Identity, UnifiedRoleManagementPolicyRule} from './index';
...
export class UnifiedRoleManagementPolicy extends Entity implements Parsable {
    ...
    private _lastModifiedBy?: Identity | AdminMember1 | undefined;
     ...
     */
    public set lastModifiedBy(value: Identity | AdminMember1 | undefined) {
