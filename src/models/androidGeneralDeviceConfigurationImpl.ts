...
export class AndroidGeneralDeviceConfigurationImpl extends DeviceConfigurationImpl implements AndroidGeneralDeviceConfiguration {
    ...
    public constructor(androidGeneralDeviceConfigurationParameterValue?: AndroidGeneralDeviceConfiguration | undefined) {
        ...
        this._appsBlockClipboardSharing = androidGeneralDeviceConfigurationParameterValue?.appsBlockClipboardSharing;
        this._appsBlockCopyPaste = androidGeneralDeviceConfigurationParameterValue?.appsBlockCopyPaste;
        this._appsBlockYouTube = androidGeneralDeviceConfigurationParameterValue?.appsBlockYouTube;
        this._appsHideList = androidGeneralDeviceConfigurationParameterValue?.appsHideList;
        this._appsInstallAllowList = androidGeneralDeviceConfigurationParameterValue?.appsInstallAllowList;
        this._appsLaunchBlockList = androidGeneralDeviceConfigurationParameterValue?.appsLaunchBlockList;
        this._bluetoothBlocked = androidGeneralDeviceConfigurationParameterValue?.bluetoothBlocked;
        this._cameraBlocked = androidGeneralDeviceConfigurationParameterValue?.cameraBlocked;
        this._cellularBlockDataRoaming = androidGeneralDeviceConfigurationParameterValue?.cellularBlockDataRoaming;
        this._cellularBlockMessaging = androidGeneralDeviceConfigurationParameterValue?.cellularBlockMessaging;
        this._cellularBlockVoiceRoaming = androidGeneralDeviceConfigurationParameterValue?.cellularBlockVoiceRoaming;
        this._cellularBlockWiFiTethering = androidGeneralDeviceConfigurationParameterValue?.cellularBlockWiFiTethering;
        this._compliantAppListType = androidGeneralDeviceConfigurationParameterValue?.compliantAppListType;
        this._compliantAppsList = androidGeneralDeviceConfigurationParameterValue?.compliantAppsList;
        this._deviceSharingAllowed = androidGeneralDeviceConfigurationParameterValue?.deviceSharingAllowed;
        this._diagnosticDataBlockSubmission = androidGeneralDeviceConfigurationParameterValue?.diagnosticDataBlockSubmission;
        this._factoryResetBlocked = androidGeneralDeviceConfigurationParameterValue?.factoryResetBlocked;
        this._googleAccountBlockAutoSync = androidGeneralDeviceConfigurationParameterValue?.googleAccountBlockAutoSync;
        this._googlePlayStoreBlocked = androidGeneralDeviceConfigurationParameterValue?.googlePlayStoreBlocked;
        this._kioskModeApps = androidGeneralDeviceConfigurationParameterValue?.kioskModeApps;
        this._kioskModeBlockSleepButton = androidGeneralDeviceConfigurationParameterValue?.kioskModeBlockSleepButton;
        this._kioskModeBlockVolumeButtons = androidGeneralDeviceConfigurationParameterValue?.kioskModeBlockVolumeButtons;
        this._locationServicesBlocked = androidGeneralDeviceConfigurationParameterValue?.locationServicesBlocked;
        this._nfcBlocked = androidGeneralDeviceConfigurationParameterValue?.nfcBlocked;
        this._passwordBlockFingerprintUnlock = androidGeneralDeviceConfigurationParameterValue?.passwordBlockFingerprintUnlock;
        this._passwordBlockTrustAgents = androidGeneralDeviceConfigurationParameterValue?.passwordBlockTrustAgents;
        this._passwordExpirationDays = androidGeneralDeviceConfigurationParameterValue?.passwordExpirationDays;
        this._passwordMinimumLength = androidGeneralDeviceConfigurationParameterValue?.passwordMinimumLength;
        this._passwordMinutesOfInactivityBeforeScreenTimeout = androidGeneralDeviceConfigurationParameterValue?.passwordMinutesOfInactivityBeforeScreenTimeout;
        this._passwordPreviousPasswordBlockCount = androidGeneralDeviceConfigurationParameterValue?.passwordPreviousPasswordBlockCount;
        this._passwordRequired = androidGeneralDeviceConfigurationParameterValue?.passwordRequired;
        this._passwordRequiredType = androidGeneralDeviceConfigurationParameterValue?.passwordRequiredType;
        this._passwordSignInFailureCountBeforeFactoryReset = androidGeneralDeviceConfigurationParameterValue?.passwordSignInFailureCountBeforeFactoryReset;
        this._powerOffBlocked = androidGeneralDeviceConfigurationParameterValue?.powerOffBlocked;
        this._screenCaptureBlocked = androidGeneralDeviceConfigurationParameterValue?.screenCaptureBlocked;
        this._securityRequireVerifyApps = androidGeneralDeviceConfigurationParameterValue?.securityRequireVerifyApps;
        this._storageBlockGoogleBackup = androidGeneralDeviceConfigurationParameterValue?.storageBlockGoogleBackup;
        this._storageBlockRemovableStorage = androidGeneralDeviceConfigurationParameterValue?.storageBlockRemovableStorage;
        this._storageRequireDeviceEncryption = androidGeneralDeviceConfigurationParameterValue?.storageRequireDeviceEncryption;
        this._storageRequireRemovableStorageEncryption = androidGeneralDeviceConfigurationParameterValue?.storageRequireRemovableStorageEncryption;
        this._voiceAssistantBlocked = androidGeneralDeviceConfigurationParameterValue?.voiceAssistantBlocked;
        this._voiceDialingBlocked = androidGeneralDeviceConfigurationParameterValue?.voiceDialingBlocked;
        this._webBrowserBlockAutofill = androidGeneralDeviceConfigurationParameterValue?.webBrowserBlockAutofill;
        this._webBrowserBlocked = androidGeneralDeviceConfigurationParameterValue?.webBrowserBlocked;
        this._webBrowserBlockJavaScript = androidGeneralDeviceConfigurationParameterValue?.webBrowserBlockJavaScript;
        this._webBrowserBlockPopups = androidGeneralDeviceConfigurationParameterValue?.webBrowserBlockPopups;
        this._webBrowserCookieSettings = androidGeneralDeviceConfigurationParameterValue?.webBrowserCookieSettings;
        this._wiFiBlocked = androidGeneralDeviceConfigurationParameterValue?.wiFiBlocked;
    };
    /**
