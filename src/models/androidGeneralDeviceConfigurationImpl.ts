...
export class AndroidGeneralDeviceConfigurationImpl extends DeviceConfigurationImpl implements AndroidGeneralDeviceConfiguration {
    ...
    public constructor(androidGeneralDeviceConfigurationParameterValue?: AndroidGeneralDeviceConfiguration | undefined) {
        ...
        const appsHideListArrValue: AppListItemImpl[] = []; this.appsHideList?.forEach(element => {appsHideListArrValue.push(element instanceof AppListItemImpl? element : new AppListItemImpl(element));});
        this.appsHideList = appsHideListArrValue;
        const appsInstallAllowListArrValue: AppListItemImpl[] = []; this.appsInstallAllowList?.forEach(element => {appsInstallAllowListArrValue.push(element instanceof AppListItemImpl? element : new AppListItemImpl(element));});
        this.appsInstallAllowList = appsInstallAllowListArrValue;
        const appsLaunchBlockListArrValue: AppListItemImpl[] = []; this.appsLaunchBlockList?.forEach(element => {appsLaunchBlockListArrValue.push(element instanceof AppListItemImpl? element : new AppListItemImpl(element));});
        ...
        const kioskModeAppsArrValue: AppListItemImpl[] = []; this.kioskModeApps?.forEach(element => {kioskModeAppsArrValue.push(element instanceof AppListItemImpl? element : new AppListItemImpl(element));});
