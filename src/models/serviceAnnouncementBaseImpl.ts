...
export class ServiceAnnouncementBaseImpl extends EntityImpl implements ServiceAnnouncementBase {
    ...
    public constructor(serviceAnnouncementBaseParameterValue?: ServiceAnnouncementBase | undefined) {
        ...
        this._details = serviceAnnouncementBaseParameterValue?.details;
        this._endDateTime = serviceAnnouncementBaseParameterValue?.endDateTime;
        this._lastModifiedDateTime = serviceAnnouncementBaseParameterValue?.lastModifiedDateTime;
        this._startDateTime = serviceAnnouncementBaseParameterValue?.startDateTime;
        this._title = serviceAnnouncementBaseParameterValue?.title;
    };
    /**
