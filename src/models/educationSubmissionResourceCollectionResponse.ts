...
export class EducationSubmissionResourceCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as EducationSubmissionResourceCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as EducationSubmissionResourceCollectionResponse).value = n.getCollectionOfObjectValues<EducationSubmissionResource>(createEducationSubmissionResourceFromDiscriminatorValue); },
        };
    };
    /**
