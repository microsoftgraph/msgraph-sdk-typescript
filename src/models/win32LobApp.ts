import {AdminMember1, MobileLobApp, Win32LobAppInstallExperience, Win32LobAppMsiInformation, Win32LobAppReturnCode, Win32LobAppRule} from './index';
...
export class Win32LobApp extends MobileLobApp implements Parsable {
    ...
    private _installExperience?: Win32LobAppInstallExperience | AdminMember1 | undefined;
    ...
    private _msiInformation?: Win32LobAppMsiInformation | AdminMember1 | undefined;
    /** The return codes for post installation behavior. */
    private _returnCodes?: Win32LobAppReturnCode | AdminMember1[] | undefined;
    /** The detection and requirement rules for this app. */
    private _rules?: Win32LobAppRule | AdminMember1[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "returnCodes": n => { this.returnCodes = n.getObjectValue<Win32LobAppReturnCode>(createWin32LobAppReturnCodeFromDiscriminatorValue); },
            "rules": n => { this.rules = n.getObjectValue<Win32LobAppRule>(createWin32LobAppRuleFromDiscriminatorValue); },
     ...
     */
    public set installExperience(value: Win32LobAppInstallExperience | AdminMember1 | undefined) {
     ...
     */
    public set msiInformation(value: Win32LobAppMsiInformation | AdminMember1 | undefined) {
     ...
     */
    public set returnCodes(value: Win32LobAppReturnCode | AdminMember1[] | undefined) {
     ...
     */
    public set rules(value: Win32LobAppRule | AdminMember1[] | undefined) {
        this._rules = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<Win32LobAppReturnCode>("returnCodes", this.returnCodes);
        writer.writeObjectValue<Win32LobAppRule>("rules", this.rules);
