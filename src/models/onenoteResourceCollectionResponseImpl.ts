...
export class OnenoteResourceCollectionResponseImpl implements OnenoteResourceCollectionResponse {
    ...
    public constructor(onenoteResourceCollectionResponseParameterValue?: OnenoteResourceCollectionResponse | undefined) {
        this._additionalData = onenoteResourceCollectionResponseParameterValue?.additionalData ? onenoteResourceCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = onenoteResourceCollectionResponseParameterValue?.nextLink;
        this._value = onenoteResourceCollectionResponseParameterValue?.value;
    };
    /**
