...
export function serializeAccessPackage(writer: SerializationWriter, accessPackage: AccessPackage | undefined = {} as AccessPackage) : void {
        ...
        writer.writeCollectionOfObjectValues<AccessPackage>("accessPackagesIncompatibleWith", accessPackage.accessPackagesIncompatibleWith, );
        writer.writeCollectionOfObjectValues<AccessPackageAssignmentPolicy>("assignmentPolicies", accessPackage.assignmentPolicies, );
        writer.writeObjectValue<AccessPackageCatalog>("catalog", accessPackage.catalog, );
        ...
        writer.writeCollectionOfObjectValues<AccessPackage>("incompatibleAccessPackages", accessPackage.incompatibleAccessPackages, );
        writer.writeCollectionOfObjectValues<Group>("incompatibleGroups", accessPackage.incompatibleGroups, );
        ...
        writer.writeCollectionOfObjectValues<AccessPackageResourceRoleScope>("resourceRoleScopes", accessPackage.resourceRoleScopes, );
}
// tslint:enable
// eslint-enable
