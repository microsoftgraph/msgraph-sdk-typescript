...
export class DirectoryRoleCollectionResponseImpl implements DirectoryRoleCollectionResponse {
    ...
    public constructor(directoryRoleCollectionResponseParameterValue?: DirectoryRoleCollectionResponse | undefined) {
        this._additionalData = directoryRoleCollectionResponseParameterValue?.additionalData ? directoryRoleCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = directoryRoleCollectionResponseParameterValue?.nextLink;
        this._value = directoryRoleCollectionResponseParameterValue?.value;
    };
    /**
     ...
     * @returns a DirectoryRoleInterface
     */
    public get value() {
        return this._value;
    };
