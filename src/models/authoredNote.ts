...
export class AuthoredNote extends Entity implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "author": n => { this.author = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue); },
            "content": n => { this.content = n.getObjectValue<ItemBody>(createItemBodyFromDiscriminatorValue); },
