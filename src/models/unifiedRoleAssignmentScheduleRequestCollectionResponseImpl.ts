...
export class UnifiedRoleAssignmentScheduleRequestCollectionResponseImpl implements UnifiedRoleAssignmentScheduleRequestCollectionResponse {
    ...
    public constructor(unifiedRoleAssignmentScheduleRequestCollectionResponseParameterValue?: UnifiedRoleAssignmentScheduleRequestCollectionResponse | undefined) {
        this._additionalData = unifiedRoleAssignmentScheduleRequestCollectionResponseParameterValue?.additionalData ? unifiedRoleAssignmentScheduleRequestCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = unifiedRoleAssignmentScheduleRequestCollectionResponseParameterValue?.nextLink;
        this._value = unifiedRoleAssignmentScheduleRequestCollectionResponseParameterValue?.value;
    };
    /**
