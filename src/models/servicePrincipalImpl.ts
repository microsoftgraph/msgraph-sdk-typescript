...
export class ServicePrincipalImpl extends DirectoryObjectImpl implements ServicePrincipal {
    ...
    public constructor(servicePrincipalParameterValue?: ServicePrincipal | undefined) {
        ...
        const appRoleAssignedToArrValue: AppRoleAssignmentImpl[] = []; this.appRoleAssignedTo?.forEach(element => {appRoleAssignedToArrValue.push(element instanceof AppRoleAssignmentImpl? element : new AppRoleAssignmentImpl(element));});
        ...
        const appRoleAssignmentsArrValue: AppRoleAssignmentImpl[] = []; this.appRoleAssignments?.forEach(element => {appRoleAssignmentsArrValue.push(element instanceof AppRoleAssignmentImpl? element : new AppRoleAssignmentImpl(element));});
        ...
        const createdObjectsArrValue: DirectoryObjectImpl[] = []; this.createdObjects?.forEach(element => {createdObjectsArrValue.push(element instanceof DirectoryObjectImpl? element : new DirectoryObjectImpl(element));});
        ...
        const endpointsArrValue: EndpointImpl[] = []; this.endpoints?.forEach(element => {endpointsArrValue.push(element instanceof EndpointImpl? element : new EndpointImpl(element));});
        ...
        const oauth2PermissionGrantsArrValue: OAuth2PermissionGrantImpl[] = []; this.oauth2PermissionGrants?.forEach(element => {oauth2PermissionGrantsArrValue.push(element instanceof OAuth2PermissionGrantImpl? element : new OAuth2PermissionGrantImpl(element));});
        ...
        const ownedObjectsArrValue: DirectoryObjectImpl[] = []; this.ownedObjects?.forEach(element => {ownedObjectsArrValue.push(element instanceof DirectoryObjectImpl? element : new DirectoryObjectImpl(element));});
        ...
        const resourceSpecificApplicationPermissionsArrValue: ResourceSpecificPermissionImpl[] = []; this.resourceSpecificApplicationPermissions?.forEach(element => {resourceSpecificApplicationPermissionsArrValue.push(element instanceof ResourceSpecificPermissionImpl? element : new ResourceSpecificPermissionImpl(element));});
