...
import {AdminMember1, DefenderDetectedMalwareActions, DeviceConfiguration, EdgeSearchEngineBase, Windows10NetworkProxyServer} from './index';
...
export class Windows10GeneralConfiguration extends DeviceConfiguration implements Parsable {
    ...
    private _defenderDetectedMalwareActions?: DefenderDetectedMalwareActions | AdminMember1 | undefined;
    ...
    private _edgeSearchEngine?: EdgeSearchEngineBase | AdminMember1 | undefined;
    ...
    private _networkProxyServer?: Windows10NetworkProxyServer | AdminMember1 | undefined;
     ...
     */
    public set defenderDetectedMalwareActions(value: DefenderDetectedMalwareActions | AdminMember1 | undefined) {
     ...
     */
    public set edgeSearchEngine(value: EdgeSearchEngineBase | AdminMember1 | undefined) {
     ...
     */
    public set networkProxyServer(value: Windows10NetworkProxyServer | AdminMember1 | undefined) {
