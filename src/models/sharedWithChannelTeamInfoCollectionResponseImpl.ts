...
export class SharedWithChannelTeamInfoCollectionResponseImpl implements SharedWithChannelTeamInfoCollectionResponse {
    ...
    public constructor(sharedWithChannelTeamInfoCollectionResponseParameterValue?: SharedWithChannelTeamInfoCollectionResponse | undefined) {
        this._additionalData = sharedWithChannelTeamInfoCollectionResponseParameterValue?.additionalData ? sharedWithChannelTeamInfoCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = sharedWithChannelTeamInfoCollectionResponseParameterValue?.nextLink;
        this._value = sharedWithChannelTeamInfoCollectionResponseParameterValue?.value;
    };
    /**
