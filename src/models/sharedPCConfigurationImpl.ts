...
export class SharedPCConfigurationImpl extends DeviceConfigurationImpl implements SharedPCConfiguration {
    ...
    private _accountManagerPolicy?: SharedPCAccountManagerPolicy | undefined;
     ...
     * @returns a SharedPCAccountManagerPolicyInterface
     */
    ...
    public constructor(sharedPCConfigurationParameterValue?: SharedPCConfiguration | undefined) {
        ...
        this._accountManagerPolicy = sharedPCConfigurationParameterValue?.accountManagerPolicy;
        this._allowedAccounts = sharedPCConfigurationParameterValue?.allowedAccounts;
        this._allowLocalStorage = sharedPCConfigurationParameterValue?.allowLocalStorage;
        this._disableAccountManager = sharedPCConfigurationParameterValue?.disableAccountManager;
        this._disableEduPolicies = sharedPCConfigurationParameterValue?.disableEduPolicies;
        this._disablePowerPolicies = sharedPCConfigurationParameterValue?.disablePowerPolicies;
        this._disableSignInOnResume = sharedPCConfigurationParameterValue?.disableSignInOnResume;
        this._enabled = sharedPCConfigurationParameterValue?.enabled;
        this._idleTimeBeforeSleepInSeconds = sharedPCConfigurationParameterValue?.idleTimeBeforeSleepInSeconds;
        this._kioskAppDisplayName = sharedPCConfigurationParameterValue?.kioskAppDisplayName;
        this._kioskAppUserModelId = sharedPCConfigurationParameterValue?.kioskAppUserModelId;
        this._maintenanceStartTime = sharedPCConfigurationParameterValue?.maintenanceStartTime;
    };
    /**
