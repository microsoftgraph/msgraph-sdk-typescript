...
export class ObjectIdentityImpl implements ObjectIdentity {
    ...
    public constructor(objectIdentityParameterValue?: ObjectIdentity | undefined) {
        this._additionalData = objectIdentityParameterValue?.additionalData ? objectIdentityParameterValue?.additionalData! : {};
        this._issuer = objectIdentityParameterValue?.issuer;
        this._issuerAssignedId = objectIdentityParameterValue?.issuerAssignedId;
        this._signInType = objectIdentityParameterValue?.signInType;
    };
    /**
