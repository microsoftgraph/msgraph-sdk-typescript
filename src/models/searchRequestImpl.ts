...
export class SearchRequestImpl implements AdditionalDataHolder, Parsable, SearchRequest {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        const aggregationsArrValue: AggregationOptionImpl[] = []; this.aggregations?.forEach(element => {aggregationsArrValue.push(new AggregationOptionImpl(element));});
        ...
        const sortPropertiesArrValue: SortPropertyImpl[] = []; this.sortProperties?.forEach(element => {sortPropertiesArrValue.push(new SortPropertyImpl(element));});
