...
export class ManagedDeviceCollectionResponseImpl implements ManagedDeviceCollectionResponse {
    ...
    public constructor(managedDeviceCollectionResponseParameterValue?: ManagedDeviceCollectionResponse | undefined) {
        this._additionalData = managedDeviceCollectionResponseParameterValue?.additionalData ? managedDeviceCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = managedDeviceCollectionResponseParameterValue?.nextLink;
        this._value = managedDeviceCollectionResponseParameterValue?.value;
    };
    /**
