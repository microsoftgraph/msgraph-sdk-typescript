...
export function serializeMacOSLobApp(writer: SerializationWriter, macOSLobApp: MacOSLobApp | undefined = {} as MacOSLobApp) : void {
        ...
        writer.writeCollectionOfObjectValues<MacOSLobChildApp>("childApps", macOSLobApp.childApps, );
        ...
        writer.writeObjectValue<MacOSMinimumOperatingSystem>("minimumSupportedOperatingSystem", macOSLobApp.minimumSupportedOperatingSystem, );
