...
export class ThumbnailSetCollectionResponseImpl implements ThumbnailSetCollectionResponse {
    ...
    public constructor(thumbnailSetCollectionResponseParameterValue?: ThumbnailSetCollectionResponse | undefined) {
        this._additionalData = thumbnailSetCollectionResponseParameterValue?.additionalData ? thumbnailSetCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = thumbnailSetCollectionResponseParameterValue?.nextLink;
        this._value = thumbnailSetCollectionResponseParameterValue?.value;
    };
    /**
