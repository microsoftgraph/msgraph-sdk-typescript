...
export class RichLongRunningOperationCollectionResponseImpl implements RichLongRunningOperationCollectionResponse {
    ...
    public constructor(richLongRunningOperationCollectionResponseParameterValue?: RichLongRunningOperationCollectionResponse | undefined) {
        this._additionalData = richLongRunningOperationCollectionResponseParameterValue?.additionalData ? richLongRunningOperationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = richLongRunningOperationCollectionResponseParameterValue?.nextLink;
        this._value = richLongRunningOperationCollectionResponseParameterValue?.value;
    };
    /**
