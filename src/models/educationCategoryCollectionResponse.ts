...
export class EducationCategoryCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as EducationCategoryCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as EducationCategoryCollectionResponse).value = n.getCollectionOfObjectValues<EducationCategory>(createEducationCategoryFromDiscriminatorValue); },
        };
    };
    /**
