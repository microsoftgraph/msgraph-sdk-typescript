...
export class UnifiedRoleManagementPolicyCollectionResponseImpl implements UnifiedRoleManagementPolicyCollectionResponse {
    ...
    public constructor(unifiedRoleManagementPolicyCollectionResponseParameterValue?: UnifiedRoleManagementPolicyCollectionResponse | undefined) {
        this._additionalData = unifiedRoleManagementPolicyCollectionResponseParameterValue?.additionalData ? unifiedRoleManagementPolicyCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = unifiedRoleManagementPolicyCollectionResponseParameterValue?.nextLink;
        this._value = unifiedRoleManagementPolicyCollectionResponseParameterValue?.value;
    };
    /**
