...
export class AuthenticationMethodConfigurationCollectionResponseImpl implements AuthenticationMethodConfigurationCollectionResponse {
    ...
    public constructor(authenticationMethodConfigurationCollectionResponseParameterValue?: AuthenticationMethodConfigurationCollectionResponse | undefined) {
        this._additionalData = authenticationMethodConfigurationCollectionResponseParameterValue?.additionalData ? authenticationMethodConfigurationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = authenticationMethodConfigurationCollectionResponseParameterValue?.nextLink;
        this._value = authenticationMethodConfigurationCollectionResponseParameterValue?.value;
    };
    /**
