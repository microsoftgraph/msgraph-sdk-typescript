...
export class Invitation extends Entity implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "invitedUser": n => { this.invitedUser = n.getObjectValue<User>(createUserFromDiscriminatorValue); },
            ...
            "invitedUserMessageInfo": n => { this.invitedUserMessageInfo = n.getObjectValue<InvitedUserMessageInfo>(createInvitedUserMessageInfoFromDiscriminatorValue); },
            ...
            "resetRedemption": n => { this.resetRedemption = n.getBooleanValue(); },
