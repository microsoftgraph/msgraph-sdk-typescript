...
export class ColumnDefinitionCollectionResponseImpl implements ColumnDefinitionCollectionResponse {
    ...
    public constructor(columnDefinitionCollectionResponseParameterValue?: ColumnDefinitionCollectionResponse | undefined) {
        this._additionalData = columnDefinitionCollectionResponseParameterValue?.additionalData ? columnDefinitionCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = columnDefinitionCollectionResponseParameterValue?.nextLink;
        this._value = columnDefinitionCollectionResponseParameterValue?.value;
    };
    /**
