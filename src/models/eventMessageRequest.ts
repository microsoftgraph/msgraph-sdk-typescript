import {AdminMember1, DateTimeTimeZone, EventMessage, Location} from './index';
...
export class EventMessageRequest extends EventMessage implements Parsable {
    ...
    private _meetingRequestType?: MeetingRequestType | AdminMember1 | undefined;
    /** If the meeting update changes the meeting end time, this property specifies the previous meeting end time. */
    private _previousEndDateTime?: DateTimeTimeZone | AdminMember1 | undefined;
    /** If the meeting update changes the meeting location, this property specifies the previous meeting location. */
    private _previousLocation?: Location | AdminMember1 | undefined;
    /** If the meeting update changes the meeting start time, this property specifies the previous meeting start time. */
    private _previousStartDateTime?: DateTimeTimeZone | AdminMember1 | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "meetingRequestType": n => { this.meetingRequestType = n.getObjectValue<MeetingRequestType>(createMeetingRequestTypeFromDiscriminatorValue); },
     ...
     */
    public set meetingRequestType(value: MeetingRequestType | AdminMember1 | undefined) {
     ...
     */
    public set previousEndDateTime(value: DateTimeTimeZone | AdminMember1 | undefined) {
     ...
     */
    public set previousLocation(value: Location | AdminMember1 | undefined) {
     ...
     */
    public set previousStartDateTime(value: DateTimeTimeZone | AdminMember1 | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<MeetingRequestType>("meetingRequestType", this.meetingRequestType);
