...
export class AccessReviewInstanceCollectionResponseImpl implements AccessReviewInstanceCollectionResponse {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData?: Record<string, unknown> | undefined;
    /** The nextLink property */
    private _nextLink?: string | undefined;
    /** The value property */
    private _value?: AccessReviewInstance[] | undefined;
    /**
    ...
    public constructor(accessReviewInstanceCollectionResponseParameterValue?: AccessReviewInstanceCollectionResponse | undefined) {
        this._additionalData = accessReviewInstanceCollectionResponseParameterValue?.additionalData ? accessReviewInstanceCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = accessReviewInstanceCollectionResponseParameterValue?.nextLink;
        this._value = accessReviewInstanceCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value && this.value.length != 0){        const valueArrValue: AccessReviewInstanceImpl[] = [];
        this.value?.forEach(element => {
            valueArrValue.push((element instanceof AccessReviewInstanceImpl? element as AccessReviewInstanceImpl:new AccessReviewInstanceImpl(element)));
        });
     ...
     */
    public set value(value: AccessReviewInstance[] | undefined) {
        if(value) {
            const valueArrValue: AccessReviewInstanceImpl[] = [];
            this.value?.forEach(element => {
                valueArrValue.push((element instanceof AccessReviewInstanceImpl? element as AccessReviewInstanceImpl:new AccessReviewInstanceImpl(element)));
            });
