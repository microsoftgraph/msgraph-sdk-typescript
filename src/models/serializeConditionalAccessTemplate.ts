...
export function serializeConditionalAccessTemplate(conditionalAccessTemplate: ConditionalAccessTemplate | undefined = {} as ConditionalAccessTemplate, writer: SerializationWriter) : void {
