import {AdminMember1, Entity, Json, WorkbookRangeFormat, WorkbookRangeSort, WorkbookWorksheet} from './index';
...
export class WorkbookRange extends Entity implements Parsable {
    ...
    private _format?: WorkbookRangeFormat | AdminMember1 | undefined;
    /** Represents the formula in A1-style notation. */
    private _formulas?: Json | AdminMember1 | undefined;
    /** Represents the formula in A1-style notation, in the user's language and number-formatting locale.  For example, the English '=SUM(A1, 1.5)' formula would become '=SUMME(A1; 1,5)' in German. */
    private _formulasLocal?: Json | AdminMember1 | undefined;
    /** Represents the formula in R1C1-style notation. */
    private _formulasR1C1?: Json | AdminMember1 | undefined;
    /** Represents if all cells of the current range are hidden. Read-only. */
    private _hidden?: boolean | undefined;
    /** Represents Excel's number format code for the given cell. */
    private _numberFormat?: Json | AdminMember1 | undefined;
    ...
    private _sort?: WorkbookRangeSort | AdminMember1 | undefined;
    /** Text values of the specified range. The Text value will not depend on the cell width. The # sign substitution that happens in Excel UI will not affect the text value returned by the API. Read-only. */
    private _text?: Json | AdminMember1 | undefined;
    ...
    private _valueTypes?: Json | AdminMember1 | undefined;
    /** The worksheet containing the current range. Read-only. */
     ...
     */
    public set format(value: WorkbookRangeFormat | AdminMember1 | undefined) {
        this._format = value;
    };
    /**
     ...
     */
    public set formulas(value: Json | AdminMember1 | undefined) {
     ...
     */
    public set formulasLocal(value: Json | AdminMember1 | undefined) {
     ...
     */
    public set formulasR1C1(value: Json | AdminMember1 | undefined) {
     ...
     */
    public set numberFormat(value: Json | AdminMember1 | undefined) {
     ...
     */
    public set sort(value: WorkbookRangeSort | AdminMember1 | undefined) {
        this._sort = value;
    };
    /**
     ...
     */
    public set text(value: Json | AdminMember1 | undefined) {
        this._text = value;
    };
    /**
     ...
     */
    public set valueTypes(value: Json | AdminMember1 | undefined) {
