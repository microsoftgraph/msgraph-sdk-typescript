...
export class WindowsFirewallNetworkProfileImpl implements WindowsFirewallNetworkProfile {
    ...
    public constructor(windowsFirewallNetworkProfileParameterValue?: WindowsFirewallNetworkProfile | undefined) {
        this._additionalData = windowsFirewallNetworkProfileParameterValue?.additionalData ? windowsFirewallNetworkProfileParameterValue?.additionalData! : {};
        this._authorizedApplicationRulesFromGroupPolicyMerged = windowsFirewallNetworkProfileParameterValue?.authorizedApplicationRulesFromGroupPolicyMerged;
        this._connectionSecurityRulesFromGroupPolicyMerged = windowsFirewallNetworkProfileParameterValue?.connectionSecurityRulesFromGroupPolicyMerged;
        this._firewallEnabled = windowsFirewallNetworkProfileParameterValue?.firewallEnabled;
        this._globalPortRulesFromGroupPolicyMerged = windowsFirewallNetworkProfileParameterValue?.globalPortRulesFromGroupPolicyMerged;
        this._inboundConnectionsBlocked = windowsFirewallNetworkProfileParameterValue?.inboundConnectionsBlocked;
        this._inboundNotificationsBlocked = windowsFirewallNetworkProfileParameterValue?.inboundNotificationsBlocked;
        this._incomingTrafficBlocked = windowsFirewallNetworkProfileParameterValue?.incomingTrafficBlocked;
        this._outboundConnectionsBlocked = windowsFirewallNetworkProfileParameterValue?.outboundConnectionsBlocked;
        this._policyRulesFromGroupPolicyMerged = windowsFirewallNetworkProfileParameterValue?.policyRulesFromGroupPolicyMerged;
        this._securedPacketExemptionAllowed = windowsFirewallNetworkProfileParameterValue?.securedPacketExemptionAllowed;
        this._stealthModeBlocked = windowsFirewallNetworkProfileParameterValue?.stealthModeBlocked;
        this._unicastResponsesToMulticastBroadcastsBlocked = windowsFirewallNetworkProfileParameterValue?.unicastResponsesToMulticastBroadcastsBlocked;
    };
    /**
