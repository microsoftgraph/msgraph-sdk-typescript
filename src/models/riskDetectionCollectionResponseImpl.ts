...
export class RiskDetectionCollectionResponseImpl implements RiskDetectionCollectionResponse {
    ...
    public constructor(riskDetectionCollectionResponseParameterValue?: RiskDetectionCollectionResponse | undefined) {
        this._additionalData = riskDetectionCollectionResponseParameterValue?.additionalData ? riskDetectionCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = riskDetectionCollectionResponseParameterValue?.nextLink;
        this._value = riskDetectionCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "value": n => { this.value = n.getCollectionOfObjectValues<RiskDetectionImpl>(createRiskDetectionFromDiscriminatorValue); },
        };
    };
    /**
