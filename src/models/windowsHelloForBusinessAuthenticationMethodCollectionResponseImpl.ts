...
export class WindowsHelloForBusinessAuthenticationMethodCollectionResponseImpl implements AdditionalDataHolder, Parsable, WindowsHelloForBusinessAuthenticationMethodCollectionResponse {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value){
        const valueArrValue: WindowsHelloForBusinessAuthenticationMethodImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new WindowsHelloForBusinessAuthenticationMethodImpl(element));});
