...
export class ScopedRoleMembershipCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ScopedRoleMembershipCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ScopedRoleMembershipCollectionResponse).value = n.getCollectionOfObjectValues<ScopedRoleMembership>(createScopedRoleMembershipFromDiscriminatorValue); },
        };
    };
    /**
