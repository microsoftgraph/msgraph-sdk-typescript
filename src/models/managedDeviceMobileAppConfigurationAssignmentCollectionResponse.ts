...
export class ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse).value = n.getCollectionOfObjectValues<ManagedDeviceMobileAppConfigurationAssignment>(createManagedDeviceMobileAppConfigurationAssignmentFromDiscriminatorValue); },
        };
    };
    /**
