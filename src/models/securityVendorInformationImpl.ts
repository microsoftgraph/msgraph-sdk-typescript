...
export class SecurityVendorInformationImpl implements SecurityVendorInformation {
    ...
    public constructor(securityVendorInformationParameterValue?: SecurityVendorInformation | undefined) {
        this._additionalData = securityVendorInformationParameterValue?.additionalData ? securityVendorInformationParameterValue?.additionalData! : {};
        this._provider = securityVendorInformationParameterValue?.provider;
        this._providerVersion = securityVendorInformationParameterValue?.providerVersion;
        this._subProvider = securityVendorInformationParameterValue?.subProvider;
        this._vendor = securityVendorInformationParameterValue?.vendor;
    };
    /**
