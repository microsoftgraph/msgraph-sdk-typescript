...
export class EducationAssignmentGrade implements AdditionalDataHolder, Parsable {
    ...
    private _gradedBy?: IdentitySet | AdminMember1 | undefined;
    ...
    public constructor() {
        ...
        this.type = "#microsoft.graph.educationAssignmentGrade";
    };
    /**
     ...
     */
    public set gradedBy(value: IdentitySet | AdminMember1 | undefined) {
