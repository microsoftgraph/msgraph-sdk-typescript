...
export class DeviceManagementExportJobCollectionResponseImpl implements DeviceManagementExportJobCollectionResponse {
    ...
    public constructor(deviceManagementExportJobCollectionResponseParameterValue?: DeviceManagementExportJobCollectionResponse | undefined) {
        this._additionalData = deviceManagementExportJobCollectionResponseParameterValue?.additionalData ? deviceManagementExportJobCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = deviceManagementExportJobCollectionResponseParameterValue?.nextLink;
        this._value = deviceManagementExportJobCollectionResponseParameterValue?.value;
    };
    /**
