...
export class ManagedDeviceMobileAppConfigurationCollectionResponseImpl implements ManagedDeviceMobileAppConfigurationCollectionResponse {
    ...
    public constructor(managedDeviceMobileAppConfigurationCollectionResponseParameterValue?: ManagedDeviceMobileAppConfigurationCollectionResponse | undefined) {
        this._additionalData = managedDeviceMobileAppConfigurationCollectionResponseParameterValue?.additionalData ? managedDeviceMobileAppConfigurationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = managedDeviceMobileAppConfigurationCollectionResponseParameterValue?.nextLink;
        this._value = managedDeviceMobileAppConfigurationCollectionResponseParameterValue?.value;
    };
    /**
