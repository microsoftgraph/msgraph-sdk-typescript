...
export class DeviceConfigurationStateCollectionResponseImpl implements DeviceConfigurationStateCollectionResponse {
    ...
    public constructor(deviceConfigurationStateCollectionResponseParameterValue?: DeviceConfigurationStateCollectionResponse | undefined) {
        this._additionalData = deviceConfigurationStateCollectionResponseParameterValue?.additionalData ? deviceConfigurationStateCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = deviceConfigurationStateCollectionResponseParameterValue?.nextLink;
        this._value = deviceConfigurationStateCollectionResponseParameterValue?.value;
    };
    /**
