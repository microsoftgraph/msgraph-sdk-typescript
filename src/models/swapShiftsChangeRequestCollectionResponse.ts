...
export class SwapShiftsChangeRequestCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as SwapShiftsChangeRequestCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as SwapShiftsChangeRequestCollectionResponse).value = n.getCollectionOfObjectValues<SwapShiftsChangeRequest>(createSwapShiftsChangeRequestFromDiscriminatorValue); },
        };
    };
    /**
