...
export class LicenseDetailsCollectionResponseImpl implements LicenseDetailsCollectionResponse {
    ...
    public constructor(licenseDetailsCollectionResponseParameterValue?: LicenseDetailsCollectionResponse | undefined) {
        this._additionalData = licenseDetailsCollectionResponseParameterValue?.additionalData ? licenseDetailsCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = licenseDetailsCollectionResponseParameterValue?.nextLink;
        this._value = licenseDetailsCollectionResponseParameterValue?.value;
    };
    /**
