...
export class UserFlowLanguageConfigurationCollectionResponseImpl implements UserFlowLanguageConfigurationCollectionResponse {
    ...
    public constructor(userFlowLanguageConfigurationCollectionResponseParameterValue?: UserFlowLanguageConfigurationCollectionResponse | undefined) {
        this._additionalData = userFlowLanguageConfigurationCollectionResponseParameterValue?.additionalData ? userFlowLanguageConfigurationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = userFlowLanguageConfigurationCollectionResponseParameterValue?.nextLink;
        this._value = userFlowLanguageConfigurationCollectionResponseParameterValue?.value;
    };
    /**
