...
export class TeamCollectionResponseImpl implements TeamCollectionResponse {
    ...
    public constructor(teamCollectionResponseParameterValue?: TeamCollectionResponse | undefined) {
        this._additionalData = teamCollectionResponseParameterValue?.additionalData ? teamCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = teamCollectionResponseParameterValue?.nextLink;
        this._value = teamCollectionResponseParameterValue?.value;
    };
    /**
