...
export class MobileApp extends Entity implements Parsable {
    ...
    public constructor() {
        super();
        this.odataType = "#microsoft.graph.mobileApp";
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "assignments": n => { this.assignments = n.getCollectionOfObjectValues<MobileAppAssignment>(createMobileAppAssignmentFromDiscriminatorValue); },
            "categories": n => { this.categories = n.getCollectionOfObjectValues<MobileAppCategory>(createMobileAppCategoryFromDiscriminatorValue); },
            ...
            "largeIcon": n => { this.largeIcon = n.getObjectValue<MimeContent>(createMimeContentFromDiscriminatorValue); },
