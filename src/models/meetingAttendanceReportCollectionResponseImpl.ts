...
export class MeetingAttendanceReportCollectionResponseImpl implements MeetingAttendanceReportCollectionResponse {
    ...
    public constructor(meetingAttendanceReportCollectionResponseParameterValue?: MeetingAttendanceReportCollectionResponse | undefined) {
        this._additionalData = meetingAttendanceReportCollectionResponseParameterValue?.additionalData ? meetingAttendanceReportCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = meetingAttendanceReportCollectionResponseParameterValue?.nextLink;
        this._value = meetingAttendanceReportCollectionResponseParameterValue?.value;
    };
    /**
