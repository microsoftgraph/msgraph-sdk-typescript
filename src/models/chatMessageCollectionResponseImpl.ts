...
export class ChatMessageCollectionResponseImpl implements ChatMessageCollectionResponse {
    ...
    public constructor(chatMessageCollectionResponseParameterValue?: ChatMessageCollectionResponse | undefined) {
        this._additionalData = chatMessageCollectionResponseParameterValue?.additionalData ? chatMessageCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = chatMessageCollectionResponseParameterValue?.nextLink;
        this._value = chatMessageCollectionResponseParameterValue?.value;
    };
    /**
