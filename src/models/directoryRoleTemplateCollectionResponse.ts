...
export class DirectoryRoleTemplateCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DirectoryRoleTemplateCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DirectoryRoleTemplateCollectionResponse).value = n.getCollectionOfObjectValues<DirectoryRoleTemplate>(createDirectoryRoleTemplateFromDiscriminatorValue); },
        };
    };
    /**
