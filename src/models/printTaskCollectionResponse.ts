...
export class PrintTaskCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as PrintTaskCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as PrintTaskCollectionResponse).value = n.getCollectionOfObjectValues<PrintTask>(createPrintTaskFromDiscriminatorValue); },
        };
    };
    /**
