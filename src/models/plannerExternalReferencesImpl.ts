...
export class PlannerExternalReferencesImpl implements PlannerExternalReferences {
    ...
    public constructor(plannerExternalReferencesParameterValue?: PlannerExternalReferences | undefined) {
        this._additionalData = plannerExternalReferencesParameterValue?.additionalData ? plannerExternalReferencesParameterValue?.additionalData! : {};
    };
    /**
