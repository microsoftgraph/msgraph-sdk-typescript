...
export class ConversationCollectionResponseImpl implements ConversationCollectionResponse {
    ...
    public constructor(conversationCollectionResponseParameterValue?: ConversationCollectionResponse | undefined) {
        this._additionalData = conversationCollectionResponseParameterValue?.additionalData ? conversationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = conversationCollectionResponseParameterValue?.nextLink;
        this._value = conversationCollectionResponseParameterValue?.value;
    };
    /**
