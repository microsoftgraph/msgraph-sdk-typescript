...
export class ShiftActivityImpl implements ShiftActivity {
    ...
    public constructor(shiftActivityParameterValue?: ShiftActivity | undefined) {
        this._additionalData = shiftActivityParameterValue?.additionalData ? shiftActivityParameterValue?.additionalData! : {};
        this._code = shiftActivityParameterValue?.code;
        this._displayName = shiftActivityParameterValue?.displayName;
        this._endDateTime = shiftActivityParameterValue?.endDateTime;
        this._isPaid = shiftActivityParameterValue?.isPaid;
        this._startDateTime = shiftActivityParameterValue?.startDateTime;
        this._theme = shiftActivityParameterValue?.theme;
    };
    /**
