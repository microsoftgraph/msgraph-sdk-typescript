import {AllDevicesAssignmentTarget, AllLicensedUsersAssignmentTarget, ConfigurationManagerCollectionAssignmentTarget, DeviceAndAppManagementAssignmentTarget, GroupAssignmentTarget} from './index';
