...
export class ExtensionSchemaPropertyImpl implements ExtensionSchemaProperty {
    ...
    public constructor(extensionSchemaPropertyParameterValue?: ExtensionSchemaProperty | undefined) {
        this._additionalData = extensionSchemaPropertyParameterValue?.additionalData ? extensionSchemaPropertyParameterValue?.additionalData! : {};
        this._name = extensionSchemaPropertyParameterValue?.name;
        this._type = extensionSchemaPropertyParameterValue?.type;
    };
    /**
