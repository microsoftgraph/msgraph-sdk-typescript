...
export class OutlookCategoryCollectionResponseImpl implements OutlookCategoryCollectionResponse {
    ...
    public constructor(outlookCategoryCollectionResponseParameterValue?: OutlookCategoryCollectionResponse | undefined) {
        this._additionalData = outlookCategoryCollectionResponseParameterValue?.additionalData ? outlookCategoryCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = outlookCategoryCollectionResponseParameterValue?.nextLink;
        this._value = outlookCategoryCollectionResponseParameterValue?.value;
    };
    /**
