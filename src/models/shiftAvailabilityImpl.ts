...
export class ShiftAvailabilityImpl implements ShiftAvailability {
    ...
    public constructor(shiftAvailabilityParameterValue?: ShiftAvailability | undefined) {
        ...
        const timeSlotsArrValue: TimeRangeImpl[] = []; this.timeSlots?.forEach(element => {timeSlotsArrValue.push(element instanceof TimeRangeImpl? element : new TimeRangeImpl(element));});
