...
export class Post extends OutlookItem implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "inReplyTo": n => { this.inReplyTo = n.getObjectValue<Post>(createPostFromDiscriminatorValue); },
            ...
            "newParticipants": n => { this.newParticipants = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue); },
