...
export class TermsAndConditionsAcceptanceStatusCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as TermsAndConditionsAcceptanceStatusCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as TermsAndConditionsAcceptanceStatusCollectionResponse).value = n.getCollectionOfObjectValues<TermsAndConditionsAcceptanceStatus>(createTermsAndConditionsAcceptanceStatusFromDiscriminatorValue); },
        };
    };
    /**
