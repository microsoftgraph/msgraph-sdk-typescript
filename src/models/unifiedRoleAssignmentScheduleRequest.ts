...
export function serializeUnifiedRoleAssignmentScheduleRequest(writer: SerializationWriter, unifiedRoleAssignmentScheduleRequest: UnifiedRoleAssignmentScheduleRequest | undefined = {} as UnifiedRoleAssignmentScheduleRequest) : void {
        ...
        writer.writeObjectValue<UnifiedRoleEligibilitySchedule>("activatedUsing", unifiedRoleAssignmentScheduleRequest.activatedUsing, );
        writer.writeObjectValue<AppScope>("appScope", unifiedRoleAssignmentScheduleRequest.appScope, );
        writer.writeStringValue("appScopeId", unifiedRoleAssignmentScheduleRequest.appScopeId);
        writer.writeObjectValue<DirectoryObject>("directoryScope", unifiedRoleAssignmentScheduleRequest.directoryScope, );
        ...
        writer.writeObjectValue<DirectoryObject>("principal", unifiedRoleAssignmentScheduleRequest.principal, );
        writer.writeStringValue("principalId", unifiedRoleAssignmentScheduleRequest.principalId);
        writer.writeObjectValue<UnifiedRoleDefinition>("roleDefinition", unifiedRoleAssignmentScheduleRequest.roleDefinition, );
        writer.writeStringValue("roleDefinitionId", unifiedRoleAssignmentScheduleRequest.roleDefinitionId);
        writer.writeObjectValue<RequestSchedule>("scheduleInfo", unifiedRoleAssignmentScheduleRequest.scheduleInfo, );
        writer.writeObjectValue<UnifiedRoleAssignmentSchedule>("targetSchedule", unifiedRoleAssignmentScheduleRequest.targetSchedule, );
        writer.writeStringValue("targetScheduleId", unifiedRoleAssignmentScheduleRequest.targetScheduleId);
        writer.writeObjectValue<TicketInfo>("ticketInfo", unifiedRoleAssignmentScheduleRequest.ticketInfo, );
}
