...
export class EnrollmentConfigurationAssignmentCollectionResponseImpl implements AdditionalDataHolder, EnrollmentConfigurationAssignmentCollectionResponse, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value){
        const valueArrValue: EnrollmentConfigurationAssignmentImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new EnrollmentConfigurationAssignmentImpl(element));});
