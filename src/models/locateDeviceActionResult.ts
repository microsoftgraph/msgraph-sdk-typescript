import {AdminMember1, DeviceActionResult, DeviceGeoLocation} from './index';
import {Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class LocateDeviceActionResult extends DeviceActionResult implements Parsable {
    /** device location */
    private _deviceLocation?: DeviceGeoLocation | AdminMember1 | undefined;
    /**
     ...
     */
    public set deviceLocation(value: DeviceGeoLocation | AdminMember1 | undefined) {
