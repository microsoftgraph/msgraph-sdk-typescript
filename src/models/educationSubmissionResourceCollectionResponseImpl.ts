...
export class EducationSubmissionResourceCollectionResponseImpl implements EducationSubmissionResourceCollectionResponse {
    ...
    public constructor(educationSubmissionResourceCollectionResponseParameterValue?: EducationSubmissionResourceCollectionResponse | undefined) {
        this._additionalData = educationSubmissionResourceCollectionResponseParameterValue?.additionalData ? educationSubmissionResourceCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = educationSubmissionResourceCollectionResponseParameterValue?.nextLink;
        this._value = educationSubmissionResourceCollectionResponseParameterValue?.value;
    };
    /**
