import {AdminMember1, EducationItemBody, IdentitySet} from './index';
...
export class EducationFeedback implements AdditionalDataHolder, Parsable {
    ...
    private _feedbackBy?: IdentitySet | AdminMember1 | undefined;
    ...
    /** Feedback. */
    private _text?: EducationItemBody | AdminMember1 | undefined;
    /**
     ...
     */
    public set feedbackBy(value: IdentitySet | AdminMember1 | undefined) {
     ...
     */
    public set text(value: EducationItemBody | AdminMember1 | undefined) {
        this._text = value;
    };
}
