...
export class BroadcastMeetingSettingsImpl implements BroadcastMeetingSettings {
    ...
    public constructor(broadcastMeetingSettingsParameterValue?: BroadcastMeetingSettings | undefined) {
        this._additionalData = broadcastMeetingSettingsParameterValue?.additionalData ? broadcastMeetingSettingsParameterValue?.additionalData! : {};
        this._allowedAudience = broadcastMeetingSettingsParameterValue?.allowedAudience;
        this._isAttendeeReportEnabled = broadcastMeetingSettingsParameterValue?.isAttendeeReportEnabled;
        this._isQuestionAndAnswerEnabled = broadcastMeetingSettingsParameterValue?.isQuestionAndAnswerEnabled;
        this._isRecordingEnabled = broadcastMeetingSettingsParameterValue?.isRecordingEnabled;
        this._isVideoOnDemandEnabled = broadcastMeetingSettingsParameterValue?.isVideoOnDemandEnabled;
    };
    /**
