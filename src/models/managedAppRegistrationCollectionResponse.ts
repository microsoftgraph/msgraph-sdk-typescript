...
export class ManagedAppRegistrationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ManagedAppRegistrationCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ManagedAppRegistrationCollectionResponse).value = n.getCollectionOfObjectValues<ManagedAppRegistration>(createManagedAppRegistrationFromDiscriminatorValue); },
        };
    };
    /**
