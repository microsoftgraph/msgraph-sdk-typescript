...
export class IosGeneralDeviceConfiguration extends DeviceConfiguration implements Parsable {
    ...
    private _appsSingleAppModeList?: AppListItem | AdminMember1[] | undefined;
    ...
    private _appsVisibilityList?: AppListItem | AdminMember1[] | undefined;
    ...
    private _compliantAppsList?: AppListItem | AdminMember1[] | undefined;
    ...
    private _mediaContentRatingAustralia?: MediaContentRatingAustralia | AdminMember1 | undefined;
    /** Media content rating settings for Canada */
    private _mediaContentRatingCanada?: MediaContentRatingCanada | AdminMember1 | undefined;
    /** Media content rating settings for France */
    private _mediaContentRatingFrance?: MediaContentRatingFrance | AdminMember1 | undefined;
    /** Media content rating settings for Germany */
    private _mediaContentRatingGermany?: MediaContentRatingGermany | AdminMember1 | undefined;
    /** Media content rating settings for Ireland */
    private _mediaContentRatingIreland?: MediaContentRatingIreland | AdminMember1 | undefined;
    /** Media content rating settings for Japan */
    private _mediaContentRatingJapan?: MediaContentRatingJapan | AdminMember1 | undefined;
    /** Media content rating settings for New Zealand */
    private _mediaContentRatingNewZealand?: MediaContentRatingNewZealand | AdminMember1 | undefined;
    /** Media content rating settings for United Kingdom */
    private _mediaContentRatingUnitedKingdom?: MediaContentRatingUnitedKingdom | AdminMember1 | undefined;
    /** Media content rating settings for United States */
    private _mediaContentRatingUnitedStates?: MediaContentRatingUnitedStates | AdminMember1 | undefined;
    /** Indicates whether or not to block the user from using the Messages app on the supervised device. */
    private _messagesBlocked?: boolean | undefined;
    /** List of managed apps and the network rules that applies to them. This collection can contain a maximum of 1000 elements. */
    private _networkUsageRules?: IosNetworkUsageRule | AdminMember1[] | undefined;
     ...
     */
    public set appsSingleAppModeList(value: AppListItem | AdminMember1[] | undefined) {
     ...
     */
    public set appsVisibilityList(value: AppListItem | AdminMember1[] | undefined) {
     ...
     */
    public set compliantAppsList(value: AppListItem | AdminMember1[] | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "appsSingleAppModeList": n => { this.appsSingleAppModeList = n.getObjectValue<AppListItem>(createAppListItemFromDiscriminatorValue); },
            ...
            "appsVisibilityList": n => { this.appsVisibilityList = n.getObjectValue<AppListItem>(createAppListItemFromDiscriminatorValue); },
            ...
            "compliantAppsList": n => { this.compliantAppsList = n.getObjectValue<AppListItem>(createAppListItemFromDiscriminatorValue); },
            ...
            "networkUsageRules": n => { this.networkUsageRules = n.getObjectValue<IosNetworkUsageRule>(createIosNetworkUsageRuleFromDiscriminatorValue); },
     ...
     */
    public set mediaContentRatingAustralia(value: MediaContentRatingAustralia | AdminMember1 | undefined) {
     ...
     */
    public set mediaContentRatingCanada(value: MediaContentRatingCanada | AdminMember1 | undefined) {
     ...
     */
    public set mediaContentRatingFrance(value: MediaContentRatingFrance | AdminMember1 | undefined) {
     ...
     */
    public set mediaContentRatingGermany(value: MediaContentRatingGermany | AdminMember1 | undefined) {
     ...
     */
    public set mediaContentRatingIreland(value: MediaContentRatingIreland | AdminMember1 | undefined) {
     ...
     */
    public set mediaContentRatingJapan(value: MediaContentRatingJapan | AdminMember1 | undefined) {
     ...
     */
    public set mediaContentRatingNewZealand(value: MediaContentRatingNewZealand | AdminMember1 | undefined) {
     ...
     */
    public set mediaContentRatingUnitedKingdom(value: MediaContentRatingUnitedKingdom | AdminMember1 | undefined) {
     ...
     */
    public set mediaContentRatingUnitedStates(value: MediaContentRatingUnitedStates | AdminMember1 | undefined) {
     ...
     */
    public set networkUsageRules(value: IosNetworkUsageRule | AdminMember1[] | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<AppListItem>("appsSingleAppModeList", this.appsSingleAppModeList);
        ...
        writer.writeObjectValue<AppListItem>("appsVisibilityList", this.appsVisibilityList);
        ...
        writer.writeObjectValue<AppListItem>("compliantAppsList", this.compliantAppsList);
        ...
        writer.writeObjectValue<IosNetworkUsageRule>("networkUsageRules", this.networkUsageRules);
