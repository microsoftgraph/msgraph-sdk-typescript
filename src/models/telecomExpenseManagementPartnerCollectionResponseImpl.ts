...
export class TelecomExpenseManagementPartnerCollectionResponseImpl implements TelecomExpenseManagementPartnerCollectionResponse {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** The nextLink property */
    private _nextLink?: string | undefined;
    /** The value property */
    private _value?: TelecomExpenseManagementPartner[] | undefined;
    /**
    ...
    public constructor(telecomExpenseManagementPartnerCollectionResponseParameterValue?: TelecomExpenseManagementPartnerCollectionResponse | undefined) {
        this._additionalData = telecomExpenseManagementPartnerCollectionResponseParameterValue?.additionalData ? telecomExpenseManagementPartnerCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = telecomExpenseManagementPartnerCollectionResponseParameterValue?.nextLink;
        this._value = telecomExpenseManagementPartnerCollectionResponseParameterValue?.value;
    };
    /**
     ...
     * @returns a TelecomExpenseManagementPartnerInterface
     */
    public get value() {
        return this._value;
    };
     ...
     */
    public set value(value: TelecomExpenseManagementPartner[] | undefined) {
        if(value) {
