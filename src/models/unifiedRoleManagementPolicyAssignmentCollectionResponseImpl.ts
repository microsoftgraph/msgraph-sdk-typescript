...
export class UnifiedRoleManagementPolicyAssignmentCollectionResponseImpl implements AdditionalDataHolder, Parsable, UnifiedRoleManagementPolicyAssignmentCollectionResponse {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value){
        const valueArrValue: UnifiedRoleManagementPolicyAssignmentImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new UnifiedRoleManagementPolicyAssignmentImpl(element));});
