...
export class DeviceConfigurationDeviceStatusImpl extends EntityImpl implements DeviceConfigurationDeviceStatus {
    ...
    public constructor(deviceConfigurationDeviceStatusParameterValue?: DeviceConfigurationDeviceStatus | undefined) {
        ...
        this._complianceGracePeriodExpirationDateTime = deviceConfigurationDeviceStatusParameterValue?.complianceGracePeriodExpirationDateTime;
        this._deviceDisplayName = deviceConfigurationDeviceStatusParameterValue?.deviceDisplayName;
        this._deviceModel = deviceConfigurationDeviceStatusParameterValue?.deviceModel;
        this._lastReportedDateTime = deviceConfigurationDeviceStatusParameterValue?.lastReportedDateTime;
        this._status = deviceConfigurationDeviceStatusParameterValue?.status;
        this._userName = deviceConfigurationDeviceStatusParameterValue?.userName;
        this._userPrincipalName = deviceConfigurationDeviceStatusParameterValue?.userPrincipalName;
    };
    /**
