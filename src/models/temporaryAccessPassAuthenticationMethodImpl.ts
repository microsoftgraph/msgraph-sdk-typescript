...
export class TemporaryAccessPassAuthenticationMethodImpl extends AuthenticationMethodImpl implements TemporaryAccessPassAuthenticationMethod {
    ...
    public constructor(temporaryAccessPassAuthenticationMethodParameterValue?: TemporaryAccessPassAuthenticationMethod | undefined) {
        ...
        this._createdDateTime = temporaryAccessPassAuthenticationMethodParameterValue?.createdDateTime;
        this._isUsable = temporaryAccessPassAuthenticationMethodParameterValue?.isUsable;
        this._isUsableOnce = temporaryAccessPassAuthenticationMethodParameterValue?.isUsableOnce;
        this._lifetimeInMinutes = temporaryAccessPassAuthenticationMethodParameterValue?.lifetimeInMinutes;
        this._methodUsabilityReason = temporaryAccessPassAuthenticationMethodParameterValue?.methodUsabilityReason;
        this._startDateTime = temporaryAccessPassAuthenticationMethodParameterValue?.startDateTime;
        this._temporaryAccessPass = temporaryAccessPassAuthenticationMethodParameterValue?.temporaryAccessPass;
    };
    /**
