...
export class ProvisioningErrorInfoImpl implements ProvisioningErrorInfo {
    ...
    public constructor(provisioningErrorInfoParameterValue?: ProvisioningErrorInfo | undefined) {
        this._additionalData = provisioningErrorInfoParameterValue?.additionalData ? provisioningErrorInfoParameterValue?.additionalData! : {};
        this._additionalDetails = provisioningErrorInfoParameterValue?.additionalDetails;
        this._errorCategory = provisioningErrorInfoParameterValue?.errorCategory;
        this._errorCode = provisioningErrorInfoParameterValue?.errorCode;
        this._reason = provisioningErrorInfoParameterValue?.reason;
        this._recommendedAction = provisioningErrorInfoParameterValue?.recommendedAction;
    };
    /**
