...
export class ServicePrincipalCollectionResponseImpl implements ServicePrincipalCollectionResponse {
    ...
    public constructor(servicePrincipalCollectionResponseParameterValue?: ServicePrincipalCollectionResponse | undefined) {
        this._additionalData = servicePrincipalCollectionResponseParameterValue?.additionalData ? servicePrincipalCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = servicePrincipalCollectionResponseParameterValue?.nextLink;
        this._value = servicePrincipalCollectionResponseParameterValue?.value;
    };
    /**
