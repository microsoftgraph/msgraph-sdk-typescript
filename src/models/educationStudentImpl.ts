...
export class EducationStudentImpl implements EducationStudent {
    ...
    public constructor(educationStudentParameterValue?: EducationStudent | undefined) {
        this._additionalData = educationStudentParameterValue?.additionalData ? educationStudentParameterValue?.additionalData! : {};
        this._birthDate = educationStudentParameterValue?.birthDate;
        this._externalId = educationStudentParameterValue?.externalId;
        this._gender = educationStudentParameterValue?.gender;
        this._grade = educationStudentParameterValue?.grade;
        this._graduationYear = educationStudentParameterValue?.graduationYear;
        this._studentNumber = educationStudentParameterValue?.studentNumber;
    };
    /**
