...
export class UnifiedRoleDefinitionCollectionResponseImpl implements UnifiedRoleDefinitionCollectionResponse {
    ...
    public constructor(unifiedRoleDefinitionCollectionResponseParameterValue?: UnifiedRoleDefinitionCollectionResponse | undefined) {
        this._additionalData = unifiedRoleDefinitionCollectionResponseParameterValue?.additionalData ? unifiedRoleDefinitionCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = unifiedRoleDefinitionCollectionResponseParameterValue?.nextLink;
        this._value = unifiedRoleDefinitionCollectionResponseParameterValue?.value;
    };
    /**
