...
export class BookingServiceCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as BookingServiceCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as BookingServiceCollectionResponse).value = n.getCollectionOfObjectValues<BookingService>(createBookingServiceFromDiscriminatorValue); },
        };
    };
    /**
