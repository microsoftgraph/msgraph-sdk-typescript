...
export class EmailFileAssessmentRequestImpl extends ThreatAssessmentRequestImpl implements EmailFileAssessmentRequest {
    ...
    public constructor(emailFileAssessmentRequestParameterValue?: EmailFileAssessmentRequest | undefined) {
        ...
        this._contentData = emailFileAssessmentRequestParameterValue?.contentData;
        this._destinationRoutingReason = emailFileAssessmentRequestParameterValue?.destinationRoutingReason;
        this._recipientEmail = emailFileAssessmentRequestParameterValue?.recipientEmail;
    };
    /**
