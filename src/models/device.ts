...
export class Device extends DirectoryObject implements Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            ...
            "alternativeSecurityIds": (o, n) => { (o as unknown as Device).alternativeSecurityIds = n.getCollectionOfObjectValues<AlternativeSecurityId>(createAlternativeSecurityIdFromDiscriminatorValue); },
            ...
            "extensions": (o, n) => { (o as unknown as Device).extensions = n.getCollectionOfObjectValues<Extension>(createExtensionFromDiscriminatorValue); },
            ...
            "memberOf": (o, n) => { (o as unknown as Device).memberOf = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); },
            ...
            "registeredOwners": (o, n) => { (o as unknown as Device).registeredOwners = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); },
            "registeredUsers": (o, n) => { (o as unknown as Device).registeredUsers = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); },
            "systemLabels": (o, n) => { (o as unknown as Device).systemLabels = n.getCollectionOfPrimitiveValues<string>(); },
            "transitiveMemberOf": (o, n) => { (o as unknown as Device).transitiveMemberOf = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); },
