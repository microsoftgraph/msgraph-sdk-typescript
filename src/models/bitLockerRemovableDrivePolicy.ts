...
export class BitLockerRemovableDrivePolicy implements AdditionalDataHolder, Parsable {
    ...
    private _encryptionMethod?: BitLockerEncryptionMethod | AdminMember1 | undefined;
     ...
     */
    public set encryptionMethod(value: BitLockerEncryptionMethod | AdminMember1 | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "encryptionMethod": n => { this.encryptionMethod = n.getObjectValue<BitLockerEncryptionMethod>(createBitLockerEncryptionMethodFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<BitLockerEncryptionMethod>("encryptionMethod", this.encryptionMethod);
