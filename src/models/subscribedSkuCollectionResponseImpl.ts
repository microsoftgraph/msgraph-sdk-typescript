...
export class SubscribedSkuCollectionResponseImpl implements SubscribedSkuCollectionResponse {
    ...
    public constructor(subscribedSkuCollectionResponseParameterValue?: SubscribedSkuCollectionResponse | undefined) {
        this._additionalData = subscribedSkuCollectionResponseParameterValue?.additionalData ? subscribedSkuCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = subscribedSkuCollectionResponseParameterValue?.nextLink;
        this._value = subscribedSkuCollectionResponseParameterValue?.value;
    };
    /**
     ...
     * @returns a SubscribedSkuInterface
     */
    public get value() {
        return this._value;
    };
