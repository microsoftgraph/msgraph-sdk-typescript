...
export class WindowsMinimumOperatingSystemImpl implements WindowsMinimumOperatingSystem {
    ...
    public constructor(windowsMinimumOperatingSystemParameterValue?: WindowsMinimumOperatingSystem | undefined) {
        this._additionalData = windowsMinimumOperatingSystemParameterValue?.additionalData ? windowsMinimumOperatingSystemParameterValue?.additionalData! : {};
        this._v10_0 = windowsMinimumOperatingSystemParameterValue?.v10_0;
        this._v8_0 = windowsMinimumOperatingSystemParameterValue?.v8_0;
        this._v8_1 = windowsMinimumOperatingSystemParameterValue?.v8_1;
    };
    /**
