...
export class TeleconferenceDeviceQualityImpl implements TeleconferenceDeviceQuality {
    ...
    public constructor(teleconferenceDeviceQualityParameterValue?: TeleconferenceDeviceQuality | undefined) {
        ...
        const mediaQualityListArrValue: TeleconferenceDeviceMediaQualityImpl[] = []; this.mediaQualityList?.forEach(element => {mediaQualityListArrValue.push(element instanceof TeleconferenceDeviceMediaQualityImpl? element : new TeleconferenceDeviceMediaQualityImpl(element));});
