...
export class TeleconferenceDeviceQualityImpl implements AdditionalDataHolder, Parsable, TeleconferenceDeviceQuality {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.mediaQualityList){
        const mediaQualityListArrValue: TeleconferenceDeviceMediaQualityImpl[] = []; this.mediaQualityList?.forEach(element => {mediaQualityListArrValue.push(new TeleconferenceDeviceMediaQualityImpl(element));});
