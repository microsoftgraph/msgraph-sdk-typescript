...
export class DeviceConfigurationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DeviceConfigurationCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DeviceConfigurationCollectionResponse).value = n.getCollectionOfObjectValues<DeviceConfiguration>(createDeviceConfigurationFromDiscriminatorValue); },
        };
    };
    /**
