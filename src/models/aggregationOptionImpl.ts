...
export class AggregationOptionImpl implements AggregationOption {
     ...
     * @returns a BucketAggregationDefinitionInterface
     */
    ...
    public constructor(aggregationOptionParameterValue?: AggregationOption | undefined) {
        this._additionalData = aggregationOptionParameterValue?.additionalData ? aggregationOptionParameterValue?.additionalData! : {};
        this._bucketDefinition = aggregationOptionParameterValue?.bucketDefinition;
        this._field = aggregationOptionParameterValue?.field;
        this._size = aggregationOptionParameterValue?.size;
    };
    /**
