...
export class RecentNotebookLinksImpl implements RecentNotebookLinks {
     ...
     * @param recentNotebookLinksParameterValue 
     */
    public constructor(recentNotebookLinksParameterValue?: RecentNotebookLinks | undefined) {
        this._additionalData = recentNotebookLinksParameterValue?.additionalData ? recentNotebookLinksParameterValue?.additionalData! : {};
        this._oneNoteClientUrl = recentNotebookLinksParameterValue?.oneNoteClientUrl;
        this._oneNoteWebUrl = recentNotebookLinksParameterValue?.oneNoteWebUrl;
    };
    /**
