...
export class DomainCollectionResponseImpl implements DomainCollectionResponse {
    ...
    public constructor(domainCollectionResponseParameterValue?: DomainCollectionResponse | undefined) {
        this._additionalData = domainCollectionResponseParameterValue?.additionalData ? domainCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = domainCollectionResponseParameterValue?.nextLink;
        this._value = domainCollectionResponseParameterValue?.value;
    };
    /**
