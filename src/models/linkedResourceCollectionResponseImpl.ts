...
export class LinkedResourceCollectionResponseImpl implements LinkedResourceCollectionResponse {
    ...
    public constructor(linkedResourceCollectionResponseParameterValue?: LinkedResourceCollectionResponse | undefined) {
        this._additionalData = linkedResourceCollectionResponseParameterValue?.additionalData ? linkedResourceCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = linkedResourceCollectionResponseParameterValue?.nextLink;
        this._value = linkedResourceCollectionResponseParameterValue?.value;
    };
    /**
