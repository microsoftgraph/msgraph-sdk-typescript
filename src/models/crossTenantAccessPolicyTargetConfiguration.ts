...
import {ApplicationsMember1, CrossTenantAccessPolicyTarget} from './index';
...
export class CrossTenantAccessPolicyTargetConfiguration implements AdditionalDataHolder, Parsable {
    ...
    private _accessType?: CrossTenantAccessPolicyTargetConfigurationAccessType | ApplicationsMember1 | undefined;
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Specifies whether to target users, groups, or applications with this rule. */
    private _targets?: CrossTenantAccessPolicyTarget | ApplicationsMember1[] | undefined;
    /**
     ...
     */
    public set accessType(value: CrossTenantAccessPolicyTargetConfigurationAccessType | ApplicationsMember1 | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "accessType": n => { this.accessType = n.getObjectValue<CrossTenantAccessPolicyTargetConfigurationAccessType>(createCrossTenantAccessPolicyTargetConfigurationAccessTypeFromDiscriminatorValue); },
            "targets": n => { this.targets = n.getObjectValue<CrossTenantAccessPolicyTarget>(createCrossTenantAccessPolicyTargetFromDiscriminatorValue); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<CrossTenantAccessPolicyTargetConfigurationAccessType>("accessType", this.accessType);
        writer.writeObjectValue<CrossTenantAccessPolicyTarget>("targets", this.targets);
     ...
     */
    public set targets(value: CrossTenantAccessPolicyTarget | ApplicationsMember1[] | undefined) {
        this._targets = value;
    };
}
