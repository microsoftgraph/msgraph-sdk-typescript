import {createSocialIdentityProviderFromDiscriminatorValue} from './createSocialIdentityProviderFromDiscriminatorValue';
...
export class SocialIdentityProviderCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "value": n => { this.value = n.getCollectionOfObjectValues<SocialIdentityProvider>(createSocialIdentityProviderFromDiscriminatorValue); },
        };
    };
    /**
