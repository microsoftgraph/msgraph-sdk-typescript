...
export class DomainDnsSrvRecordImpl extends DomainDnsRecordImpl implements DomainDnsSrvRecord {
    ...
    public constructor(domainDnsSrvRecordParameterValue?: DomainDnsSrvRecord | undefined) {
        ...
        this._nameTarget = domainDnsSrvRecordParameterValue?.nameTarget;
        this._port = domainDnsSrvRecordParameterValue?.port;
        this._priority = domainDnsSrvRecordParameterValue?.priority;
        this._protocol = domainDnsSrvRecordParameterValue?.protocol;
        this._service = domainDnsSrvRecordParameterValue?.service;
        this._weight = domainDnsSrvRecordParameterValue?.weight;
    };
    /**
