import {AdminMember1, AppListItem} from './index';
...
export class IosNetworkUsageRule implements AdditionalDataHolder, Parsable {
    ...
    private _managedApps?: AppListItem | AdminMember1[] | undefined;
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "managedApps": n => { this.managedApps = n.getObjectValue<AppListItem>(createAppListItemFromDiscriminatorValue); },
        };
    };
    /**
     ...
     */
    public set managedApps(value: AppListItem | AdminMember1[] | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<AppListItem>("managedApps", this.managedApps);
