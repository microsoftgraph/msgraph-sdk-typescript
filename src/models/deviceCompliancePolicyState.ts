...
import {AdminMember1, DeviceCompliancePolicySettingState, Entity} from './index';
...
export class DeviceCompliancePolicyState extends Entity implements Parsable {
    ...
    private _settingStates?: DeviceCompliancePolicySettingState | AdminMember1[] | undefined;
    /** The state property */
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "settingStates": n => { this.settingStates = n.getObjectValue<DeviceCompliancePolicySettingState>(createDeviceCompliancePolicySettingStateFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<DeviceCompliancePolicySettingState>("settingStates", this.settingStates);
     ...
     */
    public set settingStates(value: DeviceCompliancePolicySettingState | AdminMember1[] | undefined) {
