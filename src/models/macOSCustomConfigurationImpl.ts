...
export class MacOSCustomConfigurationImpl extends DeviceConfigurationImpl implements MacOSCustomConfiguration {
    ...
    public constructor(macOSCustomConfigurationParameterValue?: MacOSCustomConfiguration | undefined) {
        ...
        this._payload = macOSCustomConfigurationParameterValue?.payload;
        this._payloadFileName = macOSCustomConfigurationParameterValue?.payloadFileName;
        this._payloadName = macOSCustomConfigurationParameterValue?.payloadName;
    };
    /**
