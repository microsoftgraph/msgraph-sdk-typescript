import {createIpNamedLocationFromDiscriminatorValue} from './createIpNamedLocationFromDiscriminatorValue';
...
export class IpNamedLocationCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "value": n => { this.value = n.getCollectionOfObjectValues<IpNamedLocation>(createIpNamedLocationFromDiscriminatorValue); },
        };
    };
    /**
