import {AdminMember1, Entity, UnifiedRoleManagementPolicy} from './index';
...
export class UnifiedRoleManagementPolicyAssignment extends Entity implements Parsable {
    ...
    private _policy?: UnifiedRoleManagementPolicy | AdminMember1 | undefined;
     ...
     */
    public set policy(value: UnifiedRoleManagementPolicy | AdminMember1 | undefined) {
        this._policy = value;
    };
    /**
