...
export class TermsExpirationImpl implements TermsExpiration {
    ...
    public constructor(termsExpirationParameterValue?: TermsExpiration | undefined) {
        this._additionalData = termsExpirationParameterValue?.additionalData ? termsExpirationParameterValue?.additionalData! : {};
        this._frequency = termsExpirationParameterValue?.frequency;
        this._startDateTime = termsExpirationParameterValue?.startDateTime;
    };
    /**
