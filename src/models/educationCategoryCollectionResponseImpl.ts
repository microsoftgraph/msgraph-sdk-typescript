...
export class EducationCategoryCollectionResponseImpl implements EducationCategoryCollectionResponse {
    ...
    public constructor(educationCategoryCollectionResponseParameterValue?: EducationCategoryCollectionResponse | undefined) {
        this._additionalData = educationCategoryCollectionResponseParameterValue?.additionalData ? educationCategoryCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = educationCategoryCollectionResponseParameterValue?.nextLink;
        this._value = educationCategoryCollectionResponseParameterValue?.value;
    };
    /**
