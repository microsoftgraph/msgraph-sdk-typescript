...
export class ResourceSpecificPermissionGrantImpl extends DirectoryObjectImpl implements ResourceSpecificPermissionGrant {
    ...
    public constructor(resourceSpecificPermissionGrantParameterValue?: ResourceSpecificPermissionGrant | undefined) {
        ...
        this._clientAppId = resourceSpecificPermissionGrantParameterValue?.clientAppId;
        this._clientId = resourceSpecificPermissionGrantParameterValue?.clientId;
        this._permission = resourceSpecificPermissionGrantParameterValue?.permission;
        this._permissionType = resourceSpecificPermissionGrantParameterValue?.permissionType;
        this._resourceAppId = resourceSpecificPermissionGrantParameterValue?.resourceAppId;
    };
    /**
