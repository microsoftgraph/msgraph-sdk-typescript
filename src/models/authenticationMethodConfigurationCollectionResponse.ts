...
export class AuthenticationMethodConfigurationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as AuthenticationMethodConfigurationCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as AuthenticationMethodConfigurationCollectionResponse).value = n.getCollectionOfObjectValues<AuthenticationMethodConfiguration>(createAuthenticationMethodConfigurationFromDiscriminatorValue); },
        };
    };
    /**
