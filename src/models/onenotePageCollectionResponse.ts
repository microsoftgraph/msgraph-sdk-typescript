...
export class OnenotePageCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as OnenotePageCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as OnenotePageCollectionResponse).value = n.getCollectionOfObjectValues<OnenotePage>(createOnenotePageFromDiscriminatorValue); },
        };
    };
    /**
