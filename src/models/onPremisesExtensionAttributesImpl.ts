...
export class OnPremisesExtensionAttributesImpl implements OnPremisesExtensionAttributes {
    ...
    public constructor(onPremisesExtensionAttributesParameterValue?: OnPremisesExtensionAttributes | undefined) {
        this._additionalData = onPremisesExtensionAttributesParameterValue?.additionalData ? onPremisesExtensionAttributesParameterValue?.additionalData! : {};
        this._extensionAttribute1 = onPremisesExtensionAttributesParameterValue?.extensionAttribute1;
        this._extensionAttribute10 = onPremisesExtensionAttributesParameterValue?.extensionAttribute10;
        this._extensionAttribute11 = onPremisesExtensionAttributesParameterValue?.extensionAttribute11;
        this._extensionAttribute12 = onPremisesExtensionAttributesParameterValue?.extensionAttribute12;
        this._extensionAttribute13 = onPremisesExtensionAttributesParameterValue?.extensionAttribute13;
        this._extensionAttribute14 = onPremisesExtensionAttributesParameterValue?.extensionAttribute14;
        this._extensionAttribute15 = onPremisesExtensionAttributesParameterValue?.extensionAttribute15;
        this._extensionAttribute2 = onPremisesExtensionAttributesParameterValue?.extensionAttribute2;
        this._extensionAttribute3 = onPremisesExtensionAttributesParameterValue?.extensionAttribute3;
        this._extensionAttribute4 = onPremisesExtensionAttributesParameterValue?.extensionAttribute4;
        this._extensionAttribute5 = onPremisesExtensionAttributesParameterValue?.extensionAttribute5;
        this._extensionAttribute6 = onPremisesExtensionAttributesParameterValue?.extensionAttribute6;
        this._extensionAttribute7 = onPremisesExtensionAttributesParameterValue?.extensionAttribute7;
        this._extensionAttribute8 = onPremisesExtensionAttributesParameterValue?.extensionAttribute8;
        this._extensionAttribute9 = onPremisesExtensionAttributesParameterValue?.extensionAttribute9;
    };
    /**
