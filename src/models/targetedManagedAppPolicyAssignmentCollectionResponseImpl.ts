...
export class TargetedManagedAppPolicyAssignmentCollectionResponseImpl implements TargetedManagedAppPolicyAssignmentCollectionResponse {
    ...
    public constructor(targetedManagedAppPolicyAssignmentCollectionResponseParameterValue?: TargetedManagedAppPolicyAssignmentCollectionResponse | undefined) {
        this._additionalData = targetedManagedAppPolicyAssignmentCollectionResponseParameterValue?.additionalData ? targetedManagedAppPolicyAssignmentCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = targetedManagedAppPolicyAssignmentCollectionResponseParameterValue?.nextLink;
        this._value = targetedManagedAppPolicyAssignmentCollectionResponseParameterValue?.value;
    };
    /**
