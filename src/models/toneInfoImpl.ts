...
export class ToneInfoImpl implements ToneInfo {
    ...
    public constructor(toneInfoParameterValue?: ToneInfo | undefined) {
        this._additionalData = toneInfoParameterValue?.additionalData ? toneInfoParameterValue?.additionalData! : {};
        this._sequenceId = toneInfoParameterValue?.sequenceId;
        this._tone = toneInfoParameterValue?.tone;
    };
    /**
