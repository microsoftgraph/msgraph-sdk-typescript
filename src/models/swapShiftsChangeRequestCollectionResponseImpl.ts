...
export class SwapShiftsChangeRequestCollectionResponseImpl implements AdditionalDataHolder, Parsable, SwapShiftsChangeRequestCollectionResponse {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value){
        const valueArrValue: SwapShiftsChangeRequestImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new SwapShiftsChangeRequestImpl(element));});
