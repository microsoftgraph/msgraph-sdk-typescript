...
export class MobileThreatDefenseConnectorCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as MobileThreatDefenseConnectorCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as MobileThreatDefenseConnectorCollectionResponse).value = n.getCollectionOfObjectValues<MobileThreatDefenseConnector>(createMobileThreatDefenseConnectorFromDiscriminatorValue); },
        };
    };
    /**
