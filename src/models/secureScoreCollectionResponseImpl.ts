...
export class SecureScoreCollectionResponseImpl implements SecureScoreCollectionResponse {
    ...
    public constructor(secureScoreCollectionResponseParameterValue?: SecureScoreCollectionResponse | undefined) {
        this._additionalData = secureScoreCollectionResponseParameterValue?.additionalData ? secureScoreCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = secureScoreCollectionResponseParameterValue?.nextLink;
        this._value = secureScoreCollectionResponseParameterValue?.value;
    };
    /**
