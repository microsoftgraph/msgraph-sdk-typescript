...
export class ServiceUpdateMessage extends ServiceAnnouncementBase implements Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            ...
            "attachments": (o, n) => { (o as unknown as ServiceUpdateMessage).attachments = n.getCollectionOfObjectValues<ServiceAnnouncementAttachment>(createServiceAnnouncementAttachmentFromDiscriminatorValue); },
            "attachmentsArchive": (o, n) => { (o as unknown as ServiceUpdateMessage).attachmentsArchive = n.getStringValue(); },
            "body": (o, n) => { (o as unknown as ServiceUpdateMessage).body = n.getObjectValue<ItemBody>(createItemBodyFromDiscriminatorValue); },
            ...
            "viewPoint": (o, n) => { (o as unknown as ServiceUpdateMessage).viewPoint = n.getObjectValue<ServiceUpdateMessageViewpoint>(createServiceUpdateMessageViewpointFromDiscriminatorValue); },
        };
    };
    /**
