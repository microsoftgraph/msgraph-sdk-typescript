...
export class GroupSettingTemplateCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as GroupSettingTemplateCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as GroupSettingTemplateCollectionResponse).value = n.getCollectionOfObjectValues<GroupSettingTemplate>(createGroupSettingTemplateFromDiscriminatorValue); },
        };
    };
    /**
