...
export class TodoTaskListCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as TodoTaskListCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as TodoTaskListCollectionResponse).value = n.getCollectionOfObjectValues<TodoTaskList>(createTodoTaskListFromDiscriminatorValue); },
        };
    };
    /**
