...
export class ThreatAssessmentRequestCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ThreatAssessmentRequestCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ThreatAssessmentRequestCollectionResponse).value = n.getCollectionOfObjectValues<ThreatAssessmentRequest>(createThreatAssessmentRequestFromDiscriminatorValue); },
        };
    };
    /**
