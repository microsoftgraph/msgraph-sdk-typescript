...
export class SubscribedSkuCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as SubscribedSkuCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as SubscribedSkuCollectionResponse).value = n.getCollectionOfObjectValues<SubscribedSku>(createSubscribedSkuFromDiscriminatorValue); },
        };
    };
    /**
