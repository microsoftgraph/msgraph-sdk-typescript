...
export class IdentityUserFlowAttributeAssignmentCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as IdentityUserFlowAttributeAssignmentCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as IdentityUserFlowAttributeAssignmentCollectionResponse).value = n.getCollectionOfObjectValues<IdentityUserFlowAttributeAssignment>(createIdentityUserFlowAttributeAssignmentFromDiscriminatorValue); },
        };
    };
    /**
