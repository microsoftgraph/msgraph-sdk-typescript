...
export class AuthenticationMethodCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as AuthenticationMethodCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as AuthenticationMethodCollectionResponse).value = n.getCollectionOfObjectValues<AuthenticationMethod>(createAuthenticationMethodFromDiscriminatorValue); },
        };
    };
    /**
