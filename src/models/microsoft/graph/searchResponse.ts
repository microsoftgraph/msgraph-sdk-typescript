...
export class SearchResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["hitsContainers", (o, n) => { (o as unknown as SearchResponse).hitsContainers = n.getCollectionOfObjectValues<SearchHitsContainer>(SearchHitsContainer); }],
            ["queryAlterationResponse", (o, n) => { (o as unknown as SearchResponse).queryAlterationResponse = n.getObjectValue<AlterationResponse>(AlterationResponse); }],
            ["resultTemplates", (o, n) => { (o as unknown as SearchResponse).resultTemplates = n.getObjectValue<ResultTemplateDictionary>(ResultTemplateDictionary); }],
