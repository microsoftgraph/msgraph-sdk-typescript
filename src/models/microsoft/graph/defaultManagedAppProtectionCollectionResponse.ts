...
export class DefaultManagedAppProtectionCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DefaultManagedAppProtectionCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DefaultManagedAppProtectionCollectionResponse).value = n.getCollectionOfObjectValues<DefaultManagedAppProtection>(createDefaultManagedAppProtectionFromDiscriminatorValue); },
        };
    };
    /**
