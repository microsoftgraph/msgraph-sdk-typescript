...
export class RecentNotebookLinks implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["oneNoteClientUrl", (o, n) => { (o as unknown as RecentNotebookLinks).oneNoteClientUrl = n.getObjectValue<ExternalLink>(createExternalLinkFromDiscriminatorValue); }],
            ["oneNoteWebUrl", (o, n) => { (o as unknown as RecentNotebookLinks).oneNoteWebUrl = n.getObjectValue<ExternalLink>(createExternalLinkFromDiscriminatorValue); }],
        ]);
    };
    /**
