...
export class ColumnLinkCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ColumnLinkCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ColumnLinkCollectionResponse).value = n.getCollectionOfObjectValues<ColumnLink>(createColumnLinkFromDiscriminatorValue); },
        };
    };
    /**
