...
export class UserActivityCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as UserActivityCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as UserActivityCollectionResponse).value = n.getCollectionOfObjectValues<UserActivity>(createUserActivityFromDiscriminatorValue); },
        };
    };
    /**
