...
export class TrendingCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TrendingCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TrendingCollectionResponse).value = n.getCollectionOfObjectValues<Trending>(createTrendingFromDiscriminatorValue); }],
        ]);
    };
    /**
