...
export class AdministrativeUnitCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AdministrativeUnitCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AdministrativeUnitCollectionResponse).value = n.getCollectionOfObjectValues<AdministrativeUnit>(createAdministrativeUnitFromDiscriminatorValue); }],
        ]);
    };
    /**
