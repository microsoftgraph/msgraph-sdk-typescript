...
export class SingleValueLegacyExtendedPropertyCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as SingleValueLegacyExtendedPropertyCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as SingleValueLegacyExtendedPropertyCollectionResponse).value = n.getCollectionOfObjectValues<SingleValueLegacyExtendedProperty>(createSingleValueLegacyExtendedPropertyFromDiscriminatorValue); },
        };
    };
    /**
