...
export class EducationSchoolCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as EducationSchoolCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as EducationSchoolCollectionResponse).value = n.getCollectionOfObjectValues<EducationSchool>(createEducationSchoolFromDiscriminatorValue); },
        };
    };
    /**
