...
export class ServiceUpdateMessageCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ServiceUpdateMessageCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ServiceUpdateMessageCollectionResponse).value = n.getCollectionOfObjectValues<ServiceUpdateMessage>(createServiceUpdateMessageFromDiscriminatorValue); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<ServiceUpdateMessage>("value", this.value);
