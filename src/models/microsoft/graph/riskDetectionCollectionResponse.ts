...
export class RiskDetectionCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as RiskDetectionCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as RiskDetectionCollectionResponse).value = n.getCollectionOfObjectValues<RiskDetection>(createRiskDetectionFromDiscriminatorValue); },
        };
    };
    /**
