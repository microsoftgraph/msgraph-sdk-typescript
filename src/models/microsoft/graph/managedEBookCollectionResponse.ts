...
export class ManagedEBookCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ManagedEBookCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ManagedEBookCollectionResponse).value = n.getCollectionOfObjectValues<ManagedEBook>(createManagedEBookFromDiscriminatorValue); },
        };
    };
    /**
