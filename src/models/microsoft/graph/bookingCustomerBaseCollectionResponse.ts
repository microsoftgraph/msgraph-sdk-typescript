...
export class BookingCustomerBaseCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as BookingCustomerBaseCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as BookingCustomerBaseCollectionResponse).value = n.getCollectionOfObjectValues<BookingCustomerBase>(createBookingCustomerBaseFromDiscriminatorValue); }],
        ]);
    };
    /**
