...
export class EducationUser extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["assignedLicenses", (o, n) => { (o as unknown as EducationUser).assignedLicenses = n.getCollectionOfObjectValues<AssignedLicense>(createAssignedLicenseFromDiscriminatorValue); }],
            ["assignedPlans", (o, n) => { (o as unknown as EducationUser).assignedPlans = n.getCollectionOfObjectValues<AssignedPlan>(createAssignedPlanFromDiscriminatorValue); }],
            ["assignments", (o, n) => { (o as unknown as EducationUser).assignments = n.getCollectionOfObjectValues<EducationAssignment>(createEducationAssignmentFromDiscriminatorValue); }],
            ["businessPhones", (o, n) => { (o as unknown as EducationUser).businessPhones = n.getCollectionOfPrimitiveValues<string>(); }],
            ["classes", (o, n) => { (o as unknown as EducationUser).classes = n.getCollectionOfObjectValues<EducationClass>(createEducationClassFromDiscriminatorValue); }],
            ["createdBy", (o, n) => { (o as unknown as EducationUser).createdBy = n.getObjectValue<IdentitySet>(createIdentitySetFromDiscriminatorValue); }],
            ...
            ["mailingAddress", (o, n) => { (o as unknown as EducationUser).mailingAddress = n.getObjectValue<PhysicalAddress>(createPhysicalAddressFromDiscriminatorValue); }],
            ...
            ["onPremisesInfo", (o, n) => { (o as unknown as EducationUser).onPremisesInfo = n.getObjectValue<EducationOnPremisesInfo>(createEducationOnPremisesInfoFromDiscriminatorValue); }],
            ["passwordPolicies", (o, n) => { (o as unknown as EducationUser).passwordPolicies = n.getStringValue(); }],
            ["passwordProfile", (o, n) => { (o as unknown as EducationUser).passwordProfile = n.getObjectValue<PasswordProfile>(createPasswordProfileFromDiscriminatorValue); }],
            ...
            ["provisionedPlans", (o, n) => { (o as unknown as EducationUser).provisionedPlans = n.getCollectionOfObjectValues<ProvisionedPlan>(createProvisionedPlanFromDiscriminatorValue); }],
            ["refreshTokensValidFromDateTime", (o, n) => { (o as unknown as EducationUser).refreshTokensValidFromDateTime = n.getDateValue(); }],
            ["relatedContacts", (o, n) => { (o as unknown as EducationUser).relatedContacts = n.getCollectionOfObjectValues<RelatedContact>(createRelatedContactFromDiscriminatorValue); }],
            ["residenceAddress", (o, n) => { (o as unknown as EducationUser).residenceAddress = n.getObjectValue<PhysicalAddress>(createPhysicalAddressFromDiscriminatorValue); }],
            ["rubrics", (o, n) => { (o as unknown as EducationUser).rubrics = n.getCollectionOfObjectValues<EducationRubric>(createEducationRubricFromDiscriminatorValue); }],
            ["schools", (o, n) => { (o as unknown as EducationUser).schools = n.getCollectionOfObjectValues<EducationSchool>(createEducationSchoolFromDiscriminatorValue); }],
            ["showInAddressList", (o, n) => { (o as unknown as EducationUser).showInAddressList = n.getBooleanValue(); }],
            ["student", (o, n) => { (o as unknown as EducationUser).student = n.getObjectValue<EducationStudent>(createEducationStudentFromDiscriminatorValue); }],
            ["surname", (o, n) => { (o as unknown as EducationUser).surname = n.getStringValue(); }],
            ["taughtClasses", (o, n) => { (o as unknown as EducationUser).taughtClasses = n.getCollectionOfObjectValues<EducationClass>(createEducationClassFromDiscriminatorValue); }],
            ["teacher", (o, n) => { (o as unknown as EducationUser).teacher = n.getObjectValue<EducationTeacher>(createEducationTeacherFromDiscriminatorValue); }],
            ["usageLocation", (o, n) => { (o as unknown as EducationUser).usageLocation = n.getStringValue(); }],
            ["user", (o, n) => { (o as unknown as EducationUser).user = n.getObjectValue<User>(createUserFromDiscriminatorValue); }],
