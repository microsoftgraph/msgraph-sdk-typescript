...
export class NotebookLinks implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["oneNoteClientUrl", (o, n) => { (o as unknown as NotebookLinks).oneNoteClientUrl = n.getObjectValue<ExternalLink>(ExternalLink); }],
            ["oneNoteWebUrl", (o, n) => { (o as unknown as NotebookLinks).oneNoteWebUrl = n.getObjectValue<ExternalLink>(ExternalLink); }],
        ]);
    };
    /**
