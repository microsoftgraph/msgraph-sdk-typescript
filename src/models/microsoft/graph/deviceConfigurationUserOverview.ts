...
export class DeviceConfigurationUserOverview extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["configurationVersion", (o, n) => { (o as unknown as DeviceConfigurationUserOverview).configurationVersion = n.getNumberValue(); }],
            ["errorCount", (o, n) => { (o as unknown as DeviceConfigurationUserOverview).errorCount = n.getNumberValue(); }],
            ["failedCount", (o, n) => { (o as unknown as DeviceConfigurationUserOverview).failedCount = n.getNumberValue(); }],
            ["lastUpdateDateTime", (o, n) => { (o as unknown as DeviceConfigurationUserOverview).lastUpdateDateTime = n.getDateValue(); }],
            ["notApplicableCount", (o, n) => { (o as unknown as DeviceConfigurationUserOverview).notApplicableCount = n.getNumberValue(); }],
            ["pendingCount", (o, n) => { (o as unknown as DeviceConfigurationUserOverview).pendingCount = n.getNumberValue(); }],
            ["successCount", (o, n) => { (o as unknown as DeviceConfigurationUserOverview).successCount = n.getNumberValue(); }],
        ]);
    };
    /**
