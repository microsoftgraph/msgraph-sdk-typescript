...
export class DeviceComplianceUserStatusCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DeviceComplianceUserStatusCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DeviceComplianceUserStatusCollectionResponse).value = n.getCollectionOfObjectValues<DeviceComplianceUserStatus>(createDeviceComplianceUserStatusFromDiscriminatorValue); },
        };
    };
    /**
