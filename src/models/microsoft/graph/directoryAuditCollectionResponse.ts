...
export class DirectoryAuditCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DirectoryAuditCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DirectoryAuditCollectionResponse).value = n.getCollectionOfObjectValues<DirectoryAudit>(createDirectoryAuditFromDiscriminatorValue); },
        };
    };
    /**
