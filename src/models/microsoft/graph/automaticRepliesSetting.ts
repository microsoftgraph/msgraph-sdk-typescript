...
export class AutomaticRepliesSetting implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["scheduledEndDateTime", (o, n) => { (o as unknown as AutomaticRepliesSetting).scheduledEndDateTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
            ["scheduledStartDateTime", (o, n) => { (o as unknown as AutomaticRepliesSetting).scheduledStartDateTime = n.getObjectValue<DateTimeTimeZone>(DateTimeTimeZone); }],
