...
export class RelationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as RelationCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as RelationCollectionResponse).value = n.getCollectionOfObjectValues<Relation>(createRelationFromDiscriminatorValue); }],
        ]);
    };
    /**
