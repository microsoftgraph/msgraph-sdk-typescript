...
export class MessageRuleCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as MessageRuleCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as MessageRuleCollectionResponse).value = n.getCollectionOfObjectValues<MessageRule>(createMessageRuleFromDiscriminatorValue); },
        };
    };
    /**
