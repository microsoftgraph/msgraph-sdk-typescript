...
export class ContactCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ContactCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ContactCollectionResponse).value = n.getCollectionOfObjectValues<Contact>(createContactFromDiscriminatorValue); },
        };
    };
    /**
