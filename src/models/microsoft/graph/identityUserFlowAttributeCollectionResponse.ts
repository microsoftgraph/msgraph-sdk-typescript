...
export class IdentityUserFlowAttributeCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as IdentityUserFlowAttributeCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as IdentityUserFlowAttributeCollectionResponse).value = n.getCollectionOfObjectValues<IdentityUserFlowAttribute>(createIdentityUserFlowAttributeFromDiscriminatorValue); },
        };
    };
    /**
