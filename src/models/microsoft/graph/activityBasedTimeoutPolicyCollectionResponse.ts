...
export class ActivityBasedTimeoutPolicyCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ActivityBasedTimeoutPolicyCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ActivityBasedTimeoutPolicyCollectionResponse).value = n.getCollectionOfObjectValues<ActivityBasedTimeoutPolicy>(createActivityBasedTimeoutPolicyFromDiscriminatorValue); },
        };
    };
    /**
