...
export class EducationClassCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as EducationClassCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as EducationClassCollectionResponse).value = n.getCollectionOfObjectValues<EducationClass>(createEducationClassFromDiscriminatorValue); }],
        ]);
    };
    /**
