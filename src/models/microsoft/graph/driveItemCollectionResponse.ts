...
export class DriveItemCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DriveItemCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DriveItemCollectionResponse).value = n.getCollectionOfObjectValues<DriveItem>(createDriveItemFromDiscriminatorValue); },
        };
    };
    /**
