...
export class MailTips implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["automaticReplies", (o, n) => { (o as unknown as MailTips).automaticReplies = n.getObjectValue<AutomaticRepliesMailTips>(AutomaticRepliesMailTips); }],
            ...
            ["emailAddress", (o, n) => { (o as unknown as MailTips).emailAddress = n.getObjectValue<EmailAddress>(EmailAddress); }],
            ["error", (o, n) => { (o as unknown as MailTips).error_escaped = n.getObjectValue<MailTipsError>(MailTipsError); }],
            ...
            ["recipientSuggestions", (o, n) => { (o as unknown as MailTips).recipientSuggestions = n.getCollectionOfObjectValues<Recipient>(Recipient); }],
