...
export class Calendar extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["multiValueExtendedProperties", (o, n) => { (o as unknown as Calendar).multiValueExtendedProperties = n.getCollectionOfObjectValues<MultiValueLegacyExtendedProperty>(MultiValueLegacyExtendedProperty); }],
            ["name", (o, n) => { (o as unknown as Calendar).name = n.getStringValue(); }],
            ["owner", (o, n) => { (o as unknown as Calendar).owner = n.getObjectValue<EmailAddress>(EmailAddress); }],
            ["singleValueExtendedProperties", (o, n) => { (o as unknown as Calendar).singleValueExtendedProperties = n.getCollectionOfObjectValues<SingleValueLegacyExtendedProperty>(SingleValueLegacyExtendedProperty); }],
        ]);
    };
    /**
