...
export class AlertCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as AlertCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as AlertCollectionResponse).value = n.getCollectionOfObjectValues<Alert>(createAlertFromDiscriminatorValue); },
        };
    };
    /**
