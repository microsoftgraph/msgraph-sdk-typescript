...
export class ExternalItemCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ExternalItemCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ExternalItemCollectionResponse).value = n.getCollectionOfObjectValues<ExternalItem>(createExternalItemFromDiscriminatorValue); },
        };
    };
    /**
