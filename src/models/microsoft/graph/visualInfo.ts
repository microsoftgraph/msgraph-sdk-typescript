...
export class VisualInfo implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["attribution", (o, n) => { (o as unknown as VisualInfo).attribution = n.getObjectValue<ImageInfo>(ImageInfo); }],
            ["backgroundColor", (o, n) => { (o as unknown as VisualInfo).backgroundColor = n.getStringValue(); }],
            ["content", (o, n) => { (o as unknown as VisualInfo).content = n.getObjectValue<Json>(Json); }],
