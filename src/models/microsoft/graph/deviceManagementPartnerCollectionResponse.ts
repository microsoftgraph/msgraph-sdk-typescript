...
export class DeviceManagementPartnerCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DeviceManagementPartnerCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DeviceManagementPartnerCollectionResponse).value = n.getCollectionOfObjectValues<DeviceManagementPartner>(createDeviceManagementPartnerFromDiscriminatorValue); },
        };
    };
    /**
