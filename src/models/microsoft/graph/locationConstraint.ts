...
export class LocationConstraint implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["locations", (o, n) => { (o as unknown as LocationConstraint).locations = n.getCollectionOfObjectValues<LocationConstraintItem>(LocationConstraintItem); }],
