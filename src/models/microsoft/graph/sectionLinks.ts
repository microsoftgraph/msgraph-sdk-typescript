...
export class SectionLinks implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "oneNoteClientUrl": (o, n) => { (o as unknown as SectionLinks).oneNoteClientUrl = n.getObjectValue<ExternalLink>(createExternalLinkFromDiscriminatorValue); },
            "oneNoteWebUrl": (o, n) => { (o as unknown as SectionLinks).oneNoteWebUrl = n.getObjectValue<ExternalLink>(createExternalLinkFromDiscriminatorValue); },
        };
    };
    /**
