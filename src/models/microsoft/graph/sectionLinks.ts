...
export class SectionLinks implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["oneNoteClientUrl", (o, n) => { (o as unknown as SectionLinks).oneNoteClientUrl = n.getObjectValue<ExternalLink>(ExternalLink); }],
            ["oneNoteWebUrl", (o, n) => { (o as unknown as SectionLinks).oneNoteWebUrl = n.getObjectValue<ExternalLink>(ExternalLink); }],
        ]);
    };
    /**
