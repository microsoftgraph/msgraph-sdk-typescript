...
export class UsedInsightCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as UsedInsightCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as UsedInsightCollectionResponse).value = n.getCollectionOfObjectValues<UsedInsight>(createUsedInsightFromDiscriminatorValue); },
        };
    };
    /**
