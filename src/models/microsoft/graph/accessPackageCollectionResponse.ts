...
export class AccessPackageCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as AccessPackageCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as AccessPackageCollectionResponse).value = n.getCollectionOfObjectValues<AccessPackage>(createAccessPackageFromDiscriminatorValue); },
        };
    };
    /**
