...
export class DirectoryObjectCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DirectoryObjectCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DirectoryObjectCollectionResponse).value = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); },
        };
    };
    /**
