...
export class ConditionalAccessClientApplications implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "excludeServicePrincipals": (o, n) => { (o as unknown as ConditionalAccessClientApplications).excludeServicePrincipals = n.getCollectionOfPrimitiveValues<string>(); },
            "includeServicePrincipals": (o, n) => { (o as unknown as ConditionalAccessClientApplications).includeServicePrincipals = n.getCollectionOfPrimitiveValues<string>(); },
        };
    };
    /**
