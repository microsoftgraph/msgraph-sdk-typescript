...
export class DeviceCompliancePolicyCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DeviceCompliancePolicyCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DeviceCompliancePolicyCollectionResponse).value = n.getCollectionOfObjectValues<DeviceCompliancePolicy>(createDeviceCompliancePolicyFromDiscriminatorValue); },
        };
    };
    /**
