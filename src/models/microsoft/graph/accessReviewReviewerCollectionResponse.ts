...
export class AccessReviewReviewerCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as AccessReviewReviewerCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as AccessReviewReviewerCollectionResponse).value = n.getCollectionOfObjectValues<AccessReviewReviewer>(createAccessReviewReviewerFromDiscriminatorValue); },
        };
    };
    /**
