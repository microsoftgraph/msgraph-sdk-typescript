...
export class RestrictedSignInCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as RestrictedSignInCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as RestrictedSignInCollectionResponse).value = n.getCollectionOfObjectValues<RestrictedSignIn>(createRestrictedSignInFromDiscriminatorValue); }],
        ]);
    };
    /**
