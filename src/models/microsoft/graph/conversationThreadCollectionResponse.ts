...
export class ConversationThreadCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ConversationThreadCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ConversationThreadCollectionResponse).value = n.getCollectionOfObjectValues<ConversationThread>(createConversationThreadFromDiscriminatorValue); },
        };
    };
    /**
