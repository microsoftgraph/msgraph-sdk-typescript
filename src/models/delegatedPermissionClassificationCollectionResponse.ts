...
export class DelegatedPermissionClassificationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DelegatedPermissionClassificationCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DelegatedPermissionClassificationCollectionResponse).value = n.getCollectionOfObjectValues<DelegatedPermissionClassification>(createDelegatedPermissionClassificationFromDiscriminatorValue); },
        };
    };
    /**
