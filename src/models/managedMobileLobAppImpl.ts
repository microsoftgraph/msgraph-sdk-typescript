...
import {ManagedAppImpl, MobileAppContentImpl} from './index';
...
export class ManagedMobileLobAppImpl extends ManagedAppImpl implements ManagedMobileLobApp {
    ...
    public constructor(managedMobileLobAppParameterValue?: ManagedMobileLobApp | undefined) {
        ...
        this._committedContentVersion = managedMobileLobAppParameterValue?.committedContentVersion;
        this._contentVersions = managedMobileLobAppParameterValue?.contentVersions;
        this._fileName = managedMobileLobAppParameterValue?.fileName;
        this._size = managedMobileLobAppParameterValue?.size;
    };
    /**
