...
export class PrintTaskTriggerCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as PrintTaskTriggerCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as PrintTaskTriggerCollectionResponse).value = n.getCollectionOfObjectValues<PrintTaskTrigger>(createPrintTaskTriggerFromDiscriminatorValue); },
        };
    };
    /**
