...
export class ManagedAppRegistrationCollectionResponseImpl implements ManagedAppRegistrationCollectionResponse {
    ...
    public constructor(managedAppRegistrationCollectionResponseParameterValue?: ManagedAppRegistrationCollectionResponse | undefined) {
        this._additionalData = managedAppRegistrationCollectionResponseParameterValue?.additionalData ? managedAppRegistrationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = managedAppRegistrationCollectionResponseParameterValue?.nextLink;
        this._value = managedAppRegistrationCollectionResponseParameterValue?.value;
    };
    /**
