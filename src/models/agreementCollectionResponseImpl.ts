...
export class AgreementCollectionResponseImpl implements AgreementCollectionResponse {
    ...
    public constructor(agreementCollectionResponseParameterValue?: AgreementCollectionResponse | undefined) {
        this._additionalData = agreementCollectionResponseParameterValue?.additionalData ? agreementCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = agreementCollectionResponseParameterValue?.nextLink;
        this._value = agreementCollectionResponseParameterValue?.value;
    };
    /**
