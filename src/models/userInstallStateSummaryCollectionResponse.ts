...
export class UserInstallStateSummaryCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as UserInstallStateSummaryCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as UserInstallStateSummaryCollectionResponse).value = n.getCollectionOfObjectValues<UserInstallStateSummary>(createUserInstallStateSummaryFromDiscriminatorValue); },
        };
    };
    /**
