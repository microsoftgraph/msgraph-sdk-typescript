...
export class RoleDefinitionCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as RoleDefinitionCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as RoleDefinitionCollectionResponse).value = n.getCollectionOfObjectValues<RoleDefinition>(createRoleDefinitionFromDiscriminatorValue); },
        };
    };
    /**
