...
export class ExtensionPropertyCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ExtensionPropertyCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ExtensionPropertyCollectionResponse).value = n.getCollectionOfObjectValues<ExtensionProperty>(createExtensionPropertyFromDiscriminatorValue); },
        };
    };
    /**
