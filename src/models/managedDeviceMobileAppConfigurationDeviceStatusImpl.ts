...
export class ManagedDeviceMobileAppConfigurationDeviceStatusImpl extends EntityImpl implements ManagedDeviceMobileAppConfigurationDeviceStatus {
    ...
    public constructor(managedDeviceMobileAppConfigurationDeviceStatusParameterValue?: ManagedDeviceMobileAppConfigurationDeviceStatus | undefined) {
        ...
        this._complianceGracePeriodExpirationDateTime = managedDeviceMobileAppConfigurationDeviceStatusParameterValue?.complianceGracePeriodExpirationDateTime;
        this._deviceDisplayName = managedDeviceMobileAppConfigurationDeviceStatusParameterValue?.deviceDisplayName;
        this._deviceModel = managedDeviceMobileAppConfigurationDeviceStatusParameterValue?.deviceModel;
        this._lastReportedDateTime = managedDeviceMobileAppConfigurationDeviceStatusParameterValue?.lastReportedDateTime;
        this._status = managedDeviceMobileAppConfigurationDeviceStatusParameterValue?.status;
        this._userName = managedDeviceMobileAppConfigurationDeviceStatusParameterValue?.userName;
        this._userPrincipalName = managedDeviceMobileAppConfigurationDeviceStatusParameterValue?.userPrincipalName;
    };
    /**
