...
export class AssociatedTeamInfoCollectionResponseImpl implements AssociatedTeamInfoCollectionResponse {
    ...
    public constructor(associatedTeamInfoCollectionResponseParameterValue?: AssociatedTeamInfoCollectionResponse | undefined) {
        ...
        this.value = associatedTeamInfoCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value && this.value.length != 0){        const valueArrValue: AssociatedTeamInfoImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new AssociatedTeamInfoImpl(element));});
