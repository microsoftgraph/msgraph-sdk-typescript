...
export class SecureScoreCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as SecureScoreCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as SecureScoreCollectionResponse).value = n.getCollectionOfObjectValues<SecureScore>(createSecureScoreFromDiscriminatorValue); },
        };
    };
    /**
