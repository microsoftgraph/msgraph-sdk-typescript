...
export function serializeFido2KeyRestrictions(fido2KeyRestrictions: Fido2KeyRestrictions | undefined = {} as Fido2KeyRestrictions, writer: SerializationWriter) : void {
