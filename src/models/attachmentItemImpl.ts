...
export class AttachmentItemImpl implements AttachmentItem {
    ...
    public constructor(attachmentItemParameterValue?: AttachmentItem | undefined) {
        this._additionalData = attachmentItemParameterValue?.additionalData ? attachmentItemParameterValue?.additionalData! : {};
        this._attachmentType = attachmentItemParameterValue?.attachmentType;
        this._contentId = attachmentItemParameterValue?.contentId;
        this._contentType = attachmentItemParameterValue?.contentType;
        this._isInline = attachmentItemParameterValue?.isInline;
        this._name = attachmentItemParameterValue?.name;
        this._size = attachmentItemParameterValue?.size;
    };
    /**
