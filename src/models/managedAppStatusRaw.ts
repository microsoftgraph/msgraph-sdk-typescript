import {DeviceAppManagementMember1, Json, ManagedAppStatus} from './index';
import {Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class ManagedAppStatusRaw extends ManagedAppStatus implements Parsable {
    /** Status report content. */
    private _content?: Json | DeviceAppManagementMember1 | undefined;
    /**
     ...
     */
    public set content(value: Json | DeviceAppManagementMember1 | undefined) {
        this._content = value;
    };
    /**
