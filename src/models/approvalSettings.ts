import {AdminMember1, UnifiedApprovalStage} from './index';
...
export class ApprovalSettings implements AdditionalDataHolder, Parsable {
    ...
    private _approvalStages?: UnifiedApprovalStage | AdminMember1[] | undefined;
     ...
     */
    public set approvalStages(value: UnifiedApprovalStage | AdminMember1[] | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "approvalStages": n => { this.approvalStages = n.getObjectValue<UnifiedApprovalStage>(createUnifiedApprovalStageFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<UnifiedApprovalStage>("approvalStages", this.approvalStages);
