...
export class DeviceConfigurationUserStatusImpl extends EntityImpl implements DeviceConfigurationUserStatus {
    ...
    public constructor(deviceConfigurationUserStatusParameterValue?: DeviceConfigurationUserStatus | undefined) {
        ...
        this._devicesCount = deviceConfigurationUserStatusParameterValue?.devicesCount;
        this._lastReportedDateTime = deviceConfigurationUserStatusParameterValue?.lastReportedDateTime;
        this._status = deviceConfigurationUserStatusParameterValue?.status;
        this._userDisplayName = deviceConfigurationUserStatusParameterValue?.userDisplayName;
        this._userPrincipalName = deviceConfigurationUserStatusParameterValue?.userPrincipalName;
    };
    /**
