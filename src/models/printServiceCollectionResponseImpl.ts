...
export class PrintServiceCollectionResponseImpl implements PrintServiceCollectionResponse {
    ...
    public constructor(printServiceCollectionResponseParameterValue?: PrintServiceCollectionResponse | undefined) {
        this._additionalData = printServiceCollectionResponseParameterValue?.additionalData ? printServiceCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = printServiceCollectionResponseParameterValue?.nextLink;
        this._value = printServiceCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "value": n => { this.value = n.getCollectionOfObjectValues<PrintServiceImpl>(createPrintServiceFromDiscriminatorValue); },
        };
    };
    /**
