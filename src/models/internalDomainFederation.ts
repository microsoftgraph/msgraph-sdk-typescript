...
import {AdminMember1, SamlOrWsFedProvider, SigningCertificateUpdateStatus} from './index';
...
export class InternalDomainFederation extends SamlOrWsFedProvider implements Parsable {
    ...
    private _federatedIdpMfaBehavior?: FederatedIdpMfaBehavior | AdminMember1 | undefined;
    ...
    private _promptLoginBehavior?: PromptLoginBehavior | AdminMember1 | undefined;
    /** Provides status and timestamp of the last update of the signing certificate. */
    private _signingCertificateUpdateStatus?: SigningCertificateUpdateStatus | AdminMember1 | undefined;
     ...
     */
    public set federatedIdpMfaBehavior(value: FederatedIdpMfaBehavior | AdminMember1 | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "federatedIdpMfaBehavior": n => { this.federatedIdpMfaBehavior = n.getObjectValue<FederatedIdpMfaBehavior>(createFederatedIdpMfaBehaviorFromDiscriminatorValue); },
            ...
            "promptLoginBehavior": n => { this.promptLoginBehavior = n.getObjectValue<PromptLoginBehavior>(createPromptLoginBehaviorFromDiscriminatorValue); },
     ...
     */
    public set promptLoginBehavior(value: PromptLoginBehavior | AdminMember1 | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<FederatedIdpMfaBehavior>("federatedIdpMfaBehavior", this.federatedIdpMfaBehavior);
        ...
        writer.writeObjectValue<PromptLoginBehavior>("promptLoginBehavior", this.promptLoginBehavior);
     ...
     */
    public set signingCertificateUpdateStatus(value: SigningCertificateUpdateStatus | AdminMember1 | undefined) {
