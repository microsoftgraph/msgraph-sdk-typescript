...
export class ContactCollectionResponseImpl implements ContactCollectionResponse {
    ...
    public constructor(contactCollectionResponseParameterValue?: ContactCollectionResponse | undefined) {
        this._additionalData = contactCollectionResponseParameterValue?.additionalData ? contactCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = contactCollectionResponseParameterValue?.nextLink;
        this._value = contactCollectionResponseParameterValue?.value;
    };
    /**
