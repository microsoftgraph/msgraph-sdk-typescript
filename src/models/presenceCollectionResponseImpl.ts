...
export class PresenceCollectionResponseImpl implements PresenceCollectionResponse {
    ...
    public constructor(presenceCollectionResponseParameterValue?: PresenceCollectionResponse | undefined) {
        this._additionalData = presenceCollectionResponseParameterValue?.additionalData ? presenceCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = presenceCollectionResponseParameterValue?.nextLink;
        this._value = presenceCollectionResponseParameterValue?.value;
    };
    /**
