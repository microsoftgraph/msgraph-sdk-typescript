...
export class AccessReviewInstanceDecisionItemCollectionResponseImpl implements AccessReviewInstanceDecisionItemCollectionResponse {
    ...
    public constructor(accessReviewInstanceDecisionItemCollectionResponseParameterValue?: AccessReviewInstanceDecisionItemCollectionResponse | undefined) {
        this._additionalData = accessReviewInstanceDecisionItemCollectionResponseParameterValue?.additionalData ? accessReviewInstanceDecisionItemCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = accessReviewInstanceDecisionItemCollectionResponseParameterValue?.nextLink;
        this._value = accessReviewInstanceDecisionItemCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "value": n => { this.value = n.getCollectionOfObjectValues<AccessReviewInstanceDecisionItemImpl>(createAccessReviewInstanceDecisionItemFromDiscriminatorValue); },
        };
    };
    /**
