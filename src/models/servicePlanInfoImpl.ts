...
export class ServicePlanInfoImpl implements ServicePlanInfo {
    ...
    public constructor(servicePlanInfoParameterValue?: ServicePlanInfo | undefined) {
        this._additionalData = servicePlanInfoParameterValue?.additionalData ? servicePlanInfoParameterValue?.additionalData! : {};
        this._appliesTo = servicePlanInfoParameterValue?.appliesTo;
        this._provisioningStatus = servicePlanInfoParameterValue?.provisioningStatus;
        this._servicePlanId = servicePlanInfoParameterValue?.servicePlanId;
        this._servicePlanName = servicePlanInfoParameterValue?.servicePlanName;
    };
    /**
