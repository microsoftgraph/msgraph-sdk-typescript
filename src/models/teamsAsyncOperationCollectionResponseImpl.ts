...
export class TeamsAsyncOperationCollectionResponseImpl implements TeamsAsyncOperationCollectionResponse {
    ...
    public constructor(teamsAsyncOperationCollectionResponseParameterValue?: TeamsAsyncOperationCollectionResponse | undefined) {
        this._additionalData = teamsAsyncOperationCollectionResponseParameterValue?.additionalData ? teamsAsyncOperationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = teamsAsyncOperationCollectionResponseParameterValue?.nextLink;
        this._value = teamsAsyncOperationCollectionResponseParameterValue?.value;
    };
    /**
