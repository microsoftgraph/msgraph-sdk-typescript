...
export class MessageRuleActionsImpl implements MessageRuleActions {
    ...
    public constructor(messageRuleActionsParameterValue?: MessageRuleActions | undefined) {
        ...
        const forwardAsAttachmentToArrValue: RecipientImpl[] = []; this.forwardAsAttachmentTo?.forEach(element => {forwardAsAttachmentToArrValue.push(element instanceof RecipientImpl? element : new RecipientImpl(element));});
        this.forwardAsAttachmentTo = forwardAsAttachmentToArrValue;
        const forwardToArrValue: RecipientImpl[] = []; this.forwardTo?.forEach(element => {forwardToArrValue.push(element instanceof RecipientImpl? element : new RecipientImpl(element));});
        ...
        const redirectToArrValue: RecipientImpl[] = []; this.redirectTo?.forEach(element => {redirectToArrValue.push(element instanceof RecipientImpl? element : new RecipientImpl(element));});
