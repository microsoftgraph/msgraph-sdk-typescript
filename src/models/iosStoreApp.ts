...
import {AdminMember1, IosDeviceType, IosMinimumOperatingSystem, MobileApp} from './index';
...
export class IosStoreApp extends MobileApp implements Parsable {
    ...
    private _minimumSupportedOperatingSystem?: IosMinimumOperatingSystem | AdminMember1 | undefined;
    /**
     ...
     */
    public set minimumSupportedOperatingSystem(value: IosMinimumOperatingSystem | AdminMember1 | undefined) {
