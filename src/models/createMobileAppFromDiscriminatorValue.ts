...
import { type AndroidLobApp, type AndroidStoreApp, type IosiPadOSWebClip, type IosLobApp, type IosStoreApp, type IosVppApp, type MacOSLobApp, type MacOSMicrosoftDefenderApp, type MacOSMicrosoftEdgeApp, type MacOSOfficeSuiteApp, type ManagedAndroidLobApp, type ManagedAndroidStoreApp, type ManagedApp, type ManagedIOSLobApp, type ManagedIOSStoreApp, type ManagedMobileLobApp, type MicrosoftStoreForBusinessApp, type MobileApp, type MobileLobApp, type WebApp, type Win32LobApp, type WindowsAppX, type WindowsMicrosoftEdgeApp, type WindowsMobileMSI, type WindowsUniversalAppX, type WindowsWebApp } from './index';
