...
export class EducationClassCollectionResponseImpl implements EducationClassCollectionResponse {
    ...
    public constructor(educationClassCollectionResponseParameterValue?: EducationClassCollectionResponse | undefined) {
        this._additionalData = educationClassCollectionResponseParameterValue?.additionalData ? educationClassCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = educationClassCollectionResponseParameterValue?.nextLink;
        this._value = educationClassCollectionResponseParameterValue?.value;
    };
    /**
