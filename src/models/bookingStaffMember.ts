...
import {AdminMember1, BookingStaffMemberBase, BookingWorkHours} from './index';
...
export class BookingStaffMember extends BookingStaffMemberBase implements Parsable {
    ...
    private _workingHours?: BookingWorkHours | AdminMember1[] | undefined;
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "workingHours": n => { this.workingHours = n.getObjectValue<BookingWorkHours>(createBookingWorkHoursFromDiscriminatorValue); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<BookingWorkHours>("workingHours", this.workingHours);
    };
    /**
     ...
     */
    public set workingHours(value: BookingWorkHours | AdminMember1[] | undefined) {
