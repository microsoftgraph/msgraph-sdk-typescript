...
import {AdminMember1, DeviceConfiguration, WindowsUpdateInstallScheduleType} from './index';
...
export class WindowsUpdateForBusinessConfiguration extends DeviceConfiguration implements Parsable {
    ...
    private _installationSchedule?: WindowsUpdateInstallScheduleType | AdminMember1 | undefined;
     ...
     */
    public set installationSchedule(value: WindowsUpdateInstallScheduleType | AdminMember1 | undefined) {
