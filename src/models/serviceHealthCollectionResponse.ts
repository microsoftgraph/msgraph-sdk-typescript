...
export class ServiceHealthCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ServiceHealthCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ServiceHealthCollectionResponse).value = n.getCollectionOfObjectValues<ServiceHealth>(createServiceHealthFromDiscriminatorValue); },
        };
    };
    /**
