...
export function serializeOptionalClaims(writer: SerializationWriter, optionalClaims: OptionalClaims | undefined = {} as OptionalClaims) : void {
        writer.writeCollectionOfObjectValues<OptionalClaim>("accessToken", optionalClaims.accessToken, );
        writer.writeCollectionOfObjectValues<OptionalClaim>("idToken", optionalClaims.idToken, );
        writer.writeStringValue("@odata.type", optionalClaims.odataType);
        writer.writeCollectionOfObjectValues<OptionalClaim>("saml2Token", optionalClaims.saml2Token, );
