...
export class AuthorizationPolicyImpl extends PolicyBaseImpl implements AuthorizationPolicy {
    ...
    public constructor(authorizationPolicyParameterValue?: AuthorizationPolicy | undefined) {
        ...
        this._allowedToSignUpEmailBasedSubscriptions = authorizationPolicyParameterValue?.allowedToSignUpEmailBasedSubscriptions;
        this._allowedToUseSSPR = authorizationPolicyParameterValue?.allowedToUseSSPR;
        this._allowEmailVerifiedUsersToJoinOrganization = authorizationPolicyParameterValue?.allowEmailVerifiedUsersToJoinOrganization;
        this._allowInvitesFrom = authorizationPolicyParameterValue?.allowInvitesFrom;
        this._blockMsolPowerShell = authorizationPolicyParameterValue?.blockMsolPowerShell;
        this._defaultUserRolePermissions = authorizationPolicyParameterValue?.defaultUserRolePermissions;
        this._guestUserRoleId = authorizationPolicyParameterValue?.guestUserRoleId;
    };
    /**
     * Gets the defaultUserRolePermissions property value. The defaultUserRolePermissions property
     * @returns a DefaultUserRolePermissionsInterface
     */
