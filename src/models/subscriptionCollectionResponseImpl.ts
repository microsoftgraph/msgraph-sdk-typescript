...
export class SubscriptionCollectionResponseImpl implements SubscriptionCollectionResponse {
    ...
    public constructor(subscriptionCollectionResponseParameterValue?: SubscriptionCollectionResponse | undefined) {
        this._additionalData = subscriptionCollectionResponseParameterValue?.additionalData ? subscriptionCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = subscriptionCollectionResponseParameterValue?.nextLink;
        this._value = subscriptionCollectionResponseParameterValue?.value;
    };
    /**
