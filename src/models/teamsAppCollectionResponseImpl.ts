...
export class TeamsAppCollectionResponseImpl implements TeamsAppCollectionResponse {
    ...
    public constructor(teamsAppCollectionResponseParameterValue?: TeamsAppCollectionResponse | undefined) {
        this._additionalData = teamsAppCollectionResponseParameterValue?.additionalData ? teamsAppCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = teamsAppCollectionResponseParameterValue?.nextLink;
        this._value = teamsAppCollectionResponseParameterValue?.value;
    };
    /**
