...
export class TeamsTemplateCollectionResponseImpl implements TeamsTemplateCollectionResponse {
    ...
    public constructor(teamsTemplateCollectionResponseParameterValue?: TeamsTemplateCollectionResponse | undefined) {
        this._additionalData = teamsTemplateCollectionResponseParameterValue?.additionalData ? teamsTemplateCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = teamsTemplateCollectionResponseParameterValue?.nextLink;
        this._value = teamsTemplateCollectionResponseParameterValue?.value;
    };
    /**
