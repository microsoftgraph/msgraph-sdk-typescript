...
export class SubscriptionImpl extends EntityImpl implements Subscription {
    ...
    public constructor(subscriptionParameterValue?: Subscription | undefined) {
        ...
        this._applicationId = subscriptionParameterValue?.applicationId;
        this._changeType = subscriptionParameterValue?.changeType;
        this._clientState = subscriptionParameterValue?.clientState;
        this._creatorId = subscriptionParameterValue?.creatorId;
        this._encryptionCertificate = subscriptionParameterValue?.encryptionCertificate;
        this._encryptionCertificateId = subscriptionParameterValue?.encryptionCertificateId;
        this._expirationDateTime = subscriptionParameterValue?.expirationDateTime;
        this._includeResourceData = subscriptionParameterValue?.includeResourceData;
        this._latestSupportedTlsVersion = subscriptionParameterValue?.latestSupportedTlsVersion;
        this._lifecycleNotificationUrl = subscriptionParameterValue?.lifecycleNotificationUrl;
        this._notificationQueryOptions = subscriptionParameterValue?.notificationQueryOptions;
        this._notificationUrl = subscriptionParameterValue?.notificationUrl;
        this._notificationUrlAppId = subscriptionParameterValue?.notificationUrlAppId;
        this._resource = subscriptionParameterValue?.resource;
    };
    /**
