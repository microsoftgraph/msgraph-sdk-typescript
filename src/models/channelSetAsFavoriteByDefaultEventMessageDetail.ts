...
export class ChannelSetAsFavoriteByDefaultEventMessageDetail extends EventMessageDetail implements Parsable {
    ...
    public constructor() {
        super();
        this.odataType = "#microsoft.graph.channelSetAsFavoriteByDefaultEventMessageDetail";
    };
    /**
