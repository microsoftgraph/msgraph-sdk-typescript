...
export class ScheduleChangeRequestImpl extends ChangeTrackedEntityImpl implements ScheduleChangeRequest {
    ...
    public constructor(scheduleChangeRequestParameterValue?: ScheduleChangeRequest | undefined) {
        ...
        this._assignedTo = scheduleChangeRequestParameterValue?.assignedTo;
        this._managerActionDateTime = scheduleChangeRequestParameterValue?.managerActionDateTime;
        this._managerActionMessage = scheduleChangeRequestParameterValue?.managerActionMessage;
        this._managerUserId = scheduleChangeRequestParameterValue?.managerUserId;
        this._senderDateTime = scheduleChangeRequestParameterValue?.senderDateTime;
        this._senderMessage = scheduleChangeRequestParameterValue?.senderMessage;
        this._senderUserId = scheduleChangeRequestParameterValue?.senderUserId;
        this._state = scheduleChangeRequestParameterValue?.state;
    };
    /**
