...
export class Organization extends DirectoryObject implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "branding": n => { this.branding = n.getObjectValue<OrganizationalBranding>(createOrganizationalBrandingFromDiscriminatorValue); },
            "businessPhones": n => { this.businessPhones = n.getCollectionOfPrimitiveValues<string>(); },
            "certificateBasedAuthConfiguration": n => { this.certificateBasedAuthConfiguration = n.getCollectionOfObjectValues<CertificateBasedAuthConfiguration>(createCertificateBasedAuthConfigurationFromDiscriminatorValue); },
            ...
            "verifiedDomains": n => { this.verifiedDomains = n.getCollectionOfObjectValues<VerifiedDomain>(createVerifiedDomainFromDiscriminatorValue); },
        };
    };
    /**
