...
export class TermsAndConditionsCollectionResponseImpl implements TermsAndConditionsCollectionResponse {
    ...
    public constructor(termsAndConditionsCollectionResponseParameterValue?: TermsAndConditionsCollectionResponse | undefined) {
        this._additionalData = termsAndConditionsCollectionResponseParameterValue?.additionalData ? termsAndConditionsCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = termsAndConditionsCollectionResponseParameterValue?.nextLink;
        this._value = termsAndConditionsCollectionResponseParameterValue?.value;
    };
    /**
     ...
     */
    public set value(value: TermsAndConditions[] | undefined) {
        if(value) {
