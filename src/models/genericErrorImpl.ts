...
export class GenericErrorImpl implements GenericError {
    ...
    public constructor(genericErrorParameterValue?: GenericError | undefined) {
        this._additionalData = genericErrorParameterValue?.additionalData ? genericErrorParameterValue?.additionalData! : {};
        this._code = genericErrorParameterValue?.code;
        this._message = genericErrorParameterValue?.message;
    };
    /**
