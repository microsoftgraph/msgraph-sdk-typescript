...
export class MdmWindowsInformationProtectionPolicyCollectionResponseImpl implements AdditionalDataHolder, MdmWindowsInformationProtectionPolicyCollectionResponse, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value){
        const valueArrValue: MdmWindowsInformationProtectionPolicyImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new MdmWindowsInformationProtectionPolicyImpl(element));});
