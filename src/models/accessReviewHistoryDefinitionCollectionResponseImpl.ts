...
export class AccessReviewHistoryDefinitionCollectionResponseImpl implements AccessReviewHistoryDefinitionCollectionResponse {
    ...
    public constructor(accessReviewHistoryDefinitionCollectionResponseParameterValue?: AccessReviewHistoryDefinitionCollectionResponse | undefined) {
        this._additionalData = accessReviewHistoryDefinitionCollectionResponseParameterValue?.additionalData ? accessReviewHistoryDefinitionCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = accessReviewHistoryDefinitionCollectionResponseParameterValue?.nextLink;
        this._value = accessReviewHistoryDefinitionCollectionResponseParameterValue?.value;
    };
    /**
