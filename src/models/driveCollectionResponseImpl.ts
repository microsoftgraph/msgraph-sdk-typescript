...
export class DriveCollectionResponseImpl implements DriveCollectionResponse {
    ...
    public constructor(driveCollectionResponseParameterValue?: DriveCollectionResponse | undefined) {
        this._additionalData = driveCollectionResponseParameterValue?.additionalData ? driveCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = driveCollectionResponseParameterValue?.nextLink;
        this._value = driveCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value && this.value.length != 0){        const valueArrValue: DriveImpl[] = [];
        this.value?.forEach(element => {
            valueArrValue.push((element instanceof DriveImpl? element as DriveImpl:new DriveImpl(element)));
        });
