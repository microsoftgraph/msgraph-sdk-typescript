...
export class SettingStateDeviceSummaryCollectionResponseImpl implements SettingStateDeviceSummaryCollectionResponse {
    ...
    public constructor(settingStateDeviceSummaryCollectionResponseParameterValue?: SettingStateDeviceSummaryCollectionResponse | undefined) {
        this._additionalData = settingStateDeviceSummaryCollectionResponseParameterValue?.additionalData ? settingStateDeviceSummaryCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = settingStateDeviceSummaryCollectionResponseParameterValue?.nextLink;
        this._value = settingStateDeviceSummaryCollectionResponseParameterValue?.value;
    };
    /**
