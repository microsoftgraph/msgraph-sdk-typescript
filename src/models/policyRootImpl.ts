...
export class PolicyRootImpl extends EntityImpl implements PolicyRoot {
    ...
    public constructor(policyRootParameterValue?: PolicyRoot | undefined) {
        ...
        const claimsMappingPoliciesArrValue: ClaimsMappingPolicyImpl[] = []; policyRootParameterValue?.claimsMappingPolicies?.forEach(element => {claimsMappingPoliciesArrValue.push(element instanceof ClaimsMappingPolicyImpl? element : new ClaimsMappingPolicyImpl(element));});
        this.claimsMappingPolicies = claimsMappingPoliciesArrValue;
        const conditionalAccessPoliciesArrValue: ConditionalAccessPolicyImpl[] = []; policyRootParameterValue?.conditionalAccessPolicies?.forEach(element => {conditionalAccessPoliciesArrValue.push(element instanceof ConditionalAccessPolicyImpl? element : new ConditionalAccessPolicyImpl(element));});
        this.conditionalAccessPolicies = conditionalAccessPoliciesArrValue;
        const featureRolloutPoliciesArrValue: FeatureRolloutPolicyImpl[] = []; policyRootParameterValue?.featureRolloutPolicies?.forEach(element => {featureRolloutPoliciesArrValue.push(element instanceof FeatureRolloutPolicyImpl? element : new FeatureRolloutPolicyImpl(element));});
        this.featureRolloutPolicies = featureRolloutPoliciesArrValue;
        const homeRealmDiscoveryPoliciesArrValue: HomeRealmDiscoveryPolicyImpl[] = []; policyRootParameterValue?.homeRealmDiscoveryPolicies?.forEach(element => {homeRealmDiscoveryPoliciesArrValue.push(element instanceof HomeRealmDiscoveryPolicyImpl? element : new HomeRealmDiscoveryPolicyImpl(element));});
        ...
        const permissionGrantPoliciesArrValue: PermissionGrantPolicyImpl[] = []; policyRootParameterValue?.permissionGrantPolicies?.forEach(element => {permissionGrantPoliciesArrValue.push(element instanceof PermissionGrantPolicyImpl? element : new PermissionGrantPolicyImpl(element));});
        this.permissionGrantPolicies = permissionGrantPoliciesArrValue;
        const roleManagementPoliciesArrValue: UnifiedRoleManagementPolicyImpl[] = []; policyRootParameterValue?.roleManagementPolicies?.forEach(element => {roleManagementPoliciesArrValue.push(element instanceof UnifiedRoleManagementPolicyImpl? element : new UnifiedRoleManagementPolicyImpl(element));});
        this.roleManagementPolicies = roleManagementPoliciesArrValue;
        const roleManagementPolicyAssignmentsArrValue: UnifiedRoleManagementPolicyAssignmentImpl[] = []; policyRootParameterValue?.roleManagementPolicyAssignments?.forEach(element => {roleManagementPolicyAssignmentsArrValue.push(element instanceof UnifiedRoleManagementPolicyAssignmentImpl? element : new UnifiedRoleManagementPolicyAssignmentImpl(element));});
        this.roleManagementPolicyAssignments = roleManagementPolicyAssignmentsArrValue;
        const tokenIssuancePoliciesArrValue: TokenIssuancePolicyImpl[] = []; policyRootParameterValue?.tokenIssuancePolicies?.forEach(element => {tokenIssuancePoliciesArrValue.push(element instanceof TokenIssuancePolicyImpl? element : new TokenIssuancePolicyImpl(element));});
        this.tokenIssuancePolicies = tokenIssuancePoliciesArrValue;
        const tokenLifetimePoliciesArrValue: TokenLifetimePolicyImpl[] = []; policyRootParameterValue?.tokenLifetimePolicies?.forEach(element => {tokenLifetimePoliciesArrValue.push(element instanceof TokenLifetimePolicyImpl? element : new TokenLifetimePolicyImpl(element));});
