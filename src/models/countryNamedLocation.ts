...
import {AdminMember1, NamedLocation} from './index';
...
export class CountryNamedLocation extends NamedLocation implements Parsable {
    ...
    private _countryLookupMethod?: CountryLookupMethodType | AdminMember1 | undefined;
     ...
     */
    public set countryLookupMethod(value: CountryLookupMethodType | AdminMember1 | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "countryLookupMethod": n => { this.countryLookupMethod = n.getObjectValue<CountryLookupMethodType>(createCountryLookupMethodTypeFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<CountryLookupMethodType>("countryLookupMethod", this.countryLookupMethod);
