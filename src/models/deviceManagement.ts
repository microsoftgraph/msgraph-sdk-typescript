...
export class DeviceManagement extends Entity implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "deviceCategories": n => { this.deviceCategories = n.getCollectionOfObjectValues<DeviceCategory>(createDeviceCategoryFromDiscriminatorValue); },
            "deviceCompliancePolicies": n => { this.deviceCompliancePolicies = n.getCollectionOfObjectValues<DeviceCompliancePolicy>(createDeviceCompliancePolicyFromDiscriminatorValue); },
            "deviceCompliancePolicyDeviceStateSummary": n => { this.deviceCompliancePolicyDeviceStateSummary = n.getObjectValue<DeviceCompliancePolicyDeviceStateSummary>(createDeviceCompliancePolicyDeviceStateSummaryFromDiscriminatorValue); },
            "deviceCompliancePolicySettingStateSummaries": n => { this.deviceCompliancePolicySettingStateSummaries = n.getCollectionOfObjectValues<DeviceCompliancePolicySettingStateSummary>(createDeviceCompliancePolicySettingStateSummaryFromDiscriminatorValue); },
            "deviceConfigurationDeviceStateSummaries": n => { this.deviceConfigurationDeviceStateSummaries = n.getObjectValue<DeviceConfigurationDeviceStateSummary>(createDeviceConfigurationDeviceStateSummaryFromDiscriminatorValue); },
            "deviceConfigurations": n => { this.deviceConfigurations = n.getCollectionOfObjectValues<DeviceConfiguration>(createDeviceConfigurationFromDiscriminatorValue); },
            "deviceEnrollmentConfigurations": n => { this.deviceEnrollmentConfigurations = n.getCollectionOfObjectValues<DeviceEnrollmentConfiguration>(createDeviceEnrollmentConfigurationFromDiscriminatorValue); },
            ...
            "mobileThreatDefenseConnectors": n => { this.mobileThreatDefenseConnectors = n.getCollectionOfObjectValues<MobileThreatDefenseConnector>(createMobileThreatDefenseConnectorFromDiscriminatorValue); },
            "notificationMessageTemplates": n => { this.notificationMessageTemplates = n.getCollectionOfObjectValues<NotificationMessageTemplate>(createNotificationMessageTemplateFromDiscriminatorValue); },
            "remoteAssistancePartners": n => { this.remoteAssistancePartners = n.getCollectionOfObjectValues<RemoteAssistancePartner>(createRemoteAssistancePartnerFromDiscriminatorValue); },
            "reports": n => { this.reports = n.getObjectValue<DeviceManagementReports>(createDeviceManagementReportsFromDiscriminatorValue); },
            "resourceOperations": n => { this.resourceOperations = n.getCollectionOfObjectValues<ResourceOperation>(createResourceOperationFromDiscriminatorValue); },
            "roleAssignments": n => { this.roleAssignments = n.getCollectionOfObjectValues<DeviceAndAppManagementRoleAssignment>(createDeviceAndAppManagementRoleAssignmentFromDiscriminatorValue); },
            "roleDefinitions": n => { this.roleDefinitions = n.getCollectionOfObjectValues<RoleDefinition>(createRoleDefinitionFromDiscriminatorValue); },
            "settings": n => { this.settings = n.getObjectValue<DeviceManagementSettings>(createDeviceManagementSettingsFromDiscriminatorValue); },
            "softwareUpdateStatusSummary": n => { this.softwareUpdateStatusSummary = n.getObjectValue<SoftwareUpdateStatusSummary>(createSoftwareUpdateStatusSummaryFromDiscriminatorValue); },
            ...
            "telecomExpenseManagementPartners": n => { this.telecomExpenseManagementPartners = n.getCollectionOfObjectValues<TelecomExpenseManagementPartner>(createTelecomExpenseManagementPartnerFromDiscriminatorValue); },
            "termsAndConditions": n => { this.termsAndConditions = n.getCollectionOfObjectValues<TermsAndConditions>(createTermsAndConditionsFromDiscriminatorValue); },
            "troubleshootingEvents": n => { this.troubleshootingEvents = n.getCollectionOfObjectValues<DeviceManagementTroubleshootingEvent>(createDeviceManagementTroubleshootingEventFromDiscriminatorValue); },
            "windowsAutopilotDeviceIdentities": n => { this.windowsAutopilotDeviceIdentities = n.getCollectionOfObjectValues<WindowsAutopilotDeviceIdentity>(createWindowsAutopilotDeviceIdentityFromDiscriminatorValue); },
            "windowsInformationProtectionAppLearningSummaries": n => { this.windowsInformationProtectionAppLearningSummaries = n.getCollectionOfObjectValues<WindowsInformationProtectionAppLearningSummary>(createWindowsInformationProtectionAppLearningSummaryFromDiscriminatorValue); },
            "windowsInformationProtectionNetworkLearningSummaries": n => { this.windowsInformationProtectionNetworkLearningSummaries = n.getCollectionOfObjectValues<WindowsInformationProtectionNetworkLearningSummary>(createWindowsInformationProtectionNetworkLearningSummaryFromDiscriminatorValue); },
        };
    };
    /**
