...
export class OrganizationCollectionResponseImpl implements OrganizationCollectionResponse {
     ...
     * @param organizationCollectionResponseParameterValue 
     */
    public constructor(organizationCollectionResponseParameterValue?: OrganizationCollectionResponse | undefined) {
        this._additionalData = organizationCollectionResponseParameterValue?.additionalData ? organizationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = organizationCollectionResponseParameterValue?.nextLink;
        this._value = organizationCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "value": n => { this.value = n.getCollectionOfObjectValues<OrganizationImpl>(createOrganizationFromDiscriminatorValue); },
        };
    };
    /**
     ...
     * @returns a OrganizationInterface
     */
    public get value() {
        return this._value;
    };
