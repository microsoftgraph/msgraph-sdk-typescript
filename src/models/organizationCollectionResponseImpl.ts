...
export class OrganizationCollectionResponseImpl implements AdditionalDataHolder, OrganizationCollectionResponse, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value){
        const valueArrValue: OrganizationImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new OrganizationImpl(element));});
