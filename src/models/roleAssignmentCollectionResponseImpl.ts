...
export class RoleAssignmentCollectionResponseImpl implements RoleAssignmentCollectionResponse {
    ...
    public constructor(roleAssignmentCollectionResponseParameterValue?: RoleAssignmentCollectionResponse | undefined) {
        this._additionalData = roleAssignmentCollectionResponseParameterValue?.additionalData ? roleAssignmentCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = roleAssignmentCollectionResponseParameterValue?.nextLink;
        this._value = roleAssignmentCollectionResponseParameterValue?.value;
    };
    /**
