...
export class BookingStaffMemberImpl extends BookingStaffMemberBaseImpl implements BookingStaffMember {
    ...
    public constructor(bookingStaffMemberParameterValue?: BookingStaffMember | undefined) {
        ...
        const workingHoursArrValue: BookingWorkHoursImpl[] = []; this.workingHours?.forEach(element => {workingHoursArrValue.push(element instanceof BookingWorkHoursImpl? element : new BookingWorkHoursImpl(element));});
