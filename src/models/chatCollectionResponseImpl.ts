...
export class ChatCollectionResponseImpl implements ChatCollectionResponse {
    ...
    public constructor(chatCollectionResponseParameterValue?: ChatCollectionResponse | undefined) {
        this._additionalData = chatCollectionResponseParameterValue?.additionalData ? chatCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = chatCollectionResponseParameterValue?.nextLink;
        this._value = chatCollectionResponseParameterValue?.value;
    };
    /**
