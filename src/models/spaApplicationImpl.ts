...
export class SpaApplicationImpl implements SpaApplication {
    ...
    public constructor(spaApplicationParameterValue?: SpaApplication | undefined) {
        this._additionalData = spaApplicationParameterValue?.additionalData ? spaApplicationParameterValue?.additionalData! : {};
        this._redirectUris = spaApplicationParameterValue?.redirectUris;
    };
    /**
