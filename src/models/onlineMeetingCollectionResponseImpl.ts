...
export class OnlineMeetingCollectionResponseImpl implements OnlineMeetingCollectionResponse {
    ...
    public constructor(onlineMeetingCollectionResponseParameterValue?: OnlineMeetingCollectionResponse | undefined) {
        this._additionalData = onlineMeetingCollectionResponseParameterValue?.additionalData ? onlineMeetingCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = onlineMeetingCollectionResponseParameterValue?.nextLink;
        this._value = onlineMeetingCollectionResponseParameterValue?.value;
    };
    /**
