...
export class LicenseAssignmentStateImpl implements LicenseAssignmentState {
    ...
    public constructor(licenseAssignmentStateParameterValue?: LicenseAssignmentState | undefined) {
        this._additionalData = licenseAssignmentStateParameterValue?.additionalData ? licenseAssignmentStateParameterValue?.additionalData! : {};
        this._assignedByGroup = licenseAssignmentStateParameterValue?.assignedByGroup;
        this._disabledPlans = licenseAssignmentStateParameterValue?.disabledPlans;
        this._error_escaped = licenseAssignmentStateParameterValue?.error_escaped;
        this._lastUpdatedDateTime = licenseAssignmentStateParameterValue?.lastUpdatedDateTime;
        this._skuId = licenseAssignmentStateParameterValue?.skuId;
        this._state = licenseAssignmentStateParameterValue?.state;
    };
    /**
