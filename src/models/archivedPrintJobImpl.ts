...
export class ArchivedPrintJobImpl implements ArchivedPrintJob {
    ...
    public constructor(archivedPrintJobParameterValue?: ArchivedPrintJob | undefined) {
        this._acquiredByPrinter = archivedPrintJobParameterValue?.acquiredByPrinter;
        this._acquiredDateTime = archivedPrintJobParameterValue?.acquiredDateTime;
        this._additionalData = archivedPrintJobParameterValue?.additionalData ? archivedPrintJobParameterValue?.additionalData! : {};
        this._completionDateTime = archivedPrintJobParameterValue?.completionDateTime;
        this._copiesPrinted = archivedPrintJobParameterValue?.copiesPrinted;
        this._createdBy = archivedPrintJobParameterValue?.createdBy;
        this._createdDateTime = archivedPrintJobParameterValue?.createdDateTime;
        this._id = archivedPrintJobParameterValue?.id;
        this._printerId = archivedPrintJobParameterValue?.printerId;
        this._processingState = archivedPrintJobParameterValue?.processingState;
    };
    /**
