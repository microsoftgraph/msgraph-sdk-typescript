import {EndpointImpl, FailureInfoImpl, MediaImpl} from './callRecords/';
...
import {createMediaFromDiscriminatorValue} from './callRecords/createMediaFromDiscriminatorValue';
