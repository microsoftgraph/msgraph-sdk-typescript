...
export function serializeManagedDevice(writer: SerializationWriter, managedDevice: ManagedDevice | undefined = {} as ManagedDevice) : void {
        ...
        writer.writeObjectValue<DeviceCategory>("deviceCategory", managedDevice.deviceCategory, );
        writer.writeCollectionOfObjectValues<DeviceCompliancePolicyState>("deviceCompliancePolicyStates", managedDevice.deviceCompliancePolicyStates, );
        writer.writeCollectionOfObjectValues<DeviceConfigurationState>("deviceConfigurationStates", managedDevice.deviceConfigurationStates, );
        ...
        writer.writeCollectionOfObjectValues<DeviceLogCollectionResponse>("logCollectionRequests", managedDevice.logCollectionRequests, );
        ...
        writer.writeCollectionOfObjectValues<User>("users", managedDevice.users, );
        writer.writeObjectValue<WindowsProtectionState>("windowsProtectionState", managedDevice.windowsProtectionState, );
}
// tslint:enable
// eslint-enable
