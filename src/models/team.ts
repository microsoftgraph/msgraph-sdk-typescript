...
export function serializeTeam(writer: SerializationWriter, team: Team | undefined = {} as Team) : void {
        ...
        writer.writeCollectionOfObjectValues<Channel>("allChannels", team.allChannels, );
        writer.writeCollectionOfObjectValues<Channel>("channels", team.channels, );
        ...
        writer.writeObjectValue<TeamFunSettings>("funSettings", team.funSettings, );
        writer.writeObjectValue<Group>("group", team.group, );
        writer.writeObjectValue<TeamGuestSettings>("guestSettings", team.guestSettings, );
        writer.writeCollectionOfObjectValues<Channel>("incomingChannels", team.incomingChannels, );
        writer.writeCollectionOfObjectValues<TeamsAppInstallation>("installedApps", team.installedApps, );
        writer.writeStringValue("internalId", team.internalId);
        writer.writeBooleanValue("isArchived", team.isArchived);
        writer.writeCollectionOfObjectValues<ConversationMember>("members", team.members, );
        writer.writeObjectValue<TeamMemberSettings>("memberSettings", team.memberSettings, );
        writer.writeObjectValue<TeamMessagingSettings>("messagingSettings", team.messagingSettings, );
        writer.writeCollectionOfObjectValues<TeamsAsyncOperation>("operations", team.operations, );
        writer.writeCollectionOfObjectValues<ResourceSpecificPermissionGrant>("permissionGrants", team.permissionGrants, );
        writer.writeObjectValue<ProfilePhoto>("photo", team.photo, );
        writer.writeObjectValue<Channel>("primaryChannel", team.primaryChannel, );
        writer.writeObjectValue<Schedule>("schedule", team.schedule, );
        writer.writeEnumValue<TeamSpecialization>("specialization", team.specialization);
        writer.writeObjectValue<TeamSummary>("summary", team.summary, );
        writer.writeCollectionOfObjectValues<TeamworkTag>("tags", team.tags, );
        writer.writeObjectValue<TeamsTemplate>("template", team.template, );
