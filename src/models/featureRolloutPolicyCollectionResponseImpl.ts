...
export class FeatureRolloutPolicyCollectionResponseImpl implements FeatureRolloutPolicyCollectionResponse {
    ...
    public constructor(featureRolloutPolicyCollectionResponseParameterValue?: FeatureRolloutPolicyCollectionResponse | undefined) {
        this._additionalData = featureRolloutPolicyCollectionResponseParameterValue?.additionalData ? featureRolloutPolicyCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = featureRolloutPolicyCollectionResponseParameterValue?.nextLink;
        this._value = featureRolloutPolicyCollectionResponseParameterValue?.value;
    };
    /**
