...
export class UnifiedRoleAssignmentScheduleCollectionResponseImpl implements UnifiedRoleAssignmentScheduleCollectionResponse {
    ...
    public constructor(unifiedRoleAssignmentScheduleCollectionResponseParameterValue?: UnifiedRoleAssignmentScheduleCollectionResponse | undefined) {
        this._additionalData = unifiedRoleAssignmentScheduleCollectionResponseParameterValue?.additionalData ? unifiedRoleAssignmentScheduleCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = unifiedRoleAssignmentScheduleCollectionResponseParameterValue?.nextLink;
        this._value = unifiedRoleAssignmentScheduleCollectionResponseParameterValue?.value;
    };
    /**
