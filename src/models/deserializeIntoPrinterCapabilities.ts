...
export function deserializeIntoPrinterCapabilities(printerCapabilities: PrinterCapabilities | undefined = {} as PrinterCapabilities) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "colorModes": n => { printerCapabilities.colorModes = n.getEnumValues<PrintColorMode>(PrintColorMode); },
        ...
        "duplexModes": n => { printerCapabilities.duplexModes = n.getEnumValues<PrintDuplexMode>(PrintDuplexMode); },
        "feedOrientations": n => { printerCapabilities.feedOrientations = n.getEnumValues<PrinterFeedOrientation>(PrinterFeedOrientation); },
        "finishings": n => { printerCapabilities.finishings = n.getEnumValues<PrintFinishing>(PrintFinishing); },
        ...
        "multipageLayouts": n => { printerCapabilities.multipageLayouts = n.getEnumValues<PrintMultipageLayout>(PrintMultipageLayout); },
        "@odata.type": n => { printerCapabilities.odataType = n.getStringValue(); },
        "orientations": n => { printerCapabilities.orientations = n.getEnumValues<PrintOrientation>(PrintOrientation); },
        ...
        "qualities": n => { printerCapabilities.qualities = n.getEnumValues<PrintQuality>(PrintQuality); },
        "rightMargins": n => { printerCapabilities.rightMargins = n.getCollectionOfPrimitiveValues<number>(); },
        "scalings": n => { printerCapabilities.scalings = n.getEnumValues<PrintScaling>(PrintScaling); },
