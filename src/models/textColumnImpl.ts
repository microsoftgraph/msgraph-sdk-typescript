...
export class TextColumnImpl implements TextColumn {
    ...
    public constructor(textColumnParameterValue?: TextColumn | undefined) {
        this._additionalData = textColumnParameterValue?.additionalData ? textColumnParameterValue?.additionalData! : {};
        this._allowMultipleLines = textColumnParameterValue?.allowMultipleLines;
        this._appendChangesToExistingText = textColumnParameterValue?.appendChangesToExistingText;
        this._linesForEditing = textColumnParameterValue?.linesForEditing;
        this._maxLength = textColumnParameterValue?.maxLength;
        this._textType = textColumnParameterValue?.textType;
    };
    /**
