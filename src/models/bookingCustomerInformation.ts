import {AdminMember1, BookingCustomerInformationBase, BookingQuestionAnswer, Location} from './index';
...
export class BookingCustomerInformation extends BookingCustomerInformationBase implements Parsable {
    ...
    private _customQuestionAnswers?: BookingQuestionAnswer | AdminMember1[] | undefined;
     ...
     */
    public set customQuestionAnswers(value: BookingQuestionAnswer | AdminMember1[] | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "customQuestionAnswers": n => { this.customQuestionAnswers = n.getObjectValue<BookingQuestionAnswer>(createBookingQuestionAnswerFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<BookingQuestionAnswer>("customQuestionAnswers", this.customQuestionAnswers);
