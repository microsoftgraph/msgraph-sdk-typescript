...
export class DeviceEnrollmentWindowsHelloForBusinessConfigurationImpl extends DeviceEnrollmentConfigurationImpl implements DeviceEnrollmentWindowsHelloForBusinessConfiguration {
    ...
    public constructor(deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?: DeviceEnrollmentWindowsHelloForBusinessConfiguration | undefined) {
        ...
        this._enhancedBiometricsState = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.enhancedBiometricsState;
        this._pinExpirationInDays = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.pinExpirationInDays;
        this._pinLowercaseCharactersUsage = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.pinLowercaseCharactersUsage;
        this._pinMaximumLength = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.pinMaximumLength;
        this._pinMinimumLength = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.pinMinimumLength;
        this._pinPreviousBlockCount = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.pinPreviousBlockCount;
        this._pinSpecialCharactersUsage = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.pinSpecialCharactersUsage;
        this._pinUppercaseCharactersUsage = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.pinUppercaseCharactersUsage;
        this._remotePassportEnabled = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.remotePassportEnabled;
        this._securityDeviceRequired = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.securityDeviceRequired;
        this._state = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.state;
        this._unlockWithBiometricsEnabled = deviceEnrollmentWindowsHelloForBusinessConfigurationParameterValue?.unlockWithBiometricsEnabled;
    };
    /**
