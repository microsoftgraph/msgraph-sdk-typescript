...
export class BookingCurrencyCollectionResponseImpl implements BookingCurrencyCollectionResponse {
    ...
    public constructor(bookingCurrencyCollectionResponseParameterValue?: BookingCurrencyCollectionResponse | undefined) {
        this._additionalData = bookingCurrencyCollectionResponseParameterValue?.additionalData ? bookingCurrencyCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = bookingCurrencyCollectionResponseParameterValue?.nextLink;
        this._value = bookingCurrencyCollectionResponseParameterValue?.value;
    };
    /**
