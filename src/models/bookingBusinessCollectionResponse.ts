...
export class BookingBusinessCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as BookingBusinessCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as BookingBusinessCollectionResponse).value = n.getCollectionOfObjectValues<BookingBusiness>(createBookingBusinessFromDiscriminatorValue); },
        };
    };
    /**
