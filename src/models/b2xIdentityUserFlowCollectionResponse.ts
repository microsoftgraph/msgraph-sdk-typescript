...
export class B2xIdentityUserFlowCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as B2xIdentityUserFlowCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as B2xIdentityUserFlowCollectionResponse).value = n.getCollectionOfObjectValues<B2xIdentityUserFlow>(createB2xIdentityUserFlowFromDiscriminatorValue); },
        };
    };
    /**
