...
export class SecurityResourceImpl implements SecurityResource {
    ...
    public constructor(securityResourceParameterValue?: SecurityResource | undefined) {
        this._additionalData = securityResourceParameterValue?.additionalData ? securityResourceParameterValue?.additionalData! : {};
        this._resource = securityResourceParameterValue?.resource;
        this._resourceType = securityResourceParameterValue?.resourceType;
    };
    /**
