...
export class AndroidGeneralDeviceConfiguration extends DeviceConfiguration implements Parsable {
    ...
    private _appsHideList?: AppListItem | AdminMember1[] | undefined;
    /** List of apps which can be installed on the KNOX device. This collection can contain a maximum of 500 elements. */
    private _appsInstallAllowList?: AppListItem | AdminMember1[] | undefined;
    ...
    private _appsLaunchBlockList?: AppListItem | AdminMember1[] | undefined;
    ...
    private _kioskModeApps?: AppListItem | AdminMember1[] | undefined;
     ...
     */
    public set appsHideList(value: AppListItem | AdminMember1[] | undefined) {
     ...
     */
    public set appsInstallAllowList(value: AppListItem | AdminMember1[] | undefined) {
     ...
     */
    public set appsLaunchBlockList(value: AppListItem | AdminMember1[] | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "appsHideList": n => { this.appsHideList = n.getObjectValue<AppListItem>(createAppListItemFromDiscriminatorValue); },
            "appsInstallAllowList": n => { this.appsInstallAllowList = n.getObjectValue<AppListItem>(createAppListItemFromDiscriminatorValue); },
            "appsLaunchBlockList": n => { this.appsLaunchBlockList = n.getObjectValue<AppListItem>(createAppListItemFromDiscriminatorValue); },
            ...
            "kioskModeApps": n => { this.kioskModeApps = n.getObjectValue<AppListItem>(createAppListItemFromDiscriminatorValue); },
     ...
     */
    public set kioskModeApps(value: AppListItem | AdminMember1[] | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<AppListItem>("appsHideList", this.appsHideList);
        writer.writeObjectValue<AppListItem>("appsInstallAllowList", this.appsInstallAllowList);
        writer.writeObjectValue<AppListItem>("appsLaunchBlockList", this.appsLaunchBlockList);
        ...
        writer.writeObjectValue<AppListItem>("kioskModeApps", this.kioskModeApps);
