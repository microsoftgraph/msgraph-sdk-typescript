...
export class DeviceCompliancePolicyStateImpl extends EntityImpl implements DeviceCompliancePolicyState {
    ...
    public constructor(deviceCompliancePolicyStateParameterValue?: DeviceCompliancePolicyState | undefined) {
        ...
        const settingStatesArrValue: DeviceCompliancePolicySettingStateImpl[] = []; this.settingStates?.forEach(element => {settingStatesArrValue.push(element instanceof DeviceCompliancePolicySettingStateImpl? element : new DeviceCompliancePolicySettingStateImpl(element));});
