...
export class PrinterCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as PrinterCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as PrinterCollectionResponse).value = n.getCollectionOfObjectValues<Printer>(createPrinterFromDiscriminatorValue); },
        };
    };
    /**
