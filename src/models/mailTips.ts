...
export function serializeMailTips(writer: SerializationWriter, mailTips: MailTips | undefined = {} as MailTips) : void {
        writer.writeObjectValue<AutomaticRepliesMailTips>("automaticReplies", mailTips.automaticReplies, );
        ...
        writer.writeObjectValue<EmailAddress>("emailAddress", mailTips.emailAddress, );
        writer.writeObjectValue<MailTipsError>("error", mailTips.errorEscaped, );
        ...
        writer.writeCollectionOfObjectValues<Recipient>("recipientSuggestions", mailTips.recipientSuggestions, );
