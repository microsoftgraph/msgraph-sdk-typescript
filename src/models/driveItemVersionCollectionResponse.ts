...
export class DriveItemVersionCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DriveItemVersionCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DriveItemVersionCollectionResponse).value = n.getCollectionOfObjectValues<DriveItemVersion>(createDriveItemVersionFromDiscriminatorValue); },
        };
    };
    /**
