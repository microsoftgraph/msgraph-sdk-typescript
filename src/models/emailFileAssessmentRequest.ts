import {AdminMember1, ThreatAssessmentRequest} from './index';
...
export class EmailFileAssessmentRequest extends ThreatAssessmentRequest implements Parsable {
    ...
    private _destinationRoutingReason?: MailDestinationRoutingReason | AdminMember1 | undefined;
     ...
     */
    public set destinationRoutingReason(value: MailDestinationRoutingReason | AdminMember1 | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "destinationRoutingReason": n => { this.destinationRoutingReason = n.getObjectValue<MailDestinationRoutingReason>(createMailDestinationRoutingReasonFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<MailDestinationRoutingReason>("destinationRoutingReason", this.destinationRoutingReason);
