...
export class GroupLifecyclePolicyCollectionResponseImpl implements GroupLifecyclePolicyCollectionResponse {
    ...
    public constructor(groupLifecyclePolicyCollectionResponseParameterValue?: GroupLifecyclePolicyCollectionResponse | undefined) {
        this._additionalData = groupLifecyclePolicyCollectionResponseParameterValue?.additionalData ? groupLifecyclePolicyCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = groupLifecyclePolicyCollectionResponseParameterValue?.nextLink;
        this._value = groupLifecyclePolicyCollectionResponseParameterValue?.value;
    };
    /**
