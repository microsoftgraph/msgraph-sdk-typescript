...
export class UsedInsightCollectionResponseImpl implements UsedInsightCollectionResponse {
    ...
    public constructor(usedInsightCollectionResponseParameterValue?: UsedInsightCollectionResponse | undefined) {
        this._additionalData = usedInsightCollectionResponseParameterValue?.additionalData ? usedInsightCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = usedInsightCollectionResponseParameterValue?.nextLink;
        this._value = usedInsightCollectionResponseParameterValue?.value;
    };
    /**
