...
export class SubjectRightsRequestCollectionResponseImpl implements SubjectRightsRequestCollectionResponse {
    ...
    public constructor(subjectRightsRequestCollectionResponseParameterValue?: SubjectRightsRequestCollectionResponse | undefined) {
        this._additionalData = subjectRightsRequestCollectionResponseParameterValue?.additionalData ? subjectRightsRequestCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = subjectRightsRequestCollectionResponseParameterValue?.nextLink;
        this._value = subjectRightsRequestCollectionResponseParameterValue?.value;
    };
    /**
