...
export class BaseItem extends Entity implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "createdByUser": n => { this.createdByUser = n.getObjectValue<User>(createUserFromDiscriminatorValue); },
            ...
            "lastModifiedByUser": n => { this.lastModifiedByUser = n.getObjectValue<User>(createUserFromDiscriminatorValue); },
