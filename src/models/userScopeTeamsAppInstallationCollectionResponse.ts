...
export class UserScopeTeamsAppInstallationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as UserScopeTeamsAppInstallationCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as UserScopeTeamsAppInstallationCollectionResponse).value = n.getCollectionOfObjectValues<UserScopeTeamsAppInstallation>(createUserScopeTeamsAppInstallationFromDiscriminatorValue); },
        };
    };
    /**
