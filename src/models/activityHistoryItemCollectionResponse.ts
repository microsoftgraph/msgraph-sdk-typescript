...
export class ActivityHistoryItemCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ActivityHistoryItemCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ActivityHistoryItemCollectionResponse).value = n.getCollectionOfObjectValues<ActivityHistoryItem>(createActivityHistoryItemFromDiscriminatorValue); },
        };
    };
    /**
