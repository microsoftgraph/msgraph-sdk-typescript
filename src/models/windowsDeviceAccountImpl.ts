...
export class WindowsDeviceAccountImpl implements WindowsDeviceAccount {
    ...
    public constructor(windowsDeviceAccountParameterValue?: WindowsDeviceAccount | undefined) {
        this._additionalData = windowsDeviceAccountParameterValue?.additionalData ? windowsDeviceAccountParameterValue?.additionalData! : {};
        this._password = windowsDeviceAccountParameterValue?.password;
    };
    /**
