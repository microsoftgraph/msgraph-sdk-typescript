...
export class OrgContactCollectionResponseImpl implements OrgContactCollectionResponse {
    ...
    public constructor(orgContactCollectionResponseParameterValue?: OrgContactCollectionResponse | undefined) {
        this._additionalData = orgContactCollectionResponseParameterValue?.additionalData ? orgContactCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = orgContactCollectionResponseParameterValue?.nextLink;
        this._value = orgContactCollectionResponseParameterValue?.value;
    };
    /**
