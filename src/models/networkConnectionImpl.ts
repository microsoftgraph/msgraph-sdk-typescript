...
export class NetworkConnectionImpl implements NetworkConnection {
    ...
    public constructor(networkConnectionParameterValue?: NetworkConnection | undefined) {
        this._additionalData = networkConnectionParameterValue?.additionalData ? networkConnectionParameterValue?.additionalData! : {};
        this._applicationName = networkConnectionParameterValue?.applicationName;
        this._destinationAddress = networkConnectionParameterValue?.destinationAddress;
        this._destinationDomain = networkConnectionParameterValue?.destinationDomain;
        this._destinationLocation = networkConnectionParameterValue?.destinationLocation;
        this._destinationPort = networkConnectionParameterValue?.destinationPort;
        this._destinationUrl = networkConnectionParameterValue?.destinationUrl;
        this._direction = networkConnectionParameterValue?.direction;
        this._domainRegisteredDateTime = networkConnectionParameterValue?.domainRegisteredDateTime;
        this._localDnsName = networkConnectionParameterValue?.localDnsName;
        this._natDestinationAddress = networkConnectionParameterValue?.natDestinationAddress;
        this._natDestinationPort = networkConnectionParameterValue?.natDestinationPort;
        this._natSourceAddress = networkConnectionParameterValue?.natSourceAddress;
        this._natSourcePort = networkConnectionParameterValue?.natSourcePort;
        this._protocol = networkConnectionParameterValue?.protocol;
        this._riskScore = networkConnectionParameterValue?.riskScore;
        this._sourceAddress = networkConnectionParameterValue?.sourceAddress;
        this._sourceLocation = networkConnectionParameterValue?.sourceLocation;
        this._sourcePort = networkConnectionParameterValue?.sourcePort;
        this._status = networkConnectionParameterValue?.status;
        this._urlParameters = networkConnectionParameterValue?.urlParameters;
    };
    /**
