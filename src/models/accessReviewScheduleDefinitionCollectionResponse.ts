...
export class AccessReviewScheduleDefinitionCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as AccessReviewScheduleDefinitionCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as AccessReviewScheduleDefinitionCollectionResponse).value = n.getCollectionOfObjectValues<AccessReviewScheduleDefinition>(createAccessReviewScheduleDefinitionFromDiscriminatorValue); },
        };
    };
    /**
