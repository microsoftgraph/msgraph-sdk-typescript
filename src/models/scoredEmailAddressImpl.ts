...
export class ScoredEmailAddressImpl implements ScoredEmailAddress {
    ...
    public constructor(scoredEmailAddressParameterValue?: ScoredEmailAddress | undefined) {
        this._additionalData = scoredEmailAddressParameterValue?.additionalData ? scoredEmailAddressParameterValue?.additionalData! : {};
        this._address = scoredEmailAddressParameterValue?.address;
        this._itemId = scoredEmailAddressParameterValue?.itemId;
        this._relevanceScore = scoredEmailAddressParameterValue?.relevanceScore;
        this._selectionLikelihood = scoredEmailAddressParameterValue?.selectionLikelihood;
    };
    /**
