...
export class InvitationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as InvitationCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as InvitationCollectionResponse).value = n.getCollectionOfObjectValues<Invitation>(createInvitationFromDiscriminatorValue); },
        };
    };
    /**
