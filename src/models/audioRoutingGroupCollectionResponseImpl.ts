...
export class AudioRoutingGroupCollectionResponseImpl implements AudioRoutingGroupCollectionResponse {
    ...
    public constructor(audioRoutingGroupCollectionResponseParameterValue?: AudioRoutingGroupCollectionResponse | undefined) {
        this._additionalData = audioRoutingGroupCollectionResponseParameterValue?.additionalData ? audioRoutingGroupCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = audioRoutingGroupCollectionResponseParameterValue?.nextLink;
        this._value = audioRoutingGroupCollectionResponseParameterValue?.value;
    };
    /**
