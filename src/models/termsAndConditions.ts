...
export function serializeTermsAndConditions(writer: SerializationWriter, termsAndConditions: TermsAndConditions | undefined = {} as TermsAndConditions) : void {
        ...
        writer.writeCollectionOfObjectValues<TermsAndConditionsAcceptanceStatus>("acceptanceStatuses", termsAndConditions.acceptanceStatuses, );
        writer.writeCollectionOfObjectValues<TermsAndConditionsAssignment>("assignments", termsAndConditions.assignments, );
