...
export class EdiscoverySearch extends Search implements Parsable {
    ...
    private _addToReviewSetOperation?: EdiscoveryAddToReviewSetOperation | undefined;
    /** Custodian sources that are included in the eDiscovery search. */
    private _custodianSources?: DataSource[] | undefined;
    /** When specified, the collection will span across a service for an entire workload. Possible values are: none, allTenantMailboxes, allTenantSites, allCaseCustodians, allCaseNoncustodialDataSources. */
    private _dataSourceScopes?: DataSourceScopes | undefined;
    /** The last estimate operation associated with the eDiscovery search. */
    private _lastEstimateStatisticsOperation?: EdiscoveryEstimateOperation | undefined;
     ...
     */
    public set addToReviewSetOperation(value: EdiscoveryAddToReviewSetOperation | undefined) {
     ...
     */
    public set dataSourceScopes(value: DataSourceScopes | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "dataSourceScopes": n => { this.dataSourceScopes = n.getEnumValue<DataSourceScopes>(DataSourceScopes); },
     ...
     */
    public set lastEstimateStatisticsOperation(value: EdiscoveryEstimateOperation | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeEnumValue<DataSourceScopes>("dataSourceScopes", this.dataSourceScopes);
