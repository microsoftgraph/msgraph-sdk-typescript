...
export function serializeRetentionEventType(writer: SerializationWriter, retentionEventType: RetentionEventType | undefined = {} as RetentionEventType) : void {
        ...
        writer.writeObjectValue<IdentitySet>("createdBy", retentionEventType.createdBy, );
        ...
        writer.writeObjectValue<IdentitySet>("lastModifiedBy", retentionEventType.lastModifiedBy, );
