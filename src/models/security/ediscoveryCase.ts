...
export class EdiscoveryCase extends Case_escaped implements Parsable {
    ...
    private _settings?: EdiscoveryCaseSettings | undefined;
     ...
     */
    public set closedBy(value: IdentitySet | undefined) {
     ...
     */
    public set settings(value: EdiscoveryCaseSettings | undefined) {
