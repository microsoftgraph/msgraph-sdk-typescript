...
export function serializeRetentionEvent(writer: SerializationWriter, retentionEvent: RetentionEvent | undefined = {} as RetentionEvent) : void {
        ...
        writer.writeObjectValue<IdentitySet>("createdBy", retentionEvent.createdBy, );
        ...
        writer.writeCollectionOfObjectValues<EventPropagationResult>("eventPropagationResults", retentionEvent.eventPropagationResults, );
        writer.writeCollectionOfObjectValues<EventQuery>("eventQueries", retentionEvent.eventQueries, );
        writer.writeObjectValue<RetentionEventStatus>("eventStatus", retentionEvent.eventStatus, );
        writer.writeDateValue("eventTriggerDateTime", retentionEvent.eventTriggerDateTime);
        writer.writeObjectValue<IdentitySet>("lastModifiedBy", retentionEvent.lastModifiedBy, );
        ...
        writer.writeObjectValue<RetentionEventType>("retentionEventType", retentionEvent.retentionEventType, );
}
// tslint:enable
// eslint-enable
