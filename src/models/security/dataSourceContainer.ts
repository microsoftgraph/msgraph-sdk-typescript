...
export class DataSourceContainer extends Entity implements Parsable {
    ...
    private _status?: DataSourceContainerStatus | AdminMember1 | undefined;
    /**
     * Instantiates a new dataSourceContainer and sets the default values.
     */
    public constructor() {
        super();
        this.type = "#microsoft.graph.security.dataSourceContainer";
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "status": n => { this.status = n.getObjectValue<DataSourceContainerStatus>(createDataSourceContainerStatusFromDiscriminatorValue); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<DataSourceContainerStatus>("status", this.status);
    };
    /**
     ...
     */
    public set status(value: DataSourceContainerStatus | AdminMember1 | undefined) {
        this._status = value;
    };
}
