...
export function serializeHostPort(writer: SerializationWriter, hostPort: HostPort | undefined = {} as HostPort) : void {
        ...
        writer.writeCollectionOfObjectValues<HostPortBanner>("banners", hostPort.banners, );
        writer.writeDateValue("firstSeenDateTime", hostPort.firstSeenDateTime);
        writer.writeObjectValue<Host>("host", hostPort.host, );
        ...
        writer.writeObjectValue<SslCertificate>("mostRecentSslCertificate", hostPort.mostRecentSslCertificate, );
        writer.writeNumberValue("port", hostPort.port);
        writer.writeEnumValue<HostPortProtocol>("protocol", hostPort.protocol);
        writer.writeCollectionOfObjectValues<HostPortComponent>("services", hostPort.services, );
