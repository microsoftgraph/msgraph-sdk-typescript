...
export class EdiscoveryReviewTag extends Tag implements Parsable {
     ...
     */
    public set childSelectability(value: ChildSelectability | AdminMember1 | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "childSelectability": n => { this.childSelectability = n.getObjectValue<ChildSelectability>(createChildSelectabilityFromDiscriminatorValue); },
     ...
     */
    public set parent(value: EdiscoveryReviewTag | AdminMember1 | undefined) {
        this._parent = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<ChildSelectability>("childSelectability", this.childSelectability);
