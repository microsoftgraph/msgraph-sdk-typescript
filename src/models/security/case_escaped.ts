...
export class Case_escaped extends Entity implements Parsable {
    ...
    /** The status property */
    private _status?: CaseStatus | AdminMember1 | undefined;
    /**
     * Instantiates a new case_escaped and sets the default values.
     */
    public constructor() {
        super();
        this.type = "#microsoft.graph.security.case";
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "status": n => { this.status = n.getObjectValue<CaseStatus>(createCaseStatusFromDiscriminatorValue); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<CaseStatus>("status", this.status);
    };
    /**
     ...
     */
    public set status(value: CaseStatus | AdminMember1 | undefined) {
        this._status = value;
    };
}
