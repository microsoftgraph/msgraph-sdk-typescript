...
export function serializeAccessPackageAssignmentReviewSettings(writer: SerializationWriter, accessPackageAssignmentReviewSettings: AccessPackageAssignmentReviewSettings | undefined = {} as AccessPackageAssignmentReviewSettings) : void {
        ...
        writer.writeCollectionOfObjectValues<SubjectSet>("fallbackReviewers", accessPackageAssignmentReviewSettings.fallbackReviewers, );
        ...
        writer.writeCollectionOfObjectValues<SubjectSet>("primaryReviewers", accessPackageAssignmentReviewSettings.primaryReviewers, );
        writer.writeObjectValue<EntitlementManagementSchedule>("schedule", accessPackageAssignmentReviewSettings.schedule, );
