...
export class ContentTypeCollectionResponseImpl implements ContentTypeCollectionResponse {
    ...
    public constructor(contentTypeCollectionResponseParameterValue?: ContentTypeCollectionResponse | undefined) {
        this._additionalData = contentTypeCollectionResponseParameterValue?.additionalData ? contentTypeCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = contentTypeCollectionResponseParameterValue?.nextLink;
        this._value = contentTypeCollectionResponseParameterValue?.value;
    };
    /**
