...
export class AccessPackageAssignmentPolicyCollectionResponseImpl implements AccessPackageAssignmentPolicyCollectionResponse {
    ...
    public constructor(accessPackageAssignmentPolicyCollectionResponseParameterValue?: AccessPackageAssignmentPolicyCollectionResponse | undefined) {
        this._additionalData = accessPackageAssignmentPolicyCollectionResponseParameterValue?.additionalData ? accessPackageAssignmentPolicyCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = accessPackageAssignmentPolicyCollectionResponseParameterValue?.nextLink;
        this._value = accessPackageAssignmentPolicyCollectionResponseParameterValue?.value;
    };
    /**
