...
export class ContractCollectionResponseImpl implements ContractCollectionResponse {
    ...
    public constructor(contractCollectionResponseParameterValue?: ContractCollectionResponse | undefined) {
        this._additionalData = contractCollectionResponseParameterValue?.additionalData ? contractCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = contractCollectionResponseParameterValue?.nextLink;
        this._value = contractCollectionResponseParameterValue?.value;
    };
    /**
