...
export class PasswordCredentialImpl implements PasswordCredential {
    ...
    public constructor(passwordCredentialParameterValue?: PasswordCredential | undefined) {
        this._additionalData = passwordCredentialParameterValue?.additionalData ? passwordCredentialParameterValue?.additionalData! : {};
        this._customKeyIdentifier = passwordCredentialParameterValue?.customKeyIdentifier;
        this._displayName = passwordCredentialParameterValue?.displayName;
        this._endDateTime = passwordCredentialParameterValue?.endDateTime;
        this._hint = passwordCredentialParameterValue?.hint;
        this._keyId = passwordCredentialParameterValue?.keyId;
        this._secretText = passwordCredentialParameterValue?.secretText;
        this._startDateTime = passwordCredentialParameterValue?.startDateTime;
    };
    /**
