...
export class PermissionGrantPolicyCollectionResponseImpl implements PermissionGrantPolicyCollectionResponse {
    ...
    public constructor(permissionGrantPolicyCollectionResponseParameterValue?: PermissionGrantPolicyCollectionResponse | undefined) {
        this._additionalData = permissionGrantPolicyCollectionResponseParameterValue?.additionalData ? permissionGrantPolicyCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = permissionGrantPolicyCollectionResponseParameterValue?.nextLink;
        this._value = permissionGrantPolicyCollectionResponseParameterValue?.value;
    };
    /**
