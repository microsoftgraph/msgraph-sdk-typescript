...
export class OnenoteResourceCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as OnenoteResourceCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as OnenoteResourceCollectionResponse).value = n.getCollectionOfObjectValues<OnenoteResource>(createOnenoteResourceFromDiscriminatorValue); },
        };
    };
    /**
