...
export class AgreementFilePropertiesImpl extends EntityImpl implements AgreementFileProperties {
    ...
    public constructor(agreementFilePropertiesParameterValue?: AgreementFileProperties | undefined) {
        ...
        this._createdDateTime = agreementFilePropertiesParameterValue?.createdDateTime;
        this._displayName = agreementFilePropertiesParameterValue?.displayName;
        this._fileData = agreementFilePropertiesParameterValue?.fileData;
        this._fileName = agreementFilePropertiesParameterValue?.fileName;
        this._isDefault = agreementFilePropertiesParameterValue?.isDefault;
        this._isMajorVersion = agreementFilePropertiesParameterValue?.isMajorVersion;
        this._language = agreementFilePropertiesParameterValue?.language;
    };
    /**
     ...
     * @returns a AgreementFileDataInterface
     */
    public get fileData() {
