...
export class SignInCollectionResponseImpl implements SignInCollectionResponse {
    ...
    public constructor(signInCollectionResponseParameterValue?: SignInCollectionResponse | undefined) {
        this._additionalData = signInCollectionResponseParameterValue?.additionalData ? signInCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = signInCollectionResponseParameterValue?.nextLink;
        this._value = signInCollectionResponseParameterValue?.value;
    };
    /**
