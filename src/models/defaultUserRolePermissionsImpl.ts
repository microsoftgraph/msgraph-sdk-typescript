...
export class DefaultUserRolePermissionsImpl implements DefaultUserRolePermissions {
    ...
    public constructor(defaultUserRolePermissionsParameterValue?: DefaultUserRolePermissions | undefined) {
        this._additionalData = defaultUserRolePermissionsParameterValue?.additionalData ? defaultUserRolePermissionsParameterValue?.additionalData! : {};
        this._allowedToCreateApps = defaultUserRolePermissionsParameterValue?.allowedToCreateApps;
        this._allowedToCreateSecurityGroups = defaultUserRolePermissionsParameterValue?.allowedToCreateSecurityGroups;
        this._allowedToReadOtherUsers = defaultUserRolePermissionsParameterValue?.allowedToReadOtherUsers;
        this._permissionGrantPoliciesAssigned = defaultUserRolePermissionsParameterValue?.permissionGrantPoliciesAssigned;
    };
    /**
