...
export class PrintServiceEndpointCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as PrintServiceEndpointCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as PrintServiceEndpointCollectionResponse).value = n.getCollectionOfObjectValues<PrintServiceEndpoint>(createPrintServiceEndpointFromDiscriminatorValue); },
        };
    };
    /**
