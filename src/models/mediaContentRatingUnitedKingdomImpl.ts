...
export class MediaContentRatingUnitedKingdomImpl implements MediaContentRatingUnitedKingdom {
    ...
    public constructor(mediaContentRatingUnitedKingdomParameterValue?: MediaContentRatingUnitedKingdom | undefined) {
        this._additionalData = mediaContentRatingUnitedKingdomParameterValue?.additionalData ? mediaContentRatingUnitedKingdomParameterValue?.additionalData! : {};
        this._movieRating = mediaContentRatingUnitedKingdomParameterValue?.movieRating;
        this._tvRating = mediaContentRatingUnitedKingdomParameterValue?.tvRating;
    };
    /**
