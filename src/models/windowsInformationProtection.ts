...
export class WindowsInformationProtection extends ManagedAppPolicy implements Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            "assignments": (o, n) => { (o as unknown as WindowsInformationProtection).assignments = n.getCollectionOfObjectValues<TargetedManagedAppPolicyAssignment>(createTargetedManagedAppPolicyAssignmentFromDiscriminatorValue); },
            ...
            "dataRecoveryCertificate": (o, n) => { (o as unknown as WindowsInformationProtection).dataRecoveryCertificate = n.getObjectValue<WindowsInformationProtectionDataRecoveryCertificate>(createWindowsInformationProtectionDataRecoveryCertificateFromDiscriminatorValue); },
            ...
            "enterpriseInternalProxyServers": (o, n) => { (o as unknown as WindowsInformationProtection).enterpriseInternalProxyServers = n.getCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>(createWindowsInformationProtectionResourceCollectionFromDiscriminatorValue); },
            "enterpriseIPRanges": (o, n) => { (o as unknown as WindowsInformationProtection).enterpriseIPRanges = n.getCollectionOfObjectValues<WindowsInformationProtectionIPRangeCollection>(createWindowsInformationProtectionIPRangeCollectionFromDiscriminatorValue); },
            ...
            "enterpriseNetworkDomainNames": (o, n) => { (o as unknown as WindowsInformationProtection).enterpriseNetworkDomainNames = n.getCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>(createWindowsInformationProtectionResourceCollectionFromDiscriminatorValue); },
            "enterpriseProtectedDomainNames": (o, n) => { (o as unknown as WindowsInformationProtection).enterpriseProtectedDomainNames = n.getCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>(createWindowsInformationProtectionResourceCollectionFromDiscriminatorValue); },
            "enterpriseProxiedDomains": (o, n) => { (o as unknown as WindowsInformationProtection).enterpriseProxiedDomains = n.getCollectionOfObjectValues<WindowsInformationProtectionProxiedDomainCollection>(createWindowsInformationProtectionProxiedDomainCollectionFromDiscriminatorValue); },
            "enterpriseProxyServers": (o, n) => { (o as unknown as WindowsInformationProtection).enterpriseProxyServers = n.getCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>(createWindowsInformationProtectionResourceCollectionFromDiscriminatorValue); },
            ...
            "exemptAppLockerFiles": (o, n) => { (o as unknown as WindowsInformationProtection).exemptAppLockerFiles = n.getCollectionOfObjectValues<WindowsInformationProtectionAppLockerFile>(createWindowsInformationProtectionAppLockerFileFromDiscriminatorValue); },
            "exemptApps": (o, n) => { (o as unknown as WindowsInformationProtection).exemptApps = n.getCollectionOfObjectValues<WindowsInformationProtectionApp>(createWindowsInformationProtectionAppFromDiscriminatorValue); },
            ...
            "neutralDomainResources": (o, n) => { (o as unknown as WindowsInformationProtection).neutralDomainResources = n.getCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>(createWindowsInformationProtectionResourceCollectionFromDiscriminatorValue); },
            "protectedAppLockerFiles": (o, n) => { (o as unknown as WindowsInformationProtection).protectedAppLockerFiles = n.getCollectionOfObjectValues<WindowsInformationProtectionAppLockerFile>(createWindowsInformationProtectionAppLockerFileFromDiscriminatorValue); },
            "protectedApps": (o, n) => { (o as unknown as WindowsInformationProtection).protectedApps = n.getCollectionOfObjectValues<WindowsInformationProtectionApp>(createWindowsInformationProtectionAppFromDiscriminatorValue); },
            ...
            "smbAutoEncryptedFileExtensions": (o, n) => { (o as unknown as WindowsInformationProtection).smbAutoEncryptedFileExtensions = n.getCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>(createWindowsInformationProtectionResourceCollectionFromDiscriminatorValue); },
        };
    };
    /**
