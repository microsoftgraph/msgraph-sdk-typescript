...
export function serializeWindowsInformationProtection(writer: SerializationWriter, windowsInformationProtection: WindowsInformationProtection | undefined = {} as WindowsInformationProtection) : void {
        ...
        writer.writeCollectionOfObjectValues<TargetedManagedAppPolicyAssignment>("assignments", windowsInformationProtection.assignments, );
        ...
        writer.writeObjectValue<WindowsInformationProtectionDataRecoveryCertificate>("dataRecoveryCertificate", windowsInformationProtection.dataRecoveryCertificate, );
        ...
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>("enterpriseInternalProxyServers", windowsInformationProtection.enterpriseInternalProxyServers, );
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionIPRangeCollection>("enterpriseIPRanges", windowsInformationProtection.enterpriseIPRanges, );
        ...
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>("enterpriseNetworkDomainNames", windowsInformationProtection.enterpriseNetworkDomainNames, );
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>("enterpriseProtectedDomainNames", windowsInformationProtection.enterpriseProtectedDomainNames, );
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionProxiedDomainCollection>("enterpriseProxiedDomains", windowsInformationProtection.enterpriseProxiedDomains, );
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>("enterpriseProxyServers", windowsInformationProtection.enterpriseProxyServers, );
        ...
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionAppLockerFile>("exemptAppLockerFiles", windowsInformationProtection.exemptAppLockerFiles, );
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionApp>("exemptApps", windowsInformationProtection.exemptApps, );
        ...
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>("neutralDomainResources", windowsInformationProtection.neutralDomainResources, );
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionAppLockerFile>("protectedAppLockerFiles", windowsInformationProtection.protectedAppLockerFiles, );
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionApp>("protectedApps", windowsInformationProtection.protectedApps, );
        ...
        writer.writeCollectionOfObjectValues<WindowsInformationProtectionResourceCollection>("smbAutoEncryptedFileExtensions", windowsInformationProtection.smbAutoEncryptedFileExtensions, );
}
