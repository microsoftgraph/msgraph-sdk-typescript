...
export class ProvisioningObjectSummaryCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ProvisioningObjectSummaryCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ProvisioningObjectSummaryCollectionResponse).value = n.getCollectionOfObjectValues<ProvisioningObjectSummary>(createProvisioningObjectSummaryFromDiscriminatorValue); },
        };
    };
    /**
