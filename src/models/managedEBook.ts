...
export function serializeManagedEBook(writer: SerializationWriter, managedEBook: ManagedEBook | undefined = {} as ManagedEBook) : void {
        ...
        writer.writeCollectionOfObjectValues<ManagedEBookAssignment>("assignments", managedEBook.assignments, );
        ...
        writer.writeCollectionOfObjectValues<DeviceInstallState>("deviceStates", managedEBook.deviceStates, );
        ...
        writer.writeObjectValue<EBookInstallSummary>("installSummary", managedEBook.installSummary, );
        writer.writeObjectValue<MimeContent>("largeCover", managedEBook.largeCover, );
        ...
        writer.writeCollectionOfObjectValues<UserInstallStateSummary>("userStateSummary", managedEBook.userStateSummary, );
}
// tslint:enable
// eslint-enable
