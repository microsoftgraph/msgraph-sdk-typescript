...
export class ApplicationTemplateCollectionResponseImpl implements ApplicationTemplateCollectionResponse {
    ...
    public constructor(applicationTemplateCollectionResponseParameterValue?: ApplicationTemplateCollectionResponse | undefined) {
        this._additionalData = applicationTemplateCollectionResponseParameterValue?.additionalData ? applicationTemplateCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = applicationTemplateCollectionResponseParameterValue?.nextLink;
        this._value = applicationTemplateCollectionResponseParameterValue?.value;
    };
    /**
     ...
     * @returns a ApplicationTemplateInterface
     */
    public get value() {
        return this._value;
    };
