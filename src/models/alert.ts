...
export class Alert extends Entity implements Parsable {
    ...
    private _alertDetections?: AlertDetection | AdminMember1[] | undefined;
    ...
    private _cloudAppStates?: CloudAppSecurityState | AdminMember1[] | undefined;
    ...
    private _fileStates?: FileSecurityState | AdminMember1[] | undefined;
    /** A collection of alertHistoryStates comprising an audit log of all updates made to an alert. */
    private _historyStates?: AlertHistoryState | AdminMember1[] | undefined;
    /** Security-related stateful information generated by the provider about the host(s) related to this alert. */
    private _hostStates?: HostSecurityState | AdminMember1[] | undefined;
    /** IDs of incidents related to current alert. */
    private _incidentIds?: string[] | undefined;
    /** The investigationSecurityStates property */
    private _investigationSecurityStates?: InvestigationSecurityState | AdminMember1[] | undefined;
    ...
    private _malwareStates?: MalwareState | AdminMember1[] | undefined;
    /** The messageSecurityStates property */
    private _messageSecurityStates?: MessageSecurityState | AdminMember1[] | undefined;
    /** Security-related stateful information generated by the provider about the network connection(s) related to this alert. */
    private _networkConnections?: NetworkConnection | AdminMember1[] | undefined;
    /** Security-related stateful information generated by the provider about the process or processes related to this alert. */
    private _processes?: Process | AdminMember1[] | undefined;
    ...
    private _registryKeyStates?: RegistryKeyState | AdminMember1[] | undefined;
    /** Resources related to current alert. For example, for some alerts this can have the Azure Resource value. */
    private _securityResources?: SecurityResource | AdminMember1[] | undefined;
    ...
    private _triggers?: AlertTrigger | AdminMember1[] | undefined;
    /** The uriClickSecurityStates property */
    private _uriClickSecurityStates?: UriClickSecurityState | AdminMember1[] | undefined;
    /** Security-related stateful information generated by the provider about the user accounts related to this alert. */
    private _userStates?: UserSecurityState | AdminMember1[] | undefined;
    ...
    private _vulnerabilityStates?: VulnerabilityState | AdminMember1[] | undefined;
    /**
     ...
     */
    public set alertDetections(value: AlertDetection | AdminMember1[] | undefined) {
     ...
     */
    public set cloudAppStates(value: CloudAppSecurityState | AdminMember1[] | undefined) {
     ...
     */
    public set fileStates(value: FileSecurityState | AdminMember1[] | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "alertDetections": n => { this.alertDetections = n.getObjectValue<AlertDetection>(createAlertDetectionFromDiscriminatorValue); },
            ...
            "cloudAppStates": n => { this.cloudAppStates = n.getObjectValue<CloudAppSecurityState>(createCloudAppSecurityStateFromDiscriminatorValue); },
            ...
            "fileStates": n => { this.fileStates = n.getObjectValue<FileSecurityState>(createFileSecurityStateFromDiscriminatorValue); },
            "historyStates": n => { this.historyStates = n.getObjectValue<AlertHistoryState>(createAlertHistoryStateFromDiscriminatorValue); },
            "hostStates": n => { this.hostStates = n.getObjectValue<HostSecurityState>(createHostSecurityStateFromDiscriminatorValue); },
            "incidentIds": n => { this.incidentIds = n.getCollectionOfPrimitiveValues<string>(); },
            "investigationSecurityStates": n => { this.investigationSecurityStates = n.getObjectValue<InvestigationSecurityState>(createInvestigationSecurityStateFromDiscriminatorValue); },
            "lastEventDateTime": n => { this.lastEventDateTime = n.getDateValue(); },
            "lastModifiedDateTime": n => { this.lastModifiedDateTime = n.getDateValue(); },
            "malwareStates": n => { this.malwareStates = n.getObjectValue<MalwareState>(createMalwareStateFromDiscriminatorValue); },
            "messageSecurityStates": n => { this.messageSecurityStates = n.getObjectValue<MessageSecurityState>(createMessageSecurityStateFromDiscriminatorValue); },
            "networkConnections": n => { this.networkConnections = n.getObjectValue<NetworkConnection>(createNetworkConnectionFromDiscriminatorValue); },
            "processes": n => { this.processes = n.getObjectValue<Process>(createProcessFromDiscriminatorValue); },
            "recommendedActions": n => { this.recommendedActions = n.getCollectionOfPrimitiveValues<string>(); },
            "registryKeyStates": n => { this.registryKeyStates = n.getObjectValue<RegistryKeyState>(createRegistryKeyStateFromDiscriminatorValue); },
            "securityResources": n => { this.securityResources = n.getObjectValue<SecurityResource>(createSecurityResourceFromDiscriminatorValue); },
            ...
            "triggers": n => { this.triggers = n.getObjectValue<AlertTrigger>(createAlertTriggerFromDiscriminatorValue); },
            "uriClickSecurityStates": n => { this.uriClickSecurityStates = n.getObjectValue<UriClickSecurityState>(createUriClickSecurityStateFromDiscriminatorValue); },
            "userStates": n => { this.userStates = n.getObjectValue<UserSecurityState>(createUserSecurityStateFromDiscriminatorValue); },
            ...
            "vulnerabilityStates": n => { this.vulnerabilityStates = n.getObjectValue<VulnerabilityState>(createVulnerabilityStateFromDiscriminatorValue); },
        };
    };
    /**
     ...
     */
    public set historyStates(value: AlertHistoryState | AdminMember1[] | undefined) {
     ...
     */
    public set hostStates(value: HostSecurityState | AdminMember1[] | undefined) {
     ...
     */
    public set investigationSecurityStates(value: InvestigationSecurityState | AdminMember1[] | undefined) {
     ...
     */
    public set malwareStates(value: MalwareState | AdminMember1[] | undefined) {
     ...
     */
    public set messageSecurityStates(value: MessageSecurityState | AdminMember1[] | undefined) {
     ...
     */
    public set networkConnections(value: NetworkConnection | AdminMember1[] | undefined) {
     ...
     */
    public set processes(value: Process | AdminMember1[] | undefined) {
     ...
     */
    public set registryKeyStates(value: RegistryKeyState | AdminMember1[] | undefined) {
     ...
     */
    public set securityResources(value: SecurityResource | AdminMember1[] | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<AlertDetection>("alertDetections", this.alertDetections);
        ...
        writer.writeObjectValue<CloudAppSecurityState>("cloudAppStates", this.cloudAppStates);
        ...
        writer.writeObjectValue<FileSecurityState>("fileStates", this.fileStates);
        writer.writeObjectValue<AlertHistoryState>("historyStates", this.historyStates);
        writer.writeObjectValue<HostSecurityState>("hostStates", this.hostStates);
        writer.writeCollectionOfPrimitiveValues<string>("incidentIds", this.incidentIds);
        writer.writeObjectValue<InvestigationSecurityState>("investigationSecurityStates", this.investigationSecurityStates);
        writer.writeDateValue("lastEventDateTime", this.lastEventDateTime);
        writer.writeDateValue("lastModifiedDateTime", this.lastModifiedDateTime);
        writer.writeObjectValue<MalwareState>("malwareStates", this.malwareStates);
        writer.writeObjectValue<MessageSecurityState>("messageSecurityStates", this.messageSecurityStates);
        writer.writeObjectValue<NetworkConnection>("networkConnections", this.networkConnections);
        writer.writeObjectValue<Process>("processes", this.processes);
        writer.writeCollectionOfPrimitiveValues<string>("recommendedActions", this.recommendedActions);
        writer.writeObjectValue<RegistryKeyState>("registryKeyStates", this.registryKeyStates);
        writer.writeObjectValue<SecurityResource>("securityResources", this.securityResources);
        ...
        writer.writeObjectValue<AlertTrigger>("triggers", this.triggers);
        writer.writeObjectValue<UriClickSecurityState>("uriClickSecurityStates", this.uriClickSecurityStates);
        writer.writeObjectValue<UserSecurityState>("userStates", this.userStates);
        writer.writeObjectValue<SecurityVendorInformation>("vendorInformation", this.vendorInformation);
        writer.writeObjectValue<VulnerabilityState>("vulnerabilityStates", this.vulnerabilityStates);
    };
    /**
     ...
     */
    public set triggers(value: AlertTrigger | AdminMember1[] | undefined) {
     ...
     */
    public set uriClickSecurityStates(value: UriClickSecurityState | AdminMember1[] | undefined) {
     ...
     */
    public set userStates(value: UserSecurityState | AdminMember1[] | undefined) {
     ...
     */
    public set vulnerabilityStates(value: VulnerabilityState | AdminMember1[] | undefined) {
