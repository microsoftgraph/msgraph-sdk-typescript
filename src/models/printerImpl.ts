...
export class PrinterImpl extends PrinterBaseImpl implements Parsable, Printer {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.taskTriggers){
        const taskTriggersArrValue: PrintTaskTriggerImpl[] = []; this.taskTriggers?.forEach(element => {taskTriggersArrValue.push(new PrintTaskTriggerImpl(element));});
