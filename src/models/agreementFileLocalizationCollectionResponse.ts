...
export class AgreementFileLocalizationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as AgreementFileLocalizationCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as AgreementFileLocalizationCollectionResponse).value = n.getCollectionOfObjectValues<AgreementFileLocalization>(createAgreementFileLocalizationFromDiscriminatorValue); },
        };
    };
    /**
