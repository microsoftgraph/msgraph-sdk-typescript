...
export function serializeMembershipOutlierInsight(writer: SerializationWriter, membershipOutlierInsight: MembershipOutlierInsight | undefined = {} as MembershipOutlierInsight) : void {
        ...
        writer.writeObjectValue<DirectoryObject>("container", membershipOutlierInsight.container, );
        writer.writeStringValue("containerId", membershipOutlierInsight.containerId);
        writer.writeObjectValue<User>("lastModifiedBy", membershipOutlierInsight.lastModifiedBy, );
        writer.writeObjectValue<DirectoryObject>("member", membershipOutlierInsight.member, );
