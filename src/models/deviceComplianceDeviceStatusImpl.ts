...
export class DeviceComplianceDeviceStatusImpl extends EntityImpl implements DeviceComplianceDeviceStatus {
    ...
    public constructor(deviceComplianceDeviceStatusParameterValue?: DeviceComplianceDeviceStatus | undefined) {
        ...
        this._complianceGracePeriodExpirationDateTime = deviceComplianceDeviceStatusParameterValue?.complianceGracePeriodExpirationDateTime;
        this._deviceDisplayName = deviceComplianceDeviceStatusParameterValue?.deviceDisplayName;
        this._deviceModel = deviceComplianceDeviceStatusParameterValue?.deviceModel;
        this._lastReportedDateTime = deviceComplianceDeviceStatusParameterValue?.lastReportedDateTime;
        this._status = deviceComplianceDeviceStatusParameterValue?.status;
        this._userName = deviceComplianceDeviceStatusParameterValue?.userName;
        this._userPrincipalName = deviceComplianceDeviceStatusParameterValue?.userPrincipalName;
    };
    /**
