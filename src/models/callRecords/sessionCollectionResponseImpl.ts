...
export class SessionCollectionResponseImpl implements SessionCollectionResponse {
    ...
    public constructor(sessionCollectionResponseParameterValue?: SessionCollectionResponse | undefined) {
        this._additionalData = sessionCollectionResponseParameterValue?.additionalData ? sessionCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = sessionCollectionResponseParameterValue?.nextLink;
        this._value = sessionCollectionResponseParameterValue?.value;
    };
    /**
