import {CommunicationsMember1, FeedbackTokenSet} from './index';
...
export class UserFeedback implements AdditionalDataHolder, Parsable {
    ...
    private _tokens?: FeedbackTokenSet | CommunicationsMember1 | undefined;
    /**
     ...
     */
    public set tokens(value: FeedbackTokenSet | CommunicationsMember1 | undefined) {
        this._tokens = value;
    };
}
