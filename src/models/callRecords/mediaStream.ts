...
export class MediaStream implements AdditionalDataHolder, Parsable {
    ...
    private _averageAudioDegradation?: number | string | ReferenceNumeric | undefined;
    ...
    private _averagePacketLossRate?: number | string | ReferenceNumeric | undefined;
    ...
    private _averageRatioOfConcealedSamples?: number | string | ReferenceNumeric | undefined;
    /** Average frames per second received for all video streams computed over the duration of the session. */
    private _averageReceivedFrameRate?: number | string | ReferenceNumeric | undefined;
    ...
    private _averageVideoFrameLossPercentage?: number | string | ReferenceNumeric | undefined;
    /** Average frames per second received for a video stream, computed over the duration of the session. */
    private _averageVideoFrameRate?: number | string | ReferenceNumeric | undefined;
    /** Average fraction of packets lost, as specified in [RFC 3550][], computed over the duration of the session. */
    private _averageVideoPacketLossRate?: number | string | ReferenceNumeric | undefined;
    ...
    private _lowFrameRateRatio?: number | string | ReferenceNumeric | undefined;
    /** Fraction of the call that the client is running less than 70% expected video processing capability. */
    private _lowVideoProcessingCapabilityRatio?: number | string | ReferenceNumeric | undefined;
    ...
    private _maxPacketLossRate?: number | string | ReferenceNumeric | undefined;
    /** Maximum ratio of packets concealed by the healer. */
    private _maxRatioOfConcealedSamples?: number | string | ReferenceNumeric | undefined;
    ...
    private _postForwardErrorCorrectionPacketLossRate?: number | string | ReferenceNumeric | undefined;
     ...
     */
    public set averageAudioDegradation(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set averagePacketLossRate(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set averageRatioOfConcealedSamples(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set averageReceivedFrameRate(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set averageVideoFrameLossPercentage(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set averageVideoFrameRate(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set averageVideoPacketLossRate(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set lowFrameRateRatio(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set lowVideoProcessingCapabilityRatio(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set maxPacketLossRate(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set maxRatioOfConcealedSamples(value: number | string | ReferenceNumeric | undefined) {
     ...
     */
    public set postForwardErrorCorrectionPacketLossRate(value: number | string | ReferenceNumeric | undefined) {
