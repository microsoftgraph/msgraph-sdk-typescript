...
export class MediaStream implements AdditionalDataHolder, Parsable {
    ...
    private _audioCodec?: AudioCodec | CommunicationsMember1 | undefined;
    ...
    private _videoCodec?: VideoCodec | CommunicationsMember1 | undefined;
     ...
     */
    public set audioCodec(value: AudioCodec | CommunicationsMember1 | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "audioCodec": n => { this.audioCodec = n.getObjectValue<AudioCodec>(createAudioCodecFromDiscriminatorValue); },
            ...
            "videoCodec": n => { this.videoCodec = n.getObjectValue<VideoCodec>(createVideoCodecFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<AudioCodec>("audioCodec", this.audioCodec);
        ...
        writer.writeObjectValue<VideoCodec>("videoCodec", this.videoCodec);
     ...
     */
    public set videoCodec(value: VideoCodec | CommunicationsMember1 | undefined) {
