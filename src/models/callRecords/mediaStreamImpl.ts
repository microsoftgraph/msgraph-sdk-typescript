...
export class MediaStreamImpl implements MediaStream {
    ...
    public constructor(mediaStreamParameterValue?: MediaStream | undefined) {
        ...
        this._audioCodec = mediaStreamParameterValue?.audioCodec;
        this._averageAudioDegradation = mediaStreamParameterValue?.averageAudioDegradation;
        this._averageAudioNetworkJitter = mediaStreamParameterValue?.averageAudioNetworkJitter;
        this._averageBandwidthEstimate = mediaStreamParameterValue?.averageBandwidthEstimate;
        this._averageJitter = mediaStreamParameterValue?.averageJitter;
        this._averagePacketLossRate = mediaStreamParameterValue?.averagePacketLossRate;
        this._averageRatioOfConcealedSamples = mediaStreamParameterValue?.averageRatioOfConcealedSamples;
        this._averageReceivedFrameRate = mediaStreamParameterValue?.averageReceivedFrameRate;
        this._averageRoundTripTime = mediaStreamParameterValue?.averageRoundTripTime;
        this._averageVideoFrameLossPercentage = mediaStreamParameterValue?.averageVideoFrameLossPercentage;
        this._averageVideoFrameRate = mediaStreamParameterValue?.averageVideoFrameRate;
        this._averageVideoPacketLossRate = mediaStreamParameterValue?.averageVideoPacketLossRate;
        this._endDateTime = mediaStreamParameterValue?.endDateTime;
        this._lowFrameRateRatio = mediaStreamParameterValue?.lowFrameRateRatio;
        this._lowVideoProcessingCapabilityRatio = mediaStreamParameterValue?.lowVideoProcessingCapabilityRatio;
        this._maxAudioNetworkJitter = mediaStreamParameterValue?.maxAudioNetworkJitter;
        this._maxJitter = mediaStreamParameterValue?.maxJitter;
        this._maxPacketLossRate = mediaStreamParameterValue?.maxPacketLossRate;
        this._maxRatioOfConcealedSamples = mediaStreamParameterValue?.maxRatioOfConcealedSamples;
        this._maxRoundTripTime = mediaStreamParameterValue?.maxRoundTripTime;
        this._packetUtilization = mediaStreamParameterValue?.packetUtilization;
        this._postForwardErrorCorrectionPacketLossRate = mediaStreamParameterValue?.postForwardErrorCorrectionPacketLossRate;
        this._startDateTime = mediaStreamParameterValue?.startDateTime;
        this._streamDirection = mediaStreamParameterValue?.streamDirection;
        this._streamId = mediaStreamParameterValue?.streamId;
        this._videoCodec = mediaStreamParameterValue?.videoCodec;
        this._wasMediaBypassed = mediaStreamParameterValue?.wasMediaBypassed;
    };
    /**
