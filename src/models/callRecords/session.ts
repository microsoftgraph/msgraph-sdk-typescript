...
export function serializeSession(writer: SerializationWriter, session: Session | undefined = {} as Session) : void {
        ...
        writer.writeObjectValue<Endpoint>("callee", session.callee, );
        writer.writeObjectValue<Endpoint>("caller", session.caller, );
        writer.writeDateValue("endDateTime", session.endDateTime);
        writer.writeObjectValue<FailureInfo>("failureInfo", session.failureInfo, );
        ...
        writer.writeCollectionOfObjectValues<Segment>("segments", session.segments, );
