...
export class SegmentCollectionResponseImpl implements SegmentCollectionResponse {
    ...
    public constructor(segmentCollectionResponseParameterValue?: SegmentCollectionResponse | undefined) {
        this._additionalData = segmentCollectionResponseParameterValue?.additionalData ? segmentCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = segmentCollectionResponseParameterValue?.nextLink;
        this._value = segmentCollectionResponseParameterValue?.value;
    };
    /**
