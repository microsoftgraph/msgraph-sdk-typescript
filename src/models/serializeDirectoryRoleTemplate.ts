...
export function serializeDirectoryRoleTemplate(directoryRoleTemplate: DirectoryRoleTemplate | undefined = {} as DirectoryRoleTemplate, writer: SerializationWriter) : void {
