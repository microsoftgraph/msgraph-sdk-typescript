...
export class UserImpl extends DirectoryObjectImpl implements User {
    ...
    public constructor(userParameterValue?: User | undefined) {
        ...
        const activitiesArrValue: UserActivityImpl[] = []; this.activities?.forEach(element => {activitiesArrValue.push(element instanceof UserActivityImpl? element : new UserActivityImpl(element));});
        ...
        const calendarGroupsArrValue: CalendarGroupImpl[] = []; this.calendarGroups?.forEach(element => {calendarGroupsArrValue.push(element instanceof CalendarGroupImpl? element : new CalendarGroupImpl(element));});
        ...
        const chatsArrValue: ChatImpl[] = []; this.chats?.forEach(element => {chatsArrValue.push(element instanceof ChatImpl? element : new ChatImpl(element));});
        ...
        const contactFoldersArrValue: ContactFolderImpl[] = []; this.contactFolders?.forEach(element => {contactFoldersArrValue.push(element instanceof ContactFolderImpl? element : new ContactFolderImpl(element));});
        ...
        const followedSitesArrValue: SiteImpl[] = []; this.followedSites?.forEach(element => {followedSitesArrValue.push(element instanceof SiteImpl? element : new SiteImpl(element));});
        ...
        const identitiesArrValue: ObjectIdentityImpl[] = []; this.identities?.forEach(element => {identitiesArrValue.push(element instanceof ObjectIdentityImpl? element : new ObjectIdentityImpl(element));});
        ...
        const joinedTeamsArrValue: TeamImpl[] = []; this.joinedTeams?.forEach(element => {joinedTeamsArrValue.push(element instanceof TeamImpl? element : new TeamImpl(element));});
        ...
        const licenseAssignmentStatesArrValue: LicenseAssignmentStateImpl[] = []; this.licenseAssignmentStates?.forEach(element => {licenseAssignmentStatesArrValue.push(element instanceof LicenseAssignmentStateImpl? element : new LicenseAssignmentStateImpl(element));});
        this.licenseAssignmentStates = licenseAssignmentStatesArrValue;
        const licenseDetailsArrValue: LicenseDetailsImpl[] = []; this.licenseDetails?.forEach(element => {licenseDetailsArrValue.push(element instanceof LicenseDetailsImpl? element : new LicenseDetailsImpl(element));});
        ...
        const mailFoldersArrValue: MailFolderImpl[] = []; this.mailFolders?.forEach(element => {mailFoldersArrValue.push(element instanceof MailFolderImpl? element : new MailFolderImpl(element));});
        ...
        const ownedDevicesArrValue: DirectoryObjectImpl[] = []; this.ownedDevices?.forEach(element => {ownedDevicesArrValue.push(element instanceof DirectoryObjectImpl? element : new DirectoryObjectImpl(element));});
        ...
        const peopleArrValue: PersonImpl[] = []; this.people?.forEach(element => {peopleArrValue.push(element instanceof PersonImpl? element : new PersonImpl(element));});
        ...
        const registeredDevicesArrValue: DirectoryObjectImpl[] = []; this.registeredDevices?.forEach(element => {registeredDevicesArrValue.push(element instanceof DirectoryObjectImpl? element : new DirectoryObjectImpl(element));});
        ...
        const scopedRoleMemberOfArrValue: ScopedRoleMembershipImpl[] = []; this.scopedRoleMemberOf?.forEach(element => {scopedRoleMemberOfArrValue.push(element instanceof ScopedRoleMembershipImpl? element : new ScopedRoleMembershipImpl(element));});
