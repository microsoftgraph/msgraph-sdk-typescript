import {AccessReviewScope, AdminMember1} from './index';
...
export class PrincipalResourceMembershipsScope extends AccessReviewScope implements Parsable {
    ...
    private _principalScopes?: AccessReviewScope | AdminMember1[] | undefined;
    /** Defines the scopes of the resources for which access is reviewed. */
    private _resourceScopes?: AccessReviewScope | AdminMember1[] | undefined;
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "principalScopes": n => { this.principalScopes = n.getObjectValue<AccessReviewScope>(createAccessReviewScopeFromDiscriminatorValue); },
            "resourceScopes": n => { this.resourceScopes = n.getObjectValue<AccessReviewScope>(createAccessReviewScopeFromDiscriminatorValue); },
        };
    };
    /**
     ...
     */
    public set principalScopes(value: AccessReviewScope | AdminMember1[] | undefined) {
     ...
     */
    public set resourceScopes(value: AccessReviewScope | AdminMember1[] | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<AccessReviewScope>("principalScopes", this.principalScopes);
        writer.writeObjectValue<AccessReviewScope>("resourceScopes", this.resourceScopes);
    };
}
