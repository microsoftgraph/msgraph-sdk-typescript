...
export class IdentityProviderBaseCollectionResponseImpl implements IdentityProviderBaseCollectionResponse {
    ...
    public constructor(identityProviderBaseCollectionResponseParameterValue?: IdentityProviderBaseCollectionResponse | undefined) {
        this._additionalData = identityProviderBaseCollectionResponseParameterValue?.additionalData ? identityProviderBaseCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = identityProviderBaseCollectionResponseParameterValue?.nextLink;
        this._value = identityProviderBaseCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value && this.value.length != 0){        const valueArrValue: IdentityProviderBaseImpl[] = [];
        this.value?.forEach(element => {
            valueArrValue.push((element instanceof IdentityProviderBaseImpl? element as IdentityProviderBaseImpl:new IdentityProviderBaseImpl(element)));
        });
    ...
    public set value(value: IdentityProviderBase[] | undefined) {
        if(value) {
            const valueArrValue: IdentityProviderBaseImpl[] = [];
            this.value?.forEach(element => {
                valueArrValue.push((element instanceof IdentityProviderBaseImpl? element as IdentityProviderBaseImpl:new IdentityProviderBaseImpl(element)));
            });
