...
export class ManagedMobileLobAppCollectionResponseImpl implements ManagedMobileLobAppCollectionResponse {
    ...
    public constructor(managedMobileLobAppCollectionResponseParameterValue?: ManagedMobileLobAppCollectionResponse | undefined) {
        this._additionalData = managedMobileLobAppCollectionResponseParameterValue?.additionalData ? managedMobileLobAppCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = managedMobileLobAppCollectionResponseParameterValue?.nextLink;
        this._value = managedMobileLobAppCollectionResponseParameterValue?.value;
    };
    /**
     ...
     * @returns a ManagedMobileLobAppInterface
     */
    public get value() {
        return this._value;
    };
