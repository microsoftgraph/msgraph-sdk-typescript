...
export class ConnectedOrganizationCollectionResponseImpl implements ConnectedOrganizationCollectionResponse {
    ...
    public constructor(connectedOrganizationCollectionResponseParameterValue?: ConnectedOrganizationCollectionResponse | undefined) {
        this._additionalData = connectedOrganizationCollectionResponseParameterValue?.additionalData ? connectedOrganizationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = connectedOrganizationCollectionResponseParameterValue?.nextLink;
        this._value = connectedOrganizationCollectionResponseParameterValue?.value;
    };
    /**
