...
export class DirectoryAuditImpl extends EntityImpl implements DirectoryAudit {
    ...
    public constructor(directoryAuditParameterValue?: DirectoryAudit | undefined) {
        ...
        const additionalDetailsArrValue: KeyValueImpl[] = []; this.additionalDetails?.forEach(element => {additionalDetailsArrValue.push(element instanceof KeyValueImpl? element : new KeyValueImpl(element));});
        ...
        this.initiatedBy = directoryAuditParameterValue?.initiatedBy instanceof AuditActivityInitiatorImpl? directoryAuditParameterValue?.initiatedBy:new AuditActivityInitiatorImpl(directoryAuditParameterValue?.initiatedBy);
        ...
        const targetResourcesArrValue: TargetResourceImpl[] = []; this.targetResources?.forEach(element => {targetResourcesArrValue.push(element instanceof TargetResourceImpl? element : new TargetResourceImpl(element));});
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.additionalDetails && this.additionalDetails.length != 0){        const additionalDetailsArrValue: KeyValueImpl[] = []; this.additionalDetails?.forEach(element => {additionalDetailsArrValue.push(element instanceof KeyValueImpl? element : new KeyValueImpl(element));});
