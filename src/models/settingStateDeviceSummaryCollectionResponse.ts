...
export class SettingStateDeviceSummaryCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as SettingStateDeviceSummaryCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as SettingStateDeviceSummaryCollectionResponse).value = n.getCollectionOfObjectValues<SettingStateDeviceSummary>(createSettingStateDeviceSummaryFromDiscriminatorValue); },
        };
    };
    /**
