...
import {AdminMember1, Place} from './index';
...
export class Room extends Place implements Parsable {
    ...
    private _bookingType?: BookingType | AdminMember1 | undefined;
     ...
     */
    public set bookingType(value: BookingType | AdminMember1 | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "bookingType": n => { this.bookingType = n.getObjectValue<BookingType>(createBookingTypeFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<BookingType>("bookingType", this.bookingType);
