...
export class AccessPackageCollectionResponseImpl implements AccessPackageCollectionResponse {
    ...
    public constructor(accessPackageCollectionResponseParameterValue?: AccessPackageCollectionResponse | undefined) {
        this._additionalData = accessPackageCollectionResponseParameterValue?.additionalData ? accessPackageCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = accessPackageCollectionResponseParameterValue?.nextLink;
        this._value = accessPackageCollectionResponseParameterValue?.value;
    };
    /**
