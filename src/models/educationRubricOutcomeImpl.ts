...
export class EducationRubricOutcomeImpl extends EducationOutcomeImpl implements EducationRubricOutcome {
    ...
    public constructor(educationRubricOutcomeParameterValue?: EducationRubricOutcome | undefined) {
        ...
        const publishedRubricQualityFeedbackArrValue: RubricQualityFeedbackModelImpl[] = []; this.publishedRubricQualityFeedback?.forEach(element => {publishedRubricQualityFeedbackArrValue.push(element instanceof RubricQualityFeedbackModelImpl? element : new RubricQualityFeedbackModelImpl(element));});
        ...
        const rubricQualityFeedbackArrValue: RubricQualityFeedbackModelImpl[] = []; this.rubricQualityFeedback?.forEach(element => {rubricQualityFeedbackArrValue.push(element instanceof RubricQualityFeedbackModelImpl? element : new RubricQualityFeedbackModelImpl(element));});
        this.rubricQualityFeedback = rubricQualityFeedbackArrValue;
        const rubricQualitySelectedLevelsArrValue: RubricQualitySelectedColumnModelImpl[] = []; this.rubricQualitySelectedLevels?.forEach(element => {rubricQualitySelectedLevelsArrValue.push(element instanceof RubricQualitySelectedColumnModelImpl? element : new RubricQualitySelectedColumnModelImpl(element));});
