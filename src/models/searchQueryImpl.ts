...
export class SearchQueryImpl implements SearchQuery {
    ...
    public constructor(searchQueryParameterValue?: SearchQuery | undefined) {
        this._additionalData = searchQueryParameterValue?.additionalData ? searchQueryParameterValue?.additionalData! : {};
        this._queryString = searchQueryParameterValue?.queryString;
    };
    /**
