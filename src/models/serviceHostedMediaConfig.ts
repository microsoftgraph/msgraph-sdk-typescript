import {CommunicationsMember1, MediaConfig, MediaInfo} from './index';
import {Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class ServiceHostedMediaConfig extends MediaConfig implements Parsable {
    /** The list of media to pre-fetch. */
    private _preFetchMedia?: MediaInfo | CommunicationsMember1[] | undefined;
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "preFetchMedia": n => { this.preFetchMedia = n.getObjectValue<MediaInfo>(createMediaInfoFromDiscriminatorValue); },
        };
    };
    /**
     ...
     */
    public set preFetchMedia(value: MediaInfo | CommunicationsMember1[] | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<MediaInfo>("preFetchMedia", this.preFetchMedia);
    };
}
