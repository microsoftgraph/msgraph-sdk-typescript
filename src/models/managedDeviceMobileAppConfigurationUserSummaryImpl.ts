...
export class ManagedDeviceMobileAppConfigurationUserSummaryImpl extends EntityImpl implements ManagedDeviceMobileAppConfigurationUserSummary {
    ...
    public constructor(managedDeviceMobileAppConfigurationUserSummaryParameterValue?: ManagedDeviceMobileAppConfigurationUserSummary | undefined) {
        ...
        this._configurationVersion = managedDeviceMobileAppConfigurationUserSummaryParameterValue?.configurationVersion;
        this._errorCount = managedDeviceMobileAppConfigurationUserSummaryParameterValue?.errorCount;
        this._failedCount = managedDeviceMobileAppConfigurationUserSummaryParameterValue?.failedCount;
        this._lastUpdateDateTime = managedDeviceMobileAppConfigurationUserSummaryParameterValue?.lastUpdateDateTime;
        this._notApplicableCount = managedDeviceMobileAppConfigurationUserSummaryParameterValue?.notApplicableCount;
        this._pendingCount = managedDeviceMobileAppConfigurationUserSummaryParameterValue?.pendingCount;
        this._successCount = managedDeviceMobileAppConfigurationUserSummaryParameterValue?.successCount;
    };
    /**
