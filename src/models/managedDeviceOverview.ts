...
export class ManagedDeviceOverview extends Entity implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "deviceExchangeAccessStateSummary": n => { this.deviceExchangeAccessStateSummary = n.getObjectValue<DeviceExchangeAccessStateSummary>(createDeviceExchangeAccessStateSummaryFromDiscriminatorValue); },
            "deviceOperatingSystemSummary": n => { this.deviceOperatingSystemSummary = n.getObjectValue<DeviceOperatingSystemSummary>(createDeviceOperatingSystemSummaryFromDiscriminatorValue); },
