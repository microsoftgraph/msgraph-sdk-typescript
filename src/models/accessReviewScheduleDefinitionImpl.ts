...
export class AccessReviewScheduleDefinitionImpl extends EntityImpl implements AccessReviewScheduleDefinition, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.additionalNotificationRecipients){
        const additionalNotificationRecipientsArrValue: AccessReviewNotificationRecipientItemImpl[] = []; this.additionalNotificationRecipients?.forEach(element => {additionalNotificationRecipientsArrValue.push(new AccessReviewNotificationRecipientItemImpl(element));});
        ...
        const fallbackReviewersArrValue: AccessReviewReviewerScopeImpl[] = []; this.fallbackReviewers?.forEach(element => {fallbackReviewersArrValue.push(new AccessReviewReviewerScopeImpl(element));});
        ...
        if(this.instances){
        const instancesArrValue: AccessReviewInstanceImpl[] = []; this.instances?.forEach(element => {instancesArrValue.push(new AccessReviewInstanceImpl(element));});
