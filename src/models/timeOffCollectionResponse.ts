...
export class TimeOffCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as TimeOffCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as TimeOffCollectionResponse).value = n.getCollectionOfObjectValues<TimeOff>(createTimeOffFromDiscriminatorValue); },
        };
    };
    /**
