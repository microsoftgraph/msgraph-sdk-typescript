import {AccessReviewInstanceDecisionItemResource, AdminMember1} from './index';
...
export class AccessReviewInstanceDecisionItemAzureRoleResource extends AccessReviewInstanceDecisionItemResource implements Parsable {
    ...
    private _scope?: AccessReviewInstanceDecisionItemResource | AdminMember1 | undefined;
    /**
     ...
     */
    public set scope(value: AccessReviewInstanceDecisionItemResource | AdminMember1 | undefined) {
        this._scope = value;
    };
    /**
