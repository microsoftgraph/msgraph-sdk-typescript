...
export class ExcludeTargetImpl implements ExcludeTarget {
    ...
    public constructor(excludeTargetParameterValue?: ExcludeTarget | undefined) {
        this._additionalData = excludeTargetParameterValue?.additionalData ? excludeTargetParameterValue?.additionalData! : {};
        this._id = excludeTargetParameterValue?.id;
        this._targetType = excludeTargetParameterValue?.targetType;
    };
    /**
