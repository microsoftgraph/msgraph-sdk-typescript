...
export class ApiApplicationImpl implements AdditionalDataHolder, ApiApplication, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.preAuthorizedApplications){
        const preAuthorizedApplicationsArrValue: PreAuthorizedApplicationImpl[] = []; this.preAuthorizedApplications?.forEach(element => {preAuthorizedApplicationsArrValue.push(new PreAuthorizedApplicationImpl(element));});
