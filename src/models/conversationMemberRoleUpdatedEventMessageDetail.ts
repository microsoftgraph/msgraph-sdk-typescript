...
export class ConversationMemberRoleUpdatedEventMessageDetail extends EventMessageDetail implements Parsable {
    ...
    private _conversationMemberUser?: TeamworkUserIdentity | AdminMember1 | undefined;
     ...
     */
    public set conversationMemberUser(value: TeamworkUserIdentity | AdminMember1 | undefined) {
