...
export function serializeEducationFeedbackOutcome(educationFeedbackOutcome: EducationFeedbackOutcome | undefined = {} as EducationFeedbackOutcome, writer: SerializationWriter) : void {
