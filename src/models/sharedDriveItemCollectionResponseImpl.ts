...
export class SharedDriveItemCollectionResponseImpl implements SharedDriveItemCollectionResponse {
    ...
    public constructor(sharedDriveItemCollectionResponseParameterValue?: SharedDriveItemCollectionResponse | undefined) {
        this._additionalData = sharedDriveItemCollectionResponseParameterValue?.additionalData ? sharedDriveItemCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = sharedDriveItemCollectionResponseParameterValue?.nextLink;
        this._value = sharedDriveItemCollectionResponseParameterValue?.value;
    };
    /**
     ...
     * @returns a SharedDriveItemInterface
     */
    public get value() {
        return this._value;
    };
