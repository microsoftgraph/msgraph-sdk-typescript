...
export class AttendanceRecordImpl extends EntityImpl implements AttendanceRecord {
    ...
    public constructor(attendanceRecordParameterValue?: AttendanceRecord | undefined) {
        ...
        const attendanceIntervalsArrValue: AttendanceIntervalImpl[] = []; this.attendanceIntervals?.forEach(element => {attendanceIntervalsArrValue.push(element instanceof AttendanceIntervalImpl? element : new AttendanceIntervalImpl(element));});
