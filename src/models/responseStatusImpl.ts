...
export class ResponseStatusImpl implements ResponseStatus {
    ...
    public constructor(responseStatusParameterValue?: ResponseStatus | undefined) {
        this._additionalData = responseStatusParameterValue?.additionalData ? responseStatusParameterValue?.additionalData! : {};
        this._response = responseStatusParameterValue?.response;
        this._time = responseStatusParameterValue?.time;
    };
    /**
