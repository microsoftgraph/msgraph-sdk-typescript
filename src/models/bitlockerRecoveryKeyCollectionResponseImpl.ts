...
export class BitlockerRecoveryKeyCollectionResponseImpl implements BitlockerRecoveryKeyCollectionResponse {
    ...
    /** The value property */
    public value?: BitlockerRecoveryKey[] | undefined;
    /**
    ...
    public constructor(bitlockerRecoveryKeyCollectionResponseParameterValue?: BitlockerRecoveryKeyCollectionResponse | undefined) {
        ...
        const valueArrValue: BitlockerRecoveryKeyImpl[] = []; this.value?.forEach(element => {valueArrValue.push(element instanceof BitlockerRecoveryKeyImpl? element : new BitlockerRecoveryKeyImpl(element));});
