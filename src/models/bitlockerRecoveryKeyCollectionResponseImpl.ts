...
export class BitlockerRecoveryKeyCollectionResponseImpl implements BitlockerRecoveryKeyCollectionResponse {
    ...
    public constructor(bitlockerRecoveryKeyCollectionResponseParameterValue?: BitlockerRecoveryKeyCollectionResponse | undefined) {
        this._additionalData = bitlockerRecoveryKeyCollectionResponseParameterValue?.additionalData ? bitlockerRecoveryKeyCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = bitlockerRecoveryKeyCollectionResponseParameterValue?.nextLink;
        this._value = bitlockerRecoveryKeyCollectionResponseParameterValue?.value;
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "value": n => { this.value = n.getCollectionOfObjectValues<BitlockerRecoveryKeyImpl>(createBitlockerRecoveryKeyFromDiscriminatorValue); },
        };
    };
    /**
