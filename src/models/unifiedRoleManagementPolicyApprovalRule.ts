import {AdminMember1, ApprovalSettings, UnifiedRoleManagementPolicyRule} from './index';
...
export class UnifiedRoleManagementPolicyApprovalRule extends UnifiedRoleManagementPolicyRule implements Parsable {
    ...
    private _setting?: ApprovalSettings | AdminMember1 | undefined;
    /**
     ...
     */
    public set setting(value: ApprovalSettings | AdminMember1 | undefined) {
        this._setting = value;
    };
}
