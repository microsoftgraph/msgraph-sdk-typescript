import {AdminMember1, EducationFeedback, EducationOutcome} from './index';
...
export class EducationFeedbackOutcome extends EducationOutcome implements Parsable {
    ...
    private _feedback?: EducationFeedback | AdminMember1 | undefined;
    /** A copy of the feedback property that is made when the grade is released to the student. */
    private _publishedFeedback?: EducationFeedback | AdminMember1 | undefined;
    /**
     ...
     */
    public set feedback(value: EducationFeedback | AdminMember1 | undefined) {
     ...
     */
    public set publishedFeedback(value: EducationFeedback | AdminMember1 | undefined) {
