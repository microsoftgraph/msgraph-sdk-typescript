...
export class InternalDomainFederationImpl extends SamlOrWsFedProviderImpl implements InternalDomainFederation {
    ...
    public constructor(internalDomainFederationParameterValue?: InternalDomainFederation | undefined) {
        ...
        this._activeSignInUri = internalDomainFederationParameterValue?.activeSignInUri;
        this._federatedIdpMfaBehavior = internalDomainFederationParameterValue?.federatedIdpMfaBehavior;
        this._isSignedAuthenticationRequestRequired = internalDomainFederationParameterValue?.isSignedAuthenticationRequestRequired;
        this._nextSigningCertificate = internalDomainFederationParameterValue?.nextSigningCertificate;
        this._promptLoginBehavior = internalDomainFederationParameterValue?.promptLoginBehavior;
        this._signingCertificateUpdateStatus = internalDomainFederationParameterValue?.signingCertificateUpdateStatus;
        this._signOutUri = internalDomainFederationParameterValue?.signOutUri;
    };
    /**
     ...
     * @returns a SigningCertificateUpdateStatusInterface
     */
