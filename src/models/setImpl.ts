...
import {Set} from './set';
import {GroupImpl, LocalizedNameImpl, RelationImpl, TermImpl} from './termStore/';
import {createGroupFromDiscriminatorValue} from './termStore/createGroupFromDiscriminatorValue';
import {createLocalizedNameFromDiscriminatorValue} from './termStore/createLocalizedNameFromDiscriminatorValue';
...
export class SetImpl extends EntityImpl implements Set {
    ...
    public constructor(setParameterValue?: Set | undefined) {
        ...
        this.additionalData = setParameterValue?.additionalData ? setParameterValue?.additionalData! : {};
