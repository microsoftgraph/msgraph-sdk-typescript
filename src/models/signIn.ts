...
export class SignIn extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            ...
            "appliedConditionalAccessPolicies": (o, n) => { (o as unknown as SignIn).appliedConditionalAccessPolicies = n.getCollectionOfObjectValues<AppliedConditionalAccessPolicy>(createAppliedConditionalAccessPolicyFromDiscriminatorValue); },
            ...
            "deviceDetail": (o, n) => { (o as unknown as SignIn).deviceDetail = n.getObjectValue<DeviceDetail>(createDeviceDetailFromDiscriminatorValue); },
            ...
            "location": (o, n) => { (o as unknown as SignIn).location = n.getObjectValue<SignInLocation>(createSignInLocationFromDiscriminatorValue); },
            ...
            "status": (o, n) => { (o as unknown as SignIn).status = n.getObjectValue<SignInStatus>(createSignInStatusFromDiscriminatorValue); },
