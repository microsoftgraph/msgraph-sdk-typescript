...
export class ApplicationImpl extends DirectoryObjectImpl implements Application, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        const extensionPropertiesArrValue: ExtensionPropertyImpl[] = []; this.extensionProperties?.forEach(element => {extensionPropertiesArrValue.push(new ExtensionPropertyImpl(element));});
        ...
        if(this.requiredResourceAccess){
        const requiredResourceAccessArrValue: RequiredResourceAccessImpl[] = []; this.requiredResourceAccess?.forEach(element => {requiredResourceAccessArrValue.push(new RequiredResourceAccessImpl(element));});
