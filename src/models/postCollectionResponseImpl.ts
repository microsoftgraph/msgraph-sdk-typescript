...
export class PostCollectionResponseImpl implements PostCollectionResponse {
    ...
    public constructor(postCollectionResponseParameterValue?: PostCollectionResponse | undefined) {
        this._additionalData = postCollectionResponseParameterValue?.additionalData ? postCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = postCollectionResponseParameterValue?.nextLink;
        this._value = postCollectionResponseParameterValue?.value;
    };
    /**
