...
export class IdentityUserFlowAttributeAssignmentCollectionResponseImpl implements AdditionalDataHolder, IdentityUserFlowAttributeAssignmentCollectionResponse, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.value){
        const valueArrValue: IdentityUserFlowAttributeAssignmentImpl[] = []; this.value?.forEach(element => {valueArrValue.push(new IdentityUserFlowAttributeAssignmentImpl(element));});
