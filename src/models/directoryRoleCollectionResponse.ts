...
export class DirectoryRoleCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as DirectoryRoleCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as DirectoryRoleCollectionResponse).value = n.getCollectionOfObjectValues<DirectoryRole>(createDirectoryRoleFromDiscriminatorValue); },
        };
    };
    /**
