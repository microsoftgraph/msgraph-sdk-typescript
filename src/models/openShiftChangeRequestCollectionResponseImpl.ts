...
export class OpenShiftChangeRequestCollectionResponseImpl implements OpenShiftChangeRequestCollectionResponse {
    ...
    public constructor(openShiftChangeRequestCollectionResponseParameterValue?: OpenShiftChangeRequestCollectionResponse | undefined) {
        this._additionalData = openShiftChangeRequestCollectionResponseParameterValue?.additionalData ? openShiftChangeRequestCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = openShiftChangeRequestCollectionResponseParameterValue?.nextLink;
        this._value = openShiftChangeRequestCollectionResponseParameterValue?.value;
    };
    /**
