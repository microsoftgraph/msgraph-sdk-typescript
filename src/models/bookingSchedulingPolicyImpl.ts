...
export class BookingSchedulingPolicyImpl implements BookingSchedulingPolicy {
    ...
    public constructor(bookingSchedulingPolicyParameterValue?: BookingSchedulingPolicy | undefined) {
        this._additionalData = bookingSchedulingPolicyParameterValue?.additionalData ? bookingSchedulingPolicyParameterValue?.additionalData! : {};
        this._allowStaffSelection = bookingSchedulingPolicyParameterValue?.allowStaffSelection;
        this._maximumAdvance = bookingSchedulingPolicyParameterValue?.maximumAdvance;
        this._minimumLeadTime = bookingSchedulingPolicyParameterValue?.minimumLeadTime;
        this._sendConfirmationsToOwner = bookingSchedulingPolicyParameterValue?.sendConfirmationsToOwner;
        this._timeSlotInterval = bookingSchedulingPolicyParameterValue?.timeSlotInterval;
    };
    /**
