...
export class IosGeneralDeviceConfigurationImpl extends DeviceConfigurationImpl implements IosGeneralDeviceConfiguration {
    ...
    public constructor(iosGeneralDeviceConfigurationParameterValue?: IosGeneralDeviceConfiguration | undefined) {
        ...
        const appsSingleAppModeListArrValue: AppListItemImpl[] = []; this.appsSingleAppModeList?.forEach(element => {appsSingleAppModeListArrValue.push(element instanceof AppListItemImpl? element : new AppListItemImpl(element));});
        ...
        const appsVisibilityListArrValue: AppListItemImpl[] = []; this.appsVisibilityList?.forEach(element => {appsVisibilityListArrValue.push(element instanceof AppListItemImpl? element : new AppListItemImpl(element));});
        ...
        const networkUsageRulesArrValue: IosNetworkUsageRuleImpl[] = []; this.networkUsageRules?.forEach(element => {networkUsageRulesArrValue.push(element instanceof IosNetworkUsageRuleImpl? element : new IosNetworkUsageRuleImpl(element));});
