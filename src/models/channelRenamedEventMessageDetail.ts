...
export class ChannelRenamedEventMessageDetail extends EventMessageDetail implements Parsable {
    ...
    public constructor() {
        super();
        this.odataType = "#microsoft.graph.channelRenamedEventMessageDetail";
    };
    /**
