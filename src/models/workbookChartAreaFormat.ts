...
export class WorkbookChartAreaFormat extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            "fill": (o, n) => { (o as unknown as WorkbookChartAreaFormat).fill = n.getObjectValue<WorkbookChartFill>(createWorkbookChartFillFromDiscriminatorValue); },
            "font": (o, n) => { (o as unknown as WorkbookChartAreaFormat).font = n.getObjectValue<WorkbookChartFont>(createWorkbookChartFontFromDiscriminatorValue); },
        };
    };
    /**
