...
export class OAuth2PermissionGrantCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as OAuth2PermissionGrantCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as OAuth2PermissionGrantCollectionResponse).value = n.getCollectionOfObjectValues<OAuth2PermissionGrant>(createOAuth2PermissionGrantFromDiscriminatorValue); },
        };
    };
    /**
