...
export class AccessReviewReviewerImpl extends EntityImpl implements AccessReviewReviewer {
    ...
    public constructor(accessReviewReviewerParameterValue?: AccessReviewReviewer | undefined) {
        ...
        this._createdDateTime = accessReviewReviewerParameterValue?.createdDateTime;
        this._displayName = accessReviewReviewerParameterValue?.displayName;
        this._userPrincipalName = accessReviewReviewerParameterValue?.userPrincipalName;
    };
    /**
