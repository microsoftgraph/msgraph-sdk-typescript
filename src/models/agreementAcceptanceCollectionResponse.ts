...
export class AgreementAcceptanceCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as AgreementAcceptanceCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as AgreementAcceptanceCollectionResponse).value = n.getCollectionOfObjectValues<AgreementAcceptance>(createAgreementAcceptanceFromDiscriminatorValue); },
        };
    };
    /**
