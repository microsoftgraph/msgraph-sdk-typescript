...
export class UserActivityCollectionResponseImpl implements UserActivityCollectionResponse {
    ...
    public constructor(userActivityCollectionResponseParameterValue?: UserActivityCollectionResponse | undefined) {
        this._additionalData = userActivityCollectionResponseParameterValue?.additionalData ? userActivityCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = userActivityCollectionResponseParameterValue?.nextLink;
        this._value = userActivityCollectionResponseParameterValue?.value;
    };
    /**
