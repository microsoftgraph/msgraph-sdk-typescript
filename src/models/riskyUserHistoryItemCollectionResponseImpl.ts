...
export class RiskyUserHistoryItemCollectionResponseImpl implements RiskyUserHistoryItemCollectionResponse {
    ...
    public constructor(riskyUserHistoryItemCollectionResponseParameterValue?: RiskyUserHistoryItemCollectionResponse | undefined) {
        this._additionalData = riskyUserHistoryItemCollectionResponseParameterValue?.additionalData ? riskyUserHistoryItemCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = riskyUserHistoryItemCollectionResponseParameterValue?.nextLink;
        this._value = riskyUserHistoryItemCollectionResponseParameterValue?.value;
    };
    /**
