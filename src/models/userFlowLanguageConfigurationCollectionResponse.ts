...
export class UserFlowLanguageConfigurationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as UserFlowLanguageConfigurationCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as UserFlowLanguageConfigurationCollectionResponse).value = n.getCollectionOfObjectValues<UserFlowLanguageConfiguration>(createUserFlowLanguageConfigurationFromDiscriminatorValue); },
        };
    };
    /**
