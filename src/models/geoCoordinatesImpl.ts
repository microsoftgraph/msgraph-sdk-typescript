...
export class GeoCoordinatesImpl implements GeoCoordinates {
    ...
    public constructor(geoCoordinatesParameterValue?: GeoCoordinates | undefined) {
        this._additionalData = geoCoordinatesParameterValue?.additionalData ? geoCoordinatesParameterValue?.additionalData! : {};
        this._altitude = geoCoordinatesParameterValue?.altitude;
        this._latitude = geoCoordinatesParameterValue?.latitude;
        this._longitude = geoCoordinatesParameterValue?.longitude;
    };
    /**
