import {AdminMember1, CalendarSharingMessageAction, Message} from './index';
...
export class CalendarSharingMessage extends Message implements Parsable {
    ...
    private _sharingMessageAction?: CalendarSharingMessageAction | AdminMember1 | undefined;
    /** The sharingMessageActions property */
    private _sharingMessageActions?: CalendarSharingMessageAction | AdminMember1[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "sharingMessageActions": n => { this.sharingMessageActions = n.getObjectValue<CalendarSharingMessageAction>(createCalendarSharingMessageActionFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<CalendarSharingMessageAction>("sharingMessageActions", this.sharingMessageActions);
     ...
     */
    public set sharingMessageAction(value: CalendarSharingMessageAction | AdminMember1 | undefined) {
     ...
     */
    public set sharingMessageActions(value: CalendarSharingMessageAction | AdminMember1[] | undefined) {
