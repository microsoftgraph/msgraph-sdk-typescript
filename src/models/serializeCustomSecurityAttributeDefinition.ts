...
export function serializeCustomSecurityAttributeDefinition(customSecurityAttributeDefinition: CustomSecurityAttributeDefinition | undefined = {} as CustomSecurityAttributeDefinition, writer: SerializationWriter) : void {
