...
export class EducationUserCollectionResponseImpl implements EducationUserCollectionResponse {
    ...
    public constructor(educationUserCollectionResponseParameterValue?: EducationUserCollectionResponse | undefined) {
        this._additionalData = educationUserCollectionResponseParameterValue?.additionalData ? educationUserCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = educationUserCollectionResponseParameterValue?.nextLink;
        this._value = educationUserCollectionResponseParameterValue?.value;
    };
    /**
