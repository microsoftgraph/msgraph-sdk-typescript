...
export class UserScopeTeamsAppInstallationCollectionResponseImpl implements UserScopeTeamsAppInstallationCollectionResponse {
    ...
    public constructor(userScopeTeamsAppInstallationCollectionResponseParameterValue?: UserScopeTeamsAppInstallationCollectionResponse | undefined) {
        this._additionalData = userScopeTeamsAppInstallationCollectionResponseParameterValue?.additionalData ? userScopeTeamsAppInstallationCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = userScopeTeamsAppInstallationCollectionResponseParameterValue?.nextLink;
        this._value = userScopeTeamsAppInstallationCollectionResponseParameterValue?.value;
    };
    /**
