...
export class SiteImpl extends BaseItemImpl implements Site {
    ...
    public constructor(siteParameterValue?: Site | undefined) {
        ...
        const contentTypesArrValue: ContentTypeImpl[] = []; this.contentTypes?.forEach(element => {contentTypesArrValue.push(element instanceof ContentTypeImpl? element : new ContentTypeImpl(element));});
        ...
        const externalColumnsArrValue: ColumnDefinitionImpl[] = []; this.externalColumns?.forEach(element => {externalColumnsArrValue.push(element instanceof ColumnDefinitionImpl? element : new ColumnDefinitionImpl(element));});
        this.externalColumns = externalColumnsArrValue;
        const itemsArrValue: BaseItemImpl[] = []; this.items?.forEach(element => {itemsArrValue.push(element instanceof BaseItemImpl? element : new BaseItemImpl(element));});
        this.items = itemsArrValue;
        const listsArrValue: ListImpl[] = []; this.lists?.forEach(element => {listsArrValue.push(element instanceof ListImpl? element : new ListImpl(element));});
        ...
        const operationsArrValue: RichLongRunningOperationImpl[] = []; this.operations?.forEach(element => {operationsArrValue.push(element instanceof RichLongRunningOperationImpl? element : new RichLongRunningOperationImpl(element));});
        ...
        const termStoresArrValue: StoreImpl[] = []; this.termStores?.forEach(element => {termStoresArrValue.push(element instanceof StoreImpl? element : new StoreImpl(element));});
