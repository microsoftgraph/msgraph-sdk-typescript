...
export class DeviceImpl extends DirectoryObjectImpl implements Device, Parsable {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        if(this.alternativeSecurityIds){
        const alternativeSecurityIdsArrValue: AlternativeSecurityIdImpl[] = []; this.alternativeSecurityIds?.forEach(element => {alternativeSecurityIdsArrValue.push(new AlternativeSecurityIdImpl(element));});
        ...
        if(this.registeredOwners){
        const registeredOwnersArrValue: DirectoryObjectImpl[] = []; this.registeredOwners?.forEach(element => {registeredOwnersArrValue.push(new DirectoryObjectImpl(element));});
        ...
        const registeredUsersArrValue: DirectoryObjectImpl[] = []; this.registeredUsers?.forEach(element => {registeredUsersArrValue.push(new DirectoryObjectImpl(element));});
