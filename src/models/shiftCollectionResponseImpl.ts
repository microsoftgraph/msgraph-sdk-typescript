...
export class ShiftCollectionResponseImpl implements ShiftCollectionResponse {
    ...
    public constructor(shiftCollectionResponseParameterValue?: ShiftCollectionResponse | undefined) {
        this._additionalData = shiftCollectionResponseParameterValue?.additionalData ? shiftCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = shiftCollectionResponseParameterValue?.nextLink;
        this._value = shiftCollectionResponseParameterValue?.value;
    };
    /**
