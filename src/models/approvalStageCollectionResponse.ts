...
export class ApprovalStageCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as ApprovalStageCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as ApprovalStageCollectionResponse).value = n.getCollectionOfObjectValues<ApprovalStage>(createApprovalStageFromDiscriminatorValue); },
        };
    };
    /**
