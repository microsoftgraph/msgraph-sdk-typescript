import {AdminMember1, DaylightTimeZoneOffset, StandardTimeZoneOffset, TimeZoneBase} from './index';
...
export class CustomTimeZone extends TimeZoneBase implements Parsable {
    ...
    private _daylightOffset?: DaylightTimeZoneOffset | AdminMember1 | undefined;
    /** Specifies when the time zone switches from daylight saving time to standard time. */
    private _standardOffset?: StandardTimeZoneOffset | AdminMember1 | undefined;
    /**
     ...
     */
    public set daylightOffset(value: DaylightTimeZoneOffset | AdminMember1 | undefined) {
     ...
     */
    public set standardOffset(value: StandardTimeZoneOffset | AdminMember1 | undefined) {
