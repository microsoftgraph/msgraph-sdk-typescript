...
export class InvitationImpl extends EntityImpl implements Invitation {
    ...
    public constructor(invitationParameterValue?: Invitation | undefined) {
        ...
        this._invitedUser = invitationParameterValue?.invitedUser;
        this._invitedUserDisplayName = invitationParameterValue?.invitedUserDisplayName;
        this._invitedUserEmailAddress = invitationParameterValue?.invitedUserEmailAddress;
        this._invitedUserMessageInfo = invitationParameterValue?.invitedUserMessageInfo;
        this._invitedUserType = invitationParameterValue?.invitedUserType;
        this._inviteRedeemUrl = invitationParameterValue?.inviteRedeemUrl;
        this._inviteRedirectUrl = invitationParameterValue?.inviteRedirectUrl;
        this._sendInvitationMessage = invitationParameterValue?.sendInvitationMessage;
        this._status = invitationParameterValue?.status;
    };
    /**
     ...
     * @returns a InvitedUserMessageInfoInterface
     */
