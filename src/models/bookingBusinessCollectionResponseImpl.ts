...
export class BookingBusinessCollectionResponseImpl implements BookingBusinessCollectionResponse {
    ...
    public constructor(bookingBusinessCollectionResponseParameterValue?: BookingBusinessCollectionResponse | undefined) {
        this._additionalData = bookingBusinessCollectionResponseParameterValue?.additionalData ? bookingBusinessCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = bookingBusinessCollectionResponseParameterValue?.nextLink;
        this._value = bookingBusinessCollectionResponseParameterValue?.value;
    };
    /**
