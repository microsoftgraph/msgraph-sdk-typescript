...
import {ApplicationsMember1, CrossTenantAccessPolicyConfigurationDefault, CrossTenantAccessPolicyConfigurationPartner, PolicyBase} from './index';
import {Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class CrossTenantAccessPolicy extends PolicyBase implements Parsable {
    /** Defines the default configuration for how your organization interacts with external Azure Active Directory organizations. */
    private _default_escaped?: CrossTenantAccessPolicyConfigurationDefault | ApplicationsMember1 | undefined;
     ...
     */
    public set default_escaped(value: CrossTenantAccessPolicyConfigurationDefault | ApplicationsMember1 | undefined) {
