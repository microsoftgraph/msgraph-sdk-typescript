...
export class PreAuthorizedApplicationImpl implements PreAuthorizedApplication {
    ...
    public constructor(preAuthorizedApplicationParameterValue?: PreAuthorizedApplication | undefined) {
        this._additionalData = preAuthorizedApplicationParameterValue?.additionalData ? preAuthorizedApplicationParameterValue?.additionalData! : {};
        this._appId = preAuthorizedApplicationParameterValue?.appId;
        this._delegatedPermissionIds = preAuthorizedApplicationParameterValue?.delegatedPermissionIds;
    };
    /**
