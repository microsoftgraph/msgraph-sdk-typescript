...
export function serializeAttributeDefinition(writer: SerializationWriter, attributeDefinition: AttributeDefinition | undefined = {} as AttributeDefinition) : void {
        ...
        writer.writeCollectionOfObjectValues<StringKeyStringValuePair>("apiExpressions", attributeDefinition.apiExpressions, );
        ...
        writer.writeCollectionOfObjectValues<AttributeDefinitionMetadataEntry>("metadata", attributeDefinition.metadata, );
        ...
        writer.writeCollectionOfObjectValues<ReferencedObject>("referencedObjects", attributeDefinition.referencedObjects, );
