...
export class TimeRangeImpl implements TimeRange {
    ...
    public constructor(timeRangeParameterValue?: TimeRange | undefined) {
        this._additionalData = timeRangeParameterValue?.additionalData ? timeRangeParameterValue?.additionalData! : {};
        this._endTime = timeRangeParameterValue?.endTime;
        this._startTime = timeRangeParameterValue?.startTime;
    };
    /**
