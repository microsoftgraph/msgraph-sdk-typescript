...
export class DeviceComplianceDeviceOverviewImpl extends EntityImpl implements DeviceComplianceDeviceOverview {
    ...
    public constructor(deviceComplianceDeviceOverviewParameterValue?: DeviceComplianceDeviceOverview | undefined) {
        ...
        this._configurationVersion = deviceComplianceDeviceOverviewParameterValue?.configurationVersion;
        this._errorCount = deviceComplianceDeviceOverviewParameterValue?.errorCount;
        this._failedCount = deviceComplianceDeviceOverviewParameterValue?.failedCount;
        this._lastUpdateDateTime = deviceComplianceDeviceOverviewParameterValue?.lastUpdateDateTime;
        this._notApplicableCount = deviceComplianceDeviceOverviewParameterValue?.notApplicableCount;
        this._pendingCount = deviceComplianceDeviceOverviewParameterValue?.pendingCount;
        this._successCount = deviceComplianceDeviceOverviewParameterValue?.successCount;
    };
    /**
