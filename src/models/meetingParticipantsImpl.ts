...
export class MeetingParticipantsImpl implements MeetingParticipants {
    ...
    public constructor(meetingParticipantsParameterValue?: MeetingParticipants | undefined) {
        ...
        const attendeesArrValue: MeetingParticipantInfoImpl[] = []; this.attendees?.forEach(element => {attendeesArrValue.push(element instanceof MeetingParticipantInfoImpl? element : new MeetingParticipantInfoImpl(element));});
