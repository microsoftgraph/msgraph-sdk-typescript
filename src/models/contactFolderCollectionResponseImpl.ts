...
export class ContactFolderCollectionResponseImpl implements ContactFolderCollectionResponse {
    ...
    public constructor(contactFolderCollectionResponseParameterValue?: ContactFolderCollectionResponse | undefined) {
        this._additionalData = contactFolderCollectionResponseParameterValue?.additionalData ? contactFolderCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = contactFolderCollectionResponseParameterValue?.nextLink;
        this._value = contactFolderCollectionResponseParameterValue?.value;
    };
    /**
