...
import {AccessPackage, AccessPackageAssignment, AccessPackageAssignmentPolicy, AccessPackageAssignmentRequest, AccessPackageCatalog, AccessPackageSubject, AccessReviewHistoryDefinition, AccessReviewHistoryInstance, AccessReviewInstance, AccessReviewInstanceDecisionItem, AccessReviewReviewer, AccessReviewScheduleDefinition, AccessReviewSet, AccessReviewStage, ActivityHistoryItem, AdminConsentRequestPolicy, Agreement, AgreementAcceptance, AgreementFileProperties, Alert, AppCatalogs, AppConsentApprovalRoute, AppConsentRequest, ApplePushNotificationCertificate, ApplicationTemplate, Approval, ApprovalStage, AppScope, Attachment, AttendanceRecord, AudioRoutingGroup, AuditLogRoot, Authentication, AuthenticationFlowsPolicy, AuthenticationMethod, AuthenticationMethodConfiguration, AuthenticationMethodsPolicy, AuthenticationMethodTarget, AuthoredNote, BaseItem, BaseItemVersion, Bitlocker, BitlockerRecoveryKey, BookingAppointment, BookingBusiness, BookingCurrency, BookingCustomerBase, BookingCustomQuestion, BookingService, BookingStaffMemberBase, Calendar, CalendarGroup, CalendarPermission, Call, CertificateBasedAuthConfiguration, ChangeTrackedEntity, Channel, Chat, ChatMessage, ChecklistItem, CloudCommunications, ColumnDefinition, ColumnLink, CommsOperation, ComplianceManagementPartner, ConditionalAccessPolicy, ConditionalAccessRoot, ConnectedOrganization, ContactFolder, ContentType, Conversation, ConversationMember, ConversationThread, CrossTenantAccessPolicyConfigurationDefault, DataPolicyOperation, DelegatedPermissionClassification, DetectedApp, DeviceAppManagement, DeviceCategory, DeviceComplianceActionItem, DeviceComplianceDeviceOverview, DeviceComplianceDeviceStatus, DeviceCompliancePolicy, DeviceCompliancePolicyAssignment, DeviceCompliancePolicyDeviceStateSummary, DeviceCompliancePolicySettingStateSummary, DeviceCompliancePolicyState, DeviceComplianceScheduledActionForRule, DeviceComplianceSettingState, DeviceComplianceUserOverview, DeviceComplianceUserStatus, DeviceConfiguration, DeviceConfigurationAssignment, DeviceConfigurationDeviceOverview, DeviceConfigurationDeviceStateSummary, DeviceConfigurationDeviceStatus, DeviceConfigurationState, DeviceConfigurationUserOverview, DeviceConfigurationUserStatus, DeviceEnrollmentConfiguration, DeviceInstallState, DeviceManagement, DeviceManagementExchangeConnector, DeviceManagementExportJob, DeviceManagementPartner, DeviceManagementReports, DeviceManagementTroubleshootingEvent, Directory, DirectoryAudit, DirectoryObject, Domain, DomainDnsRecord, EBookInstallSummary, EducationAssignment, EducationAssignmentDefaults, EducationAssignmentResource, EducationAssignmentSettings, EducationCategory, EducationClass, EducationOrganization, EducationOutcome, EducationRubric, EducationSubmission, EducationSubmissionResource, EducationUser, EnrollmentConfigurationAssignment, EntitlementManagement, EntitlementManagementSettings, Entity, Extension, ExternalDomainName, FeatureRolloutPolicy, FederatedIdentityCredential, FieldValueSet, GroupLifecyclePolicy, GroupSetting, IdentityApiConnector, IdentityContainer, IdentityProvider, IdentityProviderBase, IdentityUserFlow, IdentityUserFlowAttribute, IdentityUserFlowAttributeAssignment, ImportedWindowsAutopilotDeviceIdentity, ImportedWindowsAutopilotDeviceIdentityUpload, InferenceClassification, InferenceClassificationOverride, InformationProtection, Invitation, IosUpdateDeviceStatus, ItemActivity, ItemActivityStat, ItemAnalytics, LicenseDetails, LinkedResource, LocalizedNotificationMessage, LongRunningOperation, MailFolder, ManagedAppOperation, ManagedAppPolicy, ManagedAppPolicyDeploymentSummary, ManagedAppRegistration, ManagedAppStatus, ManagedDevice, ManagedDeviceMobileAppConfiguration, ManagedDeviceMobileAppConfigurationAssignment, ManagedDeviceMobileAppConfigurationDeviceStatus, ManagedDeviceMobileAppConfigurationDeviceSummary, ManagedDeviceMobileAppConfigurationUserStatus, ManagedDeviceMobileAppConfigurationUserSummary, ManagedDeviceOverview, ManagedEBook, ManagedEBookAssignment, ManagedMobileApp, MeetingAttendanceReport, MessageRule, MobileApp, MobileAppAssignment, MobileAppCategory, MobileAppContent, MobileAppContentFile, MobileThreatDefenseConnector, MultiValueLegacyExtendedProperty, NamedLocation, NotificationMessageTemplate, OAuth2PermissionGrant, OfficeGraphInsights, Onenote, OnenoteEntityBaseModel, OnlineMeeting, OnPremisesConditionalAccessSettings, Operation, OrganizationalBrandingProperties, OutlookCategory, OutlookItem, OutlookUser, Participant, ParticipantJoiningNotification, ParticipantLeftNotification, Permission, PermissionGrantConditionSet, Person, Place, Planner, PlannerAssignedToTaskBoardTaskFormat, PlannerBucket, PlannerBucketTaskBoardTaskFormat, PlannerGroup, PlannerPlan, PlannerPlanDetails, PlannerProgressTaskBoardTaskFormat, PlannerTask, PlannerTaskDetails, PlannerUser, PolicyRoot, Presence, PrintConnector, PrintDocument, PrinterBase, PrintJob, PrintOperation, PrintService, PrintServiceEndpoint, PrintTask, PrintTaskDefinition, PrintTaskTrigger, PrintUsage, ProfilePhoto, ProvisioningObjectSummary, RbacApplication, RemoteAssistancePartner, ReportRoot, Request, ResourceOperation, RiskDetection, RiskyUser, RoleAssignment, RoleDefinition, Schedule, SchemaExtension, ScopedRoleMembership, SearchEntity, SecureScore, SecureScoreControlProfile, Security, ServiceAnnouncement, ServiceAnnouncementAttachment, ServiceAnnouncementBase, ServiceHealth, SettingStateDeviceSummary, SharedInsight, SignIn, SingleValueLegacyExtendedProperty, SoftwareUpdateStatusSummary, SubjectRightsRequest, SubscribedSku, Subscription, TargetedManagedAppPolicyAssignment, Team, TeamInfo, TeamsApp, TeamsAppDefinition, TeamsAppInstallation, TeamsAsyncOperation, TeamsTab, TeamsTemplate, Teamwork, TeamworkBot, TeamworkHostedContent, TelecomExpenseManagementPartner, TermsAndConditions, TermsAndConditionsAcceptanceStatus, TermsAndConditionsAssignment, TermsOfUseContainer, ThreatAssessmentRequest, ThreatAssessmentResult, ThumbnailSet, Todo, TodoTask, TodoTaskList, Trending, UnifiedRoleAssignment, UnifiedRoleDefinition, UnifiedRoleManagementPolicy, UnifiedRoleManagementPolicyAssignment, UnifiedRoleManagementPolicyRule, UnifiedRoleScheduleBase, UnifiedRoleScheduleInstanceBase, UsedInsight, UserActivity, UserFlowLanguageConfiguration, UserFlowLanguagePage, UserInstallStateSummary, UserSettings, UserTeamwork, VppToken, WindowsAutopilotDeviceIdentity, WindowsInformationProtectionAppLearningSummary, WindowsInformationProtectionAppLockerFile, WindowsInformationProtectionNetworkLearningSummary, Workbook, WorkbookApplication, WorkbookChart, WorkbookChartAreaFormat, WorkbookChartAxes, WorkbookChartAxis, WorkbookChartAxisFormat, WorkbookChartAxisTitle, WorkbookChartAxisTitleFormat, WorkbookChartDataLabelFormat, WorkbookChartDataLabels, WorkbookChartFill, WorkbookChartFont, WorkbookChartGridlines, WorkbookChartGridlinesFormat, WorkbookChartLegend, WorkbookChartLegendFormat, WorkbookChartLineFormat, WorkbookChartPoint, WorkbookChartPointFormat, WorkbookChartSeries, WorkbookChartSeriesFormat, WorkbookChartTitle, WorkbookChartTitleFormat, WorkbookComment, WorkbookCommentReply, WorkbookFilter, WorkbookFormatProtection, WorkbookFunctionResult, WorkbookFunctions, WorkbookNamedItem, WorkbookOperation, WorkbookPivotTable, WorkbookRange, WorkbookRangeBorder, WorkbookRangeFill, WorkbookRangeFont, WorkbookRangeFormat, WorkbookRangeSort, WorkbookRangeView, WorkbookTable, WorkbookTableColumn, WorkbookTableRow, WorkbookTableSort, WorkbookWorksheet, WorkbookWorksheetProtection} from './index';
import {Case_escaped, CaseOperation, CasesRoot, DataSet, DataSource, DataSourceContainer, EdiscoveryCaseSettings, Search, Tag} from './security/';
