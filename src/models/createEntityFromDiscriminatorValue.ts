        ...
        if (mappingValue) {
            switch (mappingValue) {
                ...
                case "#microsoft.graph.group":
                    return new If81e992e90f78336bbfda54d800c09bc303718f03e7e7b76571b58325dc9adad();
