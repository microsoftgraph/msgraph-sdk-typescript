        ...
        if (mappingValue) {
            switch (mappingValue) {
                ...
                case "#microsoft.graph.alert":
                    return new Ifc3dd46d8c20580598e3887e951736840b38f25b65d12c7df595f8b23d2eeae5();
