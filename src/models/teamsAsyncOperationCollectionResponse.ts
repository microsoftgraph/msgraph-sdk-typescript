...
export class TeamsAsyncOperationCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "@odata.nextLink": (o, n) => { (o as unknown as TeamsAsyncOperationCollectionResponse).nextLink = n.getStringValue(); },
            "value": (o, n) => { (o as unknown as TeamsAsyncOperationCollectionResponse).value = n.getCollectionOfObjectValues<TeamsAsyncOperation>(createTeamsAsyncOperationFromDiscriminatorValue); },
        };
    };
    /**
