...
export class MicrosoftAuthenticatorAuthenticationMethodCollectionResponseImpl implements MicrosoftAuthenticatorAuthenticationMethodCollectionResponse {
    ...
    public constructor(microsoftAuthenticatorAuthenticationMethodCollectionResponseParameterValue?: MicrosoftAuthenticatorAuthenticationMethodCollectionResponse | undefined) {
        this._additionalData = microsoftAuthenticatorAuthenticationMethodCollectionResponseParameterValue?.additionalData ? microsoftAuthenticatorAuthenticationMethodCollectionResponseParameterValue?.additionalData! : {};
        this._nextLink = microsoftAuthenticatorAuthenticationMethodCollectionResponseParameterValue?.nextLink;
        this._value = microsoftAuthenticatorAuthenticationMethodCollectionResponseParameterValue?.value;
    };
    /**
