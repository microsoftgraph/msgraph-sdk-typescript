...
import {MicrosoftGraphQueryRequestBuilder} from './microsoftGraphQuery/microsoftGraphQueryRequestBuilder';
...
export class SearchRequestBuilder {
    ...
    public get microsoftGraphQuery(): MicrosoftGraphQueryRequestBuilder {
