...
export class QueryRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["requests", (o, n) => { (o as unknown as QueryRequestBody).requests = n.getCollectionOfObjectValues<SearchRequest>(SearchRequest); }],
        ]);
    };
    /**
