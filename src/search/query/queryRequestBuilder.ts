...
export class QueryRequestBuilder {
    ...
    public post(body: QueryPostRequestBody | undefined, requestConfiguration?: QueryRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<QueryResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<QueryResponse>(requestInfo, createQueryResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
