...
export class QueryRequestBuilder {
    ...
    public post(body: QueryPostRequestBody | undefined, requestConfiguration?: QueryRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<QueryResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<QueryResponseImpl>(requestInfo, createQueryResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
