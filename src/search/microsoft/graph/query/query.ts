...
export class Microsoft.graph.query implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["hitsContainers", (o, n) => { (o as unknown as Microsoft.graph.query).hitsContainers = n.getCollectionOfPrimitiveValues<searchHitsContainer>(); }],
            ["searchTerms", (o, n) => { (o as unknown as Microsoft.graph.query).searchTerms = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
