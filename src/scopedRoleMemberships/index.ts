 ...
 */
export class ScopedRoleMembershipsRequestBuilder extends BaseRequestBuilder<ScopedRoleMembershipsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/scopedRoleMemberships{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ScopedRoleMembershipsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<ScopedRoleMembershipsRequestBuilderGetQueryParameters> | undefined) : Promise<ScopedRoleMembershipCollectionResponse | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<ScopedRoleMembershipsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, scopedRoleMembershipsRequestBuilderGetQueryParametersMapper);
