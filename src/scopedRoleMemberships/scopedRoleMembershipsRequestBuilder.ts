...
import { type ScopedRoleMembershipsRequestBuilderGetRequestConfiguration } from './scopedRoleMembershipsRequestBuilderGetRequestConfiguration';
import { type ScopedRoleMembershipsRequestBuilderPostRequestConfiguration } from './scopedRoleMembershipsRequestBuilderPostRequestConfiguration';
...
export class ScopedRoleMembershipsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: ScopedRoleMembership, requestConfiguration?: ScopedRoleMembershipsRequestBuilderPostRequestConfiguration | undefined) : Promise<ScopedRoleMembership | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: ScopedRoleMembership, requestConfiguration?: ScopedRoleMembershipsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a scopedRoleMembershipsRequestBuilder
     */
    public withUrl(rawUrl: string) : ScopedRoleMembershipsRequestBuilder {
