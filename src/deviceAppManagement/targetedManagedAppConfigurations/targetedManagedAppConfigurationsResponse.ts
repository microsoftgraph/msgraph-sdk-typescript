...
export class TargetedManagedAppConfigurationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TargetedManagedAppConfigurationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TargetedManagedAppConfigurationsResponse).value = n.getCollectionOfObjectValues<TargetedManagedAppConfiguration>(TargetedManagedAppConfiguration); }],
        ]);
    };
    /**
