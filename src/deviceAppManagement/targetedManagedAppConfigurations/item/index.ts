...
import { createTargetedManagedAppConfigurationFromDiscriminatorValue, deserializeIntoTargetedManagedAppConfiguration, serializeTargetedManagedAppConfiguration, type TargetedManagedAppConfiguration } from '../../../models/';
 ...
 */
export class TargetedManagedAppConfigurationItemRequestBuilder extends BaseRequestBuilder<TargetedManagedAppConfigurationItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}{?%24select,%24expand}", (x, y) => new TargetedManagedAppConfigurationItemRequestBuilder(x, y));
    }
    /**
