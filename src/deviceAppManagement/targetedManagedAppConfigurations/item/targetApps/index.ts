...
export function deserializeIntoTargetAppsPostRequestBody(targetAppsPostRequestBody: TargetAppsPostRequestBody | undefined = {} as TargetAppsPostRequestBody) : Record<string, (node: ParseNode) => void> {
    return {
        "appGroupType": n => { targetAppsPostRequestBody.appGroupType = n.getEnumValue<TargetAppsPostRequestBody_appGroupType>(TargetAppsPostRequestBody_appGroupTypeObject); },
...
export function serializeTargetAppsPostRequestBody(writer: SerializationWriter, targetAppsPostRequestBody: TargetAppsPostRequestBody | undefined = {} as TargetAppsPostRequestBody) : void {
    writer.writeEnumValue<TargetAppsPostRequestBody_appGroupType>("appGroupType", targetAppsPostRequestBody.appGroupType);
...
export interface TargetAppsPostRequestBody extends AdditionalDataHolder, Parsable {
     ...
     */
    appGroupType?: TargetAppsPostRequestBody_appGroupType;
    /**
     * The apps property
     */
...
export class TargetAppsRequestBuilder extends BaseRequestBuilder<TargetAppsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}/targetApps", (x, y) => new TargetAppsRequestBuilder(x, y));
    }
    /**
     * Not yet documented
