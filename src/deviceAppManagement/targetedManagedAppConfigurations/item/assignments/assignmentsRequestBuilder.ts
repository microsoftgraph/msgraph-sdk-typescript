import {TargetedManagedAppPolicyAssignmentCollectionResponseImpl, TargetedManagedAppPolicyAssignmentImpl} from '../../../../models/';
...
export class AssignmentsRequestBuilder {
    ...
    public createPostRequestInformation(body: TargetedManagedAppPolicyAssignment | undefined, requestConfiguration?: AssignmentsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new TargetedManagedAppPolicyAssignmentImpl(body)
     ...
     */
    public get(requestConfiguration?: AssignmentsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TargetedManagedAppPolicyAssignmentCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TargetedManagedAppPolicyAssignmentCollectionResponseImpl>(requestInfo, createTargetedManagedAppPolicyAssignmentCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to assignments for deviceAppManagement
     * @param body 
     ...
     */
    public post(body: TargetedManagedAppPolicyAssignment | undefined, requestConfiguration?: AssignmentsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TargetedManagedAppPolicyAssignmentImpl | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        ...
        return this.requestAdapter?.sendAsync<TargetedManagedAppPolicyAssignmentImpl>(requestInfo, createTargetedManagedAppPolicyAssignmentFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
