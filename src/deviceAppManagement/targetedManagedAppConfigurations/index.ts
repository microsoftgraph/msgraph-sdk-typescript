...
import { createTargetedManagedAppConfigurationCollectionResponseFromDiscriminatorValue, createTargetedManagedAppConfigurationFromDiscriminatorValue, deserializeIntoTargetedManagedAppConfiguration, serializeTargetedManagedAppConfiguration, type TargetedManagedAppConfiguration, type TargetedManagedAppConfigurationCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { TargetedManagedAppConfigurationItemRequestBuilder } from './item/';
 ...
 */
export class TargetedManagedAppConfigurationsRequestBuilder extends BaseRequestBuilder<TargetedManagedAppConfigurationsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new TargetedManagedAppConfigurationsRequestBuilder(x, y));
    }
    /**
