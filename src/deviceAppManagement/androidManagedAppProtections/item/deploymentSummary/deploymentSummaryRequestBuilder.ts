...
export class DeploymentSummaryRequestBuilder {
    ...
    public createPatchRequestInformation(body: ManagedAppPolicyDeploymentSummary | undefined, requestConfiguration?: DeploymentSummaryRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const bodyParsable = new ManagedAppPolicyDeploymentSummaryImpl(body)
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: ManagedAppPolicyDeploymentSummaryImpl | undefined, requestConfiguration?: DeploymentSummaryRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
