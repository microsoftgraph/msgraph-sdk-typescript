...
import { createTargetedManagedAppPolicyAssignmentFromDiscriminatorValue, deserializeIntoTargetedManagedAppPolicyAssignment, serializeTargetedManagedAppPolicyAssignment, type TargetedManagedAppPolicyAssignment } from '../../../../../models/';
 ...
 */
export class TargetedManagedAppPolicyAssignmentItemRequestBuilder extends BaseRequestBuilder<TargetedManagedAppPolicyAssignmentItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection%2Did}/assignments/{targetedManagedAppPolicyAssignment%2Did}{?%24select,%24expand}", (x, y) => new TargetedManagedAppPolicyAssignmentItemRequestBuilder(x, y));
    }
    /**
