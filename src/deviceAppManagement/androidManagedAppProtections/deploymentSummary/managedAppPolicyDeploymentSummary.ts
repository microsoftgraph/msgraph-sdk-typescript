...
export class ManagedAppPolicyDeploymentSummary extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["configurationDeploymentSummaryPerApp", (o, n) => { (o as unknown as ManagedAppPolicyDeploymentSummary).configurationDeploymentSummaryPerApp = n.getCollectionOfPrimitiveValues<managedAppPolicyDeploymentSummaryPerApp>(); }],
