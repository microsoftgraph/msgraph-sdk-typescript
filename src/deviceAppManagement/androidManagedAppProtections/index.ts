...
import { createAndroidManagedAppProtectionCollectionResponseFromDiscriminatorValue, createAndroidManagedAppProtectionFromDiscriminatorValue, deserializeIntoAndroidManagedAppProtection, serializeAndroidManagedAppProtection, type AndroidManagedAppProtection, type AndroidManagedAppProtectionCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { AndroidManagedAppProtectionItemRequestBuilder } from './item/';
 ...
 */
export class AndroidManagedAppProtectionsRequestBuilder extends BaseRequestBuilder<AndroidManagedAppProtectionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/androidManagedAppProtections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AndroidManagedAppProtectionsRequestBuilder(x, y));
    }
    /**
