...
export class AndroidManagedAppProtectionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AndroidManagedAppProtectionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AndroidManagedAppProtectionsResponse).value = n.getCollectionOfObjectValues<AndroidManagedAppProtection>(AndroidManagedAppProtection); }],
        ]);
    };
    /**
