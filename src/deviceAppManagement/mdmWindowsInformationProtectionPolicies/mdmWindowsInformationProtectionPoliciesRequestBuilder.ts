...
export class MdmWindowsInformationProtectionPoliciesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<MdmWindowsInformationProtectionPoliciesRequestBuilderGetQueryParameters> | undefined) : Promise<MdmWindowsInformationProtectionPolicyCollectionResponse | undefined> {
     ...
     */
    public post(body: MdmWindowsInformationProtectionPolicy, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<MdmWindowsInformationProtectionPolicy | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<MdmWindowsInformationProtectionPoliciesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, mdmWindowsInformationProtectionPoliciesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: MdmWindowsInformationProtectionPolicy, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
