...
import { createMdmWindowsInformationProtectionPolicyCollectionResponseFromDiscriminatorValue, createMdmWindowsInformationProtectionPolicyFromDiscriminatorValue, deserializeIntoMdmWindowsInformationProtectionPolicy, serializeMdmWindowsInformationProtectionPolicy, type MdmWindowsInformationProtectionPolicy, type MdmWindowsInformationProtectionPolicyCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { MdmWindowsInformationProtectionPolicyItemRequestBuilder } from './item/';
 ...
 */
export class MdmWindowsInformationProtectionPoliciesRequestBuilder extends BaseRequestBuilder<MdmWindowsInformationProtectionPoliciesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mdmWindowsInformationProtectionPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new MdmWindowsInformationProtectionPoliciesRequestBuilder(x, y));
    }
    /**
