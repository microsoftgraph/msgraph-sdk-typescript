...
import { createWindowsInformationProtectionAppLockerFileCollectionResponseFromDiscriminatorValue, createWindowsInformationProtectionAppLockerFileFromDiscriminatorValue, deserializeIntoWindowsInformationProtectionAppLockerFile, serializeWindowsInformationProtectionAppLockerFile, type WindowsInformationProtectionAppLockerFile, type WindowsInformationProtectionAppLockerFileCollectionResponse } from '../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { WindowsInformationProtectionAppLockerFileItemRequestBuilder } from './item/';
 ...
 */
export class ExemptAppLockerFilesRequestBuilder extends BaseRequestBuilder<ExemptAppLockerFilesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy%2Did}/exemptAppLockerFiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new ExemptAppLockerFilesRequestBuilder(x, y));
    }
    /**
