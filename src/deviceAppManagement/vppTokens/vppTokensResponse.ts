...
export class VppTokensResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as VppTokensResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as VppTokensResponse).value = n.getCollectionOfObjectValues<VppToken>(VppToken); }],
        ]);
    };
    /**
