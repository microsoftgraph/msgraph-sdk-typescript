...
import { createVppTokenFromDiscriminatorValue, type VppToken } from '../../../../models/';
 ...
 */
export class SyncLicensesRequestBuilder extends BaseRequestBuilder<SyncLicensesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}/syncLicenses", (x, y) => new SyncLicensesRequestBuilder(x, y));
    }
    /**
