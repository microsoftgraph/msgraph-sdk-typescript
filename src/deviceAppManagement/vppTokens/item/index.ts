...
import { createVppTokenFromDiscriminatorValue, deserializeIntoVppToken, serializeVppToken, type VppToken } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { SyncLicensesRequestBuilder } from './syncLicenses/';
 ...
 */
export class VppTokenItemRequestBuilder extends BaseRequestBuilder<VppTokenItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}{?%24select,%24expand}", (x, y) => new VppTokenItemRequestBuilder(x, y));
    }
    /**
     * Deletes a vppToken.
