...
export class ManagedAppPoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ManagedAppPoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ManagedAppPoliciesResponse).value = n.getCollectionOfObjectValues<ManagedAppPolicy>(ManagedAppPolicy); }],
        ]);
    };
    /**
