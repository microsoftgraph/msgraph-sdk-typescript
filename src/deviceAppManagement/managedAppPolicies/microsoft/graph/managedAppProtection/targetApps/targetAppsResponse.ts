...
export class Microsoft.graph.targetAppsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["apps", (o, n) => { (o as unknown as Microsoft.graph.targetAppsResponse).apps = n.getCollectionOfObjectValues<ManagedMobileApp>(ManagedMobileApp); }],
        ]);
    };
    /**
