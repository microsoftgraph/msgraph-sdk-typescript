 ...
 */
export class ManagedAppPoliciesRequestBuilder extends BaseRequestBuilder<ManagedAppPoliciesRequestBuilder> {
    /**
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<ManagedAppPoliciesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, managedAppPoliciesRequestBuilderGetQueryParametersMapper);
