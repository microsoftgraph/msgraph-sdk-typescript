...
export class WindowsInformationProtectionPolicyItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, windowsInformationProtectionPolicyId?: string | undefined) {
