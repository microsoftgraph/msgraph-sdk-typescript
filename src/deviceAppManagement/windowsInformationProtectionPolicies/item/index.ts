...
import { createWindowsInformationProtectionPolicyFromDiscriminatorValue, deserializeIntoWindowsInformationProtectionPolicy, serializeWindowsInformationProtectionPolicy, type WindowsInformationProtectionPolicy } from '../../../models/';
 ...
 */
export class WindowsInformationProtectionPolicyItemRequestBuilder extends BaseRequestBuilder<WindowsInformationProtectionPolicyItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy%2Did}{?%24select,%24expand}", (x, y) => new WindowsInformationProtectionPolicyItemRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<WindowsInformationProtectionPolicyItemRequestBuilderGetQueryParameters> | undefined) : Promise<WindowsInformationProtectionPolicy | undefined> {
     ...
     */
    public patch(body: WindowsInformationProtectionPolicy, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<WindowsInformationProtectionPolicy | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<WindowsInformationProtectionPolicyItemRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, windowsInformationProtectionPolicyItemRequestBuilderGetQueryParametersMapper);
        requestInfo.headers.tryAdd("Accept", "application/json");
        return requestInfo;
    }
    /**
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: WindowsInformationProtectionPolicy, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
