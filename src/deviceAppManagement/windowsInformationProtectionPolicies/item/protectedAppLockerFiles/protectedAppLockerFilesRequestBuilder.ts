...
export class ProtectedAppLockerFilesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: WindowsInformationProtectionAppLockerFile | undefined, requestConfiguration?: ProtectedAppLockerFilesRequestBuilderPostRequestConfiguration | undefined) : Promise<WindowsInformationProtectionAppLockerFile | undefined> {
