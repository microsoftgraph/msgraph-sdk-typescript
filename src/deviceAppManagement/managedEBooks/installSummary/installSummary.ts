...
export class InstallSummary extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["failedDeviceCount", (o, n) => { (o as unknown as InstallSummary).failedDeviceCount = n.getNumberValue(); }],
            ["failedUserCount", (o, n) => { (o as unknown as InstallSummary).failedUserCount = n.getNumberValue(); }],
            ["installedDeviceCount", (o, n) => { (o as unknown as InstallSummary).installedDeviceCount = n.getNumberValue(); }],
            ["installedUserCount", (o, n) => { (o as unknown as InstallSummary).installedUserCount = n.getNumberValue(); }],
            ["notInstalledDeviceCount", (o, n) => { (o as unknown as InstallSummary).notInstalledDeviceCount = n.getNumberValue(); }],
            ["notInstalledUserCount", (o, n) => { (o as unknown as InstallSummary).notInstalledUserCount = n.getNumberValue(); }],
        ]);
    };
    /**
