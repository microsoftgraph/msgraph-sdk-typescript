...
import { createManagedEBookCollectionResponseFromDiscriminatorValue } from '../../models/managedEBookCollectionResponse';
...
export class ManagedEBooksRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a managedEBooksRequestBuilder
     */
    public withUrl(rawUrl: string) : ManagedEBooksRequestBuilder {
