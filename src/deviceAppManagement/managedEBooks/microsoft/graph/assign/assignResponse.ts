...
export class Microsoft.graph.assignResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["managedEBookAssignments", (o, n) => { (o as unknown as Microsoft.graph.assignResponse).managedEBookAssignments = n.getCollectionOfObjectValues<ManagedEBookAssignment>(ManagedEBookAssignment); }],
        ]);
    };
    /**
