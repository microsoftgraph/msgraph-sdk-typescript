...
export class ManagedEBooksResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ManagedEBooksResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ManagedEBooksResponse).value = n.getCollectionOfObjectValues<ManagedEBook>(ManagedEBook); }],
        ]);
    };
    /**
