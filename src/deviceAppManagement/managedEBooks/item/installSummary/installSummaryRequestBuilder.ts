...
export class InstallSummaryRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: InstallSummaryRequestBuilderDeleteRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
