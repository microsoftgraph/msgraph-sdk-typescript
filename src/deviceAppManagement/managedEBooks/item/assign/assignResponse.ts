...
export class AssignResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["managedEBookAssignments", (o, n) => { (o as unknown as AssignResponse).managedEBookAssignments = n.getCollectionOfObjectValues<ManagedEBookAssignment>(ManagedEBookAssignment); }],
        ]);
    };
    /**
