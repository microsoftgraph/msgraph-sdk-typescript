...
import { createManagedEBookFromDiscriminatorValue, deserializeIntoManagedEBook, serializeManagedEBook, type ManagedEBook } from '../../../models/';
 ...
 */
export class ManagedEBookItemRequestBuilder extends BaseRequestBuilder<ManagedEBookItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}{?%24select,%24expand}", (x, y) => new ManagedEBookItemRequestBuilder(x, y));
    }
    /**
