...
export class UserInstallStateSummaryRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: UserInstallStateSummary | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public deviceStatesById(id: string) : DeviceInstallStateRequestBuilder {
        ...
        id && urlTplParams.set("deviceInstallState_id", id);
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserInstallStateSummary | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.requestAdapter?.sendAsync<UserInstallStateSummary>(requestInfo, UserInstallStateSummary, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * The list of installation states for this eBook.
     * @param body 
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: UserInstallStateSummary | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
