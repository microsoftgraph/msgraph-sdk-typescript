...
import { createManagedDeviceMobileAppConfigurationCollectionResponseFromDiscriminatorValue, createManagedDeviceMobileAppConfigurationFromDiscriminatorValue, deserializeIntoManagedDeviceMobileAppConfiguration, serializeManagedDeviceMobileAppConfiguration, type ManagedDeviceMobileAppConfiguration, type ManagedDeviceMobileAppConfigurationCollectionResponse } from '../../models/';
 ...
 */
export class MobileAppConfigurationsRequestBuilder extends BaseRequestBuilder<MobileAppConfigurationsRequestBuilder> {
    /**
