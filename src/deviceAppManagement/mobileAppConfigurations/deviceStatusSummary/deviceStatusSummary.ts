...
export class DeviceStatusSummary extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["configurationVersion", (o, n) => { (o as unknown as DeviceStatusSummary).configurationVersion = n.getNumberValue(); }],
            ["errorCount", (o, n) => { (o as unknown as DeviceStatusSummary).errorCount = n.getNumberValue(); }],
            ["failedCount", (o, n) => { (o as unknown as DeviceStatusSummary).failedCount = n.getNumberValue(); }],
            ["lastUpdateDateTime", (o, n) => { (o as unknown as DeviceStatusSummary).lastUpdateDateTime = n.getDateValue(); }],
            ["notApplicableCount", (o, n) => { (o as unknown as DeviceStatusSummary).notApplicableCount = n.getNumberValue(); }],
            ["pendingCount", (o, n) => { (o as unknown as DeviceStatusSummary).pendingCount = n.getNumberValue(); }],
            ["successCount", (o, n) => { (o as unknown as DeviceStatusSummary).successCount = n.getNumberValue(); }],
        ]);
    };
    /**
