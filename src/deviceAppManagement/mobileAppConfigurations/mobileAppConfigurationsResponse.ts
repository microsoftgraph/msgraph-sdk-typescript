...
export class MobileAppConfigurationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as MobileAppConfigurationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as MobileAppConfigurationsResponse).value = n.getCollectionOfObjectValues<ManagedDeviceMobileAppConfiguration>(ManagedDeviceMobileAppConfiguration); }],
        ]);
    };
    /**
