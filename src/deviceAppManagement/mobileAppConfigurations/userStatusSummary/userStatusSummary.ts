...
export class UserStatusSummary extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["configurationVersion", (o, n) => { (o as unknown as UserStatusSummary).configurationVersion = n.getNumberValue(); }],
            ["errorCount", (o, n) => { (o as unknown as UserStatusSummary).errorCount = n.getNumberValue(); }],
            ["failedCount", (o, n) => { (o as unknown as UserStatusSummary).failedCount = n.getNumberValue(); }],
            ["lastUpdateDateTime", (o, n) => { (o as unknown as UserStatusSummary).lastUpdateDateTime = n.getDateValue(); }],
            ["notApplicableCount", (o, n) => { (o as unknown as UserStatusSummary).notApplicableCount = n.getNumberValue(); }],
            ["pendingCount", (o, n) => { (o as unknown as UserStatusSummary).pendingCount = n.getNumberValue(); }],
            ["successCount", (o, n) => { (o as unknown as UserStatusSummary).successCount = n.getNumberValue(); }],
        ]);
    };
    /**
