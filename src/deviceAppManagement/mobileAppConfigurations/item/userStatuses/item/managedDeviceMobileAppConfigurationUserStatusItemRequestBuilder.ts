...
export class ManagedDeviceMobileAppConfigurationUserStatusItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, managedDeviceMobileAppConfigurationUserStatusId?: string | undefined) {
