...
export class UserStatusesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as UserStatusesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as UserStatusesResponse).value = n.getCollectionOfObjectValues<ManagedDeviceMobileAppConfigurationUserStatus>(ManagedDeviceMobileAppConfigurationUserStatus); }],
        ]);
    };
    /**
