...
export interface ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderDeleteRequestConfiguration {
    /**
     * Request headers
     */
...
export interface ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderGetRequestConfiguration {
     ...
     */
    queryParameters?: ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderGetQueryParameters;
}
export interface ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderPatchRequestConfiguration {
    /**
     * Request headers
     */
    headers?: Record<string, string[]>;
