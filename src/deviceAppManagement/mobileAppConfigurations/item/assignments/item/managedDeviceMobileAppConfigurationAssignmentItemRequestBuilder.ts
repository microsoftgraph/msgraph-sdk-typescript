...
export class ManagedDeviceMobileAppConfigurationAssignmentItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, managedDeviceMobileAppConfigurationAssignmentId?: string | undefined) {
