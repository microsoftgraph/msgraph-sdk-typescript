...
import { createMobileAppCategoryCollectionResponseFromDiscriminatorValue, createMobileAppCategoryFromDiscriminatorValue, deserializeIntoMobileAppCategory, serializeMobileAppCategory, type MobileAppCategory, type MobileAppCategoryCollectionResponse } from '../../models/';
 ...
 */
export class MobileAppCategoriesRequestBuilder extends BaseRequestBuilder<MobileAppCategoriesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mobileAppCategories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new MobileAppCategoriesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<MobileAppCategoriesRequestBuilderGetQueryParameters> | undefined) : Promise<MobileAppCategoryCollectionResponse | undefined> {
     ...
     */
    public post(body: MobileAppCategory, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<MobileAppCategory | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<MobileAppCategoriesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, mobileAppCategoriesRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: MobileAppCategory, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
