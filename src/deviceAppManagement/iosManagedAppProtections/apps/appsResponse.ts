...
export class AppsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AppsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AppsResponse).value = n.getCollectionOfObjectValues<ManagedMobileApp>(ManagedMobileApp); }],
        ]);
    };
    /**
