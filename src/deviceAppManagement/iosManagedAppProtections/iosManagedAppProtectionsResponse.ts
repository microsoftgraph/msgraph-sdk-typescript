...
export class IosManagedAppProtectionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as IosManagedAppProtectionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as IosManagedAppProtectionsResponse).value = n.getCollectionOfObjectValues<IosManagedAppProtection>(IosManagedAppProtection); }],
        ]);
    };
    /**
