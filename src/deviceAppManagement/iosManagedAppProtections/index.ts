...
import { createIosManagedAppProtectionCollectionResponseFromDiscriminatorValue, createIosManagedAppProtectionFromDiscriminatorValue, deserializeIntoIosManagedAppProtection, serializeIosManagedAppProtection, type IosManagedAppProtection, type IosManagedAppProtectionCollectionResponse } from '../../models/';
 ...
 */
export class IosManagedAppProtectionsRequestBuilder extends BaseRequestBuilder<IosManagedAppProtectionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/iosManagedAppProtections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new IosManagedAppProtectionsRequestBuilder(x, y));
    }
    /**
