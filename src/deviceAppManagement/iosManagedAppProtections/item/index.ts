...
import { createIosManagedAppProtectionFromDiscriminatorValue, deserializeIntoIosManagedAppProtection, serializeIosManagedAppProtection, type IosManagedAppProtection } from '../../../models/';
 ...
 */
export class IosManagedAppProtectionItemRequestBuilder extends BaseRequestBuilder<IosManagedAppProtectionItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/iosManagedAppProtections/{iosManagedAppProtection%2Did}{?%24select,%24expand}", (x, y) => new IosManagedAppProtectionItemRequestBuilder(x, y));
    }
    /**
