import {ManagedAppOperationImpl} from '../../../../../models/';
...
export class ManagedAppOperationItemRequestBuilder {
     ...
     */
    public createDeleteRequestInformation(requestConfiguration?: ManagedAppOperationItemRequestBuilderDeleteRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createGetRequestInformation(requestConfiguration?: ManagedAppOperationItemRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
        const requestInfo = new RequestInformation();
        requestInfo.urlTemplate = this.urlTemplate;
        requestInfo.pathParameters = this.pathParameters;
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: ManagedAppOperation | undefined, requestConfiguration?: ManagedAppOperationItemRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        const parsableBody = new ManagedAppOperationImpl(body)
     ...
     */
    public get(requestConfiguration?: ManagedAppOperationItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ManagedAppOperationImpl | undefined> {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: ManagedAppOperation | undefined, requestConfiguration?: ManagedAppOperationItemRequestBuilderPatchRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
