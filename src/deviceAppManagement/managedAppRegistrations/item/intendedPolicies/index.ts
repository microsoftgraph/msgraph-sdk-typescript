 ...
 */
export class IntendedPoliciesRequestBuilder extends BaseRequestBuilder<IntendedPoliciesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/managedAppRegistrations/{managedAppRegistration%2Did}/intendedPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new IntendedPoliciesRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<IntendedPoliciesRequestBuilderGetQueryParameters> | undefined) : Promise<ManagedAppPolicyCollectionResponse | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<IntendedPoliciesRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, intendedPoliciesRequestBuilderGetQueryParametersMapper);
