...
export class AppliedPoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AppliedPoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AppliedPoliciesResponse).value = n.getCollectionOfObjectValues<ManagedAppPolicy>(ManagedAppPolicy); }],
        ]);
    };
    /**
