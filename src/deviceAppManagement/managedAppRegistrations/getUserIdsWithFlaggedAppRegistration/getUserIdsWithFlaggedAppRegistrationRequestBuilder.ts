...
export class GetUserIdsWithFlaggedAppRegistrationRequestBuilder {
    ...
    public get(requestConfiguration?: GetUserIdsWithFlaggedAppRegistrationRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetUserIdsWithFlaggedAppRegistrationResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetUserIdsWithFlaggedAppRegistrationResponseImpl>(requestInfo, createGetUserIdsWithFlaggedAppRegistrationResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
