...
export class GetUserIdsWithFlaggedAppRegistrationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GetUserIdsWithFlaggedAppRegistrationRequestBuilderGetRequestConfiguration | undefined) : Promise<GetUserIdsWithFlaggedAppRegistrationResponse | undefined> {
        ...
        return this.requestAdapter.sendAsync<GetUserIdsWithFlaggedAppRegistrationResponse>(requestInfo, createGetUserIdsWithFlaggedAppRegistrationResponseFromDiscriminatorValue, errorMapping);
    };
    /**
     * Invoke function getUserIdsWithFlaggedAppRegistration
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
