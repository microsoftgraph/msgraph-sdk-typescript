...
export class MobileAppsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as MobileAppsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as MobileAppsResponse).value = n.getCollectionOfObjectValues<MobileApp>(MobileApp); }],
        ]);
    };
    /**
