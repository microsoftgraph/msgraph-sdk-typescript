 ...
 */
export class GraphWindowsUniversalAppXRequestBuilder extends BaseRequestBuilder<GraphWindowsUniversalAppXRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.windowsUniversalAppX{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new GraphWindowsUniversalAppXRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<GraphWindowsUniversalAppXRequestBuilderGetQueryParameters> | undefined) : Promise<WindowsUniversalAppXCollectionResponse | undefined> {
