...
import { createWin32LobAppCollectionResponseFromDiscriminatorValue, type Win32LobAppCollectionResponse } from '../../../models/';
 ...
 */
export class GraphWin32LobAppRequestBuilder extends BaseRequestBuilder<GraphWin32LobAppRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.win32LobApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new GraphWin32LobAppRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<GraphWin32LobAppRequestBuilderGetQueryParameters> | undefined) : Promise<Win32LobAppCollectionResponse | undefined> {
