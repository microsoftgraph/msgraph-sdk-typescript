import { type MacOSDmgAppCollectionResponse } from '../../../models/';
import { createMacOSDmgAppCollectionResponseFromDiscriminatorValue } from '../../../models/createMacOSDmgAppCollectionResponseFromDiscriminatorValue';
...
export class GraphMacOSDmgAppRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.macOSDmgApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
     * Get the items of type microsoft.graph.macOSDmgApp in the microsoft.graph.mobileApp collection
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns a Promise of MacOSDmgAppCollectionResponse
     */
    public get(requestConfiguration?: GraphMacOSDmgAppRequestBuilderGetRequestConfiguration | undefined) : Promise<MacOSDmgAppCollectionResponse | undefined> {
        ...
        return this.requestAdapter.sendAsync<MacOSDmgAppCollectionResponse>(requestInfo, createMacOSDmgAppCollectionResponseFromDiscriminatorValue, errorMapping);
    };
    /**
     * Get the items of type microsoft.graph.macOSDmgApp in the microsoft.graph.mobileApp collection
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
