import { type ManagedMobileLobAppCollectionResponse } from '../../../models/';
...
import { type GraphManagedMobileLobAppRequestBuilderGetRequestConfiguration } from './graphManagedMobileLobAppRequestBuilderGetRequestConfiguration';
...
export class GraphManagedMobileLobAppRequestBuilder extends BaseRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.managedMobileLobApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
    ...
    public get(requestConfiguration?: GraphManagedMobileLobAppRequestBuilderGetRequestConfiguration | undefined) : Promise<ManagedMobileLobAppCollectionResponse | undefined> {
        ...
        return this.requestAdapter.sendAsync<ManagedMobileLobAppCollectionResponse>(requestInfo, createManagedMobileLobAppCollectionResponseFromDiscriminatorValue, errorMapping);
    };
    /**
     * Get the items of type microsoft.graph.managedMobileLobApp in the microsoft.graph.mobileApp collection
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
