...
export class GraphManagedMobileLobAppRequestBuilder extends BaseRequestBuilder<GraphManagedMobileLobAppRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedMobileLobApp{?%24select,%24expand}", (x, y) => new GraphManagedMobileLobAppRequestBuilder(x, y));
    }
    /**
