...
export class CategoriesRequestBuilder {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CategoriesResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<CategoriesResponse>(requestInfo, CategoriesResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
