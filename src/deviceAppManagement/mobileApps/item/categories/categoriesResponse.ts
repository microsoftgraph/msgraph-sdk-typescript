...
export class CategoriesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as CategoriesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as CategoriesResponse).value = n.getCollectionOfObjectValues<MobileAppCategory>(MobileAppCategory); }],
        ]);
    };
    /**
