...
export class GraphWindowsAppXRequestBuilder extends BaseRequestBuilder<GraphWindowsAppXRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsAppX{?%24select,%24expand}", (x, y) => new GraphWindowsAppXRequestBuilder(x, y));
    }
    /**
