...
import { CommittedContainedAppsRequestBuilder } from './committedContainedApps/';
...
export class GraphWindowsUniversalAppXRequestBuilder extends BaseRequestBuilder<GraphWindowsUniversalAppXRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsUniversalAppX{?%24select,%24expand}", (x, y) => new GraphWindowsUniversalAppXRequestBuilder(x, y));
    }
    /**
