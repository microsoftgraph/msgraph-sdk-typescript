 ...
 */
export const MobileAppCategoryItemRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.iosStoreApp/categories/{mobileAppCategory%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
