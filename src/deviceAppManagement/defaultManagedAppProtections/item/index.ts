...
import { createDefaultManagedAppProtectionFromDiscriminatorValue, deserializeIntoDefaultManagedAppProtection, serializeDefaultManagedAppProtection, type DefaultManagedAppProtection } from '../../../models/';
 ...
 */
export class DefaultManagedAppProtectionItemRequestBuilder extends BaseRequestBuilder<DefaultManagedAppProtectionItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection%2Did}{?%24select,%24expand}", (x, y) => new DefaultManagedAppProtectionItemRequestBuilder(x, y));
    }
    /**
