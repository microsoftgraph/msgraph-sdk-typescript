import {ManagedMobileAppCollectionResponseImpl, ManagedMobileAppImpl} from '../../../../models/';
...
export class AppsRequestBuilder {
    ...
    public get(requestConfiguration?: AppsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ManagedMobileAppCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ManagedMobileAppCollectionResponseImpl>(requestInfo, createManagedMobileAppCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to apps for deviceAppManagement
     * @param body 
