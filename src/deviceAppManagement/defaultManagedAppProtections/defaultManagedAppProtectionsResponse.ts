...
export class DefaultManagedAppProtectionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DefaultManagedAppProtectionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DefaultManagedAppProtectionsResponse).value = n.getCollectionOfObjectValues<DefaultManagedAppProtection>(DefaultManagedAppProtection); }],
        ]);
    };
    /**
