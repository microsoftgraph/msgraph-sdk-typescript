...
import { createDefaultManagedAppProtectionCollectionResponseFromDiscriminatorValue, createDefaultManagedAppProtectionFromDiscriminatorValue, deserializeIntoDefaultManagedAppProtection, serializeDefaultManagedAppProtection, type DefaultManagedAppProtection, type DefaultManagedAppProtectionCollectionResponse } from '../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { DefaultManagedAppProtectionItemRequestBuilder } from './item/';
 ...
 */
export class DefaultManagedAppProtectionsRequestBuilder extends BaseRequestBuilder<DefaultManagedAppProtectionsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/defaultManagedAppProtections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DefaultManagedAppProtectionsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<DefaultManagedAppProtectionsRequestBuilderGetQueryParameters> | undefined) : Promise<DefaultManagedAppProtectionCollectionResponse | undefined> {
     ...
     */
    public post(body: DefaultManagedAppProtection, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DefaultManagedAppProtection | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<DefaultManagedAppProtectionsRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, defaultManagedAppProtectionsRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: DefaultManagedAppProtection, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
