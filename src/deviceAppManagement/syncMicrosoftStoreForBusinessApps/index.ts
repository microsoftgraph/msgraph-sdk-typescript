 ...
 */
export class SyncMicrosoftStoreForBusinessAppsRequestBuilder extends BaseRequestBuilder<SyncMicrosoftStoreForBusinessAppsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/deviceAppManagement/syncMicrosoftStoreForBusinessApps", (x, y) => new SyncMicrosoftStoreForBusinessAppsRequestBuilder(x, y));
    }
    /**
