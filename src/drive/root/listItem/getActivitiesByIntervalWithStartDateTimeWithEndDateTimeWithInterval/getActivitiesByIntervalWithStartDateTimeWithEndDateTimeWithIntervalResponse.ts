...
import {ItemActivityStat} from '../../../../models/microsoft/graph/itemActivityStat';
...
export class GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["value", (o, n) => { (o as unknown as GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalResponse).value = n.getCollectionOfObjectValues<ItemActivityStat>(createItemActivityStatFromDiscriminatorValue); }],
        ]);
    };
    /**
