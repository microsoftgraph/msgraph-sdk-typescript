...
export class CreateUploadSessionPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    /** The item property */
    private _item?: DriveItemUploadableProperties | CreateUploadSessionMember1 | undefined;
    /**
     ...
     */
    public set item(value: DriveItemUploadableProperties | CreateUploadSessionMember1 | undefined) {
        this._item = value;
    };
    /**
