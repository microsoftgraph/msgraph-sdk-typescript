...
export class Root extends BaseItem implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["analytics", (o, n) => { (o as unknown as Root).analytics = n.getObjectValue<ItemAnalytics>(ItemAnalytics); }],
            ["audio", (o, n) => { (o as unknown as Root).audio = n.getObjectValue<Audio>(Audio); }],
            ["children", (o, n) => { (o as unknown as Root).children = n.getCollectionOfObjectValues<DriveItem>(DriveItem); }],
            ["content", (o, n) => { (o as unknown as Root).content = n.getObjectValue<Binary>(Binary); }],
            ["cTag", (o, n) => { (o as unknown as Root).cTag = n.getStringValue(); }],
            ["deleted", (o, n) => { (o as unknown as Root).deleted = n.getObjectValue<Deleted>(Deleted); }],
            ["file", (o, n) => { (o as unknown as Root).file = n.getObjectValue<File>(File); }],
            ["fileSystemInfo", (o, n) => { (o as unknown as Root).fileSystemInfo = n.getObjectValue<FileSystemInfo>(FileSystemInfo); }],
            ["folder", (o, n) => { (o as unknown as Root).folder = n.getObjectValue<Folder>(Folder); }],
            ["image", (o, n) => { (o as unknown as Root).image = n.getObjectValue<Image>(Image); }],
            ["listItem", (o, n) => { (o as unknown as Root).listItem = n.getObjectValue<ListItem>(ListItem); }],
            ["location", (o, n) => { (o as unknown as Root).location = n.getObjectValue<GeoCoordinates>(GeoCoordinates); }],
            ["package", (o, n) => { (o as unknown as Root).package = n.getObjectValue<Package>(Package); }],
            ["pendingOperations", (o, n) => { (o as unknown as Root).pendingOperations = n.getObjectValue<PendingOperations>(PendingOperations); }],
            ["permissions", (o, n) => { (o as unknown as Root).permissions = n.getCollectionOfObjectValues<Permission>(Permission); }],
            ["photo", (o, n) => { (o as unknown as Root).photo = n.getObjectValue<Photo>(Photo); }],
            ["publication", (o, n) => { (o as unknown as Root).publication = n.getObjectValue<PublicationFacet>(PublicationFacet); }],
            ["remoteItem", (o, n) => { (o as unknown as Root).remoteItem = n.getObjectValue<RemoteItem>(RemoteItem); }],
            ["root", (o, n) => { (o as unknown as Root).root = n.getObjectValue<Root>(Root); }],
            ["searchResult", (o, n) => { (o as unknown as Root).searchResult = n.getObjectValue<SearchResult>(SearchResult); }],
            ["shared", (o, n) => { (o as unknown as Root).shared = n.getObjectValue<Shared>(Shared); }],
            ["sharepointIds", (o, n) => { (o as unknown as Root).sharepointIds = n.getObjectValue<SharepointIds>(SharepointIds); }],
            ["size", (o, n) => { (o as unknown as Root).size = n.getObjectValue<Int64>(Int64); }],
            ["specialFolder", (o, n) => { (o as unknown as Root).specialFolder = n.getObjectValue<SpecialFolder>(SpecialFolder); }],
            ["subscriptions", (o, n) => { (o as unknown as Root).subscriptions = n.getCollectionOfObjectValues<Subscription>(Subscription); }],
            ["thumbnails", (o, n) => { (o as unknown as Root).thumbnails = n.getCollectionOfObjectValues<ThumbnailSet>(ThumbnailSet); }],
            ["versions", (o, n) => { (o as unknown as Root).versions = n.getCollectionOfObjectValues<DriveItemVersion>(DriveItemVersion); }],
            ["video", (o, n) => { (o as unknown as Root).video = n.getObjectValue<Video>(Video); }],
            ["webDavUrl", (o, n) => { (o as unknown as Root).webDavUrl = n.getStringValue(); }],
            ["workbook", (o, n) => { (o as unknown as Root).workbook = n.getObjectValue<Workbook>(Workbook); }],
        ]);
    };
    /**
