...
export class FollowingRequestBuilder {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<FollowingResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.requestAdapter?.sendAsync<FollowingResponse>(requestInfo, FollowingResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * The list of items the user is following. Only in OneDrive for Business.
     * @param body 
