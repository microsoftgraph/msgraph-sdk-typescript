...
/** Builds and executes requests for operations under /drive/list/contentTypes/{contentType-id}/microsoft.graph.publish  */
export class PublishRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType_id}/microsoft.graph.publish";
