...
export class IsPublishedRequestBuilder {
    ...
    public get(requestConfiguration?: IsPublishedRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<IsPublishedResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<IsPublishedResponseImpl>(requestInfo, createIsPublishedResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
