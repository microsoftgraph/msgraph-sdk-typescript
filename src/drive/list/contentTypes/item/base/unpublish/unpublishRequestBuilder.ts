...
/** Builds and executes requests for operations under /drive/list/contentTypes/{contentType-id}/base/microsoft.graph.unpublish  */
export class UnpublishRequestBuilder {
    ...
    public constructor(pathParameters: Map<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType_id}/base/microsoft.graph.unpublish";
