...
import {MicrosoftGraphInstantiateRequestBuilderPostRequestConfiguration} from './microsoftGraphInstantiateRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/**
 * Provides operations to call the instantiate method.
 */
export class MicrosoftGraphInstantiateRequestBuilder {
     ...
     */
    public post(body: InstantiatePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphInstantiateRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApplicationServicePrincipal | undefined> {
     ...
     */
    public toPostRequestInformation(body: InstantiatePostRequestBody | undefined, requestConfiguration?: MicrosoftGraphInstantiateRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
