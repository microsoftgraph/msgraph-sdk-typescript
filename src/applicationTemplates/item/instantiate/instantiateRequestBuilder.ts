...
export class InstantiateRequestBuilder {
    ...
    public post(body: InstantiatePostRequestBody | undefined, requestConfiguration?: InstantiateRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApplicationServicePrincipalImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ApplicationServicePrincipalImpl>(requestInfo, createApplicationServicePrincipalFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
