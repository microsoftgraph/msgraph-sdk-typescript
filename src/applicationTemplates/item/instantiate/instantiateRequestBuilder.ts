...
export class InstantiateRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: InstantiateRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: InstantiateRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApplicationServicePrincipal | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        const requestInfo = this.createPostRequestInformation(
            body, h, o
        );
        return this.requestAdapter?.sendAsync<ApplicationServicePrincipal>(requestInfo, ApplicationServicePrincipal, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
