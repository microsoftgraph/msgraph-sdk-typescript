...
export class InstantiateRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: InstantiateRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: InstantiateRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApplicationServicePrincipal | undefined> {
        if(!body) throw new Error("body cannot be undefined");
