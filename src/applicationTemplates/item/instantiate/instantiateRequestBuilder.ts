...
import {InstantiatePostRequestBody, InstantiateResponseMember1} from './index';
...
export class InstantiateRequestBuilder {
     ...
     */
    public post(body: InstantiatePostRequestBody | undefined, requestConfiguration?: InstantiateRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApplicationServicePrincipal | InstantiateResponseMember1 | undefined> {
        if(!body) throw new Error("body cannot be undefined");
        ...
        return this.requestAdapter?.sendAsync<ApplicationServicePrincipal | InstantiateResponseMember1>(requestInfo, createApplicationServicePrincipal | InstantiateResponseMember1FromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
