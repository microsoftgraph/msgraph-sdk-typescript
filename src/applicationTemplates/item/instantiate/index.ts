...
import { createApplicationServicePrincipalFromDiscriminatorValue, deserializeIntoApplicationServicePrincipal, serializeApplicationServicePrincipal, type ApplicationServicePrincipal } from '../../../models/';
 ...
 */
export class InstantiateRequestBuilder extends BaseRequestBuilder<InstantiateRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/applicationTemplates/{applicationTemplate%2Did}/instantiate", (x, y) => new InstantiateRequestBuilder(x, y));
    }
    /**
