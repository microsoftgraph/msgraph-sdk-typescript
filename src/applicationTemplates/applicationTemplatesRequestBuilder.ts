...
import { createApplicationTemplateCollectionResponseFromDiscriminatorValue } from '../models/applicationTemplateCollectionResponse';
...
export class ApplicationTemplatesRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a applicationTemplatesRequestBuilder
     */
    public withUrl(rawUrl: string) : ApplicationTemplatesRequestBuilder {
