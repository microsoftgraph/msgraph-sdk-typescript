...
export class GetAvailableExtensionProperties extends DirectoryObject implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["appDisplayName", (o, n) => { (o as unknown as GetAvailableExtensionProperties).appDisplayName = n.getStringValue(); }],
            ["dataType", (o, n) => { (o as unknown as GetAvailableExtensionProperties).dataType = n.getStringValue(); }],
            ["isSyncedFromOnPremises", (o, n) => { (o as unknown as GetAvailableExtensionProperties).isSyncedFromOnPremises = n.getBooleanValue(); }],
            ["name", (o, n) => { (o as unknown as GetAvailableExtensionProperties).name = n.getStringValue(); }],
            ["targetObjects", (o, n) => { (o as unknown as GetAvailableExtensionProperties).targetObjects = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
