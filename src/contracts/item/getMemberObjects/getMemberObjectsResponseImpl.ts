...
export class GetMemberObjectsResponseImpl implements GetMemberObjectsResponse {
    ...
    public constructor(getMemberObjectsResponseParameterValue?: GetMemberObjectsResponse | undefined) {
        this._additionalData = getMemberObjectsResponseParameterValue?.additionalData ? getMemberObjectsResponseParameterValue?.additionalData! : {};
        this._value = getMemberObjectsResponseParameterValue?.value;
    };
    /**
