...
export class Microsoft.graph.checkMemberGroupsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupIds", (o, n) => { (o as unknown as Microsoft.graph.checkMemberGroupsResponse).groupIds = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
