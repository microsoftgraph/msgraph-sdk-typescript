...
export class Microsoft.graph.validatePropertiesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["displayName", (o, n) => { (o as unknown as Microsoft.graph.validatePropertiesResponse).displayName = n.getStringValue(); }],
            ["entityType", (o, n) => { (o as unknown as Microsoft.graph.validatePropertiesResponse).entityType = n.getStringValue(); }],
            ["mailNickname", (o, n) => { (o as unknown as Microsoft.graph.validatePropertiesResponse).mailNickname = n.getStringValue(); }],
            ["onBehalfOfUserId", (o, n) => { (o as unknown as Microsoft.graph.validatePropertiesResponse).onBehalfOfUserId = n.getStringValue(); }],
        ]);
    };
    /**
