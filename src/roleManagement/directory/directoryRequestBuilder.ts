...
export class DirectoryRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a Promise of RbacApplication
     */
    public patch(body: RbacApplication | undefined, requestConfiguration?: DirectoryRequestBuilderPatchRequestConfiguration | undefined) : Promise<RbacApplication | undefined> {
