import {UnifiedRoleEligibilityScheduleCollectionResponseImpl, UnifiedRoleEligibilityScheduleImpl} from '../../../models/';
...
export class RoleEligibilitySchedulesRequestBuilder {
    ...
    public get(requestConfiguration?: RoleEligibilitySchedulesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnifiedRoleEligibilityScheduleCollectionResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UnifiedRoleEligibilityScheduleCollectionResponseImpl>(requestInfo, createUnifiedRoleEligibilityScheduleCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * Create new navigation property to roleEligibilitySchedules for roleManagement
     * @param body 
    ...
    public post(body: UnifiedRoleEligibilitySchedule | undefined, requestConfiguration?: RoleEligibilitySchedulesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnifiedRoleEligibilityScheduleImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UnifiedRoleEligibilityScheduleImpl>(requestInfo, createUnifiedRoleEligibilityScheduleFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
