...
import { createUnifiedRoleEligibilityScheduleFromDiscriminatorValue, deserializeIntoUnifiedRoleEligibilitySchedule, serializeUnifiedRoleEligibilitySchedule, type UnifiedRoleEligibilitySchedule } from '../../../../models/';
 ...
 */
export class UnifiedRoleEligibilityScheduleItemRequestBuilder extends BaseRequestBuilder<UnifiedRoleEligibilityScheduleItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/roleManagement/directory/roleEligibilitySchedules/{unifiedRoleEligibilitySchedule%2Did}{?%24select,%24expand}", (x, y) => new UnifiedRoleEligibilityScheduleItemRequestBuilder(x, y));
    }
    /**
