...
import {RoleEligibilityScheduleRequestsRequestBuilderGetQueryParameters} from './roleEligibilityScheduleRequestsRequestBuilderGetQueryParameters';
...
export class RoleEligibilityScheduleRequestsRequestBuilder {
     ...
     */
    public createGetRequestInformation(queryParameters?: RoleEligibilityScheduleRequestsRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: UnifiedRoleEligibilityScheduleRequest | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public get(queryParameters?: RoleEligibilityScheduleRequestsRequestBuilderGetQueryParameters | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnifiedRoleEligibilityScheduleRequestCollectionResponse | undefined> {
     ...
     */
    public post(body: UnifiedRoleEligibilityScheduleRequest | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnifiedRoleEligibilityScheduleRequest | undefined> {
        if(!body) throw new Error("body cannot be undefined");
