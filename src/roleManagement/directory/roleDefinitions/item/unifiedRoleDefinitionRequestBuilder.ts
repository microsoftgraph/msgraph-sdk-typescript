...
import {UnifiedRoleDefinitionRequestBuilder as i4584f3e88dc25e894cc69a8b891a6d054ff2035c8bad467d4f1cadb495601e6c} from './inheritsPermissionsFrom/item/unifiedRoleDefinitionRequestBuilder';
...
export class UnifiedRoleDefinitionRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.roleManagement.directory.roleDefinitions.item.inheritsPermissionsFrom.item collection
     * @param id Unique identifier of the item
     * @returns a unifiedRoleDefinitionRequestBuilder
     */
    public inheritsPermissionsFromById(id: string) : i4584f3e88dc25e894cc69a8b891a6d054ff2035c8bad467d4f1cadb495601e6c {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("unifiedRoleDefinition_id1", id);
        return new i4584f3e88dc25e894cc69a8b891a6d054ff2035c8bad467d4f1cadb495601e6c(urlTplParams, this.requestAdapter);
    };
    /**
     * Resource representing the roles allowed by RBAC providers and the permissions assigned to the roles.
     * @param body 
