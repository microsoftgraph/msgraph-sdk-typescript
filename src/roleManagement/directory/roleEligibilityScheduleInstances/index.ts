...
import { createUnifiedRoleEligibilityScheduleInstanceCollectionResponseFromDiscriminatorValue, createUnifiedRoleEligibilityScheduleInstanceFromDiscriminatorValue, deserializeIntoUnifiedRoleEligibilityScheduleInstance, serializeUnifiedRoleEligibilityScheduleInstance, type UnifiedRoleEligibilityScheduleInstance, type UnifiedRoleEligibilityScheduleInstanceCollectionResponse } from '../../../models/';
 ...
 */
export class RoleEligibilityScheduleInstancesRequestBuilder extends BaseRequestBuilder<RoleEligibilityScheduleInstancesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/roleManagement/directory/roleEligibilityScheduleInstances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RoleEligibilityScheduleInstancesRequestBuilder(x, y));
    }
    /**
