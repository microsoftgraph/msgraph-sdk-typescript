...
import { createUnifiedRoleAssignmentScheduleFromDiscriminatorValue, deserializeIntoUnifiedRoleAssignmentSchedule, serializeUnifiedRoleAssignmentSchedule, type UnifiedRoleAssignmentSchedule } from '../../../../models/';
 ...
 */
export class UnifiedRoleAssignmentScheduleItemRequestBuilder extends BaseRequestBuilder<UnifiedRoleAssignmentScheduleItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}{?%24select,%24expand}", (x, y) => new UnifiedRoleAssignmentScheduleItemRequestBuilder(x, y));
    }
    /**
