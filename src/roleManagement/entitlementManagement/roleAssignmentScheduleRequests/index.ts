...
import { createUnifiedRoleAssignmentScheduleRequestCollectionResponseFromDiscriminatorValue, createUnifiedRoleAssignmentScheduleRequestFromDiscriminatorValue, deserializeIntoUnifiedRoleAssignmentScheduleRequest, serializeUnifiedRoleAssignmentScheduleRequest, type UnifiedRoleAssignmentScheduleRequest, type UnifiedRoleAssignmentScheduleRequestCollectionResponse } from '../../../models/';
...
import { UnifiedRoleAssignmentScheduleRequestItemRequestBuilder } from './item/';
 ...
 */
export class RoleAssignmentScheduleRequestsRequestBuilder extends BaseRequestBuilder<RoleAssignmentScheduleRequestsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentScheduleRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RoleAssignmentScheduleRequestsRequestBuilder(x, y));
    }
    /**
