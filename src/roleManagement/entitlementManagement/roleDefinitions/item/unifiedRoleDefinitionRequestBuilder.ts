...
import {UnifiedRoleDefinitionRequestBuilder as idb4b8a988b49502035f0fb4d29ca3492e52f7bf1e2343642156266427c489756} from './inheritsPermissionsFrom/item/unifiedRoleDefinitionRequestBuilder';
...
export class UnifiedRoleDefinitionRequestBuilder {
     ...
     */
    public inheritsPermissionsFromById(id: string) : idb4b8a988b49502035f0fb4d29ca3492e52f7bf1e2343642156266427c489756 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        id && urlTplParams.set("unifiedRoleDefinition_id1", id);
        return new idb4b8a988b49502035f0fb4d29ca3492e52f7bf1e2343642156266427c489756(urlTplParams, this.requestAdapter);
    };
    /**
     * Resource representing the roles allowed by RBAC providers and the permissions assigned to the roles.
     * @param body 
