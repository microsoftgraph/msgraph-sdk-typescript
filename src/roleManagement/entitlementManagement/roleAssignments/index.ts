...
import { createUnifiedRoleAssignmentCollectionResponseFromDiscriminatorValue, createUnifiedRoleAssignmentFromDiscriminatorValue, deserializeIntoUnifiedRoleAssignment, serializeUnifiedRoleAssignment, type UnifiedRoleAssignment, type UnifiedRoleAssignmentCollectionResponse } from '../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { UnifiedRoleAssignmentItemRequestBuilder } from './item/';
...
export class RoleAssignmentsRequestBuilder extends BaseRequestBuilder<RoleAssignmentsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new RoleAssignmentsRequestBuilder(x, y));
    }
    /**
