...
export class UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, unifiedRoleAssignmentScheduleInstanceId?: string | undefined) {
