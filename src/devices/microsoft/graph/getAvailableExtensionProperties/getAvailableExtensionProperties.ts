...
export class Microsoft.graph.getAvailableExtensionProperties extends DirectoryObject implements Parsable {
    ...
    /**
     * Instantiates a new Microsoft.graph.getAvailableExtensionProperties and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["appDisplayName", (o, n) => { (o as unknown as Microsoft.graph.getAvailableExtensionProperties).appDisplayName = n.getStringValue(); }],
            ["dataType", (o, n) => { (o as unknown as Microsoft.graph.getAvailableExtensionProperties).dataType = n.getStringValue(); }],
            ["isSyncedFromOnPremises", (o, n) => { (o as unknown as Microsoft.graph.getAvailableExtensionProperties).isSyncedFromOnPremises = n.getBooleanValue(); }],
            ["name", (o, n) => { (o as unknown as Microsoft.graph.getAvailableExtensionProperties).name = n.getStringValue(); }],
            ["targetObjects", (o, n) => { (o as unknown as Microsoft.graph.getAvailableExtensionProperties).targetObjects = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
