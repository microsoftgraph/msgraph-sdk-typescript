...
export class RegisteredUsersRequestBuilder {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: object | undefined, o?: MiddlewareOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RegisteredUsersResponse | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.httpCore?.sendAsync<RegisteredUsersResponse>(requestInfo, RegisteredUsersResponse, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
}
