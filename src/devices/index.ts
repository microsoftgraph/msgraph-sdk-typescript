...
import { createDeviceCollectionResponseFromDiscriminatorValue, createDeviceFromDiscriminatorValue, deserializeIntoDevice, serializeDevice, type Device, type DeviceCollectionResponse } from '../models/';
...
import { DeviceItemRequestBuilder } from './item/';
 ...
 */
export class DevicesRequestBuilder extends BaseRequestBuilder<DevicesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/devices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new DevicesRequestBuilder(x, y));
    }
    /**
