...
import { type RegisteredUsersRequestBuilderGetRequestConfiguration } from './registeredUsersRequestBuilderGetRequestConfiguration';
...
export class RegisteredUsersRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: RegisteredUsersRequestBuilderGetRequestConfiguration | undefined) : Promise<DirectoryObjectCollectionResponse | undefined> {
