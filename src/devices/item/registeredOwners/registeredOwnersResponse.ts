...
export class RegisteredOwnersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as RegisteredOwnersResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as RegisteredOwnersResponse).value = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
        ]);
    };
    /**
