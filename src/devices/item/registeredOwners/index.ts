 ...
 */
export class RegisteredOwnersRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredOwners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
    };
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<RegisteredOwnersRequestBuilderGetQueryParameters> | undefined) : Promise<DirectoryObjectCollectionResponse | undefined> {
     ...
     */
    public toGetRequestInformation(requestConfiguration?: RequestConfiguration<RegisteredOwnersRequestBuilderGetQueryParameters> | undefined) : RequestInformation {
        const requestInfo = new RequestInformation(HttpMethod.GET, this.urlTemplate, this.pathParameters);
        requestInfo.configure(requestConfiguration, registeredOwnersRequestBuilderGetQueryParametersMapper);
     ...
     * @returns a registeredOwnersRequestBuilder
     */
    public withUrl(rawUrl: string) : RegisteredOwnersRequestBuilder {
