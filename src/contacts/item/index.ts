...
import { createOrgContactFromDiscriminatorValue, deserializeIntoOrgContact, serializeOrgContact, type OrgContact } from '../../models/';
 ...
 */
export class OrgContactItemRequestBuilder extends BaseRequestBuilder<OrgContactItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}{?%24select,%24expand}", (x, y) => new OrgContactItemRequestBuilder(x, y));
    }
    /**
