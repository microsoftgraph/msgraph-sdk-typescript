...
export class CheckMemberGroupsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["groupIds", (o, n) => { (o as unknown as CheckMemberGroupsResponse).groupIds = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
