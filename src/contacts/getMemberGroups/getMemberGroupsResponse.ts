...
export class GetMemberGroupsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["securityEnabledOnly", (o, n) => { (o as unknown as GetMemberGroupsResponse).securityEnabledOnly = n.getBooleanValue(); }],
        ]);
    };
    /**
