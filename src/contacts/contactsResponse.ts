...
export class ContactsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ContactsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ContactsResponse).value = n.getCollectionOfObjectValues<OrgContact>(OrgContact); }],
        ]);
    };
    /**
