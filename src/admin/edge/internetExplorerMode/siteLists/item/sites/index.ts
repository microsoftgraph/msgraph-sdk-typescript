...
import { createBrowserSiteCollectionResponseFromDiscriminatorValue, createBrowserSiteFromDiscriminatorValue, deserializeIntoBrowserSite, serializeBrowserSite, type BrowserSite, type BrowserSiteCollectionResponse } from '../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { BrowserSiteItemRequestBuilder } from './item/';
...
export class SitesRequestBuilder extends BaseRequestBuilder<SitesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SitesRequestBuilder(x, y));
    }
    /**
