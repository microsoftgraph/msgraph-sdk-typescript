...
import { createBrowserSharedCookieCollectionResponseFromDiscriminatorValue, createBrowserSharedCookieFromDiscriminatorValue, deserializeIntoBrowserSharedCookie, serializeBrowserSharedCookie, type BrowserSharedCookie, type BrowserSharedCookieCollectionResponse } from '../../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { BrowserSharedCookieItemRequestBuilder } from './item/';
 ...
 */
export class SharedCookiesRequestBuilder extends BaseRequestBuilder<SharedCookiesRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sharedCookies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new SharedCookiesRequestBuilder(x, y));
    }
    /**
