...
export class InternetExplorerModeRequestBuilder extends BaseRequestBuilder {
     ...
     * @returns a Promise of InternetExplorerMode
     */
    public patch(body: InternetExplorerMode, requestConfiguration?: InternetExplorerModeRequestBuilderPatchRequestConfiguration | undefined) : Promise<InternetExplorerMode | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPatchRequestInformation(body: InternetExplorerMode, requestConfiguration?: InternetExplorerModeRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
     ...
     * @returns a internetExplorerModeRequestBuilder
     */
    public withUrl(rawUrl: string) : InternetExplorerModeRequestBuilder {
