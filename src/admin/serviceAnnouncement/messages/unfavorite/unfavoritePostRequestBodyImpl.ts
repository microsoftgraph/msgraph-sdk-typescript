...
export class UnfavoritePostRequestBodyImpl implements UnfavoritePostRequestBody {
    ...
    public constructor(unfavoritePostRequestBodyParameterValue?: UnfavoritePostRequestBody | undefined) {
        this._additionalData = unfavoritePostRequestBodyParameterValue?.additionalData ? unfavoritePostRequestBodyParameterValue?.additionalData! : {};
        this._messageIds = unfavoritePostRequestBodyParameterValue?.messageIds;
    };
    /**
