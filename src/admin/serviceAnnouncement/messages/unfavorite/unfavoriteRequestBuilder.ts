...
export class UnfavoriteRequestBuilder {
    ...
    public post(body: UnfavoritePostRequestBody | undefined, requestConfiguration?: UnfavoriteRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnfavoriteResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UnfavoriteResponseImpl>(requestInfo, createUnfavoriteResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
