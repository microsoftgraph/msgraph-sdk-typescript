...
export class UnfavoriteRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "messageIds": (o, n) => { (o as unknown as UnfavoriteRequestBody).messageIds = n.getCollectionOfPrimitiveValues<string>(); },
        };
    };
    /**
