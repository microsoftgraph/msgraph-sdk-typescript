...
export class UnfavoriteResponseImpl implements UnfavoriteResponse {
    ...
    public constructor(unfavoriteResponseParameterValue?: UnfavoriteResponse | undefined) {
        this._additionalData = unfavoriteResponseParameterValue?.additionalData ? unfavoriteResponseParameterValue?.additionalData! : {};
        this._value = unfavoriteResponseParameterValue?.value;
    };
    /**
