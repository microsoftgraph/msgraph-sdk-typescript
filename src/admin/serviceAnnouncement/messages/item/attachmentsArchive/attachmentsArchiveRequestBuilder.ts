...
export class AttachmentsArchiveRequestBuilder {
     ...
     */
    public get(requestConfiguration?: AttachmentsArchiveRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
