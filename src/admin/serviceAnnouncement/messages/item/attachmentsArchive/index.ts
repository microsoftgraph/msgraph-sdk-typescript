 ...
 */
export class AttachmentsArchiveRequestBuilder extends BaseRequestBuilder<AttachmentsArchiveRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}/attachmentsArchive", (x, y) => new AttachmentsArchiveRequestBuilder(x, y));
    }
    /**
