...
import { createServiceUpdateMessageFromDiscriminatorValue, deserializeIntoServiceUpdateMessage, serializeServiceUpdateMessage, type ServiceUpdateMessage } from '../../../../models/';
 ...
 */
export class ServiceUpdateMessageItemRequestBuilder extends BaseRequestBuilder<ServiceUpdateMessageItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}{?%24select,%24expand}", (x, y) => new ServiceUpdateMessageItemRequestBuilder(x, y));
    }
    /**
