...
import { createServiceAnnouncementAttachmentCollectionResponseFromDiscriminatorValue, createServiceAnnouncementAttachmentFromDiscriminatorValue, deserializeIntoServiceAnnouncementAttachment, serializeServiceAnnouncementAttachment, type ServiceAnnouncementAttachment, type ServiceAnnouncementAttachmentCollectionResponse } from '../../../../../models/';
import { createODataErrorFromDiscriminatorValue, deserializeIntoODataError, serializeODataError, type ODataError } from '../../../../../models/oDataErrors/';
import { CountRequestBuilder } from './count/';
import { ServiceAnnouncementAttachmentItemRequestBuilder } from './item/';
...
export class AttachmentsRequestBuilder extends BaseRequestBuilder<AttachmentsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}/attachments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new AttachmentsRequestBuilder(x, y));
    }
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<AttachmentsRequestBuilderGetQueryParameters> | undefined) : Promise<ServiceAnnouncementAttachmentCollectionResponse | undefined> {
     ...
     */
    public post(body: ServiceAnnouncementAttachment, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ServiceAnnouncementAttachment | undefined> {
     ...
     * @returns a RequestInformation
     */
    public toPostRequestInformation(body: ServiceAnnouncementAttachment, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation {
