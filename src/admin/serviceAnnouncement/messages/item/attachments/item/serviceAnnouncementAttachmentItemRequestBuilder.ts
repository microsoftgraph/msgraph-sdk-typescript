...
export class ServiceAnnouncementAttachmentItemRequestBuilder {
     ...
     */
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, serviceAnnouncementAttachmentId?: string | undefined) {
