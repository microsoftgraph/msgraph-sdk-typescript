...
export class MarkUnreadPostRequestBodyImpl implements MarkUnreadPostRequestBody {
    ...
    public constructor(markUnreadPostRequestBodyParameterValue?: MarkUnreadPostRequestBody | undefined) {
        this._additionalData = markUnreadPostRequestBodyParameterValue?.additionalData ? markUnreadPostRequestBodyParameterValue?.additionalData! : {};
        this._messageIds = markUnreadPostRequestBodyParameterValue?.messageIds;
    };
    /**
