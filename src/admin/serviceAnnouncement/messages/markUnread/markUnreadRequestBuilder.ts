...
export class MarkUnreadRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: MarkUnreadRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: MarkUnreadRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<boolean | undefined> {
        if(!body) throw new Error("body cannot be undefined");
