...
import { createMarkUnreadPostResponseFromDiscriminatorValue, deserializeIntoMarkUnreadPostResponse, serializeMarkUnreadPostResponse, type MarkUnreadPostResponse } from './markUnreadPostResponse';
...
export class MarkUnreadRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: MarkUnreadPostRequestBody, requestConfiguration?: MarkUnreadRequestBuilderPostRequestConfiguration | undefined) : Promise<MarkUnreadPostResponse | undefined> {
