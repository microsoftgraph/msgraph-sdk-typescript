...
export class MarkUnreadRequestBuilder {
    ...
    public post(body: MarkUnreadPostRequestBody | undefined, requestConfiguration?: MarkUnreadRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<MarkUnreadResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<MarkUnreadResponseImpl>(requestInfo, createMarkUnreadResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
