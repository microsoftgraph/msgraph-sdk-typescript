...
export class MarkUnreadRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: MarkUnreadRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: MarkUnreadRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<MarkUnreadResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
