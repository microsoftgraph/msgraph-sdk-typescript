...
export class MarkUnreadRequestBuilder {
     ...
     */
    public post(body: MarkUnreadRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<boolean | undefined> {
        if(!body) throw new Error("body cannot be undefined");
