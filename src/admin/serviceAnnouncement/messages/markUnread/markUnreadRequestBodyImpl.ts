...
export class MarkUnreadRequestBodyImpl implements AdditionalDataHolder, MarkUnreadRequestBody, Parsable {
     ...
     * @param markUnreadRequestBodyParameterValue 
     */
    public constructor(markUnreadRequestBodyParameterValue?: MarkUnreadRequestBody | undefined) {
        this.additionalData = {};
        this.additionalData = markUnreadRequestBodyParameterValue?.additionalData ? {} : markUnreadRequestBodyParameterValue?.additionalData!
        this.messageIds = markUnreadRequestBodyParameterValue?.messageIds ;
    };
    /**
