...
export class MarkUnreadResponseImpl implements MarkUnreadResponse {
    ...
    public constructor(markUnreadResponseParameterValue?: MarkUnreadResponse | undefined) {
        this._additionalData = markUnreadResponseParameterValue?.additionalData ? markUnreadResponseParameterValue?.additionalData! : {};
        this._value = markUnreadResponseParameterValue?.value;
    };
    /**
