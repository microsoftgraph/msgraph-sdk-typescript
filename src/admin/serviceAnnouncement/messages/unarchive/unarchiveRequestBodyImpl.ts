...
export class UnarchiveRequestBodyImpl implements AdditionalDataHolder, Parsable, UnarchiveRequestBody {
     ...
     * @param unarchiveRequestBodyParameterValue 
     */
    public constructor(unarchiveRequestBodyParameterValue?: UnarchiveRequestBody | undefined) {
        this.additionalData = {};
        this.additionalData = unarchiveRequestBodyParameterValue?.additionalData ? {} : unarchiveRequestBodyParameterValue?.additionalData!
        this.messageIds = unarchiveRequestBodyParameterValue?.messageIds ;
    };
    /**
