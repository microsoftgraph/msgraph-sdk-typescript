...
export class UnarchiveRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {
            "messageIds": (o, n) => { (o as unknown as UnarchiveRequestBody).messageIds = n.getCollectionOfPrimitiveValues<string>(); },
        };
    };
    /**
