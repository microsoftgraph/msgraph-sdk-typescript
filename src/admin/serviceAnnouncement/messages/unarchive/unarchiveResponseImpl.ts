...
export class UnarchiveResponseImpl implements UnarchiveResponse {
    ...
    public constructor(unarchiveResponseParameterValue?: UnarchiveResponse | undefined) {
        this._additionalData = unarchiveResponseParameterValue?.additionalData ? unarchiveResponseParameterValue?.additionalData! : {};
        this._value = unarchiveResponseParameterValue?.value;
    };
    /**
