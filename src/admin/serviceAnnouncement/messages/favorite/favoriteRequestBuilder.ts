...
export class FavoriteRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: FavoriteRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: FavoriteRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<FavoriteResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
