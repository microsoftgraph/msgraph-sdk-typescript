...
export class FavoriteRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: FavoritePostRequestBody, requestConfiguration?: FavoriteRequestBuilderPostRequestConfiguration | undefined) : Promise<FavoriteResponse | undefined> {
