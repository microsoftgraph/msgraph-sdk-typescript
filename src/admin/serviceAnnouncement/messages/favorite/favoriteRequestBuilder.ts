...
import {FavoriteRequestBody, FavoriteResponse} from './index';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/** Provides operations to call the favorite method.  */
export class FavoriteRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: FavoriteRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: FavoriteRequestBody | undefined, headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<FavoriteResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
