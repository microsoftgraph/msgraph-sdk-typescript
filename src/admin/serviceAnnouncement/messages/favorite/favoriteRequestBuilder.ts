...
export class FavoriteRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: FavoriteRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: FavoriteRequestBody | undefined, h?: object | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<boolean | undefined> {
        if(!body) throw new Error("body cannot be undefined");
