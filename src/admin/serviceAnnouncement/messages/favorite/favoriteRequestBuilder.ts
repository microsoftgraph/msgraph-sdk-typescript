...
export class FavoriteRequestBuilder {
    ...
    public post(body: FavoritePostRequestBody | undefined, requestConfiguration?: FavoriteRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<FavoriteResponseImpl | undefined> {
        ...
        return this.requestAdapter?.sendAsync<FavoriteResponseImpl>(requestInfo, createFavoriteResponseFromDiscriminatorValue, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
}
