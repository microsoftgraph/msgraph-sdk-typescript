...
export class MarkReadResponseImpl implements MarkReadResponse {
    ...
    public constructor(markReadResponseParameterValue?: MarkReadResponse | undefined) {
        this._additionalData = markReadResponseParameterValue?.additionalData ? markReadResponseParameterValue?.additionalData! : {};
        this._value = markReadResponseParameterValue?.value;
    };
    /**
