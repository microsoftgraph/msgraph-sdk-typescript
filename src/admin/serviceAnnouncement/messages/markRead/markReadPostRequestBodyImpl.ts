...
export class MarkReadPostRequestBodyImpl implements MarkReadPostRequestBody {
    ...
    public constructor(markReadPostRequestBodyParameterValue?: MarkReadPostRequestBody | undefined) {
        this._additionalData = markReadPostRequestBodyParameterValue?.additionalData ? markReadPostRequestBodyParameterValue?.additionalData! : {};
        this._messageIds = markReadPostRequestBodyParameterValue?.messageIds;
    };
    /**
