...
export class IncidentReportRequestBuilder {
     ...
     */
    public get(headers?: Record<string, string> | undefined, options?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<IncidentReportResponse | undefined> {
