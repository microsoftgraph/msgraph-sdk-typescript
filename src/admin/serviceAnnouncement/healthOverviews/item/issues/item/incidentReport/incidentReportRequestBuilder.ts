...
export class IncidentReportRequestBuilder {
     ...
     */
    public get(requestConfiguration?: IncidentReportRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer> {
