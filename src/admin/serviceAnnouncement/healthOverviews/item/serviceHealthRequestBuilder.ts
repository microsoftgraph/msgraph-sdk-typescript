import {ServiceHealth} from '../../../../models/microsoft/graph/serviceHealth';
...
export class ServiceHealthRequestBuilder {
    ...
    /**
     * Instantiates a new ServiceHealthRequestBuilder and sets the default values.
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: ServiceHealth | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ServiceHealth | undefined> {
        const requestInfo = this.createGetRequestInformation(
            q, h, o
        );
        return this.requestAdapter?.sendAsync<ServiceHealth>(requestInfo, ServiceHealth, responseHandler) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: ServiceHealth | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
