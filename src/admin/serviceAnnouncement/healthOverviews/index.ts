...
import { createServiceHealthCollectionResponseFromDiscriminatorValue, createServiceHealthFromDiscriminatorValue, deserializeIntoServiceHealth, serializeServiceHealth, type ServiceHealth, type ServiceHealthCollectionResponse } from '../../../models/';
 ...
 */
export class HealthOverviewsRequestBuilder extends BaseRequestBuilder<HealthOverviewsRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/admin/serviceAnnouncement/healthOverviews{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new HealthOverviewsRequestBuilder(x, y));
    }
    /**
