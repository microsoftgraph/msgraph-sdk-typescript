...
import { createAdminFromDiscriminatorValue, deserializeIntoAdmin, serializeAdmin, type Admin } from '../models/';
 ...
 */
export class AdminRequestBuilder extends BaseRequestBuilder<AdminRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/admin{?%24select,%24expand}", (x, y) => new AdminRequestBuilder(x, y));
    }
    /**
     * Get admin
