...
import { createProfileCardPropertyFromDiscriminatorValue, deserializeIntoProfileCardProperty, serializeProfileCardProperty, type ProfileCardProperty } from '../../../../models/';
 ...
 */
export class ProfileCardPropertyItemRequestBuilder extends BaseRequestBuilder<ProfileCardPropertyItemRequestBuilder> {
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/admin/people/profileCardProperties/{profileCardProperty%2Did}{?%24select,%24expand}", (x, y) => new ProfileCardPropertyItemRequestBuilder(x, y));
    }
    /**
