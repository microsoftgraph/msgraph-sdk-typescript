...
export class DataPolicyOperationsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public post(body: DataPolicyOperation | undefined, requestConfiguration?: DataPolicyOperationsRequestBuilderPostRequestConfiguration | undefined) : Promise<DataPolicyOperation | undefined> {
