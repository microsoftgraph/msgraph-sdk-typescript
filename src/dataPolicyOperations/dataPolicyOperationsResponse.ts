...
export class DataPolicyOperationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DataPolicyOperationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DataPolicyOperationsResponse).value = n.getCollectionOfObjectValues<DataPolicyOperation>(DataPolicyOperation); }],
        ]);
    };
    /**
