...
var OperationsRequestBuilder = /** @class */ (function () {
    ...
    OperationsRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        ...
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, printOperation_1.PrintOperation, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
