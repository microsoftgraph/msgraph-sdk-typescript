...
var PrintService = /** @class */ (function (_super) {
    ...
    ;
    Object.defineProperty(PrintService.prototype, "endpoints", {
        /**
     ...
     */
    PrintService.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["endpoints", function (o, n) { o.endpoints = n.getCollectionOfObjectValues(printServiceEndpoint_1.PrintServiceEndpoint); }],], false));
    };
    ;
    /**
     ...
     */
    PrintService.prototype.serialize = function (writer) {
        if (!writer)
