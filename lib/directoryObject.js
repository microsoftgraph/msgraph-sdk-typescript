...
var DirectoryObject = /** @class */ (function (_super) {
    ...
    ;
    Object.defineProperty(DirectoryObject.prototype, "deletedDateTime", {
        /**
     ...
     */
    DirectoryObject.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["deletedDateTime", function (o, n) { o.deletedDateTime = n.getDateValue(); }],], false));
    };
    ;
    /**
     ...
     */
    DirectoryObject.prototype.serialize = function (writer) {
        if (!writer)
