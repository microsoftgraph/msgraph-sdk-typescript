...
var AuthenticationMethod = /** @class */ (function (_super) {
    __extends(AuthenticationMethod, _super);
    /**
     ...
     */
    AuthenticationMethod.prototype.getFieldDeserializers = function () {
     ...
     */
    AuthenticationMethod.prototype.serialize = function (writer) {
        if (!writer)
