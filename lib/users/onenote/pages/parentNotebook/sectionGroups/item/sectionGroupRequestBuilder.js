...
var SectionGroupRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.pages.parentNotebook.sectionGroups.sectionGroups collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.pages.parentNotebook.sectionGroups.sections collection
     * @param id Unique identifier of the item
