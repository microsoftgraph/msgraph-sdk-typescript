...
/** Builds and executes requests for operations under /users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}  */
var SectionGroupRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.notebooks.sectionGroups.sectionGroups collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.onenote.notebooks.sectionGroups.sections collection
     * @param id Unique identifier of the item
