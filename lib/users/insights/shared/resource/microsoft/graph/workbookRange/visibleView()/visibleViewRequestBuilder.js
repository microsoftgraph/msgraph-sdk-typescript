...
var workbookRangeView_1 = require("../../../../../../../../../../me/insights/shared/lastSharedMethod/microsoft/graph/workbookRange/microsoft/graph/workbookRangeView");
...
graph.visibleViewRequestBuilder;
{
    currentPath: string;
    ...
    Promise < workbookRangeView_1.WorkbookRangeView | undefined > {
        const: requestInfo = this.createGetRequestInfo(h, o),
        return: (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, workbookRangeView_1.WorkbookRangeView, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'))
    };
}
