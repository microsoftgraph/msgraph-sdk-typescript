...
var EventRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendars.calendarView.attachments collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.calendars.calendarView.extensions collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.calendars.calendarView.instances collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.calendars.calendarView.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.calendars.calendarView.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
