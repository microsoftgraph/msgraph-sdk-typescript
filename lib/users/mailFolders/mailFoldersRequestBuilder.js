...
var mailFoldersResponse_1 = require("./mailFoldersResponse");
var kiota_abstractions_1 = require("@microsoft/kiota-abstractions");
/** Builds and executes requests for operations under /users/{user-id}/mailFolders  */
var MailFoldersRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function MailFoldersRequestBuilder(currentPath, httpCore, isRawUrl) {
     ...
     */
    MailFoldersRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
     ...
     * @returns a RequestInfo
     */
    MailFoldersRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    MailFoldersRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
        var requestInfo = this.createGetRequestInfo(q, h, o);
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, mailFoldersResponse_1.MailFoldersResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * The user's mail folders. Read-only. Nullable.
     ...
     */
    MailFoldersRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
