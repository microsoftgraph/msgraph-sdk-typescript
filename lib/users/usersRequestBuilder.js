...
var UsersRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function UsersRequestBuilder(currentPath, httpCore, isRawUrl) {
    ...
    Object.defineProperty(UsersRequestBuilder.prototype, "microsoft", {
        get: function () { },
        enumerable: false,
        configurable: true
    });
    UsersRequestBuilder.prototype.getAvailableExtensionProperties = function () {
    ...
    UsersRequestBuilder.prototype.getByIds = function () {
    ...
    UsersRequestBuilder.prototype.validateProperties = function () {
     ...
     */
    UsersRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
     ...
     * @returns a RequestInfo
     */
    UsersRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    UsersRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
        var requestInfo = this.createGetRequestInfo(q, h, o);
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, usersResponse_1.UsersResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Add new entity to users
     ...
     */
    UsersRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
