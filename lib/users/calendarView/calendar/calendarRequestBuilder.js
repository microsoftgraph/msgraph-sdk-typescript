...
var CalendarRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.calendarView.calendar.calendarPermissions collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.calendarView.calendar.calendarView collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.calendarView.calendar.events collection
     * @param id Unique identifier of the item
     * @returns a EventRequestBuilder
     */
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.calendarView.calendar.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.calendarView.calendar.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
