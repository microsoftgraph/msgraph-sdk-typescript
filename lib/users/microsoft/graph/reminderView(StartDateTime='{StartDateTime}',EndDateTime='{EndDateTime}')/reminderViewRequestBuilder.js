...
var microsoft_graph_reminderView_1 = require("./microsoft.graph.reminderView");
Object.defineProperty(exports, "Microsoft", { enumerable: true, get: function () { return microsoft_graph_reminderView_1.Microsoft; } });
...
microsoft_graph_reminderView_1.graph.reminderViewRequestBuilder;
{
    currentPath: string;
    ...
    Promise < microsoft_graph_reminderView_1.Microsoft.graph.reminderView[] | undefined > {
        const: requestInfo = this.createGetRequestInfo(h, o),
        return: (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendCollectionAsync(requestInfo, microsoft_graph_reminderView_1.Microsoft.graph.reminderView, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'))
    };
}
