...
/** Builds and executes requests for operations under /users/{user-id}/managedDevices/{managedDevice-id}/microsoft.graph.bypassActivationLock  */
...
graph.bypassActivationLockRequestBuilder;
{
    currentPath: string;
