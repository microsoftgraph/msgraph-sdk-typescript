...
var ManagedDeviceRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.managedDevices.deviceCompliancePolicyStates collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.users.managedDevices.deviceConfigurationStates collection
     * @param id Unique identifier of the item
