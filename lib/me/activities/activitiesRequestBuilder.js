...
var ActivitiesRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function ActivitiesRequestBuilder(currentPath, httpCore, isRawUrl) {
     ...
     */
    ActivitiesRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
     ...
     * @returns a RequestInfo
     */
    ActivitiesRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    ActivitiesRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
        var requestInfo = this.createGetRequestInfo(q, h, o);
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, activitiesResponse_1.ActivitiesResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * The user's activities across devices. Read-only. Nullable.
     ...
     */
    ActivitiesRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
