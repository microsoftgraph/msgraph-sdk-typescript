...
var MessageRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.mailFolders.messages.attachments collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.mailFolders.messages.extensions collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.mailFolders.messages.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.mailFolders.messages.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
