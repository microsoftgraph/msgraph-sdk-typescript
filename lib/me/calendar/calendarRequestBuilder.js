...
var CalendarRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.calendarPermissions collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.calendarView collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events collection
     * @param id Unique identifier of the item
     * @returns a EventRequestBuilder
     */
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
