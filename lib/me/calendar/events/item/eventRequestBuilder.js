...
var EventRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events.attachments collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events.extensions collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events.instances collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
