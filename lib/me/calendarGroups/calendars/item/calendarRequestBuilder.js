...
var CalendarRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendarGroups.calendars.calendarPermissions collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendarGroups.calendars.calendarView collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendarGroups.calendars.events collection
     * @param id Unique identifier of the item
     * @returns a EventRequestBuilder
     */
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendarGroups.calendars.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendarGroups.calendars.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
