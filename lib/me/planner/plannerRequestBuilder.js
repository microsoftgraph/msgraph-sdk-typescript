...
var plannerUser_1 = require("./plannerUser");
...
var PlannerRequestBuilder = /** @class */ (function () {
    ...
    PlannerRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, plannerUser_1.PlannerUser, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Selective Planner services available to the user. Read-only. Nullable.
