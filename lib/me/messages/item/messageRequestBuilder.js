...
var MessageRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.messages.attachments collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.messages.extensions collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.messages.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.messages.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
