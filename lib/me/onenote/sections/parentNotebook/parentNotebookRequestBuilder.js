...
var ParentNotebookRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.onenote.sections.parentNotebook.sectionGroups collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.onenote.sections.parentNotebook.sections collection
     * @param id Unique identifier of the item
