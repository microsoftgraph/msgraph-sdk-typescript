...
var OutlookUser = /** @class */ (function (_super) {
    __extends(OutlookUser, _super);
    /**
    ...
    ;
    Object.defineProperty(OutlookUser.prototype, "masterCategories", {
        /**
     ...
     */
    OutlookUser.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["masterCategories", function (o, n) { o.masterCategories = n.getCollectionOfObjectValues(outlookCategory_1.OutlookCategory); }],], false));
    };
    ;
    /**
     ...
     */
    OutlookUser.prototype.serialize = function (writer) {
        if (!writer)
