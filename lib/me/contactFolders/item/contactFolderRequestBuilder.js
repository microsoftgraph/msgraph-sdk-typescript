...
var ContactFolderRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.childFolders collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.contacts collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.contactFolders.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
