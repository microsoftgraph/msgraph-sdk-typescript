...
var EventRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendars.calendarView.attachments collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendars.calendarView.extensions collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendars.calendarView.instances collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendars.calendarView.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.me.calendars.calendarView.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
