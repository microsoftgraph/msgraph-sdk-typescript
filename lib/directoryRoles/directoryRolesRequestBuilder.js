...
exports.DirectoryRolesRequestBuilder = void 0;
var directoryRole_1 = require("../directoryRole");
var directoryRolesResponse_1 = require("./directoryRolesResponse");
...
var DirectoryRolesRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function DirectoryRolesRequestBuilder(currentPath, httpCore, isRawUrl) {
    ...
    Object.defineProperty(DirectoryRolesRequestBuilder.prototype, "microsoft", {
        get: function () { },
        enumerable: false,
        configurable: true
    });
    DirectoryRolesRequestBuilder.prototype.getAvailableExtensionProperties = function () {
    ...
    DirectoryRolesRequestBuilder.prototype.getByIds = function () {
    ...
    DirectoryRolesRequestBuilder.prototype.validateProperties = function () {
     ...
     */
    DirectoryRolesRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
     ...
     * @returns a RequestInfo
     */
    DirectoryRolesRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    DirectoryRolesRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
        var requestInfo = this.createGetRequestInfo(q, h, o);
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, directoryRolesResponse_1.DirectoryRolesResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Add new entity to directoryRoles
     ...
     */
    DirectoryRolesRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
...
exports.DirectoryRolesRequestBuilder = DirectoryRolesRequestBuilder;
