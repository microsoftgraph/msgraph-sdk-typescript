...
var termsAndConditionsResponse_1 = require("./termsAndConditionsResponse");
...
var TermsAndConditionsRequestBuilder = /** @class */ (function () {
     ...
     * @returns a RequestInfo
     */
    TermsAndConditionsRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
    ...
    TermsAndConditionsRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, termsAndConditionsResponse_1.TermsAndConditionsResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * The terms and conditions associated with device management of the company.
     ...
     */
    TermsAndConditionsRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
