...
/** Builds and executes requests for operations under /deviceManagement/managedDevices/{managedDevice-id}/microsoft.graph.disableLostMode  */
...
graph.disableLostModeRequestBuilder;
{
    currentPath: string;
