...
/** Builds and executes requests for operations under /deviceManagement/managedDevices/{managedDevice-id}/microsoft.graph.resetPasscode  */
...
graph.resetPasscodeRequestBuilder;
{
    currentPath: string;
