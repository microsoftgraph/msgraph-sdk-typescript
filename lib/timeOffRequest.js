...
var TimeOffRequest = /** @class */ (function (_super) {
    ...
    ;
    Object.defineProperty(TimeOffRequest.prototype, "endDateTime", {
        /**
    ...
    ;
    Object.defineProperty(TimeOffRequest.prototype, "startDateTime", {
        /**
    ...
    ;
    Object.defineProperty(TimeOffRequest.prototype, "timeOffReasonId", {
        /**
     ...
     */
    TimeOffRequest.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["endDateTime", function (o, n) { o.endDateTime = n.getDateValue(); }],
            ...
            ["timeOffReasonId", function (o, n) { o.timeOffReasonId = n.getStringValue(); }],], false));
    };
    ;
    /**
     ...
     */
    TimeOffRequest.prototype.serialize = function (writer) {
        if (!writer)
