...
graph.durationResponse;
implements;
kiota_abstractions_1.Parsable;
{
    _additionalData: Map();
    _basis ?  : Json | undefined;
    _coupon ?  : Json | undefined;
    ...
    Map < string, function (item, node) { return void  > {
        return: new Map([
            ...
            ["coupon", function (o, n) { o.coupon = n.getObjectValue(Json); }],
    ...
    void {
        ...
        writer: writer,
        : .writeObjectValue("coupon", this.coupon),
        writer: writer,
