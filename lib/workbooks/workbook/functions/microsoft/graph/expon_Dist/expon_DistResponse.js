...
graph.expon_DistResponse;
implements;
kiota_abstractions_1.Parsable;
{
    _additionalData: Map();
    _cumulative ?  : Json | undefined;
    _lambda ?  : Json | undefined;
    _x ?  : Json | undefined;
    constructor();
    {
    ...
    Map < string, function (item, node) { return void  > {
        return: new Map([
            ...
            ["lambda", function (o, n) { o.lambda = n.getObjectValue(Json); }],
    ...
    void {
        ...
        writer: writer,
        : .writeObjectValue("lambda", this.lambda),
        writer: writer,
