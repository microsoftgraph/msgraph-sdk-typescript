...
graph.oddFPriceResponse;
implements;
kiota_abstractions_1.Parsable;
{
    _additionalData: Map();
    _basis ?  : Json | undefined;
    _firstCoupon ?  : Json | undefined;
    ...
    Map < string, function (item, node) { return void  > {
        return: new Map([
            ...
            ["firstCoupon", function (o, n) { o.firstCoupon = n.getObjectValue(Json); }],
    ...
    void {
        ...
        writer: writer,
        : .writeObjectValue("firstCoupon", this.firstCoupon),
        writer: writer,
    ...
    ;
    set;
    firstCoupon(value, Json | undefined);
    {
