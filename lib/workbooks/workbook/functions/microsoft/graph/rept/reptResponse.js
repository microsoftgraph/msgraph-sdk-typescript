...
kiota_abstractions_1.Parsable;
{
    ...
    Map < string, function (item, node) { return void  > {
        return: new Map([
            ["numberTimes", function (o, n) { o.numberTimes = n.getObjectValue(Json); }],
    ...
    void {
        ...
        writer: writer,
        : .writeObjectValue("numberTimes", this.numberTimes),
        writer: writer,
    ...
    set;
    numberTimes(value, Json | undefined);
    {
