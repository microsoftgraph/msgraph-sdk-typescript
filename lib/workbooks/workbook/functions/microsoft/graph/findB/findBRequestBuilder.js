...
var microsoft_graph_findBResponse_1 = require("./microsoft.graph.findBResponse");
Object.defineProperty(exports, "Microsoft", { enumerable: true, get: function () { return microsoft_graph_findBResponse_1.Microsoft; } });
...
microsoft_graph_findBResponse_1.graph.findBRequestBuilder;
{
    currentPath: string;
    ...
    constructor(currentPath, string, httpCore, kiota_abstractions_1.HttpCore, isRawUrl, boolean = true);
    {
        ...
        this.pathSegment = "/microsoft.graph.findB";
        this.httpCore = httpCore;
        this.currentPath = currentPath;
        this.isRawUrl = isRawUrl;
    }
    ;
    createPostRequestInfo(body, microsoft_graph_findBResponse_1.Microsoft.graph.findBResponse | undefined, h ?  : object | undefined, o ?  : kiota_abstractions_1.MiddlewareOption[] | undefined);
    ...
    ;
    post(body, microsoft_graph_findBResponse_1.Microsoft.graph.findBResponse | undefined, h ?  : object | undefined, o ?  : kiota_abstractions_1.MiddlewareOption[] | undefined, responseHandler ?  : kiota_abstractions_1.ResponseHandler | undefined);
