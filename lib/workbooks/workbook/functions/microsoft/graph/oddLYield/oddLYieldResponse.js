...
kiota_abstractions_1.Parsable;
{
    ...
    Map < string, function (item, node) { return void  > {
        return: new Map([
            ...
            ["lastInterest", function (o, n) { o.lastInterest = n.getObjectValue(Json); }],
    ...
    void {
        ...
        writer: writer,
        : .writeObjectValue("lastInterest", this.lastInterest),
        writer: writer,
    ...
    ;
    set;
    lastInterest(value, Json | undefined);
    {
