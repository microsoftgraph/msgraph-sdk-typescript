...
graph.roundUpResponse;
implements;
kiota_abstractions_1.Parsable;
{
    _additionalData: Map();
    _number ?  : Json | undefined;
    _numDigits ?  : Json | undefined;
    constructor();
    {
    ...
    Map < string, function (item, node) { return void  > {
        return: new Map([
            ...
            ["numDigits", function (o, n) { o.numDigits = n.getObjectValue(Json); }],
        ])
    }; };
    ...
    void {
        ...
        writer: writer,
        : .writeObjectValue("numDigits", this.numDigits),
        writer: writer,
    ...
    ;
    set;
    numDigits(value, Json | undefined);
    {
