...
var microsoft_graph_dateResponse_1 = require("./microsoft.graph.dateResponse");
Object.defineProperty(exports, "Microsoft", { enumerable: true, get: function () { return microsoft_graph_dateResponse_1.Microsoft; } });
...
microsoft_graph_dateResponse_1.graph.dateRequestBuilder;
{
    currentPath: string;
    ...
    constructor(currentPath, string, httpCore, kiota_abstractions_1.HttpCore, isRawUrl, boolean = true);
    {
        ...
        this.pathSegment = "/microsoft.graph.date";
        this.httpCore = httpCore;
        this.currentPath = currentPath;
        this.isRawUrl = isRawUrl;
    }
    ;
    createPostRequestInfo(body, microsoft_graph_dateResponse_1.Microsoft.graph.dateResponse | undefined, h ?  : object | undefined, o ?  : kiota_abstractions_1.MiddlewareOption[] | undefined);
    ...
    ;
    post(body, microsoft_graph_dateResponse_1.Microsoft.graph.dateResponse | undefined, h ?  : object | undefined, o ?  : kiota_abstractions_1.MiddlewareOption[] | undefined, responseHandler ?  : kiota_abstractions_1.ResponseHandler | undefined);
