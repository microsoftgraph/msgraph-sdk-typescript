...
graph.countRequestBuilder;
{
    ...
    Promise < number | undefined > {
        ...
        return: (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendPrimitiveAsync(requestInfo, "number", responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'))
    };
}
