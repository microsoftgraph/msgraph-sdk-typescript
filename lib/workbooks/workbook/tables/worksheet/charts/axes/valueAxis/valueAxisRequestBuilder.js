...
exports.ValueAxisRequestBuilder = void 0;
...
var ValueAxisRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function ValueAxisRequestBuilder(currentPath, httpCore, isRawUrl) {
    ...
    Object.defineProperty(ValueAxisRequestBuilder.prototype, "format", {
        get: function () {
    ...
    Object.defineProperty(ValueAxisRequestBuilder.prototype, "majorGridlines", {
        get: function () {
    ...
    Object.defineProperty(ValueAxisRequestBuilder.prototype, "minorGridlines", {
        get: function () {
    ...
    Object.defineProperty(ValueAxisRequestBuilder.prototype, "title", {
        get: function () {
     ...
     */
    ValueAxisRequestBuilder.prototype.createDeleteRequestInfo = function (h, o) {
     ...
     * @returns a RequestInfo
     */
    ValueAxisRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
        var requestInfo = new kiota_abstractions_1.RequestInfo();
        requestInfo.setUri(this.currentPath, this.pathSegment, this.isRawUrl);
     ...
     * @returns a RequestInfo
     */
    ValueAxisRequestBuilder.prototype.createPatchRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    ValueAxisRequestBuilder.prototype.delete = function (h, o, responseHandler) {
        var _a, _b;
     ...
     */
    ValueAxisRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    ValueAxisRequestBuilder.prototype.patch = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
...
exports.ValueAxisRequestBuilder = ValueAxisRequestBuilder;
