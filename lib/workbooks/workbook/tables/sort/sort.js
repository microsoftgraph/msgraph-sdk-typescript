...
var Sort = /** @class */ (function (_super) {
    ...
    ;
    Object.defineProperty(Sort.prototype, "fields", {
        /**
    ...
    ;
    Object.defineProperty(Sort.prototype, "matchCase", {
        /**
    ...
    ;
    Object.defineProperty(Sort.prototype, "method", {
        /**
     ...
     */
    Sort.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["fields", function (o, n) { o.fields = n.getCollectionOfPrimitiveValues(); }],
            ["matchCase", function (o, n) { o.matchCase = n.getBooleanValue(); }],
            ["method", function (o, n) { o.method = n.getStringValue(); }],], false));
    };
    ;
    /**
     ...
     */
    Sort.prototype.serialize = function (writer) {
        if (!writer)
