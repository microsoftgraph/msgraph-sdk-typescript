...
exports.WorksheetRequestBuilder = void 0;
...
var WorksheetRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function WorksheetRequestBuilder(currentPath, httpCore, isRawUrl) {
    ...
    Object.defineProperty(WorksheetRequestBuilder.prototype, "charts", {
        get: function () {
    ...
    Object.defineProperty(WorksheetRequestBuilder.prototype, "names", {
        get: function () {
    ...
    Object.defineProperty(WorksheetRequestBuilder.prototype, "pivotTables", {
        get: function () {
    ...
    Object.defineProperty(WorksheetRequestBuilder.prototype, "protection", {
        get: function () {
    ...
    Object.defineProperty(WorksheetRequestBuilder.prototype, "tables", {
        get: function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.workbooks.workbook.names.worksheet.charts collection
     * @param id Unique identifier of the item
     * @returns a WorkbookChartRequestBuilder
     */
    WorksheetRequestBuilder.prototype.chartsById = function (id) {
        if (!id)
     ...
     */
    WorksheetRequestBuilder.prototype.createDeleteRequestInfo = function (h, o) {
     ...
     * @returns a RequestInfo
     */
    WorksheetRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
        var requestInfo = new kiota_abstractions_1.RequestInfo();
        requestInfo.setUri(this.currentPath, this.pathSegment, this.isRawUrl);
     ...
     * @returns a RequestInfo
     */
    WorksheetRequestBuilder.prototype.createPatchRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    WorksheetRequestBuilder.prototype.delete = function (h, o, responseHandler) {
        var _a, _b;
     ...
     */
    WorksheetRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.workbooks.workbook.names.worksheet.names collection
     * @param id Unique identifier of the item
     * @returns a WorkbookNamedItemRequestBuilder
     */
    WorksheetRequestBuilder.prototype.namesById = function (id) {
        if (!id)
            throw new Error("id cannot be undefined");
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    WorksheetRequestBuilder.prototype.patch = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.workbooks.workbook.names.worksheet.pivotTables collection
     * @param id Unique identifier of the item
     * @returns a WorkbookPivotTableRequestBuilder
     */
    WorksheetRequestBuilder.prototype.pivotTablesById = function (id) {
        if (!id)
            throw new Error("id cannot be undefined");
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.workbooks.workbook.names.worksheet.tables collection
     * @param id Unique identifier of the item
     * @returns a WorkbookTableRequestBuilder
     */
    WorksheetRequestBuilder.prototype.tablesById = function (id) {
        if (!id)
            throw new Error("id cannot be undefined");
...
exports.WorksheetRequestBuilder = WorksheetRequestBuilder;
