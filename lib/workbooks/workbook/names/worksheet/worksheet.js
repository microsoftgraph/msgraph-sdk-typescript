...
var workbookWorksheetProtection_1 = require("./protection/workbookWorksheetProtection");
var Worksheet = /** @class */ (function (_super) {
     ...
     */
    Worksheet.prototype.getFieldDeserializers = function () {
     ...
     */
    Worksheet.prototype.serialize = function (writer) {
        if (!writer)
