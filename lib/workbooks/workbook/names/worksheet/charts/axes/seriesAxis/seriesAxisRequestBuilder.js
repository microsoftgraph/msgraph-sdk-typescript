...
exports.SeriesAxisRequestBuilder = void 0;
...
/** Builds and executes requests for operations under /workbooks/{driveItem-id}/workbook/names/{workbookNamedItem-id}/worksheet/charts/{workbookChart-id}/axes/seriesAxis  */
var SeriesAxisRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function SeriesAxisRequestBuilder(currentPath, httpCore, isRawUrl) {
        if (isRawUrl === void 0) { isRawUrl = true; }
        if (!currentPath)
            throw new Error("currentPath cannot be undefined");
        if (!httpCore)
            throw new Error("httpCore cannot be undefined");
        this.pathSegment = "/seriesAxis";
        this.httpCore = httpCore;
        this.currentPath = currentPath;
        this.isRawUrl = isRawUrl;
    }
    Object.defineProperty(SeriesAxisRequestBuilder.prototype, "format", {
        get: function () {
    ...
    Object.defineProperty(SeriesAxisRequestBuilder.prototype, "majorGridlines", {
        get: function () {
    ...
    Object.defineProperty(SeriesAxisRequestBuilder.prototype, "minorGridlines", {
        get: function () {
    ...
    Object.defineProperty(SeriesAxisRequestBuilder.prototype, "title", {
        get: function () {
     ...
     */
    SeriesAxisRequestBuilder.prototype.createDeleteRequestInfo = function (h, o) {
     ...
     * @returns a RequestInfo
     */
    SeriesAxisRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
        var requestInfo = new kiota_abstractions_1.RequestInfo();
        requestInfo.setUri(this.currentPath, this.pathSegment, this.isRawUrl);
     ...
     * @returns a RequestInfo
     */
    SeriesAxisRequestBuilder.prototype.createPatchRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    SeriesAxisRequestBuilder.prototype.delete = function (h, o, responseHandler) {
        var _a, _b;
     ...
     */
    SeriesAxisRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    SeriesAxisRequestBuilder.prototype.patch = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
...
exports.SeriesAxisRequestBuilder = SeriesAxisRequestBuilder;
