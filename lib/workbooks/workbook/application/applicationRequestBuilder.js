...
var microsoft_graph_calculateRequestBuilder_1 = require("./microsoft/graph/calculate/microsoft.graph.calculateRequestBuilder");
var workbookApplication_1 = require("./workbookApplication");
...
var ApplicationRequestBuilder = /** @class */ (function () {
    ...
    ApplicationRequestBuilder.prototype.calculate = function () {
        return new microsoft_graph_calculateRequestBuilder_1.Microsoft.graph.calculateRequestBuilder(this.currentPath + this.pathSegment, this.httpCore, false);
    };
    ;
    /**
     * Delete navigation property application for workbooks
    ...
    ApplicationRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, workbookApplication_1.WorkbookApplication, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Update the navigation property application in workbooks
