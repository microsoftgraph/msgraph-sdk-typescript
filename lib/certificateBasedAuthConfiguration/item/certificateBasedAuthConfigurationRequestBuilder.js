...
var CertificateBasedAuthConfigurationRequestBuilder = /** @class */ (function () {
     ...
     */
    CertificateBasedAuthConfigurationRequestBuilder.prototype.createDeleteRequestInfo = function (h, o) {
     ...
     * @returns a RequestInfo
     */
    CertificateBasedAuthConfigurationRequestBuilder.prototype.createPatchRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    CertificateBasedAuthConfigurationRequestBuilder.prototype.delete = function (h, o, responseHandler) {
        var _a, _b;
    ...
    CertificateBasedAuthConfigurationRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, certificateBasedAuthConfiguration_1.CertificateBasedAuthConfiguration, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Update entity in certificateBasedAuthConfiguration
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    CertificateBasedAuthConfigurationRequestBuilder.prototype.patch = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
