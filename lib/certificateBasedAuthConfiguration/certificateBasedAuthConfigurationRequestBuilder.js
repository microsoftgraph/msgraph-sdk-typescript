...
var CertificateBasedAuthConfigurationRequestBuilder = /** @class */ (function () {
     ...
     * @returns a RequestInfo
     */
    CertificateBasedAuthConfigurationRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    CertificateBasedAuthConfigurationRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
