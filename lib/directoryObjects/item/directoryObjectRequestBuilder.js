...
exports.DirectoryObjectRequestBuilder = void 0;
...
var DirectoryObjectRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function DirectoryObjectRequestBuilder(currentPath, httpCore, isRawUrl) {
    ...
    Object.defineProperty(DirectoryObjectRequestBuilder.prototype, "microsoft", {
        get: function () { },
        enumerable: false,
        configurable: true
    });
    DirectoryObjectRequestBuilder.prototype.checkMemberGroups = function () {
    ...
    DirectoryObjectRequestBuilder.prototype.checkMemberObjects = function () {
    ...
    DirectoryObjectRequestBuilder.prototype.getMemberGroups = function () {
    ...
    DirectoryObjectRequestBuilder.prototype.getMemberObjects = function () {
    ...
    DirectoryObjectRequestBuilder.prototype.restore = function () {
     ...
     */
    DirectoryObjectRequestBuilder.prototype.createDeleteRequestInfo = function (h, o) {
     ...
     * @returns a RequestInfo
     */
    DirectoryObjectRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
        var requestInfo = new kiota_abstractions_1.RequestInfo();
        requestInfo.setUri(this.currentPath, this.pathSegment, this.isRawUrl);
     ...
     * @returns a RequestInfo
     */
    DirectoryObjectRequestBuilder.prototype.createPatchRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    DirectoryObjectRequestBuilder.prototype.delete = function (h, o, responseHandler) {
        var _a, _b;
     ...
     */
    DirectoryObjectRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
        var requestInfo = this.createGetRequestInfo(q, h, o);
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, directoryObject_1.DirectoryObject, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Represents an Azure Active Directory object. The directoryObject type is the base type for many other directory entity types.
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    DirectoryObjectRequestBuilder.prototype.patch = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
