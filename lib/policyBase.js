...
exports.PolicyBase = void 0;
var directoryObject_1 = require("./directoryObject");
var PolicyBase = /** @class */ (function (_super) {
    __extends(PolicyBase, _super);
    /**
    ...
    ;
    Object.defineProperty(PolicyBase.prototype, "description", {
        /**
    ...
    ;
    Object.defineProperty(PolicyBase.prototype, "displayName", {
        /**
     ...
     */
    PolicyBase.prototype.getFieldDeserializers = function () {
     ...
     */
    PolicyBase.prototype.serialize = function (writer) {
        if (!writer)
