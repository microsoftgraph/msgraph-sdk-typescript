...
/** Builds and executes requests for operations under /groups/{group-id}/microsoft.graph.addFavorite  */
...
graph.addFavoriteRequestBuilder;
{
    currentPath: string;
    ...
    constructor(currentPath, string, httpCore, kiota_abstractions_1.HttpCore, isRawUrl, boolean = true);
    {
        ...
        this.pathSegment = "/microsoft.graph.addFavorite";
