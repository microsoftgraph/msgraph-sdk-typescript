...
var Photo = /** @class */ (function (_super) {
    ...
    ;
    Object.defineProperty(Photo.prototype, "height", {
        /**
    ...
    ;
    Object.defineProperty(Photo.prototype, "width", {
        /**
     ...
     */
    Photo.prototype.getFieldDeserializers = function () {
     ...
     */
    Photo.prototype.serialize = function (writer) {
        if (!writer)
