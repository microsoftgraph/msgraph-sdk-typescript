...
var CalendarRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.events.calendar.calendarPermissions collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.events.calendar.calendarView collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.events.calendar.events collection
     * @param id Unique identifier of the item
     * @returns a EventRequestBuilder
     */
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.events.calendar.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.events.calendar.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
