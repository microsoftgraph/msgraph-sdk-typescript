...
var EventRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.events.attachments collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.events.extensions collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.events.instances collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.events.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.events.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
