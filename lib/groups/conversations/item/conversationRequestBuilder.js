...
exports.ConversationRequestBuilder = void 0;
...
var ConversationRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function ConversationRequestBuilder(currentPath, httpCore, isRawUrl) {
    ...
    Object.defineProperty(ConversationRequestBuilder.prototype, "threads", {
        get: function () {
     ...
     */
    ConversationRequestBuilder.prototype.createDeleteRequestInfo = function (h, o) {
     ...
     * @returns a RequestInfo
     */
    ConversationRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
        var requestInfo = new kiota_abstractions_1.RequestInfo();
        requestInfo.setUri(this.currentPath, this.pathSegment, this.isRawUrl);
     ...
     * @returns a RequestInfo
     */
    ConversationRequestBuilder.prototype.createPatchRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    ConversationRequestBuilder.prototype.delete = function (h, o, responseHandler) {
        var _a, _b;
     ...
     */
    ConversationRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    ConversationRequestBuilder.prototype.patch = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.conversations.threads collection
     * @param id Unique identifier of the item
     * @returns a ConversationThreadRequestBuilder
     */
    ConversationRequestBuilder.prototype.threadsById = function (id) {
        if (!id)
...
exports.ConversationRequestBuilder = ConversationRequestBuilder;
