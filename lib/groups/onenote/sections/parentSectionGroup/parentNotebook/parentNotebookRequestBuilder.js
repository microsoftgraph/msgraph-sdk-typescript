...
var ParentNotebookRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sections.parentSectionGroup.parentNotebook.sectionGroups collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sections.parentSectionGroup.parentNotebook.sections collection
     * @param id Unique identifier of the item
