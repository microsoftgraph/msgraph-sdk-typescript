...
var ParentNotebookRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sectionGroups.sections.parentNotebook.sectionGroups collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.sectionGroups.sections.parentNotebook.sections collection
     * @param id Unique identifier of the item
