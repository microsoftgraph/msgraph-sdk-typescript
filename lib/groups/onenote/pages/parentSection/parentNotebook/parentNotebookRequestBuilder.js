...
var ParentNotebookRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.pages.parentSection.parentNotebook.sectionGroups collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.onenote.pages.parentSection.parentNotebook.sections collection
     * @param id Unique identifier of the item
