...
var EventRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.calendar.calendarView.attachments collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.calendar.calendarView.extensions collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.calendar.calendarView.instances collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.calendar.calendarView.multiValueExtendedProperties collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.calendar.calendarView.singleValueExtendedProperties collection
     * @param id Unique identifier of the item
