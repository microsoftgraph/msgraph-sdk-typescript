...
var plannerGroup_1 = require("./plannerGroup");
...
var PlannerRequestBuilder = /** @class */ (function () {
     ...
     */
    PlannerRequestBuilder.prototype.createDeleteRequestInfo = function (h, o) {
     ...
     */
    PlannerRequestBuilder.prototype.delete = function (h, o, responseHandler) {
        var _a, _b;
    ...
    PlannerRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, plannerGroup_1.PlannerGroup, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Selective Planner services available to the group. Read-only. Nullable.
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.groups.planner.plans collection
