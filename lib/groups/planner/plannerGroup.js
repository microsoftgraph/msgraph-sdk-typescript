...
var PlannerGroup = /** @class */ (function (_super) {
    ...
    ;
    Object.defineProperty(PlannerGroup.prototype, "plans", {
        /**
     ...
     */
    PlannerGroup.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["plans", function (o, n) { o.plans = n.getCollectionOfObjectValues(plannerPlan_1.PlannerPlan); }],], false));
    };
    ;
    /**
     ...
     */
    PlannerGroup.prototype.serialize = function (writer) {
        if (!writer)
...
exports.PlannerGroup = PlannerGroup;
