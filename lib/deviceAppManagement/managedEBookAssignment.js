...
exports.ManagedEBookAssignment = void 0;
var entity_1 = require("../entity");
var ManagedEBookAssignment = /** @class */ (function (_super) {
    __extends(ManagedEBookAssignment, _super);
    /**
     * Instantiates a new managedEBookAssignment and sets the default values.
     */
    function ManagedEBookAssignment() {
        return _super.call(this) || this;
    }
    ;
    Object.defineProperty(ManagedEBookAssignment.prototype, "installIntent", {
        /**
    ...
    ;
    Object.defineProperty(ManagedEBookAssignment.prototype, "target", {
        /**
     ...
     */
    ManagedEBookAssignment.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["installIntent", function (o, n) { o.installIntent = n.getObjectValue(InstallIntent); }],
     ...
     */
    ManagedEBookAssignment.prototype.serialize = function (writer) {
        if (!writer)
            throw new Error("writer cannot be undefined");
        _super.prototype.serialize.call(this, writer);
        writer.writeObjectValue("installIntent", this.installIntent);
...
exports.ManagedEBookAssignment = ManagedEBookAssignment;
