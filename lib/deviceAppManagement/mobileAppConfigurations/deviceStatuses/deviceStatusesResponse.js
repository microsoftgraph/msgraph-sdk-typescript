...
var DeviceStatusesResponse = /** @class */ (function () {
    ...
    DeviceStatusesResponse.prototype.getFieldDeserializers = function () {
        return new Map([
            ...
            ["value", function (o, n) { o.value = n.getCollectionOfObjectValues(managedDeviceMobileAppConfigurationDeviceStatus_1.ManagedDeviceMobileAppConfigurationDeviceStatus); }],
        ]);
    };
    ;
    /**
