...
exports.SchedulingGroup = void 0;
var changeTrackedEntity_1 = require("./teamwork/changeTrackedEntity");
var SchedulingGroup = /** @class */ (function (_super) {
    __extends(SchedulingGroup, _super);
    /**
    ...
    ;
    Object.defineProperty(SchedulingGroup.prototype, "displayName", {
        /**
    ...
    ;
    Object.defineProperty(SchedulingGroup.prototype, "isActive", {
        /**
    ...
    ;
    Object.defineProperty(SchedulingGroup.prototype, "userIds", {
        /**
     ...
     */
    SchedulingGroup.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["displayName", function (o, n) { o.displayName = n.getStringValue(); }],
            ...
            ["userIds", function (o, n) { o.userIds = n.getCollectionOfPrimitiveValues(); }],], false));
    };
    ;
    /**
     ...
     */
    SchedulingGroup.prototype.serialize = function (writer) {
        if (!writer)
...
exports.SchedulingGroup = SchedulingGroup;
