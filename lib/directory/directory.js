...
var Directory = /** @class */ (function (_super) {
    ...
    ;
    Object.defineProperty(Directory.prototype, "administrativeUnits", {
        /**
    ...
    ;
    Object.defineProperty(Directory.prototype, "deletedItems", {
        /**
     ...
     */
    Directory.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["administrativeUnits", function (o, n) { o.administrativeUnits = n.getCollectionOfObjectValues(administrativeUnit_1.AdministrativeUnit); }],
            ["deletedItems", function (o, n) { o.deletedItems = n.getCollectionOfObjectValues(directoryObject_1.DirectoryObject); }],], false));
    };
    ;
    /**
     ...
     */
    Directory.prototype.serialize = function (writer) {
        if (!writer)
