...
var SectionGroup = /** @class */ (function (_super) {
    ...
    ;
    Object.defineProperty(SectionGroup.prototype, "parentNotebook", {
        /**
    ...
    ;
    Object.defineProperty(SectionGroup.prototype, "sectionGroupsUrl", {
        /**
    ...
    ;
    Object.defineProperty(SectionGroup.prototype, "sectionsUrl", {
        /**
     ...
     */
    SectionGroup.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["parentNotebook", function (o, n) { o.parentNotebook = n.getObjectValue(notebook_1.Notebook); }],
            ["parentSectionGroup", function (o, n) { o.parentSectionGroup = n.getObjectValue(SectionGroup); }],
            ["sectionGroups", function (o, n) { o.sectionGroups = n.getCollectionOfObjectValues(SectionGroup); }],
     ...
     */
    SectionGroup.prototype.serialize = function (writer) {
        if (!writer)
