...
var ListRequestBuilder = /** @class */ (function () {
    ...
    /**
     * Gets an item from the MicrosoftGraph.shares.list.columns collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.shares.list.contentTypes collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.shares.list.items collection
     * @param id Unique identifier of the item
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.shares.list.subscriptions collection
     * @param id Unique identifier of the item
