...
exports.CloudCommunications = void 0;
var entity_1 = require("../entity");
var onlineMeeting_1 = require("../onlineMeeting");
var presence_1 = require("../presence");
var call_1 = require("./call");
var callRecord_1 = require("./callRecord");
var CloudCommunications = /** @class */ (function (_super) {
    __extends(CloudCommunications, _super);
    /**
     * Instantiates a new CloudCommunications and sets the default values.
     */
    function CloudCommunications() {
        return _super.call(this) || this;
    }
    ;
    Object.defineProperty(CloudCommunications.prototype, "callRecords", {
        /**
    ...
    ;
    Object.defineProperty(CloudCommunications.prototype, "calls", {
        /**
    ...
    ;
    Object.defineProperty(CloudCommunications.prototype, "onlineMeetings", {
        /**
    ...
    ;
    Object.defineProperty(CloudCommunications.prototype, "presences", {
        /**
     ...
     */
    CloudCommunications.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["callRecords", function (o, n) { o.callRecords = n.getCollectionOfObjectValues(callRecord_1.CallRecord); }],
            ["calls", function (o, n) { o.calls = n.getCollectionOfObjectValues(call_1.Call); }],
            ["onlineMeetings", function (o, n) { o.onlineMeetings = n.getCollectionOfObjectValues(onlineMeeting_1.OnlineMeeting); }],
            ["presences", function (o, n) { o.presences = n.getCollectionOfObjectValues(presence_1.Presence); }],], false));
    };
    ;
    /**
     ...
     */
    CloudCommunications.prototype.serialize = function (writer) {
        if (!writer)
...
exports.CloudCommunications = CloudCommunications;
