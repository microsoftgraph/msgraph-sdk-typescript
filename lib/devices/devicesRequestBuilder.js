...
exports.DevicesRequestBuilder = void 0;
var device_1 = require("../device");
var devicesResponse_1 = require("./devicesResponse");
...
var DevicesRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function DevicesRequestBuilder(currentPath, httpCore, isRawUrl) {
        if (isRawUrl === void 0) { isRawUrl = true; }
        if (!currentPath)
            throw new Error("currentPath cannot be undefined");
        if (!httpCore)
            throw new Error("httpCore cannot be undefined");
        this.pathSegment = "/devices";
        this.httpCore = httpCore;
        this.currentPath = currentPath;
        this.isRawUrl = isRawUrl;
    }
    Object.defineProperty(DevicesRequestBuilder.prototype, "microsoft", {
        get: function () { },
        enumerable: false,
        configurable: true
    });
    DevicesRequestBuilder.prototype.getAvailableExtensionProperties = function () {
    ...
    DevicesRequestBuilder.prototype.getByIds = function () {
    ...
    DevicesRequestBuilder.prototype.validateProperties = function () {
     ...
     */
    DevicesRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
     ...
     * @returns a RequestInfo
     */
    DevicesRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    DevicesRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
        var requestInfo = this.createGetRequestInfo(q, h, o);
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, devicesResponse_1.DevicesResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Add new entity to devices
     ...
     */
    DevicesRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
...
exports.DevicesRequestBuilder = DevicesRequestBuilder;
