...
kiota_abstractions_1.Parsable;
{
    ...
    _recipient ?  : TeamworkNotificationRecipient | undefined;
    ...
    Map < string, function (item, node) { return void  > {
        return: new Map([
            ...
            ["recipient", function (o, n) { o.recipient = n.getObjectValue(TeamworkNotificationRecipient); }],
    ...
    void {
        ...
        writer: writer,
        : .writeObjectValue("recipient", this.recipient),
        writer: writer,
    ...
    ;
    set;
    recipient(value, TeamworkNotificationRecipient | undefined);
    {
