...
var OrganizationRequestBuilder = /** @class */ (function () {
    ...
    OrganizationRequestBuilder.prototype.getAvailableExtensionProperties = function () {
    ...
    OrganizationRequestBuilder.prototype.getByIds = function () {
    ...
    OrganizationRequestBuilder.prototype.validateProperties = function () {
     ...
     * @returns a RequestInfo
     */
    OrganizationRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
    ...
    OrganizationRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, organizationResponse_1.OrganizationResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Add new entity to organization
     ...
     */
    OrganizationRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
