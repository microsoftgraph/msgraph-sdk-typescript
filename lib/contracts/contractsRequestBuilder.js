...
exports.ContractsRequestBuilder = void 0;
var contract_1 = require("../contract");
var contractsResponse_1 = require("./contractsResponse");
...
var ContractsRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function ContractsRequestBuilder(currentPath, httpCore, isRawUrl) {
        if (isRawUrl === void 0) { isRawUrl = true; }
        if (!currentPath)
            throw new Error("currentPath cannot be undefined");
        if (!httpCore)
            throw new Error("httpCore cannot be undefined");
        this.pathSegment = "/contracts";
        this.httpCore = httpCore;
        this.currentPath = currentPath;
        this.isRawUrl = isRawUrl;
    }
    Object.defineProperty(ContractsRequestBuilder.prototype, "microsoft", {
        get: function () { },
        enumerable: false,
        configurable: true
    });
    ContractsRequestBuilder.prototype.getAvailableExtensionProperties = function () {
    ...
    ContractsRequestBuilder.prototype.getByIds = function () {
    ...
    ContractsRequestBuilder.prototype.validateProperties = function () {
     ...
     */
    ContractsRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
     ...
     * @returns a RequestInfo
     */
    ContractsRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    ContractsRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
        var requestInfo = this.createGetRequestInfo(q, h, o);
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, contractsResponse_1.ContractsResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Add new entity to contracts
     ...
     */
    ContractsRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
...
exports.ContractsRequestBuilder = ContractsRequestBuilder;
