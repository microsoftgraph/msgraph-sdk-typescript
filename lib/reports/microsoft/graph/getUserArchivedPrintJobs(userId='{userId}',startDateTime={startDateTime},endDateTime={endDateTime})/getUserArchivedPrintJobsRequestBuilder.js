...
var microsoft_graph_getUserArchivedPrintJobs_1 = require("./microsoft.graph.getUserArchivedPrintJobs");
Object.defineProperty(exports, "Microsoft", { enumerable: true, get: function () { return microsoft_graph_getUserArchivedPrintJobs_1.Microsoft; } });
...
microsoft_graph_getUserArchivedPrintJobs_1.graph.getUserArchivedPrintJobsRequestBuilder;
{
    currentPath: string;
    ...
    Promise < microsoft_graph_getUserArchivedPrintJobs_1.Microsoft.graph.getUserArchivedPrintJobs[] | undefined > {
        const: requestInfo = this.createGetRequestInfo(h, o),
        return: (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendCollectionAsync(requestInfo, microsoft_graph_getUserArchivedPrintJobs_1.Microsoft.graph.getUserArchivedPrintJobs, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'))
    };
}
