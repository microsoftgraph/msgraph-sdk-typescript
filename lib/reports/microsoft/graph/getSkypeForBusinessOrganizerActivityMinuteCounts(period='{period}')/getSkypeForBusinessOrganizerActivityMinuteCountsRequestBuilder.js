...
graph.getSkypeForBusinessOrganizerActivityMinuteCountsRequestBuilder;
{
    currentPath: string;
    ...
    constructor(currentPath, string, httpCore, kiota_abstractions_1.HttpCore, isRawUrl, boolean = true);
    {
        ...
        this.pathSegment = "/microsoft.graph.getSkypeForBusinessOrganizerActivityMinuteCounts(period='{period}')";
