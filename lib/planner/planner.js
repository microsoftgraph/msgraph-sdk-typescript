...
var Planner = /** @class */ (function (_super) {
     ...
     */
    Planner.prototype.getFieldDeserializers = function () {
        return new Map(__spreadArray(__spreadArray([], __read(_super.prototype.getFieldDeserializers.call(this)), false), [["buckets", function (o, n) { o.buckets = n.getCollectionOfObjectValues(plannerBucket_1.PlannerBucket); }],
            ["plans", function (o, n) { o.plans = n.getCollectionOfObjectValues(plannerPlan_1.PlannerPlan); }],
     ...
     */
    Planner.prototype.serialize = function (writer) {
        if (!writer)
