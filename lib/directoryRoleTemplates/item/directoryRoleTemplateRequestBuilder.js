...
exports.DirectoryRoleTemplateRequestBuilder = void 0;
...
var DirectoryRoleTemplateRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function DirectoryRoleTemplateRequestBuilder(currentPath, httpCore, isRawUrl) {
    ...
    Object.defineProperty(DirectoryRoleTemplateRequestBuilder.prototype, "microsoft", {
        get: function () { },
        enumerable: false,
        configurable: true
    });
    DirectoryRoleTemplateRequestBuilder.prototype.checkMemberGroups = function () {
    ...
    DirectoryRoleTemplateRequestBuilder.prototype.checkMemberObjects = function () {
    ...
    DirectoryRoleTemplateRequestBuilder.prototype.getMemberGroups = function () {
    ...
    DirectoryRoleTemplateRequestBuilder.prototype.getMemberObjects = function () {
    ...
    DirectoryRoleTemplateRequestBuilder.prototype.restore = function () {
     ...
     */
    DirectoryRoleTemplateRequestBuilder.prototype.createDeleteRequestInfo = function (h, o) {
     ...
     * @returns a RequestInfo
     */
    DirectoryRoleTemplateRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
        var requestInfo = new kiota_abstractions_1.RequestInfo();
        requestInfo.setUri(this.currentPath, this.pathSegment, this.isRawUrl);
     ...
     * @returns a RequestInfo
     */
    DirectoryRoleTemplateRequestBuilder.prototype.createPatchRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    DirectoryRoleTemplateRequestBuilder.prototype.delete = function (h, o, responseHandler) {
        var _a, _b;
     ...
     */
    DirectoryRoleTemplateRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    DirectoryRoleTemplateRequestBuilder.prototype.patch = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
...
exports.DirectoryRoleTemplateRequestBuilder = DirectoryRoleTemplateRequestBuilder;
