...
graph.getOrderRequestBuilder;
{
    ...
    Promise < assignmentOrder_1.AssignmentOrder | undefined > {
        const: requestInfo = this.createGetRequestInfo(h, o),
        return: (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, assignmentOrder_1.AssignmentOrder, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'))
    };
}
