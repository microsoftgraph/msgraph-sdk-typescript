...
var ApplicationsRequestBuilder = /** @class */ (function () {
    /**
     ...
     */
    function ApplicationsRequestBuilder(currentPath, httpCore, isRawUrl) {
        if (isRawUrl === void 0) { isRawUrl = true; }
        if (!currentPath)
            throw new Error("currentPath cannot be undefined");
        if (!httpCore)
            throw new Error("httpCore cannot be undefined");
        this.pathSegment = "/applications";
        this.httpCore = httpCore;
        this.currentPath = currentPath;
        this.isRawUrl = isRawUrl;
    }
    Object.defineProperty(ApplicationsRequestBuilder.prototype, "microsoft", {
        get: function () { },
        enumerable: false,
        configurable: true
    });
    ApplicationsRequestBuilder.prototype.getAvailableExtensionProperties = function () {
    ...
    ApplicationsRequestBuilder.prototype.getByIds = function () {
    ...
    ApplicationsRequestBuilder.prototype.validateProperties = function () {
     ...
     */
    ApplicationsRequestBuilder.prototype.createGetRequestInfo = function (q, h, o) {
     ...
     * @returns a RequestInfo
     */
    ApplicationsRequestBuilder.prototype.createPostRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    ApplicationsRequestBuilder.prototype.get = function (q, h, o, responseHandler) {
        var _a, _b;
        var requestInfo = this.createGetRequestInfo(q, h, o);
        return (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, applicationsResponse_1.ApplicationsResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    };
    ;
    /**
     * Add new entity to applications
     ...
     */
    ApplicationsRequestBuilder.prototype.post = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
