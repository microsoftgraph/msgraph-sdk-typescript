...
var LogoRequestBuilder = /** @class */ (function () {
     ...
     */
    function LogoRequestBuilder(currentPath, httpCore, isRawUrl) {
     ...
     */
    LogoRequestBuilder.prototype.createGetRequestInfo = function (h, o) {
     ...
     * @returns a RequestInfo
     */
    LogoRequestBuilder.prototype.createPutRequestInfo = function (body, h, o) {
        if (!body)
     ...
     */
    LogoRequestBuilder.prototype.get = function (h, o, responseHandler) {
        var _a, _b;
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    LogoRequestBuilder.prototype.put = function (body, h, o, responseHandler) {
        var _a, _b;
        if (!body)
            throw new Error("body cannot be undefined");
...
exports.LogoRequestBuilder = LogoRequestBuilder;
