...
var microsoft_graph_getActivitiesByInterval_1 = require("./microsoft.graph.getActivitiesByInterval");
Object.defineProperty(exports, "Microsoft", { enumerable: true, get: function () { return microsoft_graph_getActivitiesByInterval_1.Microsoft; } });
...
microsoft_graph_getActivitiesByInterval_1.graph.getActivitiesByIntervalRequestBuilder;
{
    currentPath: string;
    ...
    Promise < microsoft_graph_getActivitiesByInterval_1.Microsoft.graph.getActivitiesByInterval[] | undefined > {
        const: requestInfo = this.createGetRequestInfo(h, o),
        return: (_b = (_a = this.httpCore) === null || _a === void 0 ? void 0 : _a.sendCollectionAsync(requestInfo, microsoft_graph_getActivitiesByInterval_1.Microsoft.graph.getActivitiesByInterval, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'))
    };
}
