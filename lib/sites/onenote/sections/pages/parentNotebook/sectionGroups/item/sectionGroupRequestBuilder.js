...
var SectionGroupRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.sections.pages.parentNotebook.sectionGroups.sectionGroups collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.sections.pages.parentNotebook.sectionGroups.sections collection
     * @param id Unique identifier of the item
