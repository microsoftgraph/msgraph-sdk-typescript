...
var ParentSectionGroupRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.notebooks.sections.parentSectionGroup.sectionGroups collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.notebooks.sections.parentSectionGroup.sections collection
     * @param id Unique identifier of the item
