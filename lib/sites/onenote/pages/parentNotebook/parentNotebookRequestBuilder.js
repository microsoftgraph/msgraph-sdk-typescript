...
var ParentNotebookRequestBuilder = /** @class */ (function () {
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentNotebook.sectionGroups collection
    ...
    ;
    /**
     * Gets an item from the MicrosoftGraph.sites.onenote.pages.parentNotebook.sections collection
     * @param id Unique identifier of the item
