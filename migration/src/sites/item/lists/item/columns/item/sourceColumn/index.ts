 ...
 */
export const SourceColumnRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
