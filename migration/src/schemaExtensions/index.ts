...
import { createSchemaExtensionCollectionResponseFromDiscriminatorValue, createSchemaExtensionFromDiscriminatorValue, serializeSchemaExtension, type SchemaExtension, type SchemaExtensionCollectionResponse } from '../models/';
