 ...
 */
export const LastModifiedByRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension%2Did}/lastModifiedBy{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
