 ...
 */
export const ContentRequestBuilderUriTemplate = "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents/{chatMessageHostedContent%2Did}/$value";
/* tslint:enable */
/* eslint-enable */
