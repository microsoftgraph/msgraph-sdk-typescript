...
import { createSynchronizationJobCollectionResponseFromDiscriminatorValue, createSynchronizationJobFromDiscriminatorValue, serializeSynchronizationJob, type SynchronizationJob, type SynchronizationJobCollectionResponse } from '../../../../models/';
 ...
 */
export const JobsRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
