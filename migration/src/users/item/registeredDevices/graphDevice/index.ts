 ...
 */
export const GraphDeviceRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/registeredDevices/graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
