 ...
 */
export const GraphDirectoryRoleRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}/graph.directoryRole{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
