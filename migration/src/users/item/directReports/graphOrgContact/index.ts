 ...
 */
export const GraphOrgContactRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/directReports/graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
