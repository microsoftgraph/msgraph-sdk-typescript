...
import { createPrintTaskCollectionResponseFromDiscriminatorValue, createPrintTaskFromDiscriminatorValue, serializePrintTask, type PrintTask, type PrintTaskCollectionResponse } from '../../../../../../models/';
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
