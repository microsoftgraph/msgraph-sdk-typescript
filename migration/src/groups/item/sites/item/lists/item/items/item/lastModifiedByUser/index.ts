 ...
 */
export const LastModifiedByUserRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/lastModifiedByUser{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
