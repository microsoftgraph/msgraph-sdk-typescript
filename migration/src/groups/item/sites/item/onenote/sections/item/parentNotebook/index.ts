 ...
 */
export const ParentNotebookRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/parentNotebook{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
