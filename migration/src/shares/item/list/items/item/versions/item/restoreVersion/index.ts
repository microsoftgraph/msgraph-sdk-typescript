 ...
 */
export const RestoreVersionRequestBuilderUriTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}/restoreVersion";
/* tslint:enable */
/* eslint-enable */
