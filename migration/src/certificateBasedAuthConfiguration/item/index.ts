...
import { createCertificateBasedAuthConfigurationFromDiscriminatorValue, serializeCertificateBasedAuthConfiguration, type CertificateBasedAuthConfiguration } from '../../models/';
