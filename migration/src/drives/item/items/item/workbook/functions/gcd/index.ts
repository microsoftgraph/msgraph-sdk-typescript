 ...
 */
export interface GcdRequestBuilder extends BaseRequestBuilder<GcdRequestBuilder> {
    /**
     * Invoke action gcd
     ...
     */
     post(body: GcdPostRequestBody, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<WorkbookFunctionResult | undefined>;
    /**
     * Invoke action gcd
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: GcdPostRequestBody, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 ...
 */
export const GcdRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeGcdPostRequestBody,
 ...
 */
export const GcdRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/gcd";
/* tslint:enable */
/* eslint-enable */
