 ...
 * @returns a sqrtPiPostRequestBody
 */
 ...
 */
export interface SqrtPiRequestBuilder extends BaseRequestBuilder<SqrtPiRequestBuilder> {
    /**
     ...
     */
     post(body: SqrtPiPostRequestBody, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<WorkbookFunctionResult | undefined>;
    /**
     * Invoke action sqrtPi
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: SqrtPiPostRequestBody, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Metadata for all the requests in the request builder.
 */
export const SqrtPiRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeSqrtPiPostRequestBody,
 ...
 */
export const SqrtPiRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/sqrtPi";
/* tslint:enable */
/* eslint-enable */
