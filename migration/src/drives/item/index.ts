...
import { createDriveFromDiscriminatorValue, serializeDrive, type Drive } from '../../models/';
 ...
 */
export const DriveItemRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
